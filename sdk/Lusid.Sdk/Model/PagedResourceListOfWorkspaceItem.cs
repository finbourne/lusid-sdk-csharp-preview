...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfWorkspaceItem : IEquatable<PagedResourceListOfWorkspaceItem>
    {
        /// <summary>
        ...
        public PagedResourceListOfWorkspaceItem(string nextPage = default(string), string previousPage = default(string), List<WorkspaceItem> values = default(List<WorkspaceItem>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfWorkspaceItem and cannot be null");
