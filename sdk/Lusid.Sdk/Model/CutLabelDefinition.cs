...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CutLabelDefinition : IEquatable<CutLabelDefinition>
    {
        ...
        public CutLabelDefinition(string code = default(string), string displayName = default(string), string description = default(string), CutLocalTime cutLocalTime = default(CutLocalTime), string timeZone = default(string), string href = default(string), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            this.Code = code;
