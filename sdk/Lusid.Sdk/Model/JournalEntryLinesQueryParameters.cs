...
namespace Lusid.Sdk.Model
{
    ...
    public partial class JournalEntryLinesQueryParameters : IEquatable<JournalEntryLinesQueryParameters>
    {
        /// <summary>
        ...
        public JournalEntryLinesQueryParameters(List<string> propertyKeys = default(List<string>), DateOrDiaryEntry start = default(DateOrDiaryEntry), DateOrDiaryEntry end = default(DateOrDiaryEntry), string dateMode = default(string), string generalLedgerProfileCode = default(string))
        {
