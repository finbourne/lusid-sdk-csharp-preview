...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CorporateActionSource :  IEquatable<CorporateActionSource>, IValidatableObject
    {
        ...
        public CorporateActionSource(string href = default(string), ResourceId id = default(ResourceId), Version version = default(Version), string displayName = default(string), string description = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for CorporateActionSource and cannot be null");;
            // to ensure "version" is required (not null)
            this.Version = version ?? throw new ArgumentNullException("version is a required property for CorporateActionSource and cannot be null");;
            this.Href = href;
