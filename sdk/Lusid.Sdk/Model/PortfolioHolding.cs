...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioHolding :  IEquatable<PortfolioHolding>
    {
        ...
        /// <param name="holdingType">Type of holding, eg Position, Balance, CashCommitment, Receivable, ForwardFX (required).</param>
        /// <param name="units">Quantity of holding (required).</param>
        /// <param name="settledUnits">Settled quantity of holding (required).</param>
        /// <param name="cost">cost (required).</param>
        /// <param name="costPortfolioCcy">costPortfolioCcy (required).</param>
        /// <param name="transaction">transaction.</param>
        public PortfolioHolding(string instrumentUid = default(string), List<PerpetualProperty> subHoldingKeys = default(List<PerpetualProperty>), List<Property> properties = default(List<Property>), string holdingType = default(string), double? units = default(double?), double? settledUnits = default(double?), CurrencyAndAmount cost = default(CurrencyAndAmount), CurrencyAndAmount costPortfolioCcy = default(CurrencyAndAmount), Transaction transaction = default(Transaction))
        {
        ...
        /// </summary>
        /// <value>Type of holding, eg Position, Balance, CashCommitment, Receivable, ForwardFX</value>
        ...
        /// Quantity of holding
        /// </summary>
        /// <value>Quantity of holding</value>
        ...
        /// </summary>
        /// <value>Settled quantity of holding</value>
