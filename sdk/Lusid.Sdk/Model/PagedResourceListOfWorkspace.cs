...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfWorkspace : IEquatable<PagedResourceListOfWorkspace>
    {
        /// <summary>
        ...
        public PagedResourceListOfWorkspace(string nextPage = default(string), string previousPage = default(string), List<Workspace> values = default(List<Workspace>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfWorkspace and cannot be null");
