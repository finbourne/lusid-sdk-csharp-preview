...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ParticipationRequest :  IEquatable<ParticipationRequest>
    {
        ...
        public ParticipationRequest(ResourceId id = default(ResourceId), ResourceId placementId = default(ResourceId), ResourceId orderId = default(ResourceId), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ParticipationRequest and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (placementId == null)
            {
                throw new InvalidDataException("placementId is a required property for ParticipationRequest and cannot be null");
            }
            else
            {
            ...
            if (orderId == null)
            {
                throw new InvalidDataException("orderId is a required property for ParticipationRequest and cannot be null");
            }
            else
            {
