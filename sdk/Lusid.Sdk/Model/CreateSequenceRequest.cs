...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateSequenceRequest : IEquatable<CreateSequenceRequest>
    {
        ...
        /// Initializes a new instance of the <see cref="CreateSequenceRequest" /> class.
        /// </summary>
        /// <param name="code">Code of the sequence (required).</param>
        ...
        public CreateSequenceRequest(string code = default(string), long increment = default(long), long minValue = default(long), long maxValue = default(long), long start = default(long), bool cycle = default(bool), List<Link> links = default(List<Link>))
        {
        ...
        /// </summary>
        /// <value>Code of the sequence</value>
