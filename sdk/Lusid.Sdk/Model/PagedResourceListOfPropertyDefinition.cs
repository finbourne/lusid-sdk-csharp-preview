...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfPropertyDefinition")]
    public partial class PagedResourceListOfPropertyDefinition : IEquatable<PagedResourceListOfPropertyDefinition>
    {
        ...
        public PagedResourceListOfPropertyDefinition(string nextPage = default(string), string previousPage = default(string), List<PropertyDefinition> values = default(List<PropertyDefinition>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfPropertyDefinition and cannot be null");
