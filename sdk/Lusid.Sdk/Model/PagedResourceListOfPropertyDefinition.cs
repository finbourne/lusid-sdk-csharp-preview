...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfPropertyDefinition :  IEquatable<PagedResourceListOfPropertyDefinition>
    {
        ...
        public PagedResourceListOfPropertyDefinition(List<PropertyDefinition> values = default(List<PropertyDefinition>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
