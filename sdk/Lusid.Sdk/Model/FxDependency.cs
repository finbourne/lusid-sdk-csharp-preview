...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxDependency : EconomicDependency, IEquatable<FxDependency>
    {
        /// <summary>
        ...
        /// <param name="dependencyType">The available values are: OpaqueDependency, CashDependency, DiscountingDependency, EquityCurveDependency, EquityVolDependency, FxDependency, FxForwardsDependency, FxVolDependency, IndexProjectionDependency, IrVolDependency, QuoteDependency, Vendor (required) (default to &quot;FxDependency&quot;).</param>
        public FxDependency(string domesticCurrency = default(string), string foreignCurrency = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base(dependencyType)
        {
            ...
            this.DomesticCurrency = domesticCurrency ?? throw new ArgumentNullException("domesticCurrency is a required property for FxDependency and cannot be null");
            // to ensure "foreignCurrency" is required (not null)
            this.ForeignCurrency = foreignCurrency ?? throw new ArgumentNullException("foreignCurrency is a required property for FxDependency and cannot be null");
            this.Date = date;
        }
        ...
        [DataMember(Name = "domesticCurrency", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "foreignCurrency", IsRequired = true, EmitDefaultValue = false)]
