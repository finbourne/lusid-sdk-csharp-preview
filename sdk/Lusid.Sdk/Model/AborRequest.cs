...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AborRequest : IEquatable<AborRequest>
    {
        /// <summary>
        ...
        /// <param name="aborConfig">aborConfig (required).</param>
        /// <param name="properties">Properties to add to the Abor..</param>
        public AborRequest(string code = default(string), List<PortfolioEntityId> portfolioIds = default(List<PortfolioEntityId>), string description = default(string), ResourceId aborConfig = default(ResourceId), Dictionary<string, Property> properties = default(Dictionary<string, Property>))
        {
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for AborRequest and cannot be null");
            // to ensure "portfolioIds" is required (not null)
            this.PortfolioIds = portfolioIds ?? throw new ArgumentNullException("portfolioIds is a required property for AborRequest and cannot be null");
            // to ensure "aborConfig" is required (not null)
            this.AborConfig = aborConfig ?? throw new ArgumentNullException("aborConfig is a required property for AborRequest and cannot be null");
        ...
        [DataMember(Name = "portfolioIds", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "aborConfig", IsRequired = true, EmitDefaultValue = false)]
