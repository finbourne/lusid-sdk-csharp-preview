...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AborRequest : IEquatable<AborRequest>
    {
        ...
        /// <param name="displayName">The given name for the Abor. (required).</param>
        ...
        public AborRequest(string code = default(string), string displayName = default(string), string description = default(string), List<PortfolioEntityId> portfolioIds = default(List<PortfolioEntityId>), ResourceId aborConfigurationId = default(ResourceId), Dictionary<string, Property> properties = default(Dictionary<string, Property>))
        {
            ...
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for AborRequest and cannot be null");
            ...
            this.AborConfigurationId = aborConfigurationId ?? throw new ArgumentNullException("aborConfigurationId is a required property for AborRequest and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "aborConfigurationId", IsRequired = true, EmitDefaultValue = false)]
