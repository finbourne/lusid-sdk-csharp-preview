...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashLadderRecord :  IEquatable<CashLadderRecord>
    {
        ...
        public CashLadderRecord(DateTimeOffset? effectiveDate = default(DateTimeOffset?), decimal? open = default(decimal?), Dictionary<string, decimal?> activities = default(Dictionary<string, decimal?>), decimal? close = default(decimal?))
        {
            ...
            if (open == null)
            {
                throw new InvalidDataException("open is a required property for CashLadderRecord and cannot be null");
            }
            else
            {
                this.Open = open;
            ...
            if (activities == null)
            {
                throw new InvalidDataException("activities is a required property for CashLadderRecord and cannot be null");
            }
            else
            {
            ...
            if (close == null)
            {
                throw new InvalidDataException("close is a required property for CashLadderRecord and cannot be null");
            }
            else
            {
                this.Close = close;
