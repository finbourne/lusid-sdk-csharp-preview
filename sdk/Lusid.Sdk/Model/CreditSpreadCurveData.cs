...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreditSpreadCurveData : ComplexMarketData, IEquatable<CreditSpreadCurveData>
    {
        ...
        public CreditSpreadCurveData(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), decimal recoveryRate = default(decimal), List<decimal> spreads = default(List<decimal>), List<string> tenors = default(List<string>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base(marketDataType)
        {
