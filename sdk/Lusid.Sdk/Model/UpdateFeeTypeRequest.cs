...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpdateFeeTypeRequest : IEquatable<UpdateFeeTypeRequest>
    {
        /// <summary>
        ...
        public UpdateFeeTypeRequest(string displayName = default(string), string description = default(string), List<ComponentTransaction> componentTransactions = default(List<ComponentTransaction>))
        {
            ...
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for UpdateFeeTypeRequest and cannot be null");
            // to ensure "componentTransactions" is required (not null)
            this.ComponentTransactions = componentTransactions ?? throw new ArgumentNullException("componentTransactions is a required property for UpdateFeeTypeRequest and cannot be null");
