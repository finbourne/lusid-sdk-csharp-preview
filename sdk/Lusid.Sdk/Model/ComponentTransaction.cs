...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComponentTransaction : IEquatable<ComponentTransaction>
    {
        /// <summary>
        ...
        public ComponentTransaction(string displayName = default(string), string condition = default(string), TransactionFieldMap transactionFieldMap = default(TransactionFieldMap), List<TransactionPropertyMap> transactionPropertyMap = default(List<TransactionPropertyMap>))
        {
            ...
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for ComponentTransaction and cannot be null");
            // to ensure "transactionFieldMap" is required (not null)
            this.TransactionFieldMap = transactionFieldMap ?? throw new ArgumentNullException("transactionFieldMap is a required property for ComponentTransaction and cannot be null");
            // to ensure "transactionPropertyMap" is required (not null)
            this.TransactionPropertyMap = transactionPropertyMap ?? throw new ArgumentNullException("transactionPropertyMap is a required property for ComponentTransaction and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "transactionFieldMap", IsRequired = true, EmitDefaultValue = false)]
        public TransactionFieldMap TransactionFieldMap { get; set; }

        /// <summary>
        /// Gets or Sets TransactionPropertyMap
        /// </summary>
        [DataMember(Name = "transactionPropertyMap", IsRequired = true, EmitDefaultValue = false)]
