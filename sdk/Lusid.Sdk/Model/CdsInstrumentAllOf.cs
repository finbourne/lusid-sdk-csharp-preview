...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CdsInstrumentAllOf :  IEquatable<CdsInstrumentAllOf>
    {
        ...
        public CdsInstrumentAllOf(string ticker = default(string), CdsFlowConventions flowConventions = default(CdsFlowConventions), decimal? couponRate = default(decimal?), CdsProtectionDetailSpecification protectionDetailSpecification = default(CdsProtectionDetailSpecification), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), string domCcy = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            {
                throw new InvalidDataException("protectionDetailSpecification is a required property for CdsInstrumentAllOf and cannot be null");
            }
            else
            {
