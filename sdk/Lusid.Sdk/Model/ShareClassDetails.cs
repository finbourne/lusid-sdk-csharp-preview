...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ShareClassDetails : IEquatable<ShareClassDetails>
    {
        /// <summary>
        ...
        /// <param name="classCurrency">The domestic currency of the share class instrument.</param>
        public ShareClassDetails(string lusidInstrumentId = default(string), string instrumentScope = default(string), string classCurrency = default(string))
        {
            this.LusidInstrumentId = lusidInstrumentId;
            this.InstrumentScope = instrumentScope;
            this.ClassCurrency = classCurrency;
        }
        ...
        [DataMember(Name = "classCurrency", EmitDefaultValue = true)]
        public string ClassCurrency { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ClassCurrency: ").Append(ClassCurrency).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(ShareClassDetails input)
        {
            ...
            return 
                ...
                (
                    this.ClassCurrency == input.ClassCurrency ||
                    (this.ClassCurrency != null &&
                    this.ClassCurrency.Equals(input.ClassCurrency))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ClassCurrency != null)
                    hashCode = hashCode * 59 + this.ClassCurrency.GetHashCode();
                return hashCode;
            }
        }
