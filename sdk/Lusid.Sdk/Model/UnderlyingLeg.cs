...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UnderlyingLeg : IEquatable<UnderlyingLeg>
    {
        /// <summary>
        ...
        public UnderlyingLeg(string payReceive = default(string), LusidInstrument underlying = default(LusidInstrument))
        {
            ...
            this.PayReceive = payReceive ?? throw new ArgumentNullException("payReceive is a required property for UnderlyingLeg and cannot be null");
            // to ensure "underlying" is required (not null)
            this.Underlying = underlying ?? throw new ArgumentNullException("underlying is a required property for UnderlyingLeg and cannot be null");
        }
