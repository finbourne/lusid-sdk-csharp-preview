...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardCurveByQuoteReferenceAllOf : IEquatable<FxForwardCurveByQuoteReferenceAllOf>
    {
        /// <summary>
        ...
        public FxForwardCurveByQuoteReferenceAllOf(string domCcy = default(string), string fgnCcy = default(string), List<string> tenors = default(List<string>), List<Dictionary<string, string>> quoteReferences = default(List<Dictionary<string, string>>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum), string lineage = default(string))
        {
            ...
            this.FgnCcy = fgnCcy ?? throw new ArgumentNullException("fgnCcy is a required property for FxForwardCurveByQuoteReferenceAllOf and cannot be null");
            // to ensure "tenors" is required (not null)
            this.Tenors = tenors ?? throw new ArgumentNullException("tenors is a required property for FxForwardCurveByQuoteReferenceAllOf and cannot be null");
