...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionFieldMap : IEquatable<TransactionFieldMap>
    {
        /// <summary>
        ...
        public TransactionFieldMap(string transactionId = default(string), string type = default(string), string source = default(string), string lusidInstrumentId = default(string), string instrumentScope = default(string), string tradeDate = default(string), string settlementDate = default(string), string units = default(string), TransactionPriceAndType transactionPrice = default(TransactionPriceAndType), string transactionCurrency = default(string), string exchangeRate = default(string), TransactionCurrencyAndAmount totalConsideration = default(TransactionCurrencyAndAmount), string settlementCurrency = default(string))
        {
            ...
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for TransactionFieldMap and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for TransactionFieldMap and cannot be null");
            // to ensure "source" is required (not null)
            this.Source = source ?? throw new ArgumentNullException("source is a required property for TransactionFieldMap and cannot be null");
            // to ensure "lusidInstrumentId" is required (not null)
            this.LusidInstrumentId = lusidInstrumentId ?? throw new ArgumentNullException("lusidInstrumentId is a required property for TransactionFieldMap and cannot be null");
            // to ensure "instrumentScope" is required (not null)
            this.InstrumentScope = instrumentScope ?? throw new ArgumentNullException("instrumentScope is a required property for TransactionFieldMap and cannot be null");
            // to ensure "tradeDate" is required (not null)
            this.TradeDate = tradeDate ?? throw new ArgumentNullException("tradeDate is a required property for TransactionFieldMap and cannot be null");
            // to ensure "settlementDate" is required (not null)
            this.SettlementDate = settlementDate ?? throw new ArgumentNullException("settlementDate is a required property for TransactionFieldMap and cannot be null");
            // to ensure "units" is required (not null)
            this.Units = units ?? throw new ArgumentNullException("units is a required property for TransactionFieldMap and cannot be null");
            // to ensure "transactionPrice" is required (not null)
            this.TransactionPrice = transactionPrice ?? throw new ArgumentNullException("transactionPrice is a required property for TransactionFieldMap and cannot be null");
            // to ensure "transactionCurrency" is required (not null)
            this.TransactionCurrency = transactionCurrency ?? throw new ArgumentNullException("transactionCurrency is a required property for TransactionFieldMap and cannot be null");
            // to ensure "exchangeRate" is required (not null)
            this.ExchangeRate = exchangeRate ?? throw new ArgumentNullException("exchangeRate is a required property for TransactionFieldMap and cannot be null");
            // to ensure "totalConsideration" is required (not null)
            this.TotalConsideration = totalConsideration ?? throw new ArgumentNullException("totalConsideration is a required property for TransactionFieldMap and cannot be null");
            // to ensure "settlementCurrency" is required (not null)
            this.SettlementCurrency = settlementCurrency ?? throw new ArgumentNullException("settlementCurrency is a required property for TransactionFieldMap and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "transactionPrice", IsRequired = true, EmitDefaultValue = false)]
