...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfCleardownModuleRule")]
    public partial class PagedResourceListOfCleardownModuleRule : IEquatable<PagedResourceListOfCleardownModuleRule>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfCleardownModuleRule" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfCleardownModuleRule() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfCleardownModuleRule" /> class.
        /// </summary>
        ...
        public PagedResourceListOfCleardownModuleRule(string nextPage = default(string), string previousPage = default(string), List<CleardownModuleRule> values = default(List<CleardownModuleRule>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfCleardownModuleRule and cannot be null");
        ...
        public List<CleardownModuleRule> Values { get; set; }
        ...
        {
            return this.Equals(input as PagedResourceListOfCleardownModuleRule);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfCleardownModuleRule instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfCleardownModuleRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfCleardownModuleRule input)
        {
            if (input == null)
                return false;
