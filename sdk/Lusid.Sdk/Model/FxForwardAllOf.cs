...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardAllOf :  IEquatable<FxForwardAllOf>
    {
        ...
        public FxForwardAllOf(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), decimal? domAmount = default(decimal?), string domCcy = default(string), decimal? fgnAmount = default(decimal?), string fgnCcy = default(string), decimal? refSpotRate = default(decimal?), bool? isNdf = default(bool?), DateTimeOffset? fixingDate = default(DateTimeOffset?), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for FxForwardAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for FxForwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (domAmount == null)
            {
                throw new InvalidDataException("domAmount is a required property for FxForwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (domCcy == null)
            {
                throw new InvalidDataException("domCcy is a required property for FxForwardAllOf and cannot be null");
            }
            else
            {
                this.DomCcy = domCcy;
            ...
            if (fgnAmount == null)
            {
                throw new InvalidDataException("fgnAmount is a required property for FxForwardAllOf and cannot be null");
            }
            else
            {
            ...
            if (fgnCcy == null)
            {
                throw new InvalidDataException("fgnCcy is a required property for FxForwardAllOf and cannot be null");
            }
            else
            {
                this.FgnCcy = fgnCcy;
            ...
            {
                throw new InvalidDataException("instrumentType is a required property for FxForwardAllOf and cannot be null");
            }
            else
            {
