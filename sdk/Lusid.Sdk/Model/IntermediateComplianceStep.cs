...
namespace Lusid.Sdk.Model
{
    ...
    public partial class IntermediateComplianceStep : ComplianceStep, IEquatable<IntermediateComplianceStep>
    {
        /// <summary>
        ...
        /// <param name="complianceStepType">. The available values are: FilterStep, GroupByStep, GroupFilterStep, BranchStep, RecombineStep, CheckStep, PercentCheckStep (required) (default to &quot;IntermediateComplianceStep&quot;).</param>
        public IntermediateComplianceStep(string label = default(string), Dictionary<string, List<ComplianceTemplateParameter>> groupedParameters = default(Dictionary<string, List<ComplianceTemplateParameter>>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum)) : base(complianceStepType)
        {
            ...
            this.Label = label ?? throw new ArgumentNullException("label is a required property for IntermediateComplianceStep and cannot be null");
            // to ensure "groupedParameters" is required (not null)
            this.GroupedParameters = groupedParameters ?? throw new ArgumentNullException("groupedParameters is a required property for IntermediateComplianceStep and cannot be null");
        }
        ...
        [DataMember(Name = "groupedParameters", IsRequired = true, EmitDefaultValue = false)]
