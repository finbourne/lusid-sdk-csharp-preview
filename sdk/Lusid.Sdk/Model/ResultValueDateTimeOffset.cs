...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResultValueDateTimeOffset")]
    [JsonConverter(typeof(JsonSubtypes), "ResultValueType")]
    public partial class ResultValueDateTimeOffset : ResultValue, IEquatable<ResultValueDateTimeOffset>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultValueDateTimeOffset" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResultValueDateTimeOffset() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultValueDateTimeOffset" /> class.
        /// </summary>
        ...
        /// <param name="resultValueType">The available values are: ResultValue, ResultValueDictionary, ResultValue0D, ResultValueDecimal, ResultValueInt, ResultValueString, CashFlowValue, CashFlowValueSet, ResultValueLifeCycleEventValue, ResultValueDateTimeOffset (required) (default to &quot;ResultValueDateTimeOffset&quot;).</param>
        public ResultValueDateTimeOffset(DateTimeOffset value = default(DateTimeOffset), int? dimension = default(int?), ResultValueTypeEnum resultValueType = default(ResultValueTypeEnum)) : base(resultValueType)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as ResultValueDateTimeOffset);
        }

        /// <summary>
        /// Returns true if ResultValueDateTimeOffset instances are equal
        /// </summary>
        /// <param name="input">Instance of ResultValueDateTimeOffset to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResultValueDateTimeOffset input)
        {
            if (input == null)
                return false;
