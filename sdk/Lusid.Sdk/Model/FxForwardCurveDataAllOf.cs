...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardCurveDataAllOf : IEquatable<FxForwardCurveDataAllOf>
    {
        ...
        public FxForwardCurveDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), string fgnCcy = default(string), List<DateTimeOffset> dates = default(List<DateTimeOffset>), List<decimal> rates = default(List<decimal>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum), string lineage = default(string))
        {
