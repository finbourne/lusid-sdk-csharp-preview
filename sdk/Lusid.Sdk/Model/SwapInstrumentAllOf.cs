...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SwapInstrumentAllOf :  IEquatable<SwapInstrumentAllOf>
    {
        ...
        public SwapInstrumentAllOf(DateTimeOffset? maturityDate = default(DateTimeOffset?), DateTimeOffset? startDate = default(DateTimeOffset?), List<InstrumentLeg> legs = default(List<InstrumentLeg>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
