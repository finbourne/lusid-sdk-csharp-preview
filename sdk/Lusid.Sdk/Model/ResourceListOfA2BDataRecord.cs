...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfA2BDataRecord")]
    public partial class ResourceListOfA2BDataRecord : IEquatable<ResourceListOfA2BDataRecord>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfA2BDataRecord" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfA2BDataRecord() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfA2BDataRecord" /> class.
        /// </summary>
        ...
        public ResourceListOfA2BDataRecord(List<A2BDataRecord> values = default(List<A2BDataRecord>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfA2BDataRecord and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfA2BDataRecord {\n");
        ...
        {
            return this.Equals(input as ResourceListOfA2BDataRecord);
        }

        /// <summary>
        /// Returns true if ResourceListOfA2BDataRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfA2BDataRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfA2BDataRecord input)
        {
            if (input == null)
                return false;
