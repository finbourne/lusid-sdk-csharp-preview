...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InterestRateSwap : LusidInstrument,  IEquatable<InterestRateSwap>
    {
        ...
        public InterestRateSwap(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), List<InstrumentLeg> legs = default(List<InstrumentLeg>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for InterestRateSwap and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for InterestRateSwap and cannot be null");
            }
            else
            {
            ...
            if (legs == null)
            {
                throw new InvalidDataException("legs is a required property for InterestRateSwap and cannot be null");
            }
            else
            {
                this.Legs = legs;
