...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardCurveData : ComplexMarketData, IEquatable<FxForwardCurveData>
    {
        ...
        /// <param name="marketDataType">The available values are: DiscountFactorCurveData, EquityVolSurfaceData, FxVolSurfaceData, IrVolCubeData, OpaqueMarketData, YieldCurveData, FxForwardCurveData, FxForwardPipsCurveData, FxForwardTenorCurveData, FxForwardTenorPipsCurveData, FxForwardCurveByQuoteReference, CreditSpreadCurveData (required) (default to &quot;FxForwardCurveData&quot;).</param>
        /// <param name="lineage">Description of the complex market data&#39;s lineage e.g. &#39;FundAccountant_GreenQuality&#39;..</param>
        public FxForwardCurveData(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), string fgnCcy = default(string), List<DateTimeOffset> dates = default(List<DateTimeOffset>), List<decimal> rates = default(List<decimal>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum), string lineage = default(string)) : base(marketDataType)
        {
