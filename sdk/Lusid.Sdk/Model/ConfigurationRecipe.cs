...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ConfigurationRecipe :  IEquatable<ConfigurationRecipe>
    {
        ...
        public ConfigurationRecipe(string code = default(string), MarketContext market = default(MarketContext), PricingContext pricing = default(PricingContext), AggregationContext aggregation = default(AggregationContext), List<ResourceId> inheritedRecipes = default(List<ResourceId>))
        {
