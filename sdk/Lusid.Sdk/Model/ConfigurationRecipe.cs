...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ConfigurationRecipe : IEquatable<ConfigurationRecipe>
    {
        ...
        public ConfigurationRecipe(string scope = default(string), string code = default(string), HoldingContext holding = default(HoldingContext), MarketContext market = default(MarketContext), PricingContext pricing = default(PricingContext), AggregationContext aggregation = default(AggregationContext), List<ResourceId> inheritedRecipes = default(List<ResourceId>), string description = default(string))
        {
