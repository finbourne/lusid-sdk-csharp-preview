...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfPortfolioCashLadder")]
    public partial class ResourceListOfPortfolioCashLadder : IEquatable<ResourceListOfPortfolioCashLadder>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfPortfolioCashLadder" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfPortfolioCashLadder() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfPortfolioCashLadder" /> class.
        /// </summary>
        ...
        public ResourceListOfPortfolioCashLadder(List<PortfolioCashLadder> values = default(List<PortfolioCashLadder>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfPortfolioCashLadder and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<PortfolioCashLadder> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfPortfolioCashLadder {\n");
        ...
        {
            return this.Equals(input as ResourceListOfPortfolioCashLadder);
        }

        /// <summary>
        /// Returns true if ResourceListOfPortfolioCashLadder instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfPortfolioCashLadder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfPortfolioCashLadder input)
        {
            if (input == null)
                return false;
