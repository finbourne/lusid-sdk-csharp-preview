...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AborConfigurationRequest : IEquatable<AborConfigurationRequest>
    {
        ...
        public AborConfigurationRequest(string code = default(string), string description = default(string), string name = default(string), ResourceId recipeId = default(ResourceId), ResourceId chartOfAccountsId = default(ResourceId), Dictionary<string, Property> properties = default(Dictionary<string, Property>))
        {
