...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AborConfigurationRequest : IEquatable<AborConfigurationRequest>
    {
        /// <summary>
        ...
        public AborConfigurationRequest(string code = default(string), string displayName = default(string), string description = default(string), ResourceId recipeId = default(ResourceId), ResourceId chartOfAccountsId = default(ResourceId), List<string> postingModuleCodes = default(List<string>), List<string> cleardownModuleCodes = default(List<string>), Dictionary<string, Property> properties = default(Dictionary<string, Property>))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for AborConfigurationRequest and cannot be null");
            // to ensure "recipeId" is required (not null)
            this.RecipeId = recipeId ?? throw new ArgumentNullException("recipeId is a required property for AborConfigurationRequest and cannot be null");
            // to ensure "chartOfAccountsId" is required (not null)
            this.ChartOfAccountsId = chartOfAccountsId ?? throw new ArgumentNullException("chartOfAccountsId is a required property for AborConfigurationRequest and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "chartOfAccountsId", IsRequired = true, EmitDefaultValue = false)]
