...
namespace Lusid.Sdk.Model
{
    ...
    public partial class VersionedResourceListOfPortfolioHolding :  IEquatable<VersionedResourceListOfPortfolioHolding>
    {
        ...
        public VersionedResourceListOfPortfolioHolding(Version version = default(Version), List<PortfolioHolding> values = default(List<PortfolioHolding>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
