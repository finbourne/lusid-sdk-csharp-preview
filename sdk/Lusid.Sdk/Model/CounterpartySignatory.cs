...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CounterpartySignatory :  IEquatable<CounterpartySignatory>
    {
        ...
        public CounterpartySignatory(string name = default(string), TypedResourceId legalEntityIdentifier = default(TypedResourceId))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CounterpartySignatory and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("legalEntityIdentifier is a required property for CounterpartySignatory and cannot be null");
            }
            else
            {
