...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxSwapAllOf :  IEquatable<FxSwapAllOf>
    {
        ...
        public FxSwapAllOf(FxForward nearFxForward = default(FxForward), FxForward farFxForward = default(FxForward), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            {
                throw new InvalidDataException("nearFxForward is a required property for FxSwapAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("farFxForward is a required property for FxSwapAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instrumentType is a required property for FxSwapAllOf and cannot be null");
            }
            else
            {
