...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfAborConfiguration")]
    public partial class PagedResourceListOfAborConfiguration : IEquatable<PagedResourceListOfAborConfiguration>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfAborConfiguration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfAborConfiguration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfAborConfiguration" /> class.
        /// </summary>
        ...
        public PagedResourceListOfAborConfiguration(string nextPage = default(string), string previousPage = default(string), List<AborConfiguration> values = default(List<AborConfiguration>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfAborConfiguration and cannot be null");
        ...
        public List<AborConfiguration> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResourceListOfAborConfiguration {\n");
        ...
        {
            return this.Equals(input as PagedResourceListOfAborConfiguration);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfAborConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfAborConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfAborConfiguration input)
        {
            if (input == null)
                return false;
