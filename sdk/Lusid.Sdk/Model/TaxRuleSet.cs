...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TaxRuleSet : IEquatable<TaxRuleSet>
    {
        /// <summary>
        ...
        /// <param name="rules">The rules of this rule set, which stipulate what rate to apply (i.e. write to the OutputPropertyKey) under certain conditions.</param>
        /// <param name="version">version.</param>
        /// <param name="links">Collection of links..</param>
        public TaxRuleSet(ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), string outputPropertyKey = default(string), List<TaxRule> rules = default(List<TaxRule>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for TaxRuleSet and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for TaxRuleSet and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for TaxRuleSet and cannot be null");
            // to ensure "outputPropertyKey" is required (not null)
            this.OutputPropertyKey = outputPropertyKey ?? throw new ArgumentNullException("outputPropertyKey is a required property for TaxRuleSet and cannot be null");
            this.Rules = rules;
