...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SidesDefinitionRequest : IEquatable<SidesDefinitionRequest>
    {
        /// <summary>
        ...
        public SidesDefinitionRequest(string side = default(string), SideDefinitionRequest sideRequest = default(SideDefinitionRequest))
        {
            ...
            this.Side = side ?? throw new ArgumentNullException("side is a required property for SidesDefinitionRequest and cannot be null");
            // to ensure "sideRequest" is required (not null)
            this.SideRequest = sideRequest ?? throw new ArgumentNullException("sideRequest is a required property for SidesDefinitionRequest and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "sideRequest", IsRequired = true, EmitDefaultValue = false)]
