...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupReconciliationReviewStatuses : IEquatable<GroupReconciliationReviewStatuses>
    {
        /// <summary>
        ...
        public GroupReconciliationReviewStatuses(int countPending = default(int), Link linkPending = default(Link), int countReviewed = default(int), Link linkReviewed = default(Link), int countMatched = default(int), Link linkMatched = default(Link), int countInvalid = default(int), Link linkInvalid = default(Link))
        {
            ...
            this.LinkPending = linkPending ?? throw new ArgumentNullException("linkPending is a required property for GroupReconciliationReviewStatuses and cannot be null");
            this.CountReviewed = countReviewed;
            // to ensure "linkReviewed" is required (not null)
            this.LinkReviewed = linkReviewed ?? throw new ArgumentNullException("linkReviewed is a required property for GroupReconciliationReviewStatuses and cannot be null");
            this.CountMatched = countMatched;
            // to ensure "linkMatched" is required (not null)
            this.LinkMatched = linkMatched ?? throw new ArgumentNullException("linkMatched is a required property for GroupReconciliationReviewStatuses and cannot be null");
            this.CountInvalid = countInvalid;
            // to ensure "linkInvalid" is required (not null)
            this.LinkInvalid = linkInvalid ?? throw new ArgumentNullException("linkInvalid is a required property for GroupReconciliationReviewStatuses and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "linkPending", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "linkReviewed", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "linkMatched", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "linkInvalid", IsRequired = true, EmitDefaultValue = false)]
