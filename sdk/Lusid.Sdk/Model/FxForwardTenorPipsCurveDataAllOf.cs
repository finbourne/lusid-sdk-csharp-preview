...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardTenorPipsCurveDataAllOf : IEquatable<FxForwardTenorPipsCurveDataAllOf>
    {
        ...
        public FxForwardTenorPipsCurveDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), string fgnCcy = default(string), List<string> tenors = default(List<string>), List<decimal> pipRates = default(List<decimal>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum), string lineage = default(string))
        {
