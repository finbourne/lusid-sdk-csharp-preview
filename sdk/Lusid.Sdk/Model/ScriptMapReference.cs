...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ScriptMapReference : IEquatable<ScriptMapReference>
    {
        /// <summary>
        ...
        public ScriptMapReference(string scope = default(string), string code = default(string), string key = default(string))
        {
            ...
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for ScriptMapReference and cannot be null");
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for ScriptMapReference and cannot be null");
            // to ensure "key" is required (not null)
            this.Key = key ?? throw new ArgumentNullException("key is a required property for ScriptMapReference and cannot be null");
        }
