...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfOrderInstruction")]
    public partial class PagedResourceListOfOrderInstruction : IEquatable<PagedResourceListOfOrderInstruction>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfOrderInstruction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfOrderInstruction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfOrderInstruction" /> class.
        /// </summary>
        ...
        public PagedResourceListOfOrderInstruction(string nextPage = default(string), string previousPage = default(string), List<OrderInstruction> values = default(List<OrderInstruction>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfOrderInstruction and cannot be null");
        ...
        {
            return this.Equals(input as PagedResourceListOfOrderInstruction);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfOrderInstruction instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfOrderInstruction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfOrderInstruction input)
        {
            if (input == null)
                return false;
