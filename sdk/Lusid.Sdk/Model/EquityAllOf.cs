...
namespace Lusid.Sdk.Model
{
    ...
    /// EquityAllOf
    /// </summary>
    [DataContract(Name = "Equity_allOf")]
    public partial class EquityAllOf : IEquatable<EquityAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EquityAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EquityAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EquityAllOf" /> class.
        /// </summary>
        ...
        public EquityAllOf(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), EquityAllOfIdentifiers identifiers = default(EquityAllOfIdentifiers), string domCcy = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            this.StartDate = startDate;
            this.MaturityDate = maturityDate;
            // to ensure "identifiers" is required (not null)
            this.Identifiers = identifiers ?? throw new ArgumentNullException("identifiers is a required property for EquityAllOf and cannot be null");
            // to ensure "domCcy" is required (not null)
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for EquityAllOf and cannot be null");
        ...
        {
            return this.Equals(input as EquityAllOf);
        }

        /// <summary>
        /// Returns true if EquityAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of EquityAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquityAllOf input)
        {
            if (input == null)
                return false;
