...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Operation : IEquatable<Operation>
    {
        ...
        public Operation(Object value = default(Object), string path = default(string), string op = default(string), string from = default(string))
        {
            ...
            this.Path = path ?? throw new ArgumentNullException("path is a required property for Operation and cannot be null");
            // to ensure "op" is required (not null)
            this.Op = op ?? throw new ArgumentNullException("op is a required property for Operation and cannot be null");
            this.Value = value;
            this.From = from;
        }
