...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateAmortisationRuleSetRequest : IEquatable<CreateAmortisationRuleSetRequest>
    {
        /// <summary>
        ...
        public CreateAmortisationRuleSetRequest(string code = default(string), string displayName = default(string), string description = default(string))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for CreateAmortisationRuleSetRequest and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CreateAmortisationRuleSetRequest and cannot be null");
