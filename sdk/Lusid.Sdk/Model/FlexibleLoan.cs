...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FlexibleLoan : LusidInstrument, IEquatable<FlexibleLoan>
    {
        /// <summary>
        ...
        public FlexibleLoan(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), string domCcy = default(string), List<Schedule> schedules = default(List<Schedule>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for FlexibleLoan and cannot be null");
            // to ensure "schedules" is required (not null)
            this.Schedules = schedules ?? throw new ArgumentNullException("schedules is a required property for FlexibleLoan and cannot be null");
        }
        ...
        [DataMember(Name = "schedules", IsRequired = true, EmitDefaultValue = false)]
