...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityCurveDependencyAllOf : IEquatable<EquityCurveDependencyAllOf>
    {
        /// <summary>
        ...
        public EquityCurveDependencyAllOf(string marketIdentifier = default(string), string code = default(string), string curveType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum))
        {
            ...
            this.MarketIdentifier = marketIdentifier ?? throw new ArgumentNullException("marketIdentifier is a required property for EquityCurveDependencyAllOf and cannot be null");
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for EquityCurveDependencyAllOf and cannot be null");
            // to ensure "curveType" is required (not null)
            this.CurveType = curveType ?? throw new ArgumentNullException("curveType is a required property for EquityCurveDependencyAllOf and cannot be null");
            this.Date = date;
        ...
        [DataMember(Name = "curveType", IsRequired = true, EmitDefaultValue = false)]
