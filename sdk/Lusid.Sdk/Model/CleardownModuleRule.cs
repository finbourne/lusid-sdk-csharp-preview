...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CleardownModuleRule : IEquatable<CleardownModuleRule>
    {
        /// <summary>
        ...
        public CleardownModuleRule(string ruleId = default(string), string generalLedgerAccountCode = default(string), string ruleFilter = default(string))
        {
            ...
            this.RuleId = ruleId ?? throw new ArgumentNullException("ruleId is a required property for CleardownModuleRule and cannot be null");
            // to ensure "generalLedgerAccountCode" is required (not null)
            this.GeneralLedgerAccountCode = generalLedgerAccountCode ?? throw new ArgumentNullException("generalLedgerAccountCode is a required property for CleardownModuleRule and cannot be null");
            // to ensure "ruleFilter" is required (not null)
            this.RuleFilter = ruleFilter ?? throw new ArgumentNullException("ruleFilter is a required property for CleardownModuleRule and cannot be null");
        }
        ...
        [DataMember(Name = "generalLedgerAccountCode", IsRequired = true, EmitDefaultValue = false)]
