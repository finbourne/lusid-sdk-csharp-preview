...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfQueryableKey : IEquatable<ResourceListOfQueryableKey>
    {
        /// <summary>
        ...
        public ResourceListOfQueryableKey(List<QueryableKey> values = default(List<QueryableKey>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfQueryableKey and cannot be null");
            this.Href = href;
            this.Links = links;
