...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ChartOfAccountsRequest : IEquatable<ChartOfAccountsRequest>
    {
        /// <summary>
        ...
        public ChartOfAccountsRequest(string code = default(string), string displayName = default(string), string description = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for ChartOfAccountsRequest and cannot be null");
