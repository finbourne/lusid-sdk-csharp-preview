...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PropertyValueIn : MatchCriterion, IEquatable<PropertyValueIn>
    {
        /// <summary>
        ...
        /// <param name="criterionType">The available values are: PropertyValueEquals, PropertyValueIn (required) (default to &quot;PropertyValueIn&quot;).</param>
        public PropertyValueIn(string propertyKey = default(string), List<string> value = default(List<string>), CriterionTypeEnum criterionType = default(CriterionTypeEnum)) : base(criterionType)
        {
            ...
            this.PropertyKey = propertyKey ?? throw new ArgumentNullException("propertyKey is a required property for PropertyValueIn and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for PropertyValueIn and cannot be null");
        }
