...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfQuoteAccessMetadataRule :  IEquatable<ResourceListOfQuoteAccessMetadataRule>
    {
        /// <summary>
        ...
        public ResourceListOfQuoteAccessMetadataRule(List<QuoteAccessMetadataRule> values = default(List<QuoteAccessMetadataRule>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfQuoteAccessMetadataRule and cannot be null");
            }
            else
            {
                this.Values = values;
