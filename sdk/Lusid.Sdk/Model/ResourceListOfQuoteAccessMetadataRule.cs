...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfQuoteAccessMetadataRule :  IEquatable<ResourceListOfQuoteAccessMetadataRule>
    {
        ...
        public ResourceListOfQuoteAccessMetadataRule(List<QuoteAccessMetadataRule> values = default(List<QuoteAccessMetadataRule>), string href = default(string), List<Link> links = default(List<Link>))
        {
