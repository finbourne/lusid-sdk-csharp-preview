...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfChartOfAccounts")]
    public partial class PagedResourceListOfChartOfAccounts : IEquatable<PagedResourceListOfChartOfAccounts>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfChartOfAccounts" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfChartOfAccounts() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfChartOfAccounts" /> class.
        /// </summary>
        ...
        public PagedResourceListOfChartOfAccounts(string nextPage = default(string), string previousPage = default(string), List<ChartOfAccounts> values = default(List<ChartOfAccounts>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfChartOfAccounts and cannot be null");
        ...
        public List<ChartOfAccounts> Values { get; set; }
        ...
        {
            return this.Equals(input as PagedResourceListOfChartOfAccounts);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfChartOfAccounts instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfChartOfAccounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfChartOfAccounts input)
        {
            if (input == null)
                return false;
