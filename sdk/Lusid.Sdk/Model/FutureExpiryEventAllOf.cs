...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FutureExpiryEventAllOf : IEquatable<FutureExpiryEventAllOf>
    {
        /// <summary>
        ...
        public FutureExpiryEventAllOf(DateTimeOffset expiryDate = default(DateTimeOffset), string settlementCurrency = default(string), decimal? notionalAmountPerUnit = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            ...
            this.SettlementCurrency = settlementCurrency ?? throw new ArgumentNullException("settlementCurrency is a required property for FutureExpiryEventAllOf and cannot be null");
