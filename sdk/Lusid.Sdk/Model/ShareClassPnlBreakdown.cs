...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ShareClassPnlBreakdown : IEquatable<ShareClassPnlBreakdown>
    {
        /// <summary>
        ...
        public ShareClassPnlBreakdown(Dictionary<string, ShareClassAmount> apportionedNonClassSpecificPnl = default(Dictionary<string, ShareClassAmount>), Dictionary<string, ShareClassAmount> classPnl = default(Dictionary<string, ShareClassAmount>), Dictionary<string, ShareClassAmount> totalPnl = default(Dictionary<string, ShareClassAmount>))
        {
            ...
            this.ApportionedNonClassSpecificPnl = apportionedNonClassSpecificPnl ?? throw new ArgumentNullException("apportionedNonClassSpecificPnl is a required property for ShareClassPnlBreakdown and cannot be null");
            // to ensure "classPnl" is required (not null)
            this.ClassPnl = classPnl ?? throw new ArgumentNullException("classPnl is a required property for ShareClassPnlBreakdown and cannot be null");
            // to ensure "totalPnl" is required (not null)
            this.TotalPnl = totalPnl ?? throw new ArgumentNullException("totalPnl is a required property for ShareClassPnlBreakdown and cannot be null");
        }
        ...
        [DataMember(Name = "apportionedNonClassSpecificPnl", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "classPnl", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "totalPnl", IsRequired = true, EmitDefaultValue = false)]
