...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertPersonsResponse : IEquatable<UpsertPersonsResponse>
    {
        /// <summary>
        ...
        public UpsertPersonsResponse(Dictionary<string, Person> values = default(Dictionary<string, Person>), Dictionary<string, ErrorDetail> failed = default(Dictionary<string, ErrorDetail>), DateTimeOffset asAtDate = default(DateTimeOffset), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for UpsertPersonsResponse and cannot be null");
            // to ensure "failed" is required (not null)
            this.Failed = failed ?? throw new ArgumentNullException("failed is a required property for UpsertPersonsResponse and cannot be null");
