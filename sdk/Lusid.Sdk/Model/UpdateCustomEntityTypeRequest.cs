...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpdateCustomEntityTypeRequest : IEquatable<UpdateCustomEntityTypeRequest>
    {
        /// <summary>
        ...
        public UpdateCustomEntityTypeRequest(string displayName = default(string), string description = default(string), List<CustomEntityFieldDefinition> fieldSchema = default(List<CustomEntityFieldDefinition>))
        {
            ...
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for UpdateCustomEntityTypeRequest and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for UpdateCustomEntityTypeRequest and cannot be null");
            // to ensure "fieldSchema" is required (not null)
            this.FieldSchema = fieldSchema ?? throw new ArgumentNullException("fieldSchema is a required property for UpdateCustomEntityTypeRequest and cannot be null");
        }
