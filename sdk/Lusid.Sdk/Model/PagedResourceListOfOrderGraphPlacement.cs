...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfOrderGraphPlacement : IEquatable<PagedResourceListOfOrderGraphPlacement>
    {
        /// <summary>
        ...
        public PagedResourceListOfOrderGraphPlacement(string nextPage = default(string), string previousPage = default(string), List<OrderGraphPlacement> values = default(List<OrderGraphPlacement>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfOrderGraphPlacement and cannot be null");
