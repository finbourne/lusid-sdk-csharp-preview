...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CdsIndex : LusidInstrument,  IEquatable<CdsIndex>
    {
        ...
        public CdsIndex(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), CdsFlowConventions flowConventions = default(CdsFlowConventions), decimal? couponRate = default(decimal?), Dictionary<string, string> identifiers = default(Dictionary<string, string>), Basket basket = default(Basket), FlowConventionName conventionName = default(FlowConventionName), decimal? notional = default(decimal?), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for CdsIndex and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for CdsIndex and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("flowConventions is a required property for CdsIndex and cannot be null");
            }
            else
            {
            ...
            if (couponRate == null)
            {
                throw new InvalidDataException("couponRate is a required property for CdsIndex and cannot be null");
            }
            else
            {
            ...
            if (identifiers == null)
            {
                throw new InvalidDataException("identifiers is a required property for CdsIndex and cannot be null");
            }
            else
            {
            ...
            if (basket == null)
            {
                throw new InvalidDataException("basket is a required property for CdsIndex and cannot be null");
            }
            else
            {
                this.Basket = basket;
            ...
            {
                throw new InvalidDataException("conventionName is a required property for CdsIndex and cannot be null");
            }
            else
            {
            ...
            if (notional == null)
            {
                throw new InvalidDataException("notional is a required property for CdsIndex and cannot be null");
            }
            else
            {
