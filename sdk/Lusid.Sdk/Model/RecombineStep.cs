...
namespace Lusid.Sdk.Model
{
    ...
    public partial class RecombineStep : IEquatable<RecombineStep>
    {
        /// <summary>
        ...
        public RecombineStep(string label = default(string), Dictionary<string, List<ComplianceTemplateParameter>> groupedParameters = default(Dictionary<string, List<ComplianceTemplateParameter>>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum))
        {
            // to ensure "label" is required (not null)
            this.Label = label ?? throw new ArgumentNullException("label is a required property for RecombineStep and cannot be null");
            // to ensure "groupedParameters" is required (not null)
            this.GroupedParameters = groupedParameters ?? throw new ArgumentNullException("groupedParameters is a required property for RecombineStep and cannot be null");
