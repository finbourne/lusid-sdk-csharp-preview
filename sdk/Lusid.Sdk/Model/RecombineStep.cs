...
namespace Lusid.Sdk.Model
{
    ...
    public partial class RecombineStep : ComplianceStep, IEquatable<RecombineStep>
    {
        /// <summary>
        ...
        /// <param name="complianceStepType">. The available values are: FilterStep, GroupByStep, GroupFilterStep, BranchStep, RecombineStep, CheckStep, PercentCheckStep (required) (default to &quot;RecombineStep&quot;).</param>
        public RecombineStep(string label = default(string), List<ComplianceTemplateParameter> parameters = default(List<ComplianceTemplateParameter>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum)) : base(complianceStepType)
        {
            ...
            this.Parameters = parameters ?? throw new ArgumentNullException("parameters is a required property for RecombineStep and cannot be null");
        }
