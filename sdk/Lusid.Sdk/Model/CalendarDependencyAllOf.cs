...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CalendarDependencyAllOf : IEquatable<CalendarDependencyAllOf>
    {
        /// <summary>
        ...
        public CalendarDependencyAllOf(List<string> calendars = default(List<string>), DependencyTypeEnum dependencyType = default(DependencyTypeEnum))
        {
            ...
            this.Calendars = calendars ?? throw new ArgumentNullException("calendars is a required property for CalendarDependencyAllOf and cannot be null");
        ...
        [DataMember(Name = "calendars", IsRequired = true, EmitDefaultValue = false)]
