...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfFundConfiguration : IEquatable<PagedResourceListOfFundConfiguration>
    {
        /// <summary>
        ...
        public PagedResourceListOfFundConfiguration(string nextPage = default(string), string previousPage = default(string), List<FundConfiguration> values = default(List<FundConfiguration>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfFundConfiguration and cannot be null");
