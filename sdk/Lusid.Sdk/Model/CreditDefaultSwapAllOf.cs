...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreditDefaultSwapAllOf : IEquatable<CreditDefaultSwapAllOf>
    {
        ...
        public CreditDefaultSwapAllOf(string ticker = default(string), DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), CdsFlowConventions flowConventions = default(CdsFlowConventions), decimal couponRate = default(decimal), FlowConventionName conventionName = default(FlowConventionName), decimal? notional = default(decimal?), CdsProtectionDetailSpecification protectionDetailSpecification = default(CdsProtectionDetailSpecification), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.Ticker = ticker ?? throw new ArgumentNullException("ticker is a required property for CreditDefaultSwapAllOf and cannot be null");
            this.StartDate = startDate;
            this.MaturityDate = maturityDate;
            this.CouponRate = couponRate;
            // to ensure "protectionDetailSpecification" is required (not null)
            this.ProtectionDetailSpecification = protectionDetailSpecification ?? throw new ArgumentNullException("protectionDetailSpecification is a required property for CreditDefaultSwapAllOf and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "protectionDetailSpecification", IsRequired = true, EmitDefaultValue = false)]
