...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreditDefaultSwapAllOf :  IEquatable<CreditDefaultSwapAllOf>
    {
        /// <summary>
        ...
        public CreditDefaultSwapAllOf(string ticker = default(string), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), CdsFlowConventions flowConventions = default(CdsFlowConventions), decimal? couponRate = default(decimal?), CdsProtectionDetailSpecification protectionDetailSpecification = default(CdsProtectionDetailSpecification), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            // to ensure "ticker" is required (not null)
            if (ticker == null)
            {
                throw new InvalidDataException("ticker is a required property for CreditDefaultSwapAllOf and cannot be null");
            }
            else
            {
                this.Ticker = ticker;
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for CreditDefaultSwapAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for CreditDefaultSwapAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("flowConventions is a required property for CreditDefaultSwapAllOf and cannot be null");
            }
            else
            {
            ...
            if (couponRate == null)
            {
                throw new InvalidDataException("couponRate is a required property for CreditDefaultSwapAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("protectionDetailSpecification is a required property for CreditDefaultSwapAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instrumentType is a required property for CreditDefaultSwapAllOf and cannot be null");
            }
            else
            {
