...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FundConfigurationProperties")]
    public partial class FundConfigurationProperties : IEquatable<FundConfigurationProperties>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundConfigurationProperties" /> class.
        /// </summary>
        /// <param name="href">The specific Uniform Resource Identifier (URI) for this resource at the requested effective and asAt datetime..</param>
        /// <param name="properties">The Fund Configuration properties. These will be from the &#39;FundConfiguration&#39; domain..</param>
        /// <param name="version">version.</param>
        /// <param name="links">Collection of links..</param>
        public FundConfigurationProperties(string href = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            this.Href = href;
        ...
        /// <summary>
        /// The Fund Configuration properties. These will be from the &#39;FundConfiguration&#39; domain.
        /// </summary>
        /// <value>The Fund Configuration properties. These will be from the &#39;FundConfiguration&#39; domain.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FundConfigurationProperties {\n");
        ...
        {
            return this.Equals(input as FundConfigurationProperties);
        }

        /// <summary>
        /// Returns true if FundConfigurationProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of FundConfigurationProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FundConfigurationProperties input)
        {
            if (input == null)
                return false;
