...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfEntityChangeItem : IEquatable<ResourceListOfEntityChangeItem>
    {
        /// <summary>
        ...
        public ResourceListOfEntityChangeItem(List<EntityChangeItem> values = default(List<EntityChangeItem>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfEntityChangeItem and cannot be null");
            this.Href = href;
            this.Links = links;
