...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateComplianceTemplateRequest : IEquatable<CreateComplianceTemplateRequest>
    {
        /// <summary>
        ...
        public CreateComplianceTemplateRequest(string code = default(string), string description = default(string), List<ComplianceTemplateVariationRequest> variations = default(List<ComplianceTemplateVariationRequest>))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for CreateComplianceTemplateRequest and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for CreateComplianceTemplateRequest and cannot be null");
            // to ensure "variations" is required (not null)
            this.Variations = variations ?? throw new ArgumentNullException("variations is a required property for CreateComplianceTemplateRequest and cannot be null");
        }
