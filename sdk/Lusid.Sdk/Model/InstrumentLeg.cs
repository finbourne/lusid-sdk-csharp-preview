...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentLeg : LusidInstrument,  IEquatable<InstrumentLeg>
    {
        ...
        public InstrumentLeg(decimal? notional = default(decimal?), DateTimeOffset? maturityDate = default(DateTimeOffset?), DateTimeOffset? startDate = default(DateTimeOffset?), LegDefinition legDefinition = default(LegDefinition), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
