...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InstrumentLeg :  IEquatable<InstrumentLeg>, IValidatableObject
    {
        /// <summary>
        ...
        public InstrumentLeg(FlowConventions conventions = default(FlowConventions), bool isPayNotReceive = default(bool), bool isFloatNotFixed = default(bool), decimal fixedRate = default(decimal))
        {
            ...
            this.Conventions = conventions ?? throw new ArgumentNullException("conventions is a required property for InstrumentLeg and cannot be null");;
