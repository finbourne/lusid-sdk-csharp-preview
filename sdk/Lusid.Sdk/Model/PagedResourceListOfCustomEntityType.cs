...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfCustomEntityType : IEquatable<PagedResourceListOfCustomEntityType>
    {
        /// <summary>
        ...
        public PagedResourceListOfCustomEntityType(string nextPage = default(string), string previousPage = default(string), List<CustomEntityType> values = default(List<CustomEntityType>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfCustomEntityType and cannot be null");
