...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DeletedEntityResponse :  IEquatable<DeletedEntityResponse>
    {
        ...
        /// <param name="effectiveFrom">The effective datetime at which the deletion became valid. Only applies when a single entity is being interacted with..</param>
        ...
        public DeletedEntityResponse(string href = default(string), DateTimeOffset? effectiveFrom = default(DateTimeOffset?), DateTimeOffset? asAt = default(DateTimeOffset?), List<Link> links = default(List<Link>))
        {
            ...
            if (asAt == null)
            {
                throw new InvalidDataException("asAt is a required property for DeletedEntityResponse and cannot be null");
            }
            else
            {
                this.AsAt = asAt;
        ...
        /// <summary>
        /// The effective datetime at which the deletion became valid. Only applies when a single entity is being interacted with.
        /// </summary>
        /// <value>The effective datetime at which the deletion became valid. Only applies when a single entity is being interacted with.</value>
