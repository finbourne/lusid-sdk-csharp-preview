...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfApplicableInstrumentEvent : IEquatable<ResourceListOfApplicableInstrumentEvent>
    {
        /// <summary>
        ...
        public ResourceListOfApplicableInstrumentEvent(List<ApplicableInstrumentEvent> values = default(List<ApplicableInstrumentEvent>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfApplicableInstrumentEvent and cannot be null");
            this.Href = href;
            this.Links = links;
