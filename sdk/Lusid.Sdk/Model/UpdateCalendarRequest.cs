...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpdateCalendarRequest : IEquatable<UpdateCalendarRequest>
    {
        ...
        public UpdateCalendarRequest(WeekendMask weekendMask = default(WeekendMask), string sourceProvider = default(string), List<Property> properties = default(List<Property>))
        {
            ...
            this.WeekendMask = weekendMask ?? throw new ArgumentNullException("weekendMask is a required property for UpdateCalendarRequest and cannot be null");
            // to ensure "sourceProvider" is required (not null)
            this.SourceProvider = sourceProvider ?? throw new ArgumentNullException("sourceProvider is a required property for UpdateCalendarRequest and cannot be null");
            // to ensure "properties" is required (not null)
            this.Properties = properties ?? throw new ArgumentNullException("properties is a required property for UpdateCalendarRequest and cannot be null");
        }
