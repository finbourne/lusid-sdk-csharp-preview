...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfCorporateAction :  IEquatable<ResourceListOfCorporateAction>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfCorporateAction(List<CorporateAction> values = default(List<CorporateAction>), string href = default(string), List<Link> links = default(List<Link>))
        {
