...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfCorporateAction :  IEquatable<ResourceListOfCorporateAction>
    {
        ...
        public ResourceListOfCorporateAction(List<CorporateAction> values = default(List<CorporateAction>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
