...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfCorporateAction :  IEquatable<ResourceListOfCorporateAction>
    {
        ...
        public ResourceListOfCorporateAction(List<CorporateAction> values = default(List<CorporateAction>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
