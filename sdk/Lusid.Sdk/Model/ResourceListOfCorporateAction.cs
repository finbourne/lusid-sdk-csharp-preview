...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfCorporateAction")]
    public partial class ResourceListOfCorporateAction : IEquatable<ResourceListOfCorporateAction>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfCorporateAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfCorporateAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfCorporateAction" /> class.
        /// </summary>
        ...
        public ResourceListOfCorporateAction(List<CorporateAction> values = default(List<CorporateAction>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfCorporateAction and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfCorporateAction {\n");
        ...
        {
            return this.Equals(input as ResourceListOfCorporateAction);
        }

        /// <summary>
        /// Returns true if ResourceListOfCorporateAction instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfCorporateAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfCorporateAction input)
        {
            if (input == null)
                return false;
