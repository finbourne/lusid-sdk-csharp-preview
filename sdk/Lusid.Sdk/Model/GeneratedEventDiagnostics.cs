...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GeneratedEventDiagnostics : IEquatable<GeneratedEventDiagnostics>
    {
        /// <summary>
        ...
        public GeneratedEventDiagnostics(string instrumentEventId = default(string), string type = default(string), string detail = default(string), List<string> errorDetails = default(List<string>))
        {
            ...
            this.InstrumentEventId = instrumentEventId ?? throw new ArgumentNullException("instrumentEventId is a required property for GeneratedEventDiagnostics and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for GeneratedEventDiagnostics and cannot be null");
            // to ensure "detail" is required (not null)
            this.Detail = detail ?? throw new ArgumentNullException("detail is a required property for GeneratedEventDiagnostics and cannot be null");
            // to ensure "errorDetails" is required (not null)
            this.ErrorDetails = errorDetails ?? throw new ArgumentNullException("errorDetails is a required property for GeneratedEventDiagnostics and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "errorDetails", IsRequired = true, EmitDefaultValue = false)]
