...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResultValueDateTimeOffset_allOf")]
    public partial class ResultValueDateTimeOffsetAllOf : IEquatable<ResultValueDateTimeOffsetAllOf>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The available values are: ResultValue, ResultValueDictionary, ResultValue0D, ResultValueDecimal, ResultValueInt, ResultValueString, CashFlowValue, CashFlowValueSet, ResultValueLifeCycleEventValue, ResultValueDateTimeOffset</value>
        ...
        /// </summary>
        /// <value>The available values are: ResultValue, ResultValueDictionary, ResultValue0D, ResultValueDecimal, ResultValueInt, ResultValueString, CashFlowValue, CashFlowValueSet, ResultValueLifeCycleEventValue, ResultValueDateTimeOffset</value>
        [DataMember(Name = "resultValueType", IsRequired = true, EmitDefaultValue = false)]
        public ResultValueTypeEnum ResultValueType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultValueDateTimeOffsetAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResultValueDateTimeOffsetAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultValueDateTimeOffsetAllOf" /> class.
        /// </summary>
        ...
        /// <param name="resultValueType">The available values are: ResultValue, ResultValueDictionary, ResultValue0D, ResultValueDecimal, ResultValueInt, ResultValueString, CashFlowValue, CashFlowValueSet, ResultValueLifeCycleEventValue, ResultValueDateTimeOffset (required).</param>
        public ResultValueDateTimeOffsetAllOf(DateTimeOffset value = default(DateTimeOffset), int? dimension = default(int?), ResultValueTypeEnum resultValueType = default(ResultValueTypeEnum))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResultValueDateTimeOffsetAllOf {\n");
        ...
        {
            return this.Equals(input as ResultValueDateTimeOffsetAllOf);
        }

        /// <summary>
        /// Returns true if ResultValueDateTimeOffsetAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ResultValueDateTimeOffsetAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResultValueDateTimeOffsetAllOf input)
        {
            if (input == null)
                return false;
