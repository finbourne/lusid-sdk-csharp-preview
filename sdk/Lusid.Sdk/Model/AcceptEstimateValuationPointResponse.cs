...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AcceptEstimateValuationPointResponse : IEquatable<AcceptEstimateValuationPointResponse>
    {
        /// <summary>
        ...
        public AcceptEstimateValuationPointResponse(string href = default(string), ValuationPointDataResponse candidateValuationPoint = default(ValuationPointDataResponse), ValuationPointDataResponse latestValuationPoint = default(ValuationPointDataResponse), List<Link> links = default(List<Link>))
        {
            ...
            this.CandidateValuationPoint = candidateValuationPoint ?? throw new ArgumentNullException("candidateValuationPoint is a required property for AcceptEstimateValuationPointResponse and cannot be null");
            this.Href = href;
        ...
        /// </summary>
        [DataMember(Name = "candidateValuationPoint", IsRequired = true, EmitDefaultValue = false)]
