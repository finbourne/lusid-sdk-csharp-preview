...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OrderGraphBlockPlacementSynopsis : IEquatable<OrderGraphBlockPlacementSynopsis>
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="OrderGraphBlockPlacementSynopsis" /> class.
        /// </summary>
        /// <param name="states">List of placement states of all the placements on this block. (required).</param>
        ...
        public OrderGraphBlockPlacementSynopsis(string states = default(string), decimal quantity = default(decimal), List<OrderGraphBlockPlacementDetail> details = default(List<OrderGraphBlockPlacementDetail>))
        {
            // to ensure "states" is required (not null)
            this.States = states ?? throw new ArgumentNullException("states is a required property for OrderGraphBlockPlacementSynopsis and cannot be null");
            this.Quantity = quantity;
            // to ensure "details" is required (not null)
            this.Details = details ?? throw new ArgumentNullException("details is a required property for OrderGraphBlockPlacementSynopsis and cannot be null");
        }

        /// <summary>
        /// List of placement states of all the placements on this block.
        /// </summary>
        /// <value>List of placement states of all the placements on this block.</value>
