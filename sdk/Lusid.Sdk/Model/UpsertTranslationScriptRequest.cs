...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertTranslationScriptRequest : IEquatable<UpsertTranslationScriptRequest>
    {
        /// <summary>
        ...
        public UpsertTranslationScriptRequest(TranslationScriptId id = default(TranslationScriptId), string body = default(string))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for UpsertTranslationScriptRequest and cannot be null");
            // to ensure "body" is required (not null)
            this.Body = body ?? throw new ArgumentNullException("body is a required property for UpsertTranslationScriptRequest and cannot be null");
        }
