...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PropertyValueInAllOf : IEquatable<PropertyValueInAllOf>
    {
        /// <summary>
        ...
        public PropertyValueInAllOf(string propertyKey = default(string), List<string> value = default(List<string>), CriterionTypeEnum criterionType = default(CriterionTypeEnum))
        {
            ...
            this.PropertyKey = propertyKey ?? throw new ArgumentNullException("propertyKey is a required property for PropertyValueInAllOf and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for PropertyValueInAllOf and cannot be null");
