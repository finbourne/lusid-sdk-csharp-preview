...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfFeeRule")]
    public partial class ResourceListOfFeeRule : IEquatable<ResourceListOfFeeRule>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfFeeRule" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfFeeRule() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfFeeRule" /> class.
        /// </summary>
        ...
        public ResourceListOfFeeRule(List<FeeRule> values = default(List<FeeRule>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfFeeRule and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<FeeRule> Values { get; set; }
        ...
        {
            return this.Equals(input as ResourceListOfFeeRule);
        }

        /// <summary>
        /// Returns true if ResourceListOfFeeRule instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfFeeRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfFeeRule input)
        {
            if (input == null)
                return false;
