...
namespace Lusid.Sdk.Model
{
    ...
    public partial class StagingRule : IEquatable<StagingRule>
    {
        /// <summary>
        ...
        public StagingRule(string ruleId = default(string), string description = default(string), string status = default(string), StagingRuleMatchCriteria matchCriteria = default(StagingRuleMatchCriteria), StagingRuleApprovalCriteria approvalCriteria = default(StagingRuleApprovalCriteria))
        {
            ...
            this.RuleId = ruleId ?? throw new ArgumentNullException("ruleId is a required property for StagingRule and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for StagingRule and cannot be null");
            // to ensure "matchCriteria" is required (not null)
            this.MatchCriteria = matchCriteria ?? throw new ArgumentNullException("matchCriteria is a required property for StagingRule and cannot be null");
            // to ensure "approvalCriteria" is required (not null)
            this.ApprovalCriteria = approvalCriteria ?? throw new ArgumentNullException("approvalCriteria is a required property for StagingRule and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "matchCriteria", IsRequired = true, EmitDefaultValue = false)]
        public StagingRuleMatchCriteria MatchCriteria { get; set; }

        /// <summary>
        /// Gets or Sets ApprovalCriteria
        /// </summary>
        [DataMember(Name = "approvalCriteria", IsRequired = true, EmitDefaultValue = false)]
