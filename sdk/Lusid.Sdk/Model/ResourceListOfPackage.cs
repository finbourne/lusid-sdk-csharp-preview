...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfPackage")]
    public partial class ResourceListOfPackage : IEquatable<ResourceListOfPackage>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfPackage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfPackage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfPackage" /> class.
        /// </summary>
        ...
        public ResourceListOfPackage(List<Package> values = default(List<Package>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfPackage and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfPackage {\n");
        ...
        {
            return this.Equals(input as ResourceListOfPackage);
        }

        /// <summary>
        /// Returns true if ResourceListOfPackage instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfPackage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfPackage input)
        {
            if (input == null)
                return false;
