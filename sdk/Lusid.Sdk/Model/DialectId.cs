...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DialectId : IEquatable<DialectId>
    {
        /// <summary>
        ...
        public DialectId(string scope = default(string), string vendor = default(string), string sourceSystem = default(string), string version = default(string), string serialisationFormat = default(string), string entityType = default(string))
        {
            ...
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for DialectId and cannot be null");
            // to ensure "vendor" is required (not null)
            this.Vendor = vendor ?? throw new ArgumentNullException("vendor is a required property for DialectId and cannot be null");
            // to ensure "sourceSystem" is required (not null)
            this.SourceSystem = sourceSystem ?? throw new ArgumentNullException("sourceSystem is a required property for DialectId and cannot be null");
            // to ensure "version" is required (not null)
            this.Version = version ?? throw new ArgumentNullException("version is a required property for DialectId and cannot be null");
            // to ensure "serialisationFormat" is required (not null)
            this.SerialisationFormat = serialisationFormat ?? throw new ArgumentNullException("serialisationFormat is a required property for DialectId and cannot be null");
            // to ensure "entityType" is required (not null)
            this.EntityType = entityType ?? throw new ArgumentNullException("entityType is a required property for DialectId and cannot be null");
        }
        ...
        [DataMember(Name = "serialisationFormat", IsRequired = true, EmitDefaultValue = false)]
