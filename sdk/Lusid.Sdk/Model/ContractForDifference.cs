...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ContractForDifference : LusidInstrument,  IEquatable<ContractForDifference>
    {
        ...
        /// <param name="referenceRate">The reference rate of the CFD, this can be set to 0 but not negative values. (required).</param>
        ...
        public ContractForDifference(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), string code = default(string), string payCcy = default(string), decimal? referenceRate = default(decimal?), string underlyingCcy = default(string), string underlyingIdentifier = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for ContractForDifference and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The reference rate of the CFD, this can be set to 0 but not negative values.</value>
