...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ContractForDifference : LusidInstrument,  IEquatable<ContractForDifference>
    {
        ...
        /// <param name="referenceDate">The reference date of the CFD. (required).</param>
        /// <param name="referenceRate">The reference rate of the CFD. (required).</param>
        ...
        public ContractForDifference(DateTimeOffset? startDate = default(DateTimeOffset?), string code = default(string), string payCcy = default(string), DateTimeOffset? referenceDate = default(DateTimeOffset?), decimal? referenceRate = default(decimal?), string underlyingCcy = default(string), string underlyingIdentifier = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            // to ensure "referenceDate" is required (not null)
            if (referenceDate == null)
            {
                throw new InvalidDataException("referenceDate is a required property for ContractForDifference and cannot be null");
            }
            else
            {
            ...
            // to ensure "referenceRate" is required (not null)
            if (referenceRate == null)
            {
                throw new InvalidDataException("referenceRate is a required property for ContractForDifference and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="payCcy", EmitDefaultValue=false)]
        public string PayCcy { get; set; }

        /// <summary>
        /// The reference date of the CFD.
        /// </summary>
        /// <value>The reference date of the CFD.</value>
        ...
        /// </summary>
        /// <value>The reference rate of the CFD.</value>
        ...
        [DataMember(Name="underlyingCcy", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>external market codes and identifiers for the CFD, e.g. RIC.  Supported string (enumeration) values are: [LusidInstrumentId, Isin, Sedol, Cusip, ClientInternal, Figi, RIC, QuotePermId].</value>
