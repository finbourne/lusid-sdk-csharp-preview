...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfCalendar :  IEquatable<PagedResourceListOfCalendar>
    {
        ...
        public PagedResourceListOfCalendar(List<Calendar> values = default(List<Calendar>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for PagedResourceListOfCalendar and cannot be null");
            }
            else
            {
                this.Values = values;
