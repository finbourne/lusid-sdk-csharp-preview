...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfFee : IEquatable<PagedResourceListOfFee>
    {
        /// <summary>
        ...
        public PagedResourceListOfFee(string nextPage = default(string), string previousPage = default(string), List<Fee> values = default(List<Fee>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfFee and cannot be null");
