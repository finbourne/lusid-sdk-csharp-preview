...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfTranslationScriptId : IEquatable<PagedResourceListOfTranslationScriptId>
    {
        /// <summary>
        ...
        public PagedResourceListOfTranslationScriptId(string nextPage = default(string), string previousPage = default(string), List<TranslationScriptId> values = default(List<TranslationScriptId>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfTranslationScriptId and cannot be null");
