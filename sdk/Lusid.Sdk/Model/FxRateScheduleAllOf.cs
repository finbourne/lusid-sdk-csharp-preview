...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxRateScheduleAllOf : IEquatable<FxRateScheduleAllOf>
    {
        /// <summary>
        ...
        public FxRateScheduleAllOf(int fixingLag = default(int), List<string> fxConversionTypes = default(List<string>), decimal rate = default(decimal), string toCurrency = default(string), ScheduleTypeEnum scheduleType = default(ScheduleTypeEnum))
        {
