...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Quote :  IEquatable<Quote>
    {
        ...
        public Quote(QuoteId quoteId = default(QuoteId), MetricValue metricValue = default(MetricValue), string lineage = default(string), string uploadedBy = default(string), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
