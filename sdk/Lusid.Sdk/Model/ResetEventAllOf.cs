...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResetEventAllOf : IEquatable<ResetEventAllOf>
    {
        /// <summary>
        ...
        public ResetEventAllOf(decimal? value = default(decimal?), string resetType = default(string), string fixingSource = default(string), string eventStatus = default(string), DateTimeOffset fixingDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            ...
            this.ResetType = resetType ?? throw new ArgumentNullException("resetType is a required property for ResetEventAllOf and cannot be null");
            // to ensure "eventStatus" is required (not null)
            this.EventStatus = eventStatus ?? throw new ArgumentNullException("eventStatus is a required property for ResetEventAllOf and cannot be null");
