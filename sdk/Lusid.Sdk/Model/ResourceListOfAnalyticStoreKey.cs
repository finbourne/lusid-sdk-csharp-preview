...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfAnalyticStoreKey :  IEquatable<ResourceListOfAnalyticStoreKey>
    {
        ...
        public ResourceListOfAnalyticStoreKey(List<AnalyticStoreKey> values = default(List<AnalyticStoreKey>), string href = default(string), List<Link> links = default(List<Link>))
        {
