...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfAnalyticStoreKey :  IEquatable<ResourceListOfAnalyticStoreKey>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfAnalyticStoreKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfAnalyticStoreKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfAnalyticStoreKey" /> class.
        /// </summary>
        ...
        public ResourceListOfAnalyticStoreKey(List<AnalyticStoreKey> values = default(List<AnalyticStoreKey>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfAnalyticStoreKey and cannot be null");
            }
            else
            {
                this.Values = values;
        ...
        public List<AnalyticStoreKey> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfAnalyticStoreKey {\n");
        ...
        {
            return this.Equals(input as ResourceListOfAnalyticStoreKey);
        }

        /// <summary>
        /// Returns true if ResourceListOfAnalyticStoreKey instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfAnalyticStoreKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfAnalyticStoreKey input)
        {
            if (input == null)
                return false;
