...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfGetCounterpartyResponse")]
    public partial class ResourceListOfGetCounterpartyResponse : IEquatable<ResourceListOfGetCounterpartyResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfGetCounterpartyResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfGetCounterpartyResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfGetCounterpartyResponse" /> class.
        /// </summary>
        ...
        public ResourceListOfGetCounterpartyResponse(List<GetCounterpartyResponse> values = default(List<GetCounterpartyResponse>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfGetCounterpartyResponse and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<GetCounterpartyResponse> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfGetCounterpartyResponse {\n");
        ...
        {
            return this.Equals(input as ResourceListOfGetCounterpartyResponse);
        }

        /// <summary>
        /// Returns true if ResourceListOfGetCounterpartyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfGetCounterpartyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfGetCounterpartyResponse input)
        {
            if (input == null)
                return false;
