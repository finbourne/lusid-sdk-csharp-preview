...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SecurityElection : IEquatable<SecurityElection>
    {
        /// <summary>
        ...
        public SecurityElection(string electionKey = default(string), bool isChosen = default(bool), bool isDefault = default(bool), decimal price = default(decimal), UnitsRatio unitsRatio = default(UnitsRatio))
        {
            ...
            this.ElectionKey = electionKey ?? throw new ArgumentNullException("electionKey is a required property for SecurityElection and cannot be null");
            this.Price = price;
