...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FundingLegAllOf :  IEquatable<FundingLegAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FundingLegAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FundingLegAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FundingLegAllOf" /> class.
        /// </summary>
        ...
        public FundingLegAllOf(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), LegDefinition legDefinition = default(LegDefinition), decimal? notional = default(decimal?), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            // to ensure "startDate" is required (not null)
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for FundingLegAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for FundingLegAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("legDefinition is a required property for FundingLegAllOf and cannot be null");
            }
            else
            {
            ...
            if (notional == null)
            {
                throw new InvalidDataException("notional is a required property for FundingLegAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instrumentType is a required property for FundingLegAllOf and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as FundingLegAllOf);
        }

        /// <summary>
        /// Returns true if FundingLegAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of FundingLegAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FundingLegAllOf input)
        {
            if (input == null)
                return false;
