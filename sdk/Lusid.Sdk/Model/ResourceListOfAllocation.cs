...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfAllocation :  IEquatable<ResourceListOfAllocation>
    {
        ...
        public ResourceListOfAllocation(List<Allocation> values = default(List<Allocation>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
