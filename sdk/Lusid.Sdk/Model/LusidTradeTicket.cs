...
namespace Lusid.Sdk.Model
{
    ...
    public partial class LusidTradeTicket : IEquatable<LusidTradeTicket>
    {
        /// <summary>
        ...
        /// <param name="instrumentProperties">instrumentProperties.</param>
        /// <param name="transactionProperties">transactionProperties.</param>
        ...
        public LusidTradeTicket(string transactionId = default(string), string transactionType = default(string), string source = default(string), string transactionDate = default(string), string settlementDate = default(string), CurrencyAndAmount totalConsideration = default(CurrencyAndAmount), decimal units = default(decimal), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), string instrumentScope = default(string), string instrumentName = default(string), LusidInstrument instrumentDefinition = default(LusidInstrument), ResourceId counterpartyAgreementId = default(ResourceId), List<Property> instrumentProperties = default(List<Property>), List<Property> transactionProperties = default(List<Property>), TradeTicketTypeEnum tradeTicketType = default(TradeTicketTypeEnum))
        {
            ...
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for LusidTradeTicket and cannot be null");
            // to ensure "transactionType" is required (not null)
            this.TransactionType = transactionType ?? throw new ArgumentNullException("transactionType is a required property for LusidTradeTicket and cannot be null");
            // to ensure "transactionDate" is required (not null)
            this.TransactionDate = transactionDate ?? throw new ArgumentNullException("transactionDate is a required property for LusidTradeTicket and cannot be null");
            // to ensure "settlementDate" is required (not null)
            this.SettlementDate = settlementDate ?? throw new ArgumentNullException("settlementDate is a required property for LusidTradeTicket and cannot be null");
            // to ensure "totalConsideration" is required (not null)
            this.TotalConsideration = totalConsideration ?? throw new ArgumentNullException("totalConsideration is a required property for LusidTradeTicket and cannot be null");
            this.Units = units;
            // to ensure "instrumentIdentifiers" is required (not null)
            this.InstrumentIdentifiers = instrumentIdentifiers ?? throw new ArgumentNullException("instrumentIdentifiers is a required property for LusidTradeTicket and cannot be null");
