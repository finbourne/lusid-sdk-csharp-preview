...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResultValueString")]
    [JsonConverter(typeof(JsonSubtypes), "ResultValueType")]
    public partial class ResultValueString : ResultValue, IEquatable<ResultValueString>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultValueString" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResultValueString() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultValueString" /> class.
        /// </summary>
        /// <param name="value">the value itself.</param>
        /// <param name="resultValueType">The available values are: ResultValue, ResultValueDictionary, ResultValue0D, ResultValueDecimal, ResultValueInt, ResultValueString, CashFlowValue, CashFlowValueSet, ResultValueLifeCycleEventValue, ResultValueDateTimeOffset (required) (default to &quot;ResultValueString&quot;).</param>
        public ResultValueString(string value = default(string), ResultValueTypeEnum resultValueType = default(ResultValueTypeEnum)) : base(resultValueType)
        {
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as ResultValueString);
        }

        /// <summary>
        /// Returns true if ResultValueString instances are equal
        /// </summary>
        /// <param name="input">Instance of ResultValueString to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResultValueString input)
        {
            if (input == null)
                return false;
