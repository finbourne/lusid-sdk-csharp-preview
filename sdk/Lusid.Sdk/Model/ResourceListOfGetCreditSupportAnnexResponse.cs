...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfGetCreditSupportAnnexResponse")]
    public partial class ResourceListOfGetCreditSupportAnnexResponse : IEquatable<ResourceListOfGetCreditSupportAnnexResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfGetCreditSupportAnnexResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfGetCreditSupportAnnexResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfGetCreditSupportAnnexResponse" /> class.
        /// </summary>
        ...
        public ResourceListOfGetCreditSupportAnnexResponse(List<GetCreditSupportAnnexResponse> values = default(List<GetCreditSupportAnnexResponse>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfGetCreditSupportAnnexResponse and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<GetCreditSupportAnnexResponse> Values { get; set; }
        ...
        {
            return this.Equals(input as ResourceListOfGetCreditSupportAnnexResponse);
        }

        /// <summary>
        /// Returns true if ResourceListOfGetCreditSupportAnnexResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfGetCreditSupportAnnexResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfGetCreditSupportAnnexResponse input)
        {
            if (input == null)
                return false;
