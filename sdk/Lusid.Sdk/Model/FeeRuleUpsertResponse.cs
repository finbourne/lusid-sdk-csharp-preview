...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FeeRuleUpsertResponse : IEquatable<FeeRuleUpsertResponse>
    {
        /// <summary>
        ...
        public FeeRuleUpsertResponse(Dictionary<string, FeeRule> values = default(Dictionary<string, FeeRule>), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for FeeRuleUpsertResponse and cannot be null");
            this.Links = links;
        }
