...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfCleardownModuleResponse")]
    public partial class PagedResourceListOfCleardownModuleResponse : IEquatable<PagedResourceListOfCleardownModuleResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfCleardownModuleResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfCleardownModuleResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfCleardownModuleResponse" /> class.
        /// </summary>
        ...
        public PagedResourceListOfCleardownModuleResponse(string nextPage = default(string), string previousPage = default(string), List<CleardownModuleResponse> values = default(List<CleardownModuleResponse>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfCleardownModuleResponse and cannot be null");
        ...
        public List<CleardownModuleResponse> Values { get; set; }
        ...
        {
            return this.Equals(input as PagedResourceListOfCleardownModuleResponse);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfCleardownModuleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfCleardownModuleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfCleardownModuleResponse input)
        {
            if (input == null)
                return false;
