...
namespace Lusid.Sdk.Model
{
    ...
    /// CloseEventAllOf
    /// </summary>
    [DataContract(Name = "CloseEvent_allOf")]
    public partial class CloseEventAllOf : IEquatable<CloseEventAllOf>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, RawVendorEvent, InformationalErrorEvent</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CloseEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CloseEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CloseEventAllOf" /> class.
        /// </summary>
        /// <param name="anchorDate">The date on which the instrument closes/matures.</param>
        /// <param name="instrumentEventType">The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, RawVendorEvent, InformationalErrorEvent (required).</param>
        public CloseEventAllOf(DateTimeOffset anchorDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
        ...
        /// <summary>
        /// The date on which the instrument closes/matures
        /// </summary>
        /// <value>The date on which the instrument closes/matures</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CloseEventAllOf {\n");
        ...
        {
            return this.Equals(input as CloseEventAllOf);
        }

        /// <summary>
        /// Returns true if CloseEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CloseEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloseEventAllOf input)
        {
            if (input == null)
                return false;
