...
namespace Lusid.Sdk.Model
{
    ...
    public partial class StepSchedule : IEquatable<StepSchedule>
    {
        /// <summary>
        ...
        /// <param name="scheduleType">What type of schedule does this represent.  Supported string (enumeration) values are: [Fixed, Float, Optionality, Step, Payment, Accrual]. (required).</param>
        ...
        public StepSchedule(string levelType = default(string), string scheduleType = default(string), string stepScheduleType = default(string), List<LevelStep> steps = default(List<LevelStep>))
        {
            // to ensure "levelType" is required (not null)
            this.LevelType = levelType ?? throw new ArgumentNullException("levelType is a required property for StepSchedule and cannot be null");
            // to ensure "scheduleType" is required (not null)
            this.ScheduleType = scheduleType ?? throw new ArgumentNullException("scheduleType is a required property for StepSchedule and cannot be null");
            // to ensure "stepScheduleType" is required (not null)
            this.StepScheduleType = stepScheduleType ?? throw new ArgumentNullException("stepScheduleType is a required property for StepSchedule and cannot be null");
            // to ensure "steps" is required (not null)
            this.Steps = steps ?? throw new ArgumentNullException("steps is a required property for StepSchedule and cannot be null");
        }
        ...
        /// </summary>
        /// <value>What type of schedule does this represent.  Supported string (enumeration) values are: [Fixed, Float, Optionality, Step, Payment, Accrual].</value>
