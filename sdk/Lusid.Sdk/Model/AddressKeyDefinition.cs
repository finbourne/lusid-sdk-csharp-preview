...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AddressKeyDefinition : IEquatable<AddressKeyDefinition>
    {
        /// <summary>
        ...
        public AddressKeyDefinition(string addressKey = default(string), string type = default(string), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            ...
            this.AddressKey = addressKey ?? throw new ArgumentNullException("addressKey is a required property for AddressKeyDefinition and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for AddressKeyDefinition and cannot be null");
