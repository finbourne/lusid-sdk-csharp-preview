...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashFlowValue : ResultValue, IEquatable<CashFlowValue>
    {
        /// <summary>
        ...
        /// <param name="resultValueType">The available values are: ResultValue, ResultValueDictionary, ResultValue0D, ResultValueDecimal, ResultValueInt, ResultValueString, CashFlowValue, CashFlowValueSet (required) (default to &quot;CashFlowValue&quot;).</param>
        public CashFlowValue(DateTimeOffset paymentDate = default(DateTimeOffset), ResultValueDictionary diagnostics = default(ResultValueDictionary), Object cashFlowLineage = default(Object), decimal paymentAmount = default(decimal), string paymentCcy = default(string), ResultValueTypeEnum resultValueType = default(ResultValueTypeEnum)) : base(resultValueType)
        {
            this.PaymentDate = paymentDate;
            this.PaymentAmount = paymentAmount;
            // to ensure "paymentCcy" is required (not null)
            this.PaymentCcy = paymentCcy ?? throw new ArgumentNullException("paymentCcy is a required property for CashFlowValue and cannot be null");
