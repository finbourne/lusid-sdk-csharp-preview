...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfStagingRuleSet : IEquatable<PagedResourceListOfStagingRuleSet>
    {
        /// <summary>
        ...
        public PagedResourceListOfStagingRuleSet(string nextPage = default(string), string previousPage = default(string), List<StagingRuleSet> values = default(List<StagingRuleSet>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfStagingRuleSet and cannot be null");
