...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfExecution")]
    public partial class PagedResourceListOfExecution : IEquatable<PagedResourceListOfExecution>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfExecution" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfExecution() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfExecution" /> class.
        /// </summary>
        ...
        public PagedResourceListOfExecution(string nextPage = default(string), string previousPage = default(string), List<Execution> values = default(List<Execution>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfExecution and cannot be null");
        ...
        {
            return this.Equals(input as PagedResourceListOfExecution);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfExecution instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfExecution to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfExecution input)
        {
            if (input == null)
                return false;
