...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionTypeRequest : IEquatable<TransactionTypeRequest>
    {
        /// <summary>
        ...
        public TransactionTypeRequest(List<TransactionTypeAlias> aliases = default(List<TransactionTypeAlias>), List<TransactionTypeMovement> movements = default(List<TransactionTypeMovement>), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>))
        {
            ...
            this.Aliases = aliases ?? throw new ArgumentNullException("aliases is a required property for TransactionTypeRequest and cannot be null");
            // to ensure "movements" is required (not null)
            this.Movements = movements ?? throw new ArgumentNullException("movements is a required property for TransactionTypeRequest and cannot be null");
