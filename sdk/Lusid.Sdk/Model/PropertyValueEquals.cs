...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PropertyValueEquals : MatchCriterion, IEquatable<PropertyValueEquals>
    {
        /// <summary>
        ...
        /// <param name="criterionType">The available values are: PropertyValueEquals, PropertyValueIn, SubHoldingKeyValueEquals (required) (default to &quot;PropertyValueEquals&quot;).</param>
        public PropertyValueEquals(string propertyKey = default(string), string value = default(string), CriterionTypeEnum criterionType = default(CriterionTypeEnum)) : base(criterionType)
        {
            // to ensure "propertyKey" is required (not null)
            this.PropertyKey = propertyKey ?? throw new ArgumentNullException("propertyKey is a required property for PropertyValueEquals and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for PropertyValueEquals and cannot be null");
        }
