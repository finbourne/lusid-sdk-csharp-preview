...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfCutLabelDefinition")]
    public partial class PagedResourceListOfCutLabelDefinition : IEquatable<PagedResourceListOfCutLabelDefinition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfCutLabelDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfCutLabelDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfCutLabelDefinition" /> class.
        /// </summary>
        ...
        public PagedResourceListOfCutLabelDefinition(string nextPage = default(string), string previousPage = default(string), List<CutLabelDefinition> values = default(List<CutLabelDefinition>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfCutLabelDefinition and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResourceListOfCutLabelDefinition {\n");
        ...
        {
            return this.Equals(input as PagedResourceListOfCutLabelDefinition);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfCutLabelDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfCutLabelDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfCutLabelDefinition input)
        {
            if (input == null)
                return false;
