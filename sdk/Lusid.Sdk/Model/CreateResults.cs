...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateResults :  IEquatable<CreateResults>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateResults(DateTimeOffset effectiveAt = default(DateTimeOffset), string entityScope = default(string), string entityCode = default(string), string calculationScope = default(string), string calculationCode = default(string), FormatEnum? format = default(FormatEnum?), string data = default(string))
        {
            ...
            this.EntityScope = entityScope ?? throw new ArgumentNullException("entityScope is a required property for CreateResults and cannot be null");;
            // to ensure "entityCode" is required (not null)
            this.EntityCode = entityCode ?? throw new ArgumentNullException("entityCode is a required property for CreateResults and cannot be null");;
            // to ensure "calculationScope" is required (not null)
            this.CalculationScope = calculationScope ?? throw new ArgumentNullException("calculationScope is a required property for CreateResults and cannot be null");;
            // to ensure "calculationCode" is required (not null)
            this.CalculationCode = calculationCode ?? throw new ArgumentNullException("calculationCode is a required property for CreateResults and cannot be null");;
            this.Format = format;
            this.Data = data;
        }
