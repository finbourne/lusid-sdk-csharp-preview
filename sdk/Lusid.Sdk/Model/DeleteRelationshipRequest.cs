...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DeleteRelationshipRequest : IEquatable<DeleteRelationshipRequest>
    {
        /// <summary>
        ...
        public DeleteRelationshipRequest(Dictionary<string, string> sourceEntityId = default(Dictionary<string, string>), Dictionary<string, string> targetEntityId = default(Dictionary<string, string>), DateTimeOrCutLabel effectiveFrom = default(DateTimeOrCutLabel))
        {
            // to ensure "sourceEntityId" is required (not null)
            this.SourceEntityId = sourceEntityId ?? throw new ArgumentNullException("sourceEntityId is a required property for DeleteRelationshipRequest and cannot be null");
            // to ensure "targetEntityId" is required (not null)
            this.TargetEntityId = targetEntityId ?? throw new ArgumentNullException("targetEntityId is a required property for DeleteRelationshipRequest and cannot be null");
