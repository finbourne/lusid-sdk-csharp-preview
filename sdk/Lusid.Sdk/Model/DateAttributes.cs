...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DateAttributes :  IEquatable<DateAttributes>
    {
        ...
        /// <param name="firstOpen">firstOpen (required).</param>
        /// <param name="lastOpen">lastOpen (required).</param>
        /// <param name="firstClose">firstClose (required).</param>
        /// <param name="lastClose">lastClose (required).</param>
        ...
        {
            // to ensure "irregular" is required (not null)
            if (irregular == null)
            {
                throw new InvalidDataException("irregular is a required property for DateAttributes and cannot be null");
            }
            else
            {
            ...
            // to ensure "irregularSession" is required (not null)
            if (irregularSession == null)
            {
                throw new InvalidDataException("irregularSession is a required property for DateAttributes and cannot be null");
            }
            else
            {
            ...
            // to ensure "newHours" is required (not null)
            if (newHours == null)
            {
                throw new InvalidDataException("newHours is a required property for DateAttributes and cannot be null");
            }
            else
            {
            ...
            if (activity == null)
            {
                throw new InvalidDataException("activity is a required property for DateAttributes and cannot be null");
            }
            else
            {
            ...
            // to ensure "firstOpen" is required (not null)
            if (firstOpen == null)
            {
                throw new InvalidDataException("firstOpen is a required property for DateAttributes and cannot be null");
            }
            else
            {
            ...
            // to ensure "lastOpen" is required (not null)
            if (lastOpen == null)
            {
                throw new InvalidDataException("lastOpen is a required property for DateAttributes and cannot be null");
            }
            else
            {
            ...
            // to ensure "firstClose" is required (not null)
            if (firstClose == null)
            {
                throw new InvalidDataException("firstClose is a required property for DateAttributes and cannot be null");
            }
            else
            {
            ...
            // to ensure "lastClose" is required (not null)
            if (lastClose == null)
            {
                throw new InvalidDataException("lastClose is a required property for DateAttributes and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="irregular", EmitDefaultValue=false)]
        public bool? Irregular { get; set; }

        /// <summary>
        /// Gets or Sets IrregularSession
        /// </summary>
        [DataMember(Name="irregularSession", EmitDefaultValue=false)]
        public bool? IrregularSession { get; set; }

        /// <summary>
        /// Gets or Sets NewHours
        /// </summary>
        [DataMember(Name="newHours", EmitDefaultValue=false)]
        ...
        /// </summary>
        [DataMember(Name="lastOpen", EmitDefaultValue=false)]
        public string LastOpen { get; set; }

        /// <summary>
        /// Gets or Sets FirstClose
        /// </summary>
        [DataMember(Name="firstClose", EmitDefaultValue=false)]
        public string FirstClose { get; set; }

        /// <summary>
        /// Gets or Sets LastClose
        /// </summary>
        [DataMember(Name="lastClose", EmitDefaultValue=false)]
