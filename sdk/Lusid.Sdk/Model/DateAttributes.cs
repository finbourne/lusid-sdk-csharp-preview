...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DateAttributes : IEquatable<DateAttributes>
    {
        ...
        public DateAttributes(bool irregular = default(bool), bool irregularSession = default(bool), bool newHours = default(bool), string activity = default(string), string firstOpen = default(string), string lastOpen = default(string), string firstClose = default(string), string lastClose = default(string))
        {
            ...
            this.Activity = activity ?? throw new ArgumentNullException("activity is a required property for DateAttributes and cannot be null");
            // to ensure "firstOpen" is required (not null)
            this.FirstOpen = firstOpen ?? throw new ArgumentNullException("firstOpen is a required property for DateAttributes and cannot be null");
            // to ensure "lastOpen" is required (not null)
            this.LastOpen = lastOpen ?? throw new ArgumentNullException("lastOpen is a required property for DateAttributes and cannot be null");
            // to ensure "firstClose" is required (not null)
            this.FirstClose = firstClose ?? throw new ArgumentNullException("firstClose is a required property for DateAttributes and cannot be null");
            // to ensure "lastClose" is required (not null)
            this.LastClose = lastClose ?? throw new ArgumentNullException("lastClose is a required property for DateAttributes and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "firstOpen", IsRequired = true, EmitDefaultValue = false)]
        public string FirstOpen { get; set; }

        /// <summary>
        /// Gets or Sets LastOpen
        /// </summary>
        [DataMember(Name = "lastOpen", IsRequired = true, EmitDefaultValue = false)]
        public string LastOpen { get; set; }

        /// <summary>
        /// Gets or Sets FirstClose
        /// </summary>
        [DataMember(Name = "firstClose", IsRequired = true, EmitDefaultValue = false)]
        public string FirstClose { get; set; }

        /// <summary>
        /// Gets or Sets LastClose
        /// </summary>
        [DataMember(Name = "lastClose", IsRequired = true, EmitDefaultValue = false)]
