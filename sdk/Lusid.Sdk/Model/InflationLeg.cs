...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InflationLeg")]
    [JsonConverter(typeof(JsonSubtypes), "InstrumentType")]
    public partial class InflationLeg : LusidInstrument, IEquatable<InflationLeg>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InflationLeg" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InflationLeg() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InflationLeg" /> class.
        /// </summary>
        ...
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption, ReferenceInstrument, ComplexBond, InflationLinkedBond, InflationSwap, SimpleCashFlowLoan, TotalReturnSwap, InflationLeg, FundShareClass, FlexibleLoan (required) (default to &quot;InflationLeg&quot;).</param>
        public InflationLeg(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), FlowConventions flowConventions = default(FlowConventions), decimal? baseCPI = default(decimal?), string calculationType = default(string), decimal? capRate = default(decimal?), decimal? floorRate = default(decimal?), InflationIndexConventions inflationIndexConventions = default(InflationIndexConventions), decimal notional = default(decimal), string payReceive = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.FlowConventions = flowConventions ?? throw new ArgumentNullException("flowConventions is a required property for InflationLeg and cannot be null");
            // to ensure "calculationType" is required (not null)
            this.CalculationType = calculationType ?? throw new ArgumentNullException("calculationType is a required property for InflationLeg and cannot be null");
            // to ensure "inflationIndexConventions" is required (not null)
            this.InflationIndexConventions = inflationIndexConventions ?? throw new ArgumentNullException("inflationIndexConventions is a required property for InflationLeg and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "inflationIndexConventions", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as InflationLeg);
        }

        /// <summary>
        /// Returns true if InflationLeg instances are equal
        /// </summary>
        /// <param name="input">Instance of InflationLeg to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InflationLeg input)
        {
            if (input == null)
                return false;
