...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfPortfolio :  IEquatable<ResourceListOfPortfolio>, IValidatableObject
    {
        ...
        public ResourceListOfPortfolio(List<Portfolio> values = default(List<Portfolio>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfPortfolio and cannot be null");;
            this.Href = href;
            this.Links = links;
        }
