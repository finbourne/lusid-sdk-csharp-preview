...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AggregateSpec :  IEquatable<AggregateSpec>
    {
        ...
        /// </summary>
        /// <param name="key">The key that uniquely identifies the property. It has the format {domain}/{scope}/{code}..</param>
        /// <param name="op">The available values are: Sum, Proportion, Average, Count, Min, Max, Value.</param>
