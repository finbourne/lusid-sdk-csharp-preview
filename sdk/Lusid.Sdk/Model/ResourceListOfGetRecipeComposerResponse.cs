...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfGetRecipeComposerResponse : IEquatable<ResourceListOfGetRecipeComposerResponse>
    {
        /// <summary>
        ...
        public ResourceListOfGetRecipeComposerResponse(List<GetRecipeComposerResponse> values = default(List<GetRecipeComposerResponse>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfGetRecipeComposerResponse and cannot be null");
            this.Href = href;
            this.Links = links;
