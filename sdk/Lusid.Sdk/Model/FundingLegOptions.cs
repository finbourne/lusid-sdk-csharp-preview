...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FundingLegOptions : ModelOptions, IEquatable<FundingLegOptions>
    {
        /// <summary>
        ...
        /// <param name="modelOptionsType">The available values are: Invalid, OpaqueModelOptions, EmptyModelOptions, IndexModelOptions, FxForwardModelOptions, FundingLegModelOptions (required) (default to &quot;FundingLegOptions&quot;).</param>
        public FundingLegOptions(string expectedFundingLegNotional = default(string), ModelOptionsTypeEnum modelOptionsType = default(ModelOptionsTypeEnum)) : base(modelOptionsType)
        {
            ...
            this.ExpectedFundingLegNotional = expectedFundingLegNotional ?? throw new ArgumentNullException("expectedFundingLegNotional is a required property for FundingLegOptions and cannot be null");
        }
        ...
        [DataMember(Name = "expectedFundingLegNotional", IsRequired = true, EmitDefaultValue = false)]
