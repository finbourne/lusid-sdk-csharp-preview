...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateRelationRequest :  IEquatable<CreateRelationRequest>
    {
        ...
        public CreateRelationRequest(Dictionary<string, string> sourceEntityId = default(Dictionary<string, string>), Dictionary<string, string> targetEntityId = default(Dictionary<string, string>))
        {
            ...
            {
                throw new InvalidDataException("sourceEntityId is a required property for CreateRelationRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("targetEntityId is a required property for CreateRelationRequest and cannot be null");
            }
            else
            {
