...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TranslateInstrumentDefinitionsRequest :  IEquatable<TranslateInstrumentDefinitionsRequest>
    {
        ...
        public TranslateInstrumentDefinitionsRequest(Dictionary<string, LusidInstrument> instruments = default(Dictionary<string, LusidInstrument>), string dialect = default(string))
        {
            ...
            if (instruments == null)
            {
                throw new InvalidDataException("instruments is a required property for TranslateInstrumentDefinitionsRequest and cannot be null");
            }
            else
            {
            ...
            if (dialect == null)
            {
                throw new InvalidDataException("dialect is a required property for TranslateInstrumentDefinitionsRequest and cannot be null");
            }
            else
            {
