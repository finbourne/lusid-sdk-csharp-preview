...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityVolSurfaceDataAllOf :  IEquatable<EquityVolSurfaceDataAllOf>
    {
        ...
        public EquityVolSurfaceDataAllOf(DateTimeOffset? baseDate = default(DateTimeOffset?), List<LusidInstrument> instruments = default(List<LusidInstrument>), List<MarketQuote> quotes = default(List<MarketQuote>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
            // to ensure "baseDate" is required (not null)
            if (baseDate == null)
            {
                throw new InvalidDataException("baseDate is a required property for EquityVolSurfaceDataAllOf and cannot be null");
            }
            else
            {
            ...
            if (instruments == null)
            {
                throw new InvalidDataException("instruments is a required property for EquityVolSurfaceDataAllOf and cannot be null");
            }
            else
            {
            ...
            if (quotes == null)
            {
                throw new InvalidDataException("quotes is a required property for EquityVolSurfaceDataAllOf and cannot be null");
            }
            else
            {
                this.Quotes = quotes;
            ...
            {
                throw new InvalidDataException("marketDataType is a required property for EquityVolSurfaceDataAllOf and cannot be null");
            }
            else
            {
