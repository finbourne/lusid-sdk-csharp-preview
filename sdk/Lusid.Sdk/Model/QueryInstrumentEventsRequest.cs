...
namespace Lusid.Sdk.Model
{
    ...
    public partial class QueryInstrumentEventsRequest : IEquatable<QueryInstrumentEventsRequest>
    {
        /// <summary>
        ...
        /// <param name="filterInstrumentEvents">filterInstrumentEvents.</param>
        public QueryInstrumentEventsRequest(DateTimeOffset asAt = default(DateTimeOffset), DateTimeOffset windowStart = default(DateTimeOffset), DateTimeOffset windowEnd = default(DateTimeOffset), List<PortfolioEntityId> portfolioEntityIds = default(List<PortfolioEntityId>), DateTimeOffset effectiveAt = default(DateTimeOffset), ResourceId recipeId = default(ResourceId), FilterInstrumentEvents filterInstrumentEvents = default(FilterInstrumentEvents))
        {
            this.AsAt = asAt;
            this.WindowStart = windowStart;
            this.WindowEnd = windowEnd;
            // to ensure "portfolioEntityIds" is required (not null)
            this.PortfolioEntityIds = portfolioEntityIds ?? throw new ArgumentNullException("portfolioEntityIds is a required property for QueryInstrumentEventsRequest and cannot be null");
            this.EffectiveAt = effectiveAt;
            // to ensure "recipeId" is required (not null)
            this.RecipeId = recipeId ?? throw new ArgumentNullException("recipeId is a required property for QueryInstrumentEventsRequest and cannot be null");
        ...
        /// <summary>
        /// Gets or Sets FilterInstrumentEvents
        /// </summary>
        [DataMember(Name = "filterInstrumentEvents", EmitDefaultValue = false)]
        public FilterInstrumentEvents FilterInstrumentEvents { get; set; }
