...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BranchStepAllOf : IEquatable<BranchStepAllOf>
    {
        /// <summary>
        ...
        public BranchStepAllOf(string label = default(string), List<ComplianceTemplateParameter> parameters = default(List<ComplianceTemplateParameter>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum))
        {
            ...
            this.Label = label ?? throw new ArgumentNullException("label is a required property for BranchStepAllOf and cannot be null");
            // to ensure "parameters" is required (not null)
            this.Parameters = parameters ?? throw new ArgumentNullException("parameters is a required property for BranchStepAllOf and cannot be null");
