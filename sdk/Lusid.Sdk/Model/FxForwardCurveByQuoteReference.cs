...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardCurveByQuoteReference : ComplexMarketData, IEquatable<FxForwardCurveByQuoteReference>
    {
        ...
        /// <param name="marketDataType">The available values are: DiscountFactorCurveData, EquityVolSurfaceData, FxVolSurfaceData, IrVolCubeData, OpaqueMarketData, YieldCurveData, FxForwardCurveData, FxForwardPipsCurveData, FxForwardTenorCurveData, FxForwardTenorPipsCurveData, FxForwardCurveByQuoteReference (required) (default to &quot;FxForwardCurveByQuoteReference&quot;).</param>
        public FxForwardCurveByQuoteReference(string domCcy = default(string), string fgnCcy = default(string), List<string> tenors = default(List<string>), List<Dictionary<string, string>> quoteReferences = default(List<Dictionary<string, string>>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base(marketDataType)
        {
