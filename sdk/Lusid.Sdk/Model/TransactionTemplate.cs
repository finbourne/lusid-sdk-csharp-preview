...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionTemplate : IEquatable<TransactionTemplate>
    {
        /// <summary>
        ...
        public TransactionTemplate(string instrumentType = default(string), string instrumentEventType = default(string), string description = default(string), string scope = default(string), List<ComponentTransaction> componentTransactions = default(List<ComponentTransaction>), List<Link> links = default(List<Link>))
        {
            ...
            this.InstrumentType = instrumentType ?? throw new ArgumentNullException("instrumentType is a required property for TransactionTemplate and cannot be null");
            // to ensure "instrumentEventType" is required (not null)
            this.InstrumentEventType = instrumentEventType ?? throw new ArgumentNullException("instrumentEventType is a required property for TransactionTemplate and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for TransactionTemplate and cannot be null");
            // to ensure "scope" is required (not null)
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for TransactionTemplate and cannot be null");
            // to ensure "componentTransactions" is required (not null)
            this.ComponentTransactions = componentTransactions ?? throw new ArgumentNullException("componentTransactions is a required property for TransactionTemplate and cannot be null");
            this.Links = links;
        }
        ...
        [DataMember(Name = "componentTransactions", IsRequired = true, EmitDefaultValue = false)]
