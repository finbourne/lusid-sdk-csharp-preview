...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InflationSwap : LusidInstrument, IEquatable<InflationSwap>
    {
        ...
        public InflationSwap(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), InflationLeg inflationLeg = default(InflationLeg), FixedLeg fixedLeg = default(FixedLeg), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.InflationLeg = inflationLeg ?? throw new ArgumentNullException("inflationLeg is a required property for InflationSwap and cannot be null");
            // to ensure "fixedLeg" is required (not null)
            this.FixedLeg = fixedLeg ?? throw new ArgumentNullException("fixedLeg is a required property for InflationSwap and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "inflationLeg", IsRequired = true, EmitDefaultValue = false)]
        public InflationLeg InflationLeg { get; set; }

        /// <summary>
        /// Gets or Sets FixedLeg
        /// </summary>
        [DataMember(Name = "fixedLeg", IsRequired = true, EmitDefaultValue = false)]
