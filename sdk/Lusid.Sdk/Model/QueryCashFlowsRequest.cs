...
namespace Lusid.Sdk.Model
{
    ...
    public partial class QueryCashFlowsRequest : IEquatable<QueryCashFlowsRequest>
    {
        /// <summary>
        ...
        public QueryCashFlowsRequest(DateTimeOffset? asAt = default(DateTimeOffset?), DateTimeOffset windowStart = default(DateTimeOffset), DateTimeOffset windowEnd = default(DateTimeOffset), List<PortfolioEntityId> portfolioEntityIds = default(List<PortfolioEntityId>), ResourceId recipeId = default(ResourceId), DateTimeOffset effectiveAt = default(DateTimeOffset))
        {
            ...
            this.PortfolioEntityIds = portfolioEntityIds ?? throw new ArgumentNullException("portfolioEntityIds is a required property for QueryCashFlowsRequest and cannot be null");
            // to ensure "recipeId" is required (not null)
            this.RecipeId = recipeId ?? throw new ArgumentNullException("recipeId is a required property for QueryCashFlowsRequest and cannot be null");
