...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InformationalEvent : InstrumentEvent, IEquatable<InformationalEvent>
    {
        /// <summary>
        ...
        /// <param name="instrumentEventType">The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent (required) (default to &quot;InformationalEvent&quot;).</param>
        public InformationalEvent(string eventStatus = default(string), DateTimeOffset anchorDate = default(DateTimeOffset), ResultValueDictionary diagnostics = default(ResultValueDictionary), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base(instrumentEventType)
        {
            // to ensure "eventStatus" is required (not null)
            this.EventStatus = eventStatus ?? throw new ArgumentNullException("eventStatus is a required property for InformationalEvent and cannot be null");
