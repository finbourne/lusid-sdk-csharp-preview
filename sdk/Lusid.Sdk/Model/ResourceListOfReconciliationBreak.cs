...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfReconciliationBreak :  IEquatable<ResourceListOfReconciliationBreak>
    {
        ...
        public ResourceListOfReconciliationBreak(List<ReconciliationBreak> values = default(List<ReconciliationBreak>), string href = default(string), List<Link> links = default(List<Link>))
        {
