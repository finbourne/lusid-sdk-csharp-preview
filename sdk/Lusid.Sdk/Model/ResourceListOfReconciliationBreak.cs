...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfReconciliationBreak :  IEquatable<ResourceListOfReconciliationBreak>
    {
        /// <summary>
        ...
        public ResourceListOfReconciliationBreak(List<ReconciliationBreak> values = default(List<ReconciliationBreak>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfReconciliationBreak and cannot be null");
            }
            else
            {
                this.Values = values;
