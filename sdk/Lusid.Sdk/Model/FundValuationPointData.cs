...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FundValuationPointData : IEquatable<FundValuationPointData>
    {
        /// <summary>
        ...
        public FundValuationPointData(Dictionary<string, FundAmount> backOut = default(Dictionary<string, FundAmount>), Dictionary<string, FundAmount> dealing = default(Dictionary<string, FundAmount>), FundPnlBreakdown pnL = default(FundPnlBreakdown), decimal gav = default(decimal), Dictionary<string, FeeAccrual> fees = default(Dictionary<string, FeeAccrual>), decimal nav = default(decimal), UnitisationData unitisation = default(UnitisationData), Dictionary<string, FundAmount> miscellaneous = default(Dictionary<string, FundAmount>), PreviousFundValuationPointData previousValuationPointData = default(PreviousFundValuationPointData))
        {
            ...
            this.BackOut = backOut ?? throw new ArgumentNullException("backOut is a required property for FundValuationPointData and cannot be null");
            // to ensure "dealing" is required (not null)
            this.Dealing = dealing ?? throw new ArgumentNullException("dealing is a required property for FundValuationPointData and cannot be null");
            // to ensure "pnL" is required (not null)
            this.PnL = pnL ?? throw new ArgumentNullException("pnL is a required property for FundValuationPointData and cannot be null");
            this.Gav = gav;
            // to ensure "fees" is required (not null)
            this.Fees = fees ?? throw new ArgumentNullException("fees is a required property for FundValuationPointData and cannot be null");
            this.Nav = nav;
        ...
        [DataMember(Name = "backOut", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "dealing", IsRequired = true, EmitDefaultValue = false)]
        public Dictionary<string, FundAmount> Dealing { get; set; }

        /// <summary>
        /// Gets or Sets PnL
        /// </summary>
        [DataMember(Name = "pnL", IsRequired = true, EmitDefaultValue = false)]
