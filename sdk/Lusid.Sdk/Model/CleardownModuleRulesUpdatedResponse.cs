...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CleardownModuleRulesUpdatedResponse : IEquatable<CleardownModuleRulesUpdatedResponse>
    {
        /// <summary>
        ...
        public CleardownModuleRulesUpdatedResponse(List<CleardownModuleRule> rules = default(List<CleardownModuleRule>), Version version = default(Version), string href = default(string), List<Link> links = default(List<Link>))
        {
            this.Rules = rules;
