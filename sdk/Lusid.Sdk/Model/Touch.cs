...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Touch : IEquatable<Touch>
    {
        /// <summary>
        ...
        public Touch(string direction = default(string), decimal level = default(decimal), string monitoring = default(string), string type = default(string))
        {
            ...
            this.Direction = direction ?? throw new ArgumentNullException("direction is a required property for Touch and cannot be null");
            this.Level = level;
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for Touch and cannot be null");
