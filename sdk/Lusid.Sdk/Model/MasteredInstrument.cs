...
namespace Lusid.Sdk.Model
{
    ...
    public partial class MasteredInstrument : LusidInstrument, IEquatable<MasteredInstrument>
    {
        /// <summary>
        ...
        public MasteredInstrument(Dictionary<string, string> identifiers = default(Dictionary<string, string>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.Identifiers = identifiers ?? throw new ArgumentNullException("identifiers is a required property for MasteredInstrument and cannot be null");
        }
