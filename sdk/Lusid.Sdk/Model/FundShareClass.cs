...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FundShareClass : LusidInstrument, IEquatable<FundShareClass>
    {
        /// <summary>
        ...
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption, ReferenceInstrument, ComplexBond, InflationLinkedBond, InflationSwap, SimpleCashFlowLoan, TotalReturnSwap, InflationLeg, FundShareClass, FlexibleLoan (required) (default to &quot;FundShareClass&quot;).</param>
        public FundShareClass(string shortCode = default(string), string fundShareClassType = default(string), string distributionPaymentType = default(string), string hedging = default(string), string domCcy = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.ShortCode = shortCode ?? throw new ArgumentNullException("shortCode is a required property for FundShareClass and cannot be null");
            // to ensure "fundShareClassType" is required (not null)
            this.FundShareClassType = fundShareClassType ?? throw new ArgumentNullException("fundShareClassType is a required property for FundShareClass and cannot be null");
            // to ensure "distributionPaymentType" is required (not null)
            this.DistributionPaymentType = distributionPaymentType ?? throw new ArgumentNullException("distributionPaymentType is a required property for FundShareClass and cannot be null");
            // to ensure "hedging" is required (not null)
            this.Hedging = hedging ?? throw new ArgumentNullException("hedging is a required property for FundShareClass and cannot be null");
            // to ensure "domCcy" is required (not null)
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for FundShareClass and cannot be null");
        }
        ...
        [DataMember(Name = "fundShareClassType", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "distributionPaymentType", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "hedging", IsRequired = true, EmitDefaultValue = false)]
