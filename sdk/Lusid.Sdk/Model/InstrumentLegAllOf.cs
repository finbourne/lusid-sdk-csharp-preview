...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InstrumentLegAllOf :  IEquatable<InstrumentLegAllOf>
    {
        /// <summary>
        /// The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashflowLeg, Unknown
        /// </summary>
        /// <value>The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashflowLeg, Unknown</value>
        ...
        /// Initializes a new instance of the <see cref="InstrumentLegAllOf" /> class.
        /// </summary>
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashflowLeg, Unknown (required).</param>
        public InstrumentLegAllOf(InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            {
                throw new InvalidDataException("instrumentType is a required property for InstrumentLegAllOf and cannot be null");
            }
            else
            {
