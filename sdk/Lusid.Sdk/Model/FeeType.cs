...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FeeType : IEquatable<FeeType>
    {
        /// <summary>
        ...
        public FeeType(string href = default(string), ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), List<ComponentTransaction> componentTransactions = default(List<ComponentTransaction>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for FeeType and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for FeeType and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for FeeType and cannot be null");
            // to ensure "componentTransactions" is required (not null)
            this.ComponentTransactions = componentTransactions ?? throw new ArgumentNullException("componentTransactions is a required property for FeeType and cannot be null");
            this.Href = href;
