...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FeeType : IEquatable<FeeType>
    {
        ...
        public FeeType(string href = default(string), ResourceId id = default(ResourceId), string name = default(string), string description = default(string), List<ComponentTransaction> componentTransactions = default(List<ComponentTransaction>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for FeeType and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for FeeType and cannot be null");
