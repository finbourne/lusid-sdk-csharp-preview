...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ListAggregationResponse :  IEquatable<ListAggregationResponse>
    {
        ...
        public ListAggregationResponse(string href = default(string), List<Dictionary<string, Object>> data = default(List<Dictionary<string, Object>>), string aggregationCurrency = default(string), ResultDataSchema dataSchema = default(ResultDataSchema), List<Link> links = default(List<Link>))
        {
            this.Href = href;
            this.Data = data;
        ...
        /// </summary>
        [DataMember(Name="aggregationCurrency", EmitDefaultValue=false)]
