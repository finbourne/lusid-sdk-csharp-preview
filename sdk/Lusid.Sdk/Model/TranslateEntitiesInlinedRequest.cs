...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TranslateEntitiesInlinedRequest : IEquatable<TranslateEntitiesInlinedRequest>
    {
        /// <summary>
        ...
        public TranslateEntitiesInlinedRequest(Dictionary<string, TranslationInput> entityPayloads = default(Dictionary<string, TranslationInput>), string scriptBody = default(string), DialectSchema schema = default(DialectSchema))
        {
            ...
            this.EntityPayloads = entityPayloads ?? throw new ArgumentNullException("entityPayloads is a required property for TranslateEntitiesInlinedRequest and cannot be null");
            // to ensure "scriptBody" is required (not null)
            this.ScriptBody = scriptBody ?? throw new ArgumentNullException("scriptBody is a required property for TranslateEntitiesInlinedRequest and cannot be null");
            this.Schema = schema;
        }
        ...
        [DataMember(Name = "scriptBody", IsRequired = true, EmitDefaultValue = false)]
