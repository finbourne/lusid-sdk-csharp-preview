...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfAmortisationRuleSet : IEquatable<PagedResourceListOfAmortisationRuleSet>
    {
        /// <summary>
        ...
        public PagedResourceListOfAmortisationRuleSet(string nextPage = default(string), string previousPage = default(string), List<AmortisationRuleSet> values = default(List<AmortisationRuleSet>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfAmortisationRuleSet and cannot be null");
