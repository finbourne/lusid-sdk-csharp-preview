...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityOption : LusidInstrument,  IEquatable<EquityOption>
    {
        ...
        /// </summary>
        /// <value>Type of optionality for the option</value>
        ...
        /// </summary>
        /// <value>is the option cash settled or physical delivery of option</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>external market codes and identifiers for the option, e.g. RIC.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="optionType">Type of optionality for the option (required).</param>
        /// <param name="deliveryType">is the option cash settled or physical delivery of option (required).</param>
        /// <param name="underlyingIdentifier">external market codes and identifiers for the option, e.g. RIC. (required).</param>
        /// <param name="domCcy">The domestic currency of the instrument. (required).</param>
        public EquityOption(string code = default(string), decimal? strike = default(decimal?), DateTimeOffset? optionMaturityDate = default(DateTimeOffset?), DateTimeOffset? optionSettlementDate = default(DateTimeOffset?), DateTimeOffset? startDate = default(DateTimeOffset?), OptionTypeEnum optionType = default(OptionTypeEnum), DeliveryTypeEnum deliveryType = default(DeliveryTypeEnum), UnderlyingIdentifierEnum underlyingIdentifier = default(UnderlyingIdentifierEnum), string domCcy = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
