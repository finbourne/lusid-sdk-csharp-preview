...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TranslationScriptId : IEquatable<TranslationScriptId>
    {
        /// <summary>
        ...
        public TranslationScriptId(string scope = default(string), string code = default(string), string version = default(string))
        {
            ...
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for TranslationScriptId and cannot be null");
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for TranslationScriptId and cannot be null");
            // to ensure "version" is required (not null)
            this.Version = version ?? throw new ArgumentNullException("version is a required property for TranslationScriptId and cannot be null");
        }
