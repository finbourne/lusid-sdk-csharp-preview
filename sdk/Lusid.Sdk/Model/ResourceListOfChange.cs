...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfChange :  IEquatable<ResourceListOfChange>
    {
        ...
        public ResourceListOfChange(List<Change> values = default(List<Change>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
