...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfPerson")]
    public partial class ResourceListOfPerson : IEquatable<ResourceListOfPerson>
    {
        ...
        public ResourceListOfPerson(List<Person> values = default(List<Person>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfPerson and cannot be null");
            this.Href = href;
            this.Links = links;
