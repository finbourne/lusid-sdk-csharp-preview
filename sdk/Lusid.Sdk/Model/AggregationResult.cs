...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AggregationResult :  IEquatable<AggregationResult>
    {
        ...
        /// <param name="scalesWithHoldingQuantity">scalesWithHoldingQuantity.</param>
        /// <param name="valueType">valueType.</param>
        public AggregationResult(string displayName = default(string), bool? scalesWithHoldingQuantity = default(bool?), ValueTypeEnum? valueType = default(ValueTypeEnum?))
        {
        ...
        /// <summary>
        /// Gets or Sets ScalesWithHoldingQuantity
        /// </summary>
        [DataMember(Name="scalesWithHoldingQuantity", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as AggregationResult);
        }

        /// <summary>
        /// Returns true if AggregationResult instances are equal
        /// </summary>
        /// <param name="input">Instance of AggregationResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AggregationResult input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.ScalesWithHoldingQuantity != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ScalesWithHoldingQuantity != null)
