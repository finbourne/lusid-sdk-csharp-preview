...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxVolSurfaceData : ComplexMarketData,  IEquatable<FxVolSurfaceData>
    {
        ...
        public FxVolSurfaceData(DateTimeOffset? baseDate = default(DateTimeOffset?), List<LusidInstrument> instruments = default(List<LusidInstrument>), List<MarketQuote> quotes = default(List<MarketQuote>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base(marketDataType)
        {
            ...
            if (baseDate == null)
            {
                throw new InvalidDataException("baseDate is a required property for FxVolSurfaceData and cannot be null");
            }
            else
            {
            ...
            if (instruments == null)
            {
                throw new InvalidDataException("instruments is a required property for FxVolSurfaceData and cannot be null");
            }
            else
            {
            ...
            if (quotes == null)
            {
                throw new InvalidDataException("quotes is a required property for FxVolSurfaceData and cannot be null");
            }
            else
            {
                this.Quotes = quotes;
