...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BlockAndOrder : IEquatable<BlockAndOrder>
    {
        /// <summary>
        ...
        public BlockAndOrder(Block block = default(Block), Order order = default(Order))
        {
            ...
            this.Block = block ?? throw new ArgumentNullException("block is a required property for BlockAndOrder and cannot be null");
            // to ensure "order" is required (not null)
            this.Order = order ?? throw new ArgumentNullException("order is a required property for BlockAndOrder and cannot be null");
        }

        /// <summary>
        /// Gets or Sets Block
        /// </summary>
        [DataMember(Name = "block", IsRequired = true, EmitDefaultValue = false)]
