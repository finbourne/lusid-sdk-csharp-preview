...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfGroupReconciliationDefinition : IEquatable<PagedResourceListOfGroupReconciliationDefinition>
    {
        /// <summary>
        ...
        public PagedResourceListOfGroupReconciliationDefinition(string nextPage = default(string), string previousPage = default(string), List<GroupReconciliationDefinition> values = default(List<GroupReconciliationDefinition>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfGroupReconciliationDefinition and cannot be null");
