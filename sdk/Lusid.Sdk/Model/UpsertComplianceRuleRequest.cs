...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertComplianceRuleRequest : IEquatable<UpsertComplianceRuleRequest>
    {
        /// <summary>
        ...
        public UpsertComplianceRuleRequest(ResourceId id = default(ResourceId), string name = default(string), string description = default(string), bool active = default(bool), ResourceId templateId = default(ResourceId), string variation = default(string), ResourceId portfolioGroupId = default(ResourceId), Dictionary<string, ComplianceParameter> parameters = default(Dictionary<string, ComplianceParameter>), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for UpsertComplianceRuleRequest and cannot be null");
            this.Active = active;
            // to ensure "templateId" is required (not null)
            this.TemplateId = templateId ?? throw new ArgumentNullException("templateId is a required property for UpsertComplianceRuleRequest and cannot be null");
            // to ensure "variation" is required (not null)
            this.Variation = variation ?? throw new ArgumentNullException("variation is a required property for UpsertComplianceRuleRequest and cannot be null");
            // to ensure "portfolioGroupId" is required (not null)
            this.PortfolioGroupId = portfolioGroupId ?? throw new ArgumentNullException("portfolioGroupId is a required property for UpsertComplianceRuleRequest and cannot be null");
            // to ensure "parameters" is required (not null)
            this.Parameters = parameters ?? throw new ArgumentNullException("parameters is a required property for UpsertComplianceRuleRequest and cannot be null");
            // to ensure "properties" is required (not null)
            this.Properties = properties ?? throw new ArgumentNullException("properties is a required property for UpsertComplianceRuleRequest and cannot be null");
            this.Name = name;
        ...
        /// </summary>
        [DataMember(Name = "portfolioGroupId", IsRequired = true, EmitDefaultValue = false)]
