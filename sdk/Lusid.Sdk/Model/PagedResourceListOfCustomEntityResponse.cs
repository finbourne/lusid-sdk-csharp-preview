...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfCustomEntityResponse")]
    public partial class PagedResourceListOfCustomEntityResponse : IEquatable<PagedResourceListOfCustomEntityResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfCustomEntityResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfCustomEntityResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfCustomEntityResponse" /> class.
        /// </summary>
        ...
        public PagedResourceListOfCustomEntityResponse(string nextPage = default(string), string previousPage = default(string), List<CustomEntityResponse> values = default(List<CustomEntityResponse>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfCustomEntityResponse and cannot be null");
        ...
        public List<CustomEntityResponse> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResourceListOfCustomEntityResponse {\n");
        ...
        {
            return this.Equals(input as PagedResourceListOfCustomEntityResponse);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfCustomEntityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfCustomEntityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfCustomEntityResponse input)
        {
            if (input == null)
                return false;
