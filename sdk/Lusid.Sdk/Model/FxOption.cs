...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxOption : LusidInstrument, IEquatable<FxOption>
    {
        ...
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption, ReferenceInstrument, ComplexBond (required) (default to &quot;FxOption&quot;).</param>
        public FxOption(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset optionMaturityDate = default(DateTimeOffset), DateTimeOffset optionSettlementDate = default(DateTimeOffset), bool isDeliveryNotCash = default(bool), bool isCallNotPut = default(bool), decimal strike = default(decimal), string domCcy = default(string), decimal? domAmount = default(decimal?), string fgnCcy = default(string), Premium premium = default(Premium), decimal? fgnAmount = default(decimal?), string exerciseType = default(string), bool isPayoffDigital = default(bool), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
