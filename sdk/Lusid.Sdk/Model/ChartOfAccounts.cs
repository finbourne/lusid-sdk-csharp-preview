...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ChartOfAccounts : IEquatable<ChartOfAccounts>
    {
        /// <summary>
        ...
        public ChartOfAccounts(string href = default(string), ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ChartOfAccounts and cannot be null");
            this.Href = href;
