...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentList : IEquatable<InstrumentList>
    {
        /// <summary>
        ...
        public InstrumentList(List<string> values = default(List<string>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for InstrumentList and cannot be null");
