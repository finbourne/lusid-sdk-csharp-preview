...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TranslateEntitiesRequest : IEquatable<TranslateEntitiesRequest>
    {
        /// <summary>
        ...
        public TranslateEntitiesRequest(Dictionary<string, TranslationInput> entityPayloads = default(Dictionary<string, TranslationInput>), TranslationScriptId scriptId = default(TranslationScriptId), DialectId dialectId = default(DialectId))
        {
            ...
            this.EntityPayloads = entityPayloads ?? throw new ArgumentNullException("entityPayloads is a required property for TranslateEntitiesRequest and cannot be null");
            // to ensure "scriptId" is required (not null)
            this.ScriptId = scriptId ?? throw new ArgumentNullException("scriptId is a required property for TranslateEntitiesRequest and cannot be null");
        ...
        [DataMember(Name = "entityPayloads", IsRequired = true, EmitDefaultValue = false)]
        public Dictionary<string, TranslationInput> EntityPayloads { get; set; }

        /// <summary>
        /// Gets or Sets ScriptId
        /// </summary>
        [DataMember(Name = "scriptId", IsRequired = true, EmitDefaultValue = false)]
