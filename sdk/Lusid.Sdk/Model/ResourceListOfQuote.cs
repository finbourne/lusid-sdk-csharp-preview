...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfQuote")]
    public partial class ResourceListOfQuote : IEquatable<ResourceListOfQuote>
    {
        ...
        public ResourceListOfQuote(List<Quote> values = default(List<Quote>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfQuote and cannot be null");
            this.Href = href;
            this.Links = links;
