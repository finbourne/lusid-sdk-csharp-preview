...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FundingLeg : InstrumentLeg,  IEquatable<FundingLeg>
    {
        ...
        public FundingLeg(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), LegDefinition legDefinition = default(LegDefinition), decimal? notional = default(decimal?), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for FundingLeg and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for FundingLeg and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("legDefinition is a required property for FundingLeg and cannot be null");
            }
            else
            {
            ...
            if (notional == null)
            {
                throw new InvalidDataException("notional is a required property for FundingLeg and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="legDefinition", EmitDefaultValue=false)]
