...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TradeTicket : IEquatable<TradeTicket>
    {
        /// <summary>
        ...
        /// <param name="instrumentIdentifiers">The set of identifiers that can be used to identify the instrument. (required).</param>
        ...
        /// <param name="instrumentProperties">The set of instrument properties wanted on the instrument from the trade ticket..</param>
        /// <param name="transactionProperties">The set of transaction properties wanted on the transaction from the trade ticket..</param>
        public TradeTicket(string transactionId = default(string), string type = default(string), string source = default(string), DateTimeOrCutLabel transactionDate = default(DateTimeOrCutLabel), DateTimeOrCutLabel settlementDate = default(DateTimeOrCutLabel), CurrencyAndAmount totalConsideration = default(CurrencyAndAmount), decimal units = default(decimal), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), string instrumentScope = default(string), string instrumentName = default(string), LusidInstrument instrumentDefinition = default(LusidInstrument), ResourceId counterpartyAgreementId = default(ResourceId), List<Property> instrumentProperties = default(List<Property>), List<Property> transactionProperties = default(List<Property>))
        {
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for TradeTicket and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for TradeTicket and cannot be null");
            // to ensure "transactionDate" is required (not null)
            this.TransactionDate = transactionDate ?? throw new ArgumentNullException("transactionDate is a required property for TradeTicket and cannot be null");
            // to ensure "settlementDate" is required (not null)
            this.SettlementDate = settlementDate ?? throw new ArgumentNullException("settlementDate is a required property for TradeTicket and cannot be null");
            // to ensure "totalConsideration" is required (not null)
            this.TotalConsideration = totalConsideration ?? throw new ArgumentNullException("totalConsideration is a required property for TradeTicket and cannot be null");
            this.Units = units;
            // to ensure "instrumentIdentifiers" is required (not null)
            this.InstrumentIdentifiers = instrumentIdentifiers ?? throw new ArgumentNullException("instrumentIdentifiers is a required property for TradeTicket and cannot be null");
            this.Source = source;
        ...
        /// </summary>
        /// <value>The set of instrument properties wanted on the instrument from the trade ticket.</value>
        ...
        /// </summary>
        /// <value>The set of transaction properties wanted on the transaction from the trade ticket.</value>
