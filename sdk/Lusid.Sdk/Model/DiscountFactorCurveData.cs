...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DiscountFactorCurveData : ComplexMarketData, IEquatable<DiscountFactorCurveData>
    {
        ...
        public DiscountFactorCurveData(DateTimeOffset baseDate = default(DateTimeOffset), List<DateTimeOffset> dates = default(List<DateTimeOffset>), List<decimal> discountFactors = default(List<decimal>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum), string lineage = default(string)) : base(marketDataType)
        {
