...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DiscountFactorCurveData : ComplexMarketData,  IEquatable<DiscountFactorCurveData>
    {
        ...
        public DiscountFactorCurveData(DateTimeOffset? baseDate = default(DateTimeOffset?), List<DateTimeOffset?> dates = default(List<DateTimeOffset?>), List<decimal?> discountFactors = default(List<decimal?>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base(marketDataType)
        {
            ...
            if (baseDate == null)
            {
                throw new InvalidDataException("baseDate is a required property for DiscountFactorCurveData and cannot be null");
            }
            else
            {
            ...
            if (dates == null)
            {
                throw new InvalidDataException("dates is a required property for DiscountFactorCurveData and cannot be null");
            }
            else
            {
                this.Dates = dates;
            ...
            {
                throw new InvalidDataException("discountFactors is a required property for DiscountFactorCurveData and cannot be null");
            }
            else
            {
