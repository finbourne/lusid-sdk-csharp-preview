...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfComplianceRunInfoV2 : IEquatable<PagedResourceListOfComplianceRunInfoV2>
    {
        /// <summary>
        ...
        public PagedResourceListOfComplianceRunInfoV2(string nextPage = default(string), string previousPage = default(string), List<ComplianceRunInfoV2> values = default(List<ComplianceRunInfoV2>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfComplianceRunInfoV2 and cannot be null");
