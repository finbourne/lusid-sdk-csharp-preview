...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CompletePortfolio : IEquatable<CompletePortfolio>
    {
        ...
        public CompletePortfolio(ResourceId id = default(ResourceId), string href = default(string), string description = default(string), string displayName = default(string), DateTimeOffset created = default(DateTimeOffset), ResourceId parentPortfolioId = default(ResourceId), TypeEnum? type = default(TypeEnum?), Version version = default(Version), List<Property> properties = default(List<Property>), string baseCurrency = default(string), List<string> subHoldingKeys = default(List<string>), List<Link> links = default(List<Link>))
        {
