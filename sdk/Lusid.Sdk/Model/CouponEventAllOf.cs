...
namespace Lusid.Sdk.Model
{
    ...
    /// CouponEventAllOf
    /// </summary>
    [DataContract(Name = "CouponEvent_allOf")]
    public partial class CouponEventAllOf : IEquatable<CouponEventAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CouponEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponEventAllOf" /> class.
        /// </summary>
        ...
        public CouponEventAllOf(DateTimeOffset anchorDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
        ...
        {
            return this.Equals(input as CouponEventAllOf);
        }

        /// <summary>
        /// Returns true if CouponEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponEventAllOf input)
        {
            if (input == null)
                return false;
