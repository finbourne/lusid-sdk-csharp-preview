...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CleardownModuleDetails")]
    public partial class CleardownModuleDetails : IEquatable<CleardownModuleDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CleardownModuleDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CleardownModuleDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CleardownModuleDetails" /> class.
        /// </summary>
        ...
        public CleardownModuleDetails(string displayName = default(string), string description = default(string), string status = default(string))
        {
            ...
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CleardownModuleDetails and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for CleardownModuleDetails and cannot be null");
        ...
        {
            return this.Equals(input as CleardownModuleDetails);
        }

        /// <summary>
        /// Returns true if CleardownModuleDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of CleardownModuleDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CleardownModuleDetails input)
        {
            if (input == null)
                return false;
