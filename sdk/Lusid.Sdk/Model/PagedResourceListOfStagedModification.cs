...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfStagedModification : IEquatable<PagedResourceListOfStagedModification>
    {
        /// <summary>
        ...
        public PagedResourceListOfStagedModification(string nextPage = default(string), string previousPage = default(string), List<StagedModification> values = default(List<StagedModification>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfStagedModification and cannot be null");
