...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfPortfolioSearchResult :  IEquatable<PagedResourceListOfPortfolioSearchResult>
    {
        ...
        public PagedResourceListOfPortfolioSearchResult(List<PortfolioSearchResult> values = default(List<PortfolioSearchResult>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
