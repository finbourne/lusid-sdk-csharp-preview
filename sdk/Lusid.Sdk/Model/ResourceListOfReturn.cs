...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfReturn")]
    public partial class ResourceListOfReturn : IEquatable<ResourceListOfReturn>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfReturn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfReturn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfReturn" /> class.
        /// </summary>
        ...
        public ResourceListOfReturn(List<Return> values = default(List<Return>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfReturn and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<Return> Values { get; set; }
        ...
        {
            return this.Equals(input as ResourceListOfReturn);
        }

        /// <summary>
        /// Returns true if ResourceListOfReturn instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfReturn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfReturn input)
        {
            if (input == null)
                return false;
