...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfReturn :  IEquatable<ResourceListOfReturn>
    {
        ...
        public ResourceListOfReturn(List<Return> values = default(List<Return>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
