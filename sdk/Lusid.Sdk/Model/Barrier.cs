...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Barrier")]
    public partial class Barrier : IEquatable<Barrier>
    {
        /// <summary>
        ...
        public Barrier(string direction = default(string), decimal level = default(decimal), string monitoring = default(string), string type = default(string))
        {
            ...
            this.Direction = direction ?? throw new ArgumentNullException("direction is a required property for Barrier and cannot be null");
            this.Level = level;
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for Barrier and cannot be null");
        ...
        /// </summary>
        /// <value>Supported string (enumeration) values are: [Knockin, Knockout].</value>
        ...
        {
            return this.Equals(input as Barrier);
        }

        /// <summary>
        /// Returns true if Barrier instances are equal
        /// </summary>
        /// <param name="input">Instance of Barrier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Barrier input)
        {
            if (input == null)
                return false;
