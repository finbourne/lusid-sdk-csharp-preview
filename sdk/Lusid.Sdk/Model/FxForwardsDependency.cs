...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardsDependency : EconomicDependency, IEquatable<FxForwardsDependency>
    {
        /// <summary>
        ...
        /// <param name="dependencyType">The available values are: Opaque, Cash, Discounting, EquityCurve, EquityVol, Fx, FxForwards, FxVol, IndexProjection, IrVol, Quote, Vendor (required) (default to &quot;FxForwardsDependency&quot;).</param>
        public FxForwardsDependency(string domesticCurrency = default(string), string foreignCurrency = default(string), string curveType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base(dependencyType)
        {
            ...
            this.DomesticCurrency = domesticCurrency ?? throw new ArgumentNullException("domesticCurrency is a required property for FxForwardsDependency and cannot be null");
            // to ensure "foreignCurrency" is required (not null)
            this.ForeignCurrency = foreignCurrency ?? throw new ArgumentNullException("foreignCurrency is a required property for FxForwardsDependency and cannot be null");
            // to ensure "curveType" is required (not null)
            this.CurveType = curveType ?? throw new ArgumentNullException("curveType is a required property for FxForwardsDependency and cannot be null");
            this.Date = date;
        }
