...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupReconciliationComparisonRuleset : IEquatable<GroupReconciliationComparisonRuleset>
    {
        /// <summary>
        ...
        public GroupReconciliationComparisonRuleset(ResourceId id = default(ResourceId), string displayName = default(string), string reconciliationType = default(string), List<GroupReconciliationCoreAttributeRule> coreAttributeRules = default(List<GroupReconciliationCoreAttributeRule>), List<GroupReconciliationAggregateAttributeRule> aggregateAttributeRules = default(List<GroupReconciliationAggregateAttributeRule>), string href = default(string), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for GroupReconciliationComparisonRuleset and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for GroupReconciliationComparisonRuleset and cannot be null");
            // to ensure "reconciliationType" is required (not null)
            this.ReconciliationType = reconciliationType ?? throw new ArgumentNullException("reconciliationType is a required property for GroupReconciliationComparisonRuleset and cannot be null");
            // to ensure "coreAttributeRules" is required (not null)
            this.CoreAttributeRules = coreAttributeRules ?? throw new ArgumentNullException("coreAttributeRules is a required property for GroupReconciliationComparisonRuleset and cannot be null");
            // to ensure "aggregateAttributeRules" is required (not null)
            this.AggregateAttributeRules = aggregateAttributeRules ?? throw new ArgumentNullException("aggregateAttributeRules is a required property for GroupReconciliationComparisonRuleset and cannot be null");
            this.Href = href;
        ...
        [DataMember(Name = "coreAttributeRules", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "aggregateAttributeRules", IsRequired = true, EmitDefaultValue = false)]
