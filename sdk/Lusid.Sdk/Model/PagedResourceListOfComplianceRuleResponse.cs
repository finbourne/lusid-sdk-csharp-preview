...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfComplianceRuleResponse : IEquatable<PagedResourceListOfComplianceRuleResponse>
    {
        /// <summary>
        ...
        public PagedResourceListOfComplianceRuleResponse(string nextPage = default(string), string previousPage = default(string), List<ComplianceRuleResponse> values = default(List<ComplianceRuleResponse>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfComplianceRuleResponse and cannot be null");
