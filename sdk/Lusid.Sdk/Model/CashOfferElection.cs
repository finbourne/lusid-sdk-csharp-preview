...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashOfferElection : IEquatable<CashOfferElection>
    {
        /// <summary>
        ...
        public CashOfferElection(string cashOfferCurrency = default(string), decimal cashOfferPrice = default(decimal), string electionKey = default(string), bool isChosen = default(bool), bool isDefault = default(bool))
        {
            ...
            this.CashOfferCurrency = cashOfferCurrency ?? throw new ArgumentNullException("cashOfferCurrency is a required property for CashOfferElection and cannot be null");
            this.CashOfferPrice = cashOfferPrice;
            // to ensure "electionKey" is required (not null)
            this.ElectionKey = electionKey ?? throw new ArgumentNullException("electionKey is a required property for CashOfferElection and cannot be null");
        ...
        [DataMember(Name = "cashOfferCurrency", IsRequired = true, EmitDefaultValue = false)]
