...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TranslateTradeTicketRequest : IEquatable<TranslateTradeTicketRequest>
    {
        /// <summary>
        ...
        public TranslateTradeTicketRequest(Dictionary<string, TradeTicket> tickets = default(Dictionary<string, TradeTicket>), string dialect = default(string))
        {
            ...
            this.Tickets = tickets ?? throw new ArgumentNullException("tickets is a required property for TranslateTradeTicketRequest and cannot be null");
            // to ensure "dialect" is required (not null)
            this.Dialect = dialect ?? throw new ArgumentNullException("dialect is a required property for TranslateTradeTicketRequest and cannot be null");
        }
