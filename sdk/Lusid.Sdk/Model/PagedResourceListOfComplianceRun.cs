...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfComplianceRun")]
    public partial class PagedResourceListOfComplianceRun : IEquatable<PagedResourceListOfComplianceRun>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfComplianceRun" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfComplianceRun() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfComplianceRun" /> class.
        /// </summary>
        ...
        public PagedResourceListOfComplianceRun(string nextPage = default(string), string previousPage = default(string), List<ComplianceRun> values = default(List<ComplianceRun>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfComplianceRun and cannot be null");
        ...
        public List<ComplianceRun> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResourceListOfComplianceRun {\n");
        ...
        {
            return this.Equals(input as PagedResourceListOfComplianceRun);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfComplianceRun instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfComplianceRun to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfComplianceRun input)
        {
            if (input == null)
                return false;
