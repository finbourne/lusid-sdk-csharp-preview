...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CancelOrdersAndMoveRemainingRequest : IEquatable<CancelOrdersAndMoveRemainingRequest>
    {
        /// <summary>
        ...
        public CancelOrdersAndMoveRemainingRequest(ResourceId cancelOrderId = default(ResourceId), ResourceId moveRemainingToOrderId = default(ResourceId), ResourceId moveRemainingToBlockId = default(ResourceId))
        {
            ...
            this.CancelOrderId = cancelOrderId ?? throw new ArgumentNullException("cancelOrderId is a required property for CancelOrdersAndMoveRemainingRequest and cannot be null");
            // to ensure "moveRemainingToOrderId" is required (not null)
            this.MoveRemainingToOrderId = moveRemainingToOrderId ?? throw new ArgumentNullException("moveRemainingToOrderId is a required property for CancelOrdersAndMoveRemainingRequest and cannot be null");
            // to ensure "moveRemainingToBlockId" is required (not null)
            this.MoveRemainingToBlockId = moveRemainingToBlockId ?? throw new ArgumentNullException("moveRemainingToBlockId is a required property for CancelOrdersAndMoveRemainingRequest and cannot be null");
        }

        /// <summary>
        /// Gets or Sets CancelOrderId
        /// </summary>
        [DataMember(Name = "cancelOrderId", IsRequired = true, EmitDefaultValue = false)]
        public ResourceId CancelOrderId { get; set; }

        /// <summary>
        /// Gets or Sets MoveRemainingToOrderId
        /// </summary>
        [DataMember(Name = "moveRemainingToOrderId", IsRequired = true, EmitDefaultValue = false)]
        public ResourceId MoveRemainingToOrderId { get; set; }

        /// <summary>
        /// Gets or Sets MoveRemainingToBlockId
        /// </summary>
        [DataMember(Name = "moveRemainingToBlockId", IsRequired = true, EmitDefaultValue = false)]
