...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfReconciliationRunBreak : IEquatable<PagedResourceListOfReconciliationRunBreak>
    {
        /// <summary>
        ...
        public PagedResourceListOfReconciliationRunBreak(string nextPage = default(string), string previousPage = default(string), List<ReconciliationRunBreak> values = default(List<ReconciliationRunBreak>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfReconciliationRunBreak and cannot be null");
