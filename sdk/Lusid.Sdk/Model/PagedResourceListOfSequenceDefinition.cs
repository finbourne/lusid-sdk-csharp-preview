...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfSequenceDefinition")]
    public partial class PagedResourceListOfSequenceDefinition : IEquatable<PagedResourceListOfSequenceDefinition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfSequenceDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfSequenceDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfSequenceDefinition" /> class.
        /// </summary>
        ...
        public PagedResourceListOfSequenceDefinition(string nextPage = default(string), string previousPage = default(string), List<SequenceDefinition> values = default(List<SequenceDefinition>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfSequenceDefinition and cannot be null");
        ...
        public List<SequenceDefinition> Values { get; set; }
        ...
        {
            return this.Equals(input as PagedResourceListOfSequenceDefinition);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfSequenceDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfSequenceDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfSequenceDefinition input)
        {
            if (input == null)
                return false;
