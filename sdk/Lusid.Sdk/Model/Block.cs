...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Block :  IEquatable<Block>
    {
        ...
        public Block(ResourceId id = default(ResourceId), List<ResourceId> orderIds = default(List<ResourceId>), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), string lusidInstrumentId = default(string), decimal? quantity = default(decimal?), string side = default(string), string type = default(string), string timeInForce = default(string), DateTimeOffset? createdDate = default(DateTimeOffset?), CurrencyAndAmount limitPrice = default(CurrencyAndAmount), CurrencyAndAmount stopPrice = default(CurrencyAndAmount), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            ...
            if (orderIds == null)
            {
                throw new InvalidDataException("orderIds is a required property for Block and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instrumentIdentifiers is a required property for Block and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("lusidInstrumentId is a required property for Block and cannot be null");
            }
            else
            {
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for Block and cannot be null");
            }
            else
            {
            ...
            if (side == null)
            {
                throw new InvalidDataException("side is a required property for Block and cannot be null");
            }
            else
            {
                this.Side = side;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Block and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (timeInForce == null)
            {
                throw new InvalidDataException("timeInForce is a required property for Block and cannot be null");
            }
            else
            {
            ...
            if (createdDate == null)
            {
                throw new InvalidDataException("createdDate is a required property for Block and cannot be null");
            }
            else
            {
