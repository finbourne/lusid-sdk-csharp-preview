...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfTransactionType : IEquatable<ResourceListOfTransactionType>
    {
        /// <summary>
        ...
        public ResourceListOfTransactionType(List<TransactionType> values = default(List<TransactionType>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfTransactionType and cannot be null");
            this.Href = href;
            this.Links = links;
