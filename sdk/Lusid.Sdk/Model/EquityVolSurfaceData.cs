...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityVolSurfaceData : ComplexMarketData, IEquatable<EquityVolSurfaceData>
    {
        ...
        /// <param name="marketDataType">The available values are: DiscountFactorCurveData, EquityVolSurfaceData, FxVolSurfaceData, IrVolCubeData, OpaqueMarketData, YieldCurveData, FxForwardCurveData, FxForwardPipsCurveData, FxForwardTenorCurveData, FxForwardTenorPipsCurveData, FxForwardCurveByQuoteReference, CreditSpreadCurveData (required) (default to &quot;EquityVolSurfaceData&quot;).</param>
        /// <param name="lineage">Description of the complex market data&#39;s lineage e.g. &#39;FundAccountant_GreenQuality&#39;..</param>
        public EquityVolSurfaceData(DateTimeOffset baseDate = default(DateTimeOffset), List<LusidInstrument> instruments = default(List<LusidInstrument>), List<MarketQuote> quotes = default(List<MarketQuote>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum), string lineage = default(string)) : base(marketDataType)
        {
            this.BaseDate = baseDate;
            // to ensure "instruments" is required (not null)
            this.Instruments = instruments ?? throw new ArgumentNullException("instruments is a required property for EquityVolSurfaceData and cannot be null");
            // to ensure "quotes" is required (not null)
            this.Quotes = quotes ?? throw new ArgumentNullException("quotes is a required property for EquityVolSurfaceData and cannot be null");
