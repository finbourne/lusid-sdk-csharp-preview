...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ElectionSpecification : IEquatable<ElectionSpecification>
    {
        /// <summary>
        ...
        public ElectionSpecification(string electionType = default(string), Dictionary<string, string> cardinality = default(Dictionary<string, string>), List<string> referencedAs = default(List<string>))
        {
            ...
            this.ElectionType = electionType ?? throw new ArgumentNullException("electionType is a required property for ElectionSpecification and cannot be null");
            // to ensure "cardinality" is required (not null)
            this.Cardinality = cardinality ?? throw new ArgumentNullException("cardinality is a required property for ElectionSpecification and cannot be null");
            // to ensure "referencedAs" is required (not null)
            this.ReferencedAs = referencedAs ?? throw new ArgumentNullException("referencedAs is a required property for ElectionSpecification and cannot be null");
        }

        /// <summary>
        /// Gets or Sets ElectionType
        /// </summary>
        [DataMember(Name = "electionType", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "referencedAs", IsRequired = true, EmitDefaultValue = false)]
