...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfGroupReconciliationComparisonRuleset : IEquatable<PagedResourceListOfGroupReconciliationComparisonRuleset>
    {
        /// <summary>
        ...
        public PagedResourceListOfGroupReconciliationComparisonRuleset(string nextPage = default(string), string previousPage = default(string), List<GroupReconciliationComparisonRuleset> values = default(List<GroupReconciliationComparisonRuleset>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfGroupReconciliationComparisonRuleset and cannot be null");
