...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Repo : LusidInstrument,  IEquatable<Repo>
    {
        ...
        public Repo(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), string domCcy = default(string), string accrualBasis = default(string), decimal? collateralValue = default(decimal?), decimal? margin = default(decimal?), decimal? repoRate = default(decimal?), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for Repo and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for Repo and cannot be null");
            }
            else
            {
            ...
            if (domCcy == null)
            {
                throw new InvalidDataException("domCcy is a required property for Repo and cannot be null");
            }
            else
            {
                this.DomCcy = domCcy;
            ...
            {
                throw new InvalidDataException("accrualBasis is a required property for Repo and cannot be null");
            }
            else
            {
            ...
            // to ensure "collateralValue" is required (not null)
            if (collateralValue == null)
            {
                throw new InvalidDataException("collateralValue is a required property for Repo and cannot be null");
            }
            else
            {
            ...
            if (margin == null)
            {
                throw new InvalidDataException("margin is a required property for Repo and cannot be null");
            }
            else
            {
                this.Margin = margin;
            ...
            // to ensure "repoRate" is required (not null)
            if (repoRate == null)
            {
                throw new InvalidDataException("repoRate is a required property for Repo and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>For calculation of interest, the accrual basis to be used.  Supported string (enumeration) values are: [Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActualActual, ActAct, ActActIsda, ActActIsma, ActActIcma, OneOne, Act364, Act365F, Act365L, Act365_25, Act252, Bus252, NL360, NL365, Invalid].</value>
        [DataMember(Name="accrualBasis", EmitDefaultValue=false)]
        ...
        [DataMember(Name="collateralValue", EmitDefaultValue=false)]
