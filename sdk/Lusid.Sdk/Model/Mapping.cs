...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Mapping : IEquatable<Mapping>
    {
        ...
        /// </summary>
        /// <param name="scope">The scope for this mapping..</param>
        /// <param name="code">The code for this mapping..</param>
        /// <param name="name">The mapping name.</param>
        /// <param name="_for">What type of reconciliation this mapping is for.</param>
        /// <param name="rules">The rules in this mapping, keyed by the left field/property name.</param>
        public Mapping(string scope = default(string), string code = default(string), string name = default(string), string _for = default(string), List<MappingRule> rules = default(List<MappingRule>))
        {
            this.Scope = scope;
            this.Code = code;
            this.Name = name;
