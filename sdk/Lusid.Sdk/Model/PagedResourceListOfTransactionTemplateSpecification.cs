...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfTransactionTemplateSpecification : IEquatable<PagedResourceListOfTransactionTemplateSpecification>
    {
        /// <summary>
        ...
        public PagedResourceListOfTransactionTemplateSpecification(string nextPage = default(string), string previousPage = default(string), List<TransactionTemplateSpecification> values = default(List<TransactionTemplateSpecification>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfTransactionTemplateSpecification and cannot be null");
