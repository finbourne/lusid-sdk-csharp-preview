...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StockDividendEvent_allOf")]
    public partial class StockDividendEventAllOf : IEquatable<StockDividendEventAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StockDividendEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StockDividendEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StockDividendEventAllOf" /> class.
        /// </summary>
        ...
        public StockDividendEventAllOf(DateTimeOffset? announcementDate = default(DateTimeOffset?), DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), DateTimeOffset? recordDate = default(DateTimeOffset?), decimal? fractionalUnitsCashPrice = default(decimal?), string fractionalUnitsCashCurrency = default(string), UnitsRatio unitsRatio = default(UnitsRatio), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            this.ExDate = exDate;
            this.PaymentDate = paymentDate;
            // to ensure "unitsRatio" is required (not null)
            this.UnitsRatio = unitsRatio ?? throw new ArgumentNullException("unitsRatio is a required property for StockDividendEventAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StockDividendEventAllOf {\n");
        ...
        {
            return this.Equals(input as StockDividendEventAllOf);
        }

        /// <summary>
        /// Returns true if StockDividendEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StockDividendEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StockDividendEventAllOf input)
        {
            if (input == null)
                return false;
