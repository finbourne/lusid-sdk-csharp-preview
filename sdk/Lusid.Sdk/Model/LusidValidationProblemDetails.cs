...
namespace Lusid.Sdk.Model
{
    ...
    public partial class LusidValidationProblemDetails :  IEquatable<LusidValidationProblemDetails>
    {
        ...
        public LusidValidationProblemDetails(string name = default(string), List<Dictionary<string, string>> errorDetails = default(List<Dictionary<string, string>>), int? code = default(int?), string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string))
        {
