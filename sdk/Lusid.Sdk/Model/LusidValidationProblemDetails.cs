...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LusidValidationProblemDetails : Dictionary<String, Object>,  IEquatable<LusidValidationProblemDetails>, IValidatableObject
    {
        /// <summary>
        ...
        public LusidValidationProblemDetails(string name = default(string), List<Dictionary<string, string>> errorDetails = default(List<Dictionary<string, string>>), int code = default(int), string type = default(string), string title = default(string), int status = default(int), string detail = default(string), string instance = default(string)) : base()
        {
