...
namespace Lusid.Sdk.Model
{
    ...
    /// DecimalListAllOf
    /// </summary>
    [DataContract(Name = "DecimalList_allOf")]
    public partial class DecimalListAllOf : IEquatable<DecimalListAllOf>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The reference list values. The available values are: PortfolioGroupIdList, PortfolioIdList, AddressKeyList, StringList, InstrumentList, DecimalList, PropertyList</value>
        [DataMember(Name = "referenceListType", IsRequired = true, EmitDefaultValue = false)]
        public ReferenceListTypeEnum ReferenceListType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecimalListAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecimalListAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecimalListAllOf" /> class.
        /// </summary>
        ...
        public DecimalListAllOf(List<decimal> values = default(List<decimal>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for DecimalListAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecimalListAllOf {\n");
        ...
        {
            return this.Equals(input as DecimalListAllOf);
        }

        /// <summary>
        /// Returns true if DecimalListAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DecimalListAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecimalListAllOf input)
        {
            if (input == null)
                return false;
