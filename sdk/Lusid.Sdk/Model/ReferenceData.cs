...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReferenceData : IEquatable<ReferenceData>
    {
        /// <summary>
        ...
        public ReferenceData(List<FieldDefinition> fieldDefinitions = default(List<FieldDefinition>), List<FieldValue> values = default(List<FieldValue>))
        {
            ...
            this.FieldDefinitions = fieldDefinitions ?? throw new ArgumentNullException("fieldDefinitions is a required property for ReferenceData and cannot be null");
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ReferenceData and cannot be null");
        }

        /// <summary>
        /// Gets or Sets FieldDefinitions
        /// </summary>
        [DataMember(Name = "fieldDefinitions", IsRequired = true, EmitDefaultValue = false)]
