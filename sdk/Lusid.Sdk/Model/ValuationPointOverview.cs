...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ValuationPointOverview : IEquatable<ValuationPointOverview>
    {
        /// <summary>
        ...
        public ValuationPointOverview(string href = default(string), string diaryEntryCode = default(string), DateTimeOffset effectiveFrom = default(DateTimeOffset), DateTimeOffset effectiveTo = default(DateTimeOffset), DateTimeOffset queryAsAt = default(DateTimeOffset), string type = default(string), string status = default(string), decimal gav = default(decimal), decimal nav = default(decimal), Dictionary<string, Property> properties = default(Dictionary<string, Property>), List<Link> links = default(List<Link>))
        {
            ...
            this.DiaryEntryCode = diaryEntryCode ?? throw new ArgumentNullException("diaryEntryCode is a required property for ValuationPointOverview and cannot be null");
            this.EffectiveFrom = effectiveFrom;
            this.EffectiveTo = effectiveTo;
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ValuationPointOverview and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for ValuationPointOverview and cannot be null");
            this.Gav = gav;
            this.Nav = nav;
            this.Href = href;
        ...
        [DataMember(Name = "diaryEntryCode", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "effectiveTo", IsRequired = true, EmitDefaultValue = false)]
