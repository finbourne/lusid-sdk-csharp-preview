...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CdsFlowConventions :  IEquatable<CdsFlowConventions>
    {
        ...
        public CdsFlowConventions(Tenor rollFrequency = default(Tenor), string scope = default(string), string code = default(string), string currency = default(string), Tenor paymentFrequency = default(Tenor), DayCountConventionEnum dayCountConvention = default(DayCountConventionEnum), RollConventionEnum rollConvention = default(RollConventionEnum), List<string> holidayCalendars = default(List<string>))
        {
            // to ensure "rollFrequency" is required (not null)
            if (rollFrequency == null)
            {
                throw new InvalidDataException("rollFrequency is a required property for CdsFlowConventions and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("holidayCalendars is a required property for CdsFlowConventions and cannot be null");
            }
            else
            {
