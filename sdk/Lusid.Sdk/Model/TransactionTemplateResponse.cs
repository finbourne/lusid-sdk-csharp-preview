...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionTemplateResponse : IEquatable<TransactionTemplateResponse>
    {
        /// <summary>
        ...
        public TransactionTemplateResponse(string instrumentEventType = default(string), string description = default(string), string scope = default(string), List<ComponentTransaction> componentTransactions = default(List<ComponentTransaction>), List<Link> links = default(List<Link>))
        {
            ...
            this.InstrumentEventType = instrumentEventType ?? throw new ArgumentNullException("instrumentEventType is a required property for TransactionTemplateResponse and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for TransactionTemplateResponse and cannot be null");
            // to ensure "scope" is required (not null)
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for TransactionTemplateResponse and cannot be null");
            // to ensure "componentTransactions" is required (not null)
            this.ComponentTransactions = componentTransactions ?? throw new ArgumentNullException("componentTransactions is a required property for TransactionTemplateResponse and cannot be null");
            this.Links = links;
        }
