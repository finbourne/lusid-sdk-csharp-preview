...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateAnalyticStoreRequest :  IEquatable<CreateAnalyticStoreRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAnalyticStoreRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAnalyticStoreRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAnalyticStoreRequest" /> class.
        /// </summary>
        /// <param name="scope">scope (required).</param>
        /// <param name="date">date (required).</param>
        public CreateAnalyticStoreRequest(string scope = default(string), DateTimeOffset? date = default(DateTimeOffset?))
        {
            // to ensure "scope" is required (not null)
            if (scope == null)
            {
                throw new InvalidDataException("scope is a required property for CreateAnalyticStoreRequest and cannot be null");
            }
            else
            {
                this.Scope = scope;
            ...
            if (date == null)
            {
                throw new InvalidDataException("date is a required property for CreateAnalyticStoreRequest and cannot be null");
            }
            else
            {
                this.Date = date;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAnalyticStoreRequest {\n");
        ...
        {
            return this.Equals(input as CreateAnalyticStoreRequest);
        }

        /// <summary>
        /// Returns true if CreateAnalyticStoreRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAnalyticStoreRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAnalyticStoreRequest input)
        {
            if (input == null)
                return false;
