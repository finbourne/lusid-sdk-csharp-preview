...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfDataTypeSummary : IEquatable<PagedResourceListOfDataTypeSummary>
    {
        /// <summary>
        ...
        public PagedResourceListOfDataTypeSummary(string nextPage = default(string), string previousPage = default(string), List<DataTypeSummary> values = default(List<DataTypeSummary>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfDataTypeSummary and cannot be null");
