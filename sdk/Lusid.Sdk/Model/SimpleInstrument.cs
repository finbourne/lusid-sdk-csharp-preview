...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SimpleInstrument : LusidInstrument,  IEquatable<SimpleInstrument>
    {
        ...
        public SimpleInstrument(DateTimeOffset? maturityDate = default(DateTimeOffset?), string domCcy = default(string), AssetClassEnum assetClass = default(AssetClassEnum), List<string> fgnCcys = default(List<string>), string simpleInstrumentType = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            if (domCcy == null)
            {
                throw new InvalidDataException("domCcy is a required property for SimpleInstrument and cannot be null");
            }
            else
            {
                this.DomCcy = domCcy;
            ...
            // to ensure "assetClass" is required (not null)
            if (assetClass == null)
            {
                throw new InvalidDataException("assetClass is a required property for SimpleInstrument and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("simpleInstrumentType is a required property for SimpleInstrument and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="simpleInstrumentType", EmitDefaultValue=false)]
