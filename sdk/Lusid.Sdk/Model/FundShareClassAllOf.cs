...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FundShareClassAllOf : IEquatable<FundShareClassAllOf>
    {
        /// <summary>
        ...
        public FundShareClassAllOf(string shortCode = default(string), string fundShareClassType = default(string), string distributionPaymentType = default(string), string hedging = default(string), string domCcy = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.ShortCode = shortCode ?? throw new ArgumentNullException("shortCode is a required property for FundShareClassAllOf and cannot be null");
            // to ensure "fundShareClassType" is required (not null)
            this.FundShareClassType = fundShareClassType ?? throw new ArgumentNullException("fundShareClassType is a required property for FundShareClassAllOf and cannot be null");
            // to ensure "distributionPaymentType" is required (not null)
            this.DistributionPaymentType = distributionPaymentType ?? throw new ArgumentNullException("distributionPaymentType is a required property for FundShareClassAllOf and cannot be null");
            // to ensure "hedging" is required (not null)
            this.Hedging = hedging ?? throw new ArgumentNullException("hedging is a required property for FundShareClassAllOf and cannot be null");
            // to ensure "domCcy" is required (not null)
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for FundShareClassAllOf and cannot be null");
