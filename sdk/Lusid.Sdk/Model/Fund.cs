...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Fund : IEquatable<Fund>
    {
        /// <summary>
        ...
        public Fund(string href = default(string), ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), ResourceId aborId = default(ResourceId), List<InstrumentResolutionDetail> shareClassInstruments = default(List<InstrumentResolutionDetail>), string type = default(string), DateTimeOffset inceptionDate = default(DateTimeOffset), int? decimalPlaces = default(int?), DayMonth yearEndDate = default(DayMonth), Dictionary<string, Property> properties = default(Dictionary<string, Property>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Fund and cannot be null");
            // to ensure "aborId" is required (not null)
            this.AborId = aborId ?? throw new ArgumentNullException("aborId is a required property for Fund and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for Fund and cannot be null");
            this.InceptionDate = inceptionDate;
            // to ensure "yearEndDate" is required (not null)
            this.YearEndDate = yearEndDate ?? throw new ArgumentNullException("yearEndDate is a required property for Fund and cannot be null");
            this.Href = href;
        ...
        /// Gets or Sets AborId
        /// </summary>
        [DataMember(Name = "aborId", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "inceptionDate", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "yearEndDate", IsRequired = true, EmitDefaultValue = false)]
