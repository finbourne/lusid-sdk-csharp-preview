...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfComplianceRule")]
    public partial class ResourceListOfComplianceRule : IEquatable<ResourceListOfComplianceRule>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfComplianceRule" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfComplianceRule() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfComplianceRule" /> class.
        /// </summary>
        ...
        public ResourceListOfComplianceRule(List<ComplianceRule> values = default(List<ComplianceRule>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfComplianceRule and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<ComplianceRule> Values { get; set; }
        ...
        {
            return this.Equals(input as ResourceListOfComplianceRule);
        }

        /// <summary>
        /// Returns true if ResourceListOfComplianceRule instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfComplianceRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfComplianceRule input)
        {
            if (input == null)
                return false;
