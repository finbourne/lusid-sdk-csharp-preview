...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VersionedResourceListOfA2BDataRecord")]
    public partial class VersionedResourceListOfA2BDataRecord : IEquatable<VersionedResourceListOfA2BDataRecord>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionedResourceListOfA2BDataRecord" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VersionedResourceListOfA2BDataRecord() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionedResourceListOfA2BDataRecord" /> class.
        /// </summary>
        ...
        public VersionedResourceListOfA2BDataRecord(Version version = default(Version), List<A2BDataRecord> values = default(List<A2BDataRecord>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Version = version ?? throw new ArgumentNullException("version is a required property for VersionedResourceListOfA2BDataRecord and cannot be null");
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for VersionedResourceListOfA2BDataRecord and cannot be null");
            this.Href = href;
        ...
        {
            return this.Equals(input as VersionedResourceListOfA2BDataRecord);
        }

        /// <summary>
        /// Returns true if VersionedResourceListOfA2BDataRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of VersionedResourceListOfA2BDataRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VersionedResourceListOfA2BDataRecord input)
        {
            if (input == null)
                return false;
