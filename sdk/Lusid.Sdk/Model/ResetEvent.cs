...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResetEvent : InstrumentEvent, IEquatable<ResetEvent>
    {
        /// <summary>
        ...
        /// <param name="instrumentEventType">The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent (required) (default to &quot;ResetEvent&quot;).</param>
        public ResetEvent(decimal? value = default(decimal?), string resetType = default(string), string fixingSource = default(string), string eventStatus = default(string), DateTimeOffset fixingDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base(instrumentEventType)
        {
            ...
            this.ResetType = resetType ?? throw new ArgumentNullException("resetType is a required property for ResetEvent and cannot be null");
            // to ensure "eventStatus" is required (not null)
            this.EventStatus = eventStatus ?? throw new ArgumentNullException("eventStatus is a required property for ResetEvent and cannot be null");
        ...
        [DataMember(Name = "resetType", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "eventStatus", IsRequired = true, EmitDefaultValue = false)]
