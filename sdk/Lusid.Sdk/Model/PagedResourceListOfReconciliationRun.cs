...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfReconciliationRun : IEquatable<PagedResourceListOfReconciliationRun>
    {
        /// <summary>
        ...
        public PagedResourceListOfReconciliationRun(string nextPage = default(string), string previousPage = default(string), List<ReconciliationRun> values = default(List<ReconciliationRun>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfReconciliationRun and cannot be null");
