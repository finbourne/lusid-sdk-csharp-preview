...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AdditionalPayment : IEquatable<AdditionalPayment>
    {
        /// <summary>
        ...
        public AdditionalPayment(decimal amount = default(decimal), string currency = default(string), DateTimeOffset payDate = default(DateTimeOffset), string payReceive = default(string))
        {
            ...
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for AdditionalPayment and cannot be null");
            this.PayDate = payDate;
            // to ensure "payReceive" is required (not null)
            this.PayReceive = payReceive ?? throw new ArgumentNullException("payReceive is a required property for AdditionalPayment and cannot be null");
        }
        ...
        [DataMember(Name = "payDate", IsRequired = true, EmitDefaultValue = false)]
