...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TaxRule : IEquatable<TaxRule>
    {
        /// <summary>
        ...
        /// <param name="rate">The rate to be applied if all conditions are met (required).</param>
        /// <param name="criteria">A set of conditions to be met for this rule to be applied (required).</param>
        /// <param name="links">Collection of links..</param>
        public TaxRule(string name = default(string), string description = default(string), decimal rate = default(decimal), List<PropertyCriterion> criteria = default(List<PropertyCriterion>), List<Link> links = default(List<Link>))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for TaxRule and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for TaxRule and cannot be null");
            this.Rate = rate;
            // to ensure "criteria" is required (not null)
            this.Criteria = criteria ?? throw new ArgumentNullException("criteria is a required property for TaxRule and cannot be null");
            this.Links = links;
        }
        ...
        /// </summary>
        /// <value>The rate to be applied if all conditions are met</value>
        ...
        /// </summary>
        /// <value>A set of conditions to be met for this rule to be applied</value>
        [DataMember(Name = "criteria", IsRequired = true, EmitDefaultValue = false)]
        public List<PropertyCriterion> Criteria { get; set; }
