...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfChangeIntervalWithOrderManagementDetail : IEquatable<ResourceListOfChangeIntervalWithOrderManagementDetail>
    {
        /// <summary>
        ...
        public ResourceListOfChangeIntervalWithOrderManagementDetail(List<ChangeIntervalWithOrderManagementDetail> values = default(List<ChangeIntervalWithOrderManagementDetail>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfChangeIntervalWithOrderManagementDetail and cannot be null");
            this.Href = href;
            this.Links = links;
