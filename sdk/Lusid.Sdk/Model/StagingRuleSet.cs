...
namespace Lusid.Sdk.Model
{
    ...
    public partial class StagingRuleSet : IEquatable<StagingRuleSet>
    {
        /// <summary>
        ...
        public StagingRuleSet(string entityType = default(string), string stagingRuleSetId = default(string), string displayName = default(string), string description = default(string), List<StagingRule> rules = default(List<StagingRule>), string href = default(string), Version version = default(Version))
        {
            // to ensure "entityType" is required (not null)
            this.EntityType = entityType ?? throw new ArgumentNullException("entityType is a required property for StagingRuleSet and cannot be null");
            // to ensure "stagingRuleSetId" is required (not null)
            this.StagingRuleSetId = stagingRuleSetId ?? throw new ArgumentNullException("stagingRuleSetId is a required property for StagingRuleSet and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for StagingRuleSet and cannot be null");
            // to ensure "rules" is required (not null)
            this.Rules = rules ?? throw new ArgumentNullException("rules is a required property for StagingRuleSet and cannot be null");
        ...
        [DataMember(Name = "stagingRuleSetId", IsRequired = true, EmitDefaultValue = false)]
