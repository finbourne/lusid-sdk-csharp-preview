...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortfoliosReconciliationRequestPreview :  IEquatable<PortfoliosReconciliationRequestPreview>, IValidatableObject
    {
        /// <summary>
        ...
        public PortfoliosReconciliationRequestPreview(Dictionary<string, Tolerance> tolerance = default(Dictionary<string, Tolerance>), PortfolioReconciliationRequest left = default(PortfolioReconciliationRequest), PortfolioReconciliationRequest right = default(PortfolioReconciliationRequest), List<string> instrumentPropertyKeys = default(List<string>))
        {
            ...
            this.Left = left ?? throw new ArgumentNullException("left is a required property for PortfoliosReconciliationRequestPreview and cannot be null");;
            // to ensure "right" is required (not null)
            this.Right = right ?? throw new ArgumentNullException("right is a required property for PortfoliosReconciliationRequestPreview and cannot be null");;
            // to ensure "instrumentPropertyKeys" is required (not null)
            this.InstrumentPropertyKeys = instrumentPropertyKeys ?? throw new ArgumentNullException("instrumentPropertyKeys is a required property for PortfoliosReconciliationRequestPreview and cannot be null");;
