...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupReconciliationAggregateAttributeRule : IEquatable<GroupReconciliationAggregateAttributeRule>
    {
        /// <summary>
        ...
        public GroupReconciliationAggregateAttributeRule(GroupReconciliationAggregateComparisonRuleOperand left = default(GroupReconciliationAggregateComparisonRuleOperand), GroupReconciliationAggregateComparisonRuleOperand right = default(GroupReconciliationAggregateComparisonRuleOperand), GroupReconciliationComparisonRuleTolerance tolerance = default(GroupReconciliationComparisonRuleTolerance))
        {
            ...
            this.Left = left ?? throw new ArgumentNullException("left is a required property for GroupReconciliationAggregateAttributeRule and cannot be null");
            // to ensure "right" is required (not null)
            this.Right = right ?? throw new ArgumentNullException("right is a required property for GroupReconciliationAggregateAttributeRule and cannot be null");
            // to ensure "tolerance" is required (not null)
            this.Tolerance = tolerance ?? throw new ArgumentNullException("tolerance is a required property for GroupReconciliationAggregateAttributeRule and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "tolerance", IsRequired = true, EmitDefaultValue = false)]
