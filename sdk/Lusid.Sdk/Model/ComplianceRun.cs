...
namespace Lusid.Sdk.Model
{
    ...
    /// ComplianceRun
    /// </summary>
    [DataContract(Name = "ComplianceRun")]
    public partial class ComplianceRun : IEquatable<ComplianceRun>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplianceRun" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ComplianceRun() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplianceRun" /> class.
        /// </summary>
        /// <param name="runId">The unique identifier of a compliance run (required).</param>
        /// <param name="asAt">The date at time at which the compliance run was run (required).</param>
        public ComplianceRun(string runId = default(string), DateTimeOffset asAt = default(DateTimeOffset))
        {
            // to ensure "runId" is required (not null)
            this.RunId = runId ?? throw new ArgumentNullException("runId is a required property for ComplianceRun and cannot be null");
            this.AsAt = asAt;
        }
        ...
        /// </summary>
        /// <value>The date at time at which the compliance run was run</value>
        ...
        {
            return this.Equals(input as ComplianceRun);
        }

        /// <summary>
        /// Returns true if ComplianceRun instances are equal
        /// </summary>
        /// <param name="input">Instance of ComplianceRun to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComplianceRun input)
        {
            if (input == null)
                return false;
