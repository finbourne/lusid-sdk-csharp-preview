...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashFlowEventAllOf : IEquatable<CashFlowEventAllOf>
    {
        ...
        public CashFlowEventAllOf(decimal? amount = default(decimal?), string currency = default(string), string eventStatus = default(string), DateTimeOffset paymentDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for CashFlowEventAllOf and cannot be null");
