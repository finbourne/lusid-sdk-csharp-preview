...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OpaqueMarketData : ComplexMarketData,  IEquatable<OpaqueMarketData>
    {
        ...
        public OpaqueMarketData(string document = default(string), string format = default(string), string name = default(string), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base(marketDataType)
        {
            ...
            if (document == null)
            {
                throw new InvalidDataException("document is a required property for OpaqueMarketData and cannot be null");
            }
            else
            {
            ...
            if (format == null)
            {
                throw new InvalidDataException("format is a required property for OpaqueMarketData and cannot be null");
            }
            else
            {
                this.Format = format;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for OpaqueMarketData and cannot be null");
            }
            else
            {
                this.Name = name;
