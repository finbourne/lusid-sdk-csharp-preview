...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupFilterStep : ComplianceStep, IEquatable<GroupFilterStep>
    {
        /// <summary>
        ...
        /// <param name="complianceStepType">. The available values are: FilterStep, GroupByStep, GroupFilterStep, BranchStep, RecombineStep, CheckStep (required) (default to &quot;GroupFilterStep&quot;).</param>
        public GroupFilterStep(string label = default(string), List<ComplianceTemplateParameter> limitCheckParameters = default(List<ComplianceTemplateParameter>), List<ComplianceTemplateParameter> warningCheckParameters = default(List<ComplianceTemplateParameter>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum)) : base(complianceStepType)
        {
            // to ensure "label" is required (not null)
            this.Label = label ?? throw new ArgumentNullException("label is a required property for GroupFilterStep and cannot be null");
            // to ensure "limitCheckParameters" is required (not null)
            this.LimitCheckParameters = limitCheckParameters ?? throw new ArgumentNullException("limitCheckParameters is a required property for GroupFilterStep and cannot be null");
            // to ensure "warningCheckParameters" is required (not null)
            this.WarningCheckParameters = warningCheckParameters ?? throw new ArgumentNullException("warningCheckParameters is a required property for GroupFilterStep and cannot be null");
        }
