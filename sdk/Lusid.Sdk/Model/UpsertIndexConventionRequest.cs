...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertIndexConventionRequest : IEquatable<UpsertIndexConventionRequest>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpsertIndexConventionRequest);
        }

        /// <summary>
        /// Returns true if UpsertIndexConventionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpsertIndexConventionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpsertIndexConventionRequest input)
        {
            if (input == null)
                return false;
