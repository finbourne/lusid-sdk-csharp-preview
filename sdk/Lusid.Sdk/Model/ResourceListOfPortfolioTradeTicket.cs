...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfPortfolioTradeTicket : IEquatable<ResourceListOfPortfolioTradeTicket>
    {
        /// <summary>
        ...
        public ResourceListOfPortfolioTradeTicket(List<PortfolioTradeTicket> values = default(List<PortfolioTradeTicket>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfPortfolioTradeTicket and cannot be null");
            this.Href = href;
            this.Links = links;
