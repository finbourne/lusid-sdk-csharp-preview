...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DialectSchema : IEquatable<DialectSchema>
    {
        /// <summary>
        ...
        public DialectSchema(string type = default(string), string body = default(string))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for DialectSchema and cannot be null");
            this.Body = body;
        }
