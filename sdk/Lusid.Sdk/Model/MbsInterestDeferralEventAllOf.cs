...
{
    /// <summary>
    /// MbsInterestDeferralEventAllOf
    /// </summary>
    [DataContract(Name = "MbsInterestDeferralEvent_allOf")]
    public partial class MbsInterestDeferralEventAllOf : IEquatable<MbsInterestDeferralEventAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MbsInterestDeferralEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MbsInterestDeferralEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MbsInterestDeferralEventAllOf" /> class.
        /// </summary>
        ...
        public MbsInterestDeferralEventAllOf(DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), decimal interestPerUnit = default(decimal), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            this.ExDate = exDate;
            this.PaymentDate = paymentDate;
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for MbsInterestDeferralEventAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MbsInterestDeferralEventAllOf {\n");
        ...
        {
            return this.Equals(input as MbsInterestDeferralEventAllOf);
        }

        /// <summary>
        /// Returns true if MbsInterestDeferralEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MbsInterestDeferralEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MbsInterestDeferralEventAllOf input)
        {
            if (input == null)
                return false;
