...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfDialectId : IEquatable<PagedResourceListOfDialectId>
    {
        /// <summary>
        ...
        public PagedResourceListOfDialectId(string nextPage = default(string), string previousPage = default(string), List<DialectId> values = default(List<DialectId>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfDialectId and cannot be null");
