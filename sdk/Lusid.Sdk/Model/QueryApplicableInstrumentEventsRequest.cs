...
namespace Lusid.Sdk.Model
{
    ...
    public partial class QueryApplicableInstrumentEventsRequest : IEquatable<QueryApplicableInstrumentEventsRequest>
    {
        /// <summary>
        ...
        public QueryApplicableInstrumentEventsRequest(DateTimeOffset windowStart = default(DateTimeOffset), DateTimeOffset windowEnd = default(DateTimeOffset), DateTimeOffset effectiveAt = default(DateTimeOffset), List<PortfolioEntityId> portfolioEntityIds = default(List<PortfolioEntityId>), ResourceId forecastingRecipeId = default(ResourceId))
        {
            ...
            this.PortfolioEntityIds = portfolioEntityIds ?? throw new ArgumentNullException("portfolioEntityIds is a required property for QueryApplicableInstrumentEventsRequest and cannot be null");
            // to ensure "forecastingRecipeId" is required (not null)
            this.ForecastingRecipeId = forecastingRecipeId ?? throw new ArgumentNullException("forecastingRecipeId is a required property for QueryApplicableInstrumentEventsRequest and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "forecastingRecipeId", IsRequired = true, EmitDefaultValue = false)]
