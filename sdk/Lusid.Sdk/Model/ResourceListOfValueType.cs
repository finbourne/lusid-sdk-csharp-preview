...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfValueType :  IEquatable<ResourceListOfValueType>
    {
        ...
        public ResourceListOfValueType(List<ValueType> values = default(List<ValueType>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
