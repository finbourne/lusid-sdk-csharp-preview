...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfValueType :  IEquatable<ResourceListOfValueType>, IValidatableObject
    {
        /// <summary>
        /// Defines Values
        /// </summary>
        ...
        public ResourceListOfValueType(List<ValuesEnum> values = default(List<ValuesEnum>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfValueType and cannot be null");;
            this.Href = href;
            this.Links = links;
        }
