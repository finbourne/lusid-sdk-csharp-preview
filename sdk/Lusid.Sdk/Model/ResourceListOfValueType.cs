...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfValueType :  IEquatable<ResourceListOfValueType>
    {
        ...
        public enum ValuesEnum
        {
            ...
            /// <summary>
            /// Enum CdsProtectionDetailSpecification for value: CdsProtectionDetailSpecification
            /// </summary>
            [EnumMember(Value = "CdsProtectionDetailSpecification")]
            CdsProtectionDetailSpecification = 42,
            ...
            /// <summary>
            /// Enum CdsFlowConventions for value: CdsFlowConventions
            /// </summary>
            [EnumMember(Value = "CdsFlowConventions")]
            CdsFlowConventions = 44,

            /// <summary>
            /// Enum LegDefinition for value: LegDefinition
            /// </summary>
            [EnumMember(Value = "LegDefinition")]
            LegDefinition = 45,

            /// <summary>
            /// Enum IndexConvention for value: IndexConvention
            /// </summary>
            [EnumMember(Value = "IndexConvention")]
            IndexConvention = 46,
        ...
        protected ResourceListOfValueType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfValueType" /> class.
        /// </summary>
        ...
        public ResourceListOfValueType(List<ValuesEnum> values = default(List<ValuesEnum>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfValueType and cannot be null");
            }
            else
            {
                this.Values = values;
