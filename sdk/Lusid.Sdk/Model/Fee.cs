...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Fee : IEquatable<Fee>
    {
        ...
        public Fee(string href = default(string), string feeCode = default(string), ResourceId feeTypeId = default(ResourceId), string displayName = default(string), string description = default(string), string origin = default(string), string calculationBase = default(string), string accrualCurrency = default(string), string treatment = default(string), decimal? totalAnnualAccrualAmount = default(decimal?), decimal? feeRatePercentage = default(decimal?), string payableFrequency = default(string), string businessDayConvention = default(string), DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset endDate = default(DateTimeOffset), DayMonth anchorDate = default(DayMonth), Dictionary<string, Property> properties = default(Dictionary<string, Property>), Version version = default(Version), ResourceId portfolioId = default(ResourceId), List<string> shareClasses = default(List<string>), List<Link> links = default(List<Link>))
        {
            // to ensure "feeTypeId" is required (not null)
            this.FeeTypeId = feeTypeId ?? throw new ArgumentNullException("feeTypeId is a required property for Fee and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for Fee and cannot be null");
            // to ensure "accrualCurrency" is required (not null)
            this.AccrualCurrency = accrualCurrency ?? throw new ArgumentNullException("accrualCurrency is a required property for Fee and cannot be null");
            // to ensure "treatment" is required (not null)
            this.Treatment = treatment ?? throw new ArgumentNullException("treatment is a required property for Fee and cannot be null");
            // to ensure "payableFrequency" is required (not null)
            this.PayableFrequency = payableFrequency ?? throw new ArgumentNullException("payableFrequency is a required property for Fee and cannot be null");
            // to ensure "businessDayConvention" is required (not null)
            this.BusinessDayConvention = businessDayConvention ?? throw new ArgumentNullException("businessDayConvention is a required property for Fee and cannot be null");
