...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfChangeInterval : IEquatable<ResourceListOfChangeInterval>
    {
        /// <summary>
        ...
        public ResourceListOfChangeInterval(List<ChangeInterval> values = default(List<ChangeInterval>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfChangeInterval and cannot be null");
            this.Href = href;
            this.Links = links;
