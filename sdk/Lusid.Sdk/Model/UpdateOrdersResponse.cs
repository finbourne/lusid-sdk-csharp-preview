...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateOrdersResponse")]
    public partial class UpdateOrdersResponse : IEquatable<UpdateOrdersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateOrdersResponse" /> class.
        /// </summary>
        /// <param name="href">The specific Uniform Resource Identifier (URI) for this resource at the requested effective and asAt datetime..</param>
        /// <param name="values">The orders which have been successfully updated..</param>
        /// <param name="failed">The orders that could not be updated, along with a reason for their failure..</param>
        /// <param name="metadata">Meta data associated with the update event..</param>
        /// <param name="links">Collection of links..</param>
        public UpdateOrdersResponse(string href = default(string), Dictionary<string, Order> values = default(Dictionary<string, Order>), Dictionary<string, ErrorDetail> failed = default(Dictionary<string, ErrorDetail>), Dictionary<string, List<ResponseMetaData>> metadata = default(Dictionary<string, List<ResponseMetaData>>), List<Link> links = default(List<Link>))
        {
            this.Href = href;
            this.Values = values;
            this.Failed = failed;
        ...
        /// </summary>
        /// <value>The orders which have been successfully updated.</value>
        [DataMember(Name = "values", EmitDefaultValue = true)]
        public Dictionary<string, Order> Values { get; set; }

        /// <summary>
        /// The orders that could not be updated, along with a reason for their failure.
        /// </summary>
        /// <value>The orders that could not be updated, along with a reason for their failure.</value>
        ...
        {
            return this.Equals(input as UpdateOrdersResponse);
        }

        /// <summary>
        /// Returns true if UpdateOrdersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateOrdersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateOrdersResponse input)
        {
            if (input == null)
                return false;
