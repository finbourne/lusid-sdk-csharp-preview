...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionTemplateSpecification : IEquatable<TransactionTemplateSpecification>
    {
        /// <summary>
        ...
        public TransactionTemplateSpecification(string instrumentEventType = default(string), List<string> supportedInstrumentTypes = default(List<string>), List<string> supportedParticipationTypes = default(List<string>), List<ElectionSpecification> supportedElectionTypes = default(List<ElectionSpecification>), List<TemplateField> supportedTemplateFields = default(List<TemplateField>), EligibilityCalculation eligibilityCalculation = default(EligibilityCalculation))
        {
            ...
            this.SupportedInstrumentTypes = supportedInstrumentTypes ?? throw new ArgumentNullException("supportedInstrumentTypes is a required property for TransactionTemplateSpecification and cannot be null");
            // to ensure "supportedParticipationTypes" is required (not null)
            this.SupportedParticipationTypes = supportedParticipationTypes ?? throw new ArgumentNullException("supportedParticipationTypes is a required property for TransactionTemplateSpecification and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "supportedInstrumentTypes", IsRequired = true, EmitDefaultValue = false)]
        public List<string> SupportedInstrumentTypes { get; set; }

        /// <summary>
        /// Gets or Sets SupportedParticipationTypes
        /// </summary>
        [DataMember(Name = "supportedParticipationTypes", IsRequired = true, EmitDefaultValue = false)]
        public List<string> SupportedParticipationTypes { get; set; }

        /// <summary>
        /// Gets or Sets SupportedElectionTypes
        /// </summary>
        [DataMember(Name = "supportedElectionTypes", IsRequired = true, EmitDefaultValue = false)]
        public List<ElectionSpecification> SupportedElectionTypes { get; set; }

        /// <summary>
        /// Gets or Sets SupportedTemplateFields
        /// </summary>
        [DataMember(Name = "supportedTemplateFields", IsRequired = true, EmitDefaultValue = false)]
