...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfPerformanceReturn")]
    public partial class ResourceListOfPerformanceReturn : IEquatable<ResourceListOfPerformanceReturn>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfPerformanceReturn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfPerformanceReturn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfPerformanceReturn" /> class.
        /// </summary>
        ...
        public ResourceListOfPerformanceReturn(List<PerformanceReturn> values = default(List<PerformanceReturn>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfPerformanceReturn and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<PerformanceReturn> Values { get; set; }
        ...
        {
            return this.Equals(input as ResourceListOfPerformanceReturn);
        }

        /// <summary>
        /// Returns true if ResourceListOfPerformanceReturn instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfPerformanceReturn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfPerformanceReturn input)
        {
            if (input == null)
                return false;
