...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResultValueDictionary_allOf")]
    public partial class ResultValueDictionaryAllOf : IEquatable<ResultValueDictionaryAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultValueDictionaryAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResultValueDictionaryAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultValueDictionaryAllOf" /> class.
        /// </summary>
        ...
        public ResultValueDictionaryAllOf(Dictionary<string, ResultValue> elements = default(Dictionary<string, ResultValue>), ResultValueTypeEnum resultValueType = default(ResultValueTypeEnum))
        {
        ...
        {
            return this.Equals(input as ResultValueDictionaryAllOf);
        }

        /// <summary>
        /// Returns true if ResultValueDictionaryAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ResultValueDictionaryAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResultValueDictionaryAllOf input)
        {
            if (input == null)
                return false;
