...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CustomEntityFieldDefinition : IEquatable<CustomEntityFieldDefinition>
    {
        ...
        public CustomEntityFieldDefinition(string name = default(string), string lifetime = default(string), string type = default(string), bool required = default(bool), string description = default(string))
        {
