...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BasketAllOf : IEquatable<BasketAllOf>
    {
        ...
        public BasketAllOf(BasketIdentifier basketName = default(BasketIdentifier), string basketType = default(string), WeightedInstruments weightedInstruments = default(WeightedInstruments), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.BasketName = basketName ?? throw new ArgumentNullException("basketName is a required property for BasketAllOf and cannot be null");
            // to ensure "basketType" is required (not null)
            this.BasketType = basketType ?? throw new ArgumentNullException("basketType is a required property for BasketAllOf and cannot be null");
            // to ensure "weightedInstruments" is required (not null)
            this.WeightedInstruments = weightedInstruments ?? throw new ArgumentNullException("weightedInstruments is a required property for BasketAllOf and cannot be null");
        ...
        /// <summary>
        /// What contents does the basket have. The validation will check that the instrument types contained match those expected.  Supported string (enumeration) values are: [Bonds, Credits, Equities, EquitySwap, Unknown].
        /// </summary>
        /// <value>What contents does the basket have. The validation will check that the instrument types contained match those expected.  Supported string (enumeration) values are: [Bonds, Credits, Equities, EquitySwap, Unknown].</value>
