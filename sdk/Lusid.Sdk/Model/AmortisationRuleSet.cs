...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AmortisationRuleSet : IEquatable<AmortisationRuleSet>
    {
        ...
        public AmortisationRuleSet(string href = default(string), ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), List<AmortisationRule> rules = default(List<AmortisationRule>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            ...
            this.Rules = rules ?? throw new ArgumentNullException("rules is a required property for AmortisationRuleSet and cannot be null");
            this.Href = href;
