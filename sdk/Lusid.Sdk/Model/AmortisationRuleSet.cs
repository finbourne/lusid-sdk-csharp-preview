...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AmortisationRuleSet : IEquatable<AmortisationRuleSet>
    {
        /// <summary>
        ...
        public AmortisationRuleSet(string href = default(string), ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), RulesInterval rulesInterval = default(RulesInterval), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for AmortisationRuleSet and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for AmortisationRuleSet and cannot be null");
            // to ensure "rulesInterval" is required (not null)
            this.RulesInterval = rulesInterval ?? throw new ArgumentNullException("rulesInterval is a required property for AmortisationRuleSet and cannot be null");
            this.Href = href;
        ...
        /// </summary>
        [DataMember(Name = "rulesInterval", IsRequired = true, EmitDefaultValue = false)]
