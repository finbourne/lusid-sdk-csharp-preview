...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfPerson :  IEquatable<PagedResourceListOfPerson>
    {
        ...
        public PagedResourceListOfPerson(List<Person> values = default(List<Person>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for PagedResourceListOfPerson and cannot be null");
            }
            else
            {
                this.Values = values;
