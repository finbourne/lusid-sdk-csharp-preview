...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Workspace : IEquatable<Workspace>
    {
        ...
        public Workspace(string name = default(string), string description = default(string), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            ...
            this.Description = description ?? throw new ArgumentNullException("description is a required property for Workspace and cannot be null");
