...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfAllocation")]
    public partial class PagedResourceListOfAllocation : IEquatable<PagedResourceListOfAllocation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfAllocation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfAllocation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfAllocation" /> class.
        /// </summary>
        ...
        public PagedResourceListOfAllocation(string nextPage = default(string), string previousPage = default(string), List<Allocation> values = default(List<Allocation>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfAllocation and cannot be null");
        ...
        {
            return this.Equals(input as PagedResourceListOfAllocation);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfAllocation instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfAllocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfAllocation input)
        {
            if (input == null)
                return false;
