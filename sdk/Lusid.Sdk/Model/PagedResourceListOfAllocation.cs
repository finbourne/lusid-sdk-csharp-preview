...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagedResourceListOfAllocation :  IEquatable<PagedResourceListOfAllocation>, IValidatableObject
    {
        /// <summary>
        ...
        public PagedResourceListOfAllocation(List<Allocation> values = default(List<Allocation>), string href = default(string), List<Link> links = default(List<Link>))
        {
