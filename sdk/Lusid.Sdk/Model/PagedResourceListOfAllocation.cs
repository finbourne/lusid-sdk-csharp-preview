...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfAllocation :  IEquatable<PagedResourceListOfAllocation>
    {
        ...
        public PagedResourceListOfAllocation(List<Allocation> values = default(List<Allocation>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
