...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InflationLinkedBond : LusidInstrument, IEquatable<InflationLinkedBond>
    {
        ...
        /// <param name="calculationType">The calculation type applied to the bond coupon and principal amount.  The default CalculationType is &#x60;Standard&#x60; and currently this is the only value supported.    Supported string (enumeration) values are: [Standard, Quarterly]..</param>
        ...
        /// <param name="observationLag">Observation lag. This is a Tenor that must have units of Month.  This field is typically 3 or 4 months, but can vary, older bonds have 8 months lag. (required).</param>
        ...
        public InflationLinkedBond(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), FlowConventions flowConventions = default(FlowConventions), decimal couponRate = default(decimal), Dictionary<string, string> identifiers = default(Dictionary<string, string>), string domCcy = default(string), decimal? baseCPI = default(decimal?), DateTimeOffset? baseCPIDate = default(DateTimeOffset?), string calculationType = default(string), int indexPrecision = default(int), string inflationIndexName = default(string), string inflationInterpolation = default(string), int inflationRollDay = default(int), string observationLag = default(string), decimal principal = default(decimal), bool principalProtection = default(bool), string stubType = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.ObservationLag = observationLag ?? throw new ArgumentNullException("observationLag is a required property for InflationLinkedBond and cannot be null");
        ...
        /// </summary>
        /// <value>The calculation type applied to the bond coupon and principal amount.  The default CalculationType is &#x60;Standard&#x60; and currently this is the only value supported.    Supported string (enumeration) values are: [Standard, Quarterly].</value>
        ...
        /// </summary>
        /// <value>Observation lag. This is a Tenor that must have units of Month.  This field is typically 3 or 4 months, but can vary, older bonds have 8 months lag.</value>
