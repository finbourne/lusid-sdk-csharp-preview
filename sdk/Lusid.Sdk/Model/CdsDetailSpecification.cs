...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CdsDetailSpecification :  IEquatable<CdsDetailSpecification>, IValidatableObject
    {
        /// <summary>
        ...
        public CdsDetailSpecification(SeniorityEnum seniority = default(SeniorityEnum), RestructuringTypeEnum restructuringType = default(RestructuringTypeEnum), bool protectStartDay = default(bool), bool payAccruedInterestOnDefault = default(bool), Tenor rollFrequency = default(Tenor))
        {
            ...
            this.RollFrequency = rollFrequency ?? throw new ArgumentNullException("rollFrequency is a required property for CdsDetailSpecification and cannot be null");;
        }
