...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionTypePropertyMapping : IEquatable<TransactionTypePropertyMapping>
    {
        /// <summary>
        ...
        public TransactionTypePropertyMapping(string propertyKey = default(string), string mapFrom = default(string), Object setTo = default(Object))
        {
            // to ensure "propertyKey" is required (not null)
            this.PropertyKey = propertyKey ?? throw new ArgumentNullException("propertyKey is a required property for TransactionTypePropertyMapping and cannot be null");
