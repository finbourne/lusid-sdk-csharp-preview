...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Future : LusidInstrument,  IEquatable<Future>
    {
        ...
        public Future(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), Dictionary<string, string> identifiers = default(Dictionary<string, string>), FuturesContractDetails contractDetails = default(FuturesContractDetails), decimal? contracts = default(decimal?), decimal? refSpotPrice = default(decimal?), LusidInstrument underlying = default(LusidInstrument), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for Future and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for Future and cannot be null");
            }
            else
            {
            ...
            if (identifiers == null)
            {
                throw new InvalidDataException("identifiers is a required property for Future and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("contractDetails is a required property for Future and cannot be null");
            }
            else
            {
            ...
            if (underlying == null)
            {
                throw new InvalidDataException("underlying is a required property for Future and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="contractDetails", EmitDefaultValue=false)]
