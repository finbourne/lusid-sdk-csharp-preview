...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Counterparty :  IEquatable<Counterparty>
    {
        ...
        public Counterparty(string counterpartyId = default(string), string counterpartyName = default(string), string countryOfRisk = default(string), List<CreditRating> issuerRatings = default(List<CreditRating>), IndustryClassificationScheme industryScheme = default(IndustryClassificationScheme), string scope = default(string), string code = default(string))
        {
            ...
            {
                throw new InvalidDataException("counterpartyId is a required property for Counterparty and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("counterpartyName is a required property for Counterparty and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("countryOfRisk is a required property for Counterparty and cannot be null");
            }
            else
            {
            ...
            if (issuerRatings == null)
            {
                throw new InvalidDataException("issuerRatings is a required property for Counterparty and cannot be null");
            }
            else
            {
            ...
            if (industryScheme == null)
            {
                throw new InvalidDataException("industryScheme is a required property for Counterparty and cannot be null");
            }
            else
            {
                this.IndustryScheme = industryScheme;
            }
        ...
        [DataMember(Name="counterpartyName", EmitDefaultValue=false)]
        ...
        [DataMember(Name="issuerRatings", EmitDefaultValue=false)]
        public List<CreditRating> IssuerRatings { get; set; }

        /// <summary>
        /// Gets or Sets IndustryScheme
        /// </summary>
        [DataMember(Name="industryScheme", EmitDefaultValue=false)]
