...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Counterparty : IEquatable<Counterparty>
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="Counterparty" /> class.
        /// </summary>
        /// <param name="counterpartyId">A unique identifier that determines the identity of the counter-party, disambiguating between related legal entities, particularly necessary in the case of multi-nationals. (required).</param>
        /// <param name="counterpartyName">The legal name of the entity to which this counterparty refers. (required).</param>
        /// <param name="countryOfRisk">To which country would one naturally ascribe risk. Typically this will be synonymous with legal registration entity.  This can be used to infer funding currency and related market data in the absence of specific overrides or preference. (required).</param>
        /// <param name="issuerRatings">A set of credit ratings for the counterparty fro, e.g. Standard and Poor or Moody&#39;s. (required).</param>
        /// <param name="industryScheme">industryScheme (required).</param>
        ...
        public Counterparty(string counterpartyId = default(string), string counterpartyName = default(string), string countryOfRisk = default(string), List<CreditRating> issuerRatings = default(List<CreditRating>), IndustryClassificationScheme industryScheme = default(IndustryClassificationScheme), string scope = default(string), string code = default(string))
        {
            // to ensure "counterpartyId" is required (not null)
            this.CounterpartyId = counterpartyId ?? throw new ArgumentNullException("counterpartyId is a required property for Counterparty and cannot be null");
            // to ensure "counterpartyName" is required (not null)
            this.CounterpartyName = counterpartyName ?? throw new ArgumentNullException("counterpartyName is a required property for Counterparty and cannot be null");
            // to ensure "countryOfRisk" is required (not null)
            this.CountryOfRisk = countryOfRisk ?? throw new ArgumentNullException("countryOfRisk is a required property for Counterparty and cannot be null");
            // to ensure "issuerRatings" is required (not null)
            this.IssuerRatings = issuerRatings ?? throw new ArgumentNullException("issuerRatings is a required property for Counterparty and cannot be null");
            // to ensure "industryScheme" is required (not null)
            this.IndustryScheme = industryScheme ?? throw new ArgumentNullException("industryScheme is a required property for Counterparty and cannot be null");
            this.Scope = scope;
            this.Code = code;
        }

        /// <summary>
        /// A unique identifier that determines the identity of the counter-party, disambiguating between related legal entities, particularly necessary in the case of multi-nationals.
        /// </summary>
        /// <value>A unique identifier that determines the identity of the counter-party, disambiguating between related legal entities, particularly necessary in the case of multi-nationals.</value>
        [DataMember(Name = "counterpartyId", IsRequired = true, EmitDefaultValue = false)]
        public string CounterpartyId { get; set; }

        /// <summary>
        /// The legal name of the entity to which this counterparty refers.
        /// </summary>
        /// <value>The legal name of the entity to which this counterparty refers.</value>
        [DataMember(Name = "counterpartyName", IsRequired = true, EmitDefaultValue = false)]
        public string CounterpartyName { get; set; }

        /// <summary>
        /// To which country would one naturally ascribe risk. Typically this will be synonymous with legal registration entity.  This can be used to infer funding currency and related market data in the absence of specific overrides or preference.
        /// </summary>
        /// <value>To which country would one naturally ascribe risk. Typically this will be synonymous with legal registration entity.  This can be used to infer funding currency and related market data in the absence of specific overrides or preference.</value>
        [DataMember(Name = "countryOfRisk", IsRequired = true, EmitDefaultValue = false)]
        public string CountryOfRisk { get; set; }

        /// <summary>
        /// A set of credit ratings for the counterparty fro, e.g. Standard and Poor or Moody&#39;s.
        /// </summary>
        /// <value>A set of credit ratings for the counterparty fro, e.g. Standard and Poor or Moody&#39;s.</value>
        [DataMember(Name = "issuerRatings", IsRequired = true, EmitDefaultValue = false)]
        public List<CreditRating> IssuerRatings { get; set; }

        /// <summary>
        /// Gets or Sets IndustryScheme
        /// </summary>
        [DataMember(Name = "industryScheme", IsRequired = true, EmitDefaultValue = false)]
        public IndustryClassificationScheme IndustryScheme { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IssuerRatings: ").Append(IssuerRatings).Append("\n");
            sb.Append("  IndustryScheme: ").Append(IndustryScheme).Append("\n");
        ...
        public bool Equals(Counterparty input)
        {
            ...
            return 
                ...
                (
                    this.IssuerRatings == input.IssuerRatings ||
                    this.IssuerRatings != null &&
                    input.IssuerRatings != null &&
                    this.IssuerRatings.SequenceEqual(input.IssuerRatings)
                ) && 
                (
                    this.IndustryScheme == input.IndustryScheme ||
                    (this.IndustryScheme != null &&
                    this.IndustryScheme.Equals(input.IndustryScheme))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IssuerRatings != null)
                    hashCode = hashCode * 59 + this.IssuerRatings.GetHashCode();
                if (this.IndustryScheme != null)
                    hashCode = hashCode * 59 + this.IndustryScheme.GetHashCode();
                if (this.Scope != null)
