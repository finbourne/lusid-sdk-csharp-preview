...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ConstantVolatilitySurfaceAllOf : IEquatable<ConstantVolatilitySurfaceAllOf>
    {
        /// <summary>
        ...
        public ConstantVolatilitySurfaceAllOf(DateTimeOffset baseDate = default(DateTimeOffset), string assetType = default(string), string lineage = default(string), decimal volatility = default(decimal), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
            ...
            this.AssetType = assetType ?? throw new ArgumentNullException("assetType is a required property for ConstantVolatilitySurfaceAllOf and cannot be null");
