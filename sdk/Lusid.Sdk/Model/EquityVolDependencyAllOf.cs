...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EquityVolDependency_allOf")]
    public partial class EquityVolDependencyAllOf : IEquatable<EquityVolDependencyAllOf>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The available values are: Opaque, Cash, Discounting, EquityCurve, EquityVol, Fx, FxForwards, FxVol, IndexProjection, IrVol, Quote, Vendor</value>
        ...
        public enum DependencyTypeEnum
        {
            ...
            /// <summary>
            /// Enum EquityCurve for value: EquityCurve
            /// </summary>
            [EnumMember(Value = "EquityCurve")]
            EquityCurve = 4,

            /// <summary>
            /// Enum EquityVol for value: EquityVol
            /// </summary>
            [EnumMember(Value = "EquityVol")]
            EquityVol = 5,
            ...
            /// <summary>
            /// Enum FxForwards for value: FxForwards
            /// </summary>
            [EnumMember(Value = "FxForwards")]
            FxForwards = 7,

            /// <summary>
            /// Enum FxVol for value: FxVol
            /// </summary>
            [EnumMember(Value = "FxVol")]
            FxVol = 8,

            /// <summary>
            /// Enum IndexProjection for value: IndexProjection
            /// </summary>
            [EnumMember(Value = "IndexProjection")]
            IndexProjection = 9,

            /// <summary>
            /// Enum IrVol for value: IrVol
            /// </summary>
            [EnumMember(Value = "IrVol")]
            IrVol = 10,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EquityVolDependencyAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EquityVolDependencyAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EquityVolDependencyAllOf" /> class.
        /// </summary>
        ...
        public EquityVolDependencyAllOf(string code = default(string), string domesticCurrency = default(string), string volType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum))
        {
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for EquityVolDependencyAllOf and cannot be null");
            // to ensure "domesticCurrency" is required (not null)
            this.DomesticCurrency = domesticCurrency ?? throw new ArgumentNullException("domesticCurrency is a required property for EquityVolDependencyAllOf and cannot be null");
            // to ensure "volType" is required (not null)
            this.VolType = volType ?? throw new ArgumentNullException("volType is a required property for EquityVolDependencyAllOf and cannot be null");
            this.Date = date;
        ...
        [DataMember(Name = "volType", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as EquityVolDependencyAllOf);
        }

        /// <summary>
        /// Returns true if EquityVolDependencyAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of EquityVolDependencyAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquityVolDependencyAllOf input)
        {
            if (input == null)
                return false;
