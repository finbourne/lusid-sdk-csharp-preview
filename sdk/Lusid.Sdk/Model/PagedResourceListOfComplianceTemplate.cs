...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfComplianceTemplate : IEquatable<PagedResourceListOfComplianceTemplate>
    {
        /// <summary>
        ...
        public PagedResourceListOfComplianceTemplate(string nextPage = default(string), string previousPage = default(string), List<ComplianceTemplate> values = default(List<ComplianceTemplate>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfComplianceTemplate and cannot be null");
