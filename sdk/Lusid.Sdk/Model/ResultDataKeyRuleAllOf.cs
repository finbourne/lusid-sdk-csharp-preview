...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResultDataKeyRuleAllOf : IEquatable<ResultDataKeyRuleAllOf>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The available values are: Invalid, ResultDataKeyRule, PortfolioResultDataKeyRule</value>
        [DataMember(Name = "resultKeyRuleType", IsRequired = true, EmitDefaultValue = false)]
        ...
        public ResultDataKeyRuleAllOf(string supplier = default(string), string dataScope = default(string), string documentCode = default(string), string quoteInterval = default(string), DateTimeOffset? asAt = default(DateTimeOffset?), string resourceKey = default(string), string documentResultType = default(string), ResultKeyRuleTypeEnum resultKeyRuleType = default(ResultKeyRuleTypeEnum))
        {
            ...
            this.Supplier = supplier ?? throw new ArgumentNullException("supplier is a required property for ResultDataKeyRuleAllOf and cannot be null");
            // to ensure "dataScope" is required (not null)
            this.DataScope = dataScope ?? throw new ArgumentNullException("dataScope is a required property for ResultDataKeyRuleAllOf and cannot be null");
            // to ensure "documentCode" is required (not null)
            this.DocumentCode = documentCode ?? throw new ArgumentNullException("documentCode is a required property for ResultDataKeyRuleAllOf and cannot be null");
            // to ensure "resourceKey" is required (not null)
            this.ResourceKey = resourceKey ?? throw new ArgumentNullException("resourceKey is a required property for ResultDataKeyRuleAllOf and cannot be null");
            // to ensure "documentResultType" is required (not null)
            this.DocumentResultType = documentResultType ?? throw new ArgumentNullException("documentResultType is a required property for ResultDataKeyRuleAllOf and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "documentResultType", IsRequired = true, EmitDefaultValue = false)]
