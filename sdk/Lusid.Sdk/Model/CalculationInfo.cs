...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CalculationInfo : IEquatable<CalculationInfo>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Method of calculating the fees or commission among: BasisPoints, Percentage, Rate, Flat etc. The available values are: Rate, BasisPoints, Percentage, Flat</value>
        ...
        public enum CalculationMethodEnum
        {
            ...
            /// <summary>
            /// Enum BasisPoints for value: BasisPoints
            /// </summary>
            [EnumMember(Value = "BasisPoints")]
            BasisPoints = 2,
        ...
        /// </summary>
        /// <value>. The available values are: None, Quantity, Value</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        public MultiplierEnum Multiplier { get; set; }
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="CalculationInfo" /> class.
        /// </summary>
        /// <param name="calculationDescription">Description of what the calculation applies to eg. Fee, MinFee, MaxFee (required).</param>
        /// <param name="calculationMethod">Method of calculating the fees or commission among: BasisPoints, Percentage, Rate, Flat etc. The available values are: Rate, BasisPoints, Percentage, Flat (required).</param>
        /// <param name="multiplier">. The available values are: None, Quantity, Value (required).</param>
        /// <param name="calculationAmount">Numerical fee amount (required).</param>
        public CalculationInfo(string calculationDescription = default(string), CalculationMethodEnum calculationMethod = default(CalculationMethodEnum), MultiplierEnum multiplier = default(MultiplierEnum), decimal calculationAmount = default(decimal))
        {
            // to ensure "calculationDescription" is required (not null)
            this.CalculationDescription = calculationDescription ?? throw new ArgumentNullException("calculationDescription is a required property for CalculationInfo and cannot be null");
        ...
        /// </summary>
        /// <value>Description of what the calculation applies to eg. Fee, MinFee, MaxFee</value>
        [DataMember(Name = "calculationDescription", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CalculationDescription: ").Append(CalculationDescription).Append("\n");
        ...
        public bool Equals(CalculationInfo input)
        {
            ...
            return 
                (
                    this.CalculationDescription == input.CalculationDescription ||
                    (this.CalculationDescription != null &&
                    this.CalculationDescription.Equals(input.CalculationDescription))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.CalculationDescription != null)
                    hashCode = hashCode * 59 + this.CalculationDescription.GetHashCode();
