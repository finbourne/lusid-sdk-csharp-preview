...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PackageRequest :  IEquatable<PackageRequest>
    {
        ...
        public PackageRequest(ResourceId id = default(ResourceId), List<ResourceId> orderIds = default(List<ResourceId>), List<ResourceId> orderInstructionIds = default(List<ResourceId>), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for PackageRequest and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (orderIds == null)
            {
                throw new InvalidDataException("orderIds is a required property for PackageRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("orderInstructionIds is a required property for PackageRequest and cannot be null");
            }
            else
            {
