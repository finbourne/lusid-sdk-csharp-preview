...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionTypeMovement : IEquatable<TransactionTypeMovement>
    {
        /// <summary>
        ...
        public TransactionTypeMovement(string movementTypes = default(string), string side = default(string), int direction = default(int), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), List<TransactionTypePropertyMapping> mappings = default(List<TransactionTypePropertyMapping>), string name = default(string))
        {
            // to ensure "movementTypes" is required (not null)
            this.MovementTypes = movementTypes ?? throw new ArgumentNullException("movementTypes is a required property for TransactionTypeMovement and cannot be null");
            // to ensure "side" is required (not null)
            this.Side = side ?? throw new ArgumentNullException("side is a required property for TransactionTypeMovement and cannot be null");
