...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfAddressKeyDefinition : IEquatable<ResourceListOfAddressKeyDefinition>
    {
        /// <summary>
        ...
        public ResourceListOfAddressKeyDefinition(List<AddressKeyDefinition> values = default(List<AddressKeyDefinition>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfAddressKeyDefinition and cannot be null");
            this.Href = href;
            this.Links = links;
