...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AllocationServiceRunResult")]
    public partial class AllocationServiceRunResult : IEquatable<AllocationServiceRunResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllocationServiceRunResult" /> class.
        /// </summary>
        /// <param name="values">values.</param>
        /// <param name="failed">failed.</param>
        public AllocationServiceRunResult(List<ResourceId> values = default(List<ResourceId>), Dictionary<string, ErrorDetail> failed = default(Dictionary<string, ErrorDetail>))
        {
            this.Values = values;
            this.Failed = failed;
        }
        ...
        {
            return this.Equals(input as AllocationServiceRunResult);
        }

        /// <summary>
        /// Returns true if AllocationServiceRunResult instances are equal
        /// </summary>
        /// <param name="input">Instance of AllocationServiceRunResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllocationServiceRunResult input)
        {
            if (input == null)
                return false;
