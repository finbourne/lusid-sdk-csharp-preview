...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateTradeTicketsResponse : IEquatable<CreateTradeTicketsResponse>
    {
        /// <summary>
        ...
        public CreateTradeTicketsResponse(List<LusidTradeTicket> values = default(List<LusidTradeTicket>), List<ErrorDetail> failures = default(List<ErrorDetail>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for CreateTradeTicketsResponse and cannot be null");
            // to ensure "failures" is required (not null)
            this.Failures = failures ?? throw new ArgumentNullException("failures is a required property for CreateTradeTicketsResponse and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "failures", IsRequired = true, EmitDefaultValue = false)]
