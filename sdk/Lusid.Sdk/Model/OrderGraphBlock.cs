...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OrderGraphBlock : IEquatable<OrderGraphBlock>
    {
        ...
        public OrderGraphBlock(Block block = default(Block), List<ResourceId> orderIds = default(List<ResourceId>), List<ResourceId> placementIds = default(List<ResourceId>), List<ResourceId> allocationIds = default(List<ResourceId>), List<ResourceId> executionIds = default(List<ResourceId>), OrderGraphSynopsis ordered = default(OrderGraphSynopsis), OrderGraphSynopsis placed = default(OrderGraphSynopsis), OrderGraphSynopsis allocated = default(OrderGraphSynopsis), OrderGraphSynopsis executed = default(OrderGraphSynopsis), string derivedState = default(string))
        {
