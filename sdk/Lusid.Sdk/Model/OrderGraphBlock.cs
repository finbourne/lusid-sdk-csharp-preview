...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OrderGraphBlock : IEquatable<OrderGraphBlock>
    {
        /// <summary>
        ...
        /// <param name="orderIds">Identifiers for all the orders in this block - DEPRECATED: see Ordered. (required).</param>
        /// <param name="placementIds">Identifiers of all placements for the block - DEPRECATED: see Placed. (required).</param>
        /// <param name="allocationIds">Identifiers for all allocations of placements to orders in the block - DEPRECATED: see Allocated. (required).</param>
        /// <param name="executionIds">Identifiers of all executions against placements in the block - DEPRECATED: see Executed. (required).</param>
        ...
        /// <param name="derivedComplianceState">The overall compliance state of a block, derived from the block&#39;s orders. Possible values are Pending, Failed, and Passed. (required).</param>
        public OrderGraphBlock(Block block = default(Block), List<ResourceId> orderIds = default(List<ResourceId>), List<ResourceId> placementIds = default(List<ResourceId>), List<ResourceId> allocationIds = default(List<ResourceId>), List<ResourceId> executionIds = default(List<ResourceId>), OrderGraphBlockOrderSynopsis ordered = default(OrderGraphBlockOrderSynopsis), OrderGraphBlockPlacementSynopsis placed = default(OrderGraphBlockPlacementSynopsis), OrderGraphBlockExecutionSynopsis executed = default(OrderGraphBlockExecutionSynopsis), OrderGraphBlockAllocationSynopsis allocated = default(OrderGraphBlockAllocationSynopsis), string derivedState = default(string), string derivedComplianceState = default(string))
        {
            ...
            this.OrderIds = orderIds ?? throw new ArgumentNullException("orderIds is a required property for OrderGraphBlock and cannot be null");
            // to ensure "placementIds" is required (not null)
            this.PlacementIds = placementIds ?? throw new ArgumentNullException("placementIds is a required property for OrderGraphBlock and cannot be null");
            // to ensure "allocationIds" is required (not null)
            this.AllocationIds = allocationIds ?? throw new ArgumentNullException("allocationIds is a required property for OrderGraphBlock and cannot be null");
            // to ensure "executionIds" is required (not null)
            this.ExecutionIds = executionIds ?? throw new ArgumentNullException("executionIds is a required property for OrderGraphBlock and cannot be null");
            // to ensure "ordered" is required (not null)
            this.Ordered = ordered ?? throw new ArgumentNullException("ordered is a required property for OrderGraphBlock and cannot be null");
            // to ensure "placed" is required (not null)
            this.Placed = placed ?? throw new ArgumentNullException("placed is a required property for OrderGraphBlock and cannot be null");
            // to ensure "executed" is required (not null)
            this.Executed = executed ?? throw new ArgumentNullException("executed is a required property for OrderGraphBlock and cannot be null");
            // to ensure "allocated" is required (not null)
            this.Allocated = allocated ?? throw new ArgumentNullException("allocated is a required property for OrderGraphBlock and cannot be null");
        ...
        /// <summary>
        /// Identifiers for all the orders in this block - DEPRECATED: see Ordered.
        /// </summary>
        /// <value>Identifiers for all the orders in this block - DEPRECATED: see Ordered.</value>
        [DataMember(Name = "orderIds", IsRequired = true, EmitDefaultValue = false)]
        public List<ResourceId> OrderIds { get; set; }

        /// <summary>
        /// Identifiers of all placements for the block - DEPRECATED: see Placed.
        /// </summary>
        /// <value>Identifiers of all placements for the block - DEPRECATED: see Placed.</value>
        [DataMember(Name = "placementIds", IsRequired = true, EmitDefaultValue = false)]
        public List<ResourceId> PlacementIds { get; set; }

        /// <summary>
        /// Identifiers for all allocations of placements to orders in the block - DEPRECATED: see Allocated.
        /// </summary>
        /// <value>Identifiers for all allocations of placements to orders in the block - DEPRECATED: see Allocated.</value>
        [DataMember(Name = "allocationIds", IsRequired = true, EmitDefaultValue = false)]
        public List<ResourceId> AllocationIds { get; set; }

        /// <summary>
        /// Identifiers of all executions against placements in the block - DEPRECATED: see Executed.
        /// </summary>
        /// <value>Identifiers of all executions against placements in the block - DEPRECATED: see Executed.</value>
        [DataMember(Name = "executionIds", IsRequired = true, EmitDefaultValue = false)]
        public List<ResourceId> ExecutionIds { get; set; }

        /// <summary>
        /// Gets or Sets Ordered
        /// </summary>
        [DataMember(Name = "ordered", IsRequired = true, EmitDefaultValue = false)]
        public OrderGraphBlockOrderSynopsis Ordered { get; set; }

        /// <summary>
        /// Gets or Sets Placed
        /// </summary>
        [DataMember(Name = "placed", IsRequired = true, EmitDefaultValue = false)]
        public OrderGraphBlockPlacementSynopsis Placed { get; set; }

        /// <summary>
        /// Gets or Sets Executed
        /// </summary>
        [DataMember(Name = "executed", IsRequired = true, EmitDefaultValue = false)]
        public OrderGraphBlockExecutionSynopsis Executed { get; set; }

        /// <summary>
        /// Gets or Sets Allocated
        /// </summary>
        [DataMember(Name = "allocated", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "derivedState", IsRequired = true, EmitDefaultValue = false)]
        public string DerivedState { get; set; }

        /// <summary>
        /// The overall compliance state of a block, derived from the block&#39;s orders. Possible values are Pending, Failed, and Passed.
        /// </summary>
        /// <value>The overall compliance state of a block, derived from the block&#39;s orders. Possible values are Pending, Failed, and Passed.</value>
        [DataMember(Name = "derivedComplianceState", IsRequired = true, EmitDefaultValue = false)]
