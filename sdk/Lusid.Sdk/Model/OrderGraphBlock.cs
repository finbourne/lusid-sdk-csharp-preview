...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OrderGraphBlock : IEquatable<OrderGraphBlock>
    {
        ...
        /// <param name="ordered">Total number of units of the instrument across all orders in the block. (required).</param>
        /// <param name="placed">Number of units of the instrument across all placements in the block. (required).</param>
        /// <param name="allocated">Number of units of the instrument across all allocations in the block. (required).</param>
        /// <param name="executed">How many of the quantity ordered for this block have been executed in the market. (required).</param>
        /// <param name="derivedState">A simple description of the overall state of a block. (required).</param>
        public OrderGraphBlock(Block block = default(Block), List<ResourceId> orderIds = default(List<ResourceId>), List<ResourceId> placementIds = default(List<ResourceId>), List<ResourceId> allocationIds = default(List<ResourceId>), List<ResourceId> executionIds = default(List<ResourceId>), decimal ordered = default(decimal), decimal placed = default(decimal), decimal allocated = default(decimal), decimal executed = default(decimal), string derivedState = default(string))
        {
        ...
        /// <summary>
        /// Total number of units of the instrument across all orders in the block.
        /// </summary>
        /// <value>Total number of units of the instrument across all orders in the block.</value>
        [DataMember(Name = "ordered", IsRequired = true, EmitDefaultValue = true)]
        public decimal Ordered { get; set; }

        /// <summary>
        /// Number of units of the instrument across all placements in the block.
        /// </summary>
        /// <value>Number of units of the instrument across all placements in the block.</value>
        [DataMember(Name = "placed", IsRequired = true, EmitDefaultValue = true)]
        public decimal Placed { get; set; }

        /// <summary>
        /// Number of units of the instrument across all allocations in the block.
        /// </summary>
        /// <value>Number of units of the instrument across all allocations in the block.</value>
        [DataMember(Name = "allocated", IsRequired = true, EmitDefaultValue = true)]
        public decimal Allocated { get; set; }

        /// <summary>
        /// How many of the quantity ordered for this block have been executed in the market.
        /// </summary>
        /// <value>How many of the quantity ordered for this block have been executed in the market.</value>
