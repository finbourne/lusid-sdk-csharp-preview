...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FxForwardTenorCurveData_allOf")]
    public partial class FxForwardTenorCurveDataAllOf : IEquatable<FxForwardTenorCurveDataAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FxForwardTenorCurveDataAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FxForwardTenorCurveDataAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FxForwardTenorCurveDataAllOf" /> class.
        /// </summary>
        ...
        public FxForwardTenorCurveDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), string fgnCcy = default(string), List<string> tenors = default(List<string>), List<decimal> rates = default(List<decimal>), string lineage = default(string), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
            this.BaseDate = baseDate;
            // to ensure "domCcy" is required (not null)
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for FxForwardTenorCurveDataAllOf and cannot be null");
            // to ensure "fgnCcy" is required (not null)
            this.FgnCcy = fgnCcy ?? throw new ArgumentNullException("fgnCcy is a required property for FxForwardTenorCurveDataAllOf and cannot be null");
            // to ensure "tenors" is required (not null)
            this.Tenors = tenors ?? throw new ArgumentNullException("tenors is a required property for FxForwardTenorCurveDataAllOf and cannot be null");
        ...
        {
            return this.Equals(input as FxForwardTenorCurveDataAllOf);
        }

        /// <summary>
        /// Returns true if FxForwardTenorCurveDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of FxForwardTenorCurveDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FxForwardTenorCurveDataAllOf input)
        {
            if (input == null)
                return false;
