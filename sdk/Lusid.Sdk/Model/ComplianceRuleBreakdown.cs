...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceRuleBreakdown : IEquatable<ComplianceRuleBreakdown>
    {
        ...
        public ComplianceRuleBreakdown(string groupStatus = default(string), Dictionary<string, decimal> resultsUsed = default(Dictionary<string, decimal>), Dictionary<string, List<Property>> propertiesUsed = default(Dictionary<string, List<Property>>), Dictionary<string, string> parametersUsed = default(Dictionary<string, string>), List<string> missingDataInformation = default(List<string>))
        {
            ...
            this.ParametersUsed = parametersUsed ?? throw new ArgumentNullException("parametersUsed is a required property for ComplianceRuleBreakdown and cannot be null");
