...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceRuleBreakdown : IEquatable<ComplianceRuleBreakdown>
    {
        /// <summary>
        ...
        public ComplianceRuleBreakdown(string groupStatus = default(string), Dictionary<string, decimal> resultsUsed = default(Dictionary<string, decimal>), Dictionary<string, List<Property>> propertiesUsed = default(Dictionary<string, List<Property>>), List<string> missingDataInformation = default(List<string>), List<LineageMember> lineage = default(List<LineageMember>))
        {
            ...
            this.GroupStatus = groupStatus ?? throw new ArgumentNullException("groupStatus is a required property for ComplianceRuleBreakdown and cannot be null");
            // to ensure "resultsUsed" is required (not null)
            this.ResultsUsed = resultsUsed ?? throw new ArgumentNullException("resultsUsed is a required property for ComplianceRuleBreakdown and cannot be null");
            // to ensure "propertiesUsed" is required (not null)
            this.PropertiesUsed = propertiesUsed ?? throw new ArgumentNullException("propertiesUsed is a required property for ComplianceRuleBreakdown and cannot be null");
            // to ensure "missingDataInformation" is required (not null)
            this.MissingDataInformation = missingDataInformation ?? throw new ArgumentNullException("missingDataInformation is a required property for ComplianceRuleBreakdown and cannot be null");
            // to ensure "lineage" is required (not null)
            this.Lineage = lineage ?? throw new ArgumentNullException("lineage is a required property for ComplianceRuleBreakdown and cannot be null");
        }
        ...
        [DataMember(Name = "groupStatus", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "resultsUsed", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "propertiesUsed", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "lineage", IsRequired = true, EmitDefaultValue = false)]
