...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateStagingRuleSetRequest : IEquatable<CreateStagingRuleSetRequest>
    {
        /// <summary>
        ...
        public CreateStagingRuleSetRequest(string displayName = default(string), string description = default(string), List<StagingRule> rules = default(List<StagingRule>))
        {
            ...
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CreateStagingRuleSetRequest and cannot be null");
            // to ensure "rules" is required (not null)
            this.Rules = rules ?? throw new ArgumentNullException("rules is a required property for CreateStagingRuleSetRequest and cannot be null");
