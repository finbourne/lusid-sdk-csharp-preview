...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfProperty : IEquatable<ResourceListOfProperty>
    {
        /// <summary>
        ...
        public ResourceListOfProperty(List<Property> values = default(List<Property>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfProperty and cannot be null");
            this.Href = href;
            this.Links = links;
