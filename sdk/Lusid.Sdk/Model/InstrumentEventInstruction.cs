...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentEventInstruction : IEquatable<InstrumentEventInstruction>
    {
        ...
        public InstrumentEventInstruction(string instrumentEventInstructionId = default(string), ResourceId portfolioId = default(ResourceId), string instrumentEventId = default(string), string instructionType = default(string), string electionKey = default(string), long? holdingId = default(long?), Version version = default(Version), string href = default(string), List<Link> links = default(List<Link>))
        {
