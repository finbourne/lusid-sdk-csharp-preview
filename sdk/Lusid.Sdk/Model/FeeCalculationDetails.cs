...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FeeCalculationDetails : IEquatable<FeeCalculationDetails>
    {
        ...
        public FeeCalculationDetails(string ruleType = default(string), string ruleInformation = default(string), Dictionary<string, string> additionalInformation = default(Dictionary<string, string>), string propertyKey = default(string), CalculationInfo fee = default(CalculationInfo), CalculationInfo maxFee = default(CalculationInfo), CalculationInfo minFee = default(CalculationInfo))
        {
            ...
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for FeeCalculationDetails and cannot be null");
            this.MaxFee = maxFee;
            this.MinFee = minFee;
        }
