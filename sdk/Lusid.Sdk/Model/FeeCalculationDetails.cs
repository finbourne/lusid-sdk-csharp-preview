...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FeeCalculationDetails : IEquatable<FeeCalculationDetails>
    {
        ...
        /// <param name="calculationInfo">Information for calculating fees and commissions (required).</param>
        public FeeCalculationDetails(string ruleType = default(string), string ruleInformation = default(string), Dictionary<string, string> additionalInformation = default(Dictionary<string, string>), string propertyKey = default(string), List<CalculationInfo> calculationInfo = default(List<CalculationInfo>))
        {
            ...
            // to ensure "calculationInfo" is required (not null)
            this.CalculationInfo = calculationInfo ?? throw new ArgumentNullException("calculationInfo is a required property for FeeCalculationDetails and cannot be null");
        }
        ...
        /// </summary>
        /// <value>Information for calculating fees and commissions</value>
        [DataMember(Name = "calculationInfo", IsRequired = true, EmitDefaultValue = false)]
        public List<CalculationInfo> CalculationInfo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CalculationInfo: ").Append(CalculationInfo).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(FeeCalculationDetails input)
        {
            ...
            return 
                ...
                (
                    this.CalculationInfo == input.CalculationInfo ||
                    this.CalculationInfo != null &&
                    input.CalculationInfo != null &&
                    this.CalculationInfo.SequenceEqual(input.CalculationInfo)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CalculationInfo != null)
                    hashCode = hashCode * 59 + this.CalculationInfo.GetHashCode();
                return hashCode;
            }
        }
