...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentEventInstructionRequest : IEquatable<InstrumentEventInstructionRequest>
    {
        /// <summary>
        ...
        public InstrumentEventInstructionRequest(string instrumentEventInstructionId = default(string), string instrumentEventId = default(string), string instructionType = default(string), string electionKey = default(string), long? holdingId = default(long?))
        {
            ...
            this.InstrumentEventInstructionId = instrumentEventInstructionId ?? throw new ArgumentNullException("instrumentEventInstructionId is a required property for InstrumentEventInstructionRequest and cannot be null");
            // to ensure "instrumentEventId" is required (not null)
            this.InstrumentEventId = instrumentEventId ?? throw new ArgumentNullException("instrumentEventId is a required property for InstrumentEventInstructionRequest and cannot be null");
            // to ensure "instructionType" is required (not null)
            this.InstructionType = instructionType ?? throw new ArgumentNullException("instructionType is a required property for InstrumentEventInstructionRequest and cannot be null");
        ...
        [DataMember(Name = "instrumentEventInstructionId", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "instructionType", IsRequired = true, EmitDefaultValue = false)]
