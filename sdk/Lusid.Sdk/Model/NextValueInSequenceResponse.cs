...
namespace Lusid.Sdk.Model
{
    ...
    public partial class NextValueInSequenceResponse : IEquatable<NextValueInSequenceResponse>
    {
        /// <summary>
        ...
        public NextValueInSequenceResponse(List<string> values = default(List<string>), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for NextValueInSequenceResponse and cannot be null");
            this.Links = links;
        }
