...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StringEqualsCriterion")]
    [JsonConverter(typeof(JsonSubtypes), "CriterionOp")]
    public partial class StringEqualsCriterion : PropertyCriterion, IEquatable<StringEqualsCriterion>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringEqualsCriterion" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StringEqualsCriterion() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StringEqualsCriterion" /> class.
        /// </summary>
        ...
        public StringEqualsCriterion(string key = default(string), string value = default(string), OpEnum op = default(OpEnum)) : base(op)
        {
            // to ensure "key" is required (not null)
            this.Key = key ?? throw new ArgumentNullException("key is a required property for StringEqualsCriterion and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for StringEqualsCriterion and cannot be null");
        }
        ...
        {
            return this.Equals(input as StringEqualsCriterion);
        }

        /// <summary>
        /// Returns true if StringEqualsCriterion instances are equal
        /// </summary>
        /// <param name="input">Instance of StringEqualsCriterion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringEqualsCriterion input)
        {
            if (input == null)
                return false;
