...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FlexibleLoanAllOf : IEquatable<FlexibleLoanAllOf>
    {
        /// <summary>
        ...
        public FlexibleLoanAllOf(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), string domCcy = default(string), List<Schedule> schedules = default(List<Schedule>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for FlexibleLoanAllOf and cannot be null");
            // to ensure "schedules" is required (not null)
            this.Schedules = schedules ?? throw new ArgumentNullException("schedules is a required property for FlexibleLoanAllOf and cannot be null");
