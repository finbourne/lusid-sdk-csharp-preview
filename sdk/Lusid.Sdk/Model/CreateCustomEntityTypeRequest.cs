...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateCustomEntityTypeRequest : IEquatable<CreateCustomEntityTypeRequest>
    {
        /// <summary>
        ...
        public CreateCustomEntityTypeRequest(string entityTypeName = default(string), string displayName = default(string), string description = default(string), List<CustomEntityFieldDefinition> fieldSchema = default(List<CustomEntityFieldDefinition>))
        {
            ...
            this.EntityTypeName = entityTypeName ?? throw new ArgumentNullException("entityTypeName is a required property for CreateCustomEntityTypeRequest and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CreateCustomEntityTypeRequest and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for CreateCustomEntityTypeRequest and cannot be null");
            // to ensure "fieldSchema" is required (not null)
            this.FieldSchema = fieldSchema ?? throw new ArgumentNullException("fieldSchema is a required property for CreateCustomEntityTypeRequest and cannot be null");
        }
