...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EligibilityCalculation : IEquatable<EligibilityCalculation>
    {
        /// <summary>
        ...
        public EligibilityCalculation(string entitlementDate = default(string), string eligibleUnits = default(string))
        {
            ...
            this.EntitlementDate = entitlementDate ?? throw new ArgumentNullException("entitlementDate is a required property for EligibilityCalculation and cannot be null");
            // to ensure "eligibleUnits" is required (not null)
            this.EligibleUnits = eligibleUnits ?? throw new ArgumentNullException("eligibleUnits is a required property for EligibilityCalculation and cannot be null");
        }

        /// <summary>
        /// Gets or Sets EntitlementDate
        /// </summary>
        [DataMember(Name = "entitlementDate", IsRequired = true, EmitDefaultValue = false)]
        public string EntitlementDate { get; set; }

        /// <summary>
        /// Gets or Sets EligibleUnits
        /// </summary>
        [DataMember(Name = "eligibleUnits", IsRequired = true, EmitDefaultValue = false)]
