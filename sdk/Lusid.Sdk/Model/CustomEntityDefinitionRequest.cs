...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CustomEntityDefinitionRequest :  IEquatable<CustomEntityDefinitionRequest>
    {
        ...
        public CustomEntityDefinitionRequest(string customEntityId = default(string), string displayName = default(string), string description = default(string), List<CustomEntityFieldDefinition> fieldSchema = default(List<CustomEntityFieldDefinition>))
        {
            ...
            {
                throw new InvalidDataException("customEntityId is a required property for CustomEntityDefinitionRequest and cannot be null");
            }
            else
            {
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for CustomEntityDefinitionRequest and cannot be null");
            }
            else
            {
