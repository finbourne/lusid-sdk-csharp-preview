...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CustomEntityDefinitionRequest : IEquatable<CustomEntityDefinitionRequest>
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="CustomEntityDefinitionRequest" /> class.
        /// </summary>
        /// <param name="entityTypeName">A name for the custom entity type. This will be prefixed with â€œ~â€ and returned as â€œentityTypeâ€, which is the identifier for the custom entity type. (required).</param>
        ...
        public CustomEntityDefinitionRequest(string entityTypeName = default(string), string displayName = default(string), string description = default(string), List<CustomEntityFieldDefinition> fieldSchema = default(List<CustomEntityFieldDefinition>))
        {
            ...
            this.EntityTypeName = entityTypeName ?? throw new ArgumentNullException("entityTypeName is a required property for CustomEntityDefinitionRequest and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CustomEntityDefinitionRequest and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for CustomEntityDefinitionRequest and cannot be null");
            // to ensure "fieldSchema" is required (not null)
            this.FieldSchema = fieldSchema ?? throw new ArgumentNullException("fieldSchema is a required property for CustomEntityDefinitionRequest and cannot be null");
        }

        /// <summary>
        /// A name for the custom entity type. This will be prefixed with â€œ~â€ and returned as â€œentityTypeâ€, which is the identifier for the custom entity type.
        /// </summary>
        /// <value>A name for the custom entity type. This will be prefixed with â€œ~â€ and returned as â€œentityTypeâ€, which is the identifier for the custom entity type.</value>
