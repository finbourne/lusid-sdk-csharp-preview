...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxConventions : IEquatable<FxConventions>
    {
        /// <summary>
        ...
        public FxConventions(string fgnCcy = default(string), string domCcy = default(string), string fixingReference = default(string))
        {
            ...
            this.FgnCcy = fgnCcy ?? throw new ArgumentNullException("fgnCcy is a required property for FxConventions and cannot be null");
            // to ensure "domCcy" is required (not null)
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for FxConventions and cannot be null");
            // to ensure "fixingReference" is required (not null)
            this.FixingReference = fixingReference ?? throw new ArgumentNullException("fixingReference is a required property for FxConventions and cannot be null");
        }
