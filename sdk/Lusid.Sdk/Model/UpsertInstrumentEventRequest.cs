...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertInstrumentEventRequest : IEquatable<UpsertInstrumentEventRequest>
    {
        /// <summary>
        ...
        /// <param name="eventDetail">eventDetail (required).</param>
        /// <param name="properties">The properties attached to this instrument event..</param>
        public UpsertInstrumentEventRequest(string instrumentEventId = default(string), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), string description = default(string), InstrumentEvent eventDetail = default(InstrumentEvent), List<Property> properties = default(List<Property>))
        {
            ...
            this.InstrumentIdentifiers = instrumentIdentifiers ?? throw new ArgumentNullException("instrumentIdentifiers is a required property for UpsertInstrumentEventRequest and cannot be null");
            // to ensure "eventDetail" is required (not null)
            this.EventDetail = eventDetail ?? throw new ArgumentNullException("eventDetail is a required property for UpsertInstrumentEventRequest and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "eventDetail", IsRequired = true, EmitDefaultValue = false)]
        public InstrumentEvent EventDetail { get; set; }
