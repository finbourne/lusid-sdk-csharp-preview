...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertInstrumentEventRequest : IEquatable<UpsertInstrumentEventRequest>
    {
        ...
        public UpsertInstrumentEventRequest(string instrumentEventId = default(string), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), string description = default(string), InstrumentEvent instrumentEvent = default(InstrumentEvent), List<Property> properties = default(List<Property>))
        {
