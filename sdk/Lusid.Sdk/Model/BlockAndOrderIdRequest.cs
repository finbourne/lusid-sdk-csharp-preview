...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BlockAndOrderIdRequest : IEquatable<BlockAndOrderIdRequest>
    {
        /// <summary>
        ...
        public BlockAndOrderIdRequest(ResourceId destinationBlockId = default(ResourceId), ResourceId orderId = default(ResourceId))
        {
            ...
            this.DestinationBlockId = destinationBlockId ?? throw new ArgumentNullException("destinationBlockId is a required property for BlockAndOrderIdRequest and cannot be null");
            // to ensure "orderId" is required (not null)
            this.OrderId = orderId ?? throw new ArgumentNullException("orderId is a required property for BlockAndOrderIdRequest and cannot be null");
        }

        /// <summary>
        /// Gets or Sets DestinationBlockId
        /// </summary>
        [DataMember(Name = "destinationBlockId", IsRequired = true, EmitDefaultValue = false)]
