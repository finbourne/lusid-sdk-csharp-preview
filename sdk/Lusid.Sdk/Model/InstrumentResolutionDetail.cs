...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentResolutionDetail : IEquatable<InstrumentResolutionDetail>
    {
        /// <summary>
        ...
        public InstrumentResolutionDetail(Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>))
        {
            ...
            this.InstrumentIdentifiers = instrumentIdentifiers ?? throw new ArgumentNullException("instrumentIdentifiers is a required property for InstrumentResolutionDetail and cannot be null");
        }
