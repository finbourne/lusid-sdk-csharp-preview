...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxRateSchedule : Schedule, IEquatable<FxRateSchedule>
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="FxRateSchedule" /> class.
        /// </summary>
        /// <param name="fixingLag">If rate is not known upfront then will need a fixing rate. Can be fixed x number of days before payment date..</param>
        ...
        /// <param name="scheduleType">The available values are: Fixed, Float, Optionality, Step, Exercise, FxRate, Invalid (required) (default to &quot;FxRateSchedule&quot;).</param>
        public FxRateSchedule(int fixingLag = default(int), List<string> fxConversionTypes = default(List<string>), decimal rate = default(decimal), string toCurrency = default(string), ScheduleTypeEnum scheduleType = default(ScheduleTypeEnum)) : base(scheduleType)
        {
        ...
        /// </summary>
        /// <value>If rate is not known upfront then will need a fixing rate. Can be fixed x number of days before payment date.</value>
        [DataMember(Name = "fixingLag", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FixingLag: ").Append(FixingLag).Append("\n");
        ...
        public bool Equals(FxRateSchedule input)
        {
            ...
            return base.Equals(input) && 
                (
                    this.FixingLag == input.FixingLag ||
                    this.FixingLag.Equals(input.FixingLag)
                ) && base.Equals(input) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.FixingLag.GetHashCode();
