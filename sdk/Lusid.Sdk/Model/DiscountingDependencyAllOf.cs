...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DiscountingDependencyAllOf : IEquatable<DiscountingDependencyAllOf>
    {
        /// <summary>
        ...
        public DiscountingDependencyAllOf(string currency = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum))
        {
            ...
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for DiscountingDependencyAllOf and cannot be null");
            this.Date = date;
