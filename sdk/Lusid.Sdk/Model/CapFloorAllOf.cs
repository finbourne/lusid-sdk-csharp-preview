...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CapFloorAllOf : IEquatable<CapFloorAllOf>
    {
        /// <summary>
        ...
        public CapFloorAllOf(string capFloorType = default(string), decimal capStrike = default(decimal), decimal floorStrike = default(decimal), bool includeFirstCaplet = default(bool), FloatingLeg underlyingFloatingLeg = default(FloatingLeg), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.CapFloorType = capFloorType ?? throw new ArgumentNullException("capFloorType is a required property for CapFloorAllOf and cannot be null");
            ...
            this.UnderlyingFloatingLeg = underlyingFloatingLeg ?? throw new ArgumentNullException("underlyingFloatingLeg is a required property for CapFloorAllOf and cannot be null");
