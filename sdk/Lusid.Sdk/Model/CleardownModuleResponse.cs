...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CleardownModuleResponse : IEquatable<CleardownModuleResponse>
    {
        /// <summary>
        ...
        public CleardownModuleResponse(string href = default(string), string cleardownModuleCode = default(string), ResourceId chartOfAccountsId = default(ResourceId), string displayName = default(string), string description = default(string), List<CleardownModuleRule> rules = default(List<CleardownModuleRule>), string status = default(string), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "cleardownModuleCode" is required (not null)
            this.CleardownModuleCode = cleardownModuleCode ?? throw new ArgumentNullException("cleardownModuleCode is a required property for CleardownModuleResponse and cannot be null");
            // to ensure "chartOfAccountsId" is required (not null)
            this.ChartOfAccountsId = chartOfAccountsId ?? throw new ArgumentNullException("chartOfAccountsId is a required property for CleardownModuleResponse and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CleardownModuleResponse and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for CleardownModuleResponse and cannot be null");
            this.Href = href;
        ...
        [DataMember(Name = "cleardownModuleCode", IsRequired = true, EmitDefaultValue = false)]
