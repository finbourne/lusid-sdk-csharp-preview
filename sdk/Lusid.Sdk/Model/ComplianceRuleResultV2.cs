...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceRuleResultV2 : IEquatable<ComplianceRuleResultV2>
    {
        /// <summary>
        ...
        public ComplianceRuleResultV2(ResourceId runId = default(ResourceId), DateTimeOffset instigatedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), string schedule = default(string), ComplianceSummaryRuleResult ruleResult = default(ComplianceSummaryRuleResult))
        {
            ...
            this.RunId = runId ?? throw new ArgumentNullException("runId is a required property for ComplianceRuleResultV2 and cannot be null");
            this.InstigatedAt = instigatedAt;
            this.CompletedAt = completedAt;
            // to ensure "schedule" is required (not null)
            this.Schedule = schedule ?? throw new ArgumentNullException("schedule is a required property for ComplianceRuleResultV2 and cannot be null");
            // to ensure "ruleResult" is required (not null)
            this.RuleResult = ruleResult ?? throw new ArgumentNullException("ruleResult is a required property for ComplianceRuleResultV2 and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "ruleResult", IsRequired = true, EmitDefaultValue = false)]
