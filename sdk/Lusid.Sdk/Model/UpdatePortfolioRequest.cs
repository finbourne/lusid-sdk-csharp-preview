...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpdatePortfolioRequest :  IEquatable<UpdatePortfolioRequest>
    {
        ...
        /// <param name="created">The effective datetime at which the transaction portfolio was created. No transactions can be added to the transaction portfolio before this date. (required).</param>
        public UpdatePortfolioRequest(string displayName = default(string), string description = default(string), DateTimeOffset? created = default(DateTimeOffset?))
        {
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for UpdatePortfolioRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The effective datetime at which the transaction portfolio was created. No transactions can be added to the transaction portfolio before this date.</value>
