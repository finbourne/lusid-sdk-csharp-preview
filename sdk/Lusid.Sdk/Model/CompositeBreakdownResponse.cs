...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CompositeBreakdownResponse : IEquatable<CompositeBreakdownResponse>
    {
        /// <summary>
        ...
        public CompositeBreakdownResponse(string href = default(string), Dictionary<string, List<CompositeBreakdown>> results = default(Dictionary<string, List<CompositeBreakdown>>), List<Link> links = default(List<Link>))
        {
            ...
            this.Results = results ?? throw new ArgumentNullException("results is a required property for CompositeBreakdownResponse and cannot be null");
            this.Href = href;
            this.Links = links;
        }
