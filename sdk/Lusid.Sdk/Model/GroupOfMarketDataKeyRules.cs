...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupOfMarketDataKeyRules : IEquatable<GroupOfMarketDataKeyRules>
    {
        /// <summary>
        ...
        public GroupOfMarketDataKeyRules(string marketDataKeyRuleGroupOperation = default(string), List<MarketDataKeyRule> marketRules = default(List<MarketDataKeyRule>))
        {
            ...
            this.MarketDataKeyRuleGroupOperation = marketDataKeyRuleGroupOperation ?? throw new ArgumentNullException("marketDataKeyRuleGroupOperation is a required property for GroupOfMarketDataKeyRules and cannot be null");
            // to ensure "marketRules" is required (not null)
            this.MarketRules = marketRules ?? throw new ArgumentNullException("marketRules is a required property for GroupOfMarketDataKeyRules and cannot be null");
        }
        ...
        [DataMember(Name = "marketDataKeyRuleGroupOperation", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "marketRules", IsRequired = true, EmitDefaultValue = false)]
