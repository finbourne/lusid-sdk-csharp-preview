...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SetTransactionConfigurationSourceRequest : IEquatable<SetTransactionConfigurationSourceRequest>
    {
        /// <summary>
        ...
        public SetTransactionConfigurationSourceRequest(List<SetTransactionConfigurationAlias> aliases = default(List<SetTransactionConfigurationAlias>), List<TransactionConfigurationMovementDataRequest> movements = default(List<TransactionConfigurationMovementDataRequest>), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>))
        {
            ...
            this.Aliases = aliases ?? throw new ArgumentNullException("aliases is a required property for SetTransactionConfigurationSourceRequest and cannot be null");
            // to ensure "movements" is required (not null)
            this.Movements = movements ?? throw new ArgumentNullException("movements is a required property for SetTransactionConfigurationSourceRequest and cannot be null");
