...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PortfolioResultDataKeyRule_allOf")]
    public partial class PortfolioResultDataKeyRuleAllOf : IEquatable<PortfolioResultDataKeyRuleAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioResultDataKeyRuleAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PortfolioResultDataKeyRuleAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioResultDataKeyRuleAllOf" /> class.
        /// </summary>
        ...
        public PortfolioResultDataKeyRuleAllOf(string supplier = default(string), string dataScope = default(string), string documentCode = default(string), string quoteInterval = default(string), DateTimeOffset? asAt = default(DateTimeOffset?), string portfolioCode = default(string), string portfolioScope = default(string), ResultKeyRuleTypeEnum resultKeyRuleType = default(ResultKeyRuleTypeEnum))
        {
            // to ensure "supplier" is required (not null)
            this.Supplier = supplier ?? throw new ArgumentNullException("supplier is a required property for PortfolioResultDataKeyRuleAllOf and cannot be null");
            // to ensure "dataScope" is required (not null)
            this.DataScope = dataScope ?? throw new ArgumentNullException("dataScope is a required property for PortfolioResultDataKeyRuleAllOf and cannot be null");
            // to ensure "documentCode" is required (not null)
            this.DocumentCode = documentCode ?? throw new ArgumentNullException("documentCode is a required property for PortfolioResultDataKeyRuleAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PortfolioResultDataKeyRuleAllOf {\n");
        ...
        {
            return this.Equals(input as PortfolioResultDataKeyRuleAllOf);
        }

        /// <summary>
        /// Returns true if PortfolioResultDataKeyRuleAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioResultDataKeyRuleAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioResultDataKeyRuleAllOf input)
        {
            if (input == null)
                return false;
