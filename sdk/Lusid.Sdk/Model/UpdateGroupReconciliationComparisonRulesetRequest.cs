...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpdateGroupReconciliationComparisonRulesetRequest : IEquatable<UpdateGroupReconciliationComparisonRulesetRequest>
    {
        /// <summary>
        ...
        public UpdateGroupReconciliationComparisonRulesetRequest(string displayName = default(string), string reconciliationType = default(string), List<GroupReconciliationCoreAttributeRule> coreAttributeRules = default(List<GroupReconciliationCoreAttributeRule>), List<GroupReconciliationAggregateAttributeRule> aggregateAttributeRules = default(List<GroupReconciliationAggregateAttributeRule>))
        {
            ...
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for UpdateGroupReconciliationComparisonRulesetRequest and cannot be null");
            // to ensure "reconciliationType" is required (not null)
            this.ReconciliationType = reconciliationType ?? throw new ArgumentNullException("reconciliationType is a required property for UpdateGroupReconciliationComparisonRulesetRequest and cannot be null");
            // to ensure "coreAttributeRules" is required (not null)
            this.CoreAttributeRules = coreAttributeRules ?? throw new ArgumentNullException("coreAttributeRules is a required property for UpdateGroupReconciliationComparisonRulesetRequest and cannot be null");
            // to ensure "aggregateAttributeRules" is required (not null)
            this.AggregateAttributeRules = aggregateAttributeRules ?? throw new ArgumentNullException("aggregateAttributeRules is a required property for UpdateGroupReconciliationComparisonRulesetRequest and cannot be null");
        }
