...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FieldValue : IEquatable<FieldValue>
    {
        ...
        public FieldValue(string value = default(string), Dictionary<string, string> fields = default(Dictionary<string, string>))
        {
            ...
            this.Value = value ?? throw new ArgumentNullException("value is a required property for FieldValue and cannot be null");
            // to ensure "fields" is required (not null)
            this.Fields = fields ?? throw new ArgumentNullException("fields is a required property for FieldValue and cannot be null");
        }
