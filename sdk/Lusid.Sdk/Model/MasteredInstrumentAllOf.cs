...
namespace Lusid.Sdk.Model
{
    ...
    public partial class MasteredInstrumentAllOf : IEquatable<MasteredInstrumentAllOf>
    {
        /// <summary>
        ...
        public MasteredInstrumentAllOf(Dictionary<string, string> identifiers = default(Dictionary<string, string>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.Identifiers = identifiers ?? throw new ArgumentNullException("identifiers is a required property for MasteredInstrumentAllOf and cannot be null");
