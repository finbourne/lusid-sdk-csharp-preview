...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FundConfigurationRequest : IEquatable<FundConfigurationRequest>
    {
        ...
        public FundConfigurationRequest(string code = default(string), string displayName = default(string), string description = default(string), List<ComponentRule> componentRules = default(List<ComponentRule>), Dictionary<string, Property> properties = default(Dictionary<string, Property>))
        {
            ...
            this.ComponentRules = componentRules ?? throw new ArgumentNullException("componentRules is a required property for FundConfigurationRequest and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "componentRules", IsRequired = true, EmitDefaultValue = false)]
