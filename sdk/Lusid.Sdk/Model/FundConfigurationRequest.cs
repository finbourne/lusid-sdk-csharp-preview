...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FundConfigurationRequest : IEquatable<FundConfigurationRequest>
    {
        /// <summary>
        ...
        public FundConfigurationRequest(string code = default(string), string displayName = default(string), string description = default(string), List<ComponentFilter> dealingFilters = default(List<ComponentFilter>), List<ComponentFilter> pnlFilters = default(List<ComponentFilter>), List<ComponentFilter> backOutFilters = default(List<ComponentFilter>), Dictionary<string, Property> properties = default(Dictionary<string, Property>))
        {
            ...
            this.DealingFilters = dealingFilters ?? throw new ArgumentNullException("dealingFilters is a required property for FundConfigurationRequest and cannot be null");
            // to ensure "pnlFilters" is required (not null)
            this.PnlFilters = pnlFilters ?? throw new ArgumentNullException("pnlFilters is a required property for FundConfigurationRequest and cannot be null");
            // to ensure "backOutFilters" is required (not null)
            this.BackOutFilters = backOutFilters ?? throw new ArgumentNullException("backOutFilters is a required property for FundConfigurationRequest and cannot be null");
        ...
        [DataMember(Name = "dealingFilters", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "pnlFilters", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "backOutFilters", IsRequired = true, EmitDefaultValue = false)]
