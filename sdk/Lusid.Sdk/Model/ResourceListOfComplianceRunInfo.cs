...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfComplianceRunInfo : IEquatable<ResourceListOfComplianceRunInfo>
    {
        /// <summary>
        ...
        public ResourceListOfComplianceRunInfo(List<ComplianceRunInfo> values = default(List<ComplianceRunInfo>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfComplianceRunInfo and cannot be null");
            this.Href = href;
            this.Links = links;
