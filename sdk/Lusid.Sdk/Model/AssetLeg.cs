...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AssetLeg : IEquatable<AssetLeg>
    {
        /// <summary>
        ...
        public AssetLeg(LusidInstrument asset = default(LusidInstrument), string payReceive = default(string))
        {
            ...
            this.Asset = asset ?? throw new ArgumentNullException("asset is a required property for AssetLeg and cannot be null");
            // to ensure "payReceive" is required (not null)
            this.PayReceive = payReceive ?? throw new ArgumentNullException("payReceive is a required property for AssetLeg and cannot be null");
        }
