...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfBlockAndOrder : IEquatable<ResourceListOfBlockAndOrder>
    {
        /// <summary>
        ...
        public ResourceListOfBlockAndOrder(List<BlockAndOrder> values = default(List<BlockAndOrder>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfBlockAndOrder and cannot be null");
            this.Href = href;
            this.Links = links;
