...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PerformanceReturnsMetric : IEquatable<PerformanceReturnsMetric>
    {
        ...
        public PerformanceReturnsMetric(string type = default(string), string window = default(string), bool allowPartial = default(bool), bool annualised = default(bool), bool withFee = default(bool), decimal? seedAmount = default(decimal?), string alias = default(string))
        {
            this.Type = type;
            this.Window = window;
