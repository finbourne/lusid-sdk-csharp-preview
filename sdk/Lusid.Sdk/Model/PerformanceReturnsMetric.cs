...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PerformanceReturnsMetric : IEquatable<PerformanceReturnsMetric>
    {
        ...
        public PerformanceReturnsMetric(string window = default(string), bool allowPartial = default(bool), bool annualised = default(bool), bool withFee = default(bool), string alias = default(string))
        {
            this.Window = window;
