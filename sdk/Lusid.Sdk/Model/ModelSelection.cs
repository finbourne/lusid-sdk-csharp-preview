...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ModelSelection :  IEquatable<ModelSelection>
    {
        ...
        /// </summary>
        /// <value>The available values are: SimpleStatic, Discounting, VendorDefault, BlackScholes, ConstantTimeValueOfMoney, Bachelier, ForwardWithPoints, ForwardWithPointsUndiscounted</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="model">The available values are: SimpleStatic, Discounting, VendorDefault, BlackScholes, ConstantTimeValueOfMoney, Bachelier, ForwardWithPoints, ForwardWithPointsUndiscounted (required).</param>
