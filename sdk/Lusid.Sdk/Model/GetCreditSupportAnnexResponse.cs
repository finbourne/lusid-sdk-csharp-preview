...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCreditSupportAnnexResponse")]
    public partial class GetCreditSupportAnnexResponse : IEquatable<GetCreditSupportAnnexResponse>
    {
        /// <summary>
        ...
        public CreditSupportAnnex Value { get; set; }

        /// <summary>
        /// The credit support annex that could not be updated or inserted along with a reason for failure.
        /// </summary>
        /// <value>The credit support annex that could not be updated or inserted along with a reason for failure.</value>
        ...
        {
            return this.Equals(input as GetCreditSupportAnnexResponse);
        }

        /// <summary>
        /// Returns true if GetCreditSupportAnnexResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCreditSupportAnnexResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCreditSupportAnnexResponse input)
        {
            if (input == null)
                return false;
