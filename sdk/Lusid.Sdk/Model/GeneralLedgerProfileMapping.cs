...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GeneralLedgerProfileMapping : IEquatable<GeneralLedgerProfileMapping>
    {
        /// <summary>
        ...
        public GeneralLedgerProfileMapping(string mappingFilter = default(string), List<string> levels = default(List<string>))
        {
            ...
            this.MappingFilter = mappingFilter ?? throw new ArgumentNullException("mappingFilter is a required property for GeneralLedgerProfileMapping and cannot be null");
            // to ensure "levels" is required (not null)
            this.Levels = levels ?? throw new ArgumentNullException("levels is a required property for GeneralLedgerProfileMapping and cannot be null");
        }
        ...
        [DataMember(Name = "mappingFilter", IsRequired = true, EmitDefaultValue = false)]
