...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfGetCdsFlowConventionsResponse :  IEquatable<ResourceListOfGetCdsFlowConventionsResponse>
    {
        /// <summary>
        ...
        public ResourceListOfGetCdsFlowConventionsResponse(List<GetCdsFlowConventionsResponse> values = default(List<GetCdsFlowConventionsResponse>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfGetCdsFlowConventionsResponse and cannot be null");
            }
            else
            {
                this.Values = values;
