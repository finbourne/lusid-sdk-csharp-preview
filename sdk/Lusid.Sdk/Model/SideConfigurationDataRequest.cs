...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SideConfigurationDataRequest :  IEquatable<SideConfigurationDataRequest>
    {
        ...
        public SideConfigurationDataRequest(string side = default(string), string security = default(string), string currency = default(string), string rate = default(string), string units = default(string), string amount = default(string))
        {
            ...
            if (side == null)
            {
                throw new InvalidDataException("side is a required property for SideConfigurationDataRequest and cannot be null");
            }
            else
            {
                this.Side = side;
            ...
            if (security == null)
            {
                throw new InvalidDataException("security is a required property for SideConfigurationDataRequest and cannot be null");
            }
            else
            {
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for SideConfigurationDataRequest and cannot be null");
            }
            else
            {
            ...
            if (rate == null)
            {
                throw new InvalidDataException("rate is a required property for SideConfigurationDataRequest and cannot be null");
            }
            else
            {
                this.Rate = rate;
            ...
            if (units == null)
            {
                throw new InvalidDataException("units is a required property for SideConfigurationDataRequest and cannot be null");
            }
            else
            {
                this.Units = units;
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for SideConfigurationDataRequest and cannot be null");
            }
            else
            {
                this.Amount = amount;
