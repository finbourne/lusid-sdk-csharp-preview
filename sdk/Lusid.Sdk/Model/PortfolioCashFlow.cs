...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioCashFlow :  IEquatable<PortfolioCashFlow>
    {
        ...
        /// <param name="sequenceNumber">Sequence number determing the order of the cash flow records. (required).</param>
        ...
        /// <summary>
        /// Sequence number determing the order of the cash flow records.
        /// </summary>
        /// <value>Sequence number determing the order of the cash flow records.</value>
