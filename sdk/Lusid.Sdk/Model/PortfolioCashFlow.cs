...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioCashFlow :  IEquatable<PortfolioCashFlow>
    {
        ...
        /// <param name="subHoldings">subHoldings.</param>
        /// <param name="type">type (required).</param>
        /// <param name="movementName">movementName (required).</param>
        ...
        public PortfolioCashFlow(int? sequenceNumber = default(int?), Dictionary<string, PerpetualProperty> subHoldings = default(Dictionary<string, PerpetualProperty>), string type = default(string), string movementName = default(string), CurrencyAndAmount cashflow = default(CurrencyAndAmount), CurrencyAndAmount balance = default(CurrencyAndAmount), decimal? fxRate = default(decimal?), CurrencyAndAmount cashflowReportingCurrency = default(CurrencyAndAmount), CurrencyAndAmount balanceReportingCurrency = default(CurrencyAndAmount), CurrencyAndAmount translationGainLoss = default(CurrencyAndAmount), CurrencyAndAmount costBasisReportingCurrency = default(CurrencyAndAmount), Transaction transaction = default(Transaction))
        {
            ...
            if (transaction == null)
            {
                throw new InvalidDataException("transaction is a required property for PortfolioCashFlow and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets SubHoldings
        /// </summary>
        [DataMember(Name="subHoldings", EmitDefaultValue=true)]
        public Dictionary<string, PerpetualProperty> SubHoldings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SubHoldings: ").Append(SubHoldings).Append("\n");
        ...
        public bool Equals(PortfolioCashFlow input)
        {
            ...
            return 
                ...
                (
                    this.SubHoldings == input.SubHoldings ||
                    this.SubHoldings != null &&
                    input.SubHoldings != null &&
                    this.SubHoldings.SequenceEqual(input.SubHoldings)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SubHoldings != null)
                    hashCode = hashCode * 59 + this.SubHoldings.GetHashCode();
                if (this.Type != null)
