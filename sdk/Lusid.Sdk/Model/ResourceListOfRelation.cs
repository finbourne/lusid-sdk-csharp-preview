...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfRelation :  IEquatable<ResourceListOfRelation>
    {
        ...
        public ResourceListOfRelation(List<Relation> values = default(List<Relation>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
