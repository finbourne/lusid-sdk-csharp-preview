...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfRelation")]
    public partial class ResourceListOfRelation : IEquatable<ResourceListOfRelation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfRelation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfRelation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfRelation" /> class.
        /// </summary>
        ...
        public ResourceListOfRelation(List<Relation> values = default(List<Relation>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfRelation and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<Relation> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfRelation {\n");
        ...
        {
            return this.Equals(input as ResourceListOfRelation);
        }

        /// <summary>
        /// Returns true if ResourceListOfRelation instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfRelation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfRelation input)
        {
            if (input == null)
                return false;
