...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityOptionAllOf :  IEquatable<EquityOptionAllOf>
    {
        ...
        public EquityOptionAllOf(string code = default(string), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? optionMaturityDate = default(DateTimeOffset?), DateTimeOffset? optionSettlementDate = default(DateTimeOffset?), bool? isDeliveryNotCash = default(bool?), bool? isCallNotPut = default(bool?), decimal? strike = default(decimal?), string domCcy = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for EquityOptionAllOf and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for EquityOptionAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("optionMaturityDate is a required property for EquityOptionAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("optionSettlementDate is a required property for EquityOptionAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("isDeliveryNotCash is a required property for EquityOptionAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("isCallNotPut is a required property for EquityOptionAllOf and cannot be null");
            }
            else
            {
            ...
            if (strike == null)
            {
                throw new InvalidDataException("strike is a required property for EquityOptionAllOf and cannot be null");
            }
            else
            {
                this.Strike = strike;
            ...
            if (domCcy == null)
            {
                throw new InvalidDataException("domCcy is a required property for EquityOptionAllOf and cannot be null");
            }
            else
            {
                this.DomCcy = domCcy;
            ...
            {
                throw new InvalidDataException("instrumentType is a required property for EquityOptionAllOf and cannot be null");
            }
            else
            {
