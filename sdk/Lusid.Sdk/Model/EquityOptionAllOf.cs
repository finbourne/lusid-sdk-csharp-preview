...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityOptionAllOf :  IEquatable<EquityOptionAllOf>
    {
        ...
        public EquityOptionAllOf(string code = default(string), decimal? strike = default(decimal?), DateTimeOffset? optionMaturityDate = default(DateTimeOffset?), DateTimeOffset? optionSettlementDate = default(DateTimeOffset?), DateTimeOffset? startDate = default(DateTimeOffset?), OptionTypeEnum optionType = default(OptionTypeEnum), DeliveryTypeEnum deliveryType = default(DeliveryTypeEnum), UnderlyingIdentifierEnum underlyingIdentifier = default(UnderlyingIdentifierEnum), string domCcy = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            if (optionType == null)
            {
                throw new InvalidDataException("optionType is a required property for EquityOptionAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("deliveryType is a required property for EquityOptionAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("underlyingIdentifier is a required property for EquityOptionAllOf and cannot be null");
            }
            else
            {
