...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityOptionAllOf : IEquatable<EquityOptionAllOf>
    {
        ...
        public EquityOptionAllOf(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset optionMaturityDate = default(DateTimeOffset), DateTimeOffset optionSettlementDate = default(DateTimeOffset), string deliveryType = default(string), string optionType = default(string), decimal strike = default(decimal), string domCcy = default(string), string underlyingIdentifier = default(string), string code = default(string), string equityOptionType = default(string), decimal? numberOfShares = default(decimal?), Premium premium = default(Premium), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.DeliveryType = deliveryType ?? throw new ArgumentNullException("deliveryType is a required property for EquityOptionAllOf and cannot be null");
            // to ensure "optionType" is required (not null)
            this.OptionType = optionType ?? throw new ArgumentNullException("optionType is a required property for EquityOptionAllOf and cannot be null");
            this.Strike = strike;
            ...
            this.UnderlyingIdentifier = underlyingIdentifier ?? throw new ArgumentNullException("underlyingIdentifier is a required property for EquityOptionAllOf and cannot be null");
