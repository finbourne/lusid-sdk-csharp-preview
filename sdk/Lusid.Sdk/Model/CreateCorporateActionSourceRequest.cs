...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateCorporateActionSourceRequest : IEquatable<CreateCorporateActionSourceRequest>
    {
        ...
        public CreateCorporateActionSourceRequest(string scope = default(string), string code = default(string), string displayName = default(string), string description = default(string), List<string> instrumentScopes = default(List<string>))
        {
            ...
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for CreateCorporateActionSourceRequest and cannot be null");
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for CreateCorporateActionSourceRequest and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CreateCorporateActionSourceRequest and cannot be null");
