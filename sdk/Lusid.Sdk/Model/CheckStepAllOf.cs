...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CheckStepAllOf : IEquatable<CheckStepAllOf>
    {
        /// <summary>
        ...
        public CheckStepAllOf(string label = default(string), List<ComplianceTemplateParameter> limitCheckParameters = default(List<ComplianceTemplateParameter>), List<ComplianceTemplateParameter> warningCheckParameters = default(List<ComplianceTemplateParameter>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum))
        {
            ...
            this.Label = label ?? throw new ArgumentNullException("label is a required property for CheckStepAllOf and cannot be null");
            // to ensure "limitCheckParameters" is required (not null)
            this.LimitCheckParameters = limitCheckParameters ?? throw new ArgumentNullException("limitCheckParameters is a required property for CheckStepAllOf and cannot be null");
            // to ensure "warningCheckParameters" is required (not null)
            this.WarningCheckParameters = warningCheckParameters ?? throw new ArgumentNullException("warningCheckParameters is a required property for CheckStepAllOf and cannot be null");
