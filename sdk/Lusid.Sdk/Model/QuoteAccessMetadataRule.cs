...
namespace Lusid.Sdk.Model
{
    ...
    public partial class QuoteAccessMetadataRule :  IEquatable<QuoteAccessMetadataRule>
    {
        ...
        public QuoteAccessMetadataRule(QuoteAccessMetadataRuleId id = default(QuoteAccessMetadataRuleId), Dictionary<string, List<AccessMetadataValue>> metadata = default(Dictionary<string, List<AccessMetadataValue>>))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for QuoteAccessMetadataRule and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (metadata == null)
            {
                throw new InvalidDataException("metadata is a required property for QuoteAccessMetadataRule and cannot be null");
            }
            else
            {
