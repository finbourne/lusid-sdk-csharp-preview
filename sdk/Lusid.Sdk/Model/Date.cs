...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Date :  IEquatable<Date>
    {
        ...
        public Date(string href = default(string), ResourceId calendarIdentifier = default(ResourceId), string dateIdentifier = default(string), DateTimeOffset? fromUtc = default(DateTimeOffset?), DateTimeOffset? toUtc = default(DateTimeOffset?), string localDate = default(string), string timezone = default(string), string description = default(string), string type = default(string), DateAttributes attributes = default(DateAttributes), Dictionary<string, string> sourceData = default(Dictionary<string, string>))
        {
            ...
            {
                throw new InvalidDataException("dateIdentifier is a required property for Date and cannot be null");
            }
            else
            {
            ...
            if (fromUtc == null)
            {
                throw new InvalidDataException("fromUtc is a required property for Date and cannot be null");
            }
            else
            {
            ...
            if (toUtc == null)
            {
                throw new InvalidDataException("toUtc is a required property for Date and cannot be null");
            }
            else
            {
                this.ToUtc = toUtc;
            ...
            if (localDate == null)
            {
                throw new InvalidDataException("localDate is a required property for Date and cannot be null");
            }
            else
            {
            ...
            if (timezone == null)
            {
                throw new InvalidDataException("timezone is a required property for Date and cannot be null");
            }
            else
            {
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for Date and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Date and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Date and cannot be null");
            }
            else
            {
            ...
            if (sourceData == null)
            {
                throw new InvalidDataException("sourceData is a required property for Date and cannot be null");
            }
            else
            {
