...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfAggregationQuery :  IEquatable<ResourceListOfAggregationQuery>
    {
        /// <summary>
        ...
        public ResourceListOfAggregationQuery(List<AggregationQuery> values = default(List<AggregationQuery>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfAggregationQuery and cannot be null");
            }
            else
            {
                this.Values = values;
