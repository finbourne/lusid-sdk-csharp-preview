...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CalendarDate :  IEquatable<CalendarDate>
    {
        ...
        public CalendarDate(string href = default(string), string dateIdentifier = default(string), DateTimeOffset? fromUtc = default(DateTimeOffset?), DateTimeOffset? toUtc = default(DateTimeOffset?), string localStartDate = default(string), string timezone = default(string), string description = default(string), string type = default(string), DateAttributes attributes = default(DateAttributes), Dictionary<string, string> sourceData = default(Dictionary<string, string>))
        {
            ...
            // to ensure "localStartDate" is required (not null)
            if (localStartDate == null)
            {
                throw new InvalidDataException("localStartDate is a required property for CalendarDate and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets LocalStartDate
        /// </summary>
        [DataMember(Name="localStartDate", EmitDefaultValue=false)]
        ...
        public bool Equals(CalendarDate input)
        {
            ...
            return 
                ...
                (
                    this.LocalStartDate == input.LocalStartDate ||
                    (this.LocalStartDate != null &&
                    this.LocalStartDate.Equals(input.LocalStartDate))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LocalStartDate != null)
                    hashCode = hashCode * 59 + this.LocalStartDate.GetHashCode();
