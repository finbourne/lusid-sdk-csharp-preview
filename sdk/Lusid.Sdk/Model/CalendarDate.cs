...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CalendarDate :  IEquatable<CalendarDate>
    {
        ...
        /// <param name="calendarIdentifier">calendarIdentifier (required).</param>
        ...
        public CalendarDate(string href = default(string), ResourceId calendarIdentifier = default(ResourceId), string dateIdentifier = default(string), DateTimeOffset? fromUtc = default(DateTimeOffset?), DateTimeOffset? toUtc = default(DateTimeOffset?), string localDate = default(string), string timezone = default(string), string description = default(string), string type = default(string), DateAttributes attributes = default(DateAttributes), Dictionary<string, string> sourceData = default(Dictionary<string, string>))
        {
            ...
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for CalendarDate and cannot be null");
            }
            else
            {
            ...
            if (sourceData == null)
            {
                throw new InvalidDataException("sourceData is a required property for CalendarDate and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets CalendarIdentifier
        /// </summary>
        [DataMember(Name="calendarIdentifier", EmitDefaultValue=false)]
        public ResourceId CalendarIdentifier { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CalendarIdentifier: ").Append(CalendarIdentifier).Append("\n");
        ...
        public bool Equals(CalendarDate input)
        {
            ...
            return 
                ...
                (
                    this.CalendarIdentifier == input.CalendarIdentifier ||
                    (this.CalendarIdentifier != null &&
                    this.CalendarIdentifier.Equals(input.CalendarIdentifier))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CalendarIdentifier != null)
                    hashCode = hashCode * 59 + this.CalendarIdentifier.GetHashCode();
