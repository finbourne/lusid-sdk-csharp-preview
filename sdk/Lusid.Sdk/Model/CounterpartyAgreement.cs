...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CounterpartyAgreement :  IEquatable<CounterpartyAgreement>
    {
        ...
        public CounterpartyAgreement(string displayName = default(string), string agreementType = default(string), CounterpartySignatory counterpartySignatory = default(CounterpartySignatory), DateTimeOffset? datedAsOf = default(DateTimeOffset?), ResourceId creditSupportAnnexId = default(ResourceId), ResourceId id = default(ResourceId))
        {
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for CounterpartyAgreement and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("agreementType is a required property for CounterpartyAgreement and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("counterpartySignatory is a required property for CounterpartyAgreement and cannot be null");
            }
            else
            {
            ...
            // to ensure "datedAsOf" is required (not null)
            if (datedAsOf == null)
            {
                throw new InvalidDataException("datedAsOf is a required property for CounterpartyAgreement and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditSupportAnnexId is a required property for CounterpartyAgreement and cannot be null");
            }
            else
            {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for CounterpartyAgreement and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        /// </summary>
        [DataMember(Name="counterpartySignatory", EmitDefaultValue=false)]
        ...
        [DataMember(Name="datedAsOf", EmitDefaultValue=false)]
        public DateTimeOffset? DatedAsOf { get; set; }

        /// <summary>
        /// Gets or Sets CreditSupportAnnexId
        /// </summary>
        [DataMember(Name="creditSupportAnnexId", EmitDefaultValue=false)]
