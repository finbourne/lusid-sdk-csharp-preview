...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfOrderGraphBlock")]
    public partial class PagedResourceListOfOrderGraphBlock : IEquatable<PagedResourceListOfOrderGraphBlock>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfOrderGraphBlock" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfOrderGraphBlock() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfOrderGraphBlock" /> class.
        /// </summary>
        ...
        public PagedResourceListOfOrderGraphBlock(string nextPage = default(string), string previousPage = default(string), List<OrderGraphBlock> values = default(List<OrderGraphBlock>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfOrderGraphBlock and cannot be null");
        ...
        public List<OrderGraphBlock> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResourceListOfOrderGraphBlock {\n");
        ...
        {
            return this.Equals(input as PagedResourceListOfOrderGraphBlock);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfOrderGraphBlock instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfOrderGraphBlock to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfOrderGraphBlock input)
        {
            if (input == null)
                return false;
