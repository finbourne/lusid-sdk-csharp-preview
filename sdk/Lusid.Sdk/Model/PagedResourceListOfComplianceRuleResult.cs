...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfComplianceRuleResult")]
    public partial class PagedResourceListOfComplianceRuleResult : IEquatable<PagedResourceListOfComplianceRuleResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfComplianceRuleResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfComplianceRuleResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfComplianceRuleResult" /> class.
        /// </summary>
        ...
        public PagedResourceListOfComplianceRuleResult(string nextPage = default(string), string previousPage = default(string), List<ComplianceRuleResult> values = default(List<ComplianceRuleResult>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfComplianceRuleResult and cannot be null");
        ...
        {
            return this.Equals(input as PagedResourceListOfComplianceRuleResult);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfComplianceRuleResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfComplianceRuleResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfComplianceRuleResult input)
        {
            if (input == null)
                return false;
