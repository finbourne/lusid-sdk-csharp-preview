...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SimpleInstrumentAllOf :  IEquatable<SimpleInstrumentAllOf>
    {
        ...
        public SimpleInstrumentAllOf(DateTimeOffset? maturityDate = default(DateTimeOffset?), string domCcy = default(string), AssetClassEnum assetClass = default(AssetClassEnum), List<string> fgnCcys = default(List<string>), string simpleInstrumentType = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            if (domCcy == null)
            {
                throw new InvalidDataException("domCcy is a required property for SimpleInstrumentAllOf and cannot be null");
            }
            else
            {
                this.DomCcy = domCcy;
            ...
            if (assetClass == null)
            {
                throw new InvalidDataException("assetClass is a required property for SimpleInstrumentAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("simpleInstrumentType is a required property for SimpleInstrumentAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instrumentType is a required property for SimpleInstrumentAllOf and cannot be null");
            }
            else
            {
