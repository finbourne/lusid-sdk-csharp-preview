...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreditSupportAnnex :  IEquatable<CreditSupportAnnex>
    {
        ...
        public CreditSupportAnnex(string referenceCurrency = default(string), List<string> collateralCurrencies = default(List<string>), string isdaAgreementVersion = default(string), string marginCallFrequency = default(string), string valuationAgent = default(string), decimal? thresholdAmount = default(decimal?), int? roundingDecimalPlaces = default(int?), decimal? initialMarginAmount = default(decimal?), decimal? minimumTransferAmount = default(decimal?), string scope = default(string), string code = default(string))
        {
            // to ensure "referenceCurrency" is required (not null)
            if (referenceCurrency == null)
            {
                throw new InvalidDataException("referenceCurrency is a required property for CreditSupportAnnex and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("collateralCurrencies is a required property for CreditSupportAnnex and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("isdaAgreementVersion is a required property for CreditSupportAnnex and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("marginCallFrequency is a required property for CreditSupportAnnex and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("valuationAgent is a required property for CreditSupportAnnex and cannot be null");
            }
            else
            {
            ...
            // to ensure "thresholdAmount" is required (not null)
            if (thresholdAmount == null)
            {
                throw new InvalidDataException("thresholdAmount is a required property for CreditSupportAnnex and cannot be null");
            }
            else
            {
            ...
            // to ensure "roundingDecimalPlaces" is required (not null)
            if (roundingDecimalPlaces == null)
            {
                throw new InvalidDataException("roundingDecimalPlaces is a required property for CreditSupportAnnex and cannot be null");
            }
            else
            {
            ...
            // to ensure "initialMarginAmount" is required (not null)
            if (initialMarginAmount == null)
            {
                throw new InvalidDataException("initialMarginAmount is a required property for CreditSupportAnnex and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("minimumTransferAmount is a required property for CreditSupportAnnex and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="collateralCurrencies", EmitDefaultValue=false)]
        ...
        [DataMember(Name="isdaAgreementVersion", EmitDefaultValue=false)]
        ...
        [DataMember(Name="marginCallFrequency", EmitDefaultValue=false)]
        ...
        [DataMember(Name="valuationAgent", EmitDefaultValue=false)]
        ...
        [DataMember(Name="roundingDecimalPlaces", EmitDefaultValue=false)]
        ...
        [DataMember(Name="initialMarginAmount", EmitDefaultValue=false)]
        ...
        [DataMember(Name="minimumTransferAmount", EmitDefaultValue=false)]
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RoundingDecimalPlaces != null)
                    hashCode = hashCode * 59 + this.RoundingDecimalPlaces.GetHashCode();
                if (this.InitialMarginAmount != null)
