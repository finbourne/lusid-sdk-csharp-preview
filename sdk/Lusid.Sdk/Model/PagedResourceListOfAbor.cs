...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfAbor : IEquatable<PagedResourceListOfAbor>
    {
        /// <summary>
        ...
        public PagedResourceListOfAbor(string nextPage = default(string), string previousPage = default(string), List<Abor> values = default(List<Abor>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfAbor and cannot be null");
