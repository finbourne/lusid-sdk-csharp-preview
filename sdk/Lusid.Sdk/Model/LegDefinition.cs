...
namespace Lusid.Sdk.Model
{
    ...
    public partial class LegDefinition :  IEquatable<LegDefinition>
    {
        ...
        /// Initializes a new instance of the <see cref="LegDefinition" /> class.
        /// </summary>
        /// <param name="conventionName">conventionName (required).</param>
        /// <param name="conventions">conventions (required).</param>
        /// <param name="indexConvention">indexConvention (required).</param>
        /// <param name="indexConventionName">indexConventionName (required).</param>
        ...
        /// <param name="resetConvention">Control how resets are generated relative to swap payment convention(s).  Supported string (enumeration) values are: [InAdvance, InArrears]. (required).</param>
        ...
        {
            // to ensure "conventionName" is required (not null)
            if (conventionName == null)
            {
                throw new InvalidDataException("conventionName is a required property for LegDefinition and cannot be null");
            }
            else
            {
            ...
            // to ensure "indexConvention" is required (not null)
            if (indexConvention == null)
            {
                throw new InvalidDataException("indexConvention is a required property for LegDefinition and cannot be null");
            }
            else
            {
            ...
            // to ensure "indexConventionName" is required (not null)
            if (indexConventionName == null)
            {
                throw new InvalidDataException("indexConventionName is a required property for LegDefinition and cannot be null");
            }
            else
            {
            ...
            // to ensure "resetConvention" is required (not null)
            if (resetConvention == null)
            {
                throw new InvalidDataException("resetConvention is a required property for LegDefinition and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Is the leg to be paid or received  Supported string (enumeration) values are: [NotDefined, Pay, Receive].
        /// </summary>
        /// <value>Is the leg to be paid or received  Supported string (enumeration) values are: [NotDefined, Pay, Receive].</value>
        [DataMember(Name="payReceive", EmitDefaultValue=false)]
        ...
        [DataMember(Name="rateOrSpread", EmitDefaultValue=false)]
        ...
        [DataMember(Name="resetConvention", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>If a stub is required should it be at the front or back of the leg.  Supported string (enumeration) values are: [Front, Back, Both].</value>
        [DataMember(Name="stubType", EmitDefaultValue=false)]
