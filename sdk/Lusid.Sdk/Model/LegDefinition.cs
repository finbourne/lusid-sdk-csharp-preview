...
namespace Lusid.Sdk.Model
{
    ...
    public partial class LegDefinition : IEquatable<LegDefinition>
    {
        ...
        public LegDefinition(FlowConventionName conventionName = default(FlowConventionName), FlowConventions conventions = default(FlowConventions), IndexConvention indexConvention = default(IndexConvention), FlowConventionName indexConventionName = default(FlowConventionName), string notionalExchangeType = default(string), string payReceive = default(string), decimal rateOrSpread = default(decimal), string resetConvention = default(string), string stubType = default(string), Compounding compounding = default(Compounding))
        {
            // to ensure "indexConventionName" is required (not null)
            this.IndexConventionName = indexConventionName ?? throw new ArgumentNullException("indexConventionName is a required property for LegDefinition and cannot be null");
            ...
            // to ensure "compounding" is required (not null)
            this.Compounding = compounding ?? throw new ArgumentNullException("compounding is a required property for LegDefinition and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "indexConventionName", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "compounding", IsRequired = true, EmitDefaultValue = false)]
