...
namespace Lusid.Sdk.Model
{
    ...
    public partial class LegDefinition : IEquatable<LegDefinition>
    {
        ...
        public LegDefinition(FlowConventionName conventionName = default(FlowConventionName), FlowConventions conventions = default(FlowConventions), IndexConvention indexConvention = default(IndexConvention), FlowConventionName indexConventionName = default(FlowConventionName), string notionalExchangeType = default(string), string payReceive = default(string), decimal rateOrSpread = default(decimal), string resetConvention = default(string), string stubType = default(string), Compounding compounding = default(Compounding), StepSchedule amortisation = default(StepSchedule))
        {
