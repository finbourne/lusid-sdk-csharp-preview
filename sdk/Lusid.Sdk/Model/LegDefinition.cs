...
namespace Lusid.Sdk.Model
{
    ...
    {
        /// <summary>
        /// If a stub is required should it be at the front or back of the leg.
        /// </summary>
        /// <value>If a stub is required should it be at the front or back of the leg.</value>
        ...
        public StubTypeEnum StubType { get; set; }
        /// <summary>
        /// Is the leg to be paid or received
        /// </summary>
        /// <value>Is the leg to be paid or received</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum PayReceiveEnum
        {
            /// <summary>
        ...
        public PayReceiveEnum PayReceive { get; set; }
        /// <summary>
        /// what type of notional exchange does the leg have
        /// </summary>
        /// <value>what type of notional exchange does the leg have</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="stubType">If a stub is required should it be at the front or back of the leg. (required).</param>
        /// <param name="payReceive">Is the leg to be paid or received (required).</param>
        /// <param name="notionalExchangeType">what type of notional exchange does the leg have (required).</param>
