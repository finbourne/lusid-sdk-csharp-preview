...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateTaxRuleSetRequest : IEquatable<CreateTaxRuleSetRequest>
    {
        /// <summary>
        ...
        public CreateTaxRuleSetRequest(ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), string outputPropertyKey = default(string), List<TaxRule> rules = default(List<TaxRule>))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for CreateTaxRuleSetRequest and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CreateTaxRuleSetRequest and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for CreateTaxRuleSetRequest and cannot be null");
            // to ensure "outputPropertyKey" is required (not null)
            this.OutputPropertyKey = outputPropertyKey ?? throw new ArgumentNullException("outputPropertyKey is a required property for CreateTaxRuleSetRequest and cannot be null");
            // to ensure "rules" is required (not null)
            this.Rules = rules ?? throw new ArgumentNullException("rules is a required property for CreateTaxRuleSetRequest and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "outputPropertyKey", IsRequired = true, EmitDefaultValue = false)]
