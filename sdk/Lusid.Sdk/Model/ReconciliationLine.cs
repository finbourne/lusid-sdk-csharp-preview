...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReconciliationLine : IEquatable<ReconciliationLine>
    {
        ...
        /// <param name="resultComparison">resultComparison.</param>
        public ReconciliationLine(IDataRecord left = default(IDataRecord), IDataRecord right = default(IDataRecord), IDataRecord difference = default(IDataRecord), IDataRecord resultComparison = default(IDataRecord))
        {
            this.Left = left;
            this.Right = right;
        ...
        public IDataRecord Left { get; set; }

        /// <summary>
        /// Gets or Sets Right
        /// </summary>
        [DataMember(Name = "right", EmitDefaultValue = false)]
        public IDataRecord Right { get; set; }

        /// <summary>
        /// Gets or Sets Difference
        /// </summary>
        [DataMember(Name = "difference", EmitDefaultValue = false)]
        public IDataRecord Difference { get; set; }

        /// <summary>
        /// Gets or Sets ResultComparison
        /// </summary>
        [DataMember(Name = "resultComparison", EmitDefaultValue = false)]
        public IDataRecord ResultComparison { get; set; }
        ...
        public bool Equals(ReconciliationLine input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.ResultComparison.Equals(input.ResultComparison))
                );
        }
