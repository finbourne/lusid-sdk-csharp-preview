...
namespace Lusid.Sdk.Model
{
    ...
    public partial class MarketDataSpecificRule : IEquatable<MarketDataSpecificRule>
    {
        /// <summary>
        /// The available values are: Price, Spread, Rate, LogNormalVol, NormalVol, ParSpread, IsdaSpread, Upfront, Index, Ratio, Delta
        /// </summary>
        /// <value>The available values are: Price, Spread, Rate, LogNormalVol, NormalVol, ParSpread, IsdaSpread, Upfront, Index, Ratio, Delta</value>
        ...
        public MarketDataSpecificRule(string key = default(string), string supplier = default(string), string dataScope = default(string), QuoteTypeEnum quoteType = default(QuoteTypeEnum), string field = default(string), string quoteInterval = default(string), DateTimeOffset? asAt = default(DateTimeOffset?), string priceSource = default(string), string mask = default(string), DependencySourceFilter dependencySourceFilter = default(DependencySourceFilter))
        {
            // to ensure "key" is required (not null)
            this.Key = key ?? throw new ArgumentNullException("key is a required property for MarketDataSpecificRule and cannot be null");
            // to ensure "supplier" is required (not null)
            this.Supplier = supplier ?? throw new ArgumentNullException("supplier is a required property for MarketDataSpecificRule and cannot be null");
            // to ensure "dataScope" is required (not null)
            this.DataScope = dataScope ?? throw new ArgumentNullException("dataScope is a required property for MarketDataSpecificRule and cannot be null");
            this.QuoteType = quoteType;
            // to ensure "field" is required (not null)
            this.Field = field ?? throw new ArgumentNullException("field is a required property for MarketDataSpecificRule and cannot be null");
            // to ensure "dependencySourceFilter" is required (not null)
            this.DependencySourceFilter = dependencySourceFilter ?? throw new ArgumentNullException("dependencySourceFilter is a required property for MarketDataSpecificRule and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "dependencySourceFilter", IsRequired = true, EmitDefaultValue = false)]
