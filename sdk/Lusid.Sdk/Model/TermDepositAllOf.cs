...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TermDepositAllOf : IEquatable<TermDepositAllOf>
    {
        /// <summary>
        ...
        /// <param name="domCcy">DomCcy of the TermDeposit. If provided, must match the currency of FlowConvention..</param>
        ...
        public TermDepositAllOf(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), decimal contractSize = default(decimal), FlowConventions flowConvention = default(FlowConventions), decimal rate = default(decimal), string domCcy = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.FlowConvention = flowConvention ?? throw new ArgumentNullException("flowConvention is a required property for TermDepositAllOf and cannot be null");
            this.Rate = rate;
        ...
        /// </summary>
        [DataMember(Name = "flowConvention", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>DomCcy of the TermDeposit. If provided, must match the currency of FlowConvention.</value>
