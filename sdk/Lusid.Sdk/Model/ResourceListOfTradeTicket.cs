...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfTradeTicket")]
    public partial class ResourceListOfTradeTicket : IEquatable<ResourceListOfTradeTicket>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfTradeTicket" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfTradeTicket() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfTradeTicket" /> class.
        /// </summary>
        ...
        public ResourceListOfTradeTicket(List<TradeTicket> values = default(List<TradeTicket>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfTradeTicket and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<TradeTicket> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfTradeTicket {\n");
        ...
        {
            return this.Equals(input as ResourceListOfTradeTicket);
        }

        /// <summary>
        /// Returns true if ResourceListOfTradeTicket instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfTradeTicket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfTradeTicket input)
        {
            if (input == null)
                return false;
