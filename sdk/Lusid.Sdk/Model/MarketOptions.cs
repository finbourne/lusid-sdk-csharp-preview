...
namespace Lusid.Sdk.Model
{
    ...
    public partial class MarketOptions :  IEquatable<MarketOptions>
    {
        ...
        public MarketOptions(DefaultSupplierEnum? defaultSupplier = default(DefaultSupplierEnum?), DefaultInstrumentCodeTypeEnum? defaultInstrumentCodeType = default(DefaultInstrumentCodeTypeEnum?), string defaultScope = default(string), bool? attemptToInferMissingFx = default(bool?))
        {
