...
namespace Lusid.Sdk.Model
{
    ...
    public partial class MarketOptions :  IEquatable<MarketOptions>
    {
        ...
        public MarketOptions(string defaultSupplier = default(string), string defaultInstrumentCodeType = default(string), string defaultScope = default(string), bool? attemptToInferMissingFx = default(bool?), ManifestLevelOfDetailEnum? manifestLevelOfDetail = default(ManifestLevelOfDetailEnum?))
        {
