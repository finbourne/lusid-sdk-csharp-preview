...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CdsDetailSpecifications :  IEquatable<CdsDetailSpecifications>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CdsDetailSpecifications" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CdsDetailSpecifications() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CdsDetailSpecifications" /> class.
        /// </summary>
        ...
        /// <param name="stubType">How are coupons handled when the start date is not on a CDS date (i.e. the 20th of March, June, Sept, Dec) (required).</param>
        /// <param name="rollFrequency">rollFrequency (required).</param>
        public CdsDetailSpecifications(SeniorityEnum seniority = default(SeniorityEnum), RestructuringTypeEnum restructuringType = default(RestructuringTypeEnum), bool? protectStartDay = default(bool?), bool? payAccruedInterestOnDefault = default(bool?), int? stubType = default(int?), Tenor rollFrequency = default(Tenor))
        {
            // to ensure "seniority" is required (not null)
            if (seniority == null)
            {
                throw new InvalidDataException("seniority is a required property for CdsDetailSpecifications and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("restructuringType is a required property for CdsDetailSpecifications and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("protectStartDay is a required property for CdsDetailSpecifications and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("payAccruedInterestOnDefault is a required property for CdsDetailSpecifications and cannot be null");
            }
            else
            {
            ...
            if (stubType == null)
            {
                throw new InvalidDataException("stubType is a required property for CdsDetailSpecifications and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("rollFrequency is a required property for CdsDetailSpecifications and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>How are coupons handled when the start date is not on a CDS date (i.e. the 20th of March, June, Sept, Dec)</value>
        ...
        {
            return this.Equals(input as CdsDetailSpecifications);
        }

        /// <summary>
        /// Returns true if CdsDetailSpecifications instances are equal
        /// </summary>
        /// <param name="input">Instance of CdsDetailSpecifications to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CdsDetailSpecifications input)
        {
            if (input == null)
                return false;
