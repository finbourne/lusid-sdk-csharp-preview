...
namespace Lusid.Sdk.Model
{
    ...
    public partial class IndexConvention :  IEquatable<IndexConvention>
    {
        ...
        /// <param name="name">The name of the index convention (required).</param>
        /// <param name="publicationDayLag">Number of days between spot and publication of the rate. (required).</param>
        /// <param name="paymentTenor">paymentTenor (required).</param>
        ...
        public IndexConvention(string fixingReference = default(string), string name = default(string), int? publicationDayLag = default(int?), Tenor paymentTenor = default(Tenor), DayCountConventionEnum dayCountConvention = default(DayCountConventionEnum), string currency = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for IndexConvention and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// <summary>
        /// The name of the index convention
        /// </summary>
        /// <value>The name of the index convention</value>
        ...
        /// <summary>
        /// Gets or Sets PaymentTenor
        /// </summary>
        [DataMember(Name="paymentTenor", EmitDefaultValue=false)]
        public Tenor PaymentTenor { get; set; }
