...
namespace Lusid.Sdk.Model
{
    ...
    public partial class IndexConvention :  IEquatable<IndexConvention>
    {
        ...
        public IndexConvention(string scope = default(string), string code = default(string), string fixingReference = default(string), int? publicationDayLag = default(int?), string paymentTenor = default(string), DayCountConventionEnum dayCountConvention = default(DayCountConventionEnum), string currency = default(string))
        {
            this.Scope = scope;
            this.Code = code;
