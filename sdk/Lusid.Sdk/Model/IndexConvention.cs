...
namespace Lusid.Sdk.Model
{
    ...
    public partial class IndexConvention :  IEquatable<IndexConvention>
    {
        ...
        public IndexConvention(string fixingReference = default(string), int? publicationDayLag = default(int?), string paymentTenor = default(string), DayCountConventionEnum dayCountConvention = default(DayCountConventionEnum), string currency = default(string), string scope = default(string), string code = default(string))
        {
