...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InflationIndexConventions : IEquatable<InflationIndexConventions>
    {
        /// <summary>
        ...
        public InflationIndexConventions(string inflationIndexName = default(string), string currency = default(string), string observationLag = default(string), string inflationInterpolation = default(string), string inflationFrequency = default(string), int inflationRollDay = default(int))
        {
            ...
            this.InflationIndexName = inflationIndexName ?? throw new ArgumentNullException("inflationIndexName is a required property for InflationIndexConventions and cannot be null");
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for InflationIndexConventions and cannot be null");
            // to ensure "observationLag" is required (not null)
            this.ObservationLag = observationLag ?? throw new ArgumentNullException("observationLag is a required property for InflationIndexConventions and cannot be null");
