...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnalyticStore :  IEquatable<AnalyticStore>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnalyticStore" /> class.
        /// </summary>
        /// <param name="key">key.</param>
        /// <param name="href">href.</param>
        /// <param name="links">links.</param>
        public AnalyticStore(AnalyticStoreKey key = default(AnalyticStoreKey), string href = default(string), List<Link> links = default(List<Link>))
        {
            this.Key = key;
            this.Href = href;
            this.Links = links;
        ...
        {
            return this.Equals(input as AnalyticStore);
        }

        /// <summary>
        /// Returns true if AnalyticStore instances are equal
        /// </summary>
        /// <param name="input">Instance of AnalyticStore to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnalyticStore input)
        {
            if (input == null)
                return false;
