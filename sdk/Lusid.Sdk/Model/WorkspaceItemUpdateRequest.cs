...
namespace Lusid.Sdk.Model
{
    ...
    public partial class WorkspaceItemUpdateRequest : IEquatable<WorkspaceItemUpdateRequest>
    {
        /// <summary>
        ...
        public WorkspaceItemUpdateRequest(int format = default(int), string description = default(string), string content = default(string), string type = default(string))
        {
            ...
            this.Description = description ?? throw new ArgumentNullException("description is a required property for WorkspaceItemUpdateRequest and cannot be null");
            // to ensure "content" is required (not null)
            this.Content = content ?? throw new ArgumentNullException("content is a required property for WorkspaceItemUpdateRequest and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for WorkspaceItemUpdateRequest and cannot be null");
        }
