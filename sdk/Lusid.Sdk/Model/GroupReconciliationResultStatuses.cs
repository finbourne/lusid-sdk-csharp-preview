...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupReconciliationResultStatuses : IEquatable<GroupReconciliationResultStatuses>
    {
        /// <summary>
        ...
        public GroupReconciliationResultStatuses(int countNew = default(int), Link linkNew = default(Link), int countConfirmed = default(int), Link linkConfirmed = default(Link), int countChanged = default(int), Link linkChanged = default(Link))
        {
            ...
            this.LinkNew = linkNew ?? throw new ArgumentNullException("linkNew is a required property for GroupReconciliationResultStatuses and cannot be null");
            this.CountConfirmed = countConfirmed;
            // to ensure "linkConfirmed" is required (not null)
            this.LinkConfirmed = linkConfirmed ?? throw new ArgumentNullException("linkConfirmed is a required property for GroupReconciliationResultStatuses and cannot be null");
            this.CountChanged = countChanged;
            // to ensure "linkChanged" is required (not null)
            this.LinkChanged = linkChanged ?? throw new ArgumentNullException("linkChanged is a required property for GroupReconciliationResultStatuses and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "linkNew", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "linkConfirmed", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "linkChanged", IsRequired = true, EmitDefaultValue = false)]
