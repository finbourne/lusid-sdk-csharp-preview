...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioCashLadder : IEquatable<PortfolioCashLadder>
    {
        ...
        public PortfolioCashLadder(string currency = default(string), Dictionary<string, PerpetualProperty> subHoldingKeys = default(Dictionary<string, PerpetualProperty>), List<CashLadderRecord> records = default(List<CashLadderRecord>), List<Link> links = default(List<Link>))
        {
            ...
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for PortfolioCashLadder and cannot be null");
            // to ensure "records" is required (not null)
            this.Records = records ?? throw new ArgumentNullException("records is a required property for PortfolioCashLadder and cannot be null");
