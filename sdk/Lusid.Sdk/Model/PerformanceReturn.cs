...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PerformanceReturn :  IEquatable<PerformanceReturn>
    {
        ...
        /// <param name="roR">The return number. (required).</param>
        /// <param name="openingMarketValue">The opening market value. (required).</param>
        /// <param name="period">Show the returns on a Daily or Monthly period..</param>
        public PerformanceReturn(DateTimeOffset? effectiveAt = default(DateTimeOffset?), decimal? roR = default(decimal?), decimal? openingMarketValue = default(decimal?), string period = default(string))
        {
            ...
            // to ensure "roR" is required (not null)
            if (roR == null)
            {
                throw new InvalidDataException("roR is a required property for PerformanceReturn and cannot be null");
            }
            else
            {
                this.RoR = roR;
            ...
            // to ensure "openingMarketValue" is required (not null)
            if (openingMarketValue == null)
            {
                throw new InvalidDataException("openingMarketValue is a required property for PerformanceReturn and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="roR", EmitDefaultValue=false)]
        ...
        [DataMember(Name="openingMarketValue", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RoR: ").Append(RoR).Append("\n");
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RoR != null)
                    hashCode = hashCode * 59 + this.RoR.GetHashCode();
