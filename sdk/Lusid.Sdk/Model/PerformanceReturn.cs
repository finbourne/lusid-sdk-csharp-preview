...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PerformanceReturn :  IEquatable<PerformanceReturn>
    {
        ...
        public PerformanceReturn(DateTimeOffset? effectiveAt = default(DateTimeOffset?), decimal? rateOfReturn = default(decimal?), decimal? openingMarketValue = default(decimal?), string period = default(string))
        {
