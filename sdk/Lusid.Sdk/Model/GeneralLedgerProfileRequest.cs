...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GeneralLedgerProfileRequest : IEquatable<GeneralLedgerProfileRequest>
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="GeneralLedgerProfileRequest" /> class.
        /// </summary>
        /// <param name="generalLedgerProfileCode">The code of the Posting Module. (required).</param>
        ...
        public GeneralLedgerProfileRequest(string generalLedgerProfileCode = default(string), string displayName = default(string), string description = default(string), List<GeneralLedgerProfileMapping> generalLedgerProfileMappings = default(List<GeneralLedgerProfileMapping>))
        {
            ...
            this.GeneralLedgerProfileCode = generalLedgerProfileCode ?? throw new ArgumentNullException("generalLedgerProfileCode is a required property for GeneralLedgerProfileRequest and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for GeneralLedgerProfileRequest and cannot be null");
            // to ensure "generalLedgerProfileMappings" is required (not null)
            this.GeneralLedgerProfileMappings = generalLedgerProfileMappings ?? throw new ArgumentNullException("generalLedgerProfileMappings is a required property for GeneralLedgerProfileRequest and cannot be null");
