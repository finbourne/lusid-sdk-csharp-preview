...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceRunSummary : IEquatable<ComplianceRunSummary>
    {
        /// <summary>
        ...
        public ComplianceRunSummary(ResourceId runId = default(ResourceId), DateTimeOffset instigatedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), string schedule = default(string), List<ComplianceSummaryRuleResult> results = default(List<ComplianceSummaryRuleResult>))
        {
            ...
            this.RunId = runId ?? throw new ArgumentNullException("runId is a required property for ComplianceRunSummary and cannot be null");
            this.InstigatedAt = instigatedAt;
            this.CompletedAt = completedAt;
            // to ensure "schedule" is required (not null)
            this.Schedule = schedule ?? throw new ArgumentNullException("schedule is a required property for ComplianceRunSummary and cannot be null");
            // to ensure "results" is required (not null)
            this.Results = results ?? throw new ArgumentNullException("results is a required property for ComplianceRunSummary and cannot be null");
        }
