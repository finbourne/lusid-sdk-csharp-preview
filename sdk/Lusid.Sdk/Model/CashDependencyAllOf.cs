...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashDependencyAllOf : IEquatable<CashDependencyAllOf>
    {
        /// <summary>
        ...
        public CashDependencyAllOf(string currency = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum))
        {
            ...
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for CashDependencyAllOf and cannot be null");
            this.Date = date;
