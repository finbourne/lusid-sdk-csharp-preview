...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionTypeCalculation : IEquatable<TransactionTypeCalculation>
    {
        /// <summary>
        ...
        public TransactionTypeCalculation(string type = default(string), string side = default(string))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for TransactionTypeCalculation and cannot be null");
            // to ensure "side" is required (not null)
            this.Side = side ?? throw new ArgumentNullException("side is a required property for TransactionTypeCalculation and cannot be null");
        }
