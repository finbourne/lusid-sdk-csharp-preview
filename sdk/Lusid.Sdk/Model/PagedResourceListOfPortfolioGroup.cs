...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfPortfolioGroup :  IEquatable<PagedResourceListOfPortfolioGroup>
    {
        ...
        public PagedResourceListOfPortfolioGroup(List<PortfolioGroup> values = default(List<PortfolioGroup>), string href = default(string), List<Link> links = default(List<Link>))
        {
