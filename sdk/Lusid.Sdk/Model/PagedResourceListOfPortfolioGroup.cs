...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagedResourceListOfPortfolioGroup :  IEquatable<PagedResourceListOfPortfolioGroup>
    {
        /// <summary>
        ...
        public PagedResourceListOfPortfolioGroup(List<PortfolioGroup> values = default(List<PortfolioGroup>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for PagedResourceListOfPortfolioGroup and cannot be null");
            }
            else
            {
                this.Values = values;
