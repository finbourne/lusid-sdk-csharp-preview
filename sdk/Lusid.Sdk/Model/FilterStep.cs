...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FilterStep : IEquatable<FilterStep>
    {
        /// <summary>
        ...
        public FilterStep(string label = default(string), Dictionary<string, List<ComplianceTemplateParameter>> groupedParameters = default(Dictionary<string, List<ComplianceTemplateParameter>>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum))
        {
            ...
            this.Label = label ?? throw new ArgumentNullException("label is a required property for FilterStep and cannot be null");
            // to ensure "groupedParameters" is required (not null)
            this.GroupedParameters = groupedParameters ?? throw new ArgumentNullException("groupedParameters is a required property for FilterStep and cannot be null");
