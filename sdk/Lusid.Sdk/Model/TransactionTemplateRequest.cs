...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionTemplateRequest : IEquatable<TransactionTemplateRequest>
    {
        /// <summary>
        ...
        public TransactionTemplateRequest(string description = default(string), List<ComponentTransaction> componentTransactions = default(List<ComponentTransaction>))
        {
            ...
            this.Description = description ?? throw new ArgumentNullException("description is a required property for TransactionTemplateRequest and cannot be null");
            // to ensure "componentTransactions" is required (not null)
            this.ComponentTransactions = componentTransactions ?? throw new ArgumentNullException("componentTransactions is a required property for TransactionTemplateRequest and cannot be null");
        }
