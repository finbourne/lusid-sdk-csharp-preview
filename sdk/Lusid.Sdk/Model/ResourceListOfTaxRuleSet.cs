...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfTaxRuleSet : IEquatable<ResourceListOfTaxRuleSet>
    {
        /// <summary>
        ...
        public ResourceListOfTaxRuleSet(List<TaxRuleSet> values = default(List<TaxRuleSet>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfTaxRuleSet and cannot be null");
            this.Href = href;
            this.Links = links;
