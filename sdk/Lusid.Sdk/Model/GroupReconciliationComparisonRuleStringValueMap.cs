...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupReconciliationComparisonRuleStringValueMap : IEquatable<GroupReconciliationComparisonRuleStringValueMap>
    {
        /// <summary>
        ...
        public GroupReconciliationComparisonRuleStringValueMap(string leftValue = default(string), string rightValue = default(string), string direction = default(string))
        {
            ...
            this.LeftValue = leftValue ?? throw new ArgumentNullException("leftValue is a required property for GroupReconciliationComparisonRuleStringValueMap and cannot be null");
            // to ensure "rightValue" is required (not null)
            this.RightValue = rightValue ?? throw new ArgumentNullException("rightValue is a required property for GroupReconciliationComparisonRuleStringValueMap and cannot be null");
            // to ensure "direction" is required (not null)
            this.Direction = direction ?? throw new ArgumentNullException("direction is a required property for GroupReconciliationComparisonRuleStringValueMap and cannot be null");
        }
        ...
        [DataMember(Name = "leftValue", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "rightValue", IsRequired = true, EmitDefaultValue = false)]
