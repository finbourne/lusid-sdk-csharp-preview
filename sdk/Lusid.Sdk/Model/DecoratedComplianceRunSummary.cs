...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DecoratedComplianceRunSummary : IEquatable<DecoratedComplianceRunSummary>
    {
        /// <summary>
        ...
        public DecoratedComplianceRunSummary(ResourceId runId = default(ResourceId), List<ComplianceRuleResultDetail> details = default(List<ComplianceRuleResultDetail>))
        {
            ...
            this.RunId = runId ?? throw new ArgumentNullException("runId is a required property for DecoratedComplianceRunSummary and cannot be null");
            // to ensure "details" is required (not null)
            this.Details = details ?? throw new ArgumentNullException("details is a required property for DecoratedComplianceRunSummary and cannot be null");
        }
