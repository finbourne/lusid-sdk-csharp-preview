...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfMapping")]
    public partial class ResourceListOfMapping : IEquatable<ResourceListOfMapping>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfMapping" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfMapping() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfMapping" /> class.
        /// </summary>
        ...
        public ResourceListOfMapping(List<Mapping> values = default(List<Mapping>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfMapping and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<Mapping> Values { get; set; }
        ...
        {
            return this.Equals(input as ResourceListOfMapping);
        }

        /// <summary>
        /// Returns true if ResourceListOfMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfMapping input)
        {
            if (input == null)
                return false;
