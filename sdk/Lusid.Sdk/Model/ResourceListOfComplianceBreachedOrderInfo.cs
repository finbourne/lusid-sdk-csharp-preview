...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfComplianceBreachedOrderInfo")]
    public partial class ResourceListOfComplianceBreachedOrderInfo : IEquatable<ResourceListOfComplianceBreachedOrderInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfComplianceBreachedOrderInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfComplianceBreachedOrderInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfComplianceBreachedOrderInfo" /> class.
        /// </summary>
        ...
        public ResourceListOfComplianceBreachedOrderInfo(List<ComplianceBreachedOrderInfo> values = default(List<ComplianceBreachedOrderInfo>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfComplianceBreachedOrderInfo and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<ComplianceBreachedOrderInfo> Values { get; set; }
        ...
        {
            return this.Equals(input as ResourceListOfComplianceBreachedOrderInfo);
        }

        /// <summary>
        /// Returns true if ResourceListOfComplianceBreachedOrderInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfComplianceBreachedOrderInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfComplianceBreachedOrderInfo input)
        {
            if (input == null)
                return false;
