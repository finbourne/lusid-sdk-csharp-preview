...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceRunInfoV2 : IEquatable<ComplianceRunInfoV2>
    {
        /// <summary>
        ...
        public ComplianceRunInfoV2(ResourceId runId = default(ResourceId), DateTimeOffset instigatedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), string schedule = default(string), string instigatedBy = default(string))
        {
            ...
            this.RunId = runId ?? throw new ArgumentNullException("runId is a required property for ComplianceRunInfoV2 and cannot be null");
            this.InstigatedAt = instigatedAt;
            this.CompletedAt = completedAt;
            // to ensure "schedule" is required (not null)
            this.Schedule = schedule ?? throw new ArgumentNullException("schedule is a required property for ComplianceRunInfoV2 and cannot be null");
            // to ensure "instigatedBy" is required (not null)
            this.InstigatedBy = instigatedBy ?? throw new ArgumentNullException("instigatedBy is a required property for ComplianceRunInfoV2 and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "instigatedBy", IsRequired = true, EmitDefaultValue = false)]
