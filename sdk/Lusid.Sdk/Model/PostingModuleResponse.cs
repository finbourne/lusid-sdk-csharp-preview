...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PostingModuleResponse : IEquatable<PostingModuleResponse>
    {
        ...
        public PostingModuleResponse(string href = default(string), ResourceId id = default(ResourceId), ResourceId chartOfAccountsId = default(ResourceId), string displayName = default(string), string description = default(string), int ruleCount = default(int), string status = default(string), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for PostingModuleResponse and cannot be null");
