...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PostingModuleResponse : IEquatable<PostingModuleResponse>
    {
        /// <summary>
        ...
        public PostingModuleResponse(string href = default(string), string postingModuleCode = default(string), ResourceId chartOfAccountsId = default(ResourceId), string displayName = default(string), string description = default(string), int ruleCount = default(int), string status = default(string), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "postingModuleCode" is required (not null)
            this.PostingModuleCode = postingModuleCode ?? throw new ArgumentNullException("postingModuleCode is a required property for PostingModuleResponse and cannot be null");
            // to ensure "chartOfAccountsId" is required (not null)
            this.ChartOfAccountsId = chartOfAccountsId ?? throw new ArgumentNullException("chartOfAccountsId is a required property for PostingModuleResponse and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for PostingModuleResponse and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for PostingModuleResponse and cannot be null");
            this.Href = href;
        ...
        [DataMember(Name = "postingModuleCode", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "ruleCount", EmitDefaultValue = true)]
