...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AborProperties : IEquatable<AborProperties>
    {
        /// <summary>
        ...
        public AborProperties(string href = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            this.Href = href;
