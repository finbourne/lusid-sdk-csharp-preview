...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ExerciseEvent : InstrumentEvent, IEquatable<ExerciseEvent>
    {
        ...
        /// <param name="instrumentEventType">The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent (required) (default to &quot;ExerciseEvent&quot;).</param>
        public ExerciseEvent(LusidInstrument instrument = default(LusidInstrument), string eventStatus = default(string), DateTimeOffset anchorDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base(instrumentEventType)
        {
            ...
            this.EventStatus = eventStatus ?? throw new ArgumentNullException("eventStatus is a required property for ExerciseEvent and cannot be null");
