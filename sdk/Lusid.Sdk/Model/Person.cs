...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Person :  IEquatable<Person>
    {
        ...
        public Person(string href = default(string), string lusidPersonId = default(string), Dictionary<string, Property> identifiers = default(Dictionary<string, Property>), Dictionary<string, List<Property>> properties = default(Dictionary<string, List<Property>>), Version version = default(Version))
        {
            this.Href = href;
