...
namespace Lusid.Sdk.Model
{
    ...
    public partial class LegalEntity :  IEquatable<LegalEntity>
    {
        ...
        /// <param name="lusidLegalEntityId">The unique LUSID Legal Entity Identifier (LULEID) of the Legal Entity..</param>
        ...
        public LegalEntity(string href = default(string), string lusidLegalEntityId = default(string), Dictionary<string, Property> identifiers = default(Dictionary<string, Property>), Dictionary<string, Property> properties = default(Dictionary<string, Property>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            this.Href = href;
        ...
        /// </summary>
        /// <value>The unique LUSID Legal Entity Identifier (LULEID) of the Legal Entity.</value>
