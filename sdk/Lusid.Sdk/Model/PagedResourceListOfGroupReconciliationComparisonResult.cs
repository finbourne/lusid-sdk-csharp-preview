...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfGroupReconciliationComparisonResult : IEquatable<PagedResourceListOfGroupReconciliationComparisonResult>
    {
        /// <summary>
        ...
        public PagedResourceListOfGroupReconciliationComparisonResult(string nextPage = default(string), string previousPage = default(string), List<GroupReconciliationComparisonResult> values = default(List<GroupReconciliationComparisonResult>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfGroupReconciliationComparisonResult and cannot be null");
