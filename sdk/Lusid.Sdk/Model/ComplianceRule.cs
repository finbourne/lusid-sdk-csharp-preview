...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceRule : IEquatable<ComplianceRule>
    {
        /// <summary>
        ...
        public ComplianceRule(string scope = default(string), string code = default(string), string displayName = default(string), string type = default(string), string propertyKey = default(string), string value = default(string), string addressKey = default(string), decimal lowerBound = default(decimal), decimal upperBound = default(decimal), string schedule = default(string), bool hardRequirement = default(bool), List<ResourceId> targetPortfolioIds = default(List<ResourceId>), string description = default(string), Version version = default(Version))
        {
            // to ensure "scope" is required (not null)
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for ComplianceRule and cannot be null");
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for ComplianceRule and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for ComplianceRule and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ComplianceRule and cannot be null");
            this.LowerBound = lowerBound;
            this.UpperBound = upperBound;
            // to ensure "schedule" is required (not null)
            this.Schedule = schedule ?? throw new ArgumentNullException("schedule is a required property for ComplianceRule and cannot be null");
            this.HardRequirement = hardRequirement;
            // to ensure "targetPortfolioIds" is required (not null)
            this.TargetPortfolioIds = targetPortfolioIds ?? throw new ArgumentNullException("targetPortfolioIds is a required property for ComplianceRule and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "targetPortfolioIds", IsRequired = true, EmitDefaultValue = false)]
