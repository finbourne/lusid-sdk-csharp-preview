...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CashFlowValueSet_allOf")]
    public partial class CashFlowValueSetAllOf : IEquatable<CashFlowValueSetAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CashFlowValueSetAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CashFlowValueSetAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CashFlowValueSetAllOf" /> class.
        /// </summary>
        ...
        public CashFlowValueSetAllOf(List<CashFlowValue> cashflows = default(List<CashFlowValue>), ResultValueTypeEnum resultValueType = default(ResultValueTypeEnum))
        {
        ...
        {
            return this.Equals(input as CashFlowValueSetAllOf);
        }

        /// <summary>
        /// Returns true if CashFlowValueSetAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CashFlowValueSetAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CashFlowValueSetAllOf input)
        {
            if (input == null)
                return false;
