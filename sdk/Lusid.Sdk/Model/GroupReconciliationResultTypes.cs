...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupReconciliationResultTypes : IEquatable<GroupReconciliationResultTypes>
    {
        /// <summary>
        ...
        public GroupReconciliationResultTypes(int countMatch = default(int), Link linkMatches = default(Link), int countPartialMatch = default(int), Link linkPartialMatches = default(Link), int countBreak = default(int), Link linkBreaks = default(Link), int countNotFound = default(int), Link linkNotFound = default(Link))
        {
            ...
            this.LinkMatches = linkMatches ?? throw new ArgumentNullException("linkMatches is a required property for GroupReconciliationResultTypes and cannot be null");
            this.CountPartialMatch = countPartialMatch;
            // to ensure "linkPartialMatches" is required (not null)
            this.LinkPartialMatches = linkPartialMatches ?? throw new ArgumentNullException("linkPartialMatches is a required property for GroupReconciliationResultTypes and cannot be null");
            this.CountBreak = countBreak;
            // to ensure "linkBreaks" is required (not null)
            this.LinkBreaks = linkBreaks ?? throw new ArgumentNullException("linkBreaks is a required property for GroupReconciliationResultTypes and cannot be null");
            this.CountNotFound = countNotFound;
            // to ensure "linkNotFound" is required (not null)
            this.LinkNotFound = linkNotFound ?? throw new ArgumentNullException("linkNotFound is a required property for GroupReconciliationResultTypes and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "linkMatches", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "linkPartialMatches", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "linkBreaks", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "linkNotFound", IsRequired = true, EmitDefaultValue = false)]
