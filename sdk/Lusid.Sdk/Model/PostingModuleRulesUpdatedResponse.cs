...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PostingModuleRulesUpdatedResponse : IEquatable<PostingModuleRulesUpdatedResponse>
    {
        /// <summary>
        ...
        public PostingModuleRulesUpdatedResponse(List<PostingModuleRule> rules = default(List<PostingModuleRule>), Version version = default(Version), string href = default(string), List<Link> links = default(List<Link>))
        {
            this.Rules = rules;
