...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCdsFlowConventionsResponse")]
    public partial class GetCdsFlowConventionsResponse : IEquatable<GetCdsFlowConventionsResponse>
    {
        /// <summary>
        ...
        public CdsFlowConventions Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCdsFlowConventionsResponse {\n");
        ...
        {
            return this.Equals(input as GetCdsFlowConventionsResponse);
        }

        /// <summary>
        /// Returns true if GetCdsFlowConventionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCdsFlowConventionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCdsFlowConventionsResponse input)
        {
            if (input == null)
                return false;
