...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ValuationPointDataResponse : IEquatable<ValuationPointDataResponse>
    {
        /// <summary>
        ...
        public ValuationPointDataResponse(string href = default(string), string type = default(string), string status = default(string), Dictionary<string, decimal> backout = default(Dictionary<string, decimal>), Dictionary<string, decimal> dealing = default(Dictionary<string, decimal>), Dictionary<string, decimal> pnL = default(Dictionary<string, decimal>), decimal gav = default(decimal), Dictionary<string, FeeAccrual> fees = default(Dictionary<string, FeeAccrual>), decimal nav = default(decimal), decimal previousNav = default(decimal), FundDetails fundDetails = default(FundDetails), FundValuationPointData fundValuationPointData = default(FundValuationPointData), Dictionary<string, ShareClassData> shareClassData = default(Dictionary<string, ShareClassData>), string valuationPointCode = default(string), string previousValuationPointCode = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ValuationPointDataResponse and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for ValuationPointDataResponse and cannot be null");
            // to ensure "backout" is required (not null)
            this.Backout = backout ?? throw new ArgumentNullException("backout is a required property for ValuationPointDataResponse and cannot be null");
            // to ensure "dealing" is required (not null)
            this.Dealing = dealing ?? throw new ArgumentNullException("dealing is a required property for ValuationPointDataResponse and cannot be null");
            // to ensure "pnL" is required (not null)
            this.PnL = pnL ?? throw new ArgumentNullException("pnL is a required property for ValuationPointDataResponse and cannot be null");
            this.Gav = gav;
            // to ensure "fees" is required (not null)
            this.Fees = fees ?? throw new ArgumentNullException("fees is a required property for ValuationPointDataResponse and cannot be null");
            this.Nav = nav;
            this.PreviousNav = previousNav;
            // to ensure "fundDetails" is required (not null)
            this.FundDetails = fundDetails ?? throw new ArgumentNullException("fundDetails is a required property for ValuationPointDataResponse and cannot be null");
            // to ensure "fundValuationPointData" is required (not null)
            this.FundValuationPointData = fundValuationPointData ?? throw new ArgumentNullException("fundValuationPointData is a required property for ValuationPointDataResponse and cannot be null");
            // to ensure "shareClassData" is required (not null)
            this.ShareClassData = shareClassData ?? throw new ArgumentNullException("shareClassData is a required property for ValuationPointDataResponse and cannot be null");
            this.Href = href;
        ...
        /// </summary>
        [DataMember(Name = "fundDetails", IsRequired = true, EmitDefaultValue = false)]
        public FundDetails FundDetails { get; set; }

        /// <summary>
        /// Gets or Sets FundValuationPointData
        /// </summary>
        [DataMember(Name = "fundValuationPointData", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "shareClassData", IsRequired = true, EmitDefaultValue = false)]
