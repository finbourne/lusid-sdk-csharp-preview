...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertDialectRequest : IEquatable<UpsertDialectRequest>
    {
        /// <summary>
        ...
        public UpsertDialectRequest(DialectId id = default(DialectId), DialectSchema schema = default(DialectSchema))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for UpsertDialectRequest and cannot be null");
            // to ensure "schema" is required (not null)
            this.Schema = schema ?? throw new ArgumentNullException("schema is a required property for UpsertDialectRequest and cannot be null");
        }
