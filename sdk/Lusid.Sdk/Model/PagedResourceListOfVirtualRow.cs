...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfVirtualRow : IEquatable<PagedResourceListOfVirtualRow>
    {
        /// <summary>
        ...
        public PagedResourceListOfVirtualRow(string nextPage = default(string), string previousPage = default(string), List<VirtualRow> values = default(List<VirtualRow>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfVirtualRow and cannot be null");
