...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReconcileDateTimeRuleAllOf : IEquatable<ReconcileDateTimeRuleAllOf>
    {
        /// <summary>
        ...
        public ReconcileDateTimeRuleAllOf(ComparisonTypeEnum comparisonType = default(ComparisonTypeEnum), decimal tolerance = default(decimal), AggregateSpec appliesTo = default(AggregateSpec), RuleTypeEnum ruleType = default(RuleTypeEnum))
        {
            ...
            this.AppliesTo = appliesTo ?? throw new ArgumentNullException("appliesTo is a required property for ReconcileDateTimeRuleAllOf and cannot be null");
