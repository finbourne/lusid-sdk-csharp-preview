...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CdsInstrument :  IEquatable<CdsInstrument>
    {
        ...
        /// <param name="conventions">Flow Convention details for the legs of the CDS (in practice the conventions for the protection leg are limited/based on premium leg) (required).</param>
        ...
        /// <param name="detailSpecifications">detailSpecifications (required).</param>
        ...
        public CdsInstrument(string ticker = default(string), List<FlowConventions> conventions = default(List<FlowConventions>), double? couponRate = default(double?), CdsDetailSpecifications detailSpecifications = default(CdsDetailSpecifications), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), string domCcy = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            if (conventions == null)
            {
                throw new InvalidDataException("conventions is a required property for CdsInstrument and cannot be null");
            }
            else
            {
            ...
            // to ensure "detailSpecifications" is required (not null)
            if (detailSpecifications == null)
            {
                throw new InvalidDataException("detailSpecifications is a required property for CdsInstrument and cannot be null");
            }
            else
            {
                this.DetailSpecifications = detailSpecifications;
            }
        ...
        public List<FlowConventions> Conventions { get; set; }
        ...
        /// </summary>
        [DataMember(Name="detailSpecifications", EmitDefaultValue=false)]
        public CdsDetailSpecifications DetailSpecifications { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DetailSpecifications: ").Append(DetailSpecifications).Append("\n");
        ...
        public bool Equals(CdsInstrument input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.Conventions.SequenceEqual(input.Conventions)
                ) && 
                (
                ...
                (
                    this.DetailSpecifications == input.DetailSpecifications ||
                    (this.DetailSpecifications != null &&
                    this.DetailSpecifications.Equals(input.DetailSpecifications))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DetailSpecifications != null)
                    hashCode = hashCode * 59 + this.DetailSpecifications.GetHashCode();
