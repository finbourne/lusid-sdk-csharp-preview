...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CdsInstrument : LusidInstrument,  IEquatable<CdsInstrument>
    {
        ...
        public CdsInstrument(string ticker = default(string), CdsFlowConventions flowConventions = default(CdsFlowConventions), decimal? couponRate = default(decimal?), CdsProtectionDetailSpecification protectionDetailSpecification = default(CdsProtectionDetailSpecification), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), string domCcy = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            {
                throw new InvalidDataException("protectionDetailSpecification is a required property for CdsInstrument and cannot be null");
            }
            else
            {
