...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CdsInstrument :  IEquatable<CdsInstrument>, IValidatableObject
    {
        /// <summary>
        ...
        public CdsInstrument(string ticker = default(string), List<FlowConventions> flowConventions = default(List<FlowConventions>), decimal couponRate = default(decimal), CdsDetailSpecification detailSpecification = default(CdsDetailSpecification), DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), string domCcy = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.Ticker = ticker ?? throw new ArgumentNullException("ticker is a required property for CdsInstrument and cannot be null");;
            // to ensure "flowConventions" is required (not null)
            this.FlowConventions = flowConventions ?? throw new ArgumentNullException("flowConventions is a required property for CdsInstrument and cannot be null");;
            this.CouponRate = couponRate;
            // to ensure "detailSpecification" is required (not null)
            this.DetailSpecification = detailSpecification ?? throw new ArgumentNullException("detailSpecification is a required property for CdsInstrument and cannot be null");;
            this.StartDate = startDate;
            this.MaturityDate = maturityDate;
            // to ensure "domCcy" is required (not null)
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for CdsInstrument and cannot be null");;
