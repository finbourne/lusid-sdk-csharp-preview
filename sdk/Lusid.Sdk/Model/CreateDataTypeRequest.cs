...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateDataTypeRequest :  IEquatable<CreateDataTypeRequest>
    {
        ...
        public CreateDataTypeRequest(string scope = default(string), string code = default(string), TypeValueRangeEnum typeValueRange = default(TypeValueRangeEnum), string displayName = default(string), string description = default(string), ValueTypeEnum valueType = default(ValueTypeEnum), List<PropertyValue> acceptableValues = default(List<PropertyValue>), UnitSchemaEnum? unitSchema = default(UnitSchemaEnum?), List<CreateUnitDefinition> acceptableUnits = default(List<CreateUnitDefinition>))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for CreateDataTypeRequest and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            {
                throw new InvalidDataException("typeValueRange is a required property for CreateDataTypeRequest and cannot be null");
            }
            else
            {
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for CreateDataTypeRequest and cannot be null");
            }
            else
            {
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for CreateDataTypeRequest and cannot be null");
            }
            else
            {
            ...
            if (valueType == null)
            {
                throw new InvalidDataException("valueType is a required property for CreateDataTypeRequest and cannot be null");
            }
            else
            {
        ...
        public List<PropertyValue> AcceptableValues { get; set; }
