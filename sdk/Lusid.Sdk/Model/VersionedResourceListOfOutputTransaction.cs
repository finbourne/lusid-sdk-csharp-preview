...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VersionedResourceListOfOutputTransaction")]
    public partial class VersionedResourceListOfOutputTransaction : IEquatable<VersionedResourceListOfOutputTransaction>
    {
        ...
        public VersionedResourceListOfOutputTransaction(Version version = default(Version), List<OutputTransaction> values = default(List<OutputTransaction>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "version" is required (not null)
            this.Version = version ?? throw new ArgumentNullException("version is a required property for VersionedResourceListOfOutputTransaction and cannot be null");
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for VersionedResourceListOfOutputTransaction and cannot be null");
            this.Href = href;
