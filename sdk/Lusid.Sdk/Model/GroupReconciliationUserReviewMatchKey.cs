...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupReconciliationUserReviewMatchKey : IEquatable<GroupReconciliationUserReviewMatchKey>
    {
        /// <summary>
        ...
        public GroupReconciliationUserReviewMatchKey(string matchKey = default(string), string userId = default(string), DateTimeOffset asAtAdded = default(DateTimeOffset), DateTimeOffset asAtInvalid = default(DateTimeOffset))
        {
            ...
            this.MatchKey = matchKey ?? throw new ArgumentNullException("matchKey is a required property for GroupReconciliationUserReviewMatchKey and cannot be null");
            this.UserId = userId;
        ...
        [DataMember(Name = "matchKey", IsRequired = true, EmitDefaultValue = false)]
