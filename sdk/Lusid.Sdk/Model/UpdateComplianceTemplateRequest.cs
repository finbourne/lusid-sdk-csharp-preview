...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateComplianceTemplateRequest")]
    public partial class UpdateComplianceTemplateRequest : IEquatable<UpdateComplianceTemplateRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateComplianceTemplateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateComplianceTemplateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateComplianceTemplateRequest" /> class.
        /// </summary>
        ...
        public UpdateComplianceTemplateRequest(string code = default(string), string description = default(string), List<ComplianceTemplateVariationRequest> variations = default(List<ComplianceTemplateVariationRequest>))
        {
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for UpdateComplianceTemplateRequest and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for UpdateComplianceTemplateRequest and cannot be null");
            // to ensure "variations" is required (not null)
            this.Variations = variations ?? throw new ArgumentNullException("variations is a required property for UpdateComplianceTemplateRequest and cannot be null");
        }
        ...
        [DataMember(Name = "variations", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as UpdateComplianceTemplateRequest);
        }

        /// <summary>
        /// Returns true if UpdateComplianceTemplateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateComplianceTemplateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateComplianceTemplateRequest input)
        {
            if (input == null)
                return false;
