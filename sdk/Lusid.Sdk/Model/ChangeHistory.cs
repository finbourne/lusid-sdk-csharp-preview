...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ChangeHistory : IEquatable<ChangeHistory>
    {
        /// <summary>
        ...
        public ChangeHistory(string userId = default(string), DateTimeOffset modifiedAsAt = default(DateTimeOffset), string requestId = default(string), ActionEnum action = default(ActionEnum), List<ChangeItem> changes = default(List<ChangeItem>), List<Link> links = default(List<Link>))
        {
            ...
            this.UserId = userId ?? throw new ArgumentNullException("userId is a required property for ChangeHistory and cannot be null");
            this.ModifiedAsAt = modifiedAsAt;
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for ChangeHistory and cannot be null");
            this.Action = action;
            // to ensure "changes" is required (not null)
            this.Changes = changes ?? throw new ArgumentNullException("changes is a required property for ChangeHistory and cannot be null");
            this.Links = links;
        }
        ...
        [DataMember(Name = "modifiedAsAt", IsRequired = true, EmitDefaultValue = false)]
