...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateRelationshipDefinitionRequest :  IEquatable<CreateRelationshipDefinitionRequest>
    {
        ...
        public CreateRelationshipDefinitionRequest(string scope = default(string), string code = default(string), string sourceEntityType = default(string), string targetEntityType = default(string), string displayName = default(string), string outwardDescription = default(string), string inwardDescription = default(string), string lifeTime = default(string), string relationshipCardinality = default(string))
        {
            ...
            if (scope == null)
            {
                throw new InvalidDataException("scope is a required property for CreateRelationshipDefinitionRequest and cannot be null");
            }
            else
            {
                this.Scope = scope;
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for CreateRelationshipDefinitionRequest and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            {
                throw new InvalidDataException("sourceEntityType is a required property for CreateRelationshipDefinitionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("targetEntityType is a required property for CreateRelationshipDefinitionRequest and cannot be null");
            }
            else
            {
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for CreateRelationshipDefinitionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("outwardDescription is a required property for CreateRelationshipDefinitionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("inwardDescription is a required property for CreateRelationshipDefinitionRequest and cannot be null");
            }
            else
            {
