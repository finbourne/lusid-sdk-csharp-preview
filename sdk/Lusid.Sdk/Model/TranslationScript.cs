...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TranslationScript : IEquatable<TranslationScript>
    {
        /// <summary>
        ...
        public TranslationScript(TranslationScriptId id = default(TranslationScriptId), string body = default(string), Version version = default(Version))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for TranslationScript and cannot be null");
            // to ensure "body" is required (not null)
            this.Body = body ?? throw new ArgumentNullException("body is a required property for TranslationScript and cannot be null");
