...
namespace Lusid.Sdk.Model
{
    ...
    public partial class LusidInstrument :  IEquatable<LusidInstrument>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="LusidInstrument" /> class.
        /// </summary>
        /// <param name="instrumentType">Instrument type, must be property for JSON..</param>
        /// <param name="type">type (required) (default to &quot;Finbourne.WebApi.Interface.Dto.Instruments.LusidInstrument&quot;).</param>
        public LusidInstrument(InstrumentTypeEnum? instrumentType = default(InstrumentTypeEnum?), string type = "Finbourne.WebApi.Interface.Dto.Instruments.LusidInstrument")
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for LusidInstrument and cannot be null");;
