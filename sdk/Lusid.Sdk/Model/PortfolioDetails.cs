...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioDetails :  IEquatable<PortfolioDetails>
    {
        ...
        /// <param name="originPortfolioId">originPortfolioId.</param>
        /// <param name="version">version.</param>
        /// <param name="baseCurrency">baseCurrency.</param>
        /// <param name="corporateActionSourceId">corporateActionSourceId.</param>
        /// <param name="links">links.</param>
        public PortfolioDetails(string href = default(string), ResourceId originPortfolioId = default(ResourceId), Version version = default(Version), string baseCurrency = default(string), ResourceId corporateActionSourceId = default(ResourceId), List<Link> links = default(List<Link>))
        {
            this.Href = href;
