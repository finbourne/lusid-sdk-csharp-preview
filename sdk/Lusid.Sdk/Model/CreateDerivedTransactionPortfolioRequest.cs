...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateDerivedTransactionPortfolioRequest : IEquatable<CreateDerivedTransactionPortfolioRequest>
    {
        ...
        /// <param name="created">The effective datetime at which to create the derived transaction portfolio. No transactions can be added to the derived transaction portfolio before this date. Defaults to the current LUSID system datetime if not specified..</param>
        ...
        public CreateDerivedTransactionPortfolioRequest(string displayName = default(string), string description = default(string), string code = default(string), ResourceId parentPortfolioId = default(ResourceId), DateTimeOffset? created = default(DateTimeOffset?), ResourceId corporateActionSourceId = default(ResourceId), AccountingMethodEnum? accountingMethod = default(AccountingMethodEnum?), List<string> subHoldingKeys = default(List<string>), List<string> instrumentScopes = default(List<string>))
        {
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CreateDerivedTransactionPortfolioRequest and cannot be null");
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for CreateDerivedTransactionPortfolioRequest and cannot be null");
            // to ensure "parentPortfolioId" is required (not null)
            this.ParentPortfolioId = parentPortfolioId ?? throw new ArgumentNullException("parentPortfolioId is a required property for CreateDerivedTransactionPortfolioRequest and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "parentPortfolioId", IsRequired = true, EmitDefaultValue = false)]
        public ResourceId ParentPortfolioId { get; set; }

        /// <summary>
        /// The effective datetime at which to create the derived transaction portfolio. No transactions can be added to the derived transaction portfolio before this date. Defaults to the current LUSID system datetime if not specified.
        /// </summary>
        /// <value>The effective datetime at which to create the derived transaction portfolio. No transactions can be added to the derived transaction portfolio before this date. Defaults to the current LUSID system datetime if not specified.</value>
