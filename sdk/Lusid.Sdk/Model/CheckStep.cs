...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CheckStep : ComplianceStep, IEquatable<CheckStep>
    {
        /// <summary>
        ...
        public CheckStep(string label = default(string), List<ComplianceTemplateParameter> limitCheckParameters = default(List<ComplianceTemplateParameter>), List<ComplianceTemplateParameter> warningCheckParameters = default(List<ComplianceTemplateParameter>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum)) : base(complianceStepType)
        {
            ...
            this.Label = label ?? throw new ArgumentNullException("label is a required property for CheckStep and cannot be null");
            // to ensure "limitCheckParameters" is required (not null)
            this.LimitCheckParameters = limitCheckParameters ?? throw new ArgumentNullException("limitCheckParameters is a required property for CheckStep and cannot be null");
            // to ensure "warningCheckParameters" is required (not null)
            this.WarningCheckParameters = warningCheckParameters ?? throw new ArgumentNullException("warningCheckParameters is a required property for CheckStep and cannot be null");
        }
