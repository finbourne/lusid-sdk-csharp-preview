...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SwaptionAllOf :  IEquatable<SwaptionAllOf>
    {
        ...
        /// </summary>
        /// <value>True if on exercise the holder of the option enters the swap paying fixed, false if floating.</value>
        [DataMember(Name="payOrReceiveFixed", EmitDefaultValue=false)]
        public PayOrReceiveFixedEnum PayOrReceiveFixed { get; set; }
        /// <summary>
        /// How does the option settle
        /// </summary>
        /// <value>How does the option settle</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="payOrReceiveFixed">True if on exercise the holder of the option enters the swap paying fixed, false if floating. (required).</param>
        /// <param name="deliveryMethod">How does the option settle (required).</param>
        /// <param name="instrumentType">Instrument type, must be property for JSON. (required).</param>
        public SwaptionAllOf(DateTimeOffset? startDate = default(DateTimeOffset?), SwapInstrument swap = default(SwapInstrument), PayOrReceiveFixedEnum payOrReceiveFixed = default(PayOrReceiveFixedEnum), DeliveryMethodEnum deliveryMethod = default(DeliveryMethodEnum), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            {
                throw new InvalidDataException("payOrReceiveFixed is a required property for SwaptionAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("deliveryMethod is a required property for SwaptionAllOf and cannot be null");
            }
            else
            {
        ...
        public SwapInstrument Swap { get; set; }
