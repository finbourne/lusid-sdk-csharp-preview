...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BondInstrumentAllOf :  IEquatable<BondInstrumentAllOf>
    {
        ...
        public BondInstrumentAllOf(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), string domCcy = default(string), decimal? couponRate = default(decimal?), decimal? principal = default(decimal?), FlowConventions flowConventions = default(FlowConventions), Dictionary<string, string> identifiers = default(Dictionary<string, string>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
