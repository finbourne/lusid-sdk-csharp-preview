...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReconcileNumericRule : ReconciliationRule, IEquatable<ReconcileNumericRule>
    {
        /// <summary>
        ...
        public ReconcileNumericRule(ComparisonTypeEnum comparisonType = default(ComparisonTypeEnum), decimal tolerance = default(decimal), AggregateSpec appliesTo = default(AggregateSpec), RuleTypeEnum ruleType = default(RuleTypeEnum)) : base(ruleType)
        {
            ...
            this.AppliesTo = appliesTo ?? throw new ArgumentNullException("appliesTo is a required property for ReconcileNumericRule and cannot be null");
