...
namespace Lusid.Sdk.Model
{
    ...
    public partial class StagedModificationsInfo : IEquatable<StagedModificationsInfo>
    {
        /// <summary>
        ...
        public StagedModificationsInfo(int countPending = default(int), string hrefPending = default(string), List<string> idsPreviewed = default(List<string>))
        {
            ...
            this.HrefPending = hrefPending ?? throw new ArgumentNullException("hrefPending is a required property for StagedModificationsInfo and cannot be null");
        ...
        [DataMember(Name = "hrefPending", IsRequired = true, EmitDefaultValue = false)]
