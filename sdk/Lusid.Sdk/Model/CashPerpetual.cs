...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashPerpetual : LusidInstrument,  IEquatable<CashPerpetual>
    {
        ...
        public CashPerpetual(DateTimeOffset? startDate = default(DateTimeOffset?), string domCcy = default(string), decimal? principal = default(decimal?), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for CashPerpetual and cannot be null");
            }
            else
            {
            ...
            if (domCcy == null)
            {
                throw new InvalidDataException("domCcy is a required property for CashPerpetual and cannot be null");
            }
            else
            {
                this.DomCcy = domCcy;
            ...
            if (principal == null)
            {
                throw new InvalidDataException("principal is a required property for CashPerpetual and cannot be null");
            }
            else
            {
