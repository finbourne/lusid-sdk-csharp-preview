...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SecurityOfferElection : IEquatable<SecurityOfferElection>
    {
        /// <summary>
        ...
        public SecurityOfferElection(string electionKey = default(string), bool isChosen = default(bool), bool isDefault = default(bool), UnitsRatio unitsRatio = default(UnitsRatio))
        {
            ...
            this.ElectionKey = electionKey ?? throw new ArgumentNullException("electionKey is a required property for SecurityOfferElection and cannot be null");
            // to ensure "unitsRatio" is required (not null)
            this.UnitsRatio = unitsRatio ?? throw new ArgumentNullException("unitsRatio is a required property for SecurityOfferElection and cannot be null");
