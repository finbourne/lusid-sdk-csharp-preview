...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfAddressKeyDefinition")]
    public partial class PagedResourceListOfAddressKeyDefinition : IEquatable<PagedResourceListOfAddressKeyDefinition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfAddressKeyDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfAddressKeyDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfAddressKeyDefinition" /> class.
        /// </summary>
        ...
        public PagedResourceListOfAddressKeyDefinition(string nextPage = default(string), string previousPage = default(string), List<AddressKeyDefinition> values = default(List<AddressKeyDefinition>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfAddressKeyDefinition and cannot be null");
        ...
        public List<AddressKeyDefinition> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResourceListOfAddressKeyDefinition {\n");
        ...
        {
            return this.Equals(input as PagedResourceListOfAddressKeyDefinition);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfAddressKeyDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfAddressKeyDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfAddressKeyDefinition input)
        {
            if (input == null)
                return false;
