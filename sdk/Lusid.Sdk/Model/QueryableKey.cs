...
namespace Lusid.Sdk.Model
{
    ...
    public partial class QueryableKey : IEquatable<QueryableKey>
    {
        /// <summary>
        ...
        public QueryableKey(string addressKey = default(string), string description = default(string), string displayName = default(string), string type = default(string), string flattenedType = default(string), string holdingQuantityScaling = default(string), List<string> supportedUsages = default(List<string>), List<string> supportedOperations = default(List<string>), string lifeCycleStatus = default(string), DateTimeOffset? removalDate = default(DateTimeOffset?), Dictionary<string, AddressKeyOptionDefinition> applicableOptions = default(Dictionary<string, AddressKeyOptionDefinition>), string derivationFormula = default(string))
        {
            ...
            this.AddressKey = addressKey ?? throw new ArgumentNullException("addressKey is a required property for QueryableKey and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for QueryableKey and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for QueryableKey and cannot be null");
            // to ensure "flattenedType" is required (not null)
            this.FlattenedType = flattenedType ?? throw new ArgumentNullException("flattenedType is a required property for QueryableKey and cannot be null");
            // to ensure "holdingQuantityScaling" is required (not null)
            this.HoldingQuantityScaling = holdingQuantityScaling ?? throw new ArgumentNullException("holdingQuantityScaling is a required property for QueryableKey and cannot be null");
            // to ensure "supportedUsages" is required (not null)
            this.SupportedUsages = supportedUsages ?? throw new ArgumentNullException("supportedUsages is a required property for QueryableKey and cannot be null");
            // to ensure "supportedOperations" is required (not null)
            this.SupportedOperations = supportedOperations ?? throw new ArgumentNullException("supportedOperations is a required property for QueryableKey and cannot be null");
            // to ensure "lifeCycleStatus" is required (not null)
            this.LifeCycleStatus = lifeCycleStatus ?? throw new ArgumentNullException("lifeCycleStatus is a required property for QueryableKey and cannot be null");
        ...
        [DataMember(Name = "flattenedType", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "holdingQuantityScaling", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "supportedUsages", IsRequired = true, EmitDefaultValue = false)]
