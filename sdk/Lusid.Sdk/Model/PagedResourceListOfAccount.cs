...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfAccount : IEquatable<PagedResourceListOfAccount>
    {
        /// <summary>
        ...
        public PagedResourceListOfAccount(string nextPage = default(string), string previousPage = default(string), List<Account> values = default(List<Account>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfAccount and cannot be null");
