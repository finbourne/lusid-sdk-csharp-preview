...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardTenorCurveData : ComplexMarketData, IEquatable<FxForwardTenorCurveData>
    {
        ...
        public FxForwardTenorCurveData(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), string fgnCcy = default(string), List<string> tenors = default(List<string>), List<decimal> rates = default(List<decimal>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum), string lineage = default(string)) : base(marketDataType)
        {
