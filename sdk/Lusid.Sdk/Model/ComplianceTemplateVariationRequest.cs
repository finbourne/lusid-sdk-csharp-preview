...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceTemplateVariationRequest : IEquatable<ComplianceTemplateVariationRequest>
    {
        /// <summary>
        ...
        public ComplianceTemplateVariationRequest(string label = default(string), string description = default(string), string outcomeDescription = default(string), string referencedGroupLabel = default(string), List<ComplianceStepRequest> steps = default(List<ComplianceStepRequest>))
        {
            ...
            this.Label = label ?? throw new ArgumentNullException("label is a required property for ComplianceTemplateVariationRequest and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for ComplianceTemplateVariationRequest and cannot be null");
            // to ensure "steps" is required (not null)
            this.Steps = steps ?? throw new ArgumentNullException("steps is a required property for ComplianceTemplateVariationRequest and cannot be null");
