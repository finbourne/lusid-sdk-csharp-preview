...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OrderRequest :  IEquatable<OrderRequest>
    {
        ...
        public OrderRequest(List<PerpetualProperty> properties = default(List<PerpetualProperty>), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), int? quantity = default(int?), ResourceId portfolio = default(ResourceId), string id = default(string))
        {
