...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OrderRequest :  IEquatable<OrderRequest>, IValidatableObject
    {
        ...
        public OrderRequest(Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), int quantity = default(int), string side = default(string), ResourceId orderBook = default(ResourceId), ResourceId portfolio = default(ResourceId), string code = default(string))
        {
            ...
            this.OrderBook = orderBook ?? throw new ArgumentNullException("orderBook is a required property for OrderRequest and cannot be null");;
            // to ensure "portfolio" is required (not null)
            this.Portfolio = portfolio ?? throw new ArgumentNullException("portfolio is a required property for OrderRequest and cannot be null");;
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for OrderRequest and cannot be null");;
