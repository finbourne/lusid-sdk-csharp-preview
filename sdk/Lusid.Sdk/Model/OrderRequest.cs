...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OrderRequest :  IEquatable<OrderRequest>
    {
        ...
        /// <param name="code">Uniquely identifies this order. (required).</param>
        /// <param name="lusidInstrument">The LUSID instrument id for the instrument ordered. (required).</param>
        public OrderRequest(List<PerpetualProperty> properties = default(List<PerpetualProperty>), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), int? quantity = default(int?), ResourceId portfolio = default(ResourceId), string code = default(string), string lusidInstrument = default(string))
        {
            // to ensure "properties" is required (not null)
            if (properties == null)
            {
                throw new InvalidDataException("properties is a required property for OrderRequest and cannot be null");
            }
            else
            {
            ...
            if (portfolio == null)
            {
                throw new InvalidDataException("portfolio is a required property for OrderRequest and cannot be null");
            }
            else
            {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for OrderRequest and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            // to ensure "lusidInstrument" is required (not null)
            if (lusidInstrument == null)
            {
                throw new InvalidDataException("lusidInstrument is a required property for OrderRequest and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="lusidInstrument", EmitDefaultValue=false)]
        public string LusidInstrument { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LusidInstrument: ").Append(LusidInstrument).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(OrderRequest input)
        {
            ...
            return 
                ...
                (
                    this.LusidInstrument == input.LusidInstrument ||
                    (this.LusidInstrument != null &&
                    this.LusidInstrument.Equals(input.LusidInstrument))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LusidInstrument != null)
                    hashCode = hashCode * 59 + this.LusidInstrument.GetHashCode();
                return hashCode;
            }
        }
    }
