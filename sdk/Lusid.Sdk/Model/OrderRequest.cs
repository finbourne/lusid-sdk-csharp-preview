...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OrderRequest : IEquatable<OrderRequest>
    {
        ...
        public OrderRequest(Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), int quantity = default(int), string side = default(string), ResourceId orderBookId = default(ResourceId), ResourceId portfolioId = default(ResourceId), ResourceId id = default(ResourceId))
        {
            ...
            this.OrderBookId = orderBookId ?? throw new ArgumentNullException("orderBookId is a required property for OrderRequest and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "orderBookId", IsRequired = true, EmitDefaultValue = false)]
