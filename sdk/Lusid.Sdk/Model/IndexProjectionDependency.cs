...
namespace Lusid.Sdk.Model
{
    ...
    public partial class IndexProjectionDependency : EconomicDependency, IEquatable<IndexProjectionDependency>
    {
        /// <summary>
        ...
        /// <param name="dependencyType">The available values are: Opaque, Cash, Discounting, EquityCurve, EquityVol, Fx, FxForwards, FxVol, IndexProjection, IrVol, Quote, Vendor (required) (default to &quot;IndexProjectionDependency&quot;).</param>
        public IndexProjectionDependency(string currency = default(string), string tenor = default(string), string indexName = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base(dependencyType)
        {
            ...
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for IndexProjectionDependency and cannot be null");
            // to ensure "tenor" is required (not null)
            this.Tenor = tenor ?? throw new ArgumentNullException("tenor is a required property for IndexProjectionDependency and cannot be null");
            // to ensure "indexName" is required (not null)
            this.IndexName = indexName ?? throw new ArgumentNullException("indexName is a required property for IndexProjectionDependency and cannot be null");
            this.Date = date;
        }
