...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DiscountingDependency : EconomicDependency, IEquatable<DiscountingDependency>
    {
        /// <summary>
        ...
        /// <param name="dependencyType">The available values are: Opaque, Cash, Discounting, EquityCurve, EquityVol, Fx, FxForwards, FxVol, IndexProjection, IrVol, Quote, Vendor (required) (default to &quot;DiscountingDependency&quot;).</param>
        public DiscountingDependency(string currency = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base(dependencyType)
        {
            ...
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for DiscountingDependency and cannot be null");
            this.Date = date;
        }
