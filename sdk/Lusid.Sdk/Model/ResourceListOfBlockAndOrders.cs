...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfBlockAndOrders : IEquatable<ResourceListOfBlockAndOrders>
    {
        /// <summary>
        ...
        public ResourceListOfBlockAndOrders(List<BlockAndOrders> values = default(List<BlockAndOrders>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfBlockAndOrders and cannot be null");
            this.Href = href;
            this.Links = links;
