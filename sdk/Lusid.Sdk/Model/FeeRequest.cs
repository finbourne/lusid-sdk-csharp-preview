...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FeeRequest : IEquatable<FeeRequest>
    {
        /// <summary>
        ...
        public FeeRequest(string code = default(string), ResourceId feeTypeId = default(ResourceId), string displayName = default(string), string description = default(string), string origin = default(string), string calculationBase = default(string), string accrualCurrency = default(string), string treatment = default(string), decimal? totalAnnualAccrualAmount = default(decimal?), decimal? feeRatePercentage = default(decimal?), string payableFrequency = default(string), string businessDayConvention = default(string), DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset? endDate = default(DateTimeOffset?), DayMonth anchorDate = default(DayMonth), Dictionary<string, Property> properties = default(Dictionary<string, Property>), ResourceId portfolioId = default(ResourceId))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for FeeRequest and cannot be null");
            // to ensure "feeTypeId" is required (not null)
            this.FeeTypeId = feeTypeId ?? throw new ArgumentNullException("feeTypeId is a required property for FeeRequest and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for FeeRequest and cannot be null");
            // to ensure "accrualCurrency" is required (not null)
            this.AccrualCurrency = accrualCurrency ?? throw new ArgumentNullException("accrualCurrency is a required property for FeeRequest and cannot be null");
            // to ensure "treatment" is required (not null)
            this.Treatment = treatment ?? throw new ArgumentNullException("treatment is a required property for FeeRequest and cannot be null");
            // to ensure "payableFrequency" is required (not null)
            this.PayableFrequency = payableFrequency ?? throw new ArgumentNullException("payableFrequency is a required property for FeeRequest and cannot be null");
            // to ensure "businessDayConvention" is required (not null)
            this.BusinessDayConvention = businessDayConvention ?? throw new ArgumentNullException("businessDayConvention is a required property for FeeRequest and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "feeTypeId", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "accrualCurrency", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "treatment", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "payableFrequency", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "businessDayConvention", IsRequired = true, EmitDefaultValue = false)]
