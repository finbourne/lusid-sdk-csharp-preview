...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfCutLabelDefinition :  IEquatable<ResourceListOfCutLabelDefinition>
    {
        /// <summary>
        ...
        public ResourceListOfCutLabelDefinition(List<CutLabelDefinition> values = default(List<CutLabelDefinition>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfCutLabelDefinition and cannot be null");
            }
            else
            {
                this.Values = values;
