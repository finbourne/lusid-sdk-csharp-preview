...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfCutLabelDefinition :  IEquatable<ResourceListOfCutLabelDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfCutLabelDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfCutLabelDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfCutLabelDefinition" /> class.
        /// </summary>
        ...
        public ResourceListOfCutLabelDefinition(List<CutLabelDefinition> values = default(List<CutLabelDefinition>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfCutLabelDefinition and cannot be null");;
            this.Href = href;
            this.Links = links;
        }
        ...
        public List<CutLabelDefinition> Values { get; set; }
        ...
        {
            return this.Equals(input as ResourceListOfCutLabelDefinition);
        }

        /// <summary>
        /// Returns true if ResourceListOfCutLabelDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfCutLabelDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfCutLabelDefinition input)
        {
            if (input == null)
                return false;
