...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BondInstrument :  IEquatable<BondInstrument>, IValidatableObject
    {
        /// <summary>
        ...
        public BondInstrument(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), string domCcy = default(string), decimal couponRate = default(decimal), decimal principal = default(decimal), FlowConventions flowConventions = default(FlowConventions), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            this.StartDate = startDate;
            this.MaturityDate = maturityDate;
            // to ensure "domCcy" is required (not null)
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for BondInstrument and cannot be null");;
            this.CouponRate = couponRate;
            this.Principal = principal;
            // to ensure "flowConventions" is required (not null)
            this.FlowConventions = flowConventions ?? throw new ArgumentNullException("flowConventions is a required property for BondInstrument and cannot be null");;
