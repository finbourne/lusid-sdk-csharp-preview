...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BondInstrument : LusidInstrument,  IEquatable<BondInstrument>
    {
        ...
        /// <param name="identifiers">set of market identifiers along with their types, e.g. ISIN, CUSIP, SEDOL..</param>
        public BondInstrument(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), string domCcy = default(string), decimal? couponRate = default(decimal?), decimal? principal = default(decimal?), FlowConventions flowConventions = default(FlowConventions), Dictionary<string, string> identifiers = default(Dictionary<string, string>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
        ...
        /// <summary>
        /// set of market identifiers along with their types, e.g. ISIN, CUSIP, SEDOL.
        /// </summary>
        /// <value>set of market identifiers along with their types, e.g. ISIN, CUSIP, SEDOL.</value>
