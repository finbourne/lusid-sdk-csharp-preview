...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceRuleUpsertRequest : IEquatable<ComplianceRuleUpsertRequest>
    {
        /// <summary>
        ...
        public ComplianceRuleUpsertRequest(string scope = default(string), string code = default(string), string displayName = default(string), string type = default(string), string propertyKey = default(string), string value = default(string), decimal lowerBound = default(decimal), decimal upperBound = default(decimal), string schedule = default(string), bool hardRequirement = default(bool), List<ResourceId> targetPortfolioIds = default(List<ResourceId>), string description = default(string))
        {
            // to ensure "scope" is required (not null)
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for ComplianceRuleUpsertRequest and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ComplianceRuleUpsertRequest and cannot be null");
            this.LowerBound = lowerBound;
            this.UpperBound = upperBound;
            // to ensure "schedule" is required (not null)
            this.Schedule = schedule ?? throw new ArgumentNullException("schedule is a required property for ComplianceRuleUpsertRequest and cannot be null");
            this.HardRequirement = hardRequirement;
            // to ensure "targetPortfolioIds" is required (not null)
            this.TargetPortfolioIds = targetPortfolioIds ?? throw new ArgumentNullException("targetPortfolioIds is a required property for ComplianceRuleUpsertRequest and cannot be null");
            this.Code = code;
