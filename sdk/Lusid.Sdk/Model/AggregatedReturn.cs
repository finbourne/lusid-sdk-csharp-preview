...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AggregatedReturn :  IEquatable<AggregatedReturn>
    {
        ...
        public AggregatedReturn(DateTimeOffset? effectiveAt = default(DateTimeOffset?), decimal? openingMarketValue = default(decimal?), Dictionary<string, decimal?> metricsValue = default(Dictionary<string, decimal?>), string frequency = default(string))
        {
            // to ensure "effectiveAt" is required (not null)
            if (effectiveAt == null)
            {
                throw new InvalidDataException("effectiveAt is a required property for AggregatedReturn and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("openingMarketValue is a required property for AggregatedReturn and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("metricsValue is a required property for AggregatedReturn and cannot be null");
            }
            else
            {
