...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AggregatedReturn :  IEquatable<AggregatedReturn>
    {
        ...
        public AggregatedReturn(DateTimeOffset? effectiveAt = default(DateTimeOffset?), decimal? marketValue = default(decimal?), Dictionary<string, decimal?> metricsValue = default(Dictionary<string, decimal?>), string frequency = default(string))
        {
            ...
            if (marketValue == null)
            {
                throw new InvalidDataException("marketValue is a required property for AggregatedReturn and cannot be null");
            }
            else
            {
