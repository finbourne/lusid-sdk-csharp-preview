...
{
    /// <summary>
    /// An instrument which has the Lusid economic representation where it exists.  Lusid has two ways of representing instruments with an extended definition. The first is native to Lusid using the LusidInstrument format.  The second is essentially a free-text methodology where &#39;any&#39; Json or Xml string can be given. This is to support the use case where Lusid does not  understand the instrument natively but may be able to run a limited set of queries against it.
    /// </summary>
    [DataContract]
    public partial class ExpandedInstrument :  IEquatable<ExpandedInstrument>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpandedInstrument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExpandedInstrument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpandedInstrument" /> class.
        /// </summary>
        ...
        public ExpandedInstrument(string href = default(string), string lusidInstrumentId = default(string), Version version = default(Version), string name = default(string), Dictionary<string, string> identifiers = default(Dictionary<string, string>), List<Property> properties = default(List<Property>), ResourceId lookthroughPortfolio = default(ResourceId), LusidInstrument instrumentDefinition = default(LusidInstrument), StateEnum state = default(StateEnum), List<Link> links = default(List<Link>))
        {
            this.Href = href;
            // to ensure "lusidInstrumentId" is required (not null)
            if (lusidInstrumentId == null)
            {
                throw new InvalidDataException("lusidInstrumentId is a required property for ExpandedInstrument and cannot be null");
            }
            else
            {
            ...
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for ExpandedInstrument and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ExpandedInstrument and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (identifiers == null)
            {
                throw new InvalidDataException("identifiers is a required property for ExpandedInstrument and cannot be null");
            }
            else
            {
            ...
            if (state == null)
            {
                throw new InvalidDataException("state is a required property for ExpandedInstrument and cannot be null");
            }
            else
            {
                this.State = state;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExpandedInstrument {\n");
        ...
        {
            return this.Equals(input as ExpandedInstrument);
        }

        /// <summary>
        /// Returns true if ExpandedInstrument instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpandedInstrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpandedInstrument input)
        {
            if (input == null)
                return false;
