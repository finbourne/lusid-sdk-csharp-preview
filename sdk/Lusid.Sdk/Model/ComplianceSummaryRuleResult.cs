...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceSummaryRuleResult : IEquatable<ComplianceSummaryRuleResult>
    {
        /// <summary>
        ...
        public ComplianceSummaryRuleResult(ResourceId ruleId = default(ResourceId), ResourceId templateId = default(ResourceId), string variation = default(string), string ruleStatus = default(string), List<ResourceId> affectedPortfolios = default(List<ResourceId>), List<ResourceId> affectedOrders = default(List<ResourceId>), Dictionary<string, string> parametersUsed = default(Dictionary<string, string>), Dictionary<string, ComplianceRuleBreakdown> ruleBreakdown = default(Dictionary<string, ComplianceRuleBreakdown>))
        {
            // to ensure "ruleId" is required (not null)
            this.RuleId = ruleId ?? throw new ArgumentNullException("ruleId is a required property for ComplianceSummaryRuleResult and cannot be null");
            // to ensure "templateId" is required (not null)
            this.TemplateId = templateId ?? throw new ArgumentNullException("templateId is a required property for ComplianceSummaryRuleResult and cannot be null");
            // to ensure "variation" is required (not null)
            this.Variation = variation ?? throw new ArgumentNullException("variation is a required property for ComplianceSummaryRuleResult and cannot be null");
            // to ensure "ruleStatus" is required (not null)
            this.RuleStatus = ruleStatus ?? throw new ArgumentNullException("ruleStatus is a required property for ComplianceSummaryRuleResult and cannot be null");
            // to ensure "affectedPortfolios" is required (not null)
            this.AffectedPortfolios = affectedPortfolios ?? throw new ArgumentNullException("affectedPortfolios is a required property for ComplianceSummaryRuleResult and cannot be null");
            // to ensure "affectedOrders" is required (not null)
            this.AffectedOrders = affectedOrders ?? throw new ArgumentNullException("affectedOrders is a required property for ComplianceSummaryRuleResult and cannot be null");
            // to ensure "parametersUsed" is required (not null)
            this.ParametersUsed = parametersUsed ?? throw new ArgumentNullException("parametersUsed is a required property for ComplianceSummaryRuleResult and cannot be null");
            // to ensure "ruleBreakdown" is required (not null)
            this.RuleBreakdown = ruleBreakdown ?? throw new ArgumentNullException("ruleBreakdown is a required property for ComplianceSummaryRuleResult and cannot be null");
        }
