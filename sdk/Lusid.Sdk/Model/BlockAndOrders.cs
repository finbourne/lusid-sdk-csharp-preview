...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BlockAndOrders : IEquatable<BlockAndOrders>
    {
        /// <summary>
        ...
        public BlockAndOrders(Block block = default(Block), List<Order> orders = default(List<Order>))
        {
            ...
            this.Block = block ?? throw new ArgumentNullException("block is a required property for BlockAndOrders and cannot be null");
            // to ensure "orders" is required (not null)
            this.Orders = orders ?? throw new ArgumentNullException("orders is a required property for BlockAndOrders and cannot be null");
        }
