...
namespace Lusid.Sdk.Model
{
    ...
    public partial class RelativeDateOffset : IEquatable<RelativeDateOffset>
    {
        /// <summary>
        ...
        public RelativeDateOffset(int days = default(int), string businessDayConvention = default(string), string dayType = default(string))
        {
            ...
            this.BusinessDayConvention = businessDayConvention ?? throw new ArgumentNullException("businessDayConvention is a required property for RelativeDateOffset and cannot be null");
