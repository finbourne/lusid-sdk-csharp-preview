...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashAndSecurityOfferElection : IEquatable<CashAndSecurityOfferElection>
    {
        /// <summary>
        ...
        public CashAndSecurityOfferElection(string cashOfferCurrency = default(string), decimal cashOfferPrice = default(decimal), decimal? costFactor = default(decimal?), string electionKey = default(string), bool isChosen = default(bool), bool isDefault = default(bool), UnitsRatio unitsRatio = default(UnitsRatio))
        {
            ...
            this.CashOfferCurrency = cashOfferCurrency ?? throw new ArgumentNullException("cashOfferCurrency is a required property for CashAndSecurityOfferElection and cannot be null");
            this.CashOfferPrice = cashOfferPrice;
            // to ensure "electionKey" is required (not null)
            this.ElectionKey = electionKey ?? throw new ArgumentNullException("electionKey is a required property for CashAndSecurityOfferElection and cannot be null");
            // to ensure "unitsRatio" is required (not null)
            this.UnitsRatio = unitsRatio ?? throw new ArgumentNullException("unitsRatio is a required property for CashAndSecurityOfferElection and cannot be null");
