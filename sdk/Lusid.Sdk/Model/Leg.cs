...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Leg :  IEquatable<Leg>
    {
        ...
        public Leg(FlowConventions conventions = default(FlowConventions), bool? isPayNotReceive = default(bool?), bool? isFloatNotFixed = default(bool?), decimal? fixedRate = default(decimal?))
        {
            ...
            if (conventions == null)
            {
                throw new InvalidDataException("conventions is a required property for Leg and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("isPayNotReceive is a required property for Leg and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("isFloatNotFixed is a required property for Leg and cannot be null");
            }
            else
            {
            ...
            if (fixedRate == null)
            {
                throw new InvalidDataException("fixedRate is a required property for Leg and cannot be null");
            }
            else
            {
