...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Warning : IEquatable<Warning>
    {
        ...
        public Warning(string entityId = default(string), string message = default(string))
        {
            ...
            this.EntityId = entityId ?? throw new ArgumentNullException("entityId is a required property for Warning and cannot be null");
            // to ensure "message" is required (not null)
            this.Message = message ?? throw new ArgumentNullException("message is a required property for Warning and cannot be null");
        }
