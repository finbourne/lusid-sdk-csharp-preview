...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfStagedModificationsRequestedChangeInterval : IEquatable<PagedResourceListOfStagedModificationsRequestedChangeInterval>
    {
        /// <summary>
        ...
        public PagedResourceListOfStagedModificationsRequestedChangeInterval(string nextPage = default(string), string previousPage = default(string), List<StagedModificationsRequestedChangeInterval> values = default(List<StagedModificationsRequestedChangeInterval>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfStagedModificationsRequestedChangeInterval and cannot be null");
