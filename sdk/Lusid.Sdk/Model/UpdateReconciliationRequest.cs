...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateReconciliationRequest")]
    public partial class UpdateReconciliationRequest : IEquatable<UpdateReconciliationRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateReconciliationRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateReconciliationRequest);
        }

        /// <summary>
        /// Returns true if UpdateReconciliationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateReconciliationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateReconciliationRequest input)
        {
            if (input == null)
                return false;
