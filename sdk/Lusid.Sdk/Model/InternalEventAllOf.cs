...
namespace Lusid.Sdk.Model
{
    ...
    /// InternalEventAllOf
    /// </summary>
    [DataContract(Name = "InternalEvent_allOf")]
    public partial class InternalEventAllOf : IEquatable<InternalEventAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InternalEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalEventAllOf" /> class.
        /// </summary>
        ...
        public InternalEventAllOf(string eventCategory = default(string), string eventSource = default(string), DateTimeOffset anchorDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
        ...
        {
            return this.Equals(input as InternalEventAllOf);
        }

        /// <summary>
        /// Returns true if InternalEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InternalEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InternalEventAllOf input)
        {
            if (input == null)
                return false;
