...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetStructuredResultDataResponse")]
    public partial class GetStructuredResultDataResponse : IEquatable<GetStructuredResultDataResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetStructuredResultDataResponse" /> class.
        /// </summary>
        ...
        public GetStructuredResultDataResponse(string href = default(string), Dictionary<string, StructuredResultData> values = default(Dictionary<string, StructuredResultData>), Dictionary<string, ErrorDetail> failed = default(Dictionary<string, ErrorDetail>), List<Link> links = default(List<Link>))
        {
            this.Href = href;
            this.Values = values;
            this.Failed = failed;
        ...
        public Dictionary<string, StructuredResultData> Values { get; set; }
        ...
        {
            return this.Equals(input as GetStructuredResultDataResponse);
        }

        /// <summary>
        /// Returns true if GetStructuredResultDataResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetStructuredResultDataResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetStructuredResultDataResponse input)
        {
            if (input == null)
                return false;
