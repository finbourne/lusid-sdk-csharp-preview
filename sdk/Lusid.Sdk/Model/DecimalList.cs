...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DecimalList : IEquatable<DecimalList>
    {
        /// <summary>
        ...
        public DecimalList(List<decimal> values = default(List<decimal>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for DecimalList and cannot be null");
