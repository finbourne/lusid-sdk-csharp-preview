...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Order :  IEquatable<Order>, IValidatableObject
    {
        ...
        public Order(Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), Version version = default(Version), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), int quantity = default(int), string side = default(string), ResourceId orderBook = default(ResourceId), ResourceId portfolio = default(ResourceId), ResourceId id = default(ResourceId), string lusidInstrumentId = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "instrumentIdentifiers" is required (not null)
            this.InstrumentIdentifiers = instrumentIdentifiers ?? throw new ArgumentNullException("instrumentIdentifiers is a required property for Order and cannot be null");;
            this.Quantity = quantity;
            // to ensure "side" is required (not null)
            this.Side = side ?? throw new ArgumentNullException("side is a required property for Order and cannot be null");;
            // to ensure "orderBook" is required (not null)
            this.OrderBook = orderBook ?? throw new ArgumentNullException("orderBook is a required property for Order and cannot be null");;
            // to ensure "portfolio" is required (not null)
            this.Portfolio = portfolio ?? throw new ArgumentNullException("portfolio is a required property for Order and cannot be null");;
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Order and cannot be null");;
            // to ensure "lusidInstrumentId" is required (not null)
            this.LusidInstrumentId = lusidInstrumentId ?? throw new ArgumentNullException("lusidInstrumentId is a required property for Order and cannot be null");;
