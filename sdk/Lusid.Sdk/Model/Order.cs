...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Order :  IEquatable<Order>
    {
        ...
        public Order(Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), Version version = default(Version), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), int? quantity = default(int?), ResourceId portfolio = default(ResourceId), OrderId id = default(OrderId), string lusidInstrument = default(string), List<Link> links = default(List<Link>))
        {
            ...
            {
                throw new InvalidDataException("lusidInstrument is a required property for Order and cannot be null");
            }
            else
            {
