...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Relation :  IEquatable<Relation>
    {
        ...
        public Relation(string href = default(string), Version version = default(Version), ResourceId relationDefinitionId = default(ResourceId), Dictionary<string, string> sourceEntityId = default(Dictionary<string, string>), Dictionary<string, string> targetEntityId = default(Dictionary<string, string>), string description = default(string), DateTimeOffset? effectiveFrom = default(DateTimeOffset?))
        {
            this.Href = href;
            ...
            {
                throw new InvalidDataException("sourceEntityId is a required property for Relation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("targetEntityId is a required property for Relation and cannot be null");
            }
            else
            {
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for Relation and cannot be null");
            }
            else
            {
