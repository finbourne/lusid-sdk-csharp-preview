 ...
 *
 * The version of the OpenAPI document: 0.11.3377-mark
...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Relation :  IEquatable<Relation>
    {
        ...
        public Relation(Version version = default(Version), ResourceId relationDefinitionId = default(ResourceId), Dictionary<string, string> relatedEntityId = default(Dictionary<string, string>), string traversalDirection = default(string), string traversalDescription = default(string), DateTimeOffset? effectiveFrom = default(DateTimeOffset?))
        {
            ...
            {
                throw new InvalidDataException("relationDefinitionId is a required property for Relation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("relatedEntityId is a required property for Relation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("traversalDirection is a required property for Relation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("traversalDescription is a required property for Relation and cannot be null");
            }
            else
            {
