...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FundRequest : IEquatable<FundRequest>
    {
        /// <summary>
        ...
        public FundRequest(string code = default(string), string displayName = default(string), string description = default(string), ResourceId fundConfigurationId = default(ResourceId), ResourceId aborId = default(ResourceId), List<string> shareClassInstrumentScopes = default(List<string>), List<InstrumentResolutionDetail> shareClassInstruments = default(List<InstrumentResolutionDetail>), string type = default(string), DateTimeOffset inceptionDate = default(DateTimeOffset), int? decimalPlaces = default(int?), DayMonth yearEndDate = default(DayMonth), Dictionary<string, Property> properties = default(Dictionary<string, Property>))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for FundRequest and cannot be null");
            // to ensure "aborId" is required (not null)
            this.AborId = aborId ?? throw new ArgumentNullException("aborId is a required property for FundRequest and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for FundRequest and cannot be null");
            this.InceptionDate = inceptionDate;
            // to ensure "yearEndDate" is required (not null)
            this.YearEndDate = yearEndDate ?? throw new ArgumentNullException("yearEndDate is a required property for FundRequest and cannot be null");
