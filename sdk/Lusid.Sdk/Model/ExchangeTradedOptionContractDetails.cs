...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ExchangeTradedOptionContractDetails : IEquatable<ExchangeTradedOptionContractDetails>
    {
        ...
        /// <param name="deliveryType">The delivery type, cash or physical. An option on a future is physically settled if upon exerciseing the  holder receives a future.  Supported string (enumeration) values are: [Cash, Physical]. (required).</param>
        /// <param name="description">Description of contract (required).</param>
        /// <param name="exchangeCode">Exchange code for contract  Supported string (enumeration) values are: [ASX, CBOT, CBF, CME, CMX, EOP, HKG, KFE, MFM, OSE, SGX, NYBOT, KCBT, MGE, MATIF, SFE, NYFE, NYM, LIFFE, EUREX, ICE, MSE, NASDAQ, EEX]. (required).</param>
        /// <param name="exerciseDate">Exercise Date (required).</param>
        /// <param name="exerciseType">The exercise type, European, American or Bermudan  Supported string (enumeration) values are: [None, European, Bermudan, American]. (required).</param>
        /// <param name="optionCode">Option Contract Code, typically one or two letters, e.g. OG &#x3D;&gt; Option on Gold. (required).</param>
        /// <param name="optionType">The option type, Call or Put.  Supported string (enumeration) values are: [None, Call, Put]. (required).</param>
        ...
        /// </summary>
        /// <value>The delivery type, cash or physical. An option on a future is physically settled if upon exerciseing the  holder receives a future.  Supported string (enumeration) values are: [Cash, Physical].</value>
        ...
        /// </summary>
        /// <value>Exchange code for contract  Supported string (enumeration) values are: [ASX, CBOT, CBF, CME, CMX, EOP, HKG, KFE, MFM, OSE, SGX, NYBOT, KCBT, MGE, MATIF, SFE, NYFE, NYM, LIFFE, EUREX, ICE, MSE, NASDAQ, EEX].</value>
        ...
        /// </summary>
        /// <value>The exercise type, European, American or Bermudan  Supported string (enumeration) values are: [None, European, Bermudan, American].</value>
        ...
        /// </summary>
        /// <value>The option type, Call or Put.  Supported string (enumeration) values are: [None, Call, Put].</value>
