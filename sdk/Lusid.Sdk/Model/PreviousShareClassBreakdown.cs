...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PreviousShareClassBreakdown : IEquatable<PreviousShareClassBreakdown>
    {
        /// <summary>
        ...
        public PreviousShareClassBreakdown(PreviousNAV nav = default(PreviousNAV), UnitisationData unitisation = default(UnitisationData), decimal shareClassToFundFxRate = default(decimal))
        {
            ...
            this.Nav = nav ?? throw new ArgumentNullException("nav is a required property for PreviousShareClassBreakdown and cannot be null");
        ...
        /// Gets or Sets Nav
        /// </summary>
        [DataMember(Name = "nav", IsRequired = true, EmitDefaultValue = false)]
