...
namespace Lusid.Sdk.Model
{
    ...
    public partial class RepoAllOf : IEquatable<RepoAllOf>
    {
        ...
        public RepoAllOf(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), string domCcy = default(string), string accrualBasis = default(string), List<Instrument> collateral = default(List<Instrument>), decimal? collateralValue = default(decimal?), decimal? haircut = default(decimal?), decimal? margin = default(decimal?), decimal? purchasePrice = default(decimal?), decimal? repoRate = default(decimal?), decimal? repurchasePrice = default(decimal?), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
