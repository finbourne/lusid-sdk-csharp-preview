...
namespace Lusid.Sdk.Model
{
    ...
    public partial class RepoAllOf :  IEquatable<RepoAllOf>
    {
        ...
        public RepoAllOf(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), string domCcy = default(string), string accrualBasis = default(string), decimal? collateralValue = default(decimal?), decimal? margin = default(decimal?), decimal? repoRate = default(decimal?), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for RepoAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for RepoAllOf and cannot be null");
            }
            else
            {
            ...
            if (domCcy == null)
            {
                throw new InvalidDataException("domCcy is a required property for RepoAllOf and cannot be null");
            }
            else
            {
                this.DomCcy = domCcy;
            ...
            {
                throw new InvalidDataException("accrualBasis is a required property for RepoAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("collateralValue is a required property for RepoAllOf and cannot be null");
            }
            else
            {
            ...
            if (margin == null)
            {
                throw new InvalidDataException("margin is a required property for RepoAllOf and cannot be null");
            }
            else
            {
                this.Margin = margin;
            ...
            if (repoRate == null)
            {
                throw new InvalidDataException("repoRate is a required property for RepoAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instrumentType is a required property for RepoAllOf and cannot be null");
            }
            else
            {
