...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LusidInstrumentDefinition :  IEquatable<LusidInstrumentDefinition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LusidInstrumentDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LusidInstrumentDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LusidInstrumentDefinition" /> class.
        /// </summary>
        ...
        public LusidInstrumentDefinition(string name = default(string), Dictionary<string, InstrumentIdValue> identifiers = default(Dictionary<string, InstrumentIdValue>), List<Property> properties = default(List<Property>), LusidInstrument definition = default(LusidInstrument))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for LusidInstrumentDefinition and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (identifiers == null)
            {
                throw new InvalidDataException("identifiers is a required property for LusidInstrumentDefinition and cannot be null");
            }
            else
            {
            ...
            if (definition == null)
            {
                throw new InvalidDataException("definition is a required property for LusidInstrumentDefinition and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as LusidInstrumentDefinition);
        }

        /// <summary>
        /// Returns true if LusidInstrumentDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of LusidInstrumentDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LusidInstrumentDefinition input)
        {
            if (input == null)
                return false;
