...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ShareClassBreakdown : IEquatable<ShareClassBreakdown>
    {
        /// <summary>
        ...
        public ShareClassBreakdown(Dictionary<string, ShareClassAmount> backOut = default(Dictionary<string, ShareClassAmount>), ShareClassDealingBreakdown dealing = default(ShareClassDealingBreakdown), ShareClassPnlBreakdown pnL = default(ShareClassPnlBreakdown), MultiCurrencyAmounts gav = default(MultiCurrencyAmounts), Dictionary<string, FeeAccrual> fees = default(Dictionary<string, FeeAccrual>), MultiCurrencyAmounts nav = default(MultiCurrencyAmounts), UnitisationData unitisation = default(UnitisationData), Dictionary<string, ShareClassAmount> miscellaneous = default(Dictionary<string, ShareClassAmount>), decimal shareClassToFundFxRate = default(decimal), decimal capitalRatio = default(decimal), PreviousShareClassBreakdown previousShareClassBreakdown = default(PreviousShareClassBreakdown))
        {
            ...
            this.BackOut = backOut ?? throw new ArgumentNullException("backOut is a required property for ShareClassBreakdown and cannot be null");
            // to ensure "dealing" is required (not null)
            this.Dealing = dealing ?? throw new ArgumentNullException("dealing is a required property for ShareClassBreakdown and cannot be null");
            // to ensure "pnL" is required (not null)
            this.PnL = pnL ?? throw new ArgumentNullException("pnL is a required property for ShareClassBreakdown and cannot be null");
            // to ensure "gav" is required (not null)
            this.Gav = gav ?? throw new ArgumentNullException("gav is a required property for ShareClassBreakdown and cannot be null");
            // to ensure "fees" is required (not null)
            this.Fees = fees ?? throw new ArgumentNullException("fees is a required property for ShareClassBreakdown and cannot be null");
            // to ensure "nav" is required (not null)
            this.Nav = nav ?? throw new ArgumentNullException("nav is a required property for ShareClassBreakdown and cannot be null");
            ...
            this.PreviousShareClassBreakdown = previousShareClassBreakdown ?? throw new ArgumentNullException("previousShareClassBreakdown is a required property for ShareClassBreakdown and cannot be null");
        ...
        /// Gets or Sets Gav
        /// </summary>
        [DataMember(Name = "gav", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "previousShareClassBreakdown", IsRequired = true, EmitDefaultValue = false)]
