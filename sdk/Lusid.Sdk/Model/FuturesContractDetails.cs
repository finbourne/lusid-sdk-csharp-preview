...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FuturesContractDetails :  IEquatable<FuturesContractDetails>
    {
        ...
        /// <param name="convention">The available values are: Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActAct, ActualActual, ActActIsda, ActActIsma, ActActIcma, Invalid (required).</param>
        ...
        public FuturesContractDetails(string domCcy = default(string), string contractCode = default(string), string contractMonth = default(string), decimal? contractSize = default(decimal?), ConventionEnum convention = default(ConventionEnum), string country = default(string), string description = default(string), string exchangeCode = default(string), string exchangeName = default(string), decimal? tickerStep = default(decimal?), decimal? unitValue = default(decimal?))
        {
