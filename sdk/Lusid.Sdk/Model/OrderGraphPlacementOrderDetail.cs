...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderGraphPlacementOrderDetail")]
    public partial class OrderGraphPlacementOrderDetail : IEquatable<OrderGraphPlacementOrderDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderGraphPlacementOrderDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderGraphPlacementOrderDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderGraphPlacementOrderDetail" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        public OrderGraphPlacementOrderDetail(ResourceId id = default(ResourceId))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for OrderGraphPlacementOrderDetail and cannot be null");
        }
        ...
        {
            return this.Equals(input as OrderGraphPlacementOrderDetail);
        }

        /// <summary>
        /// Returns true if OrderGraphPlacementOrderDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderGraphPlacementOrderDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderGraphPlacementOrderDetail input)
        {
            if (input == null)
                return false;
