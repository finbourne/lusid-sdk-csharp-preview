...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DataType : IEquatable<DataType>
    {
        ...
        public DataType(TypeValueRangeEnum typeValueRange = default(TypeValueRangeEnum), ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), ValueTypeEnum valueType = default(ValueTypeEnum), List<string> acceptableValues = default(List<string>), UnitSchemaEnum? unitSchema = default(UnitSchemaEnum?), List<IUnitDefinitionDto> acceptableUnits = default(List<IUnitDefinitionDto>), ReferenceData referenceData = default(ReferenceData), Version version = default(Version), string href = default(string), List<Link> links = default(List<Link>))
        {
