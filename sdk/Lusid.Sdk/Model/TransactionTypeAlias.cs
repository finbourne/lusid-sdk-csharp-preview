...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionTypeAlias : IEquatable<TransactionTypeAlias>
    {
        /// <summary>
        ...
        public TransactionTypeAlias(string type = default(string), string description = default(string), string transactionClass = default(string), string transactionRoles = default(string), bool isDefault = default(bool))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for TransactionTypeAlias and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for TransactionTypeAlias and cannot be null");
            // to ensure "transactionClass" is required (not null)
            this.TransactionClass = transactionClass ?? throw new ArgumentNullException("transactionClass is a required property for TransactionTypeAlias and cannot be null");
            // to ensure "transactionRoles" is required (not null)
            this.TransactionRoles = transactionRoles ?? throw new ArgumentNullException("transactionRoles is a required property for TransactionTypeAlias and cannot be null");
