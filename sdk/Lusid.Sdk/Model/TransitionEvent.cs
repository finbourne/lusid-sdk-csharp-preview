...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransitionEvent : InstrumentEvent, IEquatable<TransitionEvent>
    {
        /// <summary>
        ...
        /// <param name="instrumentEventType">The Type of Event. The available values are: TransitionEvent, InternalEvent, CouponEvent, OpenEvent, CloseEvent (required) (default to &quot;TransitionEvent&quot;).</param>
        public TransitionEvent(DateTimeOffset announcementDate = default(DateTimeOffset), DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset recordDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), List<CorporateActionTransitionRequest> transitions = default(List<CorporateActionTransitionRequest>), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base(instrumentEventType)
        {
