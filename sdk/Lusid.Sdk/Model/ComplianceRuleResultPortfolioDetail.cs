...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceRuleResultPortfolioDetail : IEquatable<ComplianceRuleResultPortfolioDetail>
    {
        /// <summary>
        ...
        public ComplianceRuleResultPortfolioDetail(ResourceId id = default(ResourceId), string name = default(string))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ComplianceRuleResultPortfolioDetail and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ComplianceRuleResultPortfolioDetail and cannot be null");
        }
