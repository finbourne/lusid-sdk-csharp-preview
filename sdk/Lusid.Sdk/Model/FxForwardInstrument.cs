...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardInstrument :  IEquatable<FxForwardInstrument>
    {
        ...
        /// <param name="isNdf">Is the contract an Fx-Forward of \&quot;Non-Deliverable\&quot; type, meaning a single payment in the domestic currency based on  the change in fx-rate vs  a reference rate is used. (required).</param>
        /// <param name="fixingDate">The fixing date. Its presence determines the NDF status of the instrument. (required).</param>
        ...
        /// <param name="refSpotRate">The reference Fx Spot rate for currency pair Foreign-Domestic that was seen on the trade start date (time). (required).</param>
        ...
        public FxForwardInstrument(double? domAmount = default(double?), double? fgnAmount = default(double?), bool? isNdf = default(bool?), DateTimeOffset? fixingDate = default(DateTimeOffset?), string fgnCcy = default(string), double? refSpotRate = default(double?), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), string domCcy = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            // to ensure "isNdf" is required (not null)
            if (isNdf == null)
            {
                throw new InvalidDataException("isNdf is a required property for FxForwardInstrument and cannot be null");
            }
            else
            {
                this.IsNdf = isNdf;
            ...
            if (fixingDate == null)
            {
                throw new InvalidDataException("fixingDate is a required property for FxForwardInstrument and cannot be null");
            }
            else
            {
            ...
            // to ensure "refSpotRate" is required (not null)
            if (refSpotRate == null)
            {
                throw new InvalidDataException("refSpotRate is a required property for FxForwardInstrument and cannot be null");
            }
            else
            {
