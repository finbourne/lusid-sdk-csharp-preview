...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BatchUpsertInstrumentPropertiesResponse : IEquatable<BatchUpsertInstrumentPropertiesResponse>
    {
        /// <summary>
        ...
        public BatchUpsertInstrumentPropertiesResponse(Dictionary<string, List<Property>> values = default(Dictionary<string, List<Property>>), Dictionary<string, ErrorDetail> failed = default(Dictionary<string, ErrorDetail>), DateTimeOffset asAtDate = default(DateTimeOffset), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for BatchUpsertInstrumentPropertiesResponse and cannot be null");
            // to ensure "failed" is required (not null)
            this.Failed = failed ?? throw new ArgumentNullException("failed is a required property for BatchUpsertInstrumentPropertiesResponse and cannot be null");
