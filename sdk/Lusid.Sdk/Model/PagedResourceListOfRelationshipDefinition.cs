...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfRelationshipDefinition : IEquatable<PagedResourceListOfRelationshipDefinition>
    {
        /// <summary>
        ...
        public PagedResourceListOfRelationshipDefinition(string nextPage = default(string), string previousPage = default(string), List<RelationshipDefinition> values = default(List<RelationshipDefinition>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfRelationshipDefinition and cannot be null");
