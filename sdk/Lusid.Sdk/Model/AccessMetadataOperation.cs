...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AccessMetadataOperation : IEquatable<AccessMetadataOperation>
    {
        ...
        public AccessMetadataOperation(List<AccessMetadataValue> value = default(List<AccessMetadataValue>), string path = default(string), OpEnum op = default(OpEnum), string from = default(string))
        {
            ...
            this.Value = value ?? throw new ArgumentNullException("value is a required property for AccessMetadataOperation and cannot be null");
            // to ensure "path" is required (not null)
            this.Path = path ?? throw new ArgumentNullException("path is a required property for AccessMetadataOperation and cannot be null");
            this.Op = op;
            this.From = from;
        }
