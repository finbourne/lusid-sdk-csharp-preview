...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SwapInstrument :  IEquatable<SwapInstrument>
    {
        /// <summary>
        ...
        public enum NotionalExchangeEnum
        {
            /// <summary>
        ...
        /// </summary>
        /// <value>True notional exchange type.</value>
        [DataMember(Name="notionalExchange", EmitDefaultValue=false)]
        public NotionalExchangeEnum NotionalExchange { get; set; }
        /// <summary>
        ...
        public SwapInstrument(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), List<Leg> legs = default(List<Leg>), double? notional = default(double?), bool? isAmortizing = default(bool?), NotionalExchangeEnum notionalExchange = default(NotionalExchangeEnum), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            // to ensure "notionalExchange" is required (not null)
            if (notionalExchange == null)
            {
                throw new InvalidDataException("notionalExchange is a required property for SwapInstrument and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instrumentType is a required property for SwapInstrument and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NotionalExchange: ").Append(NotionalExchange).Append("\n");
        ...
        public bool Equals(SwapInstrument input)
        {
            ...
            return 
                ...
                (
                    this.NotionalExchange == input.NotionalExchange ||
                    (this.NotionalExchange != null &&
                    this.NotionalExchange.Equals(input.NotionalExchange))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NotionalExchange != null)
                    hashCode = hashCode * 59 + this.NotionalExchange.GetHashCode();
