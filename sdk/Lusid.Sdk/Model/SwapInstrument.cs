...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SwapInstrument : LusidInstrument,  IEquatable<SwapInstrument>
    {
        ...
        public SwapInstrument(DateTimeOffset? maturityDate = default(DateTimeOffset?), DateTimeOffset? startDate = default(DateTimeOffset?), List<InstrumentLeg> legs = default(List<InstrumentLeg>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
