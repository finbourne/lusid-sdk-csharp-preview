...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceRuleResult : IEquatable<ComplianceRuleResult>
    {
        /// <summary>
        ...
        public ComplianceRuleResult(string ruleId = default(string), string ruleName = default(string), string ruleDescription = default(string), ResourceId portfolio = default(ResourceId), bool passed = default(bool), decimal resultValue = default(decimal), string ruleInformationMatch = default(string), string ruleInformationKey = default(string), int ruleLowerLimit = default(int), int ruleUpperLimit = default(int))
        {
            // to ensure "ruleId" is required (not null)
            this.RuleId = ruleId ?? throw new ArgumentNullException("ruleId is a required property for ComplianceRuleResult and cannot be null");
            // to ensure "ruleName" is required (not null)
            this.RuleName = ruleName ?? throw new ArgumentNullException("ruleName is a required property for ComplianceRuleResult and cannot be null");
            // to ensure "ruleDescription" is required (not null)
            this.RuleDescription = ruleDescription ?? throw new ArgumentNullException("ruleDescription is a required property for ComplianceRuleResult and cannot be null");
            // to ensure "portfolio" is required (not null)
            this.Portfolio = portfolio ?? throw new ArgumentNullException("portfolio is a required property for ComplianceRuleResult and cannot be null");
            this.Passed = passed;
            this.ResultValue = resultValue;
            // to ensure "ruleInformationMatch" is required (not null)
            this.RuleInformationMatch = ruleInformationMatch ?? throw new ArgumentNullException("ruleInformationMatch is a required property for ComplianceRuleResult and cannot be null");
            // to ensure "ruleInformationKey" is required (not null)
            this.RuleInformationKey = ruleInformationKey ?? throw new ArgumentNullException("ruleInformationKey is a required property for ComplianceRuleResult and cannot be null");
        ...
        [DataMember(Name = "ruleInformationMatch", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "ruleInformationKey", IsRequired = true, EmitDefaultValue = false)]
        ...
        public int RuleLowerLimit { get; set; }
        ...
        public int RuleUpperLimit { get; set; }
