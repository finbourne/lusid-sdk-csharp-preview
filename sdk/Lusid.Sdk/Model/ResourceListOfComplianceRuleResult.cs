...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfComplianceRuleResult : IEquatable<ResourceListOfComplianceRuleResult>
    {
        /// <summary>
        ...
        public ResourceListOfComplianceRuleResult(List<ComplianceRuleResult> values = default(List<ComplianceRuleResult>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfComplianceRuleResult and cannot be null");
            this.Href = href;
            this.Links = links;
