...
namespace Lusid.Sdk.Model
{
    ...
    /// FeeProperties
    /// </summary>
    [DataContract(Name = "FeeProperties")]
    public partial class FeeProperties : IEquatable<FeeProperties>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeProperties" /> class.
        /// </summary>
        /// <param name="href">The specific Uniform Resource Identifier (URI) for this resource at the requested effective and asAt datetime..</param>
        /// <param name="properties">The Fee properties. These will be from the &#39;Fee&#39; domain..</param>
        /// <param name="version">version.</param>
        /// <param name="links">Collection of links..</param>
        public FeeProperties(string href = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            this.Href = href;
        ...
        {
            return this.Equals(input as FeeProperties);
        }

        /// <summary>
        /// Returns true if FeeProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of FeeProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeeProperties input)
        {
            if (input == null)
                return false;
