...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfCustodianAccount : IEquatable<PagedResourceListOfCustodianAccount>
    {
        /// <summary>
        ...
        public PagedResourceListOfCustodianAccount(string nextPage = default(string), string previousPage = default(string), List<CustodianAccount> values = default(List<CustodianAccount>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfCustodianAccount and cannot be null");
