...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfGetIndexConventionResponse :  IEquatable<ResourceListOfGetIndexConventionResponse>
    {
        /// <summary>
        ...
        public ResourceListOfGetIndexConventionResponse(List<GetIndexConventionResponse> values = default(List<GetIndexConventionResponse>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfGetIndexConventionResponse and cannot be null");
            }
            else
            {
                this.Values = values;
