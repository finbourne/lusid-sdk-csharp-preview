...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EconomicDependencyWithComplexMarketData : IEquatable<EconomicDependencyWithComplexMarketData>
    {
        /// <summary>
        ...
        public EconomicDependencyWithComplexMarketData(EconomicDependency economicDependency = default(EconomicDependency), ComplexMarketData complexMarketData = default(ComplexMarketData))
        {
            ...
            this.EconomicDependency = economicDependency ?? throw new ArgumentNullException("economicDependency is a required property for EconomicDependencyWithComplexMarketData and cannot be null");
            // to ensure "complexMarketData" is required (not null)
            this.ComplexMarketData = complexMarketData ?? throw new ArgumentNullException("complexMarketData is a required property for EconomicDependencyWithComplexMarketData and cannot be null");
        }

        /// <summary>
        /// Gets or Sets EconomicDependency
        /// </summary>
        [DataMember(Name = "economicDependency", IsRequired = true, EmitDefaultValue = false)]
        public EconomicDependency EconomicDependency { get; set; }

        /// <summary>
        /// Gets or Sets ComplexMarketData
        /// </summary>
        [DataMember(Name = "complexMarketData", IsRequired = true, EmitDefaultValue = false)]
