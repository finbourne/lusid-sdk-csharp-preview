...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FeeTypeRequest : IEquatable<FeeTypeRequest>
    {
        /// <summary>
        ...
        public FeeTypeRequest(string code = default(string), string displayName = default(string), string description = default(string), List<ComponentTransaction> componentTransactions = default(List<ComponentTransaction>))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for FeeTypeRequest and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for FeeTypeRequest and cannot be null");
            // to ensure "componentTransactions" is required (not null)
            this.ComponentTransactions = componentTransactions ?? throw new ArgumentNullException("componentTransactions is a required property for FeeTypeRequest and cannot be null");
