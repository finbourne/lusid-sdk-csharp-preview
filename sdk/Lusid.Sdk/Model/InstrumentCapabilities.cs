...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentCapabilities : IEquatable<InstrumentCapabilities>
    {
        ...
        public InstrumentCapabilities(string instrumentId = default(string), string model = default(string), Dictionary<string, string> features = default(Dictionary<string, string>), List<string> supportedAddresses = default(List<string>), List<EconomicDependency> economicDependencies = default(List<EconomicDependency>), List<Link> links = default(List<Link>))
        {
