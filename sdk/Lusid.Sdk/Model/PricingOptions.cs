...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PricingOptions :  IEquatable<PricingOptions>
    {
        ...
        public PricingOptions(ModelSelection modelSelection = default(ModelSelection), bool? useInstrumentTypeToDeterminePricer = default(bool?), bool? allowAnyInstrumentsWithSecUidToPriceOffLookup = default(bool?), bool? allowPartiallySuccessfulEvaluation = default(bool?), bool? produceSeparateResultForLinearOtcLegs = default(bool?), bool? enableUseOfCachedUnitResults = default(bool?), bool? windowValuationOnInstrumentStartEnd = default(bool?))
        {
