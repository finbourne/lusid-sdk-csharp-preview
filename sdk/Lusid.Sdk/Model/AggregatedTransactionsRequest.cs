...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AggregatedTransactionsRequest : IEquatable<AggregatedTransactionsRequest>
    {
        /// <summary>
        ...
        public AggregatedTransactionsRequest(DateTimeOffset fromTransactionDate = default(DateTimeOffset), DateTimeOffset toTransactionDate = default(DateTimeOffset), ResourceId portfolioId = default(ResourceId), DateTimeOffset? asAt = default(DateTimeOffset?), List<AggregateSpec> metrics = default(List<AggregateSpec>), List<string> groupBy = default(List<string>), List<PropertyFilter> filters = default(List<PropertyFilter>), List<OrderBySpec> sort = default(List<OrderBySpec>))
        {
            ...
            this.PortfolioId = portfolioId ?? throw new ArgumentNullException("portfolioId is a required property for AggregatedTransactionsRequest and cannot be null");
            // to ensure "metrics" is required (not null)
            this.Metrics = metrics ?? throw new ArgumentNullException("metrics is a required property for AggregatedTransactionsRequest and cannot be null");
            this.AsAt = asAt;
        ...
        /// </summary>
        [DataMember(Name = "fromTransactionDate", IsRequired = true, EmitDefaultValue = false)]
        public DateTimeOffset FromTransactionDate { get; set; }

        /// <summary>
        /// Gets or Sets ToTransactionDate
        /// </summary>
        [DataMember(Name = "toTransactionDate", IsRequired = true, EmitDefaultValue = false)]
