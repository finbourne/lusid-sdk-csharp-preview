...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplexBond : LusidInstrument, IEquatable<ComplexBond>
    {
        ...
        public ComplexBond(Dictionary<string, string> identifiers = default(Dictionary<string, string>), string calculationType = default(string), List<Schedule> schedules = default(List<Schedule>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
