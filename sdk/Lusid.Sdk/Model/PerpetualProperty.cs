...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PerpetualProperty :  IEquatable<PerpetualProperty>
    {
        ...
        public PerpetualProperty(string key = default(string), Object value = default(Object), string unit = default(string))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new InvalidDataException("key is a required property for PerpetualProperty and cannot be null");
            }
            else
            {
                this.Key = key;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for PerpetualProperty and cannot be null");
            }
            else
            {
                this.Value = value;
