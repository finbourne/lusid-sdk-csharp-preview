...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Dialect : IEquatable<Dialect>
    {
        ...
        public Dialect(DialectId id = default(DialectId), DialectSchema schema = default(DialectSchema), Version version = default(Version))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Dialect and cannot be null");
            // to ensure "schema" is required (not null)
            this.Schema = schema ?? throw new ArgumentNullException("schema is a required property for Dialect and cannot be null");
