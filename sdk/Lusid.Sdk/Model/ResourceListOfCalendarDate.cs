...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfCalendarDate :  IEquatable<ResourceListOfCalendarDate>
    {
        ...
        public ResourceListOfCalendarDate(List<CalendarDate> values = default(List<CalendarDate>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfCalendarDate and cannot be null");
            }
            else
            {
                this.Values = values;
