...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BookTransactionsResponse")]
    public partial class BookTransactionsResponse : IEquatable<BookTransactionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BookTransactionsResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BookTransactionsResponse);
        }

        /// <summary>
        /// Returns true if BookTransactionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BookTransactionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BookTransactionsResponse input)
        {
            if (input == null)
                return false;
