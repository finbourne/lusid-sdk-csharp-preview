...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertComplexMarketDataRequest : IEquatable<UpsertComplexMarketDataRequest>
    {
        /// <summary>
        ...
        public UpsertComplexMarketDataRequest(ComplexMarketDataId marketDataId = default(ComplexMarketDataId), ComplexMarketData marketData = default(ComplexMarketData))
        {
            ...
            this.MarketDataId = marketDataId ?? throw new ArgumentNullException("marketDataId is a required property for UpsertComplexMarketDataRequest and cannot be null");
            // to ensure "marketData" is required (not null)
            this.MarketData = marketData ?? throw new ArgumentNullException("marketData is a required property for UpsertComplexMarketDataRequest and cannot be null");
        }
