...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertComplexMarketDataRequest :  IEquatable<UpsertComplexMarketDataRequest>
    {
        ...
        public UpsertComplexMarketDataRequest(ComplexMarketDataId marketDataId = default(ComplexMarketDataId), ComplexMarketData marketData = default(ComplexMarketData))
        {
            ...
            {
                throw new InvalidDataException("marketDataId is a required property for UpsertComplexMarketDataRequest and cannot be null");
            }
            else
            {
            ...
            if (marketData == null)
            {
                throw new InvalidDataException("marketData is a required property for UpsertComplexMarketDataRequest and cannot be null");
            }
            else
            {
