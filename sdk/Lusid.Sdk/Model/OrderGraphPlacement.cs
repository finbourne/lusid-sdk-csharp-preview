...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OrderGraphPlacement : IEquatable<OrderGraphPlacement>
    {
        /// <summary>
        ...
        /// <param name="orderIds">Identifiers for all orders in the block - DEPRECATED: see Ordered. (required).</param>
        /// <param name="allocationIds">Identifiers for all allocations relating to this placement - DEPRECATED: see Allocated. (required).</param>
        /// <param name="executionIds">Identifiers of all executions against this placement - DEPRECATED: see Executed. (required).</param>
        ...
        public OrderGraphPlacement(Placement placement = default(Placement), ResourceId blockId = default(ResourceId), List<ResourceId> orderIds = default(List<ResourceId>), List<ResourceId> allocationIds = default(List<ResourceId>), List<ResourceId> executionIds = default(List<ResourceId>), OrderGraphPlacementOrderSynopsis ordered = default(OrderGraphPlacementOrderSynopsis), OrderGraphPlacementPlacementSynopsis placed = default(OrderGraphPlacementPlacementSynopsis), OrderGraphPlacementExecutionSynopsis executed = default(OrderGraphPlacementExecutionSynopsis), OrderGraphPlacementAllocationSynopsis allocated = default(OrderGraphPlacementAllocationSynopsis), string derivedState = default(string), decimal? calculatedAveragePrice = default(decimal?))
        {
            // to ensure "placement" is required (not null)
            this.Placement = placement ?? throw new ArgumentNullException("placement is a required property for OrderGraphPlacement and cannot be null");
            // to ensure "blockId" is required (not null)
            this.BlockId = blockId ?? throw new ArgumentNullException("blockId is a required property for OrderGraphPlacement and cannot be null");
            // to ensure "orderIds" is required (not null)
            this.OrderIds = orderIds ?? throw new ArgumentNullException("orderIds is a required property for OrderGraphPlacement and cannot be null");
            // to ensure "allocationIds" is required (not null)
            this.AllocationIds = allocationIds ?? throw new ArgumentNullException("allocationIds is a required property for OrderGraphPlacement and cannot be null");
            // to ensure "executionIds" is required (not null)
            this.ExecutionIds = executionIds ?? throw new ArgumentNullException("executionIds is a required property for OrderGraphPlacement and cannot be null");
            // to ensure "ordered" is required (not null)
            this.Ordered = ordered ?? throw new ArgumentNullException("ordered is a required property for OrderGraphPlacement and cannot be null");
            // to ensure "placed" is required (not null)
            this.Placed = placed ?? throw new ArgumentNullException("placed is a required property for OrderGraphPlacement and cannot be null");
            // to ensure "executed" is required (not null)
            this.Executed = executed ?? throw new ArgumentNullException("executed is a required property for OrderGraphPlacement and cannot be null");
            // to ensure "allocated" is required (not null)
            this.Allocated = allocated ?? throw new ArgumentNullException("allocated is a required property for OrderGraphPlacement and cannot be null");
            // to ensure "derivedState" is required (not null)
            this.DerivedState = derivedState ?? throw new ArgumentNullException("derivedState is a required property for OrderGraphPlacement and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "placement", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Identifiers for all orders in the block - DEPRECATED: see Ordered.</value>
        ...
        /// </summary>
        /// <value>Identifiers for all allocations relating to this placement - DEPRECATED: see Allocated.</value>
        ...
        /// </summary>
        /// <value>Identifiers of all executions against this placement - DEPRECATED: see Executed.</value>
