...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OrderGraphPlacement : IEquatable<OrderGraphPlacement>
    {
        ...
        public OrderGraphPlacement(Placement placement = default(Placement), ResourceId blockId = default(ResourceId), List<ResourceId> orderIds = default(List<ResourceId>), List<ResourceId> allocationIds = default(List<ResourceId>), List<ResourceId> executionIds = default(List<ResourceId>), OrderGraphSynopsis placed = default(OrderGraphSynopsis), OrderGraphSynopsis allocated = default(OrderGraphSynopsis), OrderGraphSynopsis executed = default(OrderGraphSynopsis), string derivedState = default(string))
        {
