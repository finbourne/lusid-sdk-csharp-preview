...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfSideDefinition : IEquatable<ResourceListOfSideDefinition>
    {
        /// <summary>
        ...
        public ResourceListOfSideDefinition(List<SideDefinition> values = default(List<SideDefinition>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfSideDefinition and cannot be null");
            this.Href = href;
            this.Links = links;
