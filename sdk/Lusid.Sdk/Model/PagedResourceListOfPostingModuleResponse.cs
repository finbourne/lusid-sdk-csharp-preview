...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfPostingModuleResponse : IEquatable<PagedResourceListOfPostingModuleResponse>
    {
        /// <summary>
        ...
        public PagedResourceListOfPostingModuleResponse(string nextPage = default(string), string previousPage = default(string), List<PostingModuleResponse> values = default(List<PostingModuleResponse>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfPostingModuleResponse and cannot be null");
