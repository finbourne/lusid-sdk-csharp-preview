...
namespace Lusid.Sdk.Model
{
    ...
    public partial class VendorDependencyAllOf : IEquatable<VendorDependencyAllOf>
    {
        /// <summary>
        ...
        public VendorDependencyAllOf(string vendorName = default(string), List<string> vendorPath = default(List<string>), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum))
        {
            ...
            this.VendorName = vendorName ?? throw new ArgumentNullException("vendorName is a required property for VendorDependencyAllOf and cannot be null");
            // to ensure "vendorPath" is required (not null)
            this.VendorPath = vendorPath ?? throw new ArgumentNullException("vendorPath is a required property for VendorDependencyAllOf and cannot be null");
            this.Date = date;
