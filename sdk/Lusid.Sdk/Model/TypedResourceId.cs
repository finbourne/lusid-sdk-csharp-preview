...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TypedResourceId :  IEquatable<TypedResourceId>
    {
        ...
        public TypedResourceId(string idTypeScope = default(string), string idTypeCode = default(string), string code = default(string))
        {
            ...
            if (idTypeScope == null)
            {
                throw new InvalidDataException("idTypeScope is a required property for TypedResourceId and cannot be null");
            }
            else
            {
            ...
            if (idTypeCode == null)
            {
                throw new InvalidDataException("idTypeCode is a required property for TypedResourceId and cannot be null");
            }
            else
            {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for TypedResourceId and cannot be null");
            }
            else
            {
                this.Code = code;
        ...
        [DataMember(Name="idTypeScope", EmitDefaultValue=false)]
        ...
        [DataMember(Name="idTypeCode", EmitDefaultValue=false)]
