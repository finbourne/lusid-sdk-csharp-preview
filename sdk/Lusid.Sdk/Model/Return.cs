...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Return :  IEquatable<Return>
    {
        ...
        /// <param name="returnValue">The return number. (required).</param>
        /// <param name="marketValue">The market value. (required).</param>
        /// <param name="period">Show the returns on a Daily or Monthly period..</param>
        public Return(DateTimeOffset? effectiveAt = default(DateTimeOffset?), decimal? returnValue = default(decimal?), decimal? marketValue = default(decimal?), string period = default(string))
        {
            // to ensure "effectiveAt" is required (not null)
            if (effectiveAt == null)
            {
                throw new InvalidDataException("effectiveAt is a required property for Return and cannot be null");
            }
            else
            {
            ...
            if (returnValue == null)
            {
                throw new InvalidDataException("returnValue is a required property for Return and cannot be null");
            }
            else
            {
            ...
            if (marketValue == null)
            {
                throw new InvalidDataException("marketValue is a required property for Return and cannot be null");
            }
            else
            {
