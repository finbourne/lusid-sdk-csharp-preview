...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SideDefinitionRequest : IEquatable<SideDefinitionRequest>
    {
        /// <summary>
        ...
        public SideDefinitionRequest(string security = default(string), string currency = default(string), string rate = default(string), string units = default(string), string amount = default(string))
        {
            // to ensure "security" is required (not null)
            this.Security = security ?? throw new ArgumentNullException("security is a required property for SideDefinitionRequest and cannot be null");
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for SideDefinitionRequest and cannot be null");
            // to ensure "rate" is required (not null)
            this.Rate = rate ?? throw new ArgumentNullException("rate is a required property for SideDefinitionRequest and cannot be null");
            // to ensure "units" is required (not null)
            this.Units = units ?? throw new ArgumentNullException("units is a required property for SideDefinitionRequest and cannot be null");
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for SideDefinitionRequest and cannot be null");
        }
