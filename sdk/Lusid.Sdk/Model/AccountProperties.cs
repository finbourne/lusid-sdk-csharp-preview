...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AccountProperties : IEquatable<AccountProperties>
    {
        /// <summary>
        ...
        public AccountProperties(string href = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            this.Href = href;
