...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfOrder")]
    public partial class ResourceListOfOrder : IEquatable<ResourceListOfOrder>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfOrder" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfOrder() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfOrder" /> class.
        /// </summary>
        ...
        public ResourceListOfOrder(List<Order> values = default(List<Order>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfOrder and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        {
            return this.Equals(input as ResourceListOfOrder);
        }

        /// <summary>
        /// Returns true if ResourceListOfOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfOrder input)
        {
            if (input == null)
                return false;
