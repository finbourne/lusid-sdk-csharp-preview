...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfOrder :  IEquatable<ResourceListOfOrder>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfOrder(List<Order> values = default(List<Order>), string href = default(string), List<Link> links = default(List<Link>))
        {
