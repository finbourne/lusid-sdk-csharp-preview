...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfOrder :  IEquatable<ResourceListOfOrder>
    {
        ...
        public ResourceListOfOrder(List<Order> values = default(List<Order>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
