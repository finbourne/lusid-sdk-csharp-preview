...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfGetFlowConventionsResponse :  IEquatable<ResourceListOfGetFlowConventionsResponse>
    {
        /// <summary>
        ...
        public ResourceListOfGetFlowConventionsResponse(List<GetFlowConventionsResponse> values = default(List<GetFlowConventionsResponse>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfGetFlowConventionsResponse and cannot be null");
            }
            else
            {
                this.Values = values;
