...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfReconciliation : IEquatable<PagedResourceListOfReconciliation>
    {
        /// <summary>
        ...
        public PagedResourceListOfReconciliation(string nextPage = default(string), string previousPage = default(string), List<Reconciliation> values = default(List<Reconciliation>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfReconciliation and cannot be null");
