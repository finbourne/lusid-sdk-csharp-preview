...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BatchUpdateUserReviewForComparisonResultRequest : IEquatable<BatchUpdateUserReviewForComparisonResultRequest>
    {
        /// <summary>
        ...
        public BatchUpdateUserReviewForComparisonResultRequest(string comparisonResultId = default(string), GroupReconciliationUserReviewAdd userReviewAdd = default(GroupReconciliationUserReviewAdd), GroupReconciliationUserReviewRemove userReviewRemove = default(GroupReconciliationUserReviewRemove))
        {
            ...
            this.ComparisonResultId = comparisonResultId ?? throw new ArgumentNullException("comparisonResultId is a required property for BatchUpdateUserReviewForComparisonResultRequest and cannot be null");
        ...
        [DataMember(Name = "comparisonResultId", IsRequired = true, EmitDefaultValue = false)]
