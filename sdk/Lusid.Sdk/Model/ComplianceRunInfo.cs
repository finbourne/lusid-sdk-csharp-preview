...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceRunInfo : IEquatable<ComplianceRunInfo>
    {
        /// <summary>
        ...
        public ComplianceRunInfo(string runId = default(string), DateTimeOffset instigatedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), string schedule = default(string), bool allRulesPassed = default(bool), DateTimeOffset asAt = default(DateTimeOffset))
        {
            // to ensure "runId" is required (not null)
            this.RunId = runId ?? throw new ArgumentNullException("runId is a required property for ComplianceRunInfo and cannot be null");
            this.InstigatedAt = instigatedAt;
            this.CompletedAt = completedAt;
            // to ensure "schedule" is required (not null)
            this.Schedule = schedule ?? throw new ArgumentNullException("schedule is a required property for ComplianceRunInfo and cannot be null");
        ...
        [DataMember(Name = "instigatedAt", IsRequired = true, EmitDefaultValue = false)]
