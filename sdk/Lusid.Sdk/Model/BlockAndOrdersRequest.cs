...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BlockAndOrdersRequest : IEquatable<BlockAndOrdersRequest>
    {
        /// <summary>
        ...
        public BlockAndOrdersRequest(ResourceId blockId = default(ResourceId), List<BlockedOrderRequest> orders = default(List<BlockedOrderRequest>), Dictionary<string, PerpetualProperty> blockProperties = default(Dictionary<string, PerpetualProperty>), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), string side = default(string), string type = default(string), string timeInForce = default(string), DateTimeOffset date = default(DateTimeOffset), CurrencyAndAmount limitPrice = default(CurrencyAndAmount), CurrencyAndAmount stopPrice = default(CurrencyAndAmount))
        {
            ...
            this.BlockId = blockId ?? throw new ArgumentNullException("blockId is a required property for BlockAndOrdersRequest and cannot be null");
            // to ensure "orders" is required (not null)
            this.Orders = orders ?? throw new ArgumentNullException("orders is a required property for BlockAndOrdersRequest and cannot be null");
            // to ensure "instrumentIdentifiers" is required (not null)
            this.InstrumentIdentifiers = instrumentIdentifiers ?? throw new ArgumentNullException("instrumentIdentifiers is a required property for BlockAndOrdersRequest and cannot be null");
            // to ensure "side" is required (not null)
            this.Side = side ?? throw new ArgumentNullException("side is a required property for BlockAndOrdersRequest and cannot be null");
