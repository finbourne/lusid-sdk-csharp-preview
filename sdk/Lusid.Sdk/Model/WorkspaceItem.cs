...
namespace Lusid.Sdk.Model
{
    ...
    public partial class WorkspaceItem : IEquatable<WorkspaceItem>
    {
        /// <summary>
        ...
        public WorkspaceItem(string type = default(string), int format = default(int), string name = default(string), string description = default(string), string content = default(string), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for WorkspaceItem and cannot be null");
            this.Format = format;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for WorkspaceItem and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for WorkspaceItem and cannot be null");
            // to ensure "content" is required (not null)
            this.Content = content ?? throw new ArgumentNullException("content is a required property for WorkspaceItem and cannot be null");
