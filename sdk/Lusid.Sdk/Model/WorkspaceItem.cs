...
namespace Lusid.Sdk.Model
{
    ...
    public partial class WorkspaceItem : IEquatable<WorkspaceItem>
    {
        ...
        public WorkspaceItem(string type = default(string), int format = default(int), string name = default(string), string description = default(string), Object content = default(Object), Version version = default(Version), List<Link> links = default(List<Link>))
        {
