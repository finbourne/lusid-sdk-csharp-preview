...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IndustryClassificationScheme :  IEquatable<IndustryClassificationScheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IndustryClassificationScheme" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IndustryClassificationScheme() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IndustryClassificationScheme" /> class.
        /// </summary>
        /// <param name="schemeName">The type of the industry classification scheme (TRBC, GICs, ICB) (required).</param>
        /// <param name="schemeId">Within the given scheme, the unique id that identifies this particular classification.  e.g. within \&quot;TRCS\&quot;, 5010202011 identifies \&quot;Oil Exploration \\amp; Production - Onshore\&quot; within the Energy, fossil-fuels and Oil hierarchy. (required).</param>
        /// <param name="economicSector">Various schemes exist to classify the business sector within which a company operates.  They divide it into various categories around business, economic and sub-sectors (e.g. fossil fuels within energy)  Under ICB, TRBC, GICS which economic sector is the counterparty assigned to. This is Lvl 1 of that scheme (coarsest) (required).</param>
        /// <param name="businessSector">Various schemes exist to classify the business sector within which a company operates.  They divide it into various categories around business, economic and sub-sectors (e.g. fossil fuels within energy)  Under ICB, TRBC, GICS which business sector is the counterparty assigned to. This is Lvl 2 of that scheme (2nd coarsest)  e.g. Fossil Fuels within energy. (required).</param>
        /// <param name="industry">Various schemes exist to classify the business sector within which a company operates.  They divide it into various categories around business, economic and sub-sectors (e.g. coal within energy)  Under ICB, TRBC, GICS which business sector is the counterparty assigned to. This is Lvl 3 of that scheme (3rd coarsest)  e.g. Coal or Oil within Fossil Fuels. (required).</param>
        /// <param name="industryActivity">Various schemes exist to classify the business sector within which a company operates.  They divide it into various categories around business, economic and sub-sectors (e.g. coal within energy)  Under ICB, TRBC, GICS which business sector is the counterparty assigned to. This is Lvl 4 of the scheme (finest)  e.g. Petroleum Refining within Oil within Fossil Fuels. (required).</param>
        public IndustryClassificationScheme(string schemeName = default(string), string schemeId = default(string), string economicSector = default(string), string businessSector = default(string), string industry = default(string), string industryActivity = default(string))
        {
            // to ensure "schemeName" is required (not null)
            if (schemeName == null)
            {
                throw new InvalidDataException("schemeName is a required property for IndustryClassificationScheme and cannot be null");
            }
            else
            {
            ...
            if (schemeId == null)
            {
                throw new InvalidDataException("schemeId is a required property for IndustryClassificationScheme and cannot be null");
            }
            else
            {
            ...
            // to ensure "economicSector" is required (not null)
            if (economicSector == null)
            {
                throw new InvalidDataException("economicSector is a required property for IndustryClassificationScheme and cannot be null");
            }
            else
            {
            ...
            // to ensure "businessSector" is required (not null)
            if (businessSector == null)
            {
                throw new InvalidDataException("businessSector is a required property for IndustryClassificationScheme and cannot be null");
            }
            else
            {
            ...
            if (industry == null)
            {
                throw new InvalidDataException("industry is a required property for IndustryClassificationScheme and cannot be null");
            }
            else
            {
            ...
            // to ensure "industryActivity" is required (not null)
            if (industryActivity == null)
            {
                throw new InvalidDataException("industryActivity is a required property for IndustryClassificationScheme and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// The type of the industry classification scheme (TRBC, GICs, ICB)
        /// </summary>
        /// <value>The type of the industry classification scheme (TRBC, GICs, ICB)</value>
        [DataMember(Name="schemeName", EmitDefaultValue=false)]
        public string SchemeName { get; set; }

        /// <summary>
        /// Within the given scheme, the unique id that identifies this particular classification.  e.g. within \&quot;TRCS\&quot;, 5010202011 identifies \&quot;Oil Exploration \\amp; Production - Onshore\&quot; within the Energy, fossil-fuels and Oil hierarchy.
        /// </summary>
        /// <value>Within the given scheme, the unique id that identifies this particular classification.  e.g. within \&quot;TRCS\&quot;, 5010202011 identifies \&quot;Oil Exploration \\amp; Production - Onshore\&quot; within the Energy, fossil-fuels and Oil hierarchy.</value>
        ...
        /// </summary>
        /// <value>Various schemes exist to classify the business sector within which a company operates.  They divide it into various categories around business, economic and sub-sectors (e.g. fossil fuels within energy)  Under ICB, TRBC, GICS which economic sector is the counterparty assigned to. This is Lvl 1 of that scheme (coarsest)</value>
        ...
        /// </summary>
        /// <value>Various schemes exist to classify the business sector within which a company operates.  They divide it into various categories around business, economic and sub-sectors (e.g. fossil fuels within energy)  Under ICB, TRBC, GICS which business sector is the counterparty assigned to. This is Lvl 2 of that scheme (2nd coarsest)  e.g. Fossil Fuels within energy.</value>
        [DataMember(Name="businessSector", EmitDefaultValue=false)]
        public string BusinessSector { get; set; }

        /// <summary>
        /// Various schemes exist to classify the business sector within which a company operates.  They divide it into various categories around business, economic and sub-sectors (e.g. coal within energy)  Under ICB, TRBC, GICS which business sector is the counterparty assigned to. This is Lvl 3 of that scheme (3rd coarsest)  e.g. Coal or Oil within Fossil Fuels.
        /// </summary>
        /// <value>Various schemes exist to classify the business sector within which a company operates.  They divide it into various categories around business, economic and sub-sectors (e.g. coal within energy)  Under ICB, TRBC, GICS which business sector is the counterparty assigned to. This is Lvl 3 of that scheme (3rd coarsest)  e.g. Coal or Oil within Fossil Fuels.</value>
        ...
        /// </summary>
        /// <value>Various schemes exist to classify the business sector within which a company operates.  They divide it into various categories around business, economic and sub-sectors (e.g. coal within energy)  Under ICB, TRBC, GICS which business sector is the counterparty assigned to. This is Lvl 4 of the scheme (finest)  e.g. Petroleum Refining within Oil within Fossil Fuels.</value>
        [DataMember(Name="industryActivity", EmitDefaultValue=false)]
        public string IndustryActivity { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IndustryClassificationScheme {\n");
            ...
            sb.Append("  IndustryActivity: ").Append(IndustryActivity).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as IndustryClassificationScheme);
        }

        /// <summary>
        /// Returns true if IndustryClassificationScheme instances are equal
        /// </summary>
        /// <param name="input">Instance of IndustryClassificationScheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IndustryClassificationScheme input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.BusinessSector == input.BusinessSector ||
                    (this.BusinessSector != null &&
                    this.BusinessSector.Equals(input.BusinessSector))
                ) && 
                (
                ...
                (
                    this.IndustryActivity == input.IndustryActivity ||
                    (this.IndustryActivity != null &&
                    this.IndustryActivity.Equals(input.IndustryActivity))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BusinessSector != null)
                    hashCode = hashCode * 59 + this.BusinessSector.GetHashCode();
                if (this.Industry != null)
                    hashCode = hashCode * 59 + this.Industry.GetHashCode();
                if (this.IndustryActivity != null)
                    hashCode = hashCode * 59 + this.IndustryActivity.GetHashCode();
                return hashCode;
            }
        }
    }
