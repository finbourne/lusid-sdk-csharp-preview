...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfTransactionTemplate : IEquatable<PagedResourceListOfTransactionTemplate>
    {
        /// <summary>
        ...
        public PagedResourceListOfTransactionTemplate(string nextPage = default(string), string previousPage = default(string), List<TransactionTemplate> values = default(List<TransactionTemplate>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfTransactionTemplate and cannot be null");
