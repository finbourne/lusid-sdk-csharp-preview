...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReconciliationLeftRightAddressKeyPair :  IEquatable<ReconciliationLeftRightAddressKeyPair>
    {
        ...
        public ReconciliationLeftRightAddressKeyPair(string left = default(string), string right = default(string))
        {
            ...
            if (left == null)
            {
                throw new InvalidDataException("left is a required property for ReconciliationLeftRightAddressKeyPair and cannot be null");
            }
            else
            {
                this.Left = left;
            ...
            if (right == null)
            {
                throw new InvalidDataException("right is a required property for ReconciliationLeftRightAddressKeyPair and cannot be null");
            }
            else
            {
                this.Right = right;
