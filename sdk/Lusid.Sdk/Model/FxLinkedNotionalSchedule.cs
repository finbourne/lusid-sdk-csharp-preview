...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxLinkedNotionalSchedule : Schedule, IEquatable<FxLinkedNotionalSchedule>
    {
        /// <summary>
        ...
        public FxLinkedNotionalSchedule(FxConventions fxConventions = default(FxConventions), string varyingNotionalCurrency = default(string), RelativeDateOffset varyingNotionalFixingDates = default(RelativeDateOffset), RelativeDateOffset varyingNotionalInterimExchangePaymentDates = default(RelativeDateOffset), ScheduleTypeEnum scheduleType = default(ScheduleTypeEnum)) : base(scheduleType)
        {
            ...
            this.FxConventions = fxConventions ?? throw new ArgumentNullException("fxConventions is a required property for FxLinkedNotionalSchedule and cannot be null");
            // to ensure "varyingNotionalCurrency" is required (not null)
            this.VaryingNotionalCurrency = varyingNotionalCurrency ?? throw new ArgumentNullException("varyingNotionalCurrency is a required property for FxLinkedNotionalSchedule and cannot be null");
            // to ensure "varyingNotionalFixingDates" is required (not null)
            this.VaryingNotionalFixingDates = varyingNotionalFixingDates ?? throw new ArgumentNullException("varyingNotionalFixingDates is a required property for FxLinkedNotionalSchedule and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "fxConventions", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "varyingNotionalCurrency", IsRequired = true, EmitDefaultValue = false)]
        public string VaryingNotionalCurrency { get; set; }

        /// <summary>
        /// Gets or Sets VaryingNotionalFixingDates
        /// </summary>
        [DataMember(Name = "varyingNotionalFixingDates", IsRequired = true, EmitDefaultValue = false)]
