...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceRuleTemplate : IEquatable<ComplianceRuleTemplate>
    {
        /// <summary>
        ...
        public ComplianceRuleTemplate(ResourceId id = default(ResourceId), string description = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), List<ComplianceTemplateVariationDto> variations = default(List<ComplianceTemplateVariationDto>), string href = default(string), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            this.Id = id;
