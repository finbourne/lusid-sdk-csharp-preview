...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Swaption : LusidInstrument,  IEquatable<Swaption>
    {
        ...
        public Swaption(DateTimeOffset? startDate = default(DateTimeOffset?), SwapInstrument swap = default(SwapInstrument), PayOrReceiveFixedEnum payOrReceiveFixed = default(PayOrReceiveFixedEnum), DeliveryMethodEnum deliveryMethod = default(DeliveryMethodEnum), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            {
                throw new InvalidDataException("payOrReceiveFixed is a required property for Swaption and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("deliveryMethod is a required property for Swaption and cannot be null");
            }
            else
            {
