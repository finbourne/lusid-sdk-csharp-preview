...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ExecutionRequest :  IEquatable<ExecutionRequest>
    {
        ...
        public ExecutionRequest(ResourceId id = default(ResourceId), ResourceId placementId = default(ResourceId), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), decimal? quantity = default(decimal?), string state = default(string), string side = default(string), string type = default(string), DateTimeOffset? createdDate = default(DateTimeOffset?), DateTimeOffset? settlementDate = default(DateTimeOffset?), CurrencyAndAmount price = default(CurrencyAndAmount), string settlementCurrency = default(string), decimal? settlementCurrencyFxRate = default(decimal?), string counterparty = default(string))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ExecutionRequest and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (placementId == null)
            {
                throw new InvalidDataException("placementId is a required property for ExecutionRequest and cannot be null");
            }
            else
            {
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for ExecutionRequest and cannot be null");
            }
            else
            {
            ...
            if (state == null)
            {
                throw new InvalidDataException("state is a required property for ExecutionRequest and cannot be null");
            }
            else
            {
                this.State = state;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ExecutionRequest and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (createdDate == null)
            {
                throw new InvalidDataException("createdDate is a required property for ExecutionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("settlementCurrency is a required property for ExecutionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("settlementCurrencyFxRate is a required property for ExecutionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("counterparty is a required property for ExecutionRequest and cannot be null");
            }
            else
            {
