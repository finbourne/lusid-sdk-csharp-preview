...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentEntity : IEquatable<InstrumentEntity>
    {
        /// <summary>
        ...
        public InstrumentEntity(string href = default(string), string entityUniqueId = default(string), int? asAtVersionNumber = default(int?), string status = default(string), DateTimeOffset? asAtDeleted = default(DateTimeOffset?), string userIdDeleted = default(string), string requestIdDeleted = default(string), DateTimeOffset? effectiveAtCreated = default(DateTimeOffset?), Instrument prevailingInstrument = default(Instrument), Instrument deletedInstrument = default(Instrument), string previewedStatus = default(string), Instrument previewedInstrument = default(Instrument), List<Link> links = default(List<Link>))
        {
            ...
            this.Href = href ?? throw new ArgumentNullException("href is a required property for InstrumentEntity and cannot be null");
            // to ensure "entityUniqueId" is required (not null)
            this.EntityUniqueId = entityUniqueId ?? throw new ArgumentNullException("entityUniqueId is a required property for InstrumentEntity and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for InstrumentEntity and cannot be null");
