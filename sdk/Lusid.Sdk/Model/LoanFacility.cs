...
namespace Lusid.Sdk.Model
{
    ...
    public partial class LoanFacility : LusidInstrument, IEquatable<LoanFacility>
    {
        /// <summary>
        ...
        public LoanFacility(DateTimeOffset startDate = default(DateTimeOffset), string domCcy = default(string), string facilityPortfolioScope = default(string), string facilityPortfolioCode = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for LoanFacility and cannot be null");
            // to ensure "facilityPortfolioScope" is required (not null)
            this.FacilityPortfolioScope = facilityPortfolioScope ?? throw new ArgumentNullException("facilityPortfolioScope is a required property for LoanFacility and cannot be null");
            // to ensure "facilityPortfolioCode" is required (not null)
            this.FacilityPortfolioCode = facilityPortfolioCode ?? throw new ArgumentNullException("facilityPortfolioCode is a required property for LoanFacility and cannot be null");
        }
        ...
        [DataMember(Name = "facilityPortfolioScope", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "facilityPortfolioCode", IsRequired = true, EmitDefaultValue = false)]
