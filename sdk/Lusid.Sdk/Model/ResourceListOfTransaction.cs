...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfTransaction : IEquatable<ResourceListOfTransaction>
    {
        /// <summary>
        ...
        public ResourceListOfTransaction(List<Transaction> values = default(List<Transaction>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfTransaction and cannot be null");
            this.Href = href;
            this.Links = links;
