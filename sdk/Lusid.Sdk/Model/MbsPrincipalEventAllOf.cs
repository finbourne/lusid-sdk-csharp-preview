...
{
    /// <summary>
    /// MbsPrincipalEventAllOf
    /// </summary>
    [DataContract(Name = "MbsPrincipalEvent_allOf")]
    public partial class MbsPrincipalEventAllOf : IEquatable<MbsPrincipalEventAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MbsPrincipalEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MbsPrincipalEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MbsPrincipalEventAllOf" /> class.
        /// </summary>
        ...
        public MbsPrincipalEventAllOf(DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), decimal principalPerUnit = default(decimal), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            this.ExDate = exDate;
            this.PaymentDate = paymentDate;
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for MbsPrincipalEventAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MbsPrincipalEventAllOf {\n");
        ...
        {
            return this.Equals(input as MbsPrincipalEventAllOf);
        }

        /// <summary>
        /// Returns true if MbsPrincipalEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MbsPrincipalEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MbsPrincipalEventAllOf input)
        {
            if (input == null)
                return false;
