...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossCurrencySwapAllOf :  IEquatable<CrossCurrencySwapAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossCurrencySwapAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrossCurrencySwapAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossCurrencySwapAllOf" /> class.
        /// </summary>
        ...
        public CrossCurrencySwapAllOf(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), List<InstrumentLeg> legs = default(List<InstrumentLeg>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            // to ensure "startDate" is required (not null)
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for CrossCurrencySwapAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for CrossCurrencySwapAllOf and cannot be null");
            }
            else
            {
            ...
            if (legs == null)
            {
                throw new InvalidDataException("legs is a required property for CrossCurrencySwapAllOf and cannot be null");
            }
            else
            {
                this.Legs = legs;
            ...
            {
                throw new InvalidDataException("instrumentType is a required property for CrossCurrencySwapAllOf and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrossCurrencySwapAllOf {\n");
        ...
        {
            return this.Equals(input as CrossCurrencySwapAllOf);
        }

        /// <summary>
        /// Returns true if CrossCurrencySwapAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossCurrencySwapAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossCurrencySwapAllOf input)
        {
            if (input == null)
                return false;
