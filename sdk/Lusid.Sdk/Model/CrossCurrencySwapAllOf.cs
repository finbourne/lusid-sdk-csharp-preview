...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CrossCurrencySwap_allOf")]
    public partial class CrossCurrencySwapAllOf : IEquatable<CrossCurrencySwapAllOf>
    {
        ...
        public CrossCurrencySwapAllOf(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), List<InstrumentLeg> legs = default(List<InstrumentLeg>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.Legs = legs ?? throw new ArgumentNullException("legs is a required property for CrossCurrencySwapAllOf and cannot be null");
