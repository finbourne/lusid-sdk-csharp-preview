...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfDiaryEntry : IEquatable<PagedResourceListOfDiaryEntry>
    {
        /// <summary>
        ...
        public PagedResourceListOfDiaryEntry(string nextPage = default(string), string previousPage = default(string), List<DiaryEntry> values = default(List<DiaryEntry>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfDiaryEntry and cannot be null");
