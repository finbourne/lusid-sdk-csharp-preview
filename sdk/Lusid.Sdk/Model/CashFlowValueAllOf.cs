...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashFlowValueAllOf : IEquatable<CashFlowValueAllOf>
    {
        /// <summary>
        /// The available values are: ResultValue, ResultValueDictionary, ResultValue0D, ResultValueDecimal, ResultValueInt, ResultValueString, CashFlowValue, CashFlowValueSet
        /// </summary>
        /// <value>The available values are: ResultValue, ResultValueDictionary, ResultValue0D, ResultValueDecimal, ResultValueInt, ResultValueString, CashFlowValue, CashFlowValueSet</value>
        ...
        /// <param name="cashFlowLineage">Lineage for cash flow value.</param>
        ...
        /// <param name="resultValueType">The available values are: ResultValue, ResultValueDictionary, ResultValue0D, ResultValueDecimal, ResultValueInt, ResultValueString, CashFlowValue, CashFlowValueSet (required).</param>
        public CashFlowValueAllOf(DateTimeOffset paymentDate = default(DateTimeOffset), ResultValueDictionary diagnostics = default(ResultValueDictionary), Object cashFlowLineage = default(Object), decimal paymentAmount = default(decimal), string paymentCcy = default(string), ResultValueTypeEnum resultValueType = default(ResultValueTypeEnum))
        {
            this.PaymentDate = paymentDate;
            this.PaymentAmount = paymentAmount;
            // to ensure "paymentCcy" is required (not null)
            this.PaymentCcy = paymentCcy ?? throw new ArgumentNullException("paymentCcy is a required property for CashFlowValueAllOf and cannot be null");
        ...
        /// </summary>
        /// <value>Lineage for cash flow value</value>
        [DataMember(Name = "cashFlowLineage", EmitDefaultValue = false)]
        public Object CashFlowLineage { get; set; }
        ...
        [DataMember(Name = "paymentCcy", IsRequired = true, EmitDefaultValue = false)]
