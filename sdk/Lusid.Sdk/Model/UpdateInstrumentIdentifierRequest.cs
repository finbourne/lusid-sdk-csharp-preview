...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpdateInstrumentIdentifierRequest :  IEquatable<UpdateInstrumentIdentifierRequest>
    {
        ...
        /// </summary>
        /// <param name="type">The type of the identifier to upsert. This must be one of the code types marked as   allowable for instrument identifiers..</param>
        /// <param name="value">The value of the identifier. If set to &#x60;null&#x60;, this will remove the identifier completely.  Note that, if an instrument only has one identifier, it is an error to remove this..</param>
        /// <param name="effectiveAt">The date at which the identifier modification is to be effective from. If unset, will  default to &#x60;now&#x60;..</param>
        ...
        /// </summary>
        /// <value>The type of the identifier to upsert. This must be one of the code types marked as   allowable for instrument identifiers.</value>
        ...
        /// </summary>
        /// <value>The value of the identifier. If set to &#x60;null&#x60;, this will remove the identifier completely.  Note that, if an instrument only has one identifier, it is an error to remove this.</value>
        ...
        /// </summary>
        /// <value>The date at which the identifier modification is to be effective from. If unset, will  default to &#x60;now&#x60;.</value>
