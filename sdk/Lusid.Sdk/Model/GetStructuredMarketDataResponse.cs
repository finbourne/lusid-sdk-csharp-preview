...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetStructuredMarketDataResponse")]
    public partial class GetStructuredMarketDataResponse : IEquatable<GetStructuredMarketDataResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetStructuredMarketDataResponse" /> class.
        /// </summary>
        ...
        public GetStructuredMarketDataResponse(string href = default(string), Dictionary<string, StructuredMarketData> values = default(Dictionary<string, StructuredMarketData>), Dictionary<string, ErrorDetail> failed = default(Dictionary<string, ErrorDetail>), List<Link> links = default(List<Link>))
        {
            this.Href = href;
            this.Values = values;
            this.Failed = failed;
        ...
        public Dictionary<string, StructuredMarketData> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetStructuredMarketDataResponse {\n");
        ...
        {
            return this.Equals(input as GetStructuredMarketDataResponse);
        }

        /// <summary>
        /// Returns true if GetStructuredMarketDataResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetStructuredMarketDataResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetStructuredMarketDataResponse input)
        {
            if (input == null)
                return false;
