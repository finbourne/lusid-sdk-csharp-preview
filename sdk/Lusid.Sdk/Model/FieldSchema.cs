...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FieldSchema :  IEquatable<FieldSchema>
    {
        ...
        public FieldSchema(string scope = default(string), string name = default(string), string displayName = default(string), TypeEnum? type = default(TypeEnum?), bool? isMetric = default(bool?), int? displayOrder = default(int?), Dictionary<string, FieldSchema> propertySchema = default(Dictionary<string, FieldSchema>))
        {
            this.Scope = scope;
            this.Name = name;
        ...
        /// </summary>
        [DataMember(Name="isMetric", EmitDefaultValue=false)]
        ...
        public bool Equals(FieldSchema input)
        {
            ...
            return 
                ...
                (
                    this.IsMetric == input.IsMetric ||
                    (this.IsMetric != null &&
                    this.IsMetric.Equals(input.IsMetric))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsMetric != null)
                    hashCode = hashCode * 59 + this.IsMetric.GetHashCode();
