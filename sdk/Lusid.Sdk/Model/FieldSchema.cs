...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FieldSchema :  IEquatable<FieldSchema>
    {
        ...
        public FieldSchema(ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?), bool? isMetric = default(bool?), int? displayOrder = default(int?))
        {
            this.Id = id;
