...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TotalReturnSwap : LusidInstrument, IEquatable<TotalReturnSwap>
    {
        ...
        public TotalReturnSwap(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), InstrumentLeg paymentLeg = default(InstrumentLeg), UnderlyingLeg underlyingLeg = default(UnderlyingLeg), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.PaymentLeg = paymentLeg ?? throw new ArgumentNullException("paymentLeg is a required property for TotalReturnSwap and cannot be null");
            // to ensure "underlyingLeg" is required (not null)
            this.UnderlyingLeg = underlyingLeg ?? throw new ArgumentNullException("underlyingLeg is a required property for TotalReturnSwap and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "paymentLeg", IsRequired = true, EmitDefaultValue = false)]
        public InstrumentLeg PaymentLeg { get; set; }

        /// <summary>
        /// Gets or Sets UnderlyingLeg
        /// </summary>
        [DataMember(Name = "underlyingLeg", IsRequired = true, EmitDefaultValue = false)]
