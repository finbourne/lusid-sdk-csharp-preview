...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TotalReturnSwap : LusidInstrument, IEquatable<TotalReturnSwap>
    {
        /// <summary>
        ...
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption, ReferenceInstrument, ComplexBond, InflationLinkedBond, InflationSwap, SimpleCashFlowLoan, TotalReturnSwap, InflationLeg, FundShareClass, FlexibleLoan (required) (default to &quot;TotalReturnSwap&quot;).</param>
        public TotalReturnSwap(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), AssetLeg assetLeg = default(AssetLeg), InstrumentLeg fundingLeg = default(InstrumentLeg), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.AssetLeg = assetLeg ?? throw new ArgumentNullException("assetLeg is a required property for TotalReturnSwap and cannot be null");
            // to ensure "fundingLeg" is required (not null)
            this.FundingLeg = fundingLeg ?? throw new ArgumentNullException("fundingLeg is a required property for TotalReturnSwap and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "assetLeg", IsRequired = true, EmitDefaultValue = false)]
