...
namespace Lusid.Sdk.Model
{
    ...
    public partial class VersionedResourceListOfJELines : IEquatable<VersionedResourceListOfJELines>
    {
        /// <summary>
        ...
        public VersionedResourceListOfJELines(Version version = default(Version), List<JELines> values = default(List<JELines>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "version" is required (not null)
            this.Version = version ?? throw new ArgumentNullException("version is a required property for VersionedResourceListOfJELines and cannot be null");
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for VersionedResourceListOfJELines and cannot be null");
            this.Href = href;
