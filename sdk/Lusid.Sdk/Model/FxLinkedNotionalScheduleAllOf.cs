...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxLinkedNotionalScheduleAllOf : IEquatable<FxLinkedNotionalScheduleAllOf>
    {
        /// <summary>
        ...
        public FxLinkedNotionalScheduleAllOf(FxConventions fxConventions = default(FxConventions), string varyingNotionalCurrency = default(string), RelativeDateOffset varyingNotionalFixingDates = default(RelativeDateOffset), RelativeDateOffset varyingNotionalInterimExchangePaymentDates = default(RelativeDateOffset), ScheduleTypeEnum scheduleType = default(ScheduleTypeEnum))
        {
            ...
            this.FxConventions = fxConventions ?? throw new ArgumentNullException("fxConventions is a required property for FxLinkedNotionalScheduleAllOf and cannot be null");
            // to ensure "varyingNotionalCurrency" is required (not null)
            this.VaryingNotionalCurrency = varyingNotionalCurrency ?? throw new ArgumentNullException("varyingNotionalCurrency is a required property for FxLinkedNotionalScheduleAllOf and cannot be null");
            // to ensure "varyingNotionalFixingDates" is required (not null)
            this.VaryingNotionalFixingDates = varyingNotionalFixingDates ?? throw new ArgumentNullException("varyingNotionalFixingDates is a required property for FxLinkedNotionalScheduleAllOf and cannot be null");
