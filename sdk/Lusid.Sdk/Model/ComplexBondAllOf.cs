...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplexBondAllOf : IEquatable<ComplexBondAllOf>
    {
        /// <summary>
        ...
        public ComplexBondAllOf(Dictionary<string, string> identifiers = default(Dictionary<string, string>), string calculationType = default(string), List<Schedule> schedules = default(List<Schedule>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
