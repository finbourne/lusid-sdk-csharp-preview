...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InflationSwapAllOf : IEquatable<InflationSwapAllOf>
    {
        ...
        public InflationSwapAllOf(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), InflationLeg inflationLeg = default(InflationLeg), FixedLeg fixedLeg = default(FixedLeg), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.InflationLeg = inflationLeg ?? throw new ArgumentNullException("inflationLeg is a required property for InflationSwapAllOf and cannot be null");
            // to ensure "fixedLeg" is required (not null)
            this.FixedLeg = fixedLeg ?? throw new ArgumentNullException("fixedLeg is a required property for InflationSwapAllOf and cannot be null");
