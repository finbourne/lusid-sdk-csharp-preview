...
namespace Lusid.Sdk.Model
{
    ...
    public partial class JELines : IEquatable<JELines>
    {
        /// <summary>
        ...
        /// <param name="postingModuleId">postingModuleId (required).</param>
        ...
        public JELines(DateTimeOffset accountingDate = default(DateTimeOffset), DateTimeOffset activityDate = default(DateTimeOffset), ResourceId portfolioId = default(ResourceId), string instrumentId = default(string), string instrumentScope = default(string), Dictionary<string, PerpetualProperty> subHoldingKeys = default(Dictionary<string, PerpetualProperty>), string taxLotId = default(string), string glCode = default(string), CurrencyAndAmount local = default(CurrencyAndAmount), CurrencyAndAmount _base = default(CurrencyAndAmount), ResourceId postingModuleId = default(ResourceId), string postingRule = default(string), DateTimeOffset asAtDate = default(DateTimeOffset), string activitiesDescription = default(string), string sourceType = default(string), string sourceId = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), string movementName = default(string), string holdingType = default(string), string economicBucket = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.PortfolioId = portfolioId ?? throw new ArgumentNullException("portfolioId is a required property for JELines and cannot be null");
            // to ensure "instrumentId" is required (not null)
            this.InstrumentId = instrumentId ?? throw new ArgumentNullException("instrumentId is a required property for JELines and cannot be null");
            // to ensure "instrumentScope" is required (not null)
            this.InstrumentScope = instrumentScope ?? throw new ArgumentNullException("instrumentScope is a required property for JELines and cannot be null");
            // to ensure "taxLotId" is required (not null)
            this.TaxLotId = taxLotId ?? throw new ArgumentNullException("taxLotId is a required property for JELines and cannot be null");
            // to ensure "glCode" is required (not null)
            this.GlCode = glCode ?? throw new ArgumentNullException("glCode is a required property for JELines and cannot be null");
            // to ensure "local" is required (not null)
            this.Local = local ?? throw new ArgumentNullException("local is a required property for JELines and cannot be null");
            // to ensure "_base" is required (not null)
            this.Base = _base ?? throw new ArgumentNullException("_base is a required property for JELines and cannot be null");
            // to ensure "postingModuleId" is required (not null)
            this.PostingModuleId = postingModuleId ?? throw new ArgumentNullException("postingModuleId is a required property for JELines and cannot be null");
            // to ensure "postingRule" is required (not null)
            this.PostingRule = postingRule ?? throw new ArgumentNullException("postingRule is a required property for JELines and cannot be null");
            this.AsAtDate = asAtDate;
            // to ensure "sourceType" is required (not null)
            this.SourceType = sourceType ?? throw new ArgumentNullException("sourceType is a required property for JELines and cannot be null");
            // to ensure "sourceId" is required (not null)
            this.SourceId = sourceId ?? throw new ArgumentNullException("sourceId is a required property for JELines and cannot be null");
            // to ensure "movementName" is required (not null)
            this.MovementName = movementName ?? throw new ArgumentNullException("movementName is a required property for JELines and cannot be null");
            // to ensure "holdingType" is required (not null)
            this.HoldingType = holdingType ?? throw new ArgumentNullException("holdingType is a required property for JELines and cannot be null");
            // to ensure "economicBucket" is required (not null)
            this.EconomicBucket = economicBucket ?? throw new ArgumentNullException("economicBucket is a required property for JELines and cannot be null");
        ...
        [DataMember(Name = "glCode", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "postingModuleId", IsRequired = true, EmitDefaultValue = false)]
