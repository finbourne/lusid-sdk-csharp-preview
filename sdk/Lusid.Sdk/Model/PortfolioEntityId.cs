...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioEntityId : IEquatable<PortfolioEntityId>
    {
        ...
        public PortfolioEntityId(string scope = default(string), string code = default(string), string portfolioEntityType = default(string))
        {
            ...
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for PortfolioEntityId and cannot be null");
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for PortfolioEntityId and cannot be null");
