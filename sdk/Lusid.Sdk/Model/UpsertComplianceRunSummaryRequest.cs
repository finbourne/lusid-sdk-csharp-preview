...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertComplianceRunSummaryRequest : IEquatable<UpsertComplianceRunSummaryRequest>
    {
        /// <summary>
        ...
        public UpsertComplianceRunSummaryRequest(ResourceId runId = default(ResourceId), DateTimeOffset instigatedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), string schedule = default(string), List<ComplianceSummaryRuleResultRequest> results = default(List<ComplianceSummaryRuleResultRequest>))
        {
            ...
            this.RunId = runId ?? throw new ArgumentNullException("runId is a required property for UpsertComplianceRunSummaryRequest and cannot be null");
            this.InstigatedAt = instigatedAt;
            this.CompletedAt = completedAt;
            // to ensure "schedule" is required (not null)
            this.Schedule = schedule ?? throw new ArgumentNullException("schedule is a required property for UpsertComplianceRunSummaryRequest and cannot be null");
            // to ensure "results" is required (not null)
            this.Results = results ?? throw new ArgumentNullException("results is a required property for UpsertComplianceRunSummaryRequest and cannot be null");
        }
