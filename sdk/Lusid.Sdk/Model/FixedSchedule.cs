...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FixedSchedule : Schedule, IEquatable<FixedSchedule>
    {
        /// <summary>
        ...
        /// <param name="scheduleType">The available values are: Fixed, Float, Optionality, Step, Exercise, Invalid (required) (default to &quot;FixedSchedule&quot;).</param>
        public FixedSchedule(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), FlowConventions flowConventions = default(FlowConventions), decimal couponRate = default(decimal), FlowConventionName conventionName = default(FlowConventionName), decimal notional = default(decimal), string paymentCurrency = default(string), ScheduleTypeEnum scheduleType = default(ScheduleTypeEnum)) : base(scheduleType)
        {
