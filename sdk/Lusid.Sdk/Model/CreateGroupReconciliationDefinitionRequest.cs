...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateGroupReconciliationDefinitionRequest : IEquatable<CreateGroupReconciliationDefinitionRequest>
    {
        /// <summary>
        ...
        public CreateGroupReconciliationDefinitionRequest(ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), GroupReconciliationDefinitionPortfolioEntityIds portfolioEntityIds = default(GroupReconciliationDefinitionPortfolioEntityIds), GroupReconciliationDefinitionRecipeIds recipeIds = default(GroupReconciliationDefinitionRecipeIds), GroupReconciliationDefinitionCurrencies currencies = default(GroupReconciliationDefinitionCurrencies), TransactionDateWindows transactionDateWindows = default(TransactionDateWindows), GroupReconciliationDefinitionComparisonRulesetIds comparisonRulesetIds = default(GroupReconciliationDefinitionComparisonRulesetIds), BreakCodeSource breakCodeSource = default(BreakCodeSource))
        {
            ...
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CreateGroupReconciliationDefinitionRequest and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for CreateGroupReconciliationDefinitionRequest and cannot be null");
            // to ensure "portfolioEntityIds" is required (not null)
            this.PortfolioEntityIds = portfolioEntityIds ?? throw new ArgumentNullException("portfolioEntityIds is a required property for CreateGroupReconciliationDefinitionRequest and cannot be null");
            // to ensure "breakCodeSource" is required (not null)
            this.BreakCodeSource = breakCodeSource ?? throw new ArgumentNullException("breakCodeSource is a required property for CreateGroupReconciliationDefinitionRequest and cannot be null");
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name = "breakCodeSource", IsRequired = true, EmitDefaultValue = false)]
