...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FixedLeg : InstrumentLeg,  IEquatable<FixedLeg>
    {
        ...
        public FixedLeg(decimal? notional = default(decimal?), DateTimeOffset? maturityDate = default(DateTimeOffset?), DateTimeOffset? startDate = default(DateTimeOffset?), LegDefinition legDefinition = default(LegDefinition), FixedLegAllOfOverrides overrides = default(FixedLegAllOfOverrides), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
