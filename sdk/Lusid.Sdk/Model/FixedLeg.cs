...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FixedLeg : LusidInstrument,  IEquatable<FixedLeg>
    {
        ...
        public FixedLeg(InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum), decimal? notional = default(decimal?), DateTimeOffset? maturityDate = default(DateTimeOffset?), DateTimeOffset? startDate = default(DateTimeOffset?), LegDefinition legDefinition = default(LegDefinition)) : base(instrumentType)
        {
