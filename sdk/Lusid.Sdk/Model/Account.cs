...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Account : IEquatable<Account>
    {
        ...
        /// <param name="control">This allows users to specify whether this a protected account that prevents direct manual journal adjustment. Can have the values: System/ManualIt will default to â€œManualâ€. (required).</param>
        ...
        public Account(string code = default(string), string description = default(string), string type = default(string), StatusEnum status = default(StatusEnum), string control = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for Account and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for Account and cannot be null");
            this.Status = status;
            // to ensure "control" is required (not null)
            this.Control = control ?? throw new ArgumentNullException("control is a required property for Account and cannot be null");
        ...
        /// <summary>
        /// This allows users to specify whether this a protected account that prevents direct manual journal adjustment. Can have the values: System/ManualIt will default to â€œManualâ€.
        /// </summary>
        /// <value>This allows users to specify whether this a protected account that prevents direct manual journal adjustment. Can have the values: System/ManualIt will default to â€œManualâ€.</value>
        [DataMember(Name = "control", IsRequired = true, EmitDefaultValue = false)]
