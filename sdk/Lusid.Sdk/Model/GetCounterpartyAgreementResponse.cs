...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCounterpartyAgreementResponse")]
    public partial class GetCounterpartyAgreementResponse : IEquatable<GetCounterpartyAgreementResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCounterpartyAgreementResponse" /> class.
        /// </summary>
        /// <param name="href">The specific Uniform Resource Identifier (URI) for this resource at the requested effective and asAt datetime..</param>
        /// <param name="value">value.</param>
        /// <param name="failed">The counterparty agreement that could not be retrieved along with a reason for failure..</param>
        /// <param name="links">Collection of links..</param>
        public GetCounterpartyAgreementResponse(string href = default(string), CounterpartyAgreement value = default(CounterpartyAgreement), Dictionary<string, ErrorDetail> failed = default(Dictionary<string, ErrorDetail>), List<Link> links = default(List<Link>))
        {
            this.Href = href;
            this.Value = value;
            this.Failed = failed;
        ...
        public CounterpartyAgreement Value { get; set; }

        /// <summary>
        /// The counterparty agreement that could not be retrieved along with a reason for failure.
        /// </summary>
        /// <value>The counterparty agreement that could not be retrieved along with a reason for failure.</value>
        ...
        {
            return this.Equals(input as GetCounterpartyAgreementResponse);
        }

        /// <summary>
        /// Returns true if GetCounterpartyAgreementResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCounterpartyAgreementResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCounterpartyAgreementResponse input)
        {
            if (input == null)
                return false;
