...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplexMarketDataId :  IEquatable<ComplexMarketDataId>
    {
        ...
        /// <param name="marketDataType">The type of the market element that the market entity represents, e.g. a vol surface or credit curve.</param>
        /// <param name="marketAsset">The name of the market entity that the document represents.</param>
        public ComplexMarketDataId(string provider = default(string), string priceSource = default(string), string lineage = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string marketDataType = default(string), string marketAsset = default(string))
        {
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new InvalidDataException("provider is a required property for ComplexMarketDataId and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="marketDataType", EmitDefaultValue=true)]
