...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CustomEntityField : IEquatable<CustomEntityField>
    {
        /// <summary>
        ...
        /// <param name="value">The value for the field. (required).</param>
        ...
        /// <param name="effectiveUntil">The effective datetime until which the field&#39;s value is valid. If not supplied, the value will be valid indefinitely or until the next â€œeffectiveFromâ€ date of the field..</param>
        public CustomEntityField(string name = default(string), Object value = default(Object), DateTimeOffset? effectiveFrom = default(DateTimeOffset?), DateTimeOffset? effectiveUntil = default(DateTimeOffset?))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CustomEntityField and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for CustomEntityField and cannot be null");
        ...
        /// <summary>
        /// The effective datetime until which the field&#39;s value is valid. If not supplied, the value will be valid indefinitely or until the next â€œeffectiveFromâ€ date of the field.
        /// </summary>
        /// <value>The effective datetime until which the field&#39;s value is valid. If not supplied, the value will be valid indefinitely or until the next â€œeffectiveFromâ€ date of the field.</value>
