...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfOutputTransaction : IEquatable<ResourceListOfOutputTransaction>
    {
        /// <summary>
        ...
        public ResourceListOfOutputTransaction(List<OutputTransaction> values = default(List<OutputTransaction>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfOutputTransaction and cannot be null");
            this.Href = href;
            this.Links = links;
