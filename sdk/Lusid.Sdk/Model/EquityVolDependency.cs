...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityVolDependency : EconomicDependency, IEquatable<EquityVolDependency>
    {
        /// <summary>
        ...
        /// <param name="dependencyType">The available values are: Opaque, Cash, Discounting, EquityCurve, EquityVol, Fx, FxForwards, FxVol, IndexProjection, IrVol, Quote, Vendor (required) (default to &quot;EquityVolDependency&quot;).</param>
        public EquityVolDependency(string code = default(string), string domesticCurrency = default(string), string volType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base(dependencyType)
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for EquityVolDependency and cannot be null");
            // to ensure "domesticCurrency" is required (not null)
            this.DomesticCurrency = domesticCurrency ?? throw new ArgumentNullException("domesticCurrency is a required property for EquityVolDependency and cannot be null");
            // to ensure "volType" is required (not null)
            this.VolType = volType ?? throw new ArgumentNullException("volType is a required property for EquityVolDependency and cannot be null");
            this.Date = date;
        }
