...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DividendReinvestmentEventAllOf : IEquatable<DividendReinvestmentEventAllOf>
    {
        /// <summary>
        ...
        public DividendReinvestmentEventAllOf(DateTimeOffset? announcementDate = default(DateTimeOffset?), List<CashElection> cashElections = default(List<CashElection>), DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), DateTimeOffset recordDate = default(DateTimeOffset), List<SecurityElection> securityElections = default(List<SecurityElection>), DateTimeOffset securitySettlementDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            ...
            this.CashElections = cashElections ?? throw new ArgumentNullException("cashElections is a required property for DividendReinvestmentEventAllOf and cannot be null");
            this.ExDate = exDate;
            this.PaymentDate = paymentDate;
            this.RecordDate = recordDate;
            // to ensure "securityElections" is required (not null)
            this.SecurityElections = securityElections ?? throw new ArgumentNullException("securityElections is a required property for DividendReinvestmentEventAllOf and cannot be null");
        ...
        [DataMember(Name = "securityElections", IsRequired = true, EmitDefaultValue = false)]
