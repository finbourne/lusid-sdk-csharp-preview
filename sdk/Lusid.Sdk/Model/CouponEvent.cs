...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CouponEvent")]
    [JsonConverter(typeof(JsonSubtypes), "InstrumentEventType")]
    public partial class CouponEvent : InstrumentEvent, IEquatable<CouponEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponEvent" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="CouponEvent" /> class.
        /// </summary>
        /// <param name="anchorDate">Date on which the coupon payment occurs..</param>
        /// <param name="instrumentEventType">The Type of Event. The available values are: TransitionEvent, InternalEvent, CouponEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent (required) (default to &quot;CouponEvent&quot;).</param>
        public CouponEvent(DateTimeOffset anchorDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base(instrumentEventType)
        {
        ...
        /// </summary>
        /// <value>Date on which the coupon payment occurs.</value>
        ...
        {
            return this.Equals(input as CouponEvent);
        }

        /// <summary>
        /// Returns true if CouponEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponEvent input)
        {
            if (input == null)
                return false;
