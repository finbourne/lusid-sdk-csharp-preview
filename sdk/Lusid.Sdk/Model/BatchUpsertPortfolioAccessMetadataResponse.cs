...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchUpsertPortfolioAccessMetadataResponse")]
    public partial class BatchUpsertPortfolioAccessMetadataResponse : IEquatable<BatchUpsertPortfolioAccessMetadataResponse>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BatchUpsertPortfolioAccessMetadataResponse);
        }

        /// <summary>
        /// Returns true if BatchUpsertPortfolioAccessMetadataResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchUpsertPortfolioAccessMetadataResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchUpsertPortfolioAccessMetadataResponse input)
        {
            if (input == null)
                return false;
