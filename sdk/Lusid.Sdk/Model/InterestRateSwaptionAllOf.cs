...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InterestRateSwaptionAllOf : IEquatable<InterestRateSwaptionAllOf>
    {
        ...
        public InterestRateSwaptionAllOf(DateTimeOffset startDate = default(DateTimeOffset), string payOrReceiveFixed = default(string), string deliveryMethod = default(string), InterestRateSwap swap = default(InterestRateSwap), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
