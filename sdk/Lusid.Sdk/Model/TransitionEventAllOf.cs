...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransitionEventAllOf : IEquatable<TransitionEventAllOf>
    {
        ...
        public TransitionEventAllOf(DateTimeOffset announcementDate = default(DateTimeOffset), DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset recordDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), List<CorporateActionTransitionRequest> transitions = default(List<CorporateActionTransitionRequest>), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
