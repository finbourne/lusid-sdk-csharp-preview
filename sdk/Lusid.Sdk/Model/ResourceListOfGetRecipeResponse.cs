...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfGetRecipeResponse :  IEquatable<ResourceListOfGetRecipeResponse>
    {
        ...
        public ResourceListOfGetRecipeResponse(List<GetRecipeResponse> values = default(List<GetRecipeResponse>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfGetRecipeResponse and cannot be null");
            }
            else
            {
                this.Values = values;
