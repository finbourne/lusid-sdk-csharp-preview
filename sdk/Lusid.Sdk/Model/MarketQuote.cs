...
namespace Lusid.Sdk.Model
{
    ...
    public partial class MarketQuote :  IEquatable<MarketQuote>
    {
        ...
        public MarketQuote(QuoteTypeEnum quoteType = default(QuoteTypeEnum), decimal? value = default(decimal?))
        {
            ...
            if (quoteType == null)
            {
                throw new InvalidDataException("quoteType is a required property for MarketQuote and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for MarketQuote and cannot be null");
            }
            else
            {
                this.Value = value;
