...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SubHoldingKeyValueEquals : MatchCriterion, IEquatable<SubHoldingKeyValueEquals>
    {
        /// <summary>
        ...
        public SubHoldingKeyValueEquals(string subHoldingKey = default(string), string value = default(string), CriterionTypeEnum criterionType = default(CriterionTypeEnum)) : base(criterionType)
        {
            ...
            this.SubHoldingKey = subHoldingKey ?? throw new ArgumentNullException("subHoldingKey is a required property for SubHoldingKeyValueEquals and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for SubHoldingKeyValueEquals and cannot be null");
        }
