...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CustodianAccountsUpsertResponse : IEquatable<CustodianAccountsUpsertResponse>
    {
        /// <summary>
        ...
        public CustodianAccountsUpsertResponse(string href = default(string), Version version = default(Version), List<CustodianAccount> custodianAccounts = default(List<CustodianAccount>), List<Link> links = default(List<Link>))
        {
            this.Href = href;
