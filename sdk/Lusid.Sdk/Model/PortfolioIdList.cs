...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioIdList : IEquatable<PortfolioIdList>
    {
        /// <summary>
        ...
        public PortfolioIdList(List<ResourceId> values = default(List<ResourceId>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PortfolioIdList and cannot be null");
