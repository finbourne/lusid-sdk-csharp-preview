...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateDateRequest :  IEquatable<CreateDateRequest>
    {
        ...
        public CreateDateRequest(string dateId = default(string), DateTimeOffset? fromUtc = default(DateTimeOffset?), DateTimeOffset? toUtc = default(DateTimeOffset?), string timeZone = default(string), string description = default(string), string type = default(string), DateAttributes attributes = default(DateAttributes), Dictionary<string, string> sourceData = default(Dictionary<string, string>))
        {
            ...
            if (dateId == null)
            {
                throw new InvalidDataException("dateId is a required property for CreateDateRequest and cannot be null");
            }
            else
            {
                this.DateId = dateId;
            ...
            if (fromUtc == null)
            {
                throw new InvalidDataException("fromUtc is a required property for CreateDateRequest and cannot be null");
            }
            else
            {
            ...
            if (toUtc == null)
            {
                throw new InvalidDataException("toUtc is a required property for CreateDateRequest and cannot be null");
            }
            else
            {
                this.ToUtc = toUtc;
            ...
            if (timeZone == null)
            {
                throw new InvalidDataException("timeZone is a required property for CreateDateRequest and cannot be null");
            }
            else
            {
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for CreateDateRequest and cannot be null");
            }
            else
            {
