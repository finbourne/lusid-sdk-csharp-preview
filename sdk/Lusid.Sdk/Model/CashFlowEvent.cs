...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashFlowEvent : InstrumentEvent, IEquatable<CashFlowEvent>
    {
        ...
        /// <param name="instrumentEventType">The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent, SwapCashFlowEvent (required) (default to &quot;CashFlowEvent&quot;).</param>
        public CashFlowEvent(CashFlowValue cashFlowValue = default(CashFlowValue), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base(instrumentEventType)
        {
            ...
            this.CashFlowValue = cashFlowValue ?? throw new ArgumentNullException("cashFlowValue is a required property for CashFlowEvent and cannot be null");
        }

        /// <summary>
        /// Gets or Sets CashFlowValue
        /// </summary>
        [DataMember(Name = "cashFlowValue", IsRequired = true, EmitDefaultValue = false)]
