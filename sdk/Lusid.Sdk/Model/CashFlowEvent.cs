...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashFlowEvent : InstrumentEvent, IEquatable<CashFlowEvent>
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="CashFlowEvent" /> class.
        /// </summary>
        /// <param name="amount">The quantity (amount) that will be paid, if known. This value will be negative if it is paid, and positive  if it is received..</param>
        ...
        /// <param name="paymentDate">The date on which the cashflow is scheduled to be paid into the recipient&#39;s bank account. (required).</param>
        /// <param name="instrumentEventType">The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent (required) (default to &quot;CashFlowEvent&quot;).</param>
        public CashFlowEvent(decimal? amount = default(decimal?), string currency = default(string), string eventStatus = default(string), DateTimeOffset paymentDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base(instrumentEventType)
        {
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for CashFlowEvent and cannot be null");
            // to ensure "eventStatus" is required (not null)
            this.EventStatus = eventStatus ?? throw new ArgumentNullException("eventStatus is a required property for CashFlowEvent and cannot be null");
            this.PaymentDate = paymentDate;
            this.Amount = amount;
        }

        /// <summary>
        /// The quantity (amount) that will be paid, if known. This value will be negative if it is paid, and positive  if it is received.
        /// </summary>
        /// <value>The quantity (amount) that will be paid, if known. This value will be negative if it is paid, and positive  if it is received.</value>
        ...
        /// <summary>
        /// The date on which the cashflow is scheduled to be paid into the recipient&#39;s bank account.
        /// </summary>
        /// <value>The date on which the cashflow is scheduled to be paid into the recipient&#39;s bank account.</value>
