...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupFilterStepAllOf : IEquatable<GroupFilterStepAllOf>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>. The available values are: FilterStep, GroupByStep, GroupFilterStep, BranchStep, RecombineStep</value>
        [DataMember(Name = "complianceStepType", IsRequired = true, EmitDefaultValue = false)]
        ...
        public GroupFilterStepAllOf(string label = default(string), List<ComplianceTemplateParameter> limitCheckParameters = default(List<ComplianceTemplateParameter>), List<ComplianceTemplateParameter> warningCheckParameters = default(List<ComplianceTemplateParameter>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum))
        {
            ...
            this.Label = label ?? throw new ArgumentNullException("label is a required property for GroupFilterStepAllOf and cannot be null");
            // to ensure "limitCheckParameters" is required (not null)
            this.LimitCheckParameters = limitCheckParameters ?? throw new ArgumentNullException("limitCheckParameters is a required property for GroupFilterStepAllOf and cannot be null");
            // to ensure "warningCheckParameters" is required (not null)
            this.WarningCheckParameters = warningCheckParameters ?? throw new ArgumentNullException("warningCheckParameters is a required property for GroupFilterStepAllOf and cannot be null");
        ...
        [DataMember(Name = "limitCheckParameters", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "warningCheckParameters", IsRequired = true, EmitDefaultValue = false)]
