...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FloatScheduleAllOf : IEquatable<FloatScheduleAllOf>
    {
        /// <summary>
        /// The available values are: Fixed, Float, Optionality, Step, Exercise, Invalid
        /// </summary>
        /// <value>The available values are: Fixed, Float, Optionality, Step, Exercise, Invalid</value>
        ...
        /// <param name="scheduleType">The available values are: Fixed, Float, Optionality, Step, Exercise, Invalid (required).</param>
        public FloatScheduleAllOf(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), FlowConventions flowConventions = default(FlowConventions), FlowConventionName conventionName = default(FlowConventionName), FlowConventionName indexConventionName = default(FlowConventionName), IndexConvention indexConventions = default(IndexConvention), decimal notional = default(decimal), string paymentCurrency = default(string), decimal spread = default(decimal), string stubType = default(string), ScheduleTypeEnum scheduleType = default(ScheduleTypeEnum))
        {
