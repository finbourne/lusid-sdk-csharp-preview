...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityCurveDependency : EconomicDependency, IEquatable<EquityCurveDependency>
    {
        /// <summary>
        ...
        /// <param name="dependencyType">The available values are: Opaque, Cash, Discounting, EquityCurve, EquityVol, Fx, FxForwards, FxVol, IndexProjection, IrVol, Quote, Vendor (required) (default to &quot;EquityCurveDependency&quot;).</param>
        public EquityCurveDependency(string marketIdentifier = default(string), string code = default(string), string curveType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base(dependencyType)
        {
            ...
            this.MarketIdentifier = marketIdentifier ?? throw new ArgumentNullException("marketIdentifier is a required property for EquityCurveDependency and cannot be null");
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for EquityCurveDependency and cannot be null");
            // to ensure "curveType" is required (not null)
            this.CurveType = curveType ?? throw new ArgumentNullException("curveType is a required property for EquityCurveDependency and cannot be null");
            this.Date = date;
        }
