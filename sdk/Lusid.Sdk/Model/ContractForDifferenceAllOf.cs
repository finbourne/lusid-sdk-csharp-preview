...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ContractForDifferenceAllOf :  IEquatable<ContractForDifferenceAllOf>
    {
        ...
        public ContractForDifferenceAllOf(DateTimeOffset? startDate = default(DateTimeOffset?), string code = default(string), string payCcy = default(string), DateTimeOffset? referenceDate = default(DateTimeOffset?), decimal? referenceRate = default(decimal?), string underlyingCcy = default(string), string underlyingIdentifier = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            {
                throw new InvalidDataException("referenceDate is a required property for ContractForDifferenceAllOf and cannot be null");
            }
            else
            {
