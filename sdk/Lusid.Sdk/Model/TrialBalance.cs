...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TrialBalance : IEquatable<TrialBalance>
    {
        /// <summary>
        ...
        public TrialBalance(string generalLedgerAccountCode = default(string), string description = default(string), List<string> levels = default(List<string>), string accountType = default(string), string localCurrency = default(string), MultiCurrencyAmounts opening = default(MultiCurrencyAmounts), MultiCurrencyAmounts closing = default(MultiCurrencyAmounts), MultiCurrencyAmounts debit = default(MultiCurrencyAmounts), MultiCurrencyAmounts credit = default(MultiCurrencyAmounts), Dictionary<string, Property> properties = default(Dictionary<string, Property>), List<Link> links = default(List<Link>))
        {
            ...
            this.AccountType = accountType ?? throw new ArgumentNullException("accountType is a required property for TrialBalance and cannot be null");
            // to ensure "localCurrency" is required (not null)
            this.LocalCurrency = localCurrency ?? throw new ArgumentNullException("localCurrency is a required property for TrialBalance and cannot be null");
            // to ensure "opening" is required (not null)
            this.Opening = opening ?? throw new ArgumentNullException("opening is a required property for TrialBalance and cannot be null");
            // to ensure "closing" is required (not null)
            this.Closing = closing ?? throw new ArgumentNullException("closing is a required property for TrialBalance and cannot be null");
            // to ensure "debit" is required (not null)
            this.Debit = debit ?? throw new ArgumentNullException("debit is a required property for TrialBalance and cannot be null");
            // to ensure "credit" is required (not null)
            this.Credit = credit ?? throw new ArgumentNullException("credit is a required property for TrialBalance and cannot be null");
        ...
        /// </summary>
        /// <value>The account type attributed to the record</value>
        [DataMember(Name = "localCurrency", IsRequired = true, EmitDefaultValue = false)]
        public string LocalCurrency { get; set; }

        /// <summary>
        /// Gets or Sets Opening
        /// </summary>
        [DataMember(Name = "opening", IsRequired = true, EmitDefaultValue = false)]
        public MultiCurrencyAmounts Opening { get; set; }

        /// <summary>
        /// Gets or Sets Closing
        /// </summary>
        [DataMember(Name = "closing", IsRequired = true, EmitDefaultValue = false)]
