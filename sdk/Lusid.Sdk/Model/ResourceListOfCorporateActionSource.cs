...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfCorporateActionSource :  IEquatable<ResourceListOfCorporateActionSource>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfCorporateActionSource(List<CorporateActionSource> values = default(List<CorporateActionSource>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfCorporateActionSource and cannot be null");;
            this.Href = href;
            this.Links = links;
        }
