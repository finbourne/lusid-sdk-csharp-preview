...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfParticipation : IEquatable<PagedResourceListOfParticipation>
    {
        /// <summary>
        ...
        public PagedResourceListOfParticipation(string nextPage = default(string), string previousPage = default(string), List<Participation> values = default(List<Participation>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfParticipation and cannot be null");
