...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfInstrumentEventHolder : IEquatable<ResourceListOfInstrumentEventHolder>
    {
        /// <summary>
        ...
        public ResourceListOfInstrumentEventHolder(List<InstrumentEventHolder> values = default(List<InstrumentEventHolder>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfInstrumentEventHolder and cannot be null");
            this.Href = href;
            this.Links = links;
