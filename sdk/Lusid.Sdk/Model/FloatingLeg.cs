...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FloatingLeg : LusidInstrument,  IEquatable<FloatingLeg>
    {
        /// <summary>
        ...
        public FloatingLeg(InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum), decimal? notional = default(decimal?), DateTimeOffset? maturityDate = default(DateTimeOffset?), DateTimeOffset? startDate = default(DateTimeOffset?), LegDefinition legDefinition = default(LegDefinition), FixedLegAllOfOverrides overrides = default(FixedLegAllOfOverrides)) : base(instrumentType)
        {
            // to ensure "notional" is required (not null)
            if (notional == null)
            {
                throw new InvalidDataException("notional is a required property for FloatingLeg and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for FloatingLeg and cannot be null");
            }
            else
            {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for FloatingLeg and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("legDefinition is a required property for FloatingLeg and cannot be null");
            }
            else
            {
            ...
            if (overrides == null)
            {
                throw new InvalidDataException("overrides is a required property for FloatingLeg and cannot be null");
            }
            else
            {
