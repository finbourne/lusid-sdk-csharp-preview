...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FloatingLeg : LusidInstrument,  IEquatable<FloatingLeg>
    {
        ...
        public FloatingLeg(InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum), decimal? notional = default(decimal?), DateTimeOffset? maturityDate = default(DateTimeOffset?), DateTimeOffset? startDate = default(DateTimeOffset?), LegDefinition legDefinition = default(LegDefinition)) : base(instrumentType)
        {
