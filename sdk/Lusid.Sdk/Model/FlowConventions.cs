...
namespace Lusid.Sdk.Model
{
    ...
    {
        /// <summary>
        /// The available values are: Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActAct, ActualActual, ActActIsda, ActActIsma, ActActIcma, Invalid
        /// </summary>
        /// <value>The available values are: Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActAct, ActualActual, ActActIsda, ActActIsma, ActActIcma, Invalid</value>
        ...
        public enum DayCountConventionEnum
        {
            ...
            /// <summary>
            /// Enum ActActIsma for value: ActActIsma
            /// </summary>
            [EnumMember(Value = "ActActIsma")]
            ActActIsma = 14,

            /// <summary>
            /// Enum ActActIcma for value: ActActIcma
            /// </summary>
            [EnumMember(Value = "ActActIcma")]
            ActActIcma = 15,
        ...
        /// <summary>
        /// The available values are: NoAdjustment, None, Previous, P, Following, F, ModifiedPrevious, MP, ModifiedFollowing, MF, EndOfMonth, EOM, EndOfMonthPrevious, EOMP, EndOfMonthFollowing, EOMF, Invalid
        /// </summary>
        /// <value>The available values are: NoAdjustment, None, Previous, P, Following, F, ModifiedPrevious, MP, ModifiedFollowing, MF, EndOfMonth, EOM, EndOfMonthPrevious, EOMP, EndOfMonthFollowing, EOMF, Invalid</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="dayCountConvention">The available values are: Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActAct, ActualActual, ActActIsda, ActActIsma, ActActIcma, Invalid (required).</param>
        /// <param name="rollConvention">The available values are: NoAdjustment, None, Previous, P, Following, F, ModifiedPrevious, MP, ModifiedFollowing, MF, EndOfMonth, EOM, EndOfMonthPrevious, EOMP, EndOfMonthFollowing, EOMF, Invalid (required).</param>
        ...
        /// <param name="settleDays">Number of Good Business Days between the trade date and the effective or settlement date of the instrument..</param>
        /// <param name="resetDays">The number of Good Business Days between determination and payment of reset..</param>
        public FlowConventions(string scope = default(string), string code = default(string), string currency = default(string), string paymentFrequency = default(string), DayCountConventionEnum dayCountConvention = default(DayCountConventionEnum), RollConventionEnum rollConvention = default(RollConventionEnum), List<string> holidayCalendars = default(List<string>), int? settleDays = default(int?), int? resetDays = default(int?))
        {
            this.Scope = scope;
            this.Code = code;
