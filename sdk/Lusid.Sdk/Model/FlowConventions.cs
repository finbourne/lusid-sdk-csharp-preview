...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FlowConventions : IEquatable<FlowConventions>
    {
        ...
        /// <param name="rollConvention">When generating a set of dates, what convention should be used for adjusting dates that coincide with a non-business day.    Supported string (enumeration) values are: [NoAdjustment, Previous, P, Following, F, ModifiedPrevious, MP, ModifiedFollowing, MF, HalfMonthModifiedFollowing]. (required).</param>
        ...
        public FlowConventions(string currency = default(string), string paymentFrequency = default(string), string dayCountConvention = default(string), string rollConvention = default(string), List<string> paymentCalendars = default(List<string>), List<string> resetCalendars = default(List<string>), int settleDays = default(int), int resetDays = default(int), bool? leapDaysIncluded = default(bool?), string accrualDateAdjustment = default(string), string scope = default(string), string code = default(string))
        {
        ...
        /// </summary>
        /// <value>When generating a set of dates, what convention should be used for adjusting dates that coincide with a non-business day.    Supported string (enumeration) values are: [NoAdjustment, Previous, P, Following, F, ModifiedPrevious, MP, ModifiedFollowing, MF, HalfMonthModifiedFollowing].</value>
