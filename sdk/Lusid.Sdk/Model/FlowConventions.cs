...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FlowConventions :  IEquatable<FlowConventions>
    {
        ...
        public DayCountBasisEnum DayCountBasis { get; set; }
        /// <summary>
        ...
        /// <param name="dayCountBasis">When calculating the fraction of a year between two dates, what convention is used to represent the number of days in a year  and difference between them. (required).</param>
        ...
        /// <param name="holidayCalendars">A comma separated string denoting holiday calendars that apply to generation and payment. (required).</param>
        public FlowConventions(string currency = default(string), Tenor paymentFrequency = default(Tenor), DayCountBasisEnum dayCountBasis = default(DayCountBasisEnum), RollConventionEnum rollConvention = default(RollConventionEnum), string holidayCalendars = default(string))
        {
            ...
            // to ensure "dayCountBasis" is required (not null)
            if (dayCountBasis == null)
            {
                throw new InvalidDataException("dayCountBasis is a required property for FlowConventions and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// A comma separated string denoting holiday calendars that apply to generation and payment.
        /// </summary>
        /// <value>A comma separated string denoting holiday calendars that apply to generation and payment.</value>
        ...
        public bool Equals(FlowConventions input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.HolidayCalendars.Equals(input.HolidayCalendars))
                );
        }
