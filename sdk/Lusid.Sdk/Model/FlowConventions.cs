...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FlowConventions :  IEquatable<FlowConventions>
    {
        ...
        public FlowConventions(string scope = default(string), string code = default(string), string currency = default(string), Tenor paymentFrequency = default(Tenor), DayCountConventionEnum dayCountConvention = default(DayCountConventionEnum), RollConventionEnum rollConvention = default(RollConventionEnum), List<string> holidayCalendars = default(List<string>), int? settleDays = default(int?), int? resetDays = default(int?))
        {
            this.Scope = scope;
            this.Code = code;
