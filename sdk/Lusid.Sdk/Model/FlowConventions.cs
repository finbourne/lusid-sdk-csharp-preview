...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FlowConventions :  IEquatable<FlowConventions>
    {
        ...
        public FlowConventions(string currency = default(string), string paymentFrequency = default(string), DayCountConventionEnum dayCountConvention = default(DayCountConventionEnum), RollConventionEnum rollConvention = default(RollConventionEnum), List<string> holidayCalendars = default(List<string>), int? settleDays = default(int?), int? resetDays = default(int?), string scope = default(string), string code = default(string))
        {
            ...
            if (settleDays == null)
            {
                throw new InvalidDataException("settleDays is a required property for FlowConventions and cannot be null");
            }
            else
            {
            ...
            if (resetDays == null)
            {
                throw new InvalidDataException("resetDays is a required property for FlowConventions and cannot be null");
            }
            else
            {
