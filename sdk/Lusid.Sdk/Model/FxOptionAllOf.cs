...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxOptionAllOf : IEquatable<FxOptionAllOf>
    {
        ...
        public FxOptionAllOf(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset optionMaturityDate = default(DateTimeOffset), DateTimeOffset optionSettlementDate = default(DateTimeOffset), bool isDeliveryNotCash = default(bool), bool isCallNotPut = default(bool), decimal strike = default(decimal), string domCcy = default(string), decimal? domAmount = default(decimal?), string fgnCcy = default(string), Premium premium = default(Premium), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
