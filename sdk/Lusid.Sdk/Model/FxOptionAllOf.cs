...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxOptionAllOf : IEquatable<FxOptionAllOf>
    {
        ...
        public FxOptionAllOf(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset optionMaturityDate = default(DateTimeOffset), DateTimeOffset optionSettlementDate = default(DateTimeOffset), bool isDeliveryNotCash = default(bool), bool isCallNotPut = default(bool), decimal strike = default(decimal), string domCcy = default(string), decimal? domAmount = default(decimal?), string fgnCcy = default(string), Premium premium = default(Premium), decimal? fgnAmount = default(decimal?), string exerciseType = default(string), bool isPayoffDigital = default(bool), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for FxOptionAllOf and cannot be null");
            // to ensure "fgnCcy" is required (not null)
            this.FgnCcy = fgnCcy ?? throw new ArgumentNullException("fgnCcy is a required property for FxOptionAllOf and cannot be null");
