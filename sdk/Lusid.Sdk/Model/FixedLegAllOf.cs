...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FixedLegAllOf :  IEquatable<FixedLegAllOf>
    {
        ...
        public FixedLegAllOf(decimal? notional = default(decimal?), DateTimeOffset? maturityDate = default(DateTimeOffset?), DateTimeOffset? startDate = default(DateTimeOffset?), LegDefinition legDefinition = default(LegDefinition), FixedLegAllOfOverrides overrides = default(FixedLegAllOfOverrides), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            if (overrides == null)
            {
                throw new InvalidDataException("overrides is a required property for FixedLegAllOf and cannot be null");
            }
            else
            {
