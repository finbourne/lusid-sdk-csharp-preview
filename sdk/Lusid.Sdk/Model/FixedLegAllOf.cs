...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FixedLegAllOf :  IEquatable<FixedLegAllOf>
    {
        ...
        public FixedLegAllOf(decimal? notional = default(decimal?), DateTimeOffset? maturityDate = default(DateTimeOffset?), DateTimeOffset? startDate = default(DateTimeOffset?), LegDefinition legDefinition = default(LegDefinition), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
