...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateRecipeRequest : IEquatable<CreateRecipeRequest>
    {
        ...
        public CreateRecipeRequest(List<string> recipeCreationMarketDataScopes = default(List<string>), ResourceId recipeId = default(ResourceId), ConfigurationRecipe inlineRecipe = default(ConfigurationRecipe), DateTimeOffset? asAt = default(DateTimeOffset?), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            ...
            this.RecipeCreationMarketDataScopes = recipeCreationMarketDataScopes ?? throw new ArgumentNullException("recipeCreationMarketDataScopes is a required property for CreateRecipeRequest and cannot be null");
            // to ensure "effectiveAt" is required (not null)
            this.EffectiveAt = effectiveAt ?? throw new ArgumentNullException("effectiveAt is a required property for CreateRecipeRequest and cannot be null");
        ...
        [DataMember(Name = "recipeCreationMarketDataScopes", IsRequired = true, EmitDefaultValue = false)]
