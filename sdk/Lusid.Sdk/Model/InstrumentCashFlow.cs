...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentCashFlow :  IEquatable<InstrumentCashFlow>
    {
        ...
        public InstrumentCashFlow(DateTimeOffset? paymentDate = default(DateTimeOffset?), decimal? amount = default(decimal?), string currency = default(string), string sourceTransactionId = default(string), string sourceInstrumentId = default(string), Dictionary<string, string> diagnostics = default(Dictionary<string, string>), List<Link> links = default(List<Link>))
        {
            ...
            if (paymentDate == null)
            {
                throw new InvalidDataException("paymentDate is a required property for InstrumentCashFlow and cannot be null");
            }
            else
            {
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for InstrumentCashFlow and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceTransactionId is a required property for InstrumentCashFlow and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceInstrumentId is a required property for InstrumentCashFlow and cannot be null");
            }
            else
            {
            ...
            if (diagnostics == null)
            {
                throw new InvalidDataException("diagnostics is a required property for InstrumentCashFlow and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="sourceInstrumentId", EmitDefaultValue=false)]
