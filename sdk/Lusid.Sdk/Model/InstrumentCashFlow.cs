...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentCashFlow : IEquatable<InstrumentCashFlow>
    {
        ...
        public InstrumentCashFlow(DateTimeOffset paymentDate = default(DateTimeOffset), decimal? amount = default(decimal?), string currency = default(string), string sourceTransactionId = default(string), string sourceInstrumentScope = default(string), string sourceInstrumentId = default(string), Dictionary<string, string> diagnostics = default(Dictionary<string, string>), List<Link> links = default(List<Link>))
        {
            ...
            this.SourceInstrumentScope = sourceInstrumentScope ?? throw new ArgumentNullException("sourceInstrumentScope is a required property for InstrumentCashFlow and cannot be null");
        ...
        [DataMember(Name = "sourceInstrumentScope", IsRequired = true, EmitDefaultValue = false)]
