...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfMovedOrderToDifferentBlockResponse : IEquatable<ResourceListOfMovedOrderToDifferentBlockResponse>
    {
        /// <summary>
        ...
        public ResourceListOfMovedOrderToDifferentBlockResponse(List<MovedOrderToDifferentBlockResponse> values = default(List<MovedOrderToDifferentBlockResponse>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfMovedOrderToDifferentBlockResponse and cannot be null");
            this.Href = href;
            this.Links = links;
