...
namespace Lusid.Sdk.Model
{
    ...
    public partial class VendorDependency : EconomicDependency, IEquatable<VendorDependency>
    {
        /// <summary>
        ...
        /// <param name="dependencyType">The available values are: Opaque, Cash, Discounting, EquityCurve, EquityVol, Fx, FxForwards, FxVol, IndexProjection, IrVol, Quote, Vendor (required) (default to &quot;VendorDependency&quot;).</param>
        public VendorDependency(string vendorName = default(string), List<string> vendorPath = default(List<string>), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base(dependencyType)
        {
            ...
            this.VendorName = vendorName ?? throw new ArgumentNullException("vendorName is a required property for VendorDependency and cannot be null");
            // to ensure "vendorPath" is required (not null)
            this.VendorPath = vendorPath ?? throw new ArgumentNullException("vendorPath is a required property for VendorDependency and cannot be null");
            this.Date = date;
        }
        ...
        [DataMember(Name = "vendorName", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "vendorPath", IsRequired = true, EmitDefaultValue = false)]
