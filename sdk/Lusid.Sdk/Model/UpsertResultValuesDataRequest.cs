...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertResultValuesDataRequest : IEquatable<UpsertResultValuesDataRequest>
    {
        /// <summary>
        ...
        public UpsertResultValuesDataRequest(StructuredResultDataId documentId = default(StructuredResultDataId), Dictionary<string, string> key = default(Dictionary<string, string>), string dataAddress = default(string), ResultValue resultValue = default(ResultValue))
        {
            ...
            this.DocumentId = documentId ?? throw new ArgumentNullException("documentId is a required property for UpsertResultValuesDataRequest and cannot be null");
            this.Key = key;
