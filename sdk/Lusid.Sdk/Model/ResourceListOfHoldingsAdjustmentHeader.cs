...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfHoldingsAdjustmentHeader :  IEquatable<ResourceListOfHoldingsAdjustmentHeader>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfHoldingsAdjustmentHeader(List<HoldingsAdjustmentHeader> values = default(List<HoldingsAdjustmentHeader>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfHoldingsAdjustmentHeader and cannot be null");;
            this.Href = href;
            this.Links = links;
        }
