...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Bond : LusidInstrument, IEquatable<Bond>
    {
        ...
        /// Initializes a new instance of the <see cref="Bond" /> class.
        /// </summary>
        /// <param name="startDate">The start date of the instrument. This is normally synonymous with the trade-date. If settle days &#x3D; 0 then this is the initial accrual date of the bond. (required).</param>
        ...
        /// <param name="initialCouponDate">The initial coupon date is in fact the previous coupon pay date in the bond schedule. This date specifies the start of the coupon period in which the ex-dividend date lies..</param>
        ...
        /// </summary>
        /// <value>The start date of the instrument. This is normally synonymous with the trade-date. If settle days &#x3D; 0 then this is the initial accrual date of the bond.</value>
        ...
        /// </summary>
        /// <value>The initial coupon date is in fact the previous coupon pay date in the bond schedule. This date specifies the start of the coupon period in which the ex-dividend date lies.</value>
