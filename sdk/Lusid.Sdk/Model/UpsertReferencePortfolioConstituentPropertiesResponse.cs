...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertReferencePortfolioConstituentPropertiesResponse : IEquatable<UpsertReferencePortfolioConstituentPropertiesResponse>
    {
        /// <summary>
        ...
        public UpsertReferencePortfolioConstituentPropertiesResponse(string href = default(string), Version version = default(Version), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), List<Link> links = default(List<Link>))
        {
            this.Href = href;
