...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CustodianAccountRequest : IEquatable<CustodianAccountRequest>
    {
        /// <summary>
        ...
        public CustodianAccountRequest(string scope = default(string), string code = default(string), string status = default(string), string accountNumber = default(string), string accountName = default(string), string accountingMethod = default(string), string currency = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), TypedResourceId custodianIdentifier = default(TypedResourceId))
        {
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for CustodianAccountRequest and cannot be null");
            // to ensure "accountNumber" is required (not null)
            this.AccountNumber = accountNumber ?? throw new ArgumentNullException("accountNumber is a required property for CustodianAccountRequest and cannot be null");
            // to ensure "accountName" is required (not null)
            this.AccountName = accountName ?? throw new ArgumentNullException("accountName is a required property for CustodianAccountRequest and cannot be null");
            // to ensure "accountingMethod" is required (not null)
            this.AccountingMethod = accountingMethod ?? throw new ArgumentNullException("accountingMethod is a required property for CustodianAccountRequest and cannot be null");
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for CustodianAccountRequest and cannot be null");
            // to ensure "custodianIdentifier" is required (not null)
            this.CustodianIdentifier = custodianIdentifier ?? throw new ArgumentNullException("custodianIdentifier is a required property for CustodianAccountRequest and cannot be null");
            this.Scope = scope;
            this.Status = status;
        ...
        /// </summary>
        [DataMember(Name = "custodianIdentifier", IsRequired = true, EmitDefaultValue = false)]
