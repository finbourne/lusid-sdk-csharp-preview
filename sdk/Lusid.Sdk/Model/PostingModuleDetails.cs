...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PostingModuleDetails : IEquatable<PostingModuleDetails>
    {
        /// <summary>
        ...
        public PostingModuleDetails(ResourceId chartOfAccountsId = default(ResourceId), string displayName = default(string), string description = default(string), string status = default(string))
        {
            ...
            this.ChartOfAccountsId = chartOfAccountsId ?? throw new ArgumentNullException("chartOfAccountsId is a required property for PostingModuleDetails and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for PostingModuleDetails and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for PostingModuleDetails and cannot be null");
