...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TermDepositInterestEventAllOf : IEquatable<TermDepositInterestEventAllOf>
    {
        /// <summary>
        ...
        public TermDepositInterestEventAllOf(string currency = default(string), decimal? interestPerUnit = default(decimal?), DateTimeOffset paymentDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            ...
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for TermDepositInterestEventAllOf and cannot be null");
