...
namespace Lusid.Sdk.Model
{
    ...
    public partial class LoanFacilityAllOf : IEquatable<LoanFacilityAllOf>
    {
        /// <summary>
        ...
        public LoanFacilityAllOf(DateTimeOffset startDate = default(DateTimeOffset), string domCcy = default(string), string facilityPortfolioScope = default(string), string facilityPortfolioCode = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for LoanFacilityAllOf and cannot be null");
            // to ensure "facilityPortfolioScope" is required (not null)
            this.FacilityPortfolioScope = facilityPortfolioScope ?? throw new ArgumentNullException("facilityPortfolioScope is a required property for LoanFacilityAllOf and cannot be null");
            // to ensure "facilityPortfolioCode" is required (not null)
            this.FacilityPortfolioCode = facilityPortfolioCode ?? throw new ArgumentNullException("facilityPortfolioCode is a required property for LoanFacilityAllOf and cannot be null");
