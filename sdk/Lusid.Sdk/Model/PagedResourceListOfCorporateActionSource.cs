...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfCorporateActionSource :  IEquatable<PagedResourceListOfCorporateActionSource>
    {
        ...
        public PagedResourceListOfCorporateActionSource(List<CorporateActionSource> values = default(List<CorporateActionSource>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for PagedResourceListOfCorporateActionSource and cannot be null");
            }
            else
            {
                this.Values = values;
