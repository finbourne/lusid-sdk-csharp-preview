...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InterestRateSwaption : LusidInstrument, IEquatable<InterestRateSwaption>
    {
        ...
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, CrossCurrencySwap, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption (required) (default to &quot;InterestRateSwaption&quot;).</param>
        public InterestRateSwaption(DateTimeOffset startDate = default(DateTimeOffset), string payOrReceiveFixed = default(string), string deliveryMethod = default(string), InterestRateSwap swap = default(InterestRateSwap), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            this.StartDate = startDate;
            // to ensure "payOrReceiveFixed" is required (not null)
            this.PayOrReceiveFixed = payOrReceiveFixed ?? throw new ArgumentNullException("payOrReceiveFixed is a required property for InterestRateSwaption and cannot be null");
            // to ensure "deliveryMethod" is required (not null)
            this.DeliveryMethod = deliveryMethod ?? throw new ArgumentNullException("deliveryMethod is a required property for InterestRateSwaption and cannot be null");
