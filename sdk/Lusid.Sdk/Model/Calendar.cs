...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Calendar : IEquatable<Calendar>
    {
        ...
        public Calendar(string href = default(string), ResourceId id = default(ResourceId), string type = default(string), WeekendMask weekendMask = default(WeekendMask), string sourceProvider = default(string), List<Property> properties = default(List<Property>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Calendar and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for Calendar and cannot be null");
            // to ensure "weekendMask" is required (not null)
            this.WeekendMask = weekendMask ?? throw new ArgumentNullException("weekendMask is a required property for Calendar and cannot be null");
            // to ensure "sourceProvider" is required (not null)
            this.SourceProvider = sourceProvider ?? throw new ArgumentNullException("sourceProvider is a required property for Calendar and cannot be null");
