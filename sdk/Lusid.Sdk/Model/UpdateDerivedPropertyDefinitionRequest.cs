...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpdateDerivedPropertyDefinitionRequest : IEquatable<UpdateDerivedPropertyDefinitionRequest>
    {
        /// <summary>
        ...
        public UpdateDerivedPropertyDefinitionRequest(string displayName = default(string), ResourceId dataTypeId = default(ResourceId), string propertyDescription = default(string), string derivationFormula = default(string))
        {
            ...
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for UpdateDerivedPropertyDefinitionRequest and cannot be null");
            // to ensure "dataTypeId" is required (not null)
            this.DataTypeId = dataTypeId ?? throw new ArgumentNullException("dataTypeId is a required property for UpdateDerivedPropertyDefinitionRequest and cannot be null");
            // to ensure "derivationFormula" is required (not null)
            this.DerivationFormula = derivationFormula ?? throw new ArgumentNullException("derivationFormula is a required property for UpdateDerivedPropertyDefinitionRequest and cannot be null");
        ...
        [DataMember(Name = "derivationFormula", IsRequired = true, EmitDefaultValue = false)]
