...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfProcessedCommand")]
    public partial class ResourceListOfProcessedCommand : IEquatable<ResourceListOfProcessedCommand>
    {
        ...
        public ResourceListOfProcessedCommand(List<ProcessedCommand> values = default(List<ProcessedCommand>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfProcessedCommand and cannot be null");
            this.Href = href;
            this.Links = links;
