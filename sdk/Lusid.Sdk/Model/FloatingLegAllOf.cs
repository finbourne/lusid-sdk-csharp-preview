...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FloatingLegAllOf :  IEquatable<FloatingLegAllOf>
    {
        ...
        public FloatingLegAllOf(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), LegDefinition legDefinition = default(LegDefinition), decimal? notional = default(decimal?), FixedLegAllOfOverrides overrides = default(FixedLegAllOfOverrides), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for FloatingLegAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for FloatingLegAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("legDefinition is a required property for FloatingLegAllOf and cannot be null");
            }
            else
            {
            ...
            if (notional == null)
            {
                throw new InvalidDataException("notional is a required property for FloatingLegAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instrumentType is a required property for FloatingLegAllOf and cannot be null");
            }
            else
            {
