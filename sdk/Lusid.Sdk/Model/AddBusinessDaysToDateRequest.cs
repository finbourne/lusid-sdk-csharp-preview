...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AddBusinessDaysToDateRequest :  IEquatable<AddBusinessDaysToDateRequest>
    {
        ...
        {
            // to ensure "businessDayOffset" is required (not null)
            if (businessDayOffset == null)
            {
                throw new InvalidDataException("businessDayOffset is a required property for AddBusinessDaysToDateRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("holidayCodes is a required property for AddBusinessDaysToDateRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="businessDayOffset", EmitDefaultValue=false)]
        public int? BusinessDayOffset { get; set; }

        /// <summary>
        /// Gets or Sets HolidayCodes
        /// </summary>
        [DataMember(Name="holidayCodes", EmitDefaultValue=false)]
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.BusinessDayOffset != null)
