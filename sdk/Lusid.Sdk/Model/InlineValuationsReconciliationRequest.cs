...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InlineValuationsReconciliationRequest :  IEquatable<InlineValuationsReconciliationRequest>
    {
        ...
        public InlineValuationsReconciliationRequest(InlineValuationReconciliationRequest left = default(InlineValuationReconciliationRequest), InlineValuationReconciliationRequest right = default(InlineValuationReconciliationRequest), List<ReconciliationLeftRightAddressKeyPair> leftToRightMapping = default(List<ReconciliationLeftRightAddressKeyPair>), List<string> preserveKeys = default(List<string>))
        {
