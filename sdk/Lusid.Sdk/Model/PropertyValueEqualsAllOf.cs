...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PropertyValueEquals_allOf")]
    public partial class PropertyValueEqualsAllOf : IEquatable<PropertyValueEqualsAllOf>
    {
        /// <summary>
        /// The available values are: PropertyValueEquals, PropertyValueIn
        /// </summary>
        /// <value>The available values are: PropertyValueEquals, PropertyValueIn</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyValueEqualsAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PropertyValueEqualsAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyValueEqualsAllOf" /> class.
        /// </summary>
        ...
        /// <param name="criterionType">The available values are: PropertyValueEquals, PropertyValueIn (required).</param>
        public PropertyValueEqualsAllOf(string propertyKey = default(string), string value = default(string), CriterionTypeEnum criterionType = default(CriterionTypeEnum))
        {
            // to ensure "propertyKey" is required (not null)
            this.PropertyKey = propertyKey ?? throw new ArgumentNullException("propertyKey is a required property for PropertyValueEqualsAllOf and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for PropertyValueEqualsAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertyValueEqualsAllOf {\n");
        ...
        {
            return this.Equals(input as PropertyValueEqualsAllOf);
        }

        /// <summary>
        /// Returns true if PropertyValueEqualsAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertyValueEqualsAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertyValueEqualsAllOf input)
        {
            if (input == null)
                return false;
