...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfString :  IEquatable<ResourceListOfString>
    {
        ...
        public ResourceListOfString(List<string> values = default(List<string>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
