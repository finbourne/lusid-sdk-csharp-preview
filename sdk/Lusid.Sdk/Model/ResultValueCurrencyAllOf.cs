...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResultValueCurrency_allOf")]
    public partial class ResultValueCurrencyAllOf : IEquatable<ResultValueCurrencyAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultValueCurrencyAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResultValueCurrencyAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultValueCurrencyAllOf" /> class.
        /// </summary>
        ...
        public ResultValueCurrencyAllOf(string value = default(string), ResultValueTypeEnum resultValueType = default(ResultValueTypeEnum))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResultValueCurrencyAllOf {\n");
        ...
        {
            return this.Equals(input as ResultValueCurrencyAllOf);
        }

        /// <summary>
        /// Returns true if ResultValueCurrencyAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ResultValueCurrencyAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResultValueCurrencyAllOf input)
        {
            if (input == null)
                return false;
