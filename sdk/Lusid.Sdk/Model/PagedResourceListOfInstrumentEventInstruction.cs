...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfInstrumentEventInstruction : IEquatable<PagedResourceListOfInstrumentEventInstruction>
    {
        /// <summary>
        ...
        public PagedResourceListOfInstrumentEventInstruction(string nextPage = default(string), string previousPage = default(string), List<InstrumentEventInstruction> values = default(List<InstrumentEventInstruction>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfInstrumentEventInstruction and cannot be null");
