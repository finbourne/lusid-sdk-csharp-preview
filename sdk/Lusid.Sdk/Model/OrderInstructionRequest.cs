...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OrderInstructionRequest : IEquatable<OrderInstructionRequest>
    {
        /// <summary>
        ...
        public OrderInstructionRequest(ResourceId id = default(ResourceId), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for OrderInstructionRequest and cannot be null");
