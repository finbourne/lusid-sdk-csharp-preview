...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfPackage")]
    public partial class PagedResourceListOfPackage : IEquatable<PagedResourceListOfPackage>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfPackage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfPackage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfPackage" /> class.
        /// </summary>
        ...
        public PagedResourceListOfPackage(string nextPage = default(string), string previousPage = default(string), List<Package> values = default(List<Package>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfPackage and cannot be null");
        ...
        {
            return this.Equals(input as PagedResourceListOfPackage);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfPackage instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfPackage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfPackage input)
        {
            if (input == null)
                return false;
