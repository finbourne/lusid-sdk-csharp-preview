...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReconcileNumericRuleAllOf : IEquatable<ReconcileNumericRuleAllOf>
    {
        /// <summary>
        ...
        public ReconcileNumericRuleAllOf(ComparisonTypeEnum comparisonType = default(ComparisonTypeEnum), decimal tolerance = default(decimal), AggregateSpec appliesTo = default(AggregateSpec), RuleTypeEnum ruleType = default(RuleTypeEnum))
        {
            ...
            this.AppliesTo = appliesTo ?? throw new ArgumentNullException("appliesTo is a required property for ReconcileNumericRuleAllOf and cannot be null");
