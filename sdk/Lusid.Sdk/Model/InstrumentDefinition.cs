...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentDefinition :  IEquatable<InstrumentDefinition>
    {
        ...
        /// <param name="identifiers">Required. A set of identifiers that identify this instrument (BBG123456)  with the key being the type of identifier (RIC, FIGI).  Must include atleast one unique identifier. (required).</param>
        /// <param name="properties">Optional. A collection of properties to upsert on the instrument..</param>
        /// <param name="lookThroughPortfolioId">lookThroughPortfolioId.</param>
        /// <param name="definition">definition.</param>
        public InstrumentDefinition(string name = default(string), Dictionary<string, InstrumentIdValue> identifiers = default(Dictionary<string, InstrumentIdValue>), List<InstrumentProperty> properties = default(List<InstrumentProperty>), ResourceId lookThroughPortfolioId = default(ResourceId), InstrumentEconomicDefinition definition = default(InstrumentEconomicDefinition))
        {
        ...
        /// <summary>
        /// Required. A set of identifiers that identify this instrument (BBG123456)  with the key being the type of identifier (RIC, FIGI).  Must include atleast one unique identifier.
        /// </summary>
        /// <value>Required. A set of identifiers that identify this instrument (BBG123456)  with the key being the type of identifier (RIC, FIGI).  Must include atleast one unique identifier.</value>
        ...
        /// </summary>
        /// <value>Optional. A collection of properties to upsert on the instrument.</value>
