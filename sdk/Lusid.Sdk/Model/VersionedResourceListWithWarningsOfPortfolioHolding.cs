...
namespace Lusid.Sdk.Model
{
    ...
    public partial class VersionedResourceListWithWarningsOfPortfolioHolding : IEquatable<VersionedResourceListWithWarningsOfPortfolioHolding>
    {
        /// <summary>
        ...
        public VersionedResourceListWithWarningsOfPortfolioHolding(Version version = default(Version), List<PortfolioHolding> values = default(List<PortfolioHolding>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Warning> warnings = default(List<Warning>), List<Link> links = default(List<Link>))
        {
            // to ensure "version" is required (not null)
            this.Version = version ?? throw new ArgumentNullException("version is a required property for VersionedResourceListWithWarningsOfPortfolioHolding and cannot be null");
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for VersionedResourceListWithWarningsOfPortfolioHolding and cannot be null");
            this.Href = href;
