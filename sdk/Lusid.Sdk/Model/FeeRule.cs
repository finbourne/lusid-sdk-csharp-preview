...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FeeRule : IEquatable<FeeRule>
    {
        /// <summary>
        ...
        public FeeRule(string code = default(string), string transactionPropertyKey = default(string), string transactionType = default(string), string country = default(string), string counterparty = default(string), string transactionCurrency = default(string), string settlementCurrency = default(string), string executionBroker = default(string), string custodian = default(string), string exchange = default(string), CalculationInfo fee = default(CalculationInfo), CalculationInfo minFee = default(CalculationInfo), CalculationInfo maxFee = default(CalculationInfo), Dictionary<string, string> additionalKeys = default(Dictionary<string, string>), string description = default(string), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for FeeRule and cannot be null");
            // to ensure "transactionPropertyKey" is required (not null)
            this.TransactionPropertyKey = transactionPropertyKey ?? throw new ArgumentNullException("transactionPropertyKey is a required property for FeeRule and cannot be null");
            // to ensure "transactionType" is required (not null)
            this.TransactionType = transactionType ?? throw new ArgumentNullException("transactionType is a required property for FeeRule and cannot be null");
            // to ensure "country" is required (not null)
            this.Country = country ?? throw new ArgumentNullException("country is a required property for FeeRule and cannot be null");
            // to ensure "counterparty" is required (not null)
            this.Counterparty = counterparty ?? throw new ArgumentNullException("counterparty is a required property for FeeRule and cannot be null");
            // to ensure "transactionCurrency" is required (not null)
            this.TransactionCurrency = transactionCurrency ?? throw new ArgumentNullException("transactionCurrency is a required property for FeeRule and cannot be null");
            // to ensure "settlementCurrency" is required (not null)
            this.SettlementCurrency = settlementCurrency ?? throw new ArgumentNullException("settlementCurrency is a required property for FeeRule and cannot be null");
            // to ensure "executionBroker" is required (not null)
            this.ExecutionBroker = executionBroker ?? throw new ArgumentNullException("executionBroker is a required property for FeeRule and cannot be null");
            // to ensure "custodian" is required (not null)
            this.Custodian = custodian ?? throw new ArgumentNullException("custodian is a required property for FeeRule and cannot be null");
            // to ensure "exchange" is required (not null)
            this.Exchange = exchange ?? throw new ArgumentNullException("exchange is a required property for FeeRule and cannot be null");
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for FeeRule and cannot be null");
            this.MinFee = minFee;
            this.MaxFee = maxFee;
        ...
        /// </summary>
        [DataMember(Name = "transactionPropertyKey", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "transactionCurrency", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "executionBroker", IsRequired = true, EmitDefaultValue = false)]
