...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceSummaryRuleResultRequest : IEquatable<ComplianceSummaryRuleResultRequest>
    {
        /// <summary>
        ...
        public ComplianceSummaryRuleResultRequest(ResourceId ruleId = default(ResourceId), ResourceId templateId = default(ResourceId), string variation = default(string), string ruleStatus = default(string), List<ResourceId> affectedPortfolios = default(List<ResourceId>), List<ResourceId> affectedOrders = default(List<ResourceId>), Dictionary<string, string> parametersUsed = default(Dictionary<string, string>), List<ComplianceRuleBreakdownRequest> ruleBreakdown = default(List<ComplianceRuleBreakdownRequest>))
        {
            ...
            this.RuleId = ruleId ?? throw new ArgumentNullException("ruleId is a required property for ComplianceSummaryRuleResultRequest and cannot be null");
            // to ensure "templateId" is required (not null)
            this.TemplateId = templateId ?? throw new ArgumentNullException("templateId is a required property for ComplianceSummaryRuleResultRequest and cannot be null");
            // to ensure "variation" is required (not null)
            this.Variation = variation ?? throw new ArgumentNullException("variation is a required property for ComplianceSummaryRuleResultRequest and cannot be null");
            // to ensure "ruleStatus" is required (not null)
            this.RuleStatus = ruleStatus ?? throw new ArgumentNullException("ruleStatus is a required property for ComplianceSummaryRuleResultRequest and cannot be null");
            // to ensure "affectedPortfolios" is required (not null)
            this.AffectedPortfolios = affectedPortfolios ?? throw new ArgumentNullException("affectedPortfolios is a required property for ComplianceSummaryRuleResultRequest and cannot be null");
            // to ensure "affectedOrders" is required (not null)
            this.AffectedOrders = affectedOrders ?? throw new ArgumentNullException("affectedOrders is a required property for ComplianceSummaryRuleResultRequest and cannot be null");
            // to ensure "parametersUsed" is required (not null)
            this.ParametersUsed = parametersUsed ?? throw new ArgumentNullException("parametersUsed is a required property for ComplianceSummaryRuleResultRequest and cannot be null");
            // to ensure "ruleBreakdown" is required (not null)
            this.RuleBreakdown = ruleBreakdown ?? throw new ArgumentNullException("ruleBreakdown is a required property for ComplianceSummaryRuleResultRequest and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "variation", IsRequired = true, EmitDefaultValue = false)]
        public string Variation { get; set; }

        /// <summary>
        /// Gets or Sets RuleStatus
        /// </summary>
        [DataMember(Name = "ruleStatus", IsRequired = true, EmitDefaultValue = false)]
        public string RuleStatus { get; set; }

        /// <summary>
        /// Gets or Sets AffectedPortfolios
        /// </summary>
        [DataMember(Name = "affectedPortfolios", IsRequired = true, EmitDefaultValue = false)]
        public List<ResourceId> AffectedPortfolios { get; set; }

        /// <summary>
        /// Gets or Sets AffectedOrders
        /// </summary>
        [DataMember(Name = "affectedOrders", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "ruleBreakdown", IsRequired = true, EmitDefaultValue = false)]
