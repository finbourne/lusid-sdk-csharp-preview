...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashElection : IEquatable<CashElection>
    {
        /// <summary>
        ...
        public CashElection(string electionKey = default(string), decimal? exchangeRate = default(decimal?), decimal? dividendRate = default(decimal?), bool isChosen = default(bool), bool isDeclared = default(bool), bool isDefault = default(bool), string dividendCurrency = default(string))
        {
            ...
            this.ElectionKey = electionKey ?? throw new ArgumentNullException("electionKey is a required property for CashElection and cannot be null");
            // to ensure "dividendCurrency" is required (not null)
            this.DividendCurrency = dividendCurrency ?? throw new ArgumentNullException("dividendCurrency is a required property for CashElection and cannot be null");
        ...
        [DataMember(Name = "electionKey", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "dividendCurrency", IsRequired = true, EmitDefaultValue = false)]
