...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfAccessMetadataValueOf")]
    public partial class ResourceListOfAccessMetadataValueOf : IEquatable<ResourceListOfAccessMetadataValueOf>
    {
        ...
        protected ResourceListOfAccessMetadataValueOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfAccessMetadataValueOf" /> class.
        /// </summary>
        ...
        public ResourceListOfAccessMetadataValueOf(List<List<AccessMetadataValue>> values = default(List<List<AccessMetadataValue>>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfAccessMetadataValueOf and cannot be null");
            this.Href = href;
            this.Links = links;
