...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfAccessMetadataValueOf :  IEquatable<ResourceListOfAccessMetadataValueOf>
    {
        ...
        public ResourceListOfAccessMetadataValueOf(List<List<AccessMetadataValue>> values = default(List<List<AccessMetadataValue>>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
