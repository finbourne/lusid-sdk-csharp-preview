...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ComplianceRuleUpsertResponse")]
    public partial class ComplianceRuleUpsertResponse : IEquatable<ComplianceRuleUpsertResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplianceRuleUpsertResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ComplianceRuleUpsertResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplianceRuleUpsertResponse" /> class.
        /// </summary>
        /// <param name="values">values (required).</param>
        public ComplianceRuleUpsertResponse(Dictionary<string, ComplianceRule> values = default(Dictionary<string, ComplianceRule>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ComplianceRuleUpsertResponse and cannot be null");
        }
        ...
        public Dictionary<string, ComplianceRule> Values { get; set; }
        ...
        {
            return this.Equals(input as ComplianceRuleUpsertResponse);
        }

        /// <summary>
        /// Returns true if ComplianceRuleUpsertResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ComplianceRuleUpsertResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComplianceRuleUpsertResponse input)
        {
            if (input == null)
                return false;
