...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfAggregatedReturn :  IEquatable<ResourceListOfAggregatedReturn>
    {
        ...
        public ResourceListOfAggregatedReturn(List<AggregatedReturn> values = default(List<AggregatedReturn>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfAggregatedReturn and cannot be null");
            }
            else
            {
                this.Values = values;
