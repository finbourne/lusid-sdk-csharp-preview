...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SetTransactionConfigurationAlias : IEquatable<SetTransactionConfigurationAlias>
    {
        /// <summary>
        ...
        public SetTransactionConfigurationAlias(string type = default(string), string description = default(string), string transactionClass = default(string), string transactionRole = default(string), bool isDefault = default(bool))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for SetTransactionConfigurationAlias and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for SetTransactionConfigurationAlias and cannot be null");
            // to ensure "transactionClass" is required (not null)
            this.TransactionClass = transactionClass ?? throw new ArgumentNullException("transactionClass is a required property for SetTransactionConfigurationAlias and cannot be null");
            // to ensure "transactionRole" is required (not null)
            this.TransactionRole = transactionRole ?? throw new ArgumentNullException("transactionRole is a required property for SetTransactionConfigurationAlias and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "transactionRole", IsRequired = true, EmitDefaultValue = false)]
