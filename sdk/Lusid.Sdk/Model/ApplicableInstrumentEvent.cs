...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ApplicableInstrumentEvent : IEquatable<ApplicableInstrumentEvent>
    {
        /// <summary>
        ...
        public ApplicableInstrumentEvent(ResourceId portfolioId = default(ResourceId), long holdingId = default(long), string lusidInstrumentId = default(string), string instrumentScope = default(string), string instrumentType = default(string), string instrumentEventType = default(string), string instrumentEventId = default(string), InstrumentEventHolder generatedEvent = default(InstrumentEventHolder), InstrumentEventHolder loadedEvent = default(InstrumentEventHolder), string appliedInstrumentEventInstructionId = default(string), List<Transaction> transactions = default(List<Transaction>))
        {
            ...
            this.PortfolioId = portfolioId ?? throw new ArgumentNullException("portfolioId is a required property for ApplicableInstrumentEvent and cannot be null");
            this.HoldingId = holdingId;
            // to ensure "lusidInstrumentId" is required (not null)
            this.LusidInstrumentId = lusidInstrumentId ?? throw new ArgumentNullException("lusidInstrumentId is a required property for ApplicableInstrumentEvent and cannot be null");
            // to ensure "instrumentScope" is required (not null)
            this.InstrumentScope = instrumentScope ?? throw new ArgumentNullException("instrumentScope is a required property for ApplicableInstrumentEvent and cannot be null");
            // to ensure "instrumentType" is required (not null)
            this.InstrumentType = instrumentType ?? throw new ArgumentNullException("instrumentType is a required property for ApplicableInstrumentEvent and cannot be null");
            // to ensure "instrumentEventType" is required (not null)
            this.InstrumentEventType = instrumentEventType ?? throw new ArgumentNullException("instrumentEventType is a required property for ApplicableInstrumentEvent and cannot be null");
            // to ensure "instrumentEventId" is required (not null)
            this.InstrumentEventId = instrumentEventId ?? throw new ArgumentNullException("instrumentEventId is a required property for ApplicableInstrumentEvent and cannot be null");
            // to ensure "generatedEvent" is required (not null)
            this.GeneratedEvent = generatedEvent ?? throw new ArgumentNullException("generatedEvent is a required property for ApplicableInstrumentEvent and cannot be null");
            // to ensure "loadedEvent" is required (not null)
            this.LoadedEvent = loadedEvent ?? throw new ArgumentNullException("loadedEvent is a required property for ApplicableInstrumentEvent and cannot be null");
            // to ensure "appliedInstrumentEventInstructionId" is required (not null)
            this.AppliedInstrumentEventInstructionId = appliedInstrumentEventInstructionId ?? throw new ArgumentNullException("appliedInstrumentEventInstructionId is a required property for ApplicableInstrumentEvent and cannot be null");
            // to ensure "transactions" is required (not null)
            this.Transactions = transactions ?? throw new ArgumentNullException("transactions is a required property for ApplicableInstrumentEvent and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "holdingId", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "instrumentEventId", IsRequired = true, EmitDefaultValue = false)]
        public string InstrumentEventId { get; set; }

        /// <summary>
        /// Gets or Sets GeneratedEvent
        /// </summary>
        [DataMember(Name = "generatedEvent", IsRequired = true, EmitDefaultValue = false)]
        public InstrumentEventHolder GeneratedEvent { get; set; }

        /// <summary>
        /// Gets or Sets LoadedEvent
        /// </summary>
        [DataMember(Name = "loadedEvent", IsRequired = true, EmitDefaultValue = false)]
        public InstrumentEventHolder LoadedEvent { get; set; }

        /// <summary>
        /// Gets or Sets AppliedInstrumentEventInstructionId
        /// </summary>
        [DataMember(Name = "appliedInstrumentEventInstructionId", IsRequired = true, EmitDefaultValue = false)]
