...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateReferencePortfolioRequest :  IEquatable<CreateReferencePortfolioRequest>
    {
        ...
        public CreateReferencePortfolioRequest(string displayName = default(string), string description = default(string), string code = default(string), DateTimeOffset? created = default(DateTimeOffset?), Dictionary<string, PerpetualPropertyValue> properties = default(Dictionary<string, PerpetualPropertyValue>))
        {
