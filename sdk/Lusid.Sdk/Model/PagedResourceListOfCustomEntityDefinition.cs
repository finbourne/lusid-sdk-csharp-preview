...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfCustomEntityDefinition")]
    public partial class PagedResourceListOfCustomEntityDefinition : IEquatable<PagedResourceListOfCustomEntityDefinition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfCustomEntityDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfCustomEntityDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfCustomEntityDefinition" /> class.
        /// </summary>
        ...
        public PagedResourceListOfCustomEntityDefinition(string nextPage = default(string), string previousPage = default(string), List<CustomEntityDefinition> values = default(List<CustomEntityDefinition>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfCustomEntityDefinition and cannot be null");
        ...
        public List<CustomEntityDefinition> Values { get; set; }
        ...
        {
            return this.Equals(input as PagedResourceListOfCustomEntityDefinition);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfCustomEntityDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfCustomEntityDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfCustomEntityDefinition input)
        {
            if (input == null)
                return false;
