...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AggregationRequest :  IEquatable<AggregationRequest>
    {
        ...
        public AggregationRequest(ResourceId recipeId = default(ResourceId), ConfigurationRecipe inlineRecipe = default(ConfigurationRecipe), DateTimeOffset? asAt = default(DateTimeOffset?), DateTimeOffset? effectiveFrom = default(DateTimeOffset?), DateTimeOffset? effectiveAt = default(DateTimeOffset?), List<AggregateSpec> metrics = default(List<AggregateSpec>), List<string> groupBy = default(List<string>), List<PropertyFilter> filters = default(List<PropertyFilter>), int? limit = default(int?), List<OrderBySpec> sort = default(List<OrderBySpec>))
        {
