...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AggregationRequest")]
    public partial class AggregationRequest : IEquatable<AggregationRequest>
    {
        ...
        public AggregationRequest(ResourceId recipeId = default(ResourceId), ConfigurationRecipe inlineRecipe = default(ConfigurationRecipe), DateTimeOffset? asAt = default(DateTimeOffset?), DateTimeOrCutLabel effectiveFrom = default(DateTimeOrCutLabel), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), List<AggregateSpec> metrics = default(List<AggregateSpec>), List<string> groupBy = default(List<string>), List<PropertyFilter> filters = default(List<PropertyFilter>), int? limit = default(int?), List<OrderBySpec> sort = default(List<OrderBySpec>), string reportCcy = default(string), string portfolioIdentifierCode = default(string))
        {
            ...
            this.EffectiveAt = effectiveAt ?? throw new ArgumentNullException("effectiveAt is a required property for AggregationRequest and cannot be null");
            // to ensure "metrics" is required (not null)
            this.Metrics = metrics ?? throw new ArgumentNullException("metrics is a required property for AggregationRequest and cannot be null");
        ...
        [DataMember(Name = "reportCcy", EmitDefaultValue = true)]
        public string ReportCcy { get; set; }

        /// <summary>
        /// String identifier for portfolio e.g. \&quot;SinglePortfolio\&quot; and \&quot;GroupPortfolio\&quot;
        /// </summary>
        /// <value>String identifier for portfolio e.g. \&quot;SinglePortfolio\&quot; and \&quot;GroupPortfolio\&quot;</value>
        [DataMember(Name = "portfolioIdentifierCode", EmitDefaultValue = true)]
        public string PortfolioIdentifierCode { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PortfolioIdentifierCode: ").Append(PortfolioIdentifierCode).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(AggregationRequest input)
        {
            ...
            return 
                ...
                (
                    this.PortfolioIdentifierCode == input.PortfolioIdentifierCode ||
                    (this.PortfolioIdentifierCode != null &&
                    this.PortfolioIdentifierCode.Equals(input.PortfolioIdentifierCode))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PortfolioIdentifierCode != null)
                    hashCode = hashCode * 59 + this.PortfolioIdentifierCode.GetHashCode();
                return hashCode;
            }
        }
