...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupReconciliationUserReviewComment : IEquatable<GroupReconciliationUserReviewComment>
    {
        /// <summary>
        ...
        public GroupReconciliationUserReviewComment(string commentText = default(string), string userId = default(string), DateTimeOffset asAtAdded = default(DateTimeOffset), DateTimeOffset asAtInvalid = default(DateTimeOffset))
        {
            ...
            this.CommentText = commentText ?? throw new ArgumentNullException("commentText is a required property for GroupReconciliationUserReviewComment and cannot be null");
            this.UserId = userId;
        ...
        [DataMember(Name = "commentText", IsRequired = true, EmitDefaultValue = false)]
