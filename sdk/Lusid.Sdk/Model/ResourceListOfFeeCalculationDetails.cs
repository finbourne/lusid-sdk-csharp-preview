...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfFeeCalculationDetails")]
    public partial class ResourceListOfFeeCalculationDetails : IEquatable<ResourceListOfFeeCalculationDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfFeeCalculationDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfFeeCalculationDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfFeeCalculationDetails" /> class.
        /// </summary>
        ...
        public ResourceListOfFeeCalculationDetails(List<FeeCalculationDetails> values = default(List<FeeCalculationDetails>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfFeeCalculationDetails and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<FeeCalculationDetails> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfFeeCalculationDetails {\n");
        ...
        {
            return this.Equals(input as ResourceListOfFeeCalculationDetails);
        }

        /// <summary>
        /// Returns true if ResourceListOfFeeCalculationDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfFeeCalculationDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfFeeCalculationDetails input)
        {
            if (input == null)
                return false;
