...
{
    /// <summary>
    /// MbsPrincipalWriteOffEventAllOf
    /// </summary>
    [DataContract(Name = "MbsPrincipalWriteOffEvent_allOf")]
    public partial class MbsPrincipalWriteOffEventAllOf : IEquatable<MbsPrincipalWriteOffEventAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MbsPrincipalWriteOffEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MbsPrincipalWriteOffEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MbsPrincipalWriteOffEventAllOf" /> class.
        /// </summary>
        ...
        /// <param name="paymentDate">The payment date of the principal that is written off (required).</param>
        /// <param name="currency">The currency in which the principal write off is notated (required).</param>
        /// <param name="principalPerUnit">The principal amount to be written off for each unit of the instrument held on the ex date (required).</param>
        /// <param name="instrumentEventType">The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent, SwapCashFlowEvent, SwapPrincipalEvent, CreditPremiumCashFlowEvent, CdsCreditEvent, CdxCreditEvent, MbsCouponEvent, MbsPrincipalEvent, BonusIssueEvent, MbsPrincipalWriteOffEvent, MbsInterestDeferralEvent (required).</param>
        public MbsPrincipalWriteOffEventAllOf(DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), decimal principalPerUnit = default(decimal), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            this.ExDate = exDate;
            this.PaymentDate = paymentDate;
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for MbsPrincipalWriteOffEventAllOf and cannot be null");
        ...
        /// </summary>
        /// <value>The payment date of the principal that is written off</value>
        ...
        /// </summary>
        /// <value>The currency in which the principal write off is notated</value>
        ...
        /// </summary>
        /// <value>The principal amount to be written off for each unit of the instrument held on the ex date</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MbsPrincipalWriteOffEventAllOf {\n");
        ...
        {
            return this.Equals(input as MbsPrincipalWriteOffEventAllOf);
        }

        /// <summary>
        /// Returns true if MbsPrincipalWriteOffEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MbsPrincipalWriteOffEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MbsPrincipalWriteOffEventAllOf input)
        {
            if (input == null)
                return false;
