...
namespace Lusid.Sdk.Model
{
    ...
    public partial class RulesInterval : IEquatable<RulesInterval>
    {
        /// <summary>
        ...
        public RulesInterval(DateRange effectiveRange = default(DateRange), List<AmortisationRule> rules = default(List<AmortisationRule>))
        {
            ...
            this.EffectiveRange = effectiveRange ?? throw new ArgumentNullException("effectiveRange is a required property for RulesInterval and cannot be null");
            // to ensure "rules" is required (not null)
            this.Rules = rules ?? throw new ArgumentNullException("rules is a required property for RulesInterval and cannot be null");
        }
