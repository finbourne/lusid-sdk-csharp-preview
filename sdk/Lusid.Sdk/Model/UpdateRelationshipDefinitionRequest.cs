...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpdateRelationshipDefinitionRequest :  IEquatable<UpdateRelationshipDefinitionRequest>
    {
        ...
        public UpdateRelationshipDefinitionRequest(string displayName = default(string), string outwardDescription = default(string), string inwardDescription = default(string))
        {
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for UpdateRelationshipDefinitionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("outwardDescription is a required property for UpdateRelationshipDefinitionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("inwardDescription is a required property for UpdateRelationshipDefinitionRequest and cannot be null");
            }
            else
            {
