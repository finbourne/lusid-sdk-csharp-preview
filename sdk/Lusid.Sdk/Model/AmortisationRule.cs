...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AmortisationRule : IEquatable<AmortisationRule>
    {
        /// <summary>
        ...
        public AmortisationRule(string name = default(string), string description = default(string), string filter = default(string), string amortisationMethod = default(string))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for AmortisationRule and cannot be null");
            // to ensure "filter" is required (not null)
            this.Filter = filter ?? throw new ArgumentNullException("filter is a required property for AmortisationRule and cannot be null");
            // to ensure "amortisationMethod" is required (not null)
            this.AmortisationMethod = amortisationMethod ?? throw new ArgumentNullException("amortisationMethod is a required property for AmortisationRule and cannot be null");
        ...
        /// </summary>
        /// <value>The filter for this rule.</value>
        [DataMember(Name = "amortisationMethod", IsRequired = true, EmitDefaultValue = false)]
