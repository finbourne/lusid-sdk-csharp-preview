...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfInstrumentCashFlow : IEquatable<ResourceListOfInstrumentCashFlow>
    {
        /// <summary>
        ...
        public ResourceListOfInstrumentCashFlow(List<InstrumentCashFlow> values = default(List<InstrumentCashFlow>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfInstrumentCashFlow and cannot be null");
            this.Href = href;
            this.Links = links;
