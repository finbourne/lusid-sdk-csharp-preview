...
namespace Lusid.Sdk.Model
{
    ...
    public partial class LineageMember : IEquatable<LineageMember>
    {
        /// <summary>
        ...
        public LineageMember(int index = default(int), string label = default(string), string subLabel = default(string), string infoType = default(string), string information = default(string))
        {
            ...
            this.Label = label ?? throw new ArgumentNullException("label is a required property for LineageMember and cannot be null");
            // to ensure "subLabel" is required (not null)
            this.SubLabel = subLabel ?? throw new ArgumentNullException("subLabel is a required property for LineageMember and cannot be null");
        ...
        [DataMember(Name = "subLabel", IsRequired = true, EmitDefaultValue = false)]
