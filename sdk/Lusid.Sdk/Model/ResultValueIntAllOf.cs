...
namespace Lusid.Sdk.Model
{
    ...
    /// ResultValueIntAllOf
    /// </summary>
    [DataContract(Name = "ResultValueInt_allOf")]
    public partial class ResultValueIntAllOf : IEquatable<ResultValueIntAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultValueIntAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResultValueIntAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultValueIntAllOf" /> class.
        /// </summary>
        ...
        public ResultValueIntAllOf(int value = default(int), int? dimension = default(int?), ResultValueTypeEnum resultValueType = default(ResultValueTypeEnum))
        {
        ...
        {
            return this.Equals(input as ResultValueIntAllOf);
        }

        /// <summary>
        /// Returns true if ResultValueIntAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ResultValueIntAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResultValueIntAllOf input)
        {
            if (input == null)
                return false;
