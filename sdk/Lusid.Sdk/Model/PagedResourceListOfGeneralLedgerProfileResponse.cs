...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfGeneralLedgerProfileResponse")]
    public partial class PagedResourceListOfGeneralLedgerProfileResponse : IEquatable<PagedResourceListOfGeneralLedgerProfileResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfGeneralLedgerProfileResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfGeneralLedgerProfileResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfGeneralLedgerProfileResponse" /> class.
        /// </summary>
        ...
        public PagedResourceListOfGeneralLedgerProfileResponse(string nextPage = default(string), string previousPage = default(string), List<GeneralLedgerProfileResponse> values = default(List<GeneralLedgerProfileResponse>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfGeneralLedgerProfileResponse and cannot be null");
        ...
        public List<GeneralLedgerProfileResponse> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResourceListOfGeneralLedgerProfileResponse {\n");
        ...
        {
            return this.Equals(input as PagedResourceListOfGeneralLedgerProfileResponse);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfGeneralLedgerProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfGeneralLedgerProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfGeneralLedgerProfileResponse input)
        {
            if (input == null)
                return false;
