...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfPortfolioCashFlow :  IEquatable<ResourceListOfPortfolioCashFlow>
    {
        ...
        public ResourceListOfPortfolioCashFlow(List<PortfolioCashFlow> values = default(List<PortfolioCashFlow>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
