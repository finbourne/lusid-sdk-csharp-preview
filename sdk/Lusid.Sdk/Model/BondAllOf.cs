...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BondAllOf :  IEquatable<BondAllOf>
    {
        ...
        public BondAllOf(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? maturityDate = default(DateTimeOffset?), string domCcy = default(string), FlowConventions flowConventions = default(FlowConventions), decimal? principal = default(decimal?), decimal? couponRate = default(decimal?), Dictionary<string, string> identifiers = default(Dictionary<string, string>), int? exDividendDays = default(int?), DateTimeOffset? initialCouponDate = default(DateTimeOffset?), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for BondAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maturityDate is a required property for BondAllOf and cannot be null");
            }
            else
            {
            ...
            if (domCcy == null)
            {
                throw new InvalidDataException("domCcy is a required property for BondAllOf and cannot be null");
            }
            else
            {
                this.DomCcy = domCcy;
            ...
            {
                throw new InvalidDataException("flowConventions is a required property for BondAllOf and cannot be null");
            }
            else
            {
            ...
            if (principal == null)
            {
                throw new InvalidDataException("principal is a required property for BondAllOf and cannot be null");
            }
            else
            {
            ...
            if (couponRate == null)
            {
                throw new InvalidDataException("couponRate is a required property for BondAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instrumentType is a required property for BondAllOf and cannot be null");
            }
            else
            {
