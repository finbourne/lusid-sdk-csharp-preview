...
namespace Lusid.Sdk.Model
{
    ...
    public partial class RelatedEntity :  IEquatable<RelatedEntity>
    {
        ...
        public RelatedEntity(string entityType = default(string), Dictionary<string, string> entityId = default(Dictionary<string, string>), string displayName = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>))
        {
            ...
            if (entityType == null)
            {
                throw new InvalidDataException("entityType is a required property for RelatedEntity and cannot be null");
            }
            else
            {
            ...
            if (entityId == null)
            {
                throw new InvalidDataException("entityId is a required property for RelatedEntity and cannot be null");
            }
            else
            {
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for RelatedEntity and cannot be null");
            }
            else
            {
