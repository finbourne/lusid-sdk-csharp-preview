...
namespace Lusid.Sdk.Model
{
    ...
    public partial class RelatedEntity : IEquatable<RelatedEntity>
    {
        ...
        public RelatedEntity(string entityType = default(string), Dictionary<string, string> entityId = default(Dictionary<string, string>), string displayName = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), string scope = default(string), List<EntityIdentifier> identifiers = default(List<EntityIdentifier>), string href = default(string))
        {
            ...
            this.Identifiers = identifiers ?? throw new ArgumentNullException("identifiers is a required property for RelatedEntity and cannot be null");
