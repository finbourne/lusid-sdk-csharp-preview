...
namespace Lusid.Sdk.Model
{
    ...
    /// PropertyCriterion
    /// </summary>
    [DataContract(Name = "PropertyCriterion")]
    [JsonConverter(typeof(JsonSubtypes), "CriterionOp")]
    [JsonSubtypes.KnownSubType(typeof(StringEqualsCriterion), "StringEqualsCriterion")]
    [JsonSubtypes.KnownSubType(typeof(StringInCriterion), "StringInCriterion")]
    public partial class PropertyCriterion : IEquatable<PropertyCriterion>
    {
        /// <summary>
        ...
        public PropertyCriterion(OpEnum op = default(OpEnum))
        {
            this.Op = op;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertyCriterion {\n");
        ...
        {
            return this.Equals(input as PropertyCriterion);
        }

        /// <summary>
        /// Returns true if PropertyCriterion instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertyCriterion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertyCriterion input)
        {
            if (input == null)
                return false;
