...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InternalEvent")]
    [JsonConverter(typeof(JsonSubtypes), "InstrumentEventType")]
    public partial class InternalEvent : InstrumentEvent, IEquatable<InternalEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalEvent" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="InternalEvent" /> class.
        /// </summary>
        /// <param name="eventCategory">What category of event does this represent; instrument opening, closing, transition or other..</param>
        /// <param name="eventSource">What is the event source, what causes it to happen..</param>
        /// <param name="anchorDate">In the case of a point event, the single date on which the event occurs. In the case of an event which is  spread over a window, e.g. a barrier or American option, the start of that window..</param>
        /// <param name="instrumentEventType">The Type of Event. The available values are: TransitionEvent, InternalEvent, CouponEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent (required) (default to &quot;InternalEvent&quot;).</param>
        public InternalEvent(string eventCategory = default(string), string eventSource = default(string), DateTimeOffset anchorDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base(instrumentEventType)
        {
        ...
        /// <summary>
        /// What category of event does this represent; instrument opening, closing, transition or other.
        /// </summary>
        /// <value>What category of event does this represent; instrument opening, closing, transition or other.</value>
        ...
        /// </summary>
        /// <value>What category of event does this represent; instrument opening, closing, transition or other.</value>
        [DataMember(Name = "eventCategory", EmitDefaultValue = true)]
        public string EventCategory { get; set; }

        /// <summary>
        /// What is the event source, what causes it to happen.
        /// </summary>
        /// <value>What is the event source, what causes it to happen.</value>
        ...
        {
            return this.Equals(input as InternalEvent);
        }

        /// <summary>
        /// Returns true if InternalEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of InternalEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InternalEvent input)
        {
            if (input == null)
                return false;
