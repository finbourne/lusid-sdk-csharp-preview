...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentEventHolder : IEquatable<InstrumentEventHolder>
    {
        ...
        /// <param name="corporateActionSourceId">corporateActionSourceId (required).</param>
        ...
        /// <param name="anchorDate">The date the event is determined to have occured..</param>
        ...
        public InstrumentEventHolder(Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), ResourceId corporateActionSourceId = default(ResourceId), InstrumentEvent instrumentEvent = default(InstrumentEvent), List<Property> properties = default(List<Property>), DateTimeOffset anchorDate = default(DateTimeOffset), string lusidInstrumentId = default(string), string instrumentScope = default(string), string instrumentEventId = default(string), string description = default(string))
        {
            ...
            // to ensure "corporateActionSourceId" is required (not null)
            this.CorporateActionSourceId = corporateActionSourceId ?? throw new ArgumentNullException("corporateActionSourceId is a required property for InstrumentEventHolder and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "corporateActionSourceId", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The date the event is determined to have occured.</value>
