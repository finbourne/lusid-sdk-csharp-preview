...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreditSpreadCurveDataAllOf : IEquatable<CreditSpreadCurveDataAllOf>
    {
        ...
        public CreditSpreadCurveDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), List<string> tenors = default(List<string>), List<decimal> spreads = default(List<decimal>), decimal recoveryRate = default(decimal), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
