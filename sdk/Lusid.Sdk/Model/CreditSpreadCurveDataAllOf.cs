...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreditSpreadCurveDataAllOf : IEquatable<CreditSpreadCurveDataAllOf>
    {
        ...
        public CreditSpreadCurveDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), decimal recoveryRate = default(decimal), List<decimal> spreads = default(List<decimal>), List<string> tenors = default(List<string>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
