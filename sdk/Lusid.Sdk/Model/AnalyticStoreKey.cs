...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnalyticStoreKey :  IEquatable<AnalyticStoreKey>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnalyticStoreKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AnalyticStoreKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AnalyticStoreKey" /> class.
        /// </summary>
        /// <param name="scope">scope (required).</param>
        /// <param name="date">date (required).</param>
        public AnalyticStoreKey(string scope = default(string), DateTimeOffset? date = default(DateTimeOffset?))
        {
            // to ensure "scope" is required (not null)
            if (scope == null)
            {
                throw new InvalidDataException("scope is a required property for AnalyticStoreKey and cannot be null");
            }
            else
            {
                this.Scope = scope;
            ...
            if (date == null)
            {
                throw new InvalidDataException("date is a required property for AnalyticStoreKey and cannot be null");
            }
            else
            {
                this.Date = date;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnalyticStoreKey {\n");
        ...
        {
            return this.Equals(input as AnalyticStoreKey);
        }

        /// <summary>
        /// Returns true if AnalyticStoreKey instances are equal
        /// </summary>
        /// <param name="input">Instance of AnalyticStoreKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnalyticStoreKey input)
        {
            if (input == null)
                return false;
