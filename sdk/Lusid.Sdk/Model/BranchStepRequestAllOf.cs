...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BranchStepRequestAllOf : IEquatable<BranchStepRequestAllOf>
    {
        /// <summary>
        ...
        public BranchStepRequestAllOf(string label = default(string), ComplianceStepTypeRequestEnum complianceStepTypeRequest = default(ComplianceStepTypeRequestEnum))
        {
            ...
            this.Label = label ?? throw new ArgumentNullException("label is a required property for BranchStepRequestAllOf and cannot be null");
