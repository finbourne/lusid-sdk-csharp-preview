...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfFeeType : IEquatable<PagedResourceListOfFeeType>
    {
        /// <summary>
        ...
        public PagedResourceListOfFeeType(string nextPage = default(string), string previousPage = default(string), List<FeeType> values = default(List<FeeType>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfFeeType and cannot be null");
