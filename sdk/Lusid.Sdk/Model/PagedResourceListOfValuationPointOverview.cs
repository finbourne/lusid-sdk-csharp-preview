...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfValuationPointOverview")]
    public partial class PagedResourceListOfValuationPointOverview : IEquatable<PagedResourceListOfValuationPointOverview>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfValuationPointOverview" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfValuationPointOverview() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfValuationPointOverview" /> class.
        /// </summary>
        ...
        public PagedResourceListOfValuationPointOverview(string nextPage = default(string), string previousPage = default(string), List<ValuationPointOverview> values = default(List<ValuationPointOverview>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfValuationPointOverview and cannot be null");
        ...
        public List<ValuationPointOverview> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResourceListOfValuationPointOverview {\n");
        ...
        {
            return this.Equals(input as PagedResourceListOfValuationPointOverview);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfValuationPointOverview instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfValuationPointOverview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfValuationPointOverview input)
        {
            if (input == null)
                return false;
