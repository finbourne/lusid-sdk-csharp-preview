...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionConfigurationDataRequest :  IEquatable<TransactionConfigurationDataRequest>
    {
        ...
        public TransactionConfigurationDataRequest(List<TransactionConfigurationTypeAlias> aliases = default(List<TransactionConfigurationTypeAlias>), List<TransactionConfigurationMovementDataRequest> movements = default(List<TransactionConfigurationMovementDataRequest>), Dictionary<string, PerpetualPropertyValue> properties = default(Dictionary<string, PerpetualPropertyValue>))
        {
