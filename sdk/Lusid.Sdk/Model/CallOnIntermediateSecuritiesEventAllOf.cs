...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CallOnIntermediateSecuritiesEventAllOf : IEquatable<CallOnIntermediateSecuritiesEventAllOf>
    {
        /// <summary>
        ...
        public CallOnIntermediateSecuritiesEventAllOf(DateTimeOffset expiryDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), NewInstrument newInstrument = default(NewInstrument), UnitsRatio unitsRatio = default(UnitsRatio), decimal price = default(decimal), string exerciseCurrency = default(string), List<OptionExerciseElection> optionExerciseElections = default(List<OptionExerciseElection>), List<LapseElection> lapseElections = default(List<LapseElection>), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            ...
            this.NewInstrument = newInstrument ?? throw new ArgumentNullException("newInstrument is a required property for CallOnIntermediateSecuritiesEventAllOf and cannot be null");
            // to ensure "unitsRatio" is required (not null)
            this.UnitsRatio = unitsRatio ?? throw new ArgumentNullException("unitsRatio is a required property for CallOnIntermediateSecuritiesEventAllOf and cannot be null");
            this.Price = price;
            // to ensure "exerciseCurrency" is required (not null)
            this.ExerciseCurrency = exerciseCurrency ?? throw new ArgumentNullException("exerciseCurrency is a required property for CallOnIntermediateSecuritiesEventAllOf and cannot be null");
        ...
        [DataMember(Name = "expiryDate", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "newInstrument", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "exerciseCurrency", IsRequired = true, EmitDefaultValue = false)]
