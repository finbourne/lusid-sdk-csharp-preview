...
{
    /// <summary>
    /// TermDepositPrincipalEventAllOf
    /// </summary>
    [DataContract(Name = "TermDepositPrincipalEvent_allOf")]
    public partial class TermDepositPrincipalEventAllOf : IEquatable<TermDepositPrincipalEventAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TermDepositPrincipalEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TermDepositPrincipalEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TermDepositPrincipalEventAllOf" /> class.
        /// </summary>
        ...
        public TermDepositPrincipalEventAllOf(string currency = default(string), DateTimeOffset paymentDate = default(DateTimeOffset), decimal? principalPerUnit = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for TermDepositPrincipalEventAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TermDepositPrincipalEventAllOf {\n");
        ...
        {
            return this.Equals(input as TermDepositPrincipalEventAllOf);
        }

        /// <summary>
        /// Returns true if TermDepositPrincipalEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TermDepositPrincipalEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermDepositPrincipalEventAllOf input)
        {
            if (input == null)
                return false;
