...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BlockSetRequest")]
    public partial class BlockSetRequest : IEquatable<BlockSetRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockSetRequest" /> class.
        /// </summary>
        /// <param name="requests">A collection of BlockRequests..</param>
        public BlockSetRequest(List<BlockRequest> requests = default(List<BlockRequest>))
        {
        ...
        /// </summary>
        /// <value>A collection of BlockRequests.</value>
        [DataMember(Name = "requests", EmitDefaultValue = true)]
        public List<BlockRequest> Requests { get; set; }
        ...
        {
            return this.Equals(input as BlockSetRequest);
        }

        /// <summary>
        /// Returns true if BlockSetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockSetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockSetRequest input)
        {
            if (input == null)
                return false;
