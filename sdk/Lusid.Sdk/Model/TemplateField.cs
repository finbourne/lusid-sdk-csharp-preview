...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TemplateField : IEquatable<TemplateField>
    {
        /// <summary>
        ...
        public TemplateField(string fieldName = default(string), string specificity = default(string), string description = default(string), string type = default(string), string availability = default(string), List<string> usage = default(List<string>))
        {
            ...
            this.FieldName = fieldName ?? throw new ArgumentNullException("fieldName is a required property for TemplateField and cannot be null");
            // to ensure "specificity" is required (not null)
            this.Specificity = specificity ?? throw new ArgumentNullException("specificity is a required property for TemplateField and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for TemplateField and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for TemplateField and cannot be null");
            // to ensure "availability" is required (not null)
            this.Availability = availability ?? throw new ArgumentNullException("availability is a required property for TemplateField and cannot be null");
            // to ensure "usage" is required (not null)
            this.Usage = usage ?? throw new ArgumentNullException("usage is a required property for TemplateField and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "specificity", IsRequired = true, EmitDefaultValue = false)]
