...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupReconciliationUserReviewBreakCode : IEquatable<GroupReconciliationUserReviewBreakCode>
    {
        /// <summary>
        ...
        public GroupReconciliationUserReviewBreakCode(string breakCode = default(string), string userId = default(string), DateTimeOffset asAtAdded = default(DateTimeOffset), DateTimeOffset asAtInvalid = default(DateTimeOffset))
        {
            ...
            this.BreakCode = breakCode ?? throw new ArgumentNullException("breakCode is a required property for GroupReconciliationUserReviewBreakCode and cannot be null");
            this.UserId = userId;
        ...
        [DataMember(Name = "breakCode", IsRequired = true, EmitDefaultValue = false)]
