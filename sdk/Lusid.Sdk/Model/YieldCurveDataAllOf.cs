...
namespace Lusid.Sdk.Model
{
    ...
    public partial class YieldCurveDataAllOf : IEquatable<YieldCurveDataAllOf>
    {
        ...
        public YieldCurveDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), List<LusidInstrument> instruments = default(List<LusidInstrument>), List<MarketQuote> quotes = default(List<MarketQuote>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum), string lineage = default(string))
        {
