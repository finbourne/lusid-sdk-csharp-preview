...
namespace Lusid.Sdk.Model
{
    ...
    public partial class MarketDataKeyRule :  IEquatable<MarketDataKeyRule>
    {
        ...
        /// <param name="quoteInterval">Shorthand for the time interval used to select market data. (required).</param>
        /// <param name="asAt">The AsAt predicate specification. (required).</param>
        public MarketDataKeyRule(string key = default(string), SupplierEnum supplier = default(SupplierEnum), string dataScope = default(string), QuoteTypeEnum quoteType = default(QuoteTypeEnum), string field = default(string), string quoteInterval = default(string), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            ...
            // to ensure "quoteInterval" is required (not null)
            if (quoteInterval == null)
            {
                throw new InvalidDataException("quoteInterval is a required property for MarketDataKeyRule and cannot be null");
            }
            else
            {
            ...
            if (asAt == null)
            {
                throw new InvalidDataException("asAt is a required property for MarketDataKeyRule and cannot be null");
            }
            else
            {
                this.AsAt = asAt;
