...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfFund : IEquatable<PagedResourceListOfFund>
    {
        /// <summary>
        ...
        public PagedResourceListOfFund(string nextPage = default(string), string previousPage = default(string), List<Fund> values = default(List<Fund>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfFund and cannot be null");
