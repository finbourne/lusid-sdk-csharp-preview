...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddBusinessDaysToDateResponse :  IEquatable<AddBusinessDaysToDateResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddBusinessDaysToDateResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddBusinessDaysToDateResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddBusinessDaysToDateResponse" /> class.
        /// </summary>
        ...
        public AddBusinessDaysToDateResponse(DateTimeOffset? value = default(DateTimeOffset?))
        {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for AddBusinessDaysToDateResponse and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        {
            return this.Equals(input as AddBusinessDaysToDateResponse);
        }

        /// <summary>
        /// Returns true if AddBusinessDaysToDateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AddBusinessDaysToDateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddBusinessDaysToDateResponse input)
        {
            if (input == null)
                return false;
