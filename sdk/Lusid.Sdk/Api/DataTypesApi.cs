...
namespace Lusid.Sdk.Api
{
    ...
    public interface IDataTypesApi : IApiAccessor
    {
        ...
        /// <param name="includeDefault">Whether to additionally include those data types in the \&quot;default\&quot; scope (optional)</param>
        ...
        ApiResponse<ResourceListOfDataType> ListDataTypesWithHttpInfo (string scope, bool? includeDefault = null, bool? includeSystem = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ResourceListOfDataType> ListDataTypesAsync (string scope, bool? includeDefault = null, bool? includeSystem = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfDataType>> ListDataTypesAsyncWithHttpInfo (string scope, bool? includeDefault = null, bool? includeSystem = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null);
        /// <summary>
        /// Update data type definition
        /// </summary>
        /// <remarks>
    ...
    public partial class DataTypesApi : IDataTypesApi
    {
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>ResourceListOfDataType</returns>
        public ResourceListOfDataType ListDataTypes (string scope, bool? includeDefault = null, bool? includeSystem = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
             ApiResponse<ResourceListOfDataType> localVarResponse = ListDataTypesWithHttpInfo(scope, includeDefault, includeSystem, sortBy, start, limit, filter);
             return localVarResponse.Data;
        }
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>ApiResponse of ResourceListOfDataType</returns>
        public ApiResponse< ResourceListOfDataType > ListDataTypesWithHttpInfo (string scope, bool? includeDefault = null, bool? includeSystem = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            if (scope != null) localVarPathParams.Add("scope", this.Configuration.ApiClient.ParameterToString(scope)); // path parameter
            if (includeDefault != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "includeDefault", includeDefault)); // query parameter
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>Task of ResourceListOfDataType</returns>
        public async System.Threading.Tasks.Task<ResourceListOfDataType> ListDataTypesAsync (string scope, bool? includeDefault = null, bool? includeSystem = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
             ApiResponse<ResourceListOfDataType> localVarResponse = await ListDataTypesAsyncWithHttpInfo(scope, includeDefault, includeSystem, sortBy, start, limit, filter);
             return localVarResponse.Data;
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfDataType)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfDataType>> ListDataTypesAsyncWithHttpInfo (string scope, bool? includeDefault = null, bool? includeSystem = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling DataTypesApi->ListDataTypes");
