...
namespace Lusid.Sdk.Api
{
    ...
    public interface IDataTypesApi : IApiAccessor
    {
        ...
        ApiResponse<DataType> CreateDataTypeWithHttpInfo (CreateDataTypeRequest createDataTypeRequest = null);
        /// <summary>
        ...
        /// <param name="scope">The scope of the data type</param>
        /// <param name="code">The code of the data type</param>
        /// <param name="updateDataTypeRequest">The updated definition of the data type (optional)</param>
        /// <returns>DataType</returns>
        ...
        /// <param name="updateDataTypeRequest">The updated definition of the data type (optional)</param>
        /// <returns>ApiResponse of DataType</returns>
        ApiResponse<DataType> UpdateDataTypeWithHttpInfo (string scope, string code, UpdateDataTypeRequest updateDataTypeRequest = null);
        ...
        System.Threading.Tasks.Task<DataType> CreateDataTypeAsync (CreateDataTypeRequest createDataTypeRequest = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<DataType>> CreateDataTypeAsyncWithHttpInfo (CreateDataTypeRequest createDataTypeRequest = null);
        /// <summary>
        /// [EARLY ACCESS] Get data type definition
        /// </summary>
        /// <remarks>
        ...
        /// <param name="updateDataTypeRequest">The updated definition of the data type (optional)</param>
        /// <returns>Task of DataType</returns>
        System.Threading.Tasks.Task<DataType> UpdateDataTypeAsync (string scope, string code, UpdateDataTypeRequest updateDataTypeRequest = null);
        ...
        /// <param name="updateDataTypeRequest">The updated definition of the data type (optional)</param>
        /// <returns>Task of ApiResponse (DataType)</returns>
        System.Threading.Tasks.Task<ApiResponse<DataType>> UpdateDataTypeAsyncWithHttpInfo (string scope, string code, UpdateDataTypeRequest updateDataTypeRequest = null);
    ...
    public partial class DataTypesApi : IDataTypesApi
    {
        ...
        /// <param name="createDataTypeRequest">The definition of the new data type (optional)</param>
        /// <returns>DataType</returns>
        public DataType CreateDataType (CreateDataTypeRequest createDataTypeRequest = null)
        {
             ApiResponse<DataType> localVarResponse = CreateDataTypeWithHttpInfo(createDataTypeRequest);
        ...
        /// <param name="createDataTypeRequest">The definition of the new data type (optional)</param>
        /// <returns>ApiResponse of DataType</returns>
        public ApiResponse< DataType > CreateDataTypeWithHttpInfo (CreateDataTypeRequest createDataTypeRequest = null)
        {
            ...
            if (createDataTypeRequest != null && createDataTypeRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(createDataTypeRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = createDataTypeRequest; // byte array
            }
        ...
        /// <param name="createDataTypeRequest">The definition of the new data type (optional)</param>
        /// <returns>Task of DataType</returns>
        public async System.Threading.Tasks.Task<DataType> CreateDataTypeAsync (CreateDataTypeRequest createDataTypeRequest = null)
        {
             ApiResponse<DataType> localVarResponse = await CreateDataTypeAsyncWithHttpInfo(createDataTypeRequest);
             return localVarResponse.Data;
        ...
        /// <param name="createDataTypeRequest">The definition of the new data type (optional)</param>
        /// <returns>Task of ApiResponse (DataType)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DataType>> CreateDataTypeAsyncWithHttpInfo (CreateDataTypeRequest createDataTypeRequest = null)
        {
        ...
        /// <param name="updateDataTypeRequest">The updated definition of the data type (optional)</param>
        /// <returns>DataType</returns>
        public DataType UpdateDataType (string scope, string code, UpdateDataTypeRequest updateDataTypeRequest = null)
        {
             ApiResponse<DataType> localVarResponse = UpdateDataTypeWithHttpInfo(scope, code, updateDataTypeRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="updateDataTypeRequest">The updated definition of the data type (optional)</param>
        /// <returns>ApiResponse of DataType</returns>
        public ApiResponse< DataType > UpdateDataTypeWithHttpInfo (string scope, string code, UpdateDataTypeRequest updateDataTypeRequest = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            if (scope != null) localVarPathParams.Add("scope", this.Configuration.ApiClient.ParameterToString(scope)); // path parameter
            if (code != null) localVarPathParams.Add("code", this.Configuration.ApiClient.ParameterToString(code)); // path parameter
            if (updateDataTypeRequest != null && updateDataTypeRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(updateDataTypeRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = updateDataTypeRequest; // byte array
            }
        ...
        /// <param name="updateDataTypeRequest">The updated definition of the data type (optional)</param>
        /// <returns>Task of DataType</returns>
        public async System.Threading.Tasks.Task<DataType> UpdateDataTypeAsync (string scope, string code, UpdateDataTypeRequest updateDataTypeRequest = null)
        {
             ApiResponse<DataType> localVarResponse = await UpdateDataTypeAsyncWithHttpInfo(scope, code, updateDataTypeRequest);
             return localVarResponse.Data;
        ...
        /// <param name="updateDataTypeRequest">The updated definition of the data type (optional)</param>
        /// <returns>Task of ApiResponse (DataType)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DataType>> UpdateDataTypeAsyncWithHttpInfo (string scope, string code, UpdateDataTypeRequest updateDataTypeRequest = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling DataTypesApi->UpdateDataType");
