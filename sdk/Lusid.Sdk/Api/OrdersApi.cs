...
namespace Lusid.Sdk.Api
{
    ...
    public interface IOrdersApi : IApiAccessor
    {
        ...
        /// <param name="asAt">The asat datetime at which to retrieve the order. Defaults to              return the latest version of each order if not specified. (optional)</param>
        ...
        ApiResponse<Order> GetOrderWithHttpInfo (string scope, string id, DateTimeOffset? asAt = null, List<string> propertyKeys = null);
        /// <summary>
        ...
        /// <param name="asAt">The asat datetime at which to retrieve the orders. Defaults to              return the latest version of each order if not specified. (optional)</param>
        ...
        ApiResponse<ResourceListOfOrder> ListOrdersWithHttpInfo (string scope, DateTimeOffset? asAt = null, List<string> propertyKeys = null);
        /// <summary>
        ...
        /// <param name="scope">The scope to which the orders belong.</param>
        /// <param name="request">The collection of order requests. (optional)</param>
        /// <returns>ApiResponse of OrderSet</returns>
        ApiResponse<OrderSet> UpsertOrdersWithHttpInfo (string scope, OrderSetRequest request = null);
        ...
        System.Threading.Tasks.Task<Order> GetOrderAsync (string scope, string id, DateTimeOffset? asAt = null, List<string> propertyKeys = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Order>> GetOrderAsyncWithHttpInfo (string scope, string id, DateTimeOffset? asAt = null, List<string> propertyKeys = null);
        /// <summary>
        /// [EXPERIMENTAL] Fetch the last pre-AsAt date version of each order in scope (does not fetch the entire history).
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ResourceListOfOrder> ListOrdersAsync (string scope, DateTimeOffset? asAt = null, List<string> propertyKeys = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfOrder>> ListOrdersAsyncWithHttpInfo (string scope, DateTimeOffset? asAt = null, List<string> propertyKeys = null);
        /// <summary>
        /// [EXPERIMENTAL] Upsert; update properties on existing Orders with given ids.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="scope">The scope to which the orders belong.</param>
        /// <param name="request">The collection of order requests. (optional)</param>
        /// <returns>Task of OrderSet</returns>
        System.Threading.Tasks.Task<OrderSet> UpsertOrdersAsync (string scope, OrderSetRequest request = null);
        ...
        /// <param name="scope">The scope to which the orders belong.</param>
        /// <param name="request">The collection of order requests. (optional)</param>
        /// <returns>Task of ApiResponse (OrderSet)</returns>
        System.Threading.Tasks.Task<ApiResponse<OrderSet>> UpsertOrdersAsyncWithHttpInfo (string scope, OrderSetRequest request = null);
    ...
    public partial class OrdersApi : IOrdersApi
    {
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Orders\&quot; domain to decorate onto the order.              These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)</param>
        /// <returns>Order</returns>
        public Order GetOrder (string scope, string id, DateTimeOffset? asAt = null, List<string> propertyKeys = null)
        {
             ApiResponse<Order> localVarResponse = GetOrderWithHttpInfo(scope, id, asAt, propertyKeys);
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Orders\&quot; domain to decorate onto the order.              These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)</param>
        /// <returns>ApiResponse of Order</returns>
        public ApiResponse< Order > GetOrderWithHttpInfo (string scope, string id, DateTimeOffset? asAt = null, List<string> propertyKeys = null)
        {
            ...
            var localVarPath = "./api/orders/{scope}/{id}";
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Orders\&quot; domain to decorate onto the order.              These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)</param>
        /// <returns>Task of Order</returns>
        public async System.Threading.Tasks.Task<Order> GetOrderAsync (string scope, string id, DateTimeOffset? asAt = null, List<string> propertyKeys = null)
        {
             ApiResponse<Order> localVarResponse = await GetOrderAsyncWithHttpInfo(scope, id, asAt, propertyKeys);
             return localVarResponse.Data;
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Orders\&quot; domain to decorate onto the order.              These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)</param>
        /// <returns>Task of ApiResponse (Order)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Order>> GetOrderAsyncWithHttpInfo (string scope, string id, DateTimeOffset? asAt = null, List<string> propertyKeys = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling OrdersApi->GetOrder");
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Orders\&quot; domain to decorate onto each order.              These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)</param>
        /// <returns>ResourceListOfOrder</returns>
        public ResourceListOfOrder ListOrders (string scope, DateTimeOffset? asAt = null, List<string> propertyKeys = null)
        {
             ApiResponse<ResourceListOfOrder> localVarResponse = ListOrdersWithHttpInfo(scope, asAt, propertyKeys);
             return localVarResponse.Data;
        }
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Orders\&quot; domain to decorate onto each order.              These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfOrder</returns>
        public ApiResponse< ResourceListOfOrder > ListOrdersWithHttpInfo (string scope, DateTimeOffset? asAt = null, List<string> propertyKeys = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling OrdersApi->ListOrders");

            var localVarPath = "./api/orders/{scope}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Orders\&quot; domain to decorate onto each order.              These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)</param>
        /// <returns>Task of ResourceListOfOrder</returns>
        public async System.Threading.Tasks.Task<ResourceListOfOrder> ListOrdersAsync (string scope, DateTimeOffset? asAt = null, List<string> propertyKeys = null)
        {
             ApiResponse<ResourceListOfOrder> localVarResponse = await ListOrdersAsyncWithHttpInfo(scope, asAt, propertyKeys);
             return localVarResponse.Data;
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Orders\&quot; domain to decorate onto each order.              These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfOrder)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfOrder>> ListOrdersAsyncWithHttpInfo (string scope, DateTimeOffset? asAt = null, List<string> propertyKeys = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling OrdersApi->ListOrders");
        ...
        /// <param name="request">The collection of order requests. (optional)</param>
        /// <returns>OrderSet</returns>
        public OrderSet UpsertOrders (string scope, OrderSetRequest request = null)
        {
             ApiResponse<OrderSet> localVarResponse = UpsertOrdersWithHttpInfo(scope, request);
             return localVarResponse.Data;
        }
        ...
        /// <param name="request">The collection of order requests. (optional)</param>
        /// <returns>ApiResponse of OrderSet</returns>
        public ApiResponse< OrderSet > UpsertOrdersWithHttpInfo (string scope, OrderSetRequest request = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling OrdersApi->UpsertOrders");
            ...
            return new ApiResponse<OrderSet>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (OrderSet) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(OrderSet)));
        }
        ...
        /// <param name="request">The collection of order requests. (optional)</param>
        /// <returns>Task of OrderSet</returns>
        public async System.Threading.Tasks.Task<OrderSet> UpsertOrdersAsync (string scope, OrderSetRequest request = null)
        {
             ApiResponse<OrderSet> localVarResponse = await UpsertOrdersAsyncWithHttpInfo(scope, request);
             return localVarResponse.Data;
        ...
        /// <param name="request">The collection of order requests. (optional)</param>
        /// <returns>Task of ApiResponse (OrderSet)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<OrderSet>> UpsertOrdersAsyncWithHttpInfo (string scope, OrderSetRequest request = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling OrdersApi->UpsertOrders");
