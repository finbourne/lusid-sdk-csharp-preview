...
namespace Lusid.Sdk.Api
{
    ...
    public interface IOrdersApi : IApiAccessor
    {
        ...
        /// <param name="upsertOrderPropertiesRequest">A collection of order property upsert requests. (optional)</param>
        ...
        ApiResponse<UpsertOrderPropertiesResponse> UpsertOrderPropertiesWithHttpInfo (string scope, List<UpsertOrderPropertiesRequest> upsertOrderPropertiesRequest = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<UpsertOrderPropertiesResponse> UpsertOrderPropertiesAsync (string scope, List<UpsertOrderPropertiesRequest> upsertOrderPropertiesRequest = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<UpsertOrderPropertiesResponse>> UpsertOrderPropertiesAsyncWithHttpInfo (string scope, List<UpsertOrderPropertiesRequest> upsertOrderPropertiesRequest = null);
        /// <summary>
        /// [EXPERIMENTAL] Upsert Order
        /// </summary>
        /// <remarks>
    ...
    public partial class OrdersApi : IOrdersApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Delete order Delete an order. Deletion will be valid from the order&#39;s creation datetime.  This means that the order will no longer exist at any effective datetime from the asAt datetime of deletion.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The order scope.</param>
        /// <param name="code">The order&#39;s code. This, together with the scope uniquely identifies the order to delete.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get Order Fetch an Order that matches the specified identifier
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope to which the order belongs.</param>
        /// <param name="code">The order&#39;s unique identifier.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] List Orders Fetch the last pre-AsAt date version of each order in scope (does not fetch the entire history).
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="asAt">The asAt datetime at which to retrieve the order. Defaults to return the latest version of the order if not specified. (optional)</param>
        /// <param name="page">The pagination token to use to continue listing orders from a previous call to list orders.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Upsert Order Properties Upsert; update properties on existing Orders with given ids.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope to which the orders belong.</param>
        /// <param name="upsertOrderPropertiesRequest">A collection of order property upsert requests. (optional)</param>
        /// <returns>UpsertOrderPropertiesResponse</returns>
        public UpsertOrderPropertiesResponse UpsertOrderProperties (string scope, List<UpsertOrderPropertiesRequest> upsertOrderPropertiesRequest = null)
        {
             ApiResponse<UpsertOrderPropertiesResponse> localVarResponse = UpsertOrderPropertiesWithHttpInfo(scope, upsertOrderPropertiesRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="upsertOrderPropertiesRequest">A collection of order property upsert requests. (optional)</param>
        /// <returns>ApiResponse of UpsertOrderPropertiesResponse</returns>
        public ApiResponse< UpsertOrderPropertiesResponse > UpsertOrderPropertiesWithHttpInfo (string scope, List<UpsertOrderPropertiesRequest> upsertOrderPropertiesRequest = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            if (scope != null) localVarPathParams.Add("scope", this.Configuration.ApiClient.ParameterToString(scope)); // path parameter
            if (upsertOrderPropertiesRequest != null && upsertOrderPropertiesRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(upsertOrderPropertiesRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = upsertOrderPropertiesRequest; // byte array
            }
        ...
        /// <param name="upsertOrderPropertiesRequest">A collection of order property upsert requests. (optional)</param>
        /// <returns>Task of UpsertOrderPropertiesResponse</returns>
        public async System.Threading.Tasks.Task<UpsertOrderPropertiesResponse> UpsertOrderPropertiesAsync (string scope, List<UpsertOrderPropertiesRequest> upsertOrderPropertiesRequest = null)
        {
             ApiResponse<UpsertOrderPropertiesResponse> localVarResponse = await UpsertOrderPropertiesAsyncWithHttpInfo(scope, upsertOrderPropertiesRequest);
             return localVarResponse.Data;
        ...
        /// <param name="upsertOrderPropertiesRequest">A collection of order property upsert requests. (optional)</param>
        /// <returns>Task of ApiResponse (UpsertOrderPropertiesResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpsertOrderPropertiesResponse>> UpsertOrderPropertiesAsyncWithHttpInfo (string scope, List<UpsertOrderPropertiesRequest> upsertOrderPropertiesRequest = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling OrdersApi->UpsertOrderProperties");
        ...
        /// <summary>
        /// [EXPERIMENTAL] Upsert Order Upsert; update existing orders with given ids, or create new orders otherwise.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="orderSetRequest">The collection of order requests. (optional)</param>
        /// <returns>ResourceListOfOrder</returns>
