...
namespace Lusid.Sdk.Api
{
    ...
    public interface IOrdersApiSync : IApiAccessor
    {
        ...
        PagedResourceListOfOrder ListOrders(DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>));
        ...
        ApiResponse<PagedResourceListOfOrder> ListOrdersWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>));
        /// <summary>
    ...
    public partial class OrdersApi : IOrdersApi
    {
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Orders\&quot; domain to decorate onto each order.                  These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)</param>
        /// <returns>PagedResourceListOfOrder</returns>
        public PagedResourceListOfOrder ListOrders(DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>))
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfOrder> localVarResponse = ListOrdersWithHttpInfo(asAt, page, sortBy, limit, filter, propertyKeys);
            return localVarResponse.Data;
        }
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Orders\&quot; domain to decorate onto each order.                  These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)</param>
        /// <returns>ApiResponse of PagedResourceListOfOrder</returns>
        public Lusid.Sdk.Client.ApiResponse<PagedResourceListOfOrder> ListOrdersWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>))
        {
            Lusid.Sdk.Client.RequestOptions localVarRequestOptions = new Lusid.Sdk.Client.RequestOptions();
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfOrder> localVarResponse = await ListOrdersWithHttpInfoAsync(asAt, page, sortBy, limit, filter, propertyKeys, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
