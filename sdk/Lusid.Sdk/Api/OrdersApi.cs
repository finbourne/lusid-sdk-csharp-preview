...
namespace Lusid.Sdk.Api
{
    ...
    public interface IOrdersApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="resourceId">The IDs of the orders to delete.</param>
        /// <returns>DeletedOrdersEntitiesResponse</returns>
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="resourceId">The IDs of the orders to delete.</param>
        /// <returns>ApiResponse of DeletedOrdersEntitiesResponse</returns>
        ApiResponse<DeletedOrdersEntitiesResponse> DeleteOrdersWithHttpInfo (List<ResourceId> resourceId);
        /// <summary>
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="resourceId">The IDs of the orders to delete.</param>
        /// <returns>Task of DeletedOrdersEntitiesResponse</returns>
        System.Threading.Tasks.Task<DeletedOrdersEntitiesResponse> DeleteOrdersAsync (List<ResourceId> resourceId);
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="resourceId">The IDs of the orders to delete.</param>
        /// <returns>Task of ApiResponse (DeletedOrdersEntitiesResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeletedOrdersEntitiesResponse>> DeleteOrdersAsyncWithHttpInfo (List<ResourceId> resourceId);
        /// <summary>
        /// [EXPERIMENTAL] Get Order
        /// </summary>
        /// <remarks>
    ...
    public partial class OrdersApi : IOrdersApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Delete Orders. Use this method to delete a collection of Orders, each defined by ResourceId. Each delete will be attempted  independently, and the method will return lists of successful and failed attempts.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="resourceId">The IDs of the orders to delete.</param>
        /// <returns>DeletedOrdersEntitiesResponse</returns>
        public DeletedOrdersEntitiesResponse DeleteOrders (List<ResourceId> resourceId)
        {
             ApiResponse<DeletedOrdersEntitiesResponse> localVarResponse = DeleteOrdersWithHttpInfo(resourceId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="resourceId">The IDs of the orders to delete.</param>
        /// <returns>ApiResponse of DeletedOrdersEntitiesResponse</returns>
        public ApiResponse< DeletedOrdersEntitiesResponse > DeleteOrdersWithHttpInfo (List<ResourceId> resourceId)
        {
            // verify the required parameter 'resourceId' is set
            if (resourceId == null)
                throw new ApiException(400, "Missing required parameter 'resourceId' when calling OrdersApi->DeleteOrders");

            var localVarPath = "./api/orders/$delete";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DeleteOrders", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<DeletedOrdersEntitiesResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (DeletedOrdersEntitiesResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(DeletedOrdersEntitiesResponse)));
        }
        ...
        /// <param name="resourceId">The IDs of the orders to delete.</param>
        /// <returns>Task of DeletedOrdersEntitiesResponse</returns>
        public async System.Threading.Tasks.Task<DeletedOrdersEntitiesResponse> DeleteOrdersAsync (List<ResourceId> resourceId)
        {
             ApiResponse<DeletedOrdersEntitiesResponse> localVarResponse = await DeleteOrdersAsyncWithHttpInfo(resourceId);
             return localVarResponse.Data;
        ...
        /// <param name="resourceId">The IDs of the orders to delete.</param>
        /// <returns>Task of ApiResponse (DeletedOrdersEntitiesResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeletedOrdersEntitiesResponse>> DeleteOrdersAsyncWithHttpInfo (List<ResourceId> resourceId)
        {
            // verify the required parameter 'resourceId' is set
            if (resourceId == null)
                throw new ApiException(400, "Missing required parameter 'resourceId' when calling OrdersApi->DeleteOrders");
