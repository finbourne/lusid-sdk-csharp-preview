...
namespace Lusid.Sdk.Api
{
    ...
    public interface IConventionsApi : IApiAccessor
    {
        ...
        /// <param name="scope">The scope of the conventions to delete.</param>
        /// <param name="code">The conventions to delete.</param>
        ...
        ApiResponse<AnnulSingleStructuredDataResponse> DeleteConventionsWithHttpInfo (string scope, string code);
        /// <summary>
        ...
        System.Threading.Tasks.Task<AnnulSingleStructuredDataResponse> DeleteConventionsAsync (string scope, string code);
        ...
        System.Threading.Tasks.Task<ApiResponse<AnnulSingleStructuredDataResponse>> DeleteConventionsAsyncWithHttpInfo (string scope, string code);
        /// <summary>
        /// [EXPERIMENTAL] Get Flow Conventions
        /// </summary>
        /// <remarks>
    ...
    public partial class ConventionsApi : IConventionsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Delete the conventions of given scope and code, assuming that it is present. Delete the specified conventions from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.  It is important to always check for any unsuccessful response.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the conventions to delete.</param>
        /// <param name="code">The conventions to delete.</param>
        /// <returns>AnnulSingleStructuredDataResponse</returns>
        public AnnulSingleStructuredDataResponse DeleteConventions (string scope, string code)
        {
             ApiResponse<AnnulSingleStructuredDataResponse> localVarResponse = DeleteConventionsWithHttpInfo(scope, code);
        ...
        /// <param name="code">The conventions to delete.</param>
        /// <returns>ApiResponse of AnnulSingleStructuredDataResponse</returns>
        public ApiResponse< AnnulSingleStructuredDataResponse > DeleteConventionsWithHttpInfo (string scope, string code)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ConventionsApi->DeleteConventions");
            // verify the required parameter 'code' is set
            if (code == null)
                throw new ApiException(400, "Missing required parameter 'code' when calling ConventionsApi->DeleteConventions");

            var localVarPath = "./api/conventions/{scope}/{code}";
            ...
            {
                Exception exception = ExceptionFactory("DeleteConventions", localVarResponse);
        ...
        /// <param name="code">The conventions to delete.</param>
        /// <returns>Task of AnnulSingleStructuredDataResponse</returns>
        public async System.Threading.Tasks.Task<AnnulSingleStructuredDataResponse> DeleteConventionsAsync (string scope, string code)
        {
             ApiResponse<AnnulSingleStructuredDataResponse> localVarResponse = await DeleteConventionsAsyncWithHttpInfo(scope, code);
             return localVarResponse.Data;
        ...
        /// <param name="code">The conventions to delete.</param>
        /// <returns>Task of ApiResponse (AnnulSingleStructuredDataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AnnulSingleStructuredDataResponse>> DeleteConventionsAsyncWithHttpInfo (string scope, string code)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ConventionsApi->DeleteConventions");
