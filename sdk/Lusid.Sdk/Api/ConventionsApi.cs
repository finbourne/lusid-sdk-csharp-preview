...
namespace Lusid.Sdk.Api
{
    ...
    public partial class ConventionsApi : IConventionsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] List the set of CDS Flow Conventions List the set of CDS Flow Conventions at the specified date/time
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="asAt">The asAt datetime at which to list the conventions. Defaults to latest if not specified. (optional)</param>
        /// <returns>ResourceListOfGetCdsFlowConventionsResponse</returns>
        ...
        /// <summary>
        /// [EXPERIMENTAL] List the set of Flow Conventions List the set of Flow Conventions at the specified date/time
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="asAt">The asAt datetime at which to list the conventions. Defaults to latest if not specified. (optional)</param>
        /// <returns>ResourceListOfGetFlowConventionsResponse</returns>
        ...
        /// <summary>
        /// [EXPERIMENTAL] List the set of Index Conventions List the set of Index Conventions at the specified date/time
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="asAt">The asAt datetime at which to list the conventions. Defaults to latest if not specified. (optional)</param>
        /// <returns>ResourceListOfGetIndexConventionResponse</returns>
