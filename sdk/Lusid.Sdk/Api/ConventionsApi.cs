...
namespace Lusid.Sdk.Api
{
    ...
    public partial class ConventionsApi : IConventionsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get Flow Conventions Get a Flow Conventions from a single scope.  The response will return either the recipe that has been stored, or a failure explaining why the request was unsuccessful.  It is important to always check for any unsuccessful requests (failures).
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the Flow Conventions to retrieve.</param>
        /// <param name="code">The name of the Flow Conventions to retrieve the data for.</param>
