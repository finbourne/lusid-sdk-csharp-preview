...
namespace Lusid.Sdk.Api
{
    ...
    public interface IChartOfAccountsApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the chart of account.</param>
        /// <param name="code">The code of the chart of account. Together with the scope this uniquely identifies              the chart of accounts.</param>
