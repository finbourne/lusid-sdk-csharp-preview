...
namespace Lusid.Sdk.Api
{
    ...
    public interface IConfigurationRecipeApi : IApiAccessor
    {
        ...
        ApiResponse<UpsertSingleStructuredDataResponse> UpsertConfigurationRecipeWithHttpInfo (string scope, UpsertRecipeRequest upsertRecipeRequest);
        ...
        System.Threading.Tasks.Task<UpsertSingleStructuredDataResponse> UpsertConfigurationRecipeAsync (string scope, UpsertRecipeRequest upsertRecipeRequest);
        ...
        System.Threading.Tasks.Task<ApiResponse<UpsertSingleStructuredDataResponse>> UpsertConfigurationRecipeAsyncWithHttpInfo (string scope, UpsertRecipeRequest upsertRecipeRequest);
    ...
    public partial class ConfigurationRecipeApi : IConfigurationRecipeApi
    {
        ...
        /// <param name="upsertRecipeRequest">The Configuration Recipe to update or insert</param>
        /// <returns>UpsertSingleStructuredDataResponse</returns>
        public UpsertSingleStructuredDataResponse UpsertConfigurationRecipe (string scope, UpsertRecipeRequest upsertRecipeRequest)
        {
             ApiResponse<UpsertSingleStructuredDataResponse> localVarResponse = UpsertConfigurationRecipeWithHttpInfo(scope, upsertRecipeRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="upsertRecipeRequest">The Configuration Recipe to update or insert</param>
        /// <returns>ApiResponse of UpsertSingleStructuredDataResponse</returns>
        public ApiResponse< UpsertSingleStructuredDataResponse > UpsertConfigurationRecipeWithHttpInfo (string scope, UpsertRecipeRequest upsertRecipeRequest)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="upsertRecipeRequest">The Configuration Recipe to update or insert</param>
        /// <returns>Task of UpsertSingleStructuredDataResponse</returns>
        public async System.Threading.Tasks.Task<UpsertSingleStructuredDataResponse> UpsertConfigurationRecipeAsync (string scope, UpsertRecipeRequest upsertRecipeRequest)
        {
             ApiResponse<UpsertSingleStructuredDataResponse> localVarResponse = await UpsertConfigurationRecipeAsyncWithHttpInfo(scope, upsertRecipeRequest);
             return localVarResponse.Data;
        ...
        /// <param name="upsertRecipeRequest">The Configuration Recipe to update or insert</param>
        /// <returns>Task of ApiResponse (UpsertSingleStructuredDataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpsertSingleStructuredDataResponse>> UpsertConfigurationRecipeAsyncWithHttpInfo (string scope, UpsertRecipeRequest upsertRecipeRequest)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ConfigurationRecipeApi->UpsertConfigurationRecipe");
