...
namespace Lusid.Sdk.Api
{
    ...
    public interface IConfigurationRecipeApi : IApiAccessor
    {
        ...
        ApiResponse<ResourceListOfGetRecipeResponse> ListConfigurationRecipesWithHttpInfo (DateTimeOffset? asAt = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ResourceListOfGetRecipeResponse> ListConfigurationRecipesAsync (DateTimeOffset? asAt = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfGetRecipeResponse>> ListConfigurationRecipesAsyncWithHttpInfo (DateTimeOffset? asAt = null);
        /// <summary>
        /// [EXPERIMENTAL] List the set of Configuration Recipes from all scopes
        /// </summary>
        /// <remarks>
    ...
    public partial class ConfigurationRecipeApi : IConfigurationRecipeApi
    {
        ...
        /// <param name="asAt">The asAt datetime at which to list the Configuration Recipes. Defaults to latest if not specified. (optional)</param>
        /// <returns>ResourceListOfGetRecipeResponse</returns>
        public ResourceListOfGetRecipeResponse ListConfigurationRecipes (DateTimeOffset? asAt = null)
        {
             ApiResponse<ResourceListOfGetRecipeResponse> localVarResponse = ListConfigurationRecipesWithHttpInfo(asAt);
             return localVarResponse.Data;
        }
        ...
        /// <param name="asAt">The asAt datetime at which to list the Configuration Recipes. Defaults to latest if not specified. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfGetRecipeResponse</returns>
        public ApiResponse< ResourceListOfGetRecipeResponse > ListConfigurationRecipesWithHttpInfo (DateTimeOffset? asAt = null)
        {
        ...
        /// <param name="asAt">The asAt datetime at which to list the Configuration Recipes. Defaults to latest if not specified. (optional)</param>
        /// <returns>Task of ResourceListOfGetRecipeResponse</returns>
        public async System.Threading.Tasks.Task<ResourceListOfGetRecipeResponse> ListConfigurationRecipesAsync (DateTimeOffset? asAt = null)
        {
             ApiResponse<ResourceListOfGetRecipeResponse> localVarResponse = await ListConfigurationRecipesAsyncWithHttpInfo(asAt);
             return localVarResponse.Data;
        ...
        /// <param name="asAt">The asAt datetime at which to list the Configuration Recipes. Defaults to latest if not specified. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfGetRecipeResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfGetRecipeResponse>> ListConfigurationRecipesAsyncWithHttpInfo (DateTimeOffset? asAt = null)
        {
        ...
        public ApiResponse< ResourceListOfGetRecipeResponse > ListConfigurationRecipesForAllScopesWithHttpInfo (DateTimeOffset? asAt = null, string filter = null)
        {
            ...
            var localVarPath = "./api/recipes/list";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
