...
namespace Lusid.Sdk.Api
{
    ...
    public interface IComplianceApiSync : IApiAccessor
    {
        ...
        ApiResponse<ComplianceRunSummary> GetComplianceRunSummaryWithHttpInfo(string scope, string code);
        /// <summary>
    ...
    public interface IComplianceApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ComplianceRunSummary> GetComplianceRunSummaryAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ComplianceRunSummary>> GetComplianceRunSummaryWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EARLY ACCESS] GetComplianceTemplate: Get the requested compliance template.
        /// </summary>
        /// <remarks>
    ...
    public partial class ComplianceApi : IComplianceApi
    {
        ...
        /// <param name="code">Required: Run Code.</param>
        /// <returns>ComplianceRunSummary</returns>
        public ComplianceRunSummary GetComplianceRunSummary(string scope, string code)
        {
            Lusid.Sdk.Client.ApiResponse<ComplianceRunSummary> localVarResponse = GetComplianceRunSummaryWithHttpInfo(scope, code);
            return localVarResponse.Data;
        }
        ...
        /// <param name="code">Required: Run Code.</param>
        /// <returns>ApiResponse of ComplianceRunSummary</returns>
        public Lusid.Sdk.Client.ApiResponse<ComplianceRunSummary> GetComplianceRunSummaryWithHttpInfo(string scope, string code)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling ComplianceApi->GetComplianceRunSummary");

            // verify the required parameter 'code' is set
            if (code == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling ComplianceApi->GetComplianceRunSummary");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ComplianceRunSummary>("/api/compliance/runs/summary/{scope}/{code}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ComplianceRunSummary</returns>
        public async System.Threading.Tasks.Task<ComplianceRunSummary> GetComplianceRunSummaryAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<ComplianceRunSummary> localVarResponse = await GetComplianceRunSummaryWithHttpInfoAsync(scope, code, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ComplianceRunSummary)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ComplianceRunSummary>> GetComplianceRunSummaryWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling ComplianceApi->GetComplianceRunSummary");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ComplianceRunSummary>("/api/compliance/runs/summary/{scope}/{code}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
