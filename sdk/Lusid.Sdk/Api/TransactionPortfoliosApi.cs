...
namespace Lusid.Sdk.Api
{
    ...
    public interface ITransactionPortfoliosApi : IApiAccessor
    {
        ...
        /// <param name="instrumentIdentifierCollection">The dictionary with the instrument identifiers to be updated on the              transaction and holdings. (optional)</param>
        ...
        ApiResponse<UpsertPortfolioTransactionsResponse> ResolveInstrumentWithHttpInfo (string scope, string code, string instrumentIdentifierType, string instrumentIdentifierValue, DateTimeOrCutLabel fromEffectiveAt = null, Dictionary<string, string> instrumentIdentifierCollection = null);
        /// <summary>
        /// Set holdings
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<UpsertPortfolioTransactionsResponse> ResolveInstrumentAsync (string scope, string code, string instrumentIdentifierType, string instrumentIdentifierValue, DateTimeOrCutLabel fromEffectiveAt = null, Dictionary<string, string> instrumentIdentifierCollection = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<UpsertPortfolioTransactionsResponse>> ResolveInstrumentAsyncWithHttpInfo (string scope, string code, string instrumentIdentifierType, string instrumentIdentifierValue, DateTimeOrCutLabel fromEffectiveAt = null, Dictionary<string, string> instrumentIdentifierCollection = null);
        /// <summary>
        /// Set holdings
        /// </summary>
        /// <remarks>
    ...
    public partial class TransactionPortfoliosApi : ITransactionPortfoliosApi
    {
        ...
        /// <param name="instrumentIdentifierCollection">The dictionary with the instrument identifiers to be updated on the              transaction and holdings. (optional)</param>
        /// <returns>UpsertPortfolioTransactionsResponse</returns>
        public UpsertPortfolioTransactionsResponse ResolveInstrument (string scope, string code, string instrumentIdentifierType, string instrumentIdentifierValue, DateTimeOrCutLabel fromEffectiveAt = null, Dictionary<string, string> instrumentIdentifierCollection = null)
        {
             ApiResponse<UpsertPortfolioTransactionsResponse> localVarResponse = ResolveInstrumentWithHttpInfo(scope, code, instrumentIdentifierType, instrumentIdentifierValue, fromEffectiveAt, instrumentIdentifierCollection);
             return localVarResponse.Data;
        }
        ...
        /// <param name="instrumentIdentifierCollection">The dictionary with the instrument identifiers to be updated on the              transaction and holdings. (optional)</param>
        /// <returns>ApiResponse of UpsertPortfolioTransactionsResponse</returns>
        public ApiResponse< UpsertPortfolioTransactionsResponse > ResolveInstrumentWithHttpInfo (string scope, string code, string instrumentIdentifierType, string instrumentIdentifierValue, DateTimeOrCutLabel fromEffectiveAt = null, Dictionary<string, string> instrumentIdentifierCollection = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            if (fromEffectiveAt != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "fromEffectiveAt", fromEffectiveAt)); // query parameter
            if (instrumentIdentifierCollection != null && instrumentIdentifierCollection.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(instrumentIdentifierCollection); // http body (model) parameter
            }
            else
            {
                localVarPostBody = instrumentIdentifierCollection; // byte array
            }
        ...
        /// <param name="instrumentIdentifierCollection">The dictionary with the instrument identifiers to be updated on the              transaction and holdings. (optional)</param>
        /// <returns>Task of UpsertPortfolioTransactionsResponse</returns>
        public async System.Threading.Tasks.Task<UpsertPortfolioTransactionsResponse> ResolveInstrumentAsync (string scope, string code, string instrumentIdentifierType, string instrumentIdentifierValue, DateTimeOrCutLabel fromEffectiveAt = null, Dictionary<string, string> instrumentIdentifierCollection = null)
        {
             ApiResponse<UpsertPortfolioTransactionsResponse> localVarResponse = await ResolveInstrumentAsyncWithHttpInfo(scope, code, instrumentIdentifierType, instrumentIdentifierValue, fromEffectiveAt, instrumentIdentifierCollection);
             return localVarResponse.Data;
        ...
        /// <param name="instrumentIdentifierCollection">The dictionary with the instrument identifiers to be updated on the              transaction and holdings. (optional)</param>
        /// <returns>Task of ApiResponse (UpsertPortfolioTransactionsResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpsertPortfolioTransactionsResponse>> ResolveInstrumentAsyncWithHttpInfo (string scope, string code, string instrumentIdentifierType, string instrumentIdentifierValue, DateTimeOrCutLabel fromEffectiveAt = null, Dictionary<string, string> instrumentIdentifierCollection = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling TransactionPortfoliosApi->ResolveInstrument");
