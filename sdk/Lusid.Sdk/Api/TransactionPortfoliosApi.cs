...
namespace Lusid.Sdk.Api
{
    ...
    public interface ITransactionPortfoliosApiSync : IApiAccessor
    {
        ...
        ResourceListOfPortfolioCashLadder GetPortfolioCashLadder(string scope, string code, DateTimeOrCutLabel fromEffectiveAt, DateTimeOrCutLabel toEffectiveAt, DateTimeOffset? asAt = default(DateTimeOffset?), string filter = default(string), string recipeIdScope = default(string), string recipeIdCode = default(string));
    ...
    public partial class TransactionPortfoliosApi : ITransactionPortfoliosApi
    {
        ...
        /// <param name="recipeIdCode">The code of the given recipeID (optional)</param>
        /// <returns>ResourceListOfPortfolioCashLadder</returns>
        public ResourceListOfPortfolioCashLadder GetPortfolioCashLadder(string scope, string code, DateTimeOrCutLabel fromEffectiveAt, DateTimeOrCutLabel toEffectiveAt, DateTimeOffset? asAt = default(DateTimeOffset?), string filter = default(string), string recipeIdScope = default(string), string recipeIdCode = default(string))
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfPortfolioCashLadder> localVarResponse = GetPortfolioCashLadderWithHttpInfo(scope, code, fromEffectiveAt, toEffectiveAt, asAt, filter, recipeIdScope, recipeIdCode);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfPortfolioCashLadder> localVarResponse = await GetPortfolioCashLadderWithHttpInfoAsync(scope, code, fromEffectiveAt, toEffectiveAt, asAt, filter, recipeIdScope, recipeIdCode, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
