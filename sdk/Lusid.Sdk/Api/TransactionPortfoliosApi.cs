...
namespace Lusid.Sdk.Api
{
    ...
    public interface ITransactionPortfoliosApiSync : IApiAccessor
    {
        ...
        ApiResponse<CreateTradeTicketsResponse> BatchCreateTradeTicketsWithHttpInfo(string scope, string code, List<LusidTradeTicket> lusidTradeTicket);
        /// <summary>
        ...
        /// <param name="reconciliationMethods">Optional parameter for specifying a reconciliation method: e.g. FxForward. (optional)</param>
        /// <returns>BatchAdjustHoldingsResponse</returns>
        BatchAdjustHoldingsResponse BatchSetHoldings(string scope, string code, string successMode, Dictionary<string, AdjustHoldingForDateRequest> requestBody, List<string> reconciliationMethods = default(List<string>));
        ...
        /// <param name="reconciliationMethods">Optional parameter for specifying a reconciliation method: e.g. FxForward. (optional)</param>
        /// <returns>ApiResponse of BatchAdjustHoldingsResponse</returns>
        ApiResponse<BatchAdjustHoldingsResponse> BatchSetHoldingsWithHttpInfo(string scope, string code, string successMode, Dictionary<string, AdjustHoldingForDateRequest> requestBody, List<string> reconciliationMethods = default(List<string>));
        /// <summary>
        ...
        BatchUpsertPortfolioTransactionsResponse BatchUpsertTransactions(string scope, string code, string successMode, Dictionary<string, TransactionRequest> requestBody, bool? preserveProperties = default(bool?));
        ...
        ApiResponse<BatchUpsertPortfolioTransactionsResponse> BatchUpsertTransactionsWithHttpInfo(string scope, string code, string successMode, Dictionary<string, TransactionRequest> requestBody, bool? preserveProperties = default(bool?));
        /// <summary>
        ...
        LusidTradeTicket CreateTradeTicket(string scope, string code, LusidTradeTicket lusidTradeTicket = default(LusidTradeTicket));
        ...
        /// <param name="page">The pagination token to use to continue listing transactions from a previous call to GetHoldingContributors. (optional)</param>
        /// <returns>ApiResponse of VersionedResourceListOfHoldingContributor</returns>
        ApiResponse<VersionedResourceListOfHoldingContributor> GetMultipleHoldingContributorsWithHttpInfo(string scope, string code, HoldingIdsRequest holdingIdsRequest, DateTimeOrCutLabel effectiveDate = default(DateTimeOrCutLabel), DateTimeOrCutLabel fromTransactionDate = default(DateTimeOrCutLabel), DateTimeOrCutLabel toTransactionDate = default(DateTimeOrCutLabel), bool? includeHistoric = default(bool?), string taxLotId = default(string), int? limit = default(int?), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string));
        /// <summary>
        ...
        ResourceListOfOutputTransaction PreviewTransaction(string scope, string code, TransactionRequest transactionRequest, List<string> propertyKeys = default(List<string>), bool? showCancelledTransactions = default(bool?), bool? preserveProperties = default(bool?));
        ...
        ApiResponse<ResourceListOfOutputTransaction> PreviewTransactionWithHttpInfo(string scope, string code, TransactionRequest transactionRequest, List<string> propertyKeys = default(List<string>), bool? showCancelledTransactions = default(bool?), bool? preserveProperties = default(bool?));
        /// <summary>
        ...
        /// <param name="preserveProperties">If set to false, the entire property set will be overwritten by the provided properties. If not specified or set to true, only the properties provided will be updated. (optional, default to true)</param>
        /// <returns>UpsertPortfolioTransactionsResponse</returns>
        UpsertPortfolioTransactionsResponse UpsertTransactions(string scope, string code, List<TransactionRequest> transactionRequest, bool? preserveProperties = default(bool?));
        ...
        /// <param name="preserveProperties">If set to false, the entire property set will be overwritten by the provided properties. If not specified or set to true, only the properties provided will be updated. (optional, default to true)</param>
        /// <returns>ApiResponse of UpsertPortfolioTransactionsResponse</returns>
        ApiResponse<UpsertPortfolioTransactionsResponse> UpsertTransactionsWithHttpInfo(string scope, string code, List<TransactionRequest> transactionRequest, bool? preserveProperties = default(bool?));
    ...
    public interface ITransactionPortfoliosApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CreateTradeTicketsResponse> BatchCreateTradeTicketsAsync(string scope, string code, List<LusidTradeTicket> lusidTradeTicket, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CreateTradeTicketsResponse>> BatchCreateTradeTicketsWithHttpInfoAsync(string scope, string code, List<LusidTradeTicket> lusidTradeTicket, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EARLY ACCESS] BatchSetHoldings: Batch set holdings
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<BatchUpsertPortfolioTransactionsResponse> BatchUpsertTransactionsAsync(string scope, string code, string successMode, Dictionary<string, TransactionRequest> requestBody, bool? preserveProperties = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<LusidTradeTicket> CreateTradeTicketAsync(string scope, string code, LusidTradeTicket lusidTradeTicket = default(LusidTradeTicket), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VersionedResourceListOfHoldingContributor)</returns>
        System.Threading.Tasks.Task<ApiResponse<VersionedResourceListOfHoldingContributor>> GetMultipleHoldingContributorsWithHttpInfoAsync(string scope, string code, HoldingIdsRequest holdingIdsRequest, DateTimeOrCutLabel effectiveDate = default(DateTimeOrCutLabel), DateTimeOrCutLabel fromTransactionDate = default(DateTimeOrCutLabel), DateTimeOrCutLabel toTransactionDate = default(DateTimeOrCutLabel), bool? includeHistoric = default(bool?), string taxLotId = default(string), int? limit = default(int?), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// GetPortfolioCashFlows: Get portfolio cash flows
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<VersionedResourceListOfTransaction> GetTransactionsAsync(string scope, string code, DateTimeOrCutLabel fromTransactionDate = default(DateTimeOrCutLabel), DateTimeOrCutLabel toTransactionDate = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string filter = default(string), List<string> propertyKeys = default(List<string>), string page = default(string), int? limit = default(int?), bool? showCancelledTransactions = default(bool?), List<string> sortBy = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ResourceListOfOutputTransaction> PreviewTransactionAsync(string scope, string code, TransactionRequest transactionRequest, List<string> propertyKeys = default(List<string>), bool? showCancelledTransactions = default(bool?), bool? preserveProperties = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfOutputTransaction>> PreviewTransactionWithHttpInfoAsync(string scope, string code, TransactionRequest transactionRequest, List<string> propertyKeys = default(List<string>), bool? showCancelledTransactions = default(bool?), bool? preserveProperties = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// ResolveInstrument: Resolve instrument
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UpsertPortfolioTransactionsResponse</returns>
        System.Threading.Tasks.Task<UpsertPortfolioTransactionsResponse> UpsertTransactionsAsync(string scope, string code, List<TransactionRequest> transactionRequest, bool? preserveProperties = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UpsertPortfolioTransactionsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<UpsertPortfolioTransactionsResponse>> UpsertTransactionsWithHttpInfoAsync(string scope, string code, List<TransactionRequest> transactionRequest, bool? preserveProperties = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TransactionPortfoliosApi : ITransactionPortfoliosApi
    {
        ...
        /// <param name="lusidTradeTicket">the trade tickets to create</param>
        /// <returns>CreateTradeTicketsResponse</returns>
        public CreateTradeTicketsResponse BatchCreateTradeTickets(string scope, string code, List<LusidTradeTicket> lusidTradeTicket)
        {
        ...
        /// <param name="lusidTradeTicket">the trade tickets to create</param>
        /// <returns>ApiResponse of CreateTradeTicketsResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<CreateTradeTicketsResponse> BatchCreateTradeTicketsWithHttpInfo(string scope, string code, List<LusidTradeTicket> lusidTradeTicket)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CreateTradeTicketsResponse</returns>
        public async System.Threading.Tasks.Task<CreateTradeTicketsResponse> BatchCreateTradeTicketsAsync(string scope, string code, List<LusidTradeTicket> lusidTradeTicket, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<CreateTradeTicketsResponse> localVarResponse = await BatchCreateTradeTicketsWithHttpInfoAsync(scope, code, lusidTradeTicket, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CreateTradeTicketsResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<CreateTradeTicketsResponse>> BatchCreateTradeTicketsWithHttpInfoAsync(string scope, string code, List<LusidTradeTicket> lusidTradeTicket, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling TransactionPortfoliosApi->BatchCreateTradeTickets");
        ...
        /// <param name="reconciliationMethods">Optional parameter for specifying a reconciliation method: e.g. FxForward. (optional)</param>
        /// <returns>BatchAdjustHoldingsResponse</returns>
        public BatchAdjustHoldingsResponse BatchSetHoldings(string scope, string code, string successMode, Dictionary<string, AdjustHoldingForDateRequest> requestBody, List<string> reconciliationMethods = default(List<string>))
        {
            Lusid.Sdk.Client.ApiResponse<BatchAdjustHoldingsResponse> localVarResponse = BatchSetHoldingsWithHttpInfo(scope, code, successMode, requestBody, reconciliationMethods);
            return localVarResponse.Data;
        }
        ...
        /// <param name="reconciliationMethods">Optional parameter for specifying a reconciliation method: e.g. FxForward. (optional)</param>
        /// <returns>ApiResponse of BatchAdjustHoldingsResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<BatchAdjustHoldingsResponse> BatchSetHoldingsWithHttpInfo(string scope, string code, string successMode, Dictionary<string, AdjustHoldingForDateRequest> requestBody, List<string> reconciliationMethods = default(List<string>))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<BatchAdjustHoldingsResponse> localVarResponse = await BatchSetHoldingsWithHttpInfoAsync(scope, code, successMode, requestBody, reconciliationMethods, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="preserveProperties">If set to false, the entire property set will be overwritten by the provided properties. If not specified or set to true, only the properties provided will be updated. (optional, default to true)</param>
        /// <returns>BatchUpsertPortfolioTransactionsResponse</returns>
        public BatchUpsertPortfolioTransactionsResponse BatchUpsertTransactions(string scope, string code, string successMode, Dictionary<string, TransactionRequest> requestBody, bool? preserveProperties = default(bool?))
        {
        ...
        /// <param name="preserveProperties">If set to false, the entire property set will be overwritten by the provided properties. If not specified or set to true, only the properties provided will be updated. (optional, default to true)</param>
        /// <returns>ApiResponse of BatchUpsertPortfolioTransactionsResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<BatchUpsertPortfolioTransactionsResponse> BatchUpsertTransactionsWithHttpInfo(string scope, string code, string successMode, Dictionary<string, TransactionRequest> requestBody, bool? preserveProperties = default(bool?))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<BatchUpsertPortfolioTransactionsResponse> localVarResponse = await BatchUpsertTransactionsWithHttpInfoAsync(scope, code, successMode, requestBody, preserveProperties, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="lusidTradeTicket">the trade ticket to upsert (optional)</param>
        /// <returns>LusidTradeTicket</returns>
        public LusidTradeTicket CreateTradeTicket(string scope, string code, LusidTradeTicket lusidTradeTicket = default(LusidTradeTicket))
        {
        ...
        /// <param name="lusidTradeTicket">the trade ticket to upsert (optional)</param>
        /// <returns>ApiResponse of LusidTradeTicket</returns>
        public Lusid.Sdk.Client.ApiResponse<LusidTradeTicket> CreateTradeTicketWithHttpInfo(string scope, string code, LusidTradeTicket lusidTradeTicket = default(LusidTradeTicket))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of LusidTradeTicket</returns>
        public async System.Threading.Tasks.Task<LusidTradeTicket> CreateTradeTicketAsync(string scope, string code, LusidTradeTicket lusidTradeTicket = default(LusidTradeTicket), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<LusidTradeTicket> localVarResponse = await CreateTradeTicketWithHttpInfoAsync(scope, code, lusidTradeTicket, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (LusidTradeTicket)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<LusidTradeTicket>> CreateTradeTicketWithHttpInfoAsync(string scope, string code, LusidTradeTicket lusidTradeTicket = default(LusidTradeTicket), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling TransactionPortfoliosApi->CreateTradeTicket");
        ...
        {
            Lusid.Sdk.Client.ApiResponse<VersionedResourceListOfHoldingContributor> localVarResponse = await GetHoldingContributorsWithHttpInfoAsync(scope, code, holdingId, effectiveDate, fromTradeDate, toTradeDate, includeHistoric, taxLotId, limit, asAt, page, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<VersionedResourceListOfPortfolioHolding> localVarResponse = await GetHoldingsWithHttpInfoAsync(scope, code, effectiveAt, asAt, filter, propertyKeys, byTaxlots, includeSettlementEventsAfterDays, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<VersionedResourceListWithWarningsOfPortfolioHolding> localVarResponse = await GetHoldingsWithOrdersWithHttpInfoAsync(scope, code, effectiveAt, asAt, filter, propertyKeys, byTaxlots, recipeIdScope, recipeIdCode, includeSettlementEventsAfterDays, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<VersionedResourceListOfHoldingContributor> localVarResponse = GetMultipleHoldingContributorsWithHttpInfo(scope, code, holdingIdsRequest, effectiveDate, fromTransactionDate, toTransactionDate, includeHistoric, taxLotId, limit, asAt, page);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfInstrumentCashFlow> localVarResponse = await GetPortfolioCashFlowsWithHttpInfoAsync(scope, code, effectiveAt, windowStart, windowEnd, asAt, filter, recipeIdScope, recipeIdCode, excludeUnsettledTrades, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<VersionedResourceListOfTransaction> localVarResponse = await GetTransactionsWithHttpInfoAsync(scope, code, fromTransactionDate, toTransactionDate, asAt, filter, propertyKeys, page, limit, showCancelledTransactions, sortBy, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfTransaction> localVarResponse = await GetUpsertablePortfolioCashFlowsWithHttpInfoAsync(scope, code, effectiveAt, windowStart, windowEnd, asAt, filter, recipeIdScope, recipeIdCode, excludeUnsettledTrades, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfCustodianAccount> localVarResponse = await ListCustodianAccountsWithHttpInfoAsync(scope, code, effectiveAt, asAt, page, limit, filter, propertyKeys, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="preserveProperties">If the preview transaction is an amendment to an existing transaction, then setting this to true will carry forward any unmodified properties from the earlier version. (optional)</param>
        /// <returns>ResourceListOfOutputTransaction</returns>
        public ResourceListOfOutputTransaction PreviewTransaction(string scope, string code, TransactionRequest transactionRequest, List<string> propertyKeys = default(List<string>), bool? showCancelledTransactions = default(bool?), bool? preserveProperties = default(bool?))
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfOutputTransaction> localVarResponse = PreviewTransactionWithHttpInfo(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties);
            return localVarResponse.Data;
        }
        ...
        /// <param name="preserveProperties">If the preview transaction is an amendment to an existing transaction, then setting this to true will carry forward any unmodified properties from the earlier version. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfOutputTransaction</returns>
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfOutputTransaction> PreviewTransactionWithHttpInfo(string scope, string code, TransactionRequest transactionRequest, List<string> propertyKeys = default(List<string>), bool? showCancelledTransactions = default(bool?), bool? preserveProperties = default(bool?))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResourceListOfOutputTransaction</returns>
        public async System.Threading.Tasks.Task<ResourceListOfOutputTransaction> PreviewTransactionAsync(string scope, string code, TransactionRequest transactionRequest, List<string> propertyKeys = default(List<string>), bool? showCancelledTransactions = default(bool?), bool? preserveProperties = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfOutputTransaction> localVarResponse = await PreviewTransactionWithHttpInfoAsync(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="preserveProperties">If set to false, the entire property set will be overwritten by the provided properties. If not specified or set to true, only the properties provided will be updated. (optional, default to true)</param>
        /// <returns>UpsertPortfolioTransactionsResponse</returns>
        public UpsertPortfolioTransactionsResponse UpsertTransactions(string scope, string code, List<TransactionRequest> transactionRequest, bool? preserveProperties = default(bool?))
        {
        ...
        /// <param name="preserveProperties">If set to false, the entire property set will be overwritten by the provided properties. If not specified or set to true, only the properties provided will be updated. (optional, default to true)</param>
        /// <returns>ApiResponse of UpsertPortfolioTransactionsResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<UpsertPortfolioTransactionsResponse> UpsertTransactionsWithHttpInfo(string scope, string code, List<TransactionRequest> transactionRequest, bool? preserveProperties = default(bool?))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UpsertPortfolioTransactionsResponse</returns>
        public async System.Threading.Tasks.Task<UpsertPortfolioTransactionsResponse> UpsertTransactionsAsync(string scope, string code, List<TransactionRequest> transactionRequest, bool? preserveProperties = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<UpsertPortfolioTransactionsResponse> localVarResponse = await UpsertTransactionsWithHttpInfoAsync(scope, code, transactionRequest, preserveProperties, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UpsertPortfolioTransactionsResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<UpsertPortfolioTransactionsResponse>> UpsertTransactionsWithHttpInfoAsync(string scope, string code, List<TransactionRequest> transactionRequest, bool? preserveProperties = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling TransactionPortfoliosApi->UpsertTransactions");
