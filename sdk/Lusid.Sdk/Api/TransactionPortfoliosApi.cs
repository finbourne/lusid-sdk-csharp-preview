...
namespace Lusid.Sdk.Api
{
    ...
    public interface ITransactionPortfoliosApi : IApiAccessor
    {
        ...
        /// <param name="toEffectiveAt">The upper bound effective datetime or cut label (inclusive) from which to retrieve the data.              There is no upper bound if this is not specified. (optional)</param>
        ...
        /// <returns>PortfolioCashFlowsResponse</returns>
        ...
        /// <param name="toEffectiveAt">The upper bound effective datetime or cut label (inclusive) from which to retrieve the data.              There is no upper bound if this is not specified. (optional)</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the portfolio. Defaults to return the latest version              of each transaction if not specified. (optional)</param>
        /// <returns>ApiResponse of PortfolioCashFlowsResponse</returns>
        ApiResponse<PortfolioCashFlowsResponse> GetPortfolioCashFlowsWithHttpInfo (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null);
        /// <summary>
        /// Get transactions
        /// </summary>
        /// <remarks>
        ...
        /// <param name="toEffectiveAt">The upper bound effective datetime or cut label (inclusive) from which to retrieve the data.              There is no upper bound if this is not specified. (optional)</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the portfolio. Defaults to return the latest version              of each transaction if not specified. (optional)</param>
        /// <returns>Task of PortfolioCashFlowsResponse</returns>
        System.Threading.Tasks.Task<PortfolioCashFlowsResponse> GetPortfolioCashFlowsAsync (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null);
        ...
        /// <param name="toEffectiveAt">The upper bound effective datetime or cut label (inclusive) from which to retrieve the data.              There is no upper bound if this is not specified. (optional)</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the portfolio. Defaults to return the latest version              of each transaction if not specified. (optional)</param>
        /// <returns>Task of ApiResponse (PortfolioCashFlowsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<PortfolioCashFlowsResponse>> GetPortfolioCashFlowsAsyncWithHttpInfo (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null);
        /// <summary>
        /// Get transactions
        /// </summary>
        /// <remarks>
    ...
    public partial class TransactionPortfoliosApi : ITransactionPortfoliosApi
    {
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the portfolio. Defaults to return the latest version              of each transaction if not specified. (optional)</param>
        /// <returns>PortfolioCashFlowsResponse</returns>
        public PortfolioCashFlowsResponse GetPortfolioCashFlows (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null)
        {
             ApiResponse<PortfolioCashFlowsResponse> localVarResponse = GetPortfolioCashFlowsWithHttpInfo(scope, code, fromEffectiveAt, toEffectiveAt, asAt);
             return localVarResponse.Data;
        }
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the portfolio. Defaults to return the latest version              of each transaction if not specified. (optional)</param>
        /// <returns>ApiResponse of PortfolioCashFlowsResponse</returns>
        public ApiResponse< PortfolioCashFlowsResponse > GetPortfolioCashFlowsWithHttpInfo (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            return new ApiResponse<PortfolioCashFlowsResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (PortfolioCashFlowsResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(PortfolioCashFlowsResponse)));
        }
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the portfolio. Defaults to return the latest version              of each transaction if not specified. (optional)</param>
        /// <returns>Task of PortfolioCashFlowsResponse</returns>
        public async System.Threading.Tasks.Task<PortfolioCashFlowsResponse> GetPortfolioCashFlowsAsync (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null)
        {
             ApiResponse<PortfolioCashFlowsResponse> localVarResponse = await GetPortfolioCashFlowsAsyncWithHttpInfo(scope, code, fromEffectiveAt, toEffectiveAt, asAt);
             return localVarResponse.Data;
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the portfolio. Defaults to return the latest version              of each transaction if not specified. (optional)</param>
        /// <returns>Task of ApiResponse (PortfolioCashFlowsResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PortfolioCashFlowsResponse>> GetPortfolioCashFlowsAsyncWithHttpInfo (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling TransactionPortfoliosApi->GetPortfolioCashFlows");
