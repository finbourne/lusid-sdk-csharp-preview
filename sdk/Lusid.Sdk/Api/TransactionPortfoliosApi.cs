...
namespace Lusid.Sdk.Api
{
    ...
    public interface ITransactionPortfoliosApiSync : IApiAccessor
    {
        ...
        BucketedCashFlowResponse GetBucketedCashFlows(string scope, string code, bool? excludeUnsettledTrades = default(bool?), BucketedCashFlowRequest bucketedCashFlowRequest = default(BucketedCashFlowRequest));
        ...
        ApiResponse<BucketedCashFlowResponse> GetBucketedCashFlowsWithHttpInfo(string scope, string code, bool? excludeUnsettledTrades = default(bool?), BucketedCashFlowRequest bucketedCashFlowRequest = default(BucketedCashFlowRequest));
        /// <summary>
    ...
    public interface ITransactionPortfoliosApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<BucketedCashFlowResponse>> GetBucketedCashFlowsWithHttpInfoAsync(string scope, string code, bool? excludeUnsettledTrades = default(bool?), BucketedCashFlowRequest bucketedCashFlowRequest = default(BucketedCashFlowRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// GetDetails: Get details
        /// </summary>
        /// <remarks>
    ...
    public partial class TransactionPortfoliosApi : ITransactionPortfoliosApi
    {
        ...
        /// <param name="bucketedCashFlowRequest">Request specifying the bucketing of cashflows (optional)</param>
        /// <returns>BucketedCashFlowResponse</returns>
        public BucketedCashFlowResponse GetBucketedCashFlows(string scope, string code, bool? excludeUnsettledTrades = default(bool?), BucketedCashFlowRequest bucketedCashFlowRequest = default(BucketedCashFlowRequest))
        {
            Lusid.Sdk.Client.ApiResponse<BucketedCashFlowResponse> localVarResponse = GetBucketedCashFlowsWithHttpInfo(scope, code, excludeUnsettledTrades, bucketedCashFlowRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="bucketedCashFlowRequest">Request specifying the bucketing of cashflows (optional)</param>
        /// <returns>ApiResponse of BucketedCashFlowResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<BucketedCashFlowResponse> GetBucketedCashFlowsWithHttpInfo(string scope, string code, bool? excludeUnsettledTrades = default(bool?), BucketedCashFlowRequest bucketedCashFlowRequest = default(BucketedCashFlowRequest))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<BucketedCashFlowResponse> localVarResponse = await GetBucketedCashFlowsWithHttpInfoAsync(scope, code, excludeUnsettledTrades, bucketedCashFlowRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <summary>
        /// [EXPERIMENTAL] PatchPortfolioDetails: Patch portfolio details Create or update certain details for a particular transaction portfolio.  The behaviour is defined by the JSON Patch specification.                Note that not all elements of a transaction portfolio definition are  modifiable once it has been created due to the potential implications for data already stored.  Currently supported properties are: SubHoldingKeys, BaseCurrency, AmortisationMethod
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the               scope this uniquely identifies the transaction portfolio.</param>
