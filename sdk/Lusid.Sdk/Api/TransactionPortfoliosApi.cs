...
namespace Lusid.Sdk.Api
{
    ...
    public interface ITransactionPortfoliosApiSync : IApiAccessor
    {
        ...
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        /// <param name="tradeTicket">the trade ticket to upsert (optional)</param>
        /// <returns>TradeTicket</returns>
        TradeTicket CreateTradeTicket(string scope, string code, TradeTicket tradeTicket = default(TradeTicket));
        ...
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        /// <param name="tradeTicket">the trade ticket to upsert (optional)</param>
        /// <returns>ApiResponse of TradeTicket</returns>
        ApiResponse<TradeTicket> CreateTradeTicketWithHttpInfo(string scope, string code, TradeTicket tradeTicket = default(TradeTicket));
        /// <summary>
        ...
        /// <param name="shareClass">When running LookThrough, use this along with the slice parameter to specify              the root share class in the slice in the portfolio to look through from. The slice parameter is a prerequisite              for this parameter to be valid. (optional)</param>
        /// <returns>VersionedResourceListOfTransaction</returns>
        VersionedResourceListOfTransaction LookThroughTransactions(string scope, string code, DateTimeOrCutLabel fromTransactionDate = default(DateTimeOrCutLabel), DateTimeOrCutLabel toTransactionDate = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string filter = default(string), List<string> propertyKeys = default(List<string>), string page = default(string), int? limit = default(int?), string quotesScope = default(string), string slice = default(string), string shareClass = default(string));
    ...
    public interface ITransactionPortfoliosApiAsync : IApiAccessor
    {
        ...
        /// <param name="tradeTicket">the trade ticket to upsert (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TradeTicket</returns>
        System.Threading.Tasks.Task<TradeTicket> CreateTradeTicketAsync(string scope, string code, TradeTicket tradeTicket = default(TradeTicket), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="tradeTicket">the trade ticket to upsert (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TradeTicket)</returns>
        System.Threading.Tasks.Task<ApiResponse<TradeTicket>> CreateTradeTicketWithHttpInfoAsync(string scope, string code, TradeTicket tradeTicket = default(TradeTicket), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// DeletePropertiesFromTransaction: Delete properties from transaction
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of VersionedResourceListOfTransaction</returns>
        System.Threading.Tasks.Task<VersionedResourceListOfTransaction> LookThroughTransactionsAsync(string scope, string code, DateTimeOrCutLabel fromTransactionDate = default(DateTimeOrCutLabel), DateTimeOrCutLabel toTransactionDate = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string filter = default(string), List<string> propertyKeys = default(List<string>), string page = default(string), int? limit = default(int?), string quotesScope = default(string), string slice = default(string), string shareClass = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TransactionPortfoliosApi : ITransactionPortfoliosApi
    {
        ...
        /// <param name="tradeTicket">the trade ticket to upsert (optional)</param>
        /// <returns>TradeTicket</returns>
        public TradeTicket CreateTradeTicket(string scope, string code, TradeTicket tradeTicket = default(TradeTicket))
        {
            Lusid.Sdk.Client.ApiResponse<TradeTicket> localVarResponse = CreateTradeTicketWithHttpInfo(scope, code, tradeTicket);
            return localVarResponse.Data;
        }
        ...
        /// <param name="tradeTicket">the trade ticket to upsert (optional)</param>
        /// <returns>ApiResponse of TradeTicket</returns>
        public Lusid.Sdk.Client.ApiResponse<TradeTicket> CreateTradeTicketWithHttpInfo(string scope, string code, TradeTicket tradeTicket = default(TradeTicket))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            localVarRequestOptions.PathParameters.Add("scope", Lusid.Sdk.Client.ClientUtils.ParameterToString(scope)); // path parameter
            localVarRequestOptions.PathParameters.Add("code", Lusid.Sdk.Client.ClientUtils.ParameterToString(code)); // path parameter
            localVarRequestOptions.Data = tradeTicket;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<TradeTicket>("/api/transactionportfolios/{scope}/{code}/$tradeticket", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TradeTicket</returns>
        public async System.Threading.Tasks.Task<TradeTicket> CreateTradeTicketAsync(string scope, string code, TradeTicket tradeTicket = default(TradeTicket), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<TradeTicket> localVarResponse = await CreateTradeTicketWithHttpInfoAsync(scope, code, tradeTicket, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TradeTicket)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<TradeTicket>> CreateTradeTicketWithHttpInfoAsync(string scope, string code, TradeTicket tradeTicket = default(TradeTicket), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling TransactionPortfoliosApi->CreateTradeTicket");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<TradeTicket>("/api/transactionportfolios/{scope}/{code}/$tradeticket", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Lusid.Sdk.Client.ApiResponse<VersionedResourceListOfTransaction> localVarResponse = LookThroughTransactionsWithHttpInfo(scope, code, fromTransactionDate, toTransactionDate, asAt, filter, propertyKeys, page, limit, quotesScope, slice, shareClass);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<VersionedResourceListOfTransaction> localVarResponse = await LookThroughTransactionsWithHttpInfoAsync(scope, code, fromTransactionDate, toTransactionDate, asAt, filter, propertyKeys, page, limit, quotesScope, slice, shareClass, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
