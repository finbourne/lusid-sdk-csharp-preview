...
namespace Lusid.Sdk.Api
{
    ...
    public interface IOrderManagementApiSync : IApiAccessor
    {
        ...
        /// <param name="resourceId">The allocations to create transactions for</param>
        ...
        BookTransactionsResponse BookTransactions(List<ResourceId> resourceId, bool? applyFeesAndCommission = default(bool?));
    ...
    public interface IOrderManagementApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<BookTransactionsResponse> BookTransactionsAsync(List<ResourceId> resourceId, bool? applyFeesAndCommission = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class OrderManagementApi : IOrderManagementApi
    {
        ...
        /// <param name="applyFeesAndCommission">Whether to apply fees and commissions to transactions (default: true) (optional, default to true)</param>
        /// <returns>BookTransactionsResponse</returns>
        public BookTransactionsResponse BookTransactions(List<ResourceId> resourceId, bool? applyFeesAndCommission = default(bool?))
        {
            Lusid.Sdk.Client.ApiResponse<BookTransactionsResponse> localVarResponse = BookTransactionsWithHttpInfo(resourceId, applyFeesAndCommission);
        ...
        /// <param name="applyFeesAndCommission">Whether to apply fees and commissions to transactions (default: true) (optional, default to true)</param>
        /// <returns>ApiResponse of BookTransactionsResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<BookTransactionsResponse> BookTransactionsWithHttpInfo(List<ResourceId> resourceId, bool? applyFeesAndCommission = default(bool?))
        {
            // verify the required parameter 'resourceId' is set
            if (resourceId == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'resourceId' when calling OrderManagementApi->BookTransactions");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BookTransactionsResponse</returns>
        public async System.Threading.Tasks.Task<BookTransactionsResponse> BookTransactionsAsync(List<ResourceId> resourceId, bool? applyFeesAndCommission = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<BookTransactionsResponse> localVarResponse = await BookTransactionsWithHttpInfoAsync(resourceId, applyFeesAndCommission, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BookTransactionsResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<BookTransactionsResponse>> BookTransactionsWithHttpInfoAsync(List<ResourceId> resourceId, bool? applyFeesAndCommission = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'resourceId' is set
            if (resourceId == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'resourceId' when calling OrderManagementApi->BookTransactions");
