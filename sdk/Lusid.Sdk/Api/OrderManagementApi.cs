...
namespace Lusid.Sdk.Api
{
    ...
    public interface IOrderManagementApiSync : IApiAccessor
    {
        ...
        ApiResponse<ResourceListOfEntityChangeItem> GetOrderHistoryWithHttpInfo(string scope, string code);
        /// <summary>
    ...
    public interface IOrderManagementApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ResourceListOfEntityChangeItem> GetOrderHistoryAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfEntityChangeItem>> GetOrderHistoryWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EARLY ACCESS] MoveOrders: Move orders to new or existing block
        /// </summary>
        /// <remarks>
    ...
    public partial class OrderManagementApi : IOrderManagementApi
    {
        ...
        /// <param name="code">The code of the order.</param>
        /// <returns>ResourceListOfEntityChangeItem</returns>
        public ResourceListOfEntityChangeItem GetOrderHistory(string scope, string code)
        {
        ...
        /// <param name="code">The code of the order.</param>
        /// <returns>ApiResponse of ResourceListOfEntityChangeItem</returns>
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfEntityChangeItem> GetOrderHistoryWithHttpInfo(string scope, string code)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResourceListOfEntityChangeItem</returns>
        public async System.Threading.Tasks.Task<ResourceListOfEntityChangeItem> GetOrderHistoryAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfEntityChangeItem> localVarResponse = await GetOrderHistoryWithHttpInfoAsync(scope, code, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ResourceListOfEntityChangeItem)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfEntityChangeItem>> GetOrderHistoryWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling OrderManagementApi->GetOrderHistory");
