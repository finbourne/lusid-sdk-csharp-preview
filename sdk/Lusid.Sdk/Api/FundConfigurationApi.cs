...
namespace Lusid.Sdk.Api
{
    ...
    /// </summary>
    public interface IFundConfigurationApiSync : IApiAccessor
    {
        ...
        ApiResponse<FundConfiguration> CreateFundConfigurationWithHttpInfo(string scope, FundConfigurationRequest fundConfigurationRequest);
        /// <summary>
        ...
        ApiResponse<DeletedEntityResponse> DeleteFundConfigurationWithHttpInfo(string scope, string code);
        /// <summary>
        ...
        /// <returns>FundConfiguration</returns>
        FundConfiguration GetFundConfiguration(string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>));
        ...
        /// <param name="propertyKeys">A list of property keys from the &#39;FundConfiguration&#39; domain to decorate onto the FundConfiguration.              These must take the format {domain}/{scope}/{code}, for example &#39;FundConfiguration/Manager/Id&#39;. If no properties are specified, then no properties will be returned. (optional)</param>
        /// <returns>ApiResponse of FundConfiguration</returns>
        ApiResponse<FundConfiguration> GetFundConfigurationWithHttpInfo(string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>));
        /// <summary>
        ...
        /// <param name="operation">The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902.</param>
        /// <returns>ApiResponse of FundConfiguration</returns>
        ApiResponse<FundConfiguration> PatchFundConfigurationWithHttpInfo(string scope, string code, List<Operation> operation);
        /// <summary>
        ...
        FundConfigurationProperties UpsertFundConfigurationProperties(string scope, string code, Dictionary<string, Property> requestBody = default(Dictionary<string, Property>));
        ...
        ApiResponse<FundConfigurationProperties> UpsertFundConfigurationPropertiesWithHttpInfo(string scope, string code, Dictionary<string, Property> requestBody = default(Dictionary<string, Property>));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IFundConfigurationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<FundConfiguration> CreateFundConfigurationAsync(string scope, FundConfigurationRequest fundConfigurationRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<FundConfiguration>> CreateFundConfigurationWithHttpInfoAsync(string scope, FundConfigurationRequest fundConfigurationRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] DeleteFundConfiguration: Delete a FundConfiguration.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DeletedEntityResponse> DeleteFundConfigurationAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteFundConfigurationWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] GetFundConfiguration: Get FundConfiguration.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FundConfiguration</returns>
        System.Threading.Tasks.Task<FundConfiguration> PatchFundConfigurationAsync(string scope, string code, List<Operation> operation, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FundConfiguration)</returns>
        System.Threading.Tasks.Task<ApiResponse<FundConfiguration>> PatchFundConfigurationWithHttpInfoAsync(string scope, string code, List<Operation> operation, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] UpsertFundConfigurationProperties: Upsert FundConfiguration properties
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<FundConfigurationProperties> UpsertFundConfigurationPropertiesAsync(string scope, string code, Dictionary<string, Property> requestBody = default(Dictionary<string, Property>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IFundConfigurationApi : IFundConfigurationApiSync, IFundConfigurationApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class FundConfigurationApi : IFundConfigurationApi
    {
        private Lusid.Sdk.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="FundConfigurationApi"/> class.
        /// </summary>
        /// <returns></returns>
        public FundConfigurationApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public FundConfigurationApi(String basePath)
        {
        ...
        /// <returns></returns>
        public FundConfigurationApi(Lusid.Sdk.Client.Configuration configuration)
        {
        ...
        public FundConfigurationApi(Lusid.Sdk.Client.ISynchronousClient client, Lusid.Sdk.Client.IAsynchronousClient asyncClient, Lusid.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="fundConfigurationRequest">The definition of the FundConfiguration.</param>
        /// <returns>FundConfiguration</returns>
        public FundConfiguration CreateFundConfiguration(string scope, FundConfigurationRequest fundConfigurationRequest)
        {
            Lusid.Sdk.Client.ApiResponse<FundConfiguration> localVarResponse = CreateFundConfigurationWithHttpInfo(scope, fundConfigurationRequest);
        ...
        /// <param name="fundConfigurationRequest">The definition of the FundConfiguration.</param>
        /// <returns>ApiResponse of FundConfiguration</returns>
        public Lusid.Sdk.Client.ApiResponse<FundConfiguration> CreateFundConfigurationWithHttpInfo(string scope, FundConfigurationRequest fundConfigurationRequest)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundConfigurationApi->CreateFundConfiguration");

            // verify the required parameter 'fundConfigurationRequest' is set
            if (fundConfigurationRequest == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'fundConfigurationRequest' when calling FundConfigurationApi->CreateFundConfiguration");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FundConfiguration</returns>
        public async System.Threading.Tasks.Task<FundConfiguration> CreateFundConfigurationAsync(string scope, FundConfigurationRequest fundConfigurationRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<FundConfiguration> localVarResponse = await CreateFundConfigurationWithHttpInfoAsync(scope, fundConfigurationRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FundConfiguration)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<FundConfiguration>> CreateFundConfigurationWithHttpInfoAsync(string scope, FundConfigurationRequest fundConfigurationRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundConfigurationApi->CreateFundConfiguration");
        ...
        /// <param name="code">The code of the FundConfiguration to be deleted.               Together with the scope this uniquely identifies the FundConfiguration.</param>
        /// <returns>DeletedEntityResponse</returns>
        public DeletedEntityResponse DeleteFundConfiguration(string scope, string code)
        {
            Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> localVarResponse = DeleteFundConfigurationWithHttpInfo(scope, code);
            return localVarResponse.Data;
        }
        ...
        /// <param name="code">The code of the FundConfiguration to be deleted.               Together with the scope this uniquely identifies the FundConfiguration.</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> DeleteFundConfigurationWithHttpInfo(string scope, string code)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundConfigurationApi->DeleteFundConfiguration");

            // verify the required parameter 'code' is set
            if (code == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling FundConfigurationApi->DeleteFundConfiguration");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeletedEntityResponse</returns>
        public async System.Threading.Tasks.Task<DeletedEntityResponse> DeleteFundConfigurationAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> localVarResponse = await DeleteFundConfigurationWithHttpInfoAsync(scope, code, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeletedEntityResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse>> DeleteFundConfigurationWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundConfigurationApi->DeleteFundConfiguration");
        ...
        /// <param name="propertyKeys">A list of property keys from the &#39;FundConfiguration&#39; domain to decorate onto the FundConfiguration.              These must take the format {domain}/{scope}/{code}, for example &#39;FundConfiguration/Manager/Id&#39;. If no properties are specified, then no properties will be returned. (optional)</param>
        /// <returns>FundConfiguration</returns>
        public FundConfiguration GetFundConfiguration(string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>))
        {
            Lusid.Sdk.Client.ApiResponse<FundConfiguration> localVarResponse = GetFundConfigurationWithHttpInfo(scope, code, effectiveAt, asAt, propertyKeys);
            return localVarResponse.Data;
        }
        ...
        /// <param name="propertyKeys">A list of property keys from the &#39;FundConfiguration&#39; domain to decorate onto the FundConfiguration.              These must take the format {domain}/{scope}/{code}, for example &#39;FundConfiguration/Manager/Id&#39;. If no properties are specified, then no properties will be returned. (optional)</param>
        /// <returns>ApiResponse of FundConfiguration</returns>
        public Lusid.Sdk.Client.ApiResponse<FundConfiguration> GetFundConfigurationWithHttpInfo(string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundConfigurationApi->GetFundConfiguration");

            // verify the required parameter 'code' is set
            if (code == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling FundConfigurationApi->GetFundConfiguration");
        ...
        {
            Lusid.Sdk.Client.ApiResponse<FundConfiguration> localVarResponse = await GetFundConfigurationWithHttpInfoAsync(scope, code, effectiveAt, asAt, propertyKeys, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfFundConfiguration> localVarResponse = ListFundConfigurationsWithHttpInfo(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfFundConfiguration> localVarResponse = await ListFundConfigurationsWithHttpInfoAsync(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operation">The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902.</param>
        /// <returns>FundConfiguration</returns>
        public FundConfiguration PatchFundConfiguration(string scope, string code, List<Operation> operation)
        {
            Lusid.Sdk.Client.ApiResponse<FundConfiguration> localVarResponse = PatchFundConfigurationWithHttpInfo(scope, code, operation);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operation">The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902.</param>
        /// <returns>ApiResponse of FundConfiguration</returns>
        public Lusid.Sdk.Client.ApiResponse<FundConfiguration> PatchFundConfigurationWithHttpInfo(string scope, string code, List<Operation> operation)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundConfigurationApi->PatchFundConfiguration");

            // verify the required parameter 'code' is set
            if (code == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling FundConfigurationApi->PatchFundConfiguration");

            // verify the required parameter 'operation' is set
            if (operation == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'operation' when calling FundConfigurationApi->PatchFundConfiguration");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Patch<FundConfiguration>("/api/fundconfigurations/{scope}/{code}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatchFundConfiguration", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FundConfiguration</returns>
        public async System.Threading.Tasks.Task<FundConfiguration> PatchFundConfigurationAsync(string scope, string code, List<Operation> operation, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<FundConfiguration> localVarResponse = await PatchFundConfigurationWithHttpInfoAsync(scope, code, operation, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FundConfiguration)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<FundConfiguration>> PatchFundConfigurationWithHttpInfoAsync(string scope, string code, List<Operation> operation, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundConfigurationApi->PatchFundConfiguration");
            ...
            var localVarResponse = await this.AsynchronousClient.PatchAsync<FundConfiguration>("/api/fundconfigurations/{scope}/{code}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="requestBody">The properties to be updated or inserted onto the Fund Configuration. Each property in               the request must be keyed by its unique property key. This has the format {domain}/{scope}/{code} e.g. \&quot;FundConfiguration/Manager/Id\&quot;. (optional)</param>
        /// <returns>FundConfigurationProperties</returns>
        public FundConfigurationProperties UpsertFundConfigurationProperties(string scope, string code, Dictionary<string, Property> requestBody = default(Dictionary<string, Property>))
        {
            Lusid.Sdk.Client.ApiResponse<FundConfigurationProperties> localVarResponse = UpsertFundConfigurationPropertiesWithHttpInfo(scope, code, requestBody);
            return localVarResponse.Data;
        }
        ...
        /// <param name="requestBody">The properties to be updated or inserted onto the Fund Configuration. Each property in               the request must be keyed by its unique property key. This has the format {domain}/{scope}/{code} e.g. \&quot;FundConfiguration/Manager/Id\&quot;. (optional)</param>
        /// <returns>ApiResponse of FundConfigurationProperties</returns>
        public Lusid.Sdk.Client.ApiResponse<FundConfigurationProperties> UpsertFundConfigurationPropertiesWithHttpInfo(string scope, string code, Dictionary<string, Property> requestBody = default(Dictionary<string, Property>))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundConfigurationApi->UpsertFundConfigurationProperties");

            // verify the required parameter 'code' is set
            if (code == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling FundConfigurationApi->UpsertFundConfigurationProperties");
        ...
        {
            Lusid.Sdk.Client.ApiResponse<FundConfigurationProperties> localVarResponse = await UpsertFundConfigurationPropertiesWithHttpInfoAsync(scope, code, requestBody, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
