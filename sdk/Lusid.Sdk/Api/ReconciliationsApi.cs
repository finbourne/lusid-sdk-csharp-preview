...
namespace Lusid.Sdk.Api
{
    ...
    public interface IReconciliationsApiSync : IApiAccessor
    {
        ...
        ApiResponse<bool> DeleteReconciliationMappingWithHttpInfo(string scope, string code);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="reconciliationType">Optional parameter to specify which type of mappings should be returned.              Currently only supports Transaction types (optional)</param>
    ...
    public interface IReconciliationsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<bool> DeleteReconciliationMappingAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<bool>> DeleteReconciliationMappingWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] GetReconciliationMapping: Get a mapping
        /// </summary>
        /// <remarks>
    ...
    public partial class ReconciliationsApi : IReconciliationsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] DeleteReconciliationMapping: Delete a mapping Deletes the mapping identified by the scope and code
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the mapping.</param>
        /// <param name="code">The code fof the mapping.</param>
        /// <returns>bool</returns>
        public bool DeleteReconciliationMapping(string scope, string code)
        {
            Lusid.Sdk.Client.ApiResponse<bool> localVarResponse = DeleteReconciliationMappingWithHttpInfo(scope, code);
        ...
        /// <param name="code">The code fof the mapping.</param>
        /// <returns>ApiResponse of bool</returns>
        public Lusid.Sdk.Client.ApiResponse<bool> DeleteReconciliationMappingWithHttpInfo(string scope, string code)
        {
            ...
            var localVarResponse = this.Client.Delete<bool>("/api/portfolios/mapping/{scope}/{code}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of bool</returns>
        public async System.Threading.Tasks.Task<bool> DeleteReconciliationMappingAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<bool> localVarResponse = await DeleteReconciliationMappingWithHttpInfoAsync(scope, code, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (bool)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<bool>> DeleteReconciliationMappingWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling ReconciliationsApi->DeleteReconciliationMapping");
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<bool>("/api/portfolios/mapping/{scope}/{code}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// [EXPERIMENTAL] GetReconciliationMapping: Get a mapping Gets a mapping identified by the given scope and code
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the mapping.</param>
        /// <param name="code">The code fof the mapping.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] ListReconciliationMappings: List the reconciliation mappings Lists all mappings this user is entitled to see
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="reconciliationType">Optional parameter to specify which type of mappings should be returned.              Currently only supports Transaction types (optional)</param>
        /// <returns>ResourceListOfMapping</returns>
        ...
        /// <summary>
        /// [EXPERIMENTAL] ReconcileTransactions: Perform a Transactions Reconciliation. Evaluates two sets of transactions to determine which transactions from each set likely match  using the rules of a specified mapping.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="transactionReconciliationRequest"> (optional)</param>
        /// <returns>TransactionsReconciliationsResponse</returns>
        ...
        /// <summary>
        /// [EXPERIMENTAL] UpsertReconciliationMapping: Create or update a mapping If no mapping exists with the specified scope and code will create a new one.  Else will update the existing mapping
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="mapping">The mapping to be created / updated. (optional)</param>
        /// <returns>Mapping</returns>
