...
namespace Lusid.Sdk.Api
{
    ...
    public interface IReconciliationsApiSync : IApiAccessor
    {
        ...
        PagedResourceListOfReconciliationRun ListReconciliationRuns(string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), string filter = default(string));
        ...
        ApiResponse<PagedResourceListOfReconciliationRun> ListReconciliationRunsWithHttpInfo(string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), string filter = default(string));
        /// <summary>
        ...
        PagedResourceListOfReconciliation ListReconciliations(DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>));
        ...
        ResourceListOfReconciliationBreak ReconcileHoldings(List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), PortfoliosReconciliationRequest portfoliosReconciliationRequest = default(PortfoliosReconciliationRequest));
        ...
        ApiResponse<ResourceListOfReconciliationBreak> ReconcileHoldingsWithHttpInfo(List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), PortfoliosReconciliationRequest portfoliosReconciliationRequest = default(PortfoliosReconciliationRequest));
        /// <summary>
    ...
    public partial class ReconciliationsApi : IReconciliationsApi
    {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfReconciliationRunBreak> localVarResponse = await ListReconciliationBreaksWithHttpInfoAsync(scope, code, runDate, version, effectiveAt, asAt, page, limit, filter, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="filter">Expression to filter the results.              For example, to filter on the run date, specify \&quot;Date eq 10/03/2018\&quot;. For more information about filtering              results, see https://support.lusid.com/knowledgebase/article/KA-01914. (optional)</param>
        /// <returns>PagedResourceListOfReconciliationRun</returns>
        public PagedResourceListOfReconciliationRun ListReconciliationRuns(string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), string filter = default(string))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfReconciliationRun> localVarResponse = await ListReconciliationRunsWithHttpInfoAsync(scope, code, effectiveAt, asAt, page, limit, filter, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="propertyKeys">A list of property keys from the &#39;Reconciliation&#39; domain to decorate onto each reconciliation.              These must take the format {domain}/{scope}/{code}, for example &#39;Reconciliation/Broker/Id&#39;. (optional)</param>
        /// <returns>PagedResourceListOfReconciliation</returns>
        public PagedResourceListOfReconciliation ListReconciliations(DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfReconciliation> localVarResponse = await ListReconciliationsWithHttpInfoAsync(effectiveAt, asAt, page, limit, filter, propertyKeys, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="portfoliosReconciliationRequest">The specifications of the inputs to the reconciliation (optional)</param>
        /// <returns>ResourceListOfReconciliationBreak</returns>
        public ResourceListOfReconciliationBreak ReconcileHoldings(List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), PortfoliosReconciliationRequest portfoliosReconciliationRequest = default(PortfoliosReconciliationRequest))
        {
        ...
        /// <param name="portfoliosReconciliationRequest">The specifications of the inputs to the reconciliation (optional)</param>
        /// <returns>ApiResponse of ResourceListOfReconciliationBreak</returns>
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfReconciliationBreak> ReconcileHoldingsWithHttpInfo(List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), PortfoliosReconciliationRequest portfoliosReconciliationRequest = default(PortfoliosReconciliationRequest))
        {
            Lusid.Sdk.Client.RequestOptions localVarRequestOptions = new Lusid.Sdk.Client.RequestOptions();
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfReconciliationBreak> localVarResponse = await ReconcileHoldingsWithHttpInfoAsync(sortBy, limit, filter, portfoliosReconciliationRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
