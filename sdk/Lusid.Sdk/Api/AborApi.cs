...
namespace Lusid.Sdk.Api
{
    ...
    public interface IAborApiSync : IApiAccessor
    {
        ...
        VersionedResourceListOfJELines GetJELines(string scope, string code, JELinesQueryParameters jELinesQueryParameters, DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string page = default(string));
        ...
        ApiResponse<VersionedResourceListOfJELines> GetJELinesWithHttpInfo(string scope, string code, JELinesQueryParameters jELinesQueryParameters, DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string page = default(string));
        /// <summary>
        ...
        PagedResourceListOfAbor ListAbors(DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? start = default(int?), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>));
        ...
        /// <param name="requestBody">The properties to be updated or inserted onto the chart of account. Each property in               the request must be keyed by its unique property key. This has the format {domain}/{scope}/{code} e.g. \&quot;Abor/Manager/Id\&quot;. (optional)</param>
    ...
    public partial class AborApi : IAborApi
    {
        ...
        /// <param name="page">The pagination token to use to continue listing JELines from a previous call to GetJELines. (optional)</param>
        /// <returns>VersionedResourceListOfJELines</returns>
        public VersionedResourceListOfJELines GetJELines(string scope, string code, JELinesQueryParameters jELinesQueryParameters, DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string page = default(string))
        {
        ...
        /// <param name="page">The pagination token to use to continue listing JELines from a previous call to GetJELines. (optional)</param>
        /// <returns>ApiResponse of VersionedResourceListOfJELines</returns>
        public Lusid.Sdk.Client.ApiResponse<VersionedResourceListOfJELines> GetJELinesWithHttpInfo(string scope, string code, JELinesQueryParameters jELinesQueryParameters, DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string page = default(string))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<VersionedResourceListOfJELines> localVarResponse = await GetJELinesWithHttpInfoAsync(scope, code, jELinesQueryParameters, asAt, limit, page, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="propertyKeys">A list of property keys from the &#39;Abor&#39; domain to decorate onto each Abor.              These must take the format {domain}/{scope}/{code}, for example &#39;Abor/Manager/Id&#39;. (optional)</param>
        /// <returns>PagedResourceListOfAbor</returns>
        public PagedResourceListOfAbor ListAbors(DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? start = default(int?), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfAbor> localVarResponse = await ListAborsWithHttpInfoAsync(effectiveAt, asAt, page, start, limit, filter, propertyKeys, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
