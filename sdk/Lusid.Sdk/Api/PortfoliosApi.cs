...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPortfoliosApi : IApiAccessor
    {
        ...
        ICollection<AccessMetadataValue> GetPortfoliosAccessMetadataByKey (string scope, string code, string key, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null);
        ...
        ApiResponse<ICollection<AccessMetadataValue>> GetPortfoliosAccessMetadataByKeyWithHttpInfo (string scope, string code, string key, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null);
        /// <summary>
        /// List portfolios
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ICollection<AccessMetadataValue>> GetPortfoliosAccessMetadataByKeyAsync (string scope, string code, string key, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ICollection<AccessMetadataValue>>> GetPortfoliosAccessMetadataByKeyAsyncWithHttpInfo (string scope, string code, string key, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null);
        /// <summary>
        /// List portfolios
        /// </summary>
        /// <remarks>
    ...
    public partial class PortfoliosApi : IPortfoliosApi
    {
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the portfolio access metadata. (optional)</param>
        /// <returns>ICollection&lt;AccessMetadataValue&gt;</returns>
        public ICollection<AccessMetadataValue> GetPortfoliosAccessMetadataByKey (string scope, string code, string key, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null)
        {
             ApiResponse<ICollection<AccessMetadataValue>> localVarResponse = GetPortfoliosAccessMetadataByKeyWithHttpInfo(scope, code, key, effectiveAt, asAt);
             return localVarResponse.Data;
        }
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the portfolio access metadata. (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;AccessMetadataValue&gt;</returns>
        public ApiResponse< ICollection<AccessMetadataValue> > GetPortfoliosAccessMetadataByKeyWithHttpInfo (string scope, string code, string key, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the portfolio access metadata. (optional)</param>
        /// <returns>Task of ICollection&lt;AccessMetadataValue&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<AccessMetadataValue>> GetPortfoliosAccessMetadataByKeyAsync (string scope, string code, string key, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null)
        {
             ApiResponse<ICollection<AccessMetadataValue>> localVarResponse = await GetPortfoliosAccessMetadataByKeyAsyncWithHttpInfo(scope, code, key, effectiveAt, asAt);
             return localVarResponse.Data;
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the portfolio access metadata. (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;AccessMetadataValue&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<AccessMetadataValue>>> GetPortfoliosAccessMetadataByKeyAsyncWithHttpInfo (string scope, string code, string key, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling PortfoliosApi->GetPortfoliosAccessMetadataByKey");
