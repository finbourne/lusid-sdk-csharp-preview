...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPortfoliosApi : IApiAccessor
    {
        ...
        /// <param name="propertyKey">The property key of the property that will have its history shown. These must be in the format {domain}/{scope}/{code} e.g. \&quot;Portfolio/Manager/Id\&quot;.              Each property must be from the \&quot;Portfolio\&quot; domain. (optional)</param>
        ...
        /// <param name="asAt">The asAt datetime at which to list the portfolio&#39;s property history. Defaults to return the current datetime if not supplied. (optional)</param>
    ...
    public partial class PortfoliosApi : IPortfoliosApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get the time series of a portfolio property List the complete time series of a portfolio property.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio.</param>
        /// <param name="code">The code of the portfolio. Together with the scope this uniquely identifies              the portfolio.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get Relations for Portfolio Get relations for the specified Portfolio
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio.</param>
        /// <param name="code">The code of the portfolio. Together with the scope this uniquely identifies              the portfolio.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get Relationships for Portfolio Get relationships for the specified Portfolio
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio.</param>
        /// <param name="code">The code of the portfolio. Together with the scope this uniquely identifies              the portfolio.</param>
