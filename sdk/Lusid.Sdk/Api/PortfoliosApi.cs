...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPortfoliosApi : IApiAccessor
    {
        ...
        /// <param name="outputFrequency">The type of calculated output: Daily/Monthly/Yearly. (optional)</param>
        ...
        /// <param name="scope">The scope of the portfolio.</param>
        /// <param name="code">The code of the portfolio. Together with the scope this uniquely identifies the portfolio.</param>
        /// <param name="propertyKey">The property key of the property that will have its history shown.              These must be from the &#39;Portfolio&#39; domain and in the format {domain}/{scope}/{code}, for example &#39;Portfolio/Manager/Id&#39;. (optional)</param>
        ...
        /// <param name="asAt">The as-at datetime at which to list the portfolio&#39;s property history. Defaults to return the current datetime if not supplied. (optional)</param>
        ...
        /// <param name="asAt">The as-at datetime at which to retrieve relations. Defaults to return the latest LUSID AsAt time if not specified. (optional)</param>
        ...
        /// <param name="asAt">The as-at datetime at which to retrieve relationships. Defaults to return the latest LUSID AsAt time if not specified. (optional)</param>
        /// <param name="filter">Expression to filter the relationships. Users should provide null or empty string for this field until further notice. (optional)</param>
    ...
    public partial class PortfoliosApi : IPortfoliosApi
    {
        ...
        {
             ApiResponse<ResourceListOfAggregatedReturn> localVarResponse = GetPortfolioAggregateReturnsWithHttpInfo(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, compositeMethod, period, outputFrequency, metrics, asAt);
             return localVarResponse.Data;
        }
        ...
        {
             ApiResponse<ResourceListOfAggregatedReturn> localVarResponse = await GetPortfolioAggregateReturnsAsyncWithHttpInfo(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, compositeMethod, period, outputFrequency, metrics, asAt);
             return localVarResponse.Data;
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get portfolio property time series List the complete time series of a portfolio property.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio.</param>
        /// <param name="code">The code of the portfolio. Together with the scope this uniquely identifies the portfolio.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get portfolio relations Get relations for a portfolio .
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio.</param>
        /// <param name="code">The code of the portfolio. Together with the scope this uniquely identifies the portfolio.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get portfolio relationships Get relationships for a portfolio
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio.</param>
        /// <param name="code">The code of the portfolio. Together with the scope this uniquely identifies the portfolio.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get Returns Get Returns which are on the specified portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the Portfolio.</param>
        /// <param name="code">The code of the  Portfolio.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Upsert Returns Update or insert returns into the specified portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the Portfolio.</param>
        /// <param name="code">The code of the  Portfolio.</param>
