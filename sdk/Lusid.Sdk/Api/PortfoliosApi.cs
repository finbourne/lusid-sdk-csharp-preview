...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPortfoliosApiSync : IApiAccessor
    {
        ...
        /// <returns>Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        Dictionary<string, List<AccessMetadataValue>> PatchPortfolioAccessMetadata(string scope, string code, List<Operation> operation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        ...
        /// <param name="effectiveAt">The date this rule will effective from (optional)</param>
        /// <returns>ApiResponse of Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        ApiResponse<Dictionary<string, List<AccessMetadataValue>>> PatchPortfolioAccessMetadataWithHttpInfo(string scope, string code, List<Operation> operation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        /// <summary>
    ...
    public partial class PortfoliosApi : IPortfoliosApi
    {
        ...
        /// <param name="effectiveAt">The date this rule will effective from (optional)</param>
        /// <returns>Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        public Dictionary<string, List<AccessMetadataValue>> PatchPortfolioAccessMetadata(string scope, string code, List<Operation> operation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            Lusid.Sdk.Client.ApiResponse<Dictionary<string, List<AccessMetadataValue>>> localVarResponse = PatchPortfolioAccessMetadataWithHttpInfo(scope, code, operation, effectiveAt);
            return localVarResponse.Data;
        }
        ...
        /// <param name="effectiveAt">The date this rule will effective from (optional)</param>
        /// <returns>ApiResponse of Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        public Lusid.Sdk.Client.ApiResponse<Dictionary<string, List<AccessMetadataValue>>> PatchPortfolioAccessMetadataWithHttpInfo(string scope, string code, List<Operation> operation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<Dictionary<string, List<AccessMetadataValue>>> localVarResponse = await PatchPortfolioAccessMetadataWithHttpInfoAsync(scope, code, operation, effectiveAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
