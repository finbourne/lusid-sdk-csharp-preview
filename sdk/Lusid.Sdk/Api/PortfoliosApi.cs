...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPortfoliosApiSync : IApiAccessor
    {
        ...
        BatchUpsertPortfolioAccessMetadataResponse BatchUpsertPortfolioAccessMetadata(Dictionary<string, BatchUpsertPortfolioAccessMetadataRequest> requestBody, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOrCutLabel effectiveUntil = default(DateTimeOrCutLabel));
        ...
        ApiResponse<BatchUpsertPortfolioAccessMetadataResponse> BatchUpsertPortfolioAccessMetadataWithHttpInfo(Dictionary<string, BatchUpsertPortfolioAccessMetadataRequest> requestBody, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOrCutLabel effectiveUntil = default(DateTimeOrCutLabel));
        /// <summary>
        ...
        DeletedEntityResponse DeleteInstrumentEventInstruction(string scope, string code, string instrumentEventInstructionId, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel));
        ...
        ApiResponse<DeletedEntityResponse> DeleteInstrumentEventInstructionWithHttpInfo(string scope, string code, string instrumentEventInstructionId, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel));
        /// <summary>
        ...
        CompositeBreakdownResponse GetCompositeBreakdown(string scope, string code, CompositeBreakdownRequest compositeBreakdownRequest, DateTimeOrCutLabel fromEffectiveAt = default(DateTimeOrCutLabel), DateTimeOrCutLabel toEffectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?));
        ...
        InstrumentEventInstruction GetInstrumentEventInstruction(string scope, string code, string instrumentEventInstructionId, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?));
        ...
        ApiResponse<InstrumentEventInstruction> GetInstrumentEventInstructionWithHttpInfo(string scope, string code, string instrumentEventInstructionId, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?));
        /// <summary>
        ...
        /// <param name="operation">The json patch document. For more check: https://datatracker.ietf.org/doc/html/rfc6902.</param>
        /// <returns>ApiResponse of Portfolio</returns>
        ApiResponse<Portfolio> PatchPortfolioWithHttpInfo(string scope, string code, List<Operation> operation);
        /// <summary>
        ...
        InstrumentEventInstructionsResponse UpsertInstrumentEventInstructions(string scope, string code, string successMode, Dictionary<string, InstrumentEventInstructionRequest> requestBody, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel));
        ...
        ApiResponse<InstrumentEventInstructionsResponse> UpsertInstrumentEventInstructionsWithHttpInfo(string scope, string code, string successMode, Dictionary<string, InstrumentEventInstructionRequest> requestBody, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel));
        /// <summary>
    ...
    public interface IPortfoliosApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InstrumentEventInstruction> GetInstrumentEventInstructionAsync(string scope, string code, string instrumentEventInstructionId, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Portfolio</returns>
        System.Threading.Tasks.Task<Portfolio> PatchPortfolioAsync(string scope, string code, List<Operation> operation, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Portfolio)</returns>
        System.Threading.Tasks.Task<ApiResponse<Portfolio>> PatchPortfolioWithHttpInfoAsync(string scope, string code, List<Operation> operation, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EARLY ACCESS] PatchPortfolioAccessMetadata: Patch Access Metadata rules for a Portfolio.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InstrumentEventInstructionsResponse> UpsertInstrumentEventInstructionsAsync(string scope, string code, string successMode, Dictionary<string, InstrumentEventInstructionRequest> requestBody, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PortfoliosApi : IPortfoliosApi
    {
        ...
        /// <param name="effectiveUntil">The effective date until which the Access Metadata is valid. If not supplied, this will be valid indefinitely, or until the next &#39;effectiveAt&#39; date of the Access Metadata (optional)</param>
        /// <returns>BatchUpsertPortfolioAccessMetadataResponse</returns>
        public BatchUpsertPortfolioAccessMetadataResponse BatchUpsertPortfolioAccessMetadata(Dictionary<string, BatchUpsertPortfolioAccessMetadataRequest> requestBody, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOrCutLabel effectiveUntil = default(DateTimeOrCutLabel))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<BatchUpsertPortfolioAccessMetadataResponse> localVarResponse = await BatchUpsertPortfolioAccessMetadataWithHttpInfoAsync(requestBody, effectiveAt, effectiveUntil, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="portfolioEffectiveAt">The effective date at which the portfolio will be resolved. Defaults to current time if not specified. (optional)</param>
        /// <returns>DeletedEntityResponse</returns>
        public DeletedEntityResponse DeleteInstrumentEventInstruction(string scope, string code, string instrumentEventInstructionId, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel))
        {
        ...
        /// <param name="portfolioEffectiveAt">The effective date at which the portfolio will be resolved. Defaults to current time if not specified. (optional)</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> DeleteInstrumentEventInstructionWithHttpInfo(string scope, string code, string instrumentEventInstructionId, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> localVarResponse = await DeleteInstrumentEventInstructionWithHttpInfoAsync(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the Returns. Defaults to the latest. (optional)</param>
        /// <returns>CompositeBreakdownResponse</returns>
        public CompositeBreakdownResponse GetCompositeBreakdown(string scope, string code, CompositeBreakdownRequest compositeBreakdownRequest, DateTimeOrCutLabel fromEffectiveAt = default(DateTimeOrCutLabel), DateTimeOrCutLabel toEffectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<CompositeBreakdownResponse> localVarResponse = await GetCompositeBreakdownWithHttpInfoAsync(scope, code, compositeBreakdownRequest, fromEffectiveAt, toEffectiveAt, asAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the instruction. Defaults to return the latest version of the instruction if not specified. (optional)</param>
        /// <returns>InstrumentEventInstruction</returns>
        public InstrumentEventInstruction GetInstrumentEventInstruction(string scope, string code, string instrumentEventInstructionId, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the instruction. Defaults to return the latest version of the instruction if not specified. (optional)</param>
        /// <returns>ApiResponse of InstrumentEventInstruction</returns>
        public Lusid.Sdk.Client.ApiResponse<InstrumentEventInstruction> GetInstrumentEventInstructionWithHttpInfo(string scope, string code, string instrumentEventInstructionId, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<InstrumentEventInstruction> localVarResponse = await GetInstrumentEventInstructionWithHttpInfoAsync(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, asAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfAggregatedReturn> localVarResponse = await GetPortfolioAggregateReturnsWithHttpInfoAsync(scope, code, returnScope, returnCode, recipeIdScope, recipeIdCode, fromEffectiveAt, toEffectiveAt, compositeMethod, period, outputFrequency, metrics, asAt, alternativeIncDate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="identifierTypes">Identifier types (as property keys) used for referencing Persons or Legal Entities.              These must be from the &#39;Person&#39; or &#39;LegalEntity&#39; domains and have the format {domain}/{scope}/{code}, for example              &#39;Person/CompanyDetails/Role&#39;. Only identifier types provided will be used to look up relevant entities in relations. If not applicable, provide an empty array. (optional)</param>
        /// <returns>ResourceListOfRelation</returns>
        public ResourceListOfRelation GetPortfolioRelations(string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string filter = default(string), List<string> identifierTypes = default(List<string>))
        {
        ...
        /// <param name="identifierTypes">Identifier types (as property keys) used for referencing Persons or Legal Entities.              These must be from the &#39;Person&#39; or &#39;LegalEntity&#39; domains and have the format {domain}/{scope}/{code}, for example              &#39;Person/CompanyDetails/Role&#39;. Only identifier types provided will be used to look up relevant entities in relations. If not applicable, provide an empty array. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfRelation</returns>
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfRelation> GetPortfolioRelationsWithHttpInfo(string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string filter = default(string), List<string> identifierTypes = default(List<string>))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfRelation> localVarResponse = await GetPortfolioRelationsWithHttpInfoAsync(scope, code, effectiveAt, asAt, filter, identifierTypes, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfInstrumentEventInstruction> localVarResponse = await ListInstrumentEventInstructionsWithHttpInfoAsync(scope, code, portfolioEffectiveAt, asAt, page, limit, filter, sortBy, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfPortfolio> localVarResponse = await ListPortfoliosWithHttpInfoAsync(effectiveAt, asAt, page, limit, filter, sortBy, query, propertyKeys, relationshipDefinitionIds, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfPortfolio> localVarResponse = await ListPortfoliosForScopeWithHttpInfoAsync(scope, effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, relationshipDefinitionIds, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operation">The json patch document. For more check: https://datatracker.ietf.org/doc/html/rfc6902.</param>
        /// <returns>Portfolio</returns>
        public Portfolio PatchPortfolio(string scope, string code, List<Operation> operation)
        {
        ...
        /// <param name="operation">The json patch document. For more check: https://datatracker.ietf.org/doc/html/rfc6902.</param>
        /// <returns>ApiResponse of Portfolio</returns>
        public Lusid.Sdk.Client.ApiResponse<Portfolio> PatchPortfolioWithHttpInfo(string scope, string code, List<Operation> operation)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Portfolio</returns>
        public async System.Threading.Tasks.Task<Portfolio> PatchPortfolioAsync(string scope, string code, List<Operation> operation, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<Portfolio> localVarResponse = await PatchPortfolioWithHttpInfoAsync(scope, code, operation, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Portfolio)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<Portfolio>> PatchPortfolioWithHttpInfoAsync(string scope, string code, List<Operation> operation, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling PortfoliosApi->PatchPortfolio");
        ...
        /// <param name="portfolioEffectiveAt">The effective date at which the portfolio will be resolved. Defaults to current time if not specified. (optional)</param>
        /// <returns>InstrumentEventInstructionsResponse</returns>
        public InstrumentEventInstructionsResponse UpsertInstrumentEventInstructions(string scope, string code, string successMode, Dictionary<string, InstrumentEventInstructionRequest> requestBody, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel))
        {
        ...
        /// <param name="portfolioEffectiveAt">The effective date at which the portfolio will be resolved. Defaults to current time if not specified. (optional)</param>
        /// <returns>ApiResponse of InstrumentEventInstructionsResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<InstrumentEventInstructionsResponse> UpsertInstrumentEventInstructionsWithHttpInfo(string scope, string code, string successMode, Dictionary<string, InstrumentEventInstructionRequest> requestBody, DateTimeOrCutLabel portfolioEffectiveAt = default(DateTimeOrCutLabel))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<InstrumentEventInstructionsResponse> localVarResponse = await UpsertInstrumentEventInstructionsWithHttpInfoAsync(scope, code, successMode, requestBody, portfolioEffectiveAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
