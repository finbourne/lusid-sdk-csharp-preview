...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPortfoliosApi : IApiAccessor
    {
        ...
        /// <param name="alternativeIncDate">The date from which to consider the Returns on the Portfolio, if this is different from the date when Returns begin. (optional)</param>
        ...
        ApiResponse<ResourceListOfProperty> ListPortfolioPropertiesWithHttpInfo (string scope, string code, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null);
        /// <summary>
        /// List portfolios
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ResourceListOfProperty> ListPortfolioPropertiesAsync (string scope, string code, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfProperty>> ListPortfolioPropertiesAsyncWithHttpInfo (string scope, string code, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null);
        /// <summary>
        /// List portfolios
        /// </summary>
        /// <remarks>
    ...
    public partial class PortfoliosApi : IPortfoliosApi
    {
        ...
        {
             ApiResponse<ResourceListOfAggregatedReturn> localVarResponse = GetPortfolioAggregateReturnsWithHttpInfo(scope, code, returnScope, returnCode, recipeIdScope, recipeIdCode, fromEffectiveAt, toEffectiveAt, compositeMethod, period, outputFrequency, metrics, asAt, alternativeIncDate);
             return localVarResponse.Data;
        }
        ...
        public ApiResponse< ResourceListOfAggregatedReturn > GetPortfolioAggregateReturnsWithHttpInfo (string scope, string code, string returnScope, string returnCode, string recipeIdScope = null, string recipeIdCode = null, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, string compositeMethod = null, string period = null, string outputFrequency = null, List<string> metrics = null, DateTimeOffset? asAt = null, DateTimeOrCutLabel alternativeIncDate = null)
        {
            ...
            if (asAt != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "asAt", asAt)); // query parameter
            if (alternativeIncDate != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "alternativeIncDate", alternativeIncDate)); // query parameter
        ...
        {
             ApiResponse<ResourceListOfAggregatedReturn> localVarResponse = await GetPortfolioAggregateReturnsAsyncWithHttpInfo(scope, code, returnScope, returnCode, recipeIdScope, recipeIdCode, fromEffectiveAt, toEffectiveAt, compositeMethod, period, outputFrequency, metrics, asAt, alternativeIncDate);
             return localVarResponse.Data;
        ...
        /// <param name="limit">When paginating, limit the results per page to this number. (optional)</param>
        /// <returns>ResourceListOfProperty</returns>
        public ResourceListOfProperty ListPortfolioProperties (string scope, string code, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null)
        {
             ApiResponse<ResourceListOfProperty> localVarResponse = ListPortfolioPropertiesWithHttpInfo(scope, code, effectiveAt, asAt, page, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">When paginating, limit the results per page to this number. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfProperty</returns>
        public ApiResponse< ResourceListOfProperty > ListPortfolioPropertiesWithHttpInfo (string scope, string code, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            var localVarPath = "./api/portfolios/{scope}/{code}/properties/list";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="limit">When paginating, limit the results per page to this number. (optional)</param>
        /// <returns>Task of ResourceListOfProperty</returns>
        public async System.Threading.Tasks.Task<ResourceListOfProperty> ListPortfolioPropertiesAsync (string scope, string code, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null)
        {
             ApiResponse<ResourceListOfProperty> localVarResponse = await ListPortfolioPropertiesAsyncWithHttpInfo(scope, code, effectiveAt, asAt, page, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">When paginating, limit the results per page to this number. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfProperty)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfProperty>> ListPortfolioPropertiesAsyncWithHttpInfo (string scope, string code, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling PortfoliosApi->ListPortfolioProperties");
