...
namespace Lusid.Sdk.Api
{
    ...
    public interface IScopesApiSync : IApiAccessor
    {
        ...
        ApiResponse<ResourceListOfScopeDefinition> ListEntityScopesWithHttpInfo(string entityType);
        /// <summary>
    ...
    public interface IScopesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ResourceListOfScopeDefinition> ListEntityScopesAsync(string entityType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfScopeDefinition>> ListEntityScopesWithHttpInfoAsync(string entityType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// ListScopes: List Scopes
        /// </summary>
        /// <remarks>
    ...
    public partial class ScopesApi : IScopesApi
    {
        ...
        /// <param name="entityType">The entity type to list scopes for.</param>
        /// <returns>ResourceListOfScopeDefinition</returns>
        public ResourceListOfScopeDefinition ListEntityScopes(string entityType)
        {
        ...
        /// <param name="entityType">The entity type to list scopes for.</param>
        /// <returns>ApiResponse of ResourceListOfScopeDefinition</returns>
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfScopeDefinition> ListEntityScopesWithHttpInfo(string entityType)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResourceListOfScopeDefinition</returns>
        public async System.Threading.Tasks.Task<ResourceListOfScopeDefinition> ListEntityScopesAsync(string entityType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfScopeDefinition> localVarResponse = await ListEntityScopesWithHttpInfoAsync(entityType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ResourceListOfScopeDefinition)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfScopeDefinition>> ListEntityScopesWithHttpInfoAsync(string entityType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'entityType' is set
            if (entityType == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'entityType' when calling ScopesApi->ListEntityScopes");
