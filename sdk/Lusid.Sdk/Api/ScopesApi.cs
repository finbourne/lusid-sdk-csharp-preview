...
namespace Lusid.Sdk.Api
{
    ...
    public interface IScopesApi : IApiAccessor
    {
        ...
        ApiResponse<ResourceListOfScopeDefinition> ListScopesWithHttpInfo (List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, string query = null);
        ...
        System.Threading.Tasks.Task<ResourceListOfScopeDefinition> ListScopesAsync (List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, string query = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfScopeDefinition>> ListScopesAsyncWithHttpInfo (List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, string query = null);
    ...
    public partial class ScopesApi : IScopesApi
    {
        ...
        /// <summary>
        /// [EARLY ACCESS] List scopes List all the scopes
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sortBy">Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)</param>
        /// <param name="start">Optional. When paginating, skip this number of results (optional)</param>
        ...
        /// <param name="query">Optional. Expression specifying the criteria that the returned portfolios must meet (optional)</param>
        /// <returns>ResourceListOfScopeDefinition</returns>
        public ResourceListOfScopeDefinition ListScopes (List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, string query = null)
        {
             ApiResponse<ResourceListOfScopeDefinition> localVarResponse = ListScopesWithHttpInfo(sortBy, start, limit, filter, query);
        ...
        /// <param name="query">Optional. Expression specifying the criteria that the returned portfolios must meet (optional)</param>
        /// <returns>ApiResponse of ResourceListOfScopeDefinition</returns>
        public ApiResponse< ResourceListOfScopeDefinition > ListScopesWithHttpInfo (List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, string query = null)
        {
        ...
        /// <param name="query">Optional. Expression specifying the criteria that the returned portfolios must meet (optional)</param>
        /// <returns>Task of ResourceListOfScopeDefinition</returns>
        public async System.Threading.Tasks.Task<ResourceListOfScopeDefinition> ListScopesAsync (List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, string query = null)
        {
             ApiResponse<ResourceListOfScopeDefinition> localVarResponse = await ListScopesAsyncWithHttpInfo(sortBy, start, limit, filter, query);
             return localVarResponse.Data;
        ...
        /// <param name="query">Optional. Expression specifying the criteria that the returned portfolios must meet (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfScopeDefinition)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfScopeDefinition>> ListScopesAsyncWithHttpInfo (List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, string query = null)
        {
