...
namespace Lusid.Sdk.Api
{
    ...
    public interface IScopesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ResourceListOfScopeDefinition> ListScopesAsync (string filter = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfScopeDefinition>> ListScopesAsyncWithHttpInfo (string filter = default(string));
    ...
    public partial class ScopesApi : IScopesApi
    {
        ...
        /// <param name="filter">Expression to filter the result set.              For example, to filter on the Scope, use \&quot;scope eq &#39;string&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>Task of ResourceListOfScopeDefinition</returns>
        public async System.Threading.Tasks.Task<ResourceListOfScopeDefinition> ListScopesAsync (string filter = default(string))
        {
             Lusid.Sdk.Client.ApiResponse<ResourceListOfScopeDefinition> localVarResponse = await ListScopesAsyncWithHttpInfo(filter);
             return localVarResponse.Data;
        ...
        /// <param name="filter">Expression to filter the result set.              For example, to filter on the Scope, use \&quot;scope eq &#39;string&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfScopeDefinition)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfScopeDefinition>> ListScopesAsyncWithHttpInfo (string filter = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResourceListOfScopeDefinition>("/api/scopes", localVarRequestOptions, this.Configuration);
