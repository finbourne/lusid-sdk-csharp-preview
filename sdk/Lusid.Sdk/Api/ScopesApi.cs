...
namespace Lusid.Sdk.Api
{
    ...
    public interface IScopesApiSync : IApiAccessor
    {
        ...
        ResourceListOfScopeDefinition ListEntityScopes(string entityType, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?));
        ...
        ApiResponse<ResourceListOfScopeDefinition> ListEntityScopesWithHttpInfo(string entityType, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?));
        /// <summary>
    ...
    public interface IScopesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ResourceListOfScopeDefinition> ListEntityScopesAsync(string entityType, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ScopesApi : IScopesApi
    {
        ...
        /// <param name="limit">When paginating, limit the number of returned results to this number. Defaults to 100 if not specified. (optional)</param>
        /// <returns>ResourceListOfScopeDefinition</returns>
        public ResourceListOfScopeDefinition ListEntityScopes(string entityType, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?))
        {
        ...
        /// <param name="limit">When paginating, limit the number of returned results to this number. Defaults to 100 if not specified. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfScopeDefinition</returns>
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfScopeDefinition> ListEntityScopesWithHttpInfo(string entityType, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResourceListOfScopeDefinition</returns>
        public async System.Threading.Tasks.Task<ResourceListOfScopeDefinition> ListEntityScopesAsync(string entityType, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfScopeDefinition> localVarResponse = await ListEntityScopesWithHttpInfoAsync(entityType, asAt, page, limit, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
