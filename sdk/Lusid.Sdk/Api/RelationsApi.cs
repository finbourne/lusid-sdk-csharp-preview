...
namespace Lusid.Sdk.Api
{
    ...
    public interface IRelationsApiSync : IApiAccessor
    {
        ...
        CompleteRelation CreateRelation(string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        ...
        ApiResponse<CompleteRelation> CreateRelationWithHttpInfo(string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        /// <summary>
        ...
        DeletedEntityResponse DeleteRelation(string scope, string code, DeleteRelationRequest deleteRelationRequest, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        ...
        ApiResponse<DeletedEntityResponse> DeleteRelationWithHttpInfo(string scope, string code, DeleteRelationRequest deleteRelationRequest, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
    ...
    public interface IRelationsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CompleteRelation> CreateRelationAsync(string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<DeletedEntityResponse> DeleteRelationAsync(string scope, string code, DeleteRelationRequest deleteRelationRequest, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class RelationsApi : IRelationsApi
    {
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relation should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>CompleteRelation</returns>
        public CompleteRelation CreateRelation(string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relation should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>ApiResponse of CompleteRelation</returns>
        public Lusid.Sdk.Client.ApiResponse<CompleteRelation> CreateRelationWithHttpInfo(string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CompleteRelation</returns>
        public async System.Threading.Tasks.Task<CompleteRelation> CreateRelationAsync(string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<CompleteRelation> localVarResponse = await CreateRelationWithHttpInfoAsync(scope, code, createRelationRequest, effectiveAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relation should the deletion be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>DeletedEntityResponse</returns>
        public DeletedEntityResponse DeleteRelation(string scope, string code, DeleteRelationRequest deleteRelationRequest, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relation should the deletion be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> DeleteRelationWithHttpInfo(string scope, string code, DeleteRelationRequest deleteRelationRequest, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> localVarResponse = await DeleteRelationWithHttpInfoAsync(scope, code, deleteRelationRequest, effectiveAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
