...
namespace Lusid.Sdk.Api
{
    ...
    public interface IRelationsApi : IApiAccessor
    {
        ...
        /// <param name="createRelationRequest">The details of the relation to create.</param>
        /// <param name="effectiveAt">The effective datetime or cut label at which the relation should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>ApiResponse of Relation</returns>
        ApiResponse<Relation> CreateRelationWithHttpInfo (string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = null);
        ...
        /// <param name="createRelationRequest">The details of the relation to create.</param>
        /// <param name="effectiveAt">The effective datetime or cut label at which the relation should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>Task of Relation</returns>
        System.Threading.Tasks.Task<Relation> CreateRelationAsync (string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = null);
        ...
        /// <param name="createRelationRequest">The details of the relation to create.</param>
        /// <param name="effectiveAt">The effective datetime or cut label at which the relation should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>Task of ApiResponse (Relation)</returns>
        System.Threading.Tasks.Task<ApiResponse<Relation>> CreateRelationAsyncWithHttpInfo (string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = null);
    ...
    public partial class RelationsApi : IRelationsApi
    {
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relation should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>Relation</returns>
        public Relation CreateRelation (string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = null)
        {
             ApiResponse<Relation> localVarResponse = CreateRelationWithHttpInfo(scope, code, createRelationRequest, effectiveAt);
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relation should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>ApiResponse of Relation</returns>
        public ApiResponse< Relation > CreateRelationWithHttpInfo (string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = null)
        {
            ...
            return new ApiResponse<Relation>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (Relation) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(Relation)));
        }
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relation should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>Task of Relation</returns>
        public async System.Threading.Tasks.Task<Relation> CreateRelationAsync (string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = null)
        {
             ApiResponse<Relation> localVarResponse = await CreateRelationAsyncWithHttpInfo(scope, code, createRelationRequest, effectiveAt);
             return localVarResponse.Data;
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relation should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>Task of ApiResponse (Relation)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Relation>> CreateRelationAsyncWithHttpInfo (string scope, string code, CreateRelationRequest createRelationRequest, DateTimeOrCutLabel effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling RelationsApi->CreateRelation");
