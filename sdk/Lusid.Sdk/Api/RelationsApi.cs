...
namespace Lusid.Sdk.Api
{
    ...
    public interface IRelationsApi : IApiAccessor
    {
        ...
        /// <param name="scope">Scope of the relation to create.</param>
        /// <param name="code">Code of the relation to create.</param>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">Scope of the relation to delete.</param>
        /// <param name="code">Code of the relation to delete.</param>
