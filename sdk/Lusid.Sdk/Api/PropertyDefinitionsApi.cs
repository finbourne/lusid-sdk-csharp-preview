...
namespace Lusid.Sdk.Api
{
    ...
    public partial class PropertyDefinitionsApi : IPropertyDefinitionsApi
    {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfPropertyDefinition> localVarResponse = await ListPropertyDefinitionsWithHttpInfoAsync(effectiveAt, asAt, propertyKeys, page, limit, filter, sortBy, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
