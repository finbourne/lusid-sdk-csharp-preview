...
namespace Lusid.Sdk.Api
{
    ...
    /// </summary>
    public interface IAllocationServiceApiSync : IApiAccessor
    {
        ...
        /// <returns>AllocationServiceRunResult</returns>
        AllocationServiceRunResult RunAllocationService(List<ResourceId> resourceId, string allocationAlgorithm = default(string));
        ...
        /// <param name="resourceId">The List of Placement IDs for which you wish to allocate executions.</param>
        /// <param name="allocationAlgorithm">A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-FIFO\&quot;.  This defaults to \&quot;PR-FIFO\&quot;. (optional)</param>
        /// <returns>ApiResponse of AllocationServiceRunResult</returns>
        ApiResponse<AllocationServiceRunResult> RunAllocationServiceWithHttpInfo(List<ResourceId> resourceId, string allocationAlgorithm = default(string));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAllocationServiceApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of AllocationServiceRunResult</returns>
        System.Threading.Tasks.Task<AllocationServiceRunResult> RunAllocationServiceAsync(List<ResourceId> resourceId, string allocationAlgorithm = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="allocationAlgorithm">A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-FIFO\&quot;.  This defaults to \&quot;PR-FIFO\&quot;. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AllocationServiceRunResult)</returns>
        System.Threading.Tasks.Task<ApiResponse<AllocationServiceRunResult>> RunAllocationServiceWithHttpInfoAsync(List<ResourceId> resourceId, string allocationAlgorithm = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAllocationServiceApi : IAllocationServiceApiSync, IAllocationServiceApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AllocationServiceApi : IAllocationServiceApi
    {
        private Lusid.Sdk.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AllocationServiceApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AllocationServiceApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public AllocationServiceApi(String basePath)
        {
        ...
        /// <returns></returns>
        public AllocationServiceApi(Lusid.Sdk.Client.Configuration configuration)
        {
        ...
        public AllocationServiceApi(Lusid.Sdk.Client.ISynchronousClient client, Lusid.Sdk.Client.IAsynchronousClient asyncClient, Lusid.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="allocationAlgorithm">A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-FIFO\&quot;.  This defaults to \&quot;PR-FIFO\&quot;. (optional)</param>
        /// <returns>AllocationServiceRunResult</returns>
        public AllocationServiceRunResult RunAllocationService(List<ResourceId> resourceId, string allocationAlgorithm = default(string))
        {
            Lusid.Sdk.Client.ApiResponse<AllocationServiceRunResult> localVarResponse = RunAllocationServiceWithHttpInfo(resourceId, allocationAlgorithm);
        ...
        /// <param name="allocationAlgorithm">A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-FIFO\&quot;.  This defaults to \&quot;PR-FIFO\&quot;. (optional)</param>
        /// <returns>ApiResponse of AllocationServiceRunResult</returns>
        public Lusid.Sdk.Client.ApiResponse<AllocationServiceRunResult> RunAllocationServiceWithHttpInfo(List<ResourceId> resourceId, string allocationAlgorithm = default(string))
        {
            // verify the required parameter 'resourceId' is set
            if (resourceId == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'resourceId' when calling AllocationServiceApi->RunAllocationService");
            ...
            var localVarResponse = this.Client.Post<AllocationServiceRunResult>("/api/allocationservice/allocate", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AllocationServiceRunResult</returns>
        public async System.Threading.Tasks.Task<AllocationServiceRunResult> RunAllocationServiceAsync(List<ResourceId> resourceId, string allocationAlgorithm = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<AllocationServiceRunResult> localVarResponse = await RunAllocationServiceWithHttpInfoAsync(resourceId, allocationAlgorithm, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AllocationServiceRunResult)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<AllocationServiceRunResult>> RunAllocationServiceWithHttpInfoAsync(List<ResourceId> resourceId, string allocationAlgorithm = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'resourceId' is set
            if (resourceId == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'resourceId' when calling AllocationServiceApi->RunAllocationService");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<AllocationServiceRunResult>("/api/allocationservice/allocate", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
