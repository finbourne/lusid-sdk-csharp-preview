...
namespace Lusid.Sdk.Api
{
    ...
    public interface IAggregationApi : IApiAccessor
    {
        ...
        /// <param name="request">The request specifying the parameters to generating the recipe (optional)</param>
        ...
        ApiResponse<ConfigurationRecipe> GenerateConfigurationRecipeWithHttpInfo (string scope, string code, CreateRecipeRequest request = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ConfigurationRecipe> GenerateConfigurationRecipeAsync (string scope, string code, CreateRecipeRequest request = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ConfigurationRecipe>> GenerateConfigurationRecipeAsyncWithHttpInfo (string scope, string code, CreateRecipeRequest request = null);
        /// <summary>
        /// [EXPERIMENTAL] Aggregate data in a portfolio group
        /// </summary>
        /// <remarks>
    ...
    public partial class AggregationApi : IAggregationApi
    {
        ...
        /// <param name="request">The request specifying the parameters to generating the recipe (optional)</param>
        /// <returns>ConfigurationRecipe</returns>
        public ConfigurationRecipe GenerateConfigurationRecipe (string scope, string code, CreateRecipeRequest request = null)
        {
             ApiResponse<ConfigurationRecipe> localVarResponse = GenerateConfigurationRecipeWithHttpInfo(scope, code, request);
        ...
        /// <param name="request">The request specifying the parameters to generating the recipe (optional)</param>
        /// <returns>ApiResponse of ConfigurationRecipe</returns>
        public ApiResponse< ConfigurationRecipe > GenerateConfigurationRecipeWithHttpInfo (string scope, string code, CreateRecipeRequest request = null)
        {
        ...
        /// <param name="request">The request specifying the parameters to generating the recipe (optional)</param>
        /// <returns>Task of ConfigurationRecipe</returns>
        public async System.Threading.Tasks.Task<ConfigurationRecipe> GenerateConfigurationRecipeAsync (string scope, string code, CreateRecipeRequest request = null)
        {
             ApiResponse<ConfigurationRecipe> localVarResponse = await GenerateConfigurationRecipeAsyncWithHttpInfo(scope, code, request);
             return localVarResponse.Data;
        ...
        /// <param name="request">The request specifying the parameters to generating the recipe (optional)</param>
        /// <returns>Task of ApiResponse (ConfigurationRecipe)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ConfigurationRecipe>> GenerateConfigurationRecipeAsyncWithHttpInfo (string scope, string code, CreateRecipeRequest request = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling AggregationApi->GenerateConfigurationRecipe");
