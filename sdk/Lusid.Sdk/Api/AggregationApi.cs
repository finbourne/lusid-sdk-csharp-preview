...
namespace Lusid.Sdk.Api
{
    ...
    public interface IAggregationApi : IApiAccessor
    {
        ...
        ApiResponse<ListAggregationResponse> GetAggregationByResultSetWithHttpInfo (string scope, string resultsKey, List<string> sortBy = null, int? limit = null, AggregationRequest aggregationRequest = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ListAggregationResponse> GetAggregationByResultSetAsync (string scope, string resultsKey, List<string> sortBy = null, int? limit = null, AggregationRequest aggregationRequest = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ListAggregationResponse>> GetAggregationByResultSetAsyncWithHttpInfo (string scope, string resultsKey, List<string> sortBy = null, int? limit = null, AggregationRequest aggregationRequest = null);
        /// <summary>
        /// [EXPERIMENTAL] Query the set of supported \&quot;addresses\&quot; that can be queried from the aggregation endpoint.
        /// </summary>
        /// <remarks>
    ...
    public partial class AggregationApi : IAggregationApi
    {
        ...
        /// <param name="aggregationRequest">The request specifying the parameters of the aggregation (optional)</param>
        /// <returns>ListAggregationResponse</returns>
        public ListAggregationResponse GetAggregationByResultSet (string scope, string resultsKey, List<string> sortBy = null, int? limit = null, AggregationRequest aggregationRequest = null)
        {
             ApiResponse<ListAggregationResponse> localVarResponse = GetAggregationByResultSetWithHttpInfo(scope, resultsKey, sortBy, limit, aggregationRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="aggregationRequest">The request specifying the parameters of the aggregation (optional)</param>
        /// <returns>ApiResponse of ListAggregationResponse</returns>
        public ApiResponse< ListAggregationResponse > GetAggregationByResultSetWithHttpInfo (string scope, string resultsKey, List<string> sortBy = null, int? limit = null, AggregationRequest aggregationRequest = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="aggregationRequest">The request specifying the parameters of the aggregation (optional)</param>
        /// <returns>Task of ListAggregationResponse</returns>
        public async System.Threading.Tasks.Task<ListAggregationResponse> GetAggregationByResultSetAsync (string scope, string resultsKey, List<string> sortBy = null, int? limit = null, AggregationRequest aggregationRequest = null)
        {
             ApiResponse<ListAggregationResponse> localVarResponse = await GetAggregationByResultSetAsyncWithHttpInfo(scope, resultsKey, sortBy, limit, aggregationRequest);
             return localVarResponse.Data;
        ...
        /// <param name="aggregationRequest">The request specifying the parameters of the aggregation (optional)</param>
        /// <returns>Task of ApiResponse (ListAggregationResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ListAggregationResponse>> GetAggregationByResultSetAsyncWithHttpInfo (string scope, string resultsKey, List<string> sortBy = null, int? limit = null, AggregationRequest aggregationRequest = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling AggregationApi->GetAggregationByResultSet");
