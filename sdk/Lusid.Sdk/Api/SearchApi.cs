...
namespace Lusid.Sdk.Api
{
    ...
    public interface ISearchApi : IApiAccessor
    {
        ...
        /// <returns>ResourceListOfPortfolioSearchResult</returns>
        ResourceListOfPortfolioSearchResult SearchPortfolios (string filter = null, string sortBy = null, int? start = null, int? limit = null);
        ...
        /// <param name="limit">When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfPortfolioSearchResult</returns>
        ApiResponse<ResourceListOfPortfolioSearchResult> SearchPortfoliosWithHttpInfo (string filter = null, string sortBy = null, int? start = null, int? limit = null);
        ...
        /// <param name="limit">When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>Task of ResourceListOfPortfolioSearchResult</returns>
        System.Threading.Tasks.Task<ResourceListOfPortfolioSearchResult> SearchPortfoliosAsync (string filter = null, string sortBy = null, int? start = null, int? limit = null);
        ...
        /// <param name="limit">When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfPortfolioSearchResult)</returns>
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfPortfolioSearchResult>> SearchPortfoliosAsyncWithHttpInfo (string filter = null, string sortBy = null, int? start = null, int? limit = null);
    ...
    public partial class SearchApi : ISearchApi
    {
        ...
        /// <param name="limit">When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>ResourceListOfPortfolioSearchResult</returns>
        public ResourceListOfPortfolioSearchResult SearchPortfolios (string filter = null, string sortBy = null, int? start = null, int? limit = null)
        {
             ApiResponse<ResourceListOfPortfolioSearchResult> localVarResponse = SearchPortfoliosWithHttpInfo(filter, sortBy, start, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfPortfolioSearchResult</returns>
        public ApiResponse< ResourceListOfPortfolioSearchResult > SearchPortfoliosWithHttpInfo (string filter = null, string sortBy = null, int? start = null, int? limit = null)
        {
        ...
        /// <param name="limit">When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>Task of ResourceListOfPortfolioSearchResult</returns>
        public async System.Threading.Tasks.Task<ResourceListOfPortfolioSearchResult> SearchPortfoliosAsync (string filter = null, string sortBy = null, int? start = null, int? limit = null)
        {
             ApiResponse<ResourceListOfPortfolioSearchResult> localVarResponse = await SearchPortfoliosAsyncWithHttpInfo(filter, sortBy, start, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfPortfolioSearchResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfPortfolioSearchResult>> SearchPortfoliosAsyncWithHttpInfo (string filter = null, string sortBy = null, int? start = null, int? limit = null)
        {
