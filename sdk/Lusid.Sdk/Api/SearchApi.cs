...
namespace Lusid.Sdk.Api
{
    ...
    public interface ISearchApi : IApiAccessor
    {
        ...
        ApiResponse<ICollection<InstrumentMatch>> InstrumentsSearchWithHttpInfo (List<InstrumentSearchProperty> instrumentSearchProperty, DateTimeOrCutLabel masteredEffectiveAt = null, bool? masteredOnly = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ICollection<InstrumentMatch>> InstrumentsSearchAsync (List<InstrumentSearchProperty> instrumentSearchProperty, DateTimeOrCutLabel masteredEffectiveAt = null, bool? masteredOnly = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ICollection<InstrumentMatch>>> InstrumentsSearchAsyncWithHttpInfo (List<InstrumentSearchProperty> instrumentSearchProperty, DateTimeOrCutLabel masteredEffectiveAt = null, bool? masteredOnly = null);
        /// <summary>
        /// [EARLY ACCESS] Search Portfolio Groups
        /// </summary>
        /// <remarks>
    ...
    public partial class SearchApi : ISearchApi
    {
        ...
        /// <param name="masteredOnly">If set to true, only search over instruments that have been mastered within LUSID. Defaults to false. (optional, default to false)</param>
        /// <returns>ICollection&lt;InstrumentMatch&gt;</returns>
        public ICollection<InstrumentMatch> InstrumentsSearch (List<InstrumentSearchProperty> instrumentSearchProperty, DateTimeOrCutLabel masteredEffectiveAt = null, bool? masteredOnly = null)
        {
             ApiResponse<ICollection<InstrumentMatch>> localVarResponse = InstrumentsSearchWithHttpInfo(instrumentSearchProperty, masteredEffectiveAt, masteredOnly);
        ...
        /// <param name="masteredOnly">If set to true, only search over instruments that have been mastered within LUSID. Defaults to false. (optional, default to false)</param>
        /// <returns>ApiResponse of ICollection&lt;InstrumentMatch&gt;</returns>
        public ApiResponse< ICollection<InstrumentMatch> > InstrumentsSearchWithHttpInfo (List<InstrumentSearchProperty> instrumentSearchProperty, DateTimeOrCutLabel masteredEffectiveAt = null, bool? masteredOnly = null)
        {
            // verify the required parameter 'instrumentSearchProperty' is set
            if (instrumentSearchProperty == null)
                throw new ApiException(400, "Missing required parameter 'instrumentSearchProperty' when calling SearchApi->InstrumentsSearch");
            ...
            if (instrumentSearchProperty != null && instrumentSearchProperty.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(instrumentSearchProperty); // http body (model) parameter
            }
            else
            {
                localVarPostBody = instrumentSearchProperty; // byte array
            }
        ...
        /// <param name="masteredOnly">If set to true, only search over instruments that have been mastered within LUSID. Defaults to false. (optional, default to false)</param>
        /// <returns>Task of ICollection&lt;InstrumentMatch&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<InstrumentMatch>> InstrumentsSearchAsync (List<InstrumentSearchProperty> instrumentSearchProperty, DateTimeOrCutLabel masteredEffectiveAt = null, bool? masteredOnly = null)
        {
             ApiResponse<ICollection<InstrumentMatch>> localVarResponse = await InstrumentsSearchAsyncWithHttpInfo(instrumentSearchProperty, masteredEffectiveAt, masteredOnly);
             return localVarResponse.Data;
        ...
        /// <param name="masteredOnly">If set to true, only search over instruments that have been mastered within LUSID. Defaults to false. (optional, default to false)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;InstrumentMatch&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<InstrumentMatch>>> InstrumentsSearchAsyncWithHttpInfo (List<InstrumentSearchProperty> instrumentSearchProperty, DateTimeOrCutLabel masteredEffectiveAt = null, bool? masteredOnly = null)
        {
            // verify the required parameter 'instrumentSearchProperty' is set
            if (instrumentSearchProperty == null)
                throw new ApiException(400, "Missing required parameter 'instrumentSearchProperty' when calling SearchApi->InstrumentsSearch");
