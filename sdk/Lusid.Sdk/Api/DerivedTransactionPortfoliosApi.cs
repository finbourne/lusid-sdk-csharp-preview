...
namespace Lusid.Sdk.Api
{
    ...
    public interface IDerivedTransactionPortfoliosApiSync : IApiAccessor
    {
        ...
        Portfolio CreateDerivedPortfolio (string scope, CreateDerivedTransactionPortfolioRequest portfolio = default(CreateDerivedTransactionPortfolioRequest));
        ...
        ApiResponse<Portfolio> CreateDerivedPortfolioWithHttpInfo (string scope, CreateDerivedTransactionPortfolioRequest portfolio = default(CreateDerivedTransactionPortfolioRequest));
        /// <summary>
    ...
    public interface IDerivedTransactionPortfoliosApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Portfolio> CreateDerivedPortfolioAsync (string scope, CreateDerivedTransactionPortfolioRequest portfolio = default(CreateDerivedTransactionPortfolioRequest));
        ...
        System.Threading.Tasks.Task<ApiResponse<Portfolio>> CreateDerivedPortfolioAsyncWithHttpInfo (string scope, CreateDerivedTransactionPortfolioRequest portfolio = default(CreateDerivedTransactionPortfolioRequest));
        /// <summary>
        /// [EARLY ACCESS] Delete portfolio details
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DeletedEntityResponse> DeleteDerivedPortfolioDetailsAsync (string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        ...
        System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteDerivedPortfolioDetailsAsyncWithHttpInfo (string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
    ...
    public partial class DerivedTransactionPortfoliosApi : IDerivedTransactionPortfoliosApi
    {
        ...
        /// <param name="portfolio">The root object of the new derived portfolio, containing a populated reference portfolio id and reference scope (optional)</param>
        /// <returns>Portfolio</returns>
        public Portfolio CreateDerivedPortfolio (string scope, CreateDerivedTransactionPortfolioRequest portfolio = default(CreateDerivedTransactionPortfolioRequest))
        {
             Lusid.Sdk.Client.ApiResponse<Portfolio> localVarResponse = CreateDerivedPortfolioWithHttpInfo(scope, portfolio);
        ...
        /// <param name="portfolio">The root object of the new derived portfolio, containing a populated reference portfolio id and reference scope (optional)</param>
        /// <returns>ApiResponse of Portfolio</returns>
        public Lusid.Sdk.Client.ApiResponse< Portfolio > CreateDerivedPortfolioWithHttpInfo (string scope, CreateDerivedTransactionPortfolioRequest portfolio = default(CreateDerivedTransactionPortfolioRequest))
        {
            ...
            localVarRequestOptions.Data = portfolio;
        ...
        /// <param name="portfolio">The root object of the new derived portfolio, containing a populated reference portfolio id and reference scope (optional)</param>
        /// <returns>Task of Portfolio</returns>
        public async System.Threading.Tasks.Task<Portfolio> CreateDerivedPortfolioAsync (string scope, CreateDerivedTransactionPortfolioRequest portfolio = default(CreateDerivedTransactionPortfolioRequest))
        {
             Lusid.Sdk.Client.ApiResponse<Portfolio> localVarResponse = await CreateDerivedPortfolioAsyncWithHttpInfo(scope, portfolio);
             return localVarResponse.Data;
        ...
        /// <param name="portfolio">The root object of the new derived portfolio, containing a populated reference portfolio id and reference scope (optional)</param>
        /// <returns>Task of ApiResponse (Portfolio)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<Portfolio>> CreateDerivedPortfolioAsyncWithHttpInfo (string scope, CreateDerivedTransactionPortfolioRequest portfolio = default(CreateDerivedTransactionPortfolioRequest))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling DerivedTransactionPortfoliosApi->CreateDerivedPortfolio");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Portfolio>("/api/derivedtransactionportfolios/{scope}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="effectiveAt">The effective date of the change (optional)</param>
        /// <returns>Task of DeletedEntityResponse</returns>
        public async System.Threading.Tasks.Task<DeletedEntityResponse> DeleteDerivedPortfolioDetailsAsync (string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
             Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> localVarResponse = await DeleteDerivedPortfolioDetailsAsyncWithHttpInfo(scope, code, effectiveAt);
             return localVarResponse.Data;
        ...
        /// <param name="effectiveAt">The effective date of the change (optional)</param>
        /// <returns>Task of ApiResponse (DeletedEntityResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse>> DeleteDerivedPortfolioDetailsAsyncWithHttpInfo (string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling DerivedTransactionPortfoliosApi->DeleteDerivedPortfolioDetails");
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<DeletedEntityResponse>("/api/derivedtransactionportfolios/{scope}/{code}/details", localVarRequestOptions, this.Configuration);
