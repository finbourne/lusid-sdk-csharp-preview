...
namespace Lusid.Sdk.Api
{
    ...
    public interface IDerivedTransactionPortfoliosApi : IApiAccessor
    {
        ...
        /// <param name="createDerivedTransactionPortfolioRequest">The root object of the new derived portfolio, containing a populated reference portfolio id and reference scope (optional)</param>
