...
namespace Lusid.Sdk.Api
{
    ...
    public partial class ApplicationMetadataApi : IApplicationMetadataApi
    {
        ...
        /// <summary>
        /// Download Excel Addin Download the LUSID Excel Addin for Microsoft Excel. Not providing a specific value will return the latest version being returned
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="version">The requested version of the Excel plugin (optional)</param>
        /// <returns>FileResponse</returns>
        ...
        /// <summary>
        /// Get resources available for access control Get the comprehensive set of resources that are available for access control
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>ResourceListOfAccessControlledResource</returns>
