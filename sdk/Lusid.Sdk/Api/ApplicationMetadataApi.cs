...
namespace Lusid.Sdk.Api
{
    ...
    public interface IApplicationMetadataApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<FileResponse> GetExcelAddinAsync (string version = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<FileResponse>> GetExcelAddinAsyncWithHttpInfo (string version = default(string));
        /// <summary>
        /// [EARLY ACCESS] Get LUSID versions
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ResourceListOfAccessControlledResource> ListAccessControlledResourcesAsync (string filter = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfAccessControlledResource>> ListAccessControlledResourcesAsyncWithHttpInfo (string filter = default(string));
    ...
    public partial class ApplicationMetadataApi : IApplicationMetadataApi
    {
        ...
        /// <param name="version">The requested version of the Excel plugin (optional)</param>
        /// <returns>Task of FileResponse</returns>
        public async System.Threading.Tasks.Task<FileResponse> GetExcelAddinAsync (string version = default(string))
        {
             Lusid.Sdk.Client.ApiResponse<FileResponse> localVarResponse = await GetExcelAddinAsyncWithHttpInfo(version);
             return localVarResponse.Data;
        ...
        /// <param name="version">The requested version of the Excel plugin (optional)</param>
        /// <returns>Task of ApiResponse (FileResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<FileResponse>> GetExcelAddinAsyncWithHttpInfo (string version = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<FileResponse>("/api/metadata/downloads/exceladdin", localVarRequestOptions, this.Configuration);
        ...
        {
             Lusid.Sdk.Client.ApiResponse<VersionSummaryDto> localVarResponse = await GetLusidVersionsAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (VersionSummaryDto)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<VersionSummaryDto>> GetLusidVersionsAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<VersionSummaryDto>("/api/metadata/versions", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="filter">Optional. Expression to filter the result set.               For example, to filter on the Application, use \&quot;application eq &#39;string&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>Task of ResourceListOfAccessControlledResource</returns>
        public async System.Threading.Tasks.Task<ResourceListOfAccessControlledResource> ListAccessControlledResourcesAsync (string filter = default(string))
        {
             Lusid.Sdk.Client.ApiResponse<ResourceListOfAccessControlledResource> localVarResponse = await ListAccessControlledResourcesAsyncWithHttpInfo(filter);
             return localVarResponse.Data;
        ...
        /// <param name="filter">Optional. Expression to filter the result set.               For example, to filter on the Application, use \&quot;application eq &#39;string&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfAccessControlledResource)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfAccessControlledResource>> ListAccessControlledResourcesAsyncWithHttpInfo (string filter = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResourceListOfAccessControlledResource>("/api/metadata/access/resources", localVarRequestOptions, this.Configuration);
