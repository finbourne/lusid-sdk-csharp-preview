...
namespace Lusid.Sdk.Api
{
    ...
    public partial class ApplicationMetadataApi : IApplicationMetadataApi
    {
        ...
        /// <summary>
        /// [EARLY ACCESS] GetExcelAddin: Download Excel Addin Download the LUSID Excel Addin for Microsoft Excel. Not providing a specific value will return the latest version being returned
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="version">The requested version of the Excel plugin (optional)</param>
        /// <returns>FileResponse</returns>
        ...
        /// <summary>
        /// [EARLY ACCESS] GetLusidVersions: Get LUSID versions Get the semantic versions associated with LUSID and its ecosystem
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>VersionSummaryDto</returns>
