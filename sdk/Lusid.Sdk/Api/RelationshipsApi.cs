...
namespace Lusid.Sdk.Api
{
    ...
    public interface IRelationshipsApi : IApiAccessor
    {
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relationship should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        ...
        ApiResponse<CompleteRelationship> CreateRelationshipWithHttpInfo (string scope, string code, CreateRelationshipRequest createRelationshipRequest, DateTimeOrCutLabel effectiveAt = null);
        /// <summary>
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relationship should the deletion be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        ...
        ApiResponse<DeletedEntityResponse> DeleteRelationshipWithHttpInfo (string scope, string code, DeleteRelationshipRequest deleteRelationshipRequest, DateTimeOrCutLabel effectiveAt = null);
        ...
        System.Threading.Tasks.Task<CompleteRelationship> CreateRelationshipAsync (string scope, string code, CreateRelationshipRequest createRelationshipRequest, DateTimeOrCutLabel effectiveAt = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<CompleteRelationship>> CreateRelationshipAsyncWithHttpInfo (string scope, string code, CreateRelationshipRequest createRelationshipRequest, DateTimeOrCutLabel effectiveAt = null);
        /// <summary>
        /// [EXPERIMENTAL] Delete Relationship
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DeletedEntityResponse> DeleteRelationshipAsync (string scope, string code, DeleteRelationshipRequest deleteRelationshipRequest, DateTimeOrCutLabel effectiveAt = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteRelationshipAsyncWithHttpInfo (string scope, string code, DeleteRelationshipRequest deleteRelationshipRequest, DateTimeOrCutLabel effectiveAt = null);
    ...
    public partial class RelationshipsApi : IRelationshipsApi
    {
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relationship should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>CompleteRelationship</returns>
        public CompleteRelationship CreateRelationship (string scope, string code, CreateRelationshipRequest createRelationshipRequest, DateTimeOrCutLabel effectiveAt = null)
        {
             ApiResponse<CompleteRelationship> localVarResponse = CreateRelationshipWithHttpInfo(scope, code, createRelationshipRequest, effectiveAt);
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relationship should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>ApiResponse of CompleteRelationship</returns>
        public ApiResponse< CompleteRelationship > CreateRelationshipWithHttpInfo (string scope, string code, CreateRelationshipRequest createRelationshipRequest, DateTimeOrCutLabel effectiveAt = null)
        {
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relationship should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>Task of CompleteRelationship</returns>
        public async System.Threading.Tasks.Task<CompleteRelationship> CreateRelationshipAsync (string scope, string code, CreateRelationshipRequest createRelationshipRequest, DateTimeOrCutLabel effectiveAt = null)
        {
             ApiResponse<CompleteRelationship> localVarResponse = await CreateRelationshipAsyncWithHttpInfo(scope, code, createRelationshipRequest, effectiveAt);
             return localVarResponse.Data;
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relationship should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>Task of ApiResponse (CompleteRelationship)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CompleteRelationship>> CreateRelationshipAsyncWithHttpInfo (string scope, string code, CreateRelationshipRequest createRelationshipRequest, DateTimeOrCutLabel effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling RelationshipsApi->CreateRelationship");
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relationship should the deletion be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>DeletedEntityResponse</returns>
        public DeletedEntityResponse DeleteRelationship (string scope, string code, DeleteRelationshipRequest deleteRelationshipRequest, DateTimeOrCutLabel effectiveAt = null)
        {
             ApiResponse<DeletedEntityResponse> localVarResponse = DeleteRelationshipWithHttpInfo(scope, code, deleteRelationshipRequest, effectiveAt);
             return localVarResponse.Data;
        }
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relationship should the deletion be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        public ApiResponse< DeletedEntityResponse > DeleteRelationshipWithHttpInfo (string scope, string code, DeleteRelationshipRequest deleteRelationshipRequest, DateTimeOrCutLabel effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relationship should the deletion be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>Task of DeletedEntityResponse</returns>
        public async System.Threading.Tasks.Task<DeletedEntityResponse> DeleteRelationshipAsync (string scope, string code, DeleteRelationshipRequest deleteRelationshipRequest, DateTimeOrCutLabel effectiveAt = null)
        {
             ApiResponse<DeletedEntityResponse> localVarResponse = await DeleteRelationshipAsyncWithHttpInfo(scope, code, deleteRelationshipRequest, effectiveAt);
             return localVarResponse.Data;
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which the relationship should the deletion be effective from. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>Task of ApiResponse (DeletedEntityResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteRelationshipAsyncWithHttpInfo (string scope, string code, DeleteRelationshipRequest deleteRelationshipRequest, DateTimeOrCutLabel effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling RelationshipsApi->DeleteRelationship");
