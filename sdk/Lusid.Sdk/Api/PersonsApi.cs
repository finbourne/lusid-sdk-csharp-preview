...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPersonsApiSync : IApiAccessor
    {
        ...
        /// <returns>Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        Dictionary<string, List<AccessMetadataValue>> PatchPersonAccessMetadata(string idTypeScope, string idTypeCode, string code, List<Operation> operation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        ...
        /// <param name="effectiveAt">The effectiveAt datetime at which to upsert the Access Metadata (optional)</param>
        /// <returns>ApiResponse of Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        ApiResponse<Dictionary<string, List<AccessMetadataValue>>> PatchPersonAccessMetadataWithHttpInfo(string idTypeScope, string idTypeCode, string code, List<Operation> operation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        /// <summary>
    ...
    public partial class PersonsApi : IPersonsApi
    {
        ...
        /// <param name="effectiveAt">The effectiveAt datetime at which to upsert the Access Metadata (optional)</param>
        /// <returns>Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        public Dictionary<string, List<AccessMetadataValue>> PatchPersonAccessMetadata(string idTypeScope, string idTypeCode, string code, List<Operation> operation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            Lusid.Sdk.Client.ApiResponse<Dictionary<string, List<AccessMetadataValue>>> localVarResponse = PatchPersonAccessMetadataWithHttpInfo(idTypeScope, idTypeCode, code, operation, effectiveAt);
            return localVarResponse.Data;
        }
        ...
        /// <param name="effectiveAt">The effectiveAt datetime at which to upsert the Access Metadata (optional)</param>
        /// <returns>ApiResponse of Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        public Lusid.Sdk.Client.ApiResponse<Dictionary<string, List<AccessMetadataValue>>> PatchPersonAccessMetadataWithHttpInfo(string idTypeScope, string idTypeCode, string code, List<Operation> operation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            // verify the required parameter 'idTypeScope' is set
            if (idTypeScope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<Dictionary<string, List<AccessMetadataValue>>> localVarResponse = await PatchPersonAccessMetadataWithHttpInfoAsync(idTypeScope, idTypeCode, code, operation, effectiveAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
