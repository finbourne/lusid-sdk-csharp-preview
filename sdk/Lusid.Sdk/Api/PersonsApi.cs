...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPersonsApi : IApiAccessor
    {
        ...
        /// <param name="idTypeCode">Code of the person identifier type.</param>
        /// <param name="code">Code of the person under specified identifier type&#39;s scope and code. This together with stated identifier type uniquely              identifies the person.</param>
        /// <param name="identifiers">Request containing identifiers to set for the person. Identifiers not specified in request will not be changed.</param>
        /// <returns>Person</returns>
        Person SetPersonIdentifiers (string idTypeScope, string idTypeCode, string code, SetPersonIdentifiersRequest identifiers);
        ...
        /// <param name="identifiers">Request containing identifiers to set for the person. Identifiers not specified in request will not be changed.</param>
        /// <returns>ApiResponse of Person</returns>
        ApiResponse<Person> SetPersonIdentifiersWithHttpInfo (string idTypeScope, string idTypeCode, string code, SetPersonIdentifiersRequest identifiers);
        /// <summary>
        ...
        /// <param name="idTypeCode">Code of the person identifier type.</param>
        /// <param name="code">Code of the person under specified identifier type&#39;s scope and code. This together with stated identifier type uniquely              identifies the person.</param>
        /// <param name="properties">Request containing properties to set for the person. Properties not specified in request will not be changed.</param>
        /// <returns>Person</returns>
        Person SetPersonProperties (string idTypeScope, string idTypeCode, string code, SetPersonPropertiesRequest properties);
        ...
        /// <param name="properties">Request containing properties to set for the person. Properties not specified in request will not be changed.</param>
        /// <returns>ApiResponse of Person</returns>
        ApiResponse<Person> SetPersonPropertiesWithHttpInfo (string idTypeScope, string idTypeCode, string code, SetPersonPropertiesRequest properties);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="request">Request to create or update a person.</param>
        /// <returns>Person</returns>
        Person UpsertPerson (UpsertPersonRequest request);
        ...
        /// <param name="request">Request to create or update a person.</param>
        /// <returns>ApiResponse of Person</returns>
        ApiResponse<Person> UpsertPersonWithHttpInfo (UpsertPersonRequest request);
        /// <summary>
        ...
        /// <param name="identifiers">Request containing identifiers to set for the person. Identifiers not specified in request will not be changed.</param>
        /// <returns>Task of Person</returns>
        System.Threading.Tasks.Task<Person> SetPersonIdentifiersAsync (string idTypeScope, string idTypeCode, string code, SetPersonIdentifiersRequest identifiers);
        ...
        /// <param name="identifiers">Request containing identifiers to set for the person. Identifiers not specified in request will not be changed.</param>
        /// <returns>Task of ApiResponse (Person)</returns>
        System.Threading.Tasks.Task<ApiResponse<Person>> SetPersonIdentifiersAsyncWithHttpInfo (string idTypeScope, string idTypeCode, string code, SetPersonIdentifiersRequest identifiers);
        /// <summary>
        /// [EXPERIMENTAL] Set Person Properties
        /// </summary>
        /// <remarks>
        ...
        /// <param name="properties">Request containing properties to set for the person. Properties not specified in request will not be changed.</param>
        /// <returns>Task of Person</returns>
        System.Threading.Tasks.Task<Person> SetPersonPropertiesAsync (string idTypeScope, string idTypeCode, string code, SetPersonPropertiesRequest properties);
        ...
        /// <param name="properties">Request containing properties to set for the person. Properties not specified in request will not be changed.</param>
        /// <returns>Task of ApiResponse (Person)</returns>
        System.Threading.Tasks.Task<ApiResponse<Person>> SetPersonPropertiesAsyncWithHttpInfo (string idTypeScope, string idTypeCode, string code, SetPersonPropertiesRequest properties);
        /// <summary>
        /// [EXPERIMENTAL] Upsert Person
        /// </summary>
        /// <remarks>
        ...
        /// <param name="request">Request to create or update a person.</param>
        /// <returns>Task of Person</returns>
        System.Threading.Tasks.Task<Person> UpsertPersonAsync (UpsertPersonRequest request);
        ...
        /// <param name="request">Request to create or update a person.</param>
        /// <returns>Task of ApiResponse (Person)</returns>
        System.Threading.Tasks.Task<ApiResponse<Person>> UpsertPersonAsyncWithHttpInfo (UpsertPersonRequest request);
        /// <summary>
        /// [EXPERIMENTAL] Upsert a Person Access Metadata entry associated with a specific metadataKey. This creates or updates the data in LUSID.
        /// </summary>
        /// <remarks>
    ...
    public partial class PersonsApi : IPersonsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Delete Person Identifiers Delete identifiers belong to the given property keys of the person
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="idTypeScope">Scope of the person identifier type.</param>
        /// <param name="idTypeCode">Code of the person identifier type.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Delete Person Properties Delete all properties belong to the given property keys of the person
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="idTypeScope">Scope of the person identifier type.</param>
        /// <param name="idTypeCode">Code of the person identifier type.</param>
        ...
        /// <param name="identifiers">Request containing identifiers to set for the person. Identifiers not specified in request will not be changed.</param>
        /// <returns>Person</returns>
        public Person SetPersonIdentifiers (string idTypeScope, string idTypeCode, string code, SetPersonIdentifiersRequest identifiers)
        {
             ApiResponse<Person> localVarResponse = SetPersonIdentifiersWithHttpInfo(idTypeScope, idTypeCode, code, identifiers);
             return localVarResponse.Data;
        }
        ...
        /// <param name="identifiers">Request containing identifiers to set for the person. Identifiers not specified in request will not be changed.</param>
        /// <returns>ApiResponse of Person</returns>
        public ApiResponse< Person > SetPersonIdentifiersWithHttpInfo (string idTypeScope, string idTypeCode, string code, SetPersonIdentifiersRequest identifiers)
        {
            // verify the required parameter 'idTypeScope' is set
            if (idTypeScope == null)
            ...
            if (identifiers == null)
                throw new ApiException(400, "Missing required parameter 'identifiers' when calling PersonsApi->SetPersonIdentifiers");
        ...
        /// <param name="identifiers">Request containing identifiers to set for the person. Identifiers not specified in request will not be changed.</param>
        /// <returns>Task of Person</returns>
        public async System.Threading.Tasks.Task<Person> SetPersonIdentifiersAsync (string idTypeScope, string idTypeCode, string code, SetPersonIdentifiersRequest identifiers)
        {
             ApiResponse<Person> localVarResponse = await SetPersonIdentifiersAsyncWithHttpInfo(idTypeScope, idTypeCode, code, identifiers);
             return localVarResponse.Data;
        ...
        /// <param name="identifiers">Request containing identifiers to set for the person. Identifiers not specified in request will not be changed.</param>
        /// <returns>Task of ApiResponse (Person)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Person>> SetPersonIdentifiersAsyncWithHttpInfo (string idTypeScope, string idTypeCode, string code, SetPersonIdentifiersRequest identifiers)
        {
            // verify the required parameter 'idTypeScope' is set
            if (idTypeScope == null)
                throw new ApiException(400, "Missing required parameter 'idTypeScope' when calling PersonsApi->SetPersonIdentifiers");
        ...
        /// <param name="properties">Request containing properties to set for the person. Properties not specified in request will not be changed.</param>
        /// <returns>Person</returns>
        public Person SetPersonProperties (string idTypeScope, string idTypeCode, string code, SetPersonPropertiesRequest properties)
        {
             ApiResponse<Person> localVarResponse = SetPersonPropertiesWithHttpInfo(idTypeScope, idTypeCode, code, properties);
             return localVarResponse.Data;
        }
        ...
        /// <param name="properties">Request containing properties to set for the person. Properties not specified in request will not be changed.</param>
        /// <returns>ApiResponse of Person</returns>
        public ApiResponse< Person > SetPersonPropertiesWithHttpInfo (string idTypeScope, string idTypeCode, string code, SetPersonPropertiesRequest properties)
        {
            // verify the required parameter 'idTypeScope' is set
            if (idTypeScope == null)
            ...
            if (properties == null)
                throw new ApiException(400, "Missing required parameter 'properties' when calling PersonsApi->SetPersonProperties");
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(properties); // http body (model) parameter
            }
            else
            {
        ...
        /// <param name="properties">Request containing properties to set for the person. Properties not specified in request will not be changed.</param>
        /// <returns>Task of Person</returns>
        public async System.Threading.Tasks.Task<Person> SetPersonPropertiesAsync (string idTypeScope, string idTypeCode, string code, SetPersonPropertiesRequest properties)
        {
             ApiResponse<Person> localVarResponse = await SetPersonPropertiesAsyncWithHttpInfo(idTypeScope, idTypeCode, code, properties);
             return localVarResponse.Data;
        ...
        /// <param name="properties">Request containing properties to set for the person. Properties not specified in request will not be changed.</param>
        /// <returns>Task of ApiResponse (Person)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Person>> SetPersonPropertiesAsyncWithHttpInfo (string idTypeScope, string idTypeCode, string code, SetPersonPropertiesRequest properties)
        {
            // verify the required parameter 'idTypeScope' is set
            if (idTypeScope == null)
                throw new ApiException(400, "Missing required parameter 'idTypeScope' when calling PersonsApi->SetPersonProperties");
        ...
        /// <param name="request">Request to create or update a person.</param>
        /// <returns>Person</returns>
        public Person UpsertPerson (UpsertPersonRequest request)
        {
        ...
        /// <param name="request">Request to create or update a person.</param>
        /// <returns>ApiResponse of Person</returns>
        public ApiResponse< Person > UpsertPersonWithHttpInfo (UpsertPersonRequest request)
        {
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling PersonsApi->UpsertPerson");
        ...
        /// <param name="request">Request to create or update a person.</param>
        /// <returns>Task of Person</returns>
        public async System.Threading.Tasks.Task<Person> UpsertPersonAsync (UpsertPersonRequest request)
        {
        ...
        /// <param name="request">Request to create or update a person.</param>
        /// <returns>Task of ApiResponse (Person)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Person>> UpsertPersonAsyncWithHttpInfo (UpsertPersonRequest request)
        {
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling PersonsApi->UpsertPerson");
