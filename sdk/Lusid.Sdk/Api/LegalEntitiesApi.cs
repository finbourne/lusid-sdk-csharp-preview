...
namespace Lusid.Sdk.Api
{
    ...
    public interface ILegalEntitiesApi : IApiAccessor
    {
        ...
        /// <param name="code">Code of the legal entity under specified identifier type scope and code. This together with defined              identifier type uniquely identifies the legal entity to delete.</param>
        ...
        /// <param name="code">Code of the legal entity under specified scope and code. This together with stated identifier type uniquely              identifies the legal entity.</param>
        /// <param name="propertyKeys">A list of property keys from the \&quot;LegalEntity\&quot; domain to decorate onto each legal entity.              These take the format {domain}/{scope}/{code} e.g. \&quot;LegalEntity/ContactDetails/Address\&quot;. Defaults to include all properties if not specified. (optional)</param>
        ...
        /// <param name="identifierTypes">Identifiers types (as property keys) used for referencing LegalEntities or Legal Entities. These take the format              {domain}/{scope}/{code} e.g. \&quot;Person/CompanyDetails/Role\&quot;. They must be from the \&quot;Person\&quot; or \&quot;LegalEntity\&quot; domain.              Only identifier types stated will be used to look up relevant entities in relations. If not applicable, provide an empty array. (optional)</param>
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;LegalEntity\&quot; domain to decorate onto each legal entity.              These take the format {domain}/{scope}/{code} e.g. \&quot;LegalEntity/ContactDetails/Address\&quot;. (optional)</param>
        ...
        ApiResponse<PagedResourceListOfLegalEntity> ListLegalEntitiesWithHttpInfo (string idTypeScope, string idTypeCode, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<PagedResourceListOfLegalEntity> ListLegalEntitiesAsync (string idTypeScope, string idTypeCode, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PagedResourceListOfLegalEntity>> ListLegalEntitiesAsyncWithHttpInfo (string idTypeScope, string idTypeCode, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null);
        /// <summary>
        /// [EXPERIMENTAL] Upsert Legal Entity
        /// </summary>
        /// <remarks>
    ...
    public partial class LegalEntitiesApi : ILegalEntitiesApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Delete legal entity Delete a legal entity. Deletion will be valid from the legal entity&#39;s creation datetime.  This means that the legal entity will no longer exist at any effective datetime from the asAt datetime of deletion.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="idTypeScope">The scope of the legal entity identifier type.</param>
        /// <param name="idTypeCode">The code of the legal entity identifier type.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get Legal Entity Retrieve the definition of a legal entity.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="idTypeScope">Scope of the legal entity identifier type.</param>
        /// <param name="idTypeCode">Code of the legal entity identifier type.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] List Legal Entities List legal entities which has identifier of specific identifier type&#39;s scope and code, and satisfies filter criteria.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="idTypeScope">Scope of the legal entity identifier type.</param>
        /// <param name="idTypeCode">Code of the legal entity identifier type.</param>
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;LegalEntity\&quot; domain to decorate onto each legal entity.              These take the format {domain}/{scope}/{code} e.g. \&quot;LegalEntity/ContactDetails/Address\&quot;. (optional)</param>
        /// <returns>PagedResourceListOfLegalEntity</returns>
        public PagedResourceListOfLegalEntity ListLegalEntities (string idTypeScope, string idTypeCode, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null)
        {
             ApiResponse<PagedResourceListOfLegalEntity> localVarResponse = ListLegalEntitiesWithHttpInfo(idTypeScope, idTypeCode, effectiveAt, asAt, page, start, limit, filter, propertyKeys);
             return localVarResponse.Data;
        }
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;LegalEntity\&quot; domain to decorate onto each legal entity.              These take the format {domain}/{scope}/{code} e.g. \&quot;LegalEntity/ContactDetails/Address\&quot;. (optional)</param>
        /// <returns>ApiResponse of PagedResourceListOfLegalEntity</returns>
        public ApiResponse< PagedResourceListOfLegalEntity > ListLegalEntitiesWithHttpInfo (string idTypeScope, string idTypeCode, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null)
        {
            // verify the required parameter 'idTypeScope' is set
            if (idTypeScope == null)
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;LegalEntity\&quot; domain to decorate onto each legal entity.              These take the format {domain}/{scope}/{code} e.g. \&quot;LegalEntity/ContactDetails/Address\&quot;. (optional)</param>
        /// <returns>Task of PagedResourceListOfLegalEntity</returns>
        public async System.Threading.Tasks.Task<PagedResourceListOfLegalEntity> ListLegalEntitiesAsync (string idTypeScope, string idTypeCode, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null)
        {
             ApiResponse<PagedResourceListOfLegalEntity> localVarResponse = await ListLegalEntitiesAsyncWithHttpInfo(idTypeScope, idTypeCode, effectiveAt, asAt, page, start, limit, filter, propertyKeys);
             return localVarResponse.Data;
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;LegalEntity\&quot; domain to decorate onto each legal entity.              These take the format {domain}/{scope}/{code} e.g. \&quot;LegalEntity/ContactDetails/Address\&quot;. (optional)</param>
        /// <returns>Task of ApiResponse (PagedResourceListOfLegalEntity)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PagedResourceListOfLegalEntity>> ListLegalEntitiesAsyncWithHttpInfo (string idTypeScope, string idTypeCode, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null)
        {
            // verify the required parameter 'idTypeScope' is set
            if (idTypeScope == null)
                throw new ApiException(400, "Missing required parameter 'idTypeScope' when calling LegalEntitiesApi->ListLegalEntities");
        ...
        /// <summary>
        /// [EXPERIMENTAL] Upsert Legal Entity Create or update new legal entity under specified scope
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="upsertLegalEntityRequest">Request to create or update a legal entity.</param>
        /// <returns>LegalEntity</returns>
