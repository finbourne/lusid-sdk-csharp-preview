...
namespace Lusid.Sdk.Api
{
    ...
    public interface IOrderGraphApiSync : IApiAccessor
    {
        ...
        PagedResourceListOfOrderGraphBlock ListOrderGraphBlocks(DateTimeOffset? asAt = default(DateTimeOffset?), string paginationToken = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>));
        ...
        ApiResponse<PagedResourceListOfOrderGraphBlock> ListOrderGraphBlocksWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string paginationToken = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>));
        /// <summary>
    ...
    public partial class OrderGraphApi : IOrderGraphApi
    {
        ...
        /// <param name="propertyKeys">Must be block-level properties. See https://support.lusid.com/knowledgebase/article/KA-01855/ (optional)</param>
        /// <returns>PagedResourceListOfOrderGraphBlock</returns>
        public PagedResourceListOfOrderGraphBlock ListOrderGraphBlocks(DateTimeOffset? asAt = default(DateTimeOffset?), string paginationToken = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>))
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphBlock> localVarResponse = ListOrderGraphBlocksWithHttpInfo(asAt, paginationToken, sortBy, limit, filter, propertyKeys);
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphBlock> localVarResponse = await ListOrderGraphBlocksWithHttpInfoAsync(asAt, paginationToken, sortBy, limit, filter, propertyKeys, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
