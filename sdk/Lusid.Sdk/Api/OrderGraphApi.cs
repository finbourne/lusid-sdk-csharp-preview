...
namespace Lusid.Sdk.Api
{
    ...
    public interface IOrderGraphApiSync : IApiAccessor
    {
        ...
        PagedResourceListOfOrderGraphPlacement ListOrderGraphPlacementChildren(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), string paginationToken = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), List<string> propertyKeys = default(List<string>));
        ...
        /// <param name="propertyKeys">Must be placement properties. See https://support.lusid.com/knowledgebase/article/KA-01855/ (optional)</param>
        /// <returns>PagedResourceListOfOrderGraphPlacement</returns>
        PagedResourceListOfOrderGraphPlacement ListOrderGraphPlacements(DateTimeOffset? asAt = default(DateTimeOffset?), string paginationToken = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>));
    ...
    public interface IOrderGraphApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PagedResourceListOfOrderGraphPlacement> ListOrderGraphPlacementChildrenAsync(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), string paginationToken = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), List<string> propertyKeys = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class OrderGraphApi : IOrderGraphApi
    {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphBlock> localVarResponse = await ListOrderGraphBlocksWithHttpInfoAsync(asAt, paginationToken, sortBy, limit, filter, propertyKeys, useComplianceV2, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="propertyKeys">Must be placement properties. See https://support.lusid.com/knowledgebase/article/KA-01855/ (optional)</param>
        /// <returns>PagedResourceListOfOrderGraphPlacement</returns>
        public PagedResourceListOfOrderGraphPlacement ListOrderGraphPlacementChildren(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), string paginationToken = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), List<string> propertyKeys = default(List<string>))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement> localVarResponse = await ListOrderGraphPlacementChildrenWithHttpInfoAsync(scope, code, asAt, paginationToken, sortBy, limit, propertyKeys, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="propertyKeys">Must be placement properties. See https://support.lusid.com/knowledgebase/article/KA-01855/ (optional)</param>
        /// <returns>PagedResourceListOfOrderGraphPlacement</returns>
        public PagedResourceListOfOrderGraphPlacement ListOrderGraphPlacements(DateTimeOffset? asAt = default(DateTimeOffset?), string paginationToken = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement> localVarResponse = await ListOrderGraphPlacementsWithHttpInfoAsync(asAt, paginationToken, sortBy, limit, filter, propertyKeys, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
