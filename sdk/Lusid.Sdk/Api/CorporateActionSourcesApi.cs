 ...
 *
 * The version of the OpenAPI document: 0.11.5389
...
namespace Lusid.Sdk.Api
{
    ...
    public partial class CorporateActionSourcesApi : ICorporateActionSourcesApi
    {
        ...
        public Lusid.Sdk.Client.ApiResponse<UpsertCorporateActionsResponse> BatchUpsertCorporateActionsWithHttpInfo(string scope, string code, List<UpsertCorporateActionRequest> upsertCorporateActionRequest = default(List<UpsertCorporateActionRequest>))
        {
            ...
            localVarRequestOptions.HeaderParameters.Add("X-LUSID-Sdk-Version", "0.11.5389");
        ...
        /// <summary>
        /// [EARLY ACCESS] DeleteCorporateActions: Delete corporate actions Delete one or more corporate actions from a particular corporate action source.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the corporate action source</param>
        /// <param name="code">The code of the corporate action source</param>
        ...
        /// <summary>
        /// [EARLY ACCESS] DeleteInstrumentEvents: Delete corporate actions (instrument transition events) from the corporate action source. Delete one or more corporate actions from a particular corporate action source.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the corporate action source</param>
        /// <param name="code">The code of the corporate action source</param>
        ...
        /// <summary>
        /// [EARLY ACCESS] UpsertInstrumentEvents: Upsert instrument events to the provided corporate actions source. Batch upsert instrument events to corporate action sources.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the corporate action source.</param>
        /// <param name="code">The code of the corporate action source.</param>
