 ...
 *
 * The version of the OpenAPI document: 0.11.4866
...
namespace Lusid.Sdk.Api
{
    ...
    public interface ICorporateActionSourcesApiSync : IApiAccessor
    {
        ...
        PagedResourceListOfInstrumentEventHolder GetInstrumentEvents(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string page = default(string), string filter = default(string));
        ...
        ApiResponse<PagedResourceListOfInstrumentEventHolder> GetInstrumentEventsWithHttpInfo(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string page = default(string), string filter = default(string));
        /// <summary>
    ...
    public partial class CorporateActionSourcesApi : ICorporateActionSourcesApi
    {
        ...
        public Lusid.Sdk.Client.ApiResponse<UpsertCorporateActionsResponse> BatchUpsertCorporateActionsWithHttpInfo(string scope, string code, List<UpsertCorporateActionRequest> upsertCorporateActionRequest = default(List<UpsertCorporateActionRequest>))
        {
            ...
            localVarRequestOptions.HeaderParameters.Add("X-LUSID-Sdk-Version", "0.11.4866");
        ...
        /// <param name="filter">Optional. Expression to filter the result set. (optional)</param>
        /// <returns>PagedResourceListOfInstrumentEventHolder</returns>
        public PagedResourceListOfInstrumentEventHolder GetInstrumentEvents(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string page = default(string), string filter = default(string))
        {
        ...
        /// <param name="filter">Optional. Expression to filter the result set. (optional)</param>
        /// <returns>ApiResponse of PagedResourceListOfInstrumentEventHolder</returns>
        public Lusid.Sdk.Client.ApiResponse<PagedResourceListOfInstrumentEventHolder> GetInstrumentEventsWithHttpInfo(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string page = default(string), string filter = default(string))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfInstrumentEventHolder> localVarResponse = await GetInstrumentEventsWithHttpInfoAsync(scope, code, asAt, limit, page, filter, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
