...
namespace Lusid.Sdk.Api
{
    ...
    public interface IStructuredResultDataApi : IApiAccessor
    {
        ...
        ApiResponse<GetStructuredResultDataResponse> GetStructuredResultDataWithHttpInfo (string scope, Dictionary<string, StructuredResultDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<GetStructuredResultDataResponse> GetStructuredResultDataAsync (string scope, Dictionary<string, StructuredResultDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetStructuredResultDataResponse>> GetStructuredResultDataAsyncWithHttpInfo (string scope, Dictionary<string, StructuredResultDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null);
        /// <summary>
        /// [EXPERIMENTAL] Upsert a set of structured result data items. This creates or updates the data in Lusid.
        /// </summary>
        /// <remarks>
    ...
    public partial class StructuredResultDataApi : IStructuredResultDataApi
    {
        ...
        /// <param name="maxAge">The duration of the look back window in an ISO8601 time interval format e.g. P1Y2M3DT4H30M (1 year, 2 months, 3 days, 4 hours and 30 minutes).               This is subtracted from the provided effectiveAt datetime to generate a effective datetime window inside which a structured result data item must exist to be retrieved. (optional)</param>
        /// <returns>GetStructuredResultDataResponse</returns>
        public GetStructuredResultDataResponse GetStructuredResultData (string scope, Dictionary<string, StructuredResultDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null)
        {
             ApiResponse<GetStructuredResultDataResponse> localVarResponse = GetStructuredResultDataWithHttpInfo(scope, requestBody, effectiveAt, asAt, maxAge);
             return localVarResponse.Data;
        }
        ...
        /// <param name="maxAge">The duration of the look back window in an ISO8601 time interval format e.g. P1Y2M3DT4H30M (1 year, 2 months, 3 days, 4 hours and 30 minutes).               This is subtracted from the provided effectiveAt datetime to generate a effective datetime window inside which a structured result data item must exist to be retrieved. (optional)</param>
        /// <returns>ApiResponse of GetStructuredResultDataResponse</returns>
        public ApiResponse< GetStructuredResultDataResponse > GetStructuredResultDataWithHttpInfo (string scope, Dictionary<string, StructuredResultDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="maxAge">The duration of the look back window in an ISO8601 time interval format e.g. P1Y2M3DT4H30M (1 year, 2 months, 3 days, 4 hours and 30 minutes).               This is subtracted from the provided effectiveAt datetime to generate a effective datetime window inside which a structured result data item must exist to be retrieved. (optional)</param>
        /// <returns>Task of GetStructuredResultDataResponse</returns>
        public async System.Threading.Tasks.Task<GetStructuredResultDataResponse> GetStructuredResultDataAsync (string scope, Dictionary<string, StructuredResultDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null)
        {
             ApiResponse<GetStructuredResultDataResponse> localVarResponse = await GetStructuredResultDataAsyncWithHttpInfo(scope, requestBody, effectiveAt, asAt, maxAge);
             return localVarResponse.Data;
        ...
        /// <param name="maxAge">The duration of the look back window in an ISO8601 time interval format e.g. P1Y2M3DT4H30M (1 year, 2 months, 3 days, 4 hours and 30 minutes).               This is subtracted from the provided effectiveAt datetime to generate a effective datetime window inside which a structured result data item must exist to be retrieved. (optional)</param>
        /// <returns>Task of ApiResponse (GetStructuredResultDataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetStructuredResultDataResponse>> GetStructuredResultDataAsyncWithHttpInfo (string scope, Dictionary<string, StructuredResultDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling StructuredResultDataApi->GetStructuredResultData");
