...
namespace Lusid.Sdk.Api
{
    ...
    public interface IStructuredResultDataApiSync : IApiAccessor
    {
        ...
        PagedResourceListOfVirtualRow GetVirtualDocumentRows(string scope, string code, string source, string resultType, DateTimeOrCutLabel effectiveAt, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), string filter = default(string));
        ...
        ApiResponse<PagedResourceListOfVirtualRow> GetVirtualDocumentRowsWithHttpInfo(string scope, string code, string source, string resultType, DateTimeOrCutLabel effectiveAt, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), string filter = default(string));
        /// <summary>
    ...
    public partial class StructuredResultDataApi : IStructuredResultDataApi
    {
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here:               https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>PagedResourceListOfVirtualRow</returns>
        public PagedResourceListOfVirtualRow GetVirtualDocumentRows(string scope, string code, string source, string resultType, DateTimeOrCutLabel effectiveAt, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), string filter = default(string))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfVirtualRow> localVarResponse = await GetVirtualDocumentRowsWithHttpInfoAsync(scope, code, source, resultType, effectiveAt, asAt, page, limit, filter, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
