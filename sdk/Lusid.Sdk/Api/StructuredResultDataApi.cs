...
namespace Lusid.Sdk.Api
{
    ...
    public interface IStructuredResultDataApi : IApiAccessor
    {
        ...
        /// <param name="scope">Scope in which to upsert the result address definition maps</param>
        /// <param name="requestBody">Individual result address definition map creation requests</param>
        ...
        /// <param name="requestBody">The structured result data Ids to delete, each keyed by a unique correlation id.</param>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the result address definition map keys</param>
        /// <param name="requestBody">The result address definition map keys to lookup</param>
        ...
        /// <param name="requestBody">The set of structured result data items to update or insert keyed by a unique correlation id.</param>
        /// <returns>UpsertStructuredDataResponse</returns>
    ...
    public partial class StructuredResultDataApi : IStructuredResultDataApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Upsert a set of structured result address definition maps. This creates or updates the data in Lusid. Create one or more structured result address definition map items in a single scope. These are immutable and cannot be changed once inserted                In the request each data map item must be keyed by a unique correlation id. This id is ephemeral and is not stored by LUSID.  It serves only as a way to easily identify each structured result data in the response.                The response will return both the collection of successfully updated or inserted data maps, as well as those that failed.  For the failures a reason will be provided explaining why the item could not be updated or inserted.                It is important to always check the failed set for any unsuccessful results.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">Scope in which to upsert the result address definition maps</param>
        /// <param name="requestBody">Individual result address definition map creation requests</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get the result address definition maps from the store Get one or more result address definition map from a single scope.                Each item can be identified by its invariant Data Map key, which can be thought of as a permanent URL.                For each id LUSID will return the most recent matched item.                In the request each structured result data id must be keyed by a unique correlation id. This id is ephemeral and is not stored by LUSID.  It serves only as a way to easily identify each item in the response.                The response will return three collections. One, the successfully retrieved structured result data. Two, those that had a  valid identifier but could not be found. Three, those that failed because LUSID could not construct a valid identifier from the request.                For the ids that failed to resolve or could not be found a reason will be provided explaining why that is the case.                It is important to always check the failed and not found sets for any unsuccessful results.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the result address definition map keys</param>
        /// <param name="requestBody">The result address definition map keys to lookup</param>
