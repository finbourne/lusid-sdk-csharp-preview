...
namespace Lusid.Sdk.Api
{
    ...
    public interface ICustomEntitiesApiSync : IApiAccessor
    {
        ...
        /// <param name="entityType">The type of entity to retrieve. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions.</param>
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which to get the CustomEntity. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>CustomEntityResponse</returns>
        CustomEntityResponse GetCustomEntity(string entityType, string identifierType, string identifierValue, string identifierScope, DateTimeOffset? asAt = default(DateTimeOffset?), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        ...
        ApiResponse<CustomEntityResponse> GetCustomEntityWithHttpInfo(string entityType, string identifierType, string identifierValue, string identifierScope, DateTimeOffset? asAt = default(DateTimeOffset?), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="entityType">The type of the CustomEntity to be created. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions.</param>
    ...
    public partial class CustomEntitiesApi : ICustomEntitiesApi
    {
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which to get the CustomEntity. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>CustomEntityResponse</returns>
        public CustomEntityResponse GetCustomEntity(string entityType, string identifierType, string identifierValue, string identifierScope, DateTimeOffset? asAt = default(DateTimeOffset?), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            Lusid.Sdk.Client.ApiResponse<CustomEntityResponse> localVarResponse = GetCustomEntityWithHttpInfo(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt);
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which to get the CustomEntity. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>ApiResponse of CustomEntityResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<CustomEntityResponse> GetCustomEntityWithHttpInfo(string entityType, string identifierType, string identifierValue, string identifierScope, DateTimeOffset? asAt = default(DateTimeOffset?), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<CustomEntityResponse> localVarResponse = await GetCustomEntityWithHttpInfoAsync(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
