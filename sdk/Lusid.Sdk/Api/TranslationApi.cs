...
namespace Lusid.Sdk.Api
{
    ...
    public interface ITranslationApiSync : IApiAccessor
    {
        ...
        ApiResponse<TranslateTradeTicketsResponse> TranslateTradeTicketsWithHttpInfo(TranslateTradeTicketRequest translateTradeTicketRequest);
    ...
    public interface ITranslationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TranslateTradeTicketsResponse> TranslateTradeTicketsAsync(TranslateTradeTicketRequest translateTradeTicketRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TranslateTradeTicketsResponse>> TranslateTradeTicketsWithHttpInfoAsync(TranslateTradeTicketRequest translateTradeTicketRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TranslationApi : ITranslationApi
    {
        ...
        /// <param name="translateTradeTicketRequest">The definitions of the trade ticket to translate along with the target dialect.</param>
        /// <returns>TranslateTradeTicketsResponse</returns>
        public TranslateTradeTicketsResponse TranslateTradeTickets(TranslateTradeTicketRequest translateTradeTicketRequest)
        {
        ...
        /// <param name="translateTradeTicketRequest">The definitions of the trade ticket to translate along with the target dialect.</param>
        /// <returns>ApiResponse of TranslateTradeTicketsResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<TranslateTradeTicketsResponse> TranslateTradeTicketsWithHttpInfo(TranslateTradeTicketRequest translateTradeTicketRequest)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<TranslateTradeTicketsResponse>("/api/translation/tradeticket", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TranslateTradeTicketsResponse</returns>
        public async System.Threading.Tasks.Task<TranslateTradeTicketsResponse> TranslateTradeTicketsAsync(TranslateTradeTicketRequest translateTradeTicketRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<TranslateTradeTicketsResponse> localVarResponse = await TranslateTradeTicketsWithHttpInfoAsync(translateTradeTicketRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TranslateTradeTicketsResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<TranslateTradeTicketsResponse>> TranslateTradeTicketsWithHttpInfoAsync(TranslateTradeTicketRequest translateTradeTicketRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'translateTradeTicketRequest' is set
            if (translateTradeTicketRequest == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'translateTradeTicketRequest' when calling TranslationApi->TranslateTradeTickets");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<TranslateTradeTicketsResponse>("/api/translation/tradeticket", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
