...
namespace Lusid.Sdk.Api
{
    ...
    public interface IRelationshipDefinitionsApiSync : IApiAccessor
    {
        ...
        PagedResourceListOfRelationshipDefinition ListRelationshipDefinitions(DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), string filter = default(string), List<string> sortBy = default(List<string>));
        ...
        ApiResponse<PagedResourceListOfRelationshipDefinition> ListRelationshipDefinitionsWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), string filter = default(string), List<string> sortBy = default(List<string>));
        /// <summary>
    ...
    public partial class RelationshipDefinitionsApi : IRelationshipDefinitionsApi
    {
        ...
        /// <param name="sortBy">A list of field names to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot; (optional)</param>
        /// <returns>PagedResourceListOfRelationshipDefinition</returns>
        public PagedResourceListOfRelationshipDefinition ListRelationshipDefinitions(DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), string filter = default(string), List<string> sortBy = default(List<string>))
        {
        ...
        /// <param name="sortBy">A list of field names to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot; (optional)</param>
        /// <returns>ApiResponse of PagedResourceListOfRelationshipDefinition</returns>
        public Lusid.Sdk.Client.ApiResponse<PagedResourceListOfRelationshipDefinition> ListRelationshipDefinitionsWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), string filter = default(string), List<string> sortBy = default(List<string>))
        {
            Lusid.Sdk.Client.RequestOptions localVarRequestOptions = new Lusid.Sdk.Client.RequestOptions();
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfRelationshipDefinition> localVarResponse = await ListRelationshipDefinitionsWithHttpInfoAsync(asAt, page, limit, filter, sortBy, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
