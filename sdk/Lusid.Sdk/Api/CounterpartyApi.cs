...
namespace Lusid.Sdk.Api
{
    ...
    /// </summary>
    public interface ICounterpartyApiSync : IApiAccessor
    {
        ...
        /// <param name="scope">The scope of the Counterparty to delete.</param>
        /// <param name="code">The Counterparty to delete.</param>
        ...
        ApiResponse<AnnulSingleStructuredDataResponse> DeleteCounterpartyWithHttpInfo(string scope, string code);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the CSA to delete.</param>
        /// <param name="code">The CSA to delete.</param>
        /// <returns>AnnulSingleStructuredDataResponse</returns>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the Counterparty to retrieve.</param>
        /// <param name="code">The name of the Counterparty to retrieve the data for.</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)</param>
        /// <returns>GetCounterpartyResponse</returns>
        GetCounterpartyResponse GetCounterparty(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?));
        ...
        /// <param name="code">The name of the Counterparty to retrieve the data for.</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)</param>
        /// <returns>ApiResponse of GetCounterpartyResponse</returns>
        ApiResponse<GetCounterpartyResponse> GetCounterpartyWithHttpInfo(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?));
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the CSA to retrieve.</param>
        /// <param name="code">The name of the CSA to retrieve the data for.</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the CSA. Defaults to return the latest version if not specified. (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="asAt">The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)</param>
        /// <returns>ResourceListOfGetCounterpartyResponse</returns>
        ResourceListOfGetCounterpartyResponse ListCounterparties(DateTimeOffset? asAt = default(DateTimeOffset?));
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="asAt">The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfGetCounterpartyResponse</returns>
        ApiResponse<ResourceListOfGetCounterpartyResponse> ListCounterpartiesWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?));
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="asAt">The asAt datetime at which to list the CSAs. Defaults to latest if not specified. (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="upsertCounterpartyRequest">The Counterparty to update or insert</param>
        ...
        ApiResponse<UpsertSingleStructuredDataResponse> UpsertCounterpartyWithHttpInfo(UpsertCounterpartyRequest upsertCounterpartyRequest);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="upsertCreditSupportAnnexRequest">The CSA to update or insert</param>
        /// <returns>UpsertSingleStructuredDataResponse</returns>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICounterpartyApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<AnnulSingleStructuredDataResponse> DeleteCounterpartyAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<AnnulSingleStructuredDataResponse>> DeleteCounterpartyWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] Delete the CSA of given scope and code, assuming that it is present.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetCounterpartyResponse</returns>
        System.Threading.Tasks.Task<GetCounterpartyResponse> GetCounterpartyAsync(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetCounterpartyResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<GetCounterpartyResponse>> GetCounterpartyWithHttpInfoAsync(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] Get CSA
        /// </summary>
        /// <remarks>
        ...
        /// <param name="asAt">The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResourceListOfGetCounterpartyResponse</returns>
        System.Threading.Tasks.Task<ResourceListOfGetCounterpartyResponse> ListCounterpartiesAsync(DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="asAt">The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ResourceListOfGetCounterpartyResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfGetCounterpartyResponse>> ListCounterpartiesWithHttpInfoAsync(DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] List the set of CSAs
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<UpsertSingleStructuredDataResponse> UpsertCounterpartyAsync(UpsertCounterpartyRequest upsertCounterpartyRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<UpsertSingleStructuredDataResponse>> UpsertCounterpartyWithHttpInfoAsync(UpsertCounterpartyRequest upsertCounterpartyRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] Upsert CSA. This creates or updates the data in Lusid.
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICounterpartyApi : ICounterpartyApiSync, ICounterpartyApiAsync
    {
    ...
    public partial class CounterpartyApi : ICounterpartyApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public CounterpartyApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public CounterpartyApi(Lusid.Sdk.Client.Configuration configuration)
        {
        ...
        public CounterpartyApi(Lusid.Sdk.Client.ISynchronousClient client, Lusid.Sdk.Client.IAsynchronousClient asyncClient, Lusid.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Delete the Counterparty of given scope and code, assuming that it is present. Delete the specified Counterparty from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.                It is important to always check for any unsuccessful response.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the Counterparty to delete.</param>
        /// <param name="code">The Counterparty to delete.</param>
        /// <returns>AnnulSingleStructuredDataResponse</returns>
        public AnnulSingleStructuredDataResponse DeleteCounterparty(string scope, string code)
        {
            Lusid.Sdk.Client.ApiResponse<AnnulSingleStructuredDataResponse> localVarResponse = DeleteCounterpartyWithHttpInfo(scope, code);
        ...
        /// <param name="code">The Counterparty to delete.</param>
        /// <returns>ApiResponse of AnnulSingleStructuredDataResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<AnnulSingleStructuredDataResponse> DeleteCounterpartyWithHttpInfo(string scope, string code)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling CounterpartyApi->DeleteCounterparty");

            // verify the required parameter 'code' is set
            if (code == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling CounterpartyApi->DeleteCounterparty");
            ...
            var localVarResponse = this.Client.Delete<AnnulSingleStructuredDataResponse>("/api/counterparties/counterparties/counterparty/{scope}/{code}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteCounterparty", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AnnulSingleStructuredDataResponse</returns>
        public async System.Threading.Tasks.Task<AnnulSingleStructuredDataResponse> DeleteCounterpartyAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<AnnulSingleStructuredDataResponse> localVarResponse = await DeleteCounterpartyWithHttpInfoAsync(scope, code, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AnnulSingleStructuredDataResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<AnnulSingleStructuredDataResponse>> DeleteCounterpartyWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling CounterpartyApi->DeleteCounterparty");
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<AnnulSingleStructuredDataResponse>("/api/counterparties/counterparties/counterparty/{scope}/{code}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// [EXPERIMENTAL] Delete the CSA of given scope and code, assuming that it is present. Delete the specified CSA from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.                It is important to always check for any unsuccessful response.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the CSA to delete.</param>
        /// <param name="code">The CSA to delete.</param>
        ...
        public Lusid.Sdk.Client.ApiResponse<AnnulSingleStructuredDataResponse> DeleteCreditSupportAnnexWithHttpInfo(string scope, string code)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling CounterpartyApi->DeleteCreditSupportAnnex");

            // verify the required parameter 'code' is set
            if (code == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling CounterpartyApi->DeleteCreditSupportAnnex");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<AnnulSingleStructuredDataResponse>("/api/counterparties/counterparties/csa/{scope}/{code}", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<AnnulSingleStructuredDataResponse>> DeleteCreditSupportAnnexWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<AnnulSingleStructuredDataResponse>("/api/counterparties/counterparties/csa/{scope}/{code}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get Counterparty Get a Counterparty from a single scope.  The response will return either the counterparty that has been stored, or a failure explaining why the request was unsuccessful.  It is important to always check for any unsuccessful requests (failures).
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the Counterparty to retrieve.</param>
        /// <param name="code">The name of the Counterparty to retrieve the data for.</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)</param>
        /// <returns>GetCounterpartyResponse</returns>
        public GetCounterpartyResponse GetCounterparty(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            Lusid.Sdk.Client.ApiResponse<GetCounterpartyResponse> localVarResponse = GetCounterpartyWithHttpInfo(scope, code, asAt);
            return localVarResponse.Data;
        }
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)</param>
        /// <returns>ApiResponse of GetCounterpartyResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<GetCounterpartyResponse> GetCounterpartyWithHttpInfo(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling CounterpartyApi->GetCounterparty");

            // verify the required parameter 'code' is set
            if (code == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling CounterpartyApi->GetCounterparty");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GetCounterpartyResponse>("/api/counterparties/counterparties/counterparty/{scope}/{code}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetCounterparty", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetCounterpartyResponse</returns>
        public async System.Threading.Tasks.Task<GetCounterpartyResponse> GetCounterpartyAsync(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<GetCounterpartyResponse> localVarResponse = await GetCounterpartyWithHttpInfoAsync(scope, code, asAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetCounterpartyResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<GetCounterpartyResponse>> GetCounterpartyWithHttpInfoAsync(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling CounterpartyApi->GetCounterparty");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetCounterpartyResponse>("/api/counterparties/counterparties/counterparty/{scope}/{code}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get CSA Get a CSA from a single scope.  The response will return either the CSA that has been stored, or a failure explaining why the request was unsuccessful.  It is important to always check for any unsuccessful requests (failures).
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the CSA to retrieve.</param>
        /// <param name="code">The name of the CSA to retrieve the data for.</param>
        ...
        public Lusid.Sdk.Client.ApiResponse<GetCreditSupportAnnexResponse> GetCreditSupportAnnexWithHttpInfo(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling CounterpartyApi->GetCreditSupportAnnex");

            // verify the required parameter 'code' is set
            if (code == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling CounterpartyApi->GetCreditSupportAnnex");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GetCreditSupportAnnexResponse>("/api/counterparties/counterparties/csa/{scope}/{code}", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<GetCreditSupportAnnexResponse>> GetCreditSupportAnnexWithHttpInfoAsync(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetCreditSupportAnnexResponse>("/api/counterparties/counterparties/csa/{scope}/{code}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// [EXPERIMENTAL] List the set of Counterparties List the set of Counterparties at the specified AsAt date/time
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="asAt">The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)</param>
        /// <returns>ResourceListOfGetCounterpartyResponse</returns>
        public ResourceListOfGetCounterpartyResponse ListCounterparties(DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfGetCounterpartyResponse> localVarResponse = ListCounterpartiesWithHttpInfo(asAt);
            return localVarResponse.Data;
        }
        ...
        /// <param name="asAt">The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfGetCounterpartyResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfGetCounterpartyResponse> ListCounterpartiesWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            Lusid.Sdk.Client.RequestOptions localVarRequestOptions = new Lusid.Sdk.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ResourceListOfGetCounterpartyResponse>("/api/counterparties/counterparties/counterparty", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ListCounterparties", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResourceListOfGetCounterpartyResponse</returns>
        public async System.Threading.Tasks.Task<ResourceListOfGetCounterpartyResponse> ListCounterpartiesAsync(DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfGetCounterpartyResponse> localVarResponse = await ListCounterpartiesWithHttpInfoAsync(asAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ResourceListOfGetCounterpartyResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfGetCounterpartyResponse>> ListCounterpartiesWithHttpInfoAsync(DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResourceListOfGetCounterpartyResponse>("/api/counterparties/counterparties/counterparty", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// [EXPERIMENTAL] List the set of CSAs List the set of CSAs at the specified AsAt date/time
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="asAt">The asAt datetime at which to list the CSAs. Defaults to latest if not specified. (optional)</param>
        /// <returns>ResourceListOfGetCreditSupportAnnexResponse</returns>
        ...
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfGetCreditSupportAnnexResponse> ListCreditSupportAnnexesWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ResourceListOfGetCreditSupportAnnexResponse>("/api/counterparties/counterparties/csa", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfGetCreditSupportAnnexResponse>> ListCreditSupportAnnexesWithHttpInfoAsync(DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResourceListOfGetCreditSupportAnnexResponse>("/api/counterparties/counterparties/csa", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// [EXPERIMENTAL] Upsert Counterparty. This creates or updates the data in Lusid. Update or insert Counterparty in a single scope. An item will be updated if it already exists and inserted if it does not.                The response will return the successfully updated or inserted Counterparty or failure message if unsuccessful                It is important to always check to verify success (or failure).
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="upsertCounterpartyRequest">The Counterparty to update or insert</param>
        /// <returns>UpsertSingleStructuredDataResponse</returns>
        public UpsertSingleStructuredDataResponse UpsertCounterparty(UpsertCounterpartyRequest upsertCounterpartyRequest)
        {
            Lusid.Sdk.Client.ApiResponse<UpsertSingleStructuredDataResponse> localVarResponse = UpsertCounterpartyWithHttpInfo(upsertCounterpartyRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="upsertCounterpartyRequest">The Counterparty to update or insert</param>
        /// <returns>ApiResponse of UpsertSingleStructuredDataResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<UpsertSingleStructuredDataResponse> UpsertCounterpartyWithHttpInfo(UpsertCounterpartyRequest upsertCounterpartyRequest)
        {
            // verify the required parameter 'upsertCounterpartyRequest' is set
            if (upsertCounterpartyRequest == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'upsertCounterpartyRequest' when calling CounterpartyApi->UpsertCounterparty");
            ...
            localVarRequestOptions.Data = upsertCounterpartyRequest;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<UpsertSingleStructuredDataResponse>("/api/counterparties/counterparties/counterparty", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("UpsertCounterparty", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UpsertSingleStructuredDataResponse</returns>
        public async System.Threading.Tasks.Task<UpsertSingleStructuredDataResponse> UpsertCounterpartyAsync(UpsertCounterpartyRequest upsertCounterpartyRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<UpsertSingleStructuredDataResponse> localVarResponse = await UpsertCounterpartyWithHttpInfoAsync(upsertCounterpartyRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UpsertSingleStructuredDataResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<UpsertSingleStructuredDataResponse>> UpsertCounterpartyWithHttpInfoAsync(UpsertCounterpartyRequest upsertCounterpartyRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'upsertCounterpartyRequest' is set
            if (upsertCounterpartyRequest == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'upsertCounterpartyRequest' when calling CounterpartyApi->UpsertCounterparty");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<UpsertSingleStructuredDataResponse>("/api/counterparties/counterparties/counterparty", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// [EXPERIMENTAL] Upsert CSA. This creates or updates the data in Lusid. Update or insert CSA in a single scope. An item will be updated if it already exists and inserted if it does not.                The response will return the successfully updated or inserted CSA or failure message if unsuccessful                It is important to always check to verify success (or failure).
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="upsertCreditSupportAnnexRequest">The CSA to update or insert</param>
        /// <returns>UpsertSingleStructuredDataResponse</returns>
        ...
        public Lusid.Sdk.Client.ApiResponse<UpsertSingleStructuredDataResponse> UpsertCreditSupportAnnexWithHttpInfo(UpsertCreditSupportAnnexRequest upsertCreditSupportAnnexRequest)
        {
            ...
            if (upsertCreditSupportAnnexRequest == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'upsertCreditSupportAnnexRequest' when calling CounterpartyApi->UpsertCreditSupportAnnex");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<UpsertSingleStructuredDataResponse>("/api/counterparties/counterparties/csa", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<UpsertSingleStructuredDataResponse>> UpsertCreditSupportAnnexWithHttpInfoAsync(UpsertCreditSupportAnnexRequest upsertCreditSupportAnnexRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<UpsertSingleStructuredDataResponse>("/api/counterparties/counterparties/csa", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
