...
namespace Lusid.Sdk.Api
{
    ...
    public interface ICounterpartyApi : IApiAccessor
    {
        ...
        ApiResponse<GetCounterpartyResponse> GetCounterpartyWithHttpInfo (string scope, string code, DateTimeOffset? asAt = null);
        /// <summary>
        ...
        ApiResponse<ResourceListOfGetCounterpartyResponse> ListCounterpartiesWithHttpInfo (DateTimeOffset? asAt = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<AnnulSingleStructuredDataResponse> DeleteCounterpartyAsync (string scope, string code);
        ...
        System.Threading.Tasks.Task<ApiResponse<AnnulSingleStructuredDataResponse>> DeleteCounterpartyAsyncWithHttpInfo (string scope, string code);
        /// <summary>
        /// [EXPERIMENTAL] Delete the CSA of given scope and code, assuming that it is present.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GetCounterpartyResponse> GetCounterpartyAsync (string scope, string code, DateTimeOffset? asAt = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetCounterpartyResponse>> GetCounterpartyAsyncWithHttpInfo (string scope, string code, DateTimeOffset? asAt = null);
        /// <summary>
        /// [EXPERIMENTAL] Get CSA
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ResourceListOfGetCounterpartyResponse> ListCounterpartiesAsync (DateTimeOffset? asAt = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfGetCounterpartyResponse>> ListCounterpartiesAsyncWithHttpInfo (DateTimeOffset? asAt = null);
        /// <summary>
        /// [EXPERIMENTAL] List the set of CSAs
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<UpsertSingleStructuredDataResponse> UpsertCounterpartyAsync (UpsertCounterpartyRequest upsertCounterpartyRequest);
        ...
        System.Threading.Tasks.Task<ApiResponse<UpsertSingleStructuredDataResponse>> UpsertCounterpartyAsyncWithHttpInfo (UpsertCounterpartyRequest upsertCounterpartyRequest);
        /// <summary>
        /// [EXPERIMENTAL] Upsert CSA. This creates or updates the data in Lusid.
        /// </summary>
        /// <remarks>
    ...
    public partial class CounterpartyApi : ICounterpartyApi
    {
        ...
        /// <returns></returns>
        public CounterpartyApi(Lusid.Sdk.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<AnnulSingleStructuredDataResponse> localVarResponse = DeleteCounterpartyWithHttpInfo(scope, code);
        ...
        /// <param name="code">The Counterparty to delete.</param>
        /// <returns>ApiResponse of AnnulSingleStructuredDataResponse</returns>
        public ApiResponse< AnnulSingleStructuredDataResponse > DeleteCounterpartyWithHttpInfo (string scope, string code)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CounterpartyApi->DeleteCounterparty");
            // verify the required parameter 'code' is set
            if (code == null)
                throw new ApiException(400, "Missing required parameter 'code' when calling CounterpartyApi->DeleteCounterparty");

            var localVarPath = "./api/counterparties/counterparties/counterparty/{scope}/{code}";
            ...
            {
                Exception exception = ExceptionFactory("DeleteCounterparty", localVarResponse);
        ...
        /// <param name="code">The Counterparty to delete.</param>
        /// <returns>Task of AnnulSingleStructuredDataResponse</returns>
        public async System.Threading.Tasks.Task<AnnulSingleStructuredDataResponse> DeleteCounterpartyAsync (string scope, string code)
        {
             ApiResponse<AnnulSingleStructuredDataResponse> localVarResponse = await DeleteCounterpartyAsyncWithHttpInfo(scope, code);
             return localVarResponse.Data;
        ...
        /// <param name="code">The Counterparty to delete.</param>
        /// <returns>Task of ApiResponse (AnnulSingleStructuredDataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AnnulSingleStructuredDataResponse>> DeleteCounterpartyAsyncWithHttpInfo (string scope, string code)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CounterpartyApi->DeleteCounterparty");
        ...
        public ApiResponse< AnnulSingleStructuredDataResponse > DeleteCreditSupportAnnexWithHttpInfo (string scope, string code)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CounterpartyApi->DeleteCreditSupportAnnex");
            // verify the required parameter 'code' is set
            if (code == null)
                throw new ApiException(400, "Missing required parameter 'code' when calling CounterpartyApi->DeleteCreditSupportAnnex");

            var localVarPath = "./api/counterparties/counterparties/csa/{scope}/{code}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)</param>
        /// <returns>GetCounterpartyResponse</returns>
        public GetCounterpartyResponse GetCounterparty (string scope, string code, DateTimeOffset? asAt = null)
        {
             ApiResponse<GetCounterpartyResponse> localVarResponse = GetCounterpartyWithHttpInfo(scope, code, asAt);
             return localVarResponse.Data;
        }
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)</param>
        /// <returns>ApiResponse of GetCounterpartyResponse</returns>
        public ApiResponse< GetCounterpartyResponse > GetCounterpartyWithHttpInfo (string scope, string code, DateTimeOffset? asAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CounterpartyApi->GetCounterparty");
            // verify the required parameter 'code' is set
            if (code == null)
                throw new ApiException(400, "Missing required parameter 'code' when calling CounterpartyApi->GetCounterparty");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetCounterparty", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<GetCounterpartyResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (GetCounterpartyResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(GetCounterpartyResponse)));
        }
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)</param>
        /// <returns>Task of GetCounterpartyResponse</returns>
        public async System.Threading.Tasks.Task<GetCounterpartyResponse> GetCounterpartyAsync (string scope, string code, DateTimeOffset? asAt = null)
        {
             ApiResponse<GetCounterpartyResponse> localVarResponse = await GetCounterpartyAsyncWithHttpInfo(scope, code, asAt);
             return localVarResponse.Data;
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)</param>
        /// <returns>Task of ApiResponse (GetCounterpartyResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetCounterpartyResponse>> GetCounterpartyAsyncWithHttpInfo (string scope, string code, DateTimeOffset? asAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CounterpartyApi->GetCounterparty");
        ...
        public ApiResponse< GetCreditSupportAnnexResponse > GetCreditSupportAnnexWithHttpInfo (string scope, string code, DateTimeOffset? asAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CounterpartyApi->GetCreditSupportAnnex");
            // verify the required parameter 'code' is set
            if (code == null)
                throw new ApiException(400, "Missing required parameter 'code' when calling CounterpartyApi->GetCreditSupportAnnex");
        ...
        /// <param name="asAt">The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)</param>
        /// <returns>ResourceListOfGetCounterpartyResponse</returns>
        public ResourceListOfGetCounterpartyResponse ListCounterparties (DateTimeOffset? asAt = null)
        {
             ApiResponse<ResourceListOfGetCounterpartyResponse> localVarResponse = ListCounterpartiesWithHttpInfo(asAt);
             return localVarResponse.Data;
        }
        ...
        /// <param name="asAt">The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfGetCounterpartyResponse</returns>
        public ApiResponse< ResourceListOfGetCounterpartyResponse > ListCounterpartiesWithHttpInfo (DateTimeOffset? asAt = null)
        {

            var localVarPath = "./api/counterparties/counterparties/counterparty";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ListCounterparties", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<ResourceListOfGetCounterpartyResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (ResourceListOfGetCounterpartyResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ResourceListOfGetCounterpartyResponse)));
        }
        ...
        /// <param name="asAt">The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)</param>
        /// <returns>Task of ResourceListOfGetCounterpartyResponse</returns>
        public async System.Threading.Tasks.Task<ResourceListOfGetCounterpartyResponse> ListCounterpartiesAsync (DateTimeOffset? asAt = null)
        {
             ApiResponse<ResourceListOfGetCounterpartyResponse> localVarResponse = await ListCounterpartiesAsyncWithHttpInfo(asAt);
             return localVarResponse.Data;
        ...
        /// <param name="asAt">The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfGetCounterpartyResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfGetCounterpartyResponse>> ListCounterpartiesAsyncWithHttpInfo (DateTimeOffset? asAt = null)
        {
        ...
        public ApiResponse< ResourceListOfGetCreditSupportAnnexResponse > ListCreditSupportAnnexesWithHttpInfo (DateTimeOffset? asAt = null)
        {
            ...
            var localVarPath = "./api/counterparties/counterparties/csa";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        {
             ApiResponse<UpsertSingleStructuredDataResponse> localVarResponse = UpsertCounterpartyWithHttpInfo(upsertCounterpartyRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="upsertCounterpartyRequest">The Counterparty to update or insert</param>
        /// <returns>ApiResponse of UpsertSingleStructuredDataResponse</returns>
        public ApiResponse< UpsertSingleStructuredDataResponse > UpsertCounterpartyWithHttpInfo (UpsertCounterpartyRequest upsertCounterpartyRequest)
        {
            // verify the required parameter 'upsertCounterpartyRequest' is set
            if (upsertCounterpartyRequest == null)
                throw new ApiException(400, "Missing required parameter 'upsertCounterpartyRequest' when calling CounterpartyApi->UpsertCounterparty");
            ...
            if (upsertCounterpartyRequest != null && upsertCounterpartyRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(upsertCounterpartyRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = upsertCounterpartyRequest; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("UpsertCounterparty", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="upsertCounterpartyRequest">The Counterparty to update or insert</param>
        /// <returns>Task of UpsertSingleStructuredDataResponse</returns>
        public async System.Threading.Tasks.Task<UpsertSingleStructuredDataResponse> UpsertCounterpartyAsync (UpsertCounterpartyRequest upsertCounterpartyRequest)
        {
             ApiResponse<UpsertSingleStructuredDataResponse> localVarResponse = await UpsertCounterpartyAsyncWithHttpInfo(upsertCounterpartyRequest);
             return localVarResponse.Data;
        ...
        /// <param name="upsertCounterpartyRequest">The Counterparty to update or insert</param>
        /// <returns>Task of ApiResponse (UpsertSingleStructuredDataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpsertSingleStructuredDataResponse>> UpsertCounterpartyAsyncWithHttpInfo (UpsertCounterpartyRequest upsertCounterpartyRequest)
        {
            // verify the required parameter 'upsertCounterpartyRequest' is set
            if (upsertCounterpartyRequest == null)
                throw new ApiException(400, "Missing required parameter 'upsertCounterpartyRequest' when calling CounterpartyApi->UpsertCounterparty");
        ...
        public ApiResponse< UpsertSingleStructuredDataResponse > UpsertCreditSupportAnnexWithHttpInfo (UpsertCreditSupportAnnexRequest upsertCreditSupportAnnexRequest)
        {
            ...
            if (upsertCreditSupportAnnexRequest == null)
                throw new ApiException(400, "Missing required parameter 'upsertCreditSupportAnnexRequest' when calling CounterpartyApi->UpsertCreditSupportAnnex");
