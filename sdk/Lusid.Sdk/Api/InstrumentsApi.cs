...
namespace Lusid.Sdk.Api
{
    ...
    public partial class InstrumentsApi : IInstrumentsApi
    {
        ...
        /// <summary>
        /// [EARLY ACCESS] Delete instrument Attempt to delete one or more \&quot;client\&quot; instruments.    The response will include those instruments that could not be deleted (as well as any available details).                It is important to always check the &#39;Failed&#39; set for any unsuccessful results.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">The type of identifier being supplied</param>
        /// <param name="identifier">The instrument identifier</param>
        ...
        /// <summary>
        /// [EARLY ACCESS] Get instrument definition Get an individual instrument by the one of its unique instrument identifiers. Optionally, it is possible to decorate each instrument with specified property data.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">The type of identifier being supplied</param>
        /// <param name="identifier">The identifier of the requested instrument</param>
        ...
        /// <summary>
        /// [EARLY ACCESS] Get instrument definition Get a collection of instruments by a set of identifiers. Optionally, it is possible to decorate each instrument with specified property data.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">The type of identifiers being supplied</param>
        /// <param name="identifiers">The identifiers of the instruments to get</param>
        ...
        /// <summary>
        /// [EARLY ACCESS] Get all of the currently mastered instruments in LUSID Lists all instruments that have been mastered within LUSID.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="asAt">Optional. The AsAt time (optional)</param>
        /// <param name="effectiveAt">Optional. The effective date of the query (optional)</param>
        ...
        /// <summary>
        /// [EARLY ACCESS] Update instrument identifier Adds, updates, or removes an identifier on an instrument
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">The type of identifier being supplied</param>
        /// <param name="identifier">The instrument identifier</param>
        ...
        /// <summary>
        /// [EARLY ACCESS] Upsert instruments Attempt to master one or more instruments in LUSID&#39;s instrument master. Each instrument is keyed by some unique key. This key is unimportant, and serves only as a method to identify created instruments in the response.    The response will return both the collection of successfully created instruments, as well as those that were rejected and why their creation failed. They will be keyed against the key supplied in the  request.                It is important to always check the &#39;Failed&#39; set for any unsuccessful results.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="requests">The instrument definitions (optional)</param>
        /// <returns>UpsertInstrumentsResponse</returns>
        ...
        /// <summary>
        /// [EARLY ACCESS] Upsert instrument properties Attempt to upsert property data for one or more instruments, properties, and effective dates.    The response will include the details of any failures that occurred during data storage.                It is important to always check the &#39;Failed&#39; collection for any unsuccessful results.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="instrumentProperties">The instrument property data (optional)</param>
        /// <returns>UpsertInstrumentPropertiesResponse</returns>
