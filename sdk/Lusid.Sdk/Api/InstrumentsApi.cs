...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentsApiSync : IApiAccessor
    {
        ...
        /// <param name="deleteMode">The delete mode to use, currently only &#39;soft&#39; is supported, if left unspecified, this argument is optional. (optional)</param>
        /// <param name="scope">The scope in which the instrument lies. When not supplied the scope is &#39;default&#39;. (optional, default to &quot;default&quot;)</param>
        ...
        /// <param name="recipeScope">The scope of the valuation recipe being used to generate the payment diary (optional)</param>
        /// <param name="recipeCode">The code of the valuation recipe being used to generate the payment diary (optional)</param>
        ...
        InstrumentPaymentDiary GetInstrumentPaymentDiary(string identifierType, string identifier, string recipeScope = default(string), string recipeCode = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string scope = default(string));
        ...
        ApiResponse<InstrumentPaymentDiary> GetInstrumentPaymentDiaryWithHttpInfo(string identifierType, string identifier, string recipeScope = default(string), string recipeCode = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string scope = default(string));
        /// <summary>
    ...
    public interface IInstrumentsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<InstrumentPaymentDiary>> GetInstrumentPaymentDiaryWithHttpInfoAsync(string identifierType, string identifier, string recipeScope = default(string), string recipeCode = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string scope = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] GetInstrumentProperties: Get instrument properties
        /// </summary>
        /// <remarks>
    ...
    public partial class InstrumentsApi : IInstrumentsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] DeleteInstruments: Deletes multiple instruments from a set of specified LusidInstrumentId strings Deletes a number of specified instruments (limited to 2000), as identified by LusidInstrumentId identifiers.                For soft deletion, once deleted, an instrument is marked as inactive and can no longer be referenced when creating or updating  transactions or holdings. You can still query existing transactions and holdings related to the  deleted instrument.                For Hard delete; with the same behaviour as above, in addition:      (i)     all identifiers are removed      (ii)    the instrument is marked with a state of &#39;Deleted&#39;,      (iii)   the instrument name is pre-pended with &#39;DELETED &#39;      (iv)    the instrument will not be returned by ListInstruments  The maximum number of instruments that this method can delete per request is 2,000.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="requestBody">The list of lusidInstrumentId&#39;s to delete.</param>
        /// <param name="deleteMode">The delete mode to use, currently only &#39;soft&#39; is supported, if left unspecified, this argument is optional. (optional)</param>
        ...
        /// <param name="scope">The scope in which the instrument lies. When not supplied the scope is &#39;default&#39;. (optional, default to &quot;default&quot;)</param>
        /// <returns>InstrumentPaymentDiary</returns>
        public InstrumentPaymentDiary GetInstrumentPaymentDiary(string identifierType, string identifier, string recipeScope = default(string), string recipeCode = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string scope = default(string))
        {
        ...
        /// <param name="scope">The scope in which the instrument lies. When not supplied the scope is &#39;default&#39;. (optional, default to &quot;default&quot;)</param>
        /// <returns>ApiResponse of InstrumentPaymentDiary</returns>
        public Lusid.Sdk.Client.ApiResponse<InstrumentPaymentDiary> GetInstrumentPaymentDiaryWithHttpInfo(string identifierType, string identifier, string recipeScope = default(string), string recipeCode = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string scope = default(string))
        {
            // verify the required parameter 'identifierType' is set
            if (identifierType == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InstrumentPaymentDiary)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<InstrumentPaymentDiary>> GetInstrumentPaymentDiaryWithHttpInfoAsync(string identifierType, string identifier, string recipeScope = default(string), string recipeCode = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string scope = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'identifierType' is set
            if (identifierType == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'identifierType' when calling InstrumentsApi->GetInstrumentPaymentDiary");
        ...
        /// <summary>
        /// [EXPERIMENTAL] GetInstrumentRelationships: Get Instrument relationships Get relationships for a particular Instrument.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">An identifier type attached to the Instrument.</param>
        /// <param name="identifier">The identifier value.</param>
