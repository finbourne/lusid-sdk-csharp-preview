...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentsApi : IApiAccessor
    {
        ...
        /// <param name="identifierType">The identifier type of the instrument, e.g., \&quot;Figi\&quot;</param>
        /// <param name="identifier">The value of the identifier for the requested instrument.</param>
        /// <param name="propertyKey">The property key of the property that will have its history shown. These must be in the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot;.              Each property must be from the \&quot;Instrument\&quot; domain. (optional)</param>
        /// <param name="identifierEffectiveAt">The effective datetime used to resolve the instrument from the provided identifier. Defaults to the current LUSID system datetime if not specified. (optional)</param>
    ...
    public partial class InstrumentsApi : IInstrumentsApi
    {
        ...
        /// <summary>
        /// [EARLY ACCESS] Get the time series of an instrument property List the complete time series of an instrument property.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">The identifier type of the instrument, e.g., \&quot;Figi\&quot;</param>
        /// <param name="identifier">The value of the identifier for the requested instrument.</param>
