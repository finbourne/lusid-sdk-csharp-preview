...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentsApi : IApiAccessor
    {
        ...
        /// <param name="instruments">The definitions of the instruments to update or insert.</param>
        /// <returns>UpsertInstrumentsResponse</returns>
        UpsertInstrumentsResponse UpsertLusidInstruments (Dictionary<string, LusidInstrumentDefinition> instruments);
        ...
        /// <param name="instruments">The definitions of the instruments to update or insert.</param>
        /// <returns>ApiResponse of UpsertInstrumentsResponse</returns>
        ApiResponse<UpsertInstrumentsResponse> UpsertLusidInstrumentsWithHttpInfo (Dictionary<string, LusidInstrumentDefinition> instruments);
        ...
        /// <param name="instruments">The definitions of the instruments to update or insert.</param>
        /// <returns>Task of UpsertInstrumentsResponse</returns>
        System.Threading.Tasks.Task<UpsertInstrumentsResponse> UpsertLusidInstrumentsAsync (Dictionary<string, LusidInstrumentDefinition> instruments);
        ...
        /// <param name="instruments">The definitions of the instruments to update or insert.</param>
        /// <returns>Task of ApiResponse (UpsertInstrumentsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<UpsertInstrumentsResponse>> UpsertLusidInstrumentsAsyncWithHttpInfo (Dictionary<string, LusidInstrumentDefinition> instruments);
    ...
    public partial class InstrumentsApi : IInstrumentsApi
    {
        ...
        /// <param name="instruments">The definitions of the instruments to update or insert.</param>
        /// <returns>UpsertInstrumentsResponse</returns>
        public UpsertInstrumentsResponse UpsertLusidInstruments (Dictionary<string, LusidInstrumentDefinition> instruments)
        {
             ApiResponse<UpsertInstrumentsResponse> localVarResponse = UpsertLusidInstrumentsWithHttpInfo(instruments);
             return localVarResponse.Data;
        }
        ...
        /// <param name="instruments">The definitions of the instruments to update or insert.</param>
        /// <returns>ApiResponse of UpsertInstrumentsResponse</returns>
        public ApiResponse< UpsertInstrumentsResponse > UpsertLusidInstrumentsWithHttpInfo (Dictionary<string, LusidInstrumentDefinition> instruments)
        {
            // verify the required parameter 'instruments' is set
            if (instruments == null)
                throw new ApiException(400, "Missing required parameter 'instruments' when calling InstrumentsApi->UpsertLusidInstruments");
        ...
        /// <param name="instruments">The definitions of the instruments to update or insert.</param>
        /// <returns>Task of UpsertInstrumentsResponse</returns>
        public async System.Threading.Tasks.Task<UpsertInstrumentsResponse> UpsertLusidInstrumentsAsync (Dictionary<string, LusidInstrumentDefinition> instruments)
        {
             ApiResponse<UpsertInstrumentsResponse> localVarResponse = await UpsertLusidInstrumentsAsyncWithHttpInfo(instruments);
             return localVarResponse.Data;
        ...
        /// <param name="instruments">The definitions of the instruments to update or insert.</param>
        /// <returns>Task of ApiResponse (UpsertInstrumentsResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpsertInstrumentsResponse>> UpsertLusidInstrumentsAsyncWithHttpInfo (Dictionary<string, LusidInstrumentDefinition> instruments)
        {
            // verify the required parameter 'instruments' is set
            if (instruments == null)
                throw new ApiException(400, "Missing required parameter 'instruments' when calling InstrumentsApi->UpsertLusidInstruments");
