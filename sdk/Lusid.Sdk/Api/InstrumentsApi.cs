...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentsApiSync : IApiAccessor
    {
        ...
        InstrumentCapabilities GetInstrumentCapabilities(string identifier, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string instrumentScope = default(string), string recipeScope = default(string), string recipeCode = default(string));
        ...
        /// <param name="recipeCode">A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided. (optional)</param>
        /// <returns>InstrumentCapabilities</returns>
        InstrumentCapabilities PostInstrumentCapabilities(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string recipeScope = default(string), string recipeCode = default(string));
        ...
        /// <param name="recipeCode">A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided. (optional)</param>
        /// <returns>ApiResponse of InstrumentCapabilities</returns>
        ApiResponse<InstrumentCapabilities> PostInstrumentCapabilitiesWithHttpInfo(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string recipeScope = default(string), string recipeCode = default(string));
        /// <summary>
    ...
    public interface IInstrumentsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<InstrumentCapabilities>> GetInstrumentCapabilitiesWithHttpInfoAsync(string identifier, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string instrumentScope = default(string), string recipeScope = default(string), string recipeCode = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// GetInstrumentIdentifierTypes: Get instrument identifier types
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstrumentCapabilities</returns>
        System.Threading.Tasks.Task<InstrumentCapabilities> PostInstrumentCapabilitiesAsync(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string recipeScope = default(string), string recipeCode = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InstrumentCapabilities)</returns>
        System.Threading.Tasks.Task<ApiResponse<InstrumentCapabilities>> PostInstrumentCapabilitiesWithHttpInfoAsync(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string recipeScope = default(string), string recipeCode = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// UpdateInstrumentIdentifier: Update instrument identifier
        /// </summary>
        /// <remarks>
    ...
    public partial class InstrumentsApi : IInstrumentsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] GetInstrumentCapabilities: Given an lusid instrument id provides instrument capabilities, outlining features, and, given the model, the capabilities also include supported addresses as well as economic dependencies. Returns instrument capabilities containing useful information about the instrument and the model. This includes  - features corresponding to the instrument e.g. Optionality:American, Other:InflationLinked  - supported addresses (if model provided) e.g. Valuation/Pv, Valuation/DirtyPriceKey, Valuation/Accrued  - economic dependencies (if model provided) e.g. Cash:USD, Fx:GBP.USD, Rates:GBP.GBPOIS
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifier">A lusid instrument id identifying the instrument.</param>
        /// <param name="model">A pricing model for the instrument. Defaults to Unknown if not specified. If not specified the SupportedAddresses and EconomicDependencies are not provided. (optional)</param>
        ...
        /// <param name="recipeCode">A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided. (optional)</param>
        /// <returns>InstrumentCapabilities</returns>
        public InstrumentCapabilities GetInstrumentCapabilities(string identifier, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string instrumentScope = default(string), string recipeScope = default(string), string recipeCode = default(string))
        {
            Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities> localVarResponse = GetInstrumentCapabilitiesWithHttpInfo(identifier, model, effectiveAt, asAt, instrumentScope, recipeScope, recipeCode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="recipeCode">A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided. (optional)</param>
        /// <returns>ApiResponse of InstrumentCapabilities</returns>
        public Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities> GetInstrumentCapabilitiesWithHttpInfo(string identifier, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string instrumentScope = default(string), string recipeScope = default(string), string recipeCode = default(string))
        {
            // verify the required parameter 'identifier' is set
            if (identifier == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'identifier' when calling InstrumentsApi->GetInstrumentCapabilities");
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetInstrumentCapabilities", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstrumentCapabilities</returns>
        public async System.Threading.Tasks.Task<InstrumentCapabilities> GetInstrumentCapabilitiesAsync(string identifier, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string instrumentScope = default(string), string recipeScope = default(string), string recipeCode = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities> localVarResponse = await GetInstrumentCapabilitiesWithHttpInfoAsync(identifier, model, effectiveAt, asAt, instrumentScope, recipeScope, recipeCode, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InstrumentCapabilities)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities>> GetInstrumentCapabilitiesWithHttpInfoAsync(string identifier, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string instrumentScope = default(string), string recipeScope = default(string), string recipeCode = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'identifier' is set
            if (identifier == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'identifier' when calling InstrumentsApi->GetInstrumentCapabilities");
        ...
        /// <summary>
        /// [EXPERIMENTAL] GetInstrumentProperties: Get instrument properties List all the properties of a particular instrument, as identified by a particular unique identifier.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">The unique identifier type to search, for example &#39;Figi&#39;.</param>
        /// <param name="identifier">An &lt;i&gt;identifierType&lt;/i&gt; value to use to identify the instrument, for example &#39;BBG000BLNNV0&#39;.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] ListInstrumentProperties: Get instrument properties (with Pagination) List all the properties of a particular instrument, as identified by a particular unique identifier.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">The unique identifier type to search, for example &#39;Figi&#39;.</param>
        /// <param name="identifier">An &lt;i&gt;identifierType&lt;/i&gt; value to use to identify the instrument, for example &#39;BBG000BLNNV0&#39;.</param>
        ...
        /// <param name="recipeCode">A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided. (optional)</param>
        /// <returns>InstrumentCapabilities</returns>
        public InstrumentCapabilities PostInstrumentCapabilities(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string recipeScope = default(string), string recipeCode = default(string))
        {
            Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities> localVarResponse = PostInstrumentCapabilitiesWithHttpInfo(lusidInstrument, model, effectiveAt, recipeScope, recipeCode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="recipeCode">A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided. (optional)</param>
        /// <returns>ApiResponse of InstrumentCapabilities</returns>
        public Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities> PostInstrumentCapabilitiesWithHttpInfo(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string recipeScope = default(string), string recipeCode = default(string))
        {
            // verify the required parameter 'lusidInstrument' is set
            if (lusidInstrument == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'lusidInstrument' when calling InstrumentsApi->PostInstrumentCapabilities");
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostInstrumentCapabilities", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstrumentCapabilities</returns>
        public async System.Threading.Tasks.Task<InstrumentCapabilities> PostInstrumentCapabilitiesAsync(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string recipeScope = default(string), string recipeCode = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities> localVarResponse = await PostInstrumentCapabilitiesWithHttpInfoAsync(lusidInstrument, model, effectiveAt, recipeScope, recipeCode, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InstrumentCapabilities)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities>> PostInstrumentCapabilitiesWithHttpInfoAsync(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string recipeScope = default(string), string recipeCode = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'lusidInstrument' is set
            if (lusidInstrument == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'lusidInstrument' when calling InstrumentsApi->PostInstrumentCapabilities");
