...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentsApiSync : IApiAccessor
    {
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which to retrieve the instrument.              Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>InstrumentCapabilities</returns>
        InstrumentCapabilities PostInstrumentCapabilities(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which to retrieve the instrument.              Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>ApiResponse of InstrumentCapabilities</returns>
        ApiResponse<InstrumentCapabilities> PostInstrumentCapabilitiesWithHttpInfo(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        /// <summary>
    ...
    public interface IInstrumentsApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstrumentCapabilities</returns>
        System.Threading.Tasks.Task<InstrumentCapabilities> PostInstrumentCapabilitiesAsync(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class InstrumentsApi : IInstrumentsApi
    {
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which to retrieve the instrument.              Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>InstrumentCapabilities</returns>
        public InstrumentCapabilities PostInstrumentCapabilities(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities> localVarResponse = PostInstrumentCapabilitiesWithHttpInfo(lusidInstrument, model, effectiveAt);
            return localVarResponse.Data;
        }
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which to retrieve the instrument.              Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>ApiResponse of InstrumentCapabilities</returns>
        public Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities> PostInstrumentCapabilitiesWithHttpInfo(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities> localVarResponse = await PostInstrumentCapabilitiesWithHttpInfoAsync(lusidInstrument, model, effectiveAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
