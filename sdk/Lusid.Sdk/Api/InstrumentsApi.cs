...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentsApiSync : IApiAccessor
    {
        ...
        /// <param name="recipeCode">A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided. (optional)</param>
        /// <returns>InstrumentCapabilities</returns>
        InstrumentCapabilities QueryInstrumentCapabilities(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string recipeScope = default(string), string recipeCode = default(string));
        ...
        /// <param name="recipeCode">A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided. (optional)</param>
        /// <returns>ApiResponse of InstrumentCapabilities</returns>
        ApiResponse<InstrumentCapabilities> QueryInstrumentCapabilitiesWithHttpInfo(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string recipeScope = default(string), string recipeCode = default(string));
        /// <summary>
    ...
    public partial class InstrumentsApi : IInstrumentsApi
    {
        ...
        /// <param name="recipeCode">A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided. (optional)</param>
        /// <returns>InstrumentCapabilities</returns>
        public InstrumentCapabilities QueryInstrumentCapabilities(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string recipeScope = default(string), string recipeCode = default(string))
        {
            Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities> localVarResponse = QueryInstrumentCapabilitiesWithHttpInfo(lusidInstrument, model, effectiveAt, recipeScope, recipeCode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="recipeCode">A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided. (optional)</param>
        /// <returns>ApiResponse of InstrumentCapabilities</returns>
        public Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities> QueryInstrumentCapabilitiesWithHttpInfo(LusidInstrument lusidInstrument, string model = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string recipeScope = default(string), string recipeCode = default(string))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<InstrumentCapabilities> localVarResponse = await QueryInstrumentCapabilitiesWithHttpInfoAsync(lusidInstrument, model, effectiveAt, recipeScope, recipeCode, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
