...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentsApiSync : IApiAccessor
    {
        ...
        DeleteInstrumentPropertiesResponse DeleteInstrumentProperties(string identifierType, string identifier, List<string> requestBody, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        ...
        ApiResponse<DeleteInstrumentPropertiesResponse> DeleteInstrumentPropertiesWithHttpInfo(string identifierType, string identifier, List<string> requestBody, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        /// <summary>
        ...
        InstrumentProperties GetInstrumentProperties(string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?));
        ...
        ApiResponse<InstrumentProperties> GetInstrumentPropertiesWithHttpInfo(string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?));
        /// <summary>
        ...
        ResourceListOfPropertyInterval GetInstrumentPropertyTimeSeries(string identifierType, string identifier, string propertyKey, string identifierEffectiveAt = default(string), DateTimeOffset? asAt = default(DateTimeOffset?), string filter = default(string), string page = default(string), int? limit = default(int?));
        ...
        ResourceListOfProperty ListInstrumentProperties(string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?));
        ...
        ApiResponse<ResourceListOfProperty> ListInstrumentPropertiesWithHttpInfo(string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?));
        /// <summary>
    ...
    public partial class InstrumentsApi : IInstrumentsApi
    {
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which to delete time-variant properties from.              The property must exist at the specified &#39;effectiveAt&#39; datetime. If the &#39;effectiveAt&#39; is not provided or is              before the time-variant property exists then a failure is returned. Do not specify this parameter if any of              the properties to delete are perpetual. (optional)</param>
        /// <returns>DeleteInstrumentPropertiesResponse</returns>
        public DeleteInstrumentPropertiesResponse DeleteInstrumentProperties(string identifierType, string identifier, List<string> requestBody, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            Lusid.Sdk.Client.ApiResponse<DeleteInstrumentPropertiesResponse> localVarResponse = DeleteInstrumentPropertiesWithHttpInfo(identifierType, identifier, requestBody, effectiveAt);
            return localVarResponse.Data;
        }
        ...
        /// <param name="effectiveAt">The effective datetime or cut label at which to delete time-variant properties from.              The property must exist at the specified &#39;effectiveAt&#39; datetime. If the &#39;effectiveAt&#39; is not provided or is              before the time-variant property exists then a failure is returned. Do not specify this parameter if any of              the properties to delete are perpetual. (optional)</param>
        /// <returns>ApiResponse of DeleteInstrumentPropertiesResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<DeleteInstrumentPropertiesResponse> DeleteInstrumentPropertiesWithHttpInfo(string identifierType, string identifier, List<string> requestBody, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            // verify the required parameter 'identifierType' is set
            if (identifierType == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<DeleteInstrumentPropertiesResponse> localVarResponse = await DeleteInstrumentPropertiesWithHttpInfoAsync(identifierType, identifier, requestBody, effectiveAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="asAt">The asAt datetime at which to list the instrument&#39;s properties. Defaults to returning              the latest version of each property if not specified. (optional)</param>
        /// <returns>InstrumentProperties</returns>
        public InstrumentProperties GetInstrumentProperties(string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            Lusid.Sdk.Client.ApiResponse<InstrumentProperties> localVarResponse = GetInstrumentPropertiesWithHttpInfo(identifierType, identifier, effectiveAt, asAt);
            return localVarResponse.Data;
        }
        ...
        /// <param name="asAt">The asAt datetime at which to list the instrument&#39;s properties. Defaults to returning              the latest version of each property if not specified. (optional)</param>
        /// <returns>ApiResponse of InstrumentProperties</returns>
        public Lusid.Sdk.Client.ApiResponse<InstrumentProperties> GetInstrumentPropertiesWithHttpInfo(string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            // verify the required parameter 'identifierType' is set
            if (identifierType == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<InstrumentProperties> localVarResponse = await GetInstrumentPropertiesWithHttpInfoAsync(identifierType, identifier, effectiveAt, asAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="limit">When paginating, limit the results to this number. (optional)</param>
        /// <returns>ResourceListOfPropertyInterval</returns>
        public ResourceListOfPropertyInterval GetInstrumentPropertyTimeSeries(string identifierType, string identifier, string propertyKey, string identifierEffectiveAt = default(string), DateTimeOffset? asAt = default(DateTimeOffset?), string filter = default(string), string page = default(string), int? limit = default(int?))
        {
        ...
        /// <param name="limit">When paginating, limit the results per page to this number. (optional)</param>
        /// <returns>ResourceListOfProperty</returns>
        public ResourceListOfProperty ListInstrumentProperties(string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?))
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfProperty> localVarResponse = ListInstrumentPropertiesWithHttpInfo(identifierType, identifier, effectiveAt, asAt, page, limit);
            return localVarResponse.Data;
        }
        ...
        /// <param name="limit">When paginating, limit the results per page to this number. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfProperty</returns>
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfProperty> ListInstrumentPropertiesWithHttpInfo(string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?))
        {
            // verify the required parameter 'identifierType' is set
            if (identifierType == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfProperty> localVarResponse = await ListInstrumentPropertiesWithHttpInfoAsync(identifierType, identifier, effectiveAt, asAt, page, limit, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
