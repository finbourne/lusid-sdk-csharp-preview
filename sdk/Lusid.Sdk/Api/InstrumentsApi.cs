...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentsApiSync : IApiAccessor
    {
        ...
        /// <param name="propertyKeys">The property keys of the properties to be deleted from the instrument. Only properties in the  Finbourne.WebApi.Interface.Dto.PropertyDomain.Instrument domain can be supplied.</param>
    ...
    public interface IInstrumentsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<PagedResourceListOfInstrument>> ListInstrumentsAsyncWithHttpInfo (DateTimeOffset? asAt = default(DateTimeOffset?), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string page = default(string), List<string> sortBy = default(List<string>), int? start = default(int?), int? limit = default(int?), string filter = default(string), List<string> instrumentPropertyKeys = default(List<string>));
        /// <summary>
        /// [EARLY ACCESS] Update instrument identifier
        /// </summary>
        /// <remarks>
    ...
    public partial class InstrumentsApi : IInstrumentsApi
    {
        ...
        {
             Lusid.Sdk.Client.ApiResponse<PagedResourceListOfInstrument> localVarResponse = await ListInstrumentsAsyncWithHttpInfo(asAt, effectiveAt, page, sortBy, start, limit, filter, instrumentPropertyKeys);
             return localVarResponse.Data;
        ...
        /// <param name="instrumentPropertyKeys">A list of property keys from the \&quot;Instrument\&quot; domain to decorate onto each instrument. These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot;. (optional)</param>
        /// <returns>Task of ApiResponse (PagedResourceListOfInstrument)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<PagedResourceListOfInstrument>> ListInstrumentsAsyncWithHttpInfo (DateTimeOffset? asAt = default(DateTimeOffset?), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string page = default(string), List<string> sortBy = default(List<string>), int? start = default(int?), int? limit = default(int?), string filter = default(string), List<string> instrumentPropertyKeys = default(List<string>))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PagedResourceListOfInstrument>("/api/instruments", localVarRequestOptions, this.Configuration);
