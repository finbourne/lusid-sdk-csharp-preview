...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentsApi : IApiAccessor
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get the time series of an instrument property
        /// </summary>
        /// <remarks>
        ...
        /// <param name="identifierType">The identifier type of the instrument, e.g., \&quot;Figi\&quot;</param>
        /// <param name="identifier">The identifier of the instrument to delete properties from.</param>
        /// <param name="propertyKey">The property key of the property that will have its history shown. (optional)</param>
        /// <param name="identifierEffectiveAt">The effective datetime at which to list the property history. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <param name="asAt">The asAt datetime at which to list the instrument&#39;s property history. Defaults to return the current datetime if not supplied. (optional)</param>
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <param name="page">The pagination token to use to continue listing properties from a previous call to get property timeseries.              This value is returned from the previous call. If a pagination token is provided the filter, effectiveAt, and asAt fields              must not have changed since the original request. (optional)</param>
    ...
    public partial class InstrumentsApi : IInstrumentsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get instrument properties List all the properties of a single instrument.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">The identifier being supplied e.g. \&quot;Figi\&quot;.</param>
        /// <param name="identifier">The value of the identifier for the requested instrument.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get the time series of an instrument property List the complete time series of an instrument property, ordered by effective datetime.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">The identifier type of the instrument, e.g., \&quot;Figi\&quot;</param>
        /// <param name="identifier">The identifier of the instrument to delete properties from.</param>
        ...
        /// <summary>
        /// Upsert instruments properties Update or insert one or more instrument properties for one or more instruments. Each instrument property will be updated  if it already exists and inserted if it does not. If any properties fail to be updated or inserted, none will be updated or inserted and  the reason for the failure will be returned.                Properties have an &lt;i&gt;effectiveFrom&lt;/i&gt; datetime for which the property is valid, and an &lt;i&gt;effectiveUntil&lt;/i&gt;  datetime until which the property is valid. Not supplying an &lt;i&gt;effectiveUntil&lt;/i&gt; datetime results in the property being  valid indefinitely, or until the next &lt;i&gt;effectiveFrom&lt;/i&gt; datetime of the property.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="upsertInstrumentPropertyRequest">A collection of instruments and associated instrument properties to update or insert.</param>
        /// <returns>UpsertInstrumentPropertiesResponse</returns>
