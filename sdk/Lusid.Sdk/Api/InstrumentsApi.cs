...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentsApi : IApiAccessor
    {
        ...
        /// <param name="effectiveAt">The effective date to delete time-variant properties from. Do not specify this parameter              if any of the properties to delete are perpetual. (optional)</param>
        ...
        ApiResponse<InstrumentProperties> GetInstrumentPropertiesWithHttpInfo (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null);
        /// <summary>
        ...
        ApiResponse<ResourceListOfProperty> ListInstrumentPropertiesWithHttpInfo (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<InstrumentProperties> GetInstrumentPropertiesAsync (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<InstrumentProperties>> GetInstrumentPropertiesAsyncWithHttpInfo (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null);
        /// <summary>
        /// [EARLY ACCESS] Get instrument property time series
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ResourceListOfProperty> ListInstrumentPropertiesAsync (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfProperty>> ListInstrumentPropertiesAsyncWithHttpInfo (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null);
        /// <summary>
        /// [EARLY ACCESS] List instruments
        /// </summary>
        /// <remarks>
    ...
    public partial class InstrumentsApi : IInstrumentsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Delete instrument properties Delete a collection of properties from a particular instrument.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">The unique identifier type to search, for example &#39;Figi&#39;.</param>
        /// <param name="identifier">An &lt;i&gt;identifierType&lt;/i&gt; value to use to identify the instrument, for example &#39;BBG000BLNNV0&#39;.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get instrument properties List all the properties of a particular instrument, as identified by a particular unique identifier.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">The unique identifier type to search, for example &#39;Figi&#39;.</param>
        /// <param name="identifier">An &lt;i&gt;identifierType&lt;/i&gt; value to use to identify the instrument, for example &#39;BBG000BLNNV0&#39;.</param>
        ...
        /// <param name="asAt">The asAt datetime at which to list the instrument&#39;s properties. Defaults to returning              the latest version of each property if not specified. (optional)</param>
        /// <returns>InstrumentProperties</returns>
        public InstrumentProperties GetInstrumentProperties (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null)
        {
             ApiResponse<InstrumentProperties> localVarResponse = GetInstrumentPropertiesWithHttpInfo(identifierType, identifier, effectiveAt, asAt);
             return localVarResponse.Data;
        }
        ...
        /// <param name="asAt">The asAt datetime at which to list the instrument&#39;s properties. Defaults to returning              the latest version of each property if not specified. (optional)</param>
        /// <returns>ApiResponse of InstrumentProperties</returns>
        public ApiResponse< InstrumentProperties > GetInstrumentPropertiesWithHttpInfo (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null)
        {
            // verify the required parameter 'identifierType' is set
            if (identifierType == null)
                throw new ApiException(400, "Missing required parameter 'identifierType' when calling InstrumentsApi->GetInstrumentProperties");
            // verify the required parameter 'identifier' is set
            if (identifier == null)
                throw new ApiException(400, "Missing required parameter 'identifier' when calling InstrumentsApi->GetInstrumentProperties");

            var localVarPath = "./api/instruments/{identifierType}/{identifier}/properties";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetInstrumentProperties", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<InstrumentProperties>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (InstrumentProperties) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(InstrumentProperties)));
        }
        ...
        /// <param name="asAt">The asAt datetime at which to list the instrument&#39;s properties. Defaults to returning              the latest version of each property if not specified. (optional)</param>
        /// <returns>Task of InstrumentProperties</returns>
        public async System.Threading.Tasks.Task<InstrumentProperties> GetInstrumentPropertiesAsync (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null)
        {
             ApiResponse<InstrumentProperties> localVarResponse = await GetInstrumentPropertiesAsyncWithHttpInfo(identifierType, identifier, effectiveAt, asAt);
             return localVarResponse.Data;
        ...
        /// <param name="asAt">The asAt datetime at which to list the instrument&#39;s properties. Defaults to returning              the latest version of each property if not specified. (optional)</param>
        /// <returns>Task of ApiResponse (InstrumentProperties)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InstrumentProperties>> GetInstrumentPropertiesAsyncWithHttpInfo (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null)
        {
            // verify the required parameter 'identifierType' is set
            if (identifierType == null)
                throw new ApiException(400, "Missing required parameter 'identifierType' when calling InstrumentsApi->GetInstrumentProperties");
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get instrument properties (with Pagination) List all the properties of a particular instrument, as identified by a particular unique identifier.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="identifierType">The unique identifier type to search, for example &#39;Figi&#39;.</param>
        /// <param name="identifier">An &lt;i&gt;identifierType&lt;/i&gt; value to use to identify the instrument, for example &#39;BBG000BLNNV0&#39;.</param>
        ...
        /// <param name="limit">When paginating, limit the results per page to this number. (optional)</param>
        /// <returns>ResourceListOfProperty</returns>
        public ResourceListOfProperty ListInstrumentProperties (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null)
        {
             ApiResponse<ResourceListOfProperty> localVarResponse = ListInstrumentPropertiesWithHttpInfo(identifierType, identifier, effectiveAt, asAt, page, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">When paginating, limit the results per page to this number. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfProperty</returns>
        public ApiResponse< ResourceListOfProperty > ListInstrumentPropertiesWithHttpInfo (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null)
        {
            // verify the required parameter 'identifierType' is set
            if (identifierType == null)
                throw new ApiException(400, "Missing required parameter 'identifierType' when calling InstrumentsApi->ListInstrumentProperties");
            // verify the required parameter 'identifier' is set
            if (identifier == null)
                throw new ApiException(400, "Missing required parameter 'identifier' when calling InstrumentsApi->ListInstrumentProperties");

            var localVarPath = "./api/instruments/{identifierType}/{identifier}/properties/list";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ListInstrumentProperties", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<ResourceListOfProperty>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (ResourceListOfProperty) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ResourceListOfProperty)));
        }
        ...
        /// <param name="limit">When paginating, limit the results per page to this number. (optional)</param>
        /// <returns>Task of ResourceListOfProperty</returns>
        public async System.Threading.Tasks.Task<ResourceListOfProperty> ListInstrumentPropertiesAsync (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null)
        {
             ApiResponse<ResourceListOfProperty> localVarResponse = await ListInstrumentPropertiesAsyncWithHttpInfo(identifierType, identifier, effectiveAt, asAt, page, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">When paginating, limit the results per page to this number. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfProperty)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfProperty>> ListInstrumentPropertiesAsyncWithHttpInfo (string identifierType, string identifier, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string page = null, int? limit = null)
        {
            // verify the required parameter 'identifierType' is set
            if (identifierType == null)
                throw new ApiException(400, "Missing required parameter 'identifierType' when calling InstrumentsApi->ListInstrumentProperties");
