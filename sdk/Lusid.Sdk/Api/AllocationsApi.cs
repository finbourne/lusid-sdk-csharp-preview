...
namespace Lusid.Sdk.Api
{
    ...
    public interface IAllocationsApiSync : IApiAccessor
    {
        ...
        ResourceListOfAllocation UpsertAllocations (AllocationSetRequest request = default(AllocationSetRequest));
        ...
        ApiResponse<ResourceListOfAllocation> UpsertAllocationsWithHttpInfo (AllocationSetRequest request = default(AllocationSetRequest));
    ...
    public interface IAllocationsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Allocation> GetAllocationAsync (string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>));
        ...
        System.Threading.Tasks.Task<ApiResponse<Allocation>> GetAllocationAsyncWithHttpInfo (string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>));
        /// <summary>
        /// [EXPERIMENTAL] Fetch the last pre-AsAt date version of each allocation in scope (does not fetch the entire history).
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<PagedResourceListOfAllocation>> ListAllocationsAsyncWithHttpInfo (DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), List<string> sortBy = default(List<string>), int? start = default(int?), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>));
        /// <summary>
        /// [EXPERIMENTAL] Upsert; update existing allocations with given ids, or create new allocations otherwise.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ResourceListOfAllocation> UpsertAllocationsAsync (AllocationSetRequest request = default(AllocationSetRequest));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfAllocation>> UpsertAllocationsAsyncWithHttpInfo (AllocationSetRequest request = default(AllocationSetRequest));
    ...
    public partial class AllocationsApi : IAllocationsApi
    {
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Allocations\&quot; domain to decorate onto the allocation.              These take the format {domain}/{scope}/{code} e.g. \&quot;Allocations/system/Name\&quot;. (optional)</param>
        /// <returns>Task of Allocation</returns>
        public async System.Threading.Tasks.Task<Allocation> GetAllocationAsync (string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>))
        {
             Lusid.Sdk.Client.ApiResponse<Allocation> localVarResponse = await GetAllocationAsyncWithHttpInfo(scope, code, asAt, propertyKeys);
             return localVarResponse.Data;
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Allocations\&quot; domain to decorate onto the allocation.              These take the format {domain}/{scope}/{code} e.g. \&quot;Allocations/system/Name\&quot;. (optional)</param>
        /// <returns>Task of ApiResponse (Allocation)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<Allocation>> GetAllocationAsyncWithHttpInfo (string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling AllocationsApi->GetAllocation");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Allocation>("/api/allocations/{scope}/{code}", localVarRequestOptions, this.Configuration);
        ...
        {
             Lusid.Sdk.Client.ApiResponse<PagedResourceListOfAllocation> localVarResponse = await ListAllocationsAsyncWithHttpInfo(asAt, page, sortBy, start, limit, filter, propertyKeys);
             return localVarResponse.Data;
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<PagedResourceListOfAllocation>> ListAllocationsAsyncWithHttpInfo (DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), List<string> sortBy = default(List<string>), int? start = default(int?), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PagedResourceListOfAllocation>("/api/allocations", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="request">The collection of allocation requests. (optional)</param>
        /// <returns>ResourceListOfAllocation</returns>
        public ResourceListOfAllocation UpsertAllocations (AllocationSetRequest request = default(AllocationSetRequest))
        {
             Lusid.Sdk.Client.ApiResponse<ResourceListOfAllocation> localVarResponse = UpsertAllocationsWithHttpInfo(request);
             return localVarResponse.Data;
        }
        ...
        /// <param name="request">The collection of allocation requests. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfAllocation</returns>
        public Lusid.Sdk.Client.ApiResponse< ResourceListOfAllocation > UpsertAllocationsWithHttpInfo (AllocationSetRequest request = default(AllocationSetRequest))
        {
            Lusid.Sdk.Client.RequestOptions localVarRequestOptions = new Lusid.Sdk.Client.RequestOptions();
        ...
        /// <param name="request">The collection of allocation requests. (optional)</param>
        /// <returns>Task of ResourceListOfAllocation</returns>
        public async System.Threading.Tasks.Task<ResourceListOfAllocation> UpsertAllocationsAsync (AllocationSetRequest request = default(AllocationSetRequest))
        {
             Lusid.Sdk.Client.ApiResponse<ResourceListOfAllocation> localVarResponse = await UpsertAllocationsAsyncWithHttpInfo(request);
             return localVarResponse.Data;
        ...
        /// <param name="request">The collection of allocation requests. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfAllocation)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfAllocation>> UpsertAllocationsAsyncWithHttpInfo (AllocationSetRequest request = default(AllocationSetRequest))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<ResourceListOfAllocation>("/api/allocations", localVarRequestOptions, this.Configuration);
