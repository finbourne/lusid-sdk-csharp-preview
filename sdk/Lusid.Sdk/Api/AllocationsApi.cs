...
namespace Lusid.Sdk.Api
{
    ...
    public interface IAllocationsApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="resourceId">The IDs of the allocations to delete.</param>
        ...
        ApiResponse<DeletedOrdersEntitiesResponse> DeleteAllocationsWithHttpInfo (List<ResourceId> resourceId);
        /// <summary>
        ...
        System.Threading.Tasks.Task<DeletedOrdersEntitiesResponse> DeleteAllocationsAsync (List<ResourceId> resourceId);
        ...
        System.Threading.Tasks.Task<ApiResponse<DeletedOrdersEntitiesResponse>> DeleteAllocationsAsyncWithHttpInfo (List<ResourceId> resourceId);
        /// <summary>
        /// [EXPERIMENTAL] Get Allocation
        /// </summary>
        /// <remarks>
    ...
    public partial class AllocationsApi : IAllocationsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Delete allocation Delete an allocation. Deletion will be valid from the allocation&#39;s creation datetime.  This means that the allocation will no longer exist at any effective datetime from the asAt datetime of deletion.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The allocation scope.</param>
        /// <param name="code">The allocation&#39;s code. This, together with the scope uniquely identifies the allocation to delete.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Delete Allocations. Use this method to delete a collection of Allocations, each defined by ResourceId. Each delete will be attempted  independently, and the method will return lists of successful and failed attempts.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="resourceId">The IDs of the allocations to delete.</param>
        /// <returns>DeletedOrdersEntitiesResponse</returns>
        public DeletedOrdersEntitiesResponse DeleteAllocations (List<ResourceId> resourceId)
        {
             ApiResponse<DeletedOrdersEntitiesResponse> localVarResponse = DeleteAllocationsWithHttpInfo(resourceId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="resourceId">The IDs of the allocations to delete.</param>
        /// <returns>ApiResponse of DeletedOrdersEntitiesResponse</returns>
        public ApiResponse< DeletedOrdersEntitiesResponse > DeleteAllocationsWithHttpInfo (List<ResourceId> resourceId)
        {
            // verify the required parameter 'resourceId' is set
            if (resourceId == null)
                throw new ApiException(400, "Missing required parameter 'resourceId' when calling AllocationsApi->DeleteAllocations");

            var localVarPath = "./api/allocations/$delete";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DeleteAllocations", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="resourceId">The IDs of the allocations to delete.</param>
        /// <returns>Task of DeletedOrdersEntitiesResponse</returns>
        public async System.Threading.Tasks.Task<DeletedOrdersEntitiesResponse> DeleteAllocationsAsync (List<ResourceId> resourceId)
        {
             ApiResponse<DeletedOrdersEntitiesResponse> localVarResponse = await DeleteAllocationsAsyncWithHttpInfo(resourceId);
             return localVarResponse.Data;
        ...
        /// <param name="resourceId">The IDs of the allocations to delete.</param>
        /// <returns>Task of ApiResponse (DeletedOrdersEntitiesResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeletedOrdersEntitiesResponse>> DeleteAllocationsAsyncWithHttpInfo (List<ResourceId> resourceId)
        {
            // verify the required parameter 'resourceId' is set
            if (resourceId == null)
                throw new ApiException(400, "Missing required parameter 'resourceId' when calling AllocationsApi->DeleteAllocations");
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get Allocation Fetch an Allocation matching the provided identifier
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope to which the allocation belongs.</param>
        /// <param name="code">The allocation&#39;s unique identifier.</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] List Allocations Fetch the last pre-AsAt date version of each allocation in scope (does not fetch the entire history).
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="asAt">The asAt datetime at which to retrieve the allocation. Defaults to return the latest version of the allocation if not specified. (optional)</param>
        /// <param name="page">The pagination token to use to continue listing allocations from a previous call to list allocations.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Upsert Allocations Upsert; update existing allocations with given ids, or create new allocations otherwise.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="allocationSetRequest">The collection of allocation requests. (optional)</param>
        /// <returns>ResourceListOfAllocation</returns>
