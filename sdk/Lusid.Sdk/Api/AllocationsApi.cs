...
namespace Lusid.Sdk.Api
{
    ...
    public interface IAllocationsApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope to which the allocations belong.</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the allocation. Defaults to return the latest version of the allocation if not specified. (optional)</param>
        ...
        ApiResponse<PagedResourceListOfAllocation> ListAllocationsWithHttpInfo (string scope, DateTimeOffset? asAt = null, string page = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null);
        /// <summary>
        ...
        ApiResponse<ResourceListOfAllocation> UpsertAllocationsWithHttpInfo (string scope, AllocationSetRequest request = null);
        ...
        System.Threading.Tasks.Task<PagedResourceListOfAllocation> ListAllocationsAsync (string scope, DateTimeOffset? asAt = null, string page = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PagedResourceListOfAllocation>> ListAllocationsAsyncWithHttpInfo (string scope, DateTimeOffset? asAt = null, string page = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null);
        /// <summary>
        /// [EXPERIMENTAL] Upsert; update existing allocations with given ids, or create new allocations otherwise.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ResourceListOfAllocation> UpsertAllocationsAsync (string scope, AllocationSetRequest request = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfAllocation>> UpsertAllocationsAsyncWithHttpInfo (string scope, AllocationSetRequest request = null);
    ...
    public partial class AllocationsApi : IAllocationsApi
    {
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Allocations\&quot; domain to decorate onto each allocation.                  These take the format {domain}/{scope}/{code} e.g. \&quot;Allocations/system/Name\&quot;. (optional)</param>
        /// <returns>PagedResourceListOfAllocation</returns>
        public PagedResourceListOfAllocation ListAllocations (string scope, DateTimeOffset? asAt = null, string page = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null)
        {
             ApiResponse<PagedResourceListOfAllocation> localVarResponse = ListAllocationsWithHttpInfo(scope, asAt, page, sortBy, start, limit, filter, propertyKeys);
             return localVarResponse.Data;
        }
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Allocations\&quot; domain to decorate onto each allocation.                  These take the format {domain}/{scope}/{code} e.g. \&quot;Allocations/system/Name\&quot;. (optional)</param>
        /// <returns>ApiResponse of PagedResourceListOfAllocation</returns>
        public ApiResponse< PagedResourceListOfAllocation > ListAllocationsWithHttpInfo (string scope, DateTimeOffset? asAt = null, string page = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling AllocationsApi->ListAllocations");

            var localVarPath = "./api/allocations/{scope}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Allocations\&quot; domain to decorate onto each allocation.                  These take the format {domain}/{scope}/{code} e.g. \&quot;Allocations/system/Name\&quot;. (optional)</param>
        /// <returns>Task of PagedResourceListOfAllocation</returns>
        public async System.Threading.Tasks.Task<PagedResourceListOfAllocation> ListAllocationsAsync (string scope, DateTimeOffset? asAt = null, string page = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null)
        {
             ApiResponse<PagedResourceListOfAllocation> localVarResponse = await ListAllocationsAsyncWithHttpInfo(scope, asAt, page, sortBy, start, limit, filter, propertyKeys);
             return localVarResponse.Data;
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Allocations\&quot; domain to decorate onto each allocation.                  These take the format {domain}/{scope}/{code} e.g. \&quot;Allocations/system/Name\&quot;. (optional)</param>
        /// <returns>Task of ApiResponse (PagedResourceListOfAllocation)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PagedResourceListOfAllocation>> ListAllocationsAsyncWithHttpInfo (string scope, DateTimeOffset? asAt = null, string page = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null, List<string> propertyKeys = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling AllocationsApi->ListAllocations");
        ...
        /// <param name="request">The collection of allocation requests. (optional)</param>
        /// <returns>ResourceListOfAllocation</returns>
        public ResourceListOfAllocation UpsertAllocations (string scope, AllocationSetRequest request = null)
        {
             ApiResponse<ResourceListOfAllocation> localVarResponse = UpsertAllocationsWithHttpInfo(scope, request);
             return localVarResponse.Data;
        }
        ...
        /// <param name="request">The collection of allocation requests. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfAllocation</returns>
        public ApiResponse< ResourceListOfAllocation > UpsertAllocationsWithHttpInfo (string scope, AllocationSetRequest request = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling AllocationsApi->UpsertAllocations");
        ...
        /// <param name="request">The collection of allocation requests. (optional)</param>
        /// <returns>Task of ResourceListOfAllocation</returns>
        public async System.Threading.Tasks.Task<ResourceListOfAllocation> UpsertAllocationsAsync (string scope, AllocationSetRequest request = null)
        {
             ApiResponse<ResourceListOfAllocation> localVarResponse = await UpsertAllocationsAsyncWithHttpInfo(scope, request);
             return localVarResponse.Data;
        ...
        /// <param name="request">The collection of allocation requests. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfAllocation)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfAllocation>> UpsertAllocationsAsyncWithHttpInfo (string scope, AllocationSetRequest request = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling AllocationsApi->UpsertAllocations");
