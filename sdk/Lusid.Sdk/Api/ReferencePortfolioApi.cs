...
namespace Lusid.Sdk.Api
{
    ...
    public interface IReferencePortfolioApiSync : IApiAccessor
    {
        ...
        ApiResponse<UpsertReferencePortfolioConstituentPropertiesResponse> UpsertReferencePortfolioConstituentPropertiesWithHttpInfo(string scope, string code, UpsertReferencePortfolioConstituentPropertiesRequest upsertReferencePortfolioConstituentPropertiesRequest);
        /// <summary>
    ...
    public partial class ReferencePortfolioApi : IReferencePortfolioApi
    {
        ...
        /// <param name="upsertReferencePortfolioConstituentPropertiesRequest">The request to modify properties for the constituent.</param>
        /// <returns>UpsertReferencePortfolioConstituentPropertiesResponse</returns>
        public UpsertReferencePortfolioConstituentPropertiesResponse UpsertReferencePortfolioConstituentProperties(string scope, string code, UpsertReferencePortfolioConstituentPropertiesRequest upsertReferencePortfolioConstituentPropertiesRequest)
        {
            Lusid.Sdk.Client.ApiResponse<UpsertReferencePortfolioConstituentPropertiesResponse> localVarResponse = UpsertReferencePortfolioConstituentPropertiesWithHttpInfo(scope, code, upsertReferencePortfolioConstituentPropertiesRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="upsertReferencePortfolioConstituentPropertiesRequest">The request to modify properties for the constituent.</param>
        /// <returns>ApiResponse of UpsertReferencePortfolioConstituentPropertiesResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<UpsertReferencePortfolioConstituentPropertiesResponse> UpsertReferencePortfolioConstituentPropertiesWithHttpInfo(string scope, string code, UpsertReferencePortfolioConstituentPropertiesRequest upsertReferencePortfolioConstituentPropertiesRequest)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<UpsertReferencePortfolioConstituentPropertiesResponse> localVarResponse = await UpsertReferencePortfolioConstituentPropertiesWithHttpInfoAsync(scope, code, upsertReferencePortfolioConstituentPropertiesRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
