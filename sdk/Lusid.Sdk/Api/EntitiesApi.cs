...
namespace Lusid.Sdk.Api
{
    ...
    public interface IEntitiesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ResourceListOfChange> GetPortfolioChangesAsync (string scope, DateTimeOrCutLabel effectiveAt, DateTimeOffset? asAt = default(DateTimeOffset?));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfChange>> GetPortfolioChangesAsyncWithHttpInfo (string scope, DateTimeOrCutLabel effectiveAt, DateTimeOffset? asAt = default(DateTimeOffset?));
    ...
    public partial class EntitiesApi : IEntitiesApi
    {
        ...
        /// <summary>
        /// [BETA] Get the next change to each portfolio in a scope. Gets the time of the next (earliest effective at) modification (correction and/or amendment) to each portfolio in a scope relative to a point in bitemporal time.  Includes changes from parent portfolios in different scopes.  Excludes changes from subcriptions (e.g corporate actions).
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope</param>
        /// <param name="effectiveAt">The effective date of the origin.</param>
        ...
        /// <param name="asAt">The as-at date of the origin. (optional)</param>
        /// <returns>Task of ResourceListOfChange</returns>
        public async System.Threading.Tasks.Task<ResourceListOfChange> GetPortfolioChangesAsync (string scope, DateTimeOrCutLabel effectiveAt, DateTimeOffset? asAt = default(DateTimeOffset?))
        {
             Lusid.Sdk.Client.ApiResponse<ResourceListOfChange> localVarResponse = await GetPortfolioChangesAsyncWithHttpInfo(scope, effectiveAt, asAt);
             return localVarResponse.Data;
        ...
        /// <param name="asAt">The as-at date of the origin. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfChange)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfChange>> GetPortfolioChangesAsyncWithHttpInfo (string scope, DateTimeOrCutLabel effectiveAt, DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling EntitiesApi->GetPortfolioChanges");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResourceListOfChange>("/api/entities/changes/portfolios", localVarRequestOptions, this.Configuration);
