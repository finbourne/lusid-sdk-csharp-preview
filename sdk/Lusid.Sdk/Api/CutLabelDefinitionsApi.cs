...
namespace Lusid.Sdk.Api
{
    ...
    public interface ICutLabelDefinitionsApiSync : IApiAccessor
    {
        ...
        PagedResourceListOfCutLabelDefinition ListCutLabelDefinitions(DateTimeOffset? asAt = default(DateTimeOffset?), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), string page = default(string));
        ...
        ApiResponse<PagedResourceListOfCutLabelDefinition> ListCutLabelDefinitionsWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), string page = default(string));
        /// <summary>
    ...
    public partial class CutLabelDefinitionsApi : ICutLabelDefinitionsApi
    {
        ...
        /// <param name="page">The pagination token to use to continue listing cut labels from a previous call This value is returned from the previous call.  If a pagination token is provided the sortBy, filter, and asAt fields  must not have changed since the original request. (optional)</param>
        /// <returns>PagedResourceListOfCutLabelDefinition</returns>
        public PagedResourceListOfCutLabelDefinition ListCutLabelDefinitions(DateTimeOffset? asAt = default(DateTimeOffset?), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), string page = default(string))
        {
        ...
        /// <param name="page">The pagination token to use to continue listing cut labels from a previous call This value is returned from the previous call.  If a pagination token is provided the sortBy, filter, and asAt fields  must not have changed since the original request. (optional)</param>
        /// <returns>ApiResponse of PagedResourceListOfCutLabelDefinition</returns>
        public Lusid.Sdk.Client.ApiResponse<PagedResourceListOfCutLabelDefinition> ListCutLabelDefinitionsWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), string page = default(string))
        {
            Lusid.Sdk.Client.RequestOptions localVarRequestOptions = new Lusid.Sdk.Client.RequestOptions();
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfCutLabelDefinition> localVarResponse = await ListCutLabelDefinitionsWithHttpInfoAsync(asAt, sortBy, limit, filter, page, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
