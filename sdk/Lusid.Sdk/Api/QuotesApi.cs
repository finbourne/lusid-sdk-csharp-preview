...
namespace Lusid.Sdk.Api
{
    ...
    public interface IQuotesApi : IApiAccessor
    {
        ...
        /// <param name="effectiveAt">The effective datetime at which to retrieve the quotes. Defaults to the current LUSID system datetime if not specified. (optional)</param>
