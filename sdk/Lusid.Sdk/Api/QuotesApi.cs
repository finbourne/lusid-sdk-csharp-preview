...
namespace Lusid.Sdk.Api
{
    ...
    public partial class QuotesApi : IQuotesApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] DeleteQuoteAcccesMetadataRule: Delete a Quote Access Metadata Rule Delete the Quote Access Metadata Rule that exactly matches the provided identifier parts
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the Quote Access Metadata Rule to retrieve.</param>
        /// <param name="provider">The Provider of the rule (optional)</param>
