...
namespace Lusid.Sdk.Api
{
    ...
    public interface IQuotesApi : IApiAccessor
    {
        ...
        /// <param name="effectiveAt">The date this rule will effective from (optional)</param>
        /// <returns>ApiResponse of QuoteAccessMetadataRule</returns>
        ApiResponse<QuoteAccessMetadataRule> UpsertQuoteAccessMetadataRuleWithHttpInfo (string scope, UpsertQuoteAccessMetadataRuleRequest upsertQuoteAccessMetadataRuleRequest, DateTimeOrCutLabel effectiveAt = null);
        /// <summary>
        /// [BETA] Upsert quotes
        /// </summary>
        /// <remarks>
        ...
        /// <param name="effectiveAt">The date this rule will effective from (optional)</param>
        /// <returns>Task of QuoteAccessMetadataRule</returns>
        System.Threading.Tasks.Task<QuoteAccessMetadataRule> UpsertQuoteAccessMetadataRuleAsync (string scope, UpsertQuoteAccessMetadataRuleRequest upsertQuoteAccessMetadataRuleRequest, DateTimeOrCutLabel effectiveAt = null);
        ...
        /// <param name="effectiveAt">The date this rule will effective from (optional)</param>
        /// <returns>Task of ApiResponse (QuoteAccessMetadataRule)</returns>
        System.Threading.Tasks.Task<ApiResponse<QuoteAccessMetadataRule>> UpsertQuoteAccessMetadataRuleAsyncWithHttpInfo (string scope, UpsertQuoteAccessMetadataRuleRequest upsertQuoteAccessMetadataRuleRequest, DateTimeOrCutLabel effectiveAt = null);
        /// <summary>
        /// [BETA] Upsert quotes
        /// </summary>
        /// <remarks>
    ...
    public partial class QuotesApi : IQuotesApi
    {
        ...
        /// <summary>
        /// [BETA] List quotes for scope List all the quotes from a single scope at the specified date/time
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the quotes to list.</param>
        /// <param name="asAt">The asAt datetime at which to list the quotes. Defaults to latest if not specified. (optional)</param>
        ...
        /// <param name="effectiveAt">The date this rule will effective from (optional)</param>
        /// <returns>QuoteAccessMetadataRule</returns>
        public QuoteAccessMetadataRule UpsertQuoteAccessMetadataRule (string scope, UpsertQuoteAccessMetadataRuleRequest upsertQuoteAccessMetadataRuleRequest, DateTimeOrCutLabel effectiveAt = null)
        {
             ApiResponse<QuoteAccessMetadataRule> localVarResponse = UpsertQuoteAccessMetadataRuleWithHttpInfo(scope, upsertQuoteAccessMetadataRuleRequest, effectiveAt);
             return localVarResponse.Data;
        }
        ...
        /// <param name="effectiveAt">The date this rule will effective from (optional)</param>
        /// <returns>ApiResponse of QuoteAccessMetadataRule</returns>
        public ApiResponse< QuoteAccessMetadataRule > UpsertQuoteAccessMetadataRuleWithHttpInfo (string scope, UpsertQuoteAccessMetadataRuleRequest upsertQuoteAccessMetadataRuleRequest, DateTimeOrCutLabel effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            if (upsertQuoteAccessMetadataRuleRequest == null)
                throw new ApiException(400, "Missing required parameter 'upsertQuoteAccessMetadataRuleRequest' when calling QuotesApi->UpsertQuoteAccessMetadataRule");
            ...
            if (scope != null) localVarPathParams.Add("scope", this.Configuration.ApiClient.ParameterToString(scope)); // path parameter
            if (effectiveAt != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "effectiveAt", effectiveAt)); // query parameter
            if (upsertQuoteAccessMetadataRuleRequest != null && upsertQuoteAccessMetadataRuleRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(upsertQuoteAccessMetadataRuleRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = upsertQuoteAccessMetadataRuleRequest; // byte array
            }
        ...
        /// <param name="effectiveAt">The date this rule will effective from (optional)</param>
        /// <returns>Task of QuoteAccessMetadataRule</returns>
        public async System.Threading.Tasks.Task<QuoteAccessMetadataRule> UpsertQuoteAccessMetadataRuleAsync (string scope, UpsertQuoteAccessMetadataRuleRequest upsertQuoteAccessMetadataRuleRequest, DateTimeOrCutLabel effectiveAt = null)
        {
             ApiResponse<QuoteAccessMetadataRule> localVarResponse = await UpsertQuoteAccessMetadataRuleAsyncWithHttpInfo(scope, upsertQuoteAccessMetadataRuleRequest, effectiveAt);
             return localVarResponse.Data;
        ...
        /// <param name="effectiveAt">The date this rule will effective from (optional)</param>
        /// <returns>Task of ApiResponse (QuoteAccessMetadataRule)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<QuoteAccessMetadataRule>> UpsertQuoteAccessMetadataRuleAsyncWithHttpInfo (string scope, UpsertQuoteAccessMetadataRuleRequest upsertQuoteAccessMetadataRuleRequest, DateTimeOrCutLabel effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling QuotesApi->UpsertQuoteAccessMetadataRule");
