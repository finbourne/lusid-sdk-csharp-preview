...
namespace Lusid.Sdk.Api
{
    ...
    public partial class QuotesApi : IQuotesApi
    {
        ...
        /// <summary>
        /// [BETA] Upsert quotes Upsert quotes effective at the specified time. If a quote is added with the same id (and is effective at the same time) as an existing quote, then the more recently added quote will be returned when queried  The maximum number of quotes that this method can upsert per request is 2,000.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the quotes</param>
        /// <param name="quotes">The quotes to upsert (optional)</param>
