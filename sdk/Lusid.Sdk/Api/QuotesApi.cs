...
namespace Lusid.Sdk.Api
{
    ...
    public interface IQuotesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<QuoteAccessMetadataRule>> DeleteQuoteAcccesMetadataRuleAsyncWithHttpInfo (string scope, string provider = default(string), string priceSource = default(string), string instrumentIdType = default(string), string instrumentId = default(string), string quoteType = default(string), string field = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        /// <summary>
        /// [BETA] Delete quotes
        /// </summary>
        /// <remarks>
    ...
    public partial class QuotesApi : IQuotesApi
    {
        ...
        {
             Lusid.Sdk.Client.ApiResponse<QuoteAccessMetadataRule> localVarResponse = await DeleteQuoteAcccesMetadataRuleAsyncWithHttpInfo(scope, provider, priceSource, instrumentIdType, instrumentId, quoteType, field, effectiveAt);
             return localVarResponse.Data;
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<QuoteAccessMetadataRule>> DeleteQuoteAcccesMetadataRuleAsyncWithHttpInfo (string scope, string provider = default(string), string priceSource = default(string), string instrumentIdType = default(string), string instrumentId = default(string), string quoteType = default(string), string field = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<QuoteAccessMetadataRule>("/api/metadata/quotes/rules/{scope}", localVarRequestOptions, this.Configuration);
