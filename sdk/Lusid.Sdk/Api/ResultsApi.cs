...
namespace Lusid.Sdk.Api
{
    ...
    public interface IResultsApiSync : IApiAccessor
    {
        ...
        /// <returns>Results</returns>
        Results UpsertResults (CreateResults request = default(CreateResults));
        ...
        /// <param name="request">The details of what to upsert (optional)</param>
        /// <returns>ApiResponse of Results</returns>
        ApiResponse<Results> UpsertResultsWithHttpInfo (CreateResults request = default(CreateResults));
    ...
    public interface IResultsApiAsync : IApiAccessor
    {
        ...
        /// <param name="request">The details of what to upsert (optional)</param>
        /// <returns>Task of Results</returns>
        System.Threading.Tasks.Task<Results> UpsertResultsAsync (CreateResults request = default(CreateResults));
        ...
        /// <param name="request">The details of what to upsert (optional)</param>
        /// <returns>Task of ApiResponse (Results)</returns>
        System.Threading.Tasks.Task<ApiResponse<Results>> UpsertResultsAsyncWithHttpInfo (CreateResults request = default(CreateResults));
    ...
    public partial class ResultsApi : IResultsApi
    {
        ...
        /// <returns></returns>
        public ResultsApi(Lusid.Sdk.Client.Configuration configuration)
        {
        ...
        public ResultsApi(Lusid.Sdk.Client.ISynchronousClient client,Lusid.Sdk.Client.IAsynchronousClient asyncClient, Lusid.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        {
             Lusid.Sdk.Client.ApiResponse<Results> localVarResponse = GetResultsWithHttpInfo(entityScope, entityCode, calculationScope, calculationCode, effectiveAt);
        ...
        /// <param name="effectiveAt">The market date for which the data is stored</param>
        /// <returns>ApiResponse of Results</returns>
        public Lusid.Sdk.Client.ApiResponse< Results > GetResultsWithHttpInfo (string entityScope, string entityCode, string calculationScope, string calculationCode, DateTimeOffset effectiveAt)
        {
            // verify the required parameter 'entityScope' is set
            if (entityScope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'entityScope' when calling ResultsApi->GetResults");

            // verify the required parameter 'entityCode' is set
            if (entityCode == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'entityCode' when calling ResultsApi->GetResults");

            // verify the required parameter 'calculationScope' is set
            if (calculationScope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'calculationScope' when calling ResultsApi->GetResults");

            // verify the required parameter 'calculationCode' is set
            if (calculationCode == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'calculationCode' when calling ResultsApi->GetResults");

            // verify the required parameter 'effectiveAt' is set
            if (effectiveAt == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'effectiveAt' when calling ResultsApi->GetResults");
            ...
            if (entityScope != null)
                localVarRequestOptions.PathParameters.Add("entityScope", Lusid.Sdk.Client.ClientUtils.ParameterToString(entityScope)); // path parameter
            if (entityCode != null)
                localVarRequestOptions.PathParameters.Add("entityCode", Lusid.Sdk.Client.ClientUtils.ParameterToString(entityCode)); // path parameter
            if (calculationScope != null)
                localVarRequestOptions.PathParameters.Add("calculationScope", Lusid.Sdk.Client.ClientUtils.ParameterToString(calculationScope)); // path parameter
            if (calculationCode != null)
                localVarRequestOptions.PathParameters.Add("calculationCode", Lusid.Sdk.Client.ClientUtils.ParameterToString(calculationCode)); // path parameter
            if (effectiveAt != null)
            ...
            var localVarResponse = this.Client.Get< Results >("/api/results/{entityScope}/{entityCode}/{calculationScope}/{calculationCode}/{effectiveAt}", localVarRequestOptions, this.Configuration);
        ...
        {
             Lusid.Sdk.Client.ApiResponse<Results> localVarResponse = await GetResultsAsyncWithHttpInfo(entityScope, entityCode, calculationScope, calculationCode, effectiveAt);
             return localVarResponse.Data;
        ...
        /// <param name="effectiveAt">The market date for which the data is stored</param>
        /// <returns>Task of ApiResponse (Results)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<Results>> GetResultsAsyncWithHttpInfo (string entityScope, string entityCode, string calculationScope, string calculationCode, DateTimeOffset effectiveAt)
        {
            // verify the required parameter 'entityScope' is set
            if (entityScope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'entityScope' when calling ResultsApi->GetResults");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Results>("/api/results/{entityScope}/{entityCode}/{calculationScope}/{calculationCode}/{effectiveAt}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="request">The details of what to upsert (optional)</param>
        /// <returns>Results</returns>
        public Results UpsertResults (CreateResults request = default(CreateResults))
        {
             Lusid.Sdk.Client.ApiResponse<Results> localVarResponse = UpsertResultsWithHttpInfo(request);
             return localVarResponse.Data;
        }
        ...
        /// <param name="request">The details of what to upsert (optional)</param>
        /// <returns>ApiResponse of Results</returns>
        public Lusid.Sdk.Client.ApiResponse< Results > UpsertResultsWithHttpInfo (CreateResults request = default(CreateResults))
        {
            Lusid.Sdk.Client.RequestOptions localVarRequestOptions = new Lusid.Sdk.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post< Results >("/api/results", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("UpsertResults", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="request">The details of what to upsert (optional)</param>
        /// <returns>Task of Results</returns>
        public async System.Threading.Tasks.Task<Results> UpsertResultsAsync (CreateResults request = default(CreateResults))
        {
             Lusid.Sdk.Client.ApiResponse<Results> localVarResponse = await UpsertResultsAsyncWithHttpInfo(request);
             return localVarResponse.Data;
        ...
        /// <param name="request">The details of what to upsert (optional)</param>
        /// <returns>Task of ApiResponse (Results)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<Results>> UpsertResultsAsyncWithHttpInfo (CreateResults request = default(CreateResults))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Results>("/api/results", localVarRequestOptions, this.Configuration);
