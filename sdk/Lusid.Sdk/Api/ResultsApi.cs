...
namespace Lusid.Sdk.Api
{
    ...
    public interface IResultsApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="createResults">The details of what to upsert (optional)</param>
        /// <returns>Results</returns>
        ...
        /// <param name="createResults">The details of what to upsert (optional)</param>
        /// <returns>ApiResponse of Results</returns>
        ApiResponse<Results> UpsertResultsWithHttpInfo (CreateResults createResults = null);
        ...
        /// <param name="createResults">The details of what to upsert (optional)</param>
        /// <returns>Task of Results</returns>
        System.Threading.Tasks.Task<Results> UpsertResultsAsync (CreateResults createResults = null);
        ...
        /// <param name="createResults">The details of what to upsert (optional)</param>
        /// <returns>Task of ApiResponse (Results)</returns>
        System.Threading.Tasks.Task<ApiResponse<Results>> UpsertResultsAsyncWithHttpInfo (CreateResults createResults = null);
    ...
    public partial class ResultsApi : IResultsApi
    {
        ...
        /// <param name="createResults">The details of what to upsert (optional)</param>
        /// <returns>Results</returns>
        public Results UpsertResults (CreateResults createResults = null)
        {
             ApiResponse<Results> localVarResponse = UpsertResultsWithHttpInfo(createResults);
             return localVarResponse.Data;
        }
        ...
        /// <param name="createResults">The details of what to upsert (optional)</param>
        /// <returns>ApiResponse of Results</returns>
        public ApiResponse< Results > UpsertResultsWithHttpInfo (CreateResults createResults = null)
        {
            ...
            if (createResults != null && createResults.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(createResults); // http body (model) parameter
            }
            else
            {
                localVarPostBody = createResults; // byte array
            }
        ...
        /// <param name="createResults">The details of what to upsert (optional)</param>
        /// <returns>Task of Results</returns>
        public async System.Threading.Tasks.Task<Results> UpsertResultsAsync (CreateResults createResults = null)
        {
             ApiResponse<Results> localVarResponse = await UpsertResultsAsyncWithHttpInfo(createResults);
             return localVarResponse.Data;
        ...
        /// <param name="createResults">The details of what to upsert (optional)</param>
        /// <returns>Task of ApiResponse (Results)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Results>> UpsertResultsAsyncWithHttpInfo (CreateResults createResults = null)
        {
