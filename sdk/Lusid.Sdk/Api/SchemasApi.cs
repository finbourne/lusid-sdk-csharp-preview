...
namespace Lusid.Sdk.Api
{
    ...
    public interface ISchemasApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PropertySchema> GetPropertySchemaAsync (List<string> propertyKeys = default(List<string>), DateTimeOffset? asAt = default(DateTimeOffset?));
        ...
        System.Threading.Tasks.Task<ApiResponse<PropertySchema>> GetPropertySchemaAsyncWithHttpInfo (List<string> propertyKeys = default(List<string>), DateTimeOffset? asAt = default(DateTimeOffset?));
        /// <summary>
        /// [BETA] Get value types
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ResourceListOfValueType> GetValueTypesAsync (List<string> sortBy = default(List<string>), int? start = default(int?), int? limit = default(int?));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfValueType>> GetValueTypesAsyncWithHttpInfo (List<string> sortBy = default(List<string>), int? start = default(int?), int? limit = default(int?));
        /// <summary>
        /// [BETA] List entities
        /// </summary>
        /// <remarks>
    ...
    public partial class SchemasApi : ISchemasApi
    {
        ...
        {
             Lusid.Sdk.Client.ApiResponse<Schema> localVarResponse = await GetEntitySchemaAsyncWithHttpInfo(entity);
             return localVarResponse.Data;
        ...
        /// <param name="entity">The name of a valid entity</param>
        /// <returns>Task of ApiResponse (Schema)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<Schema>> GetEntitySchemaAsyncWithHttpInfo (string entity)
        {
            // verify the required parameter 'entity' is set
            if (entity == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'entity' when calling SchemasApi->GetEntitySchema");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Schema>("/api/schemas/entities/{entity}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="asAt">Optional. The AsAt date of the data (optional)</param>
        /// <returns>Task of PropertySchema</returns>
        public async System.Threading.Tasks.Task<PropertySchema> GetPropertySchemaAsync (List<string> propertyKeys = default(List<string>), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
             Lusid.Sdk.Client.ApiResponse<PropertySchema> localVarResponse = await GetPropertySchemaAsyncWithHttpInfo(propertyKeys, asAt);
             return localVarResponse.Data;
        ...
        /// <param name="asAt">Optional. The AsAt date of the data (optional)</param>
        /// <returns>Task of ApiResponse (PropertySchema)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<PropertySchema>> GetPropertySchemaAsyncWithHttpInfo (List<string> propertyKeys = default(List<string>), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PropertySchema>("/api/schemas/properties", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="limit">Optional. When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>Task of ResourceListOfValueType</returns>
        public async System.Threading.Tasks.Task<ResourceListOfValueType> GetValueTypesAsync (List<string> sortBy = default(List<string>), int? start = default(int?), int? limit = default(int?))
        {
             Lusid.Sdk.Client.ApiResponse<ResourceListOfValueType> localVarResponse = await GetValueTypesAsyncWithHttpInfo(sortBy, start, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">Optional. When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfValueType)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfValueType>> GetValueTypesAsyncWithHttpInfo (List<string> sortBy = default(List<string>), int? start = default(int?), int? limit = default(int?))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResourceListOfValueType>("/api/schemas/types", localVarRequestOptions, this.Configuration);
        ...
        {
             Lusid.Sdk.Client.ApiResponse<ResourceListOfString> localVarResponse = await ListEntitiesAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (ResourceListOfString)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfString>> ListEntitiesAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResourceListOfString>("/api/schemas/entities", localVarRequestOptions, this.Configuration);
