...
namespace Lusid.Sdk.Api
{
    ...
    public interface ISchemasApiSync : IApiAccessor
    {
        ...
        ResourceListOfValueType GetValueTypes(List<string> sortBy = default(List<string>), int? limit = default(int?));
        ...
        ApiResponse<ResourceListOfValueType> GetValueTypesWithHttpInfo(List<string> sortBy = default(List<string>), int? limit = default(int?));
        /// <summary>
    ...
    public interface ISchemasApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ResourceListOfValueType> GetValueTypesAsync(List<string> sortBy = default(List<string>), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfValueType>> GetValueTypesWithHttpInfoAsync(List<string> sortBy = default(List<string>), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EARLY ACCESS] ListEntities: List entities
        /// </summary>
        /// <remarks>
    ...
    public partial class SchemasApi : ISchemasApi
    {
        ...
        /// <param name="limit">Optional. When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>ResourceListOfValueType</returns>
        public ResourceListOfValueType GetValueTypes(List<string> sortBy = default(List<string>), int? limit = default(int?))
        {
        ...
        /// <param name="limit">Optional. When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfValueType</returns>
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfValueType> GetValueTypesWithHttpInfo(List<string> sortBy = default(List<string>), int? limit = default(int?))
        {
            Lusid.Sdk.Client.RequestOptions localVarRequestOptions = new Lusid.Sdk.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResourceListOfValueType</returns>
        public async System.Threading.Tasks.Task<ResourceListOfValueType> GetValueTypesAsync(List<string> sortBy = default(List<string>), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfValueType> localVarResponse = await GetValueTypesWithHttpInfoAsync(sortBy, limit, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ResourceListOfValueType)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfValueType>> GetValueTypesWithHttpInfoAsync(List<string> sortBy = default(List<string>), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
