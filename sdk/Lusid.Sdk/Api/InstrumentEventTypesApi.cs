...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentEventTypesApiSync : IApiAccessor
    {
        ...
        ApiResponse<TransactionTemplateResponse> CreateTransactionTemplateWithHttpInfo(string instrumentEventType, string instrumentType, string scope, TransactionTemplateRequest transactionTemplateRequest);
        /// <summary>
    ...
    public interface IInstrumentEventTypesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TransactionTemplateResponse> CreateTransactionTemplateAsync(string instrumentEventType, string instrumentType, string scope, TransactionTemplateRequest transactionTemplateRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TransactionTemplateResponse>> CreateTransactionTemplateWithHttpInfoAsync(string instrumentEventType, string instrumentType, string scope, TransactionTemplateRequest transactionTemplateRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] GetTransactionTemplateSpecification: Get Transaction Template Specification.
        /// </summary>
        /// <remarks>
    ...
    public partial class InstrumentEventTypesApi : IInstrumentEventTypesApi
    {
        ...
        /// <param name="transactionTemplateRequest">A request defining a new transaction template to be created.</param>
        /// <returns>TransactionTemplateResponse</returns>
        public TransactionTemplateResponse CreateTransactionTemplate(string instrumentEventType, string instrumentType, string scope, TransactionTemplateRequest transactionTemplateRequest)
        {
        ...
        /// <param name="transactionTemplateRequest">A request defining a new transaction template to be created.</param>
        /// <returns>ApiResponse of TransactionTemplateResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<TransactionTemplateResponse> CreateTransactionTemplateWithHttpInfo(string instrumentEventType, string instrumentType, string scope, TransactionTemplateRequest transactionTemplateRequest)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TransactionTemplateResponse</returns>
        public async System.Threading.Tasks.Task<TransactionTemplateResponse> CreateTransactionTemplateAsync(string instrumentEventType, string instrumentType, string scope, TransactionTemplateRequest transactionTemplateRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<TransactionTemplateResponse> localVarResponse = await CreateTransactionTemplateWithHttpInfoAsync(instrumentEventType, instrumentType, scope, transactionTemplateRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TransactionTemplateResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<TransactionTemplateResponse>> CreateTransactionTemplateWithHttpInfoAsync(string instrumentEventType, string instrumentType, string scope, TransactionTemplateRequest transactionTemplateRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'instrumentEventType' is set
            if (instrumentEventType == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'instrumentEventType' when calling InstrumentEventTypesApi->CreateTransactionTemplate");
