...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentEventTypesApiSync : IApiAccessor
    {
        ...
        ApiResponse<TransactionTemplateSpecification> GetTransactionTemplateSpecificationWithHttpInfo(string instrumentType, string instrumentEventType);
    ...
    public interface IInstrumentEventTypesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TransactionTemplateSpecification> GetTransactionTemplateSpecificationAsync(string instrumentType, string instrumentEventType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TransactionTemplateSpecification>> GetTransactionTemplateSpecificationWithHttpInfoAsync(string instrumentType, string instrumentEventType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class InstrumentEventTypesApi : IInstrumentEventTypesApi
    {
        ...
        /// <param name="instrumentEventType">The requested instrument event type.</param>
        /// <returns>TransactionTemplateSpecification</returns>
        public TransactionTemplateSpecification GetTransactionTemplateSpecification(string instrumentType, string instrumentEventType)
        {
        ...
        /// <param name="instrumentEventType">The requested instrument event type.</param>
        /// <returns>ApiResponse of TransactionTemplateSpecification</returns>
        public Lusid.Sdk.Client.ApiResponse<TransactionTemplateSpecification> GetTransactionTemplateSpecificationWithHttpInfo(string instrumentType, string instrumentEventType)
        {
            // verify the required parameter 'instrumentType' is set
            if (instrumentType == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TransactionTemplateSpecification</returns>
        public async System.Threading.Tasks.Task<TransactionTemplateSpecification> GetTransactionTemplateSpecificationAsync(string instrumentType, string instrumentEventType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<TransactionTemplateSpecification> localVarResponse = await GetTransactionTemplateSpecificationWithHttpInfoAsync(instrumentType, instrumentEventType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TransactionTemplateSpecification)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<TransactionTemplateSpecification>> GetTransactionTemplateSpecificationWithHttpInfoAsync(string instrumentType, string instrumentEventType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'instrumentType' is set
            if (instrumentType == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'instrumentType' when calling InstrumentEventTypesApi->GetTransactionTemplateSpecification");
