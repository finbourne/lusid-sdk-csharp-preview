...
namespace Lusid.Sdk.Api
{
    ...
    /// </summary>
    public interface IComplexMarketDataApi : IApiAccessor
    {
        ...
        ApiResponse<GetComplexMarketDataResponse> GetComplexMarketDataWithHttpInfo (string scope, Dictionary<string, ComplexMarketDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<AnnulStructuredDataResponse> DeleteComplexMarketDataAsync (string scope, Dictionary<string, ComplexMarketDataId> requestBody);
        ...
        System.Threading.Tasks.Task<ApiResponse<AnnulStructuredDataResponse>> DeleteComplexMarketDataAsyncWithHttpInfo (string scope, Dictionary<string, ComplexMarketDataId> requestBody);
        /// <summary>
        /// [EXPERIMENTAL] Get complex market data
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GetComplexMarketDataResponse> GetComplexMarketDataAsync (string scope, Dictionary<string, ComplexMarketDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetComplexMarketDataResponse>> GetComplexMarketDataAsyncWithHttpInfo (string scope, Dictionary<string, ComplexMarketDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null);
        /// <summary>
        /// [EXPERIMENTAL] Upsert a set of complex market data items. This creates or updates the data in Lusid.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<UpsertStructuredDataResponse> UpsertComplexMarketDataAsync (string scope, Dictionary<string, UpsertComplexMarketDataRequest> requestBody);
        ...
        System.Threading.Tasks.Task<ApiResponse<UpsertStructuredDataResponse>> UpsertComplexMarketDataAsyncWithHttpInfo (string scope, Dictionary<string, UpsertComplexMarketDataRequest> requestBody);
    ...
    public partial class ComplexMarketDataApi : IComplexMarketDataApi
    {
        ...
        /// <returns></returns>
        public ComplexMarketDataApi(Lusid.Sdk.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<AnnulStructuredDataResponse> localVarResponse = DeleteComplexMarketDataWithHttpInfo(scope, requestBody);
        ...
        /// <param name="requestBody">The complex market data Ids to delete, each keyed by a unique correlation id.</param>
        /// <returns>ApiResponse of AnnulStructuredDataResponse</returns>
        public ApiResponse< AnnulStructuredDataResponse > DeleteComplexMarketDataWithHttpInfo (string scope, Dictionary<string, ComplexMarketDataId> requestBody)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ComplexMarketDataApi->DeleteComplexMarketData");
            // verify the required parameter 'requestBody' is set
            if (requestBody == null)
                throw new ApiException(400, "Missing required parameter 'requestBody' when calling ComplexMarketDataApi->DeleteComplexMarketData");

            var localVarPath = "./api/complexmarketdata/{scope}/$delete";
            ...
            {
                Exception exception = ExceptionFactory("DeleteComplexMarketData", localVarResponse);
        ...
        /// <param name="requestBody">The complex market data Ids to delete, each keyed by a unique correlation id.</param>
        /// <returns>Task of AnnulStructuredDataResponse</returns>
        public async System.Threading.Tasks.Task<AnnulStructuredDataResponse> DeleteComplexMarketDataAsync (string scope, Dictionary<string, ComplexMarketDataId> requestBody)
        {
             ApiResponse<AnnulStructuredDataResponse> localVarResponse = await DeleteComplexMarketDataAsyncWithHttpInfo(scope, requestBody);
             return localVarResponse.Data;
        ...
        /// <param name="requestBody">The complex market data Ids to delete, each keyed by a unique correlation id.</param>
        /// <returns>Task of ApiResponse (AnnulStructuredDataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AnnulStructuredDataResponse>> DeleteComplexMarketDataAsyncWithHttpInfo (string scope, Dictionary<string, ComplexMarketDataId> requestBody)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ComplexMarketDataApi->DeleteComplexMarketData");
        ...
        /// <param name="maxAge">The duration of the look back window in an ISO8601 time interval format e.g. P1Y2M3DT4H30M (1 year, 2 months, 3 days, 4 hours and 30 minutes).               This is subtracted from the provided effectiveAt datetime to generate a effective datetime window inside which a complex market data item must exist to be retrieved. (optional)</param>
        /// <returns>GetComplexMarketDataResponse</returns>
        public GetComplexMarketDataResponse GetComplexMarketData (string scope, Dictionary<string, ComplexMarketDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null)
        {
             ApiResponse<GetComplexMarketDataResponse> localVarResponse = GetComplexMarketDataWithHttpInfo(scope, requestBody, effectiveAt, asAt, maxAge);
             return localVarResponse.Data;
        }
        ...
        /// <param name="maxAge">The duration of the look back window in an ISO8601 time interval format e.g. P1Y2M3DT4H30M (1 year, 2 months, 3 days, 4 hours and 30 minutes).               This is subtracted from the provided effectiveAt datetime to generate a effective datetime window inside which a complex market data item must exist to be retrieved. (optional)</param>
        /// <returns>ApiResponse of GetComplexMarketDataResponse</returns>
        public ApiResponse< GetComplexMarketDataResponse > GetComplexMarketDataWithHttpInfo (string scope, Dictionary<string, ComplexMarketDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ComplexMarketDataApi->GetComplexMarketData");
            // verify the required parameter 'requestBody' is set
            if (requestBody == null)
                throw new ApiException(400, "Missing required parameter 'requestBody' when calling ComplexMarketDataApi->GetComplexMarketData");

            var localVarPath = "./api/complexmarketdata/{scope}/$get";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetComplexMarketData", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<GetComplexMarketDataResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (GetComplexMarketDataResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(GetComplexMarketDataResponse)));
        }
        ...
        /// <param name="maxAge">The duration of the look back window in an ISO8601 time interval format e.g. P1Y2M3DT4H30M (1 year, 2 months, 3 days, 4 hours and 30 minutes).               This is subtracted from the provided effectiveAt datetime to generate a effective datetime window inside which a complex market data item must exist to be retrieved. (optional)</param>
        /// <returns>Task of GetComplexMarketDataResponse</returns>
        public async System.Threading.Tasks.Task<GetComplexMarketDataResponse> GetComplexMarketDataAsync (string scope, Dictionary<string, ComplexMarketDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null)
        {
             ApiResponse<GetComplexMarketDataResponse> localVarResponse = await GetComplexMarketDataAsyncWithHttpInfo(scope, requestBody, effectiveAt, asAt, maxAge);
             return localVarResponse.Data;
        ...
        /// <param name="maxAge">The duration of the look back window in an ISO8601 time interval format e.g. P1Y2M3DT4H30M (1 year, 2 months, 3 days, 4 hours and 30 minutes).               This is subtracted from the provided effectiveAt datetime to generate a effective datetime window inside which a complex market data item must exist to be retrieved. (optional)</param>
        /// <returns>Task of ApiResponse (GetComplexMarketDataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetComplexMarketDataResponse>> GetComplexMarketDataAsyncWithHttpInfo (string scope, Dictionary<string, ComplexMarketDataId> requestBody, DateTimeOrCutLabel effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ComplexMarketDataApi->GetComplexMarketData");
        ...
        {
             ApiResponse<UpsertStructuredDataResponse> localVarResponse = UpsertComplexMarketDataWithHttpInfo(scope, requestBody);
             return localVarResponse.Data;
        }
        ...
        /// <param name="requestBody">The set of complex market data items to update or insert keyed by a unique correlation id.</param>
        /// <returns>ApiResponse of UpsertStructuredDataResponse</returns>
        public ApiResponse< UpsertStructuredDataResponse > UpsertComplexMarketDataWithHttpInfo (string scope, Dictionary<string, UpsertComplexMarketDataRequest> requestBody)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ComplexMarketDataApi->UpsertComplexMarketData");
            // verify the required parameter 'requestBody' is set
            if (requestBody == null)
                throw new ApiException(400, "Missing required parameter 'requestBody' when calling ComplexMarketDataApi->UpsertComplexMarketData");

            var localVarPath = "./api/complexmarketdata/{scope}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("UpsertComplexMarketData", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="requestBody">The set of complex market data items to update or insert keyed by a unique correlation id.</param>
        /// <returns>Task of UpsertStructuredDataResponse</returns>
        public async System.Threading.Tasks.Task<UpsertStructuredDataResponse> UpsertComplexMarketDataAsync (string scope, Dictionary<string, UpsertComplexMarketDataRequest> requestBody)
        {
             ApiResponse<UpsertStructuredDataResponse> localVarResponse = await UpsertComplexMarketDataAsyncWithHttpInfo(scope, requestBody);
             return localVarResponse.Data;
        ...
        /// <param name="requestBody">The set of complex market data items to update or insert keyed by a unique correlation id.</param>
        /// <returns>Task of ApiResponse (UpsertStructuredDataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpsertStructuredDataResponse>> UpsertComplexMarketDataAsyncWithHttpInfo (string scope, Dictionary<string, UpsertComplexMarketDataRequest> requestBody)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ComplexMarketDataApi->UpsertComplexMarketData");
