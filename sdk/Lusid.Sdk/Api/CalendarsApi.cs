...
namespace Lusid.Sdk.Api
{
    ...
    public interface ICalendarsApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">Scope of the calendars (optional)</param>
        ...
        ApiResponse<PagedResourceListOfCalendar> ListCalendarsWithHttpInfo (string scope = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<PagedResourceListOfCalendar> ListCalendarsAsync (string scope = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PagedResourceListOfCalendar>> ListCalendarsAsyncWithHttpInfo (string scope = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null);
        /// <summary>
        /// [EXPERIMENTAL] Update a calendar
        /// </summary>
        /// <remarks>
    ...
    public partial class CalendarsApi : ICalendarsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Check whether a DateTime is a \&quot;Business DateTime\&quot; A Business DateTime is defined as a point in time that: &lt;br /&gt;      * Does not represent a day that overlaps with the calendars WeekendMask &lt;br /&gt;      * If the calendar is a \&quot;Holiday Calendar\&quot; Does not overlap with any dates in the calendar &lt;br /&gt;      * If the calendar is a \&quot;TradingHours Calendar\&quot; Does overlap with a date in the calendar &lt;br /&gt;                All dates specified must be UTC and the upper bound of a calendar is not inclusive &lt;br /&gt;  e.g. From: 2020-12-25-00-00-00        To: 2020-12-26-00-00-00 &lt;br /&gt;  IsBusinessDay(2020-12-26-00-00-00) &#x3D;&#x3D; false
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dateTime">DateTime to check - This DateTime must be UTC</param>
        /// <param name="scope">Scope of the calendar</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] List all calenders List calendars within a specific scope and a specific window of effective time, at a point in AsAt time.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">Scope of the calendars (optional)</param>
        /// <param name="asAt">The AsAt datetime at which to retrieve the calendars (optional)</param>
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>PagedResourceListOfCalendar</returns>
        public PagedResourceListOfCalendar ListCalendars (string scope = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null)
        {
             ApiResponse<PagedResourceListOfCalendar> localVarResponse = ListCalendarsWithHttpInfo(scope, asAt, page, start, limit, filter);
             return localVarResponse.Data;
        }
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>ApiResponse of PagedResourceListOfCalendar</returns>
        public ApiResponse< PagedResourceListOfCalendar > ListCalendarsWithHttpInfo (string scope = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null)
        {
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>Task of PagedResourceListOfCalendar</returns>
        public async System.Threading.Tasks.Task<PagedResourceListOfCalendar> ListCalendarsAsync (string scope = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null)
        {
             ApiResponse<PagedResourceListOfCalendar> localVarResponse = await ListCalendarsAsyncWithHttpInfo(scope, asAt, page, start, limit, filter);
             return localVarResponse.Data;
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>Task of ApiResponse (PagedResourceListOfCalendar)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PagedResourceListOfCalendar>> ListCalendarsAsyncWithHttpInfo (string scope = null, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null)
        {
