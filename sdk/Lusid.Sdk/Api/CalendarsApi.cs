...
namespace Lusid.Sdk.Api
{
    ...
    public interface ICalendarsApiSync : IApiAccessor
    {
        ...
        ApiResponse<BatchUpsertDatesForCalendarResponse> BatchUpsertDatesForCalendarWithHttpInfo(string scope, string code, string successMode, Dictionary<string, CreateDateRequest> requestBody);
        /// <summary>
        ...
        ApiResponse<Dictionary<string, CalendarDate>> DeleteDatesFromCalendarWithHttpInfo(string scope, string code, List<string> requestBody);
        /// <summary>
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>PagedResourceListOfCalendar</returns>
        PagedResourceListOfCalendar ListCalendarsInScope(string scope, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), List<string> propertyKeys = default(List<string>), string filter = default(string));
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>ApiResponse of PagedResourceListOfCalendar</returns>
        ApiResponse<PagedResourceListOfCalendar> ListCalendarsInScopeWithHttpInfo(string scope, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), List<string> propertyKeys = default(List<string>), string filter = default(string));
        /// <summary>
    ...
    public interface ICalendarsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<BatchUpsertDatesForCalendarResponse> BatchUpsertDatesForCalendarAsync(string scope, string code, string successMode, Dictionary<string, CreateDateRequest> requestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<Dictionary<string, CalendarDate>> DeleteDatesFromCalendarAsync(string scope, string code, List<string> requestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Dictionary<string, CalendarDate>>> DeleteDatesFromCalendarWithHttpInfoAsync(string scope, string code, List<string> requestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EARLY ACCESS] GenerateSchedule: Generate an ordered schedule of dates.
        /// </summary>
        /// <remarks>
    ...
    public partial class CalendarsApi : ICalendarsApi
    {
        ...
        /// <param name="requestBody">Create Date Requests of dates to upsert</param>
        /// <returns>BatchUpsertDatesForCalendarResponse</returns>
        public BatchUpsertDatesForCalendarResponse BatchUpsertDatesForCalendar(string scope, string code, string successMode, Dictionary<string, CreateDateRequest> requestBody)
        {
            Lusid.Sdk.Client.ApiResponse<BatchUpsertDatesForCalendarResponse> localVarResponse = BatchUpsertDatesForCalendarWithHttpInfo(scope, code, successMode, requestBody);
            return localVarResponse.Data;
        }
        ...
        /// <param name="requestBody">Create Date Requests of dates to upsert</param>
        /// <returns>ApiResponse of BatchUpsertDatesForCalendarResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<BatchUpsertDatesForCalendarResponse> BatchUpsertDatesForCalendarWithHttpInfo(string scope, string code, string successMode, Dictionary<string, CreateDateRequest> requestBody)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BatchUpsertDatesForCalendarResponse</returns>
        public async System.Threading.Tasks.Task<BatchUpsertDatesForCalendarResponse> BatchUpsertDatesForCalendarAsync(string scope, string code, string successMode, Dictionary<string, CreateDateRequest> requestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<BatchUpsertDatesForCalendarResponse> localVarResponse = await BatchUpsertDatesForCalendarWithHttpInfoAsync(scope, code, successMode, requestBody, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="requestBody">Identifiers of the dates to be removed</param>
        /// <returns>Dictionary&lt;string, CalendarDate&gt;</returns>
        public Dictionary<string, CalendarDate> DeleteDatesFromCalendar(string scope, string code, List<string> requestBody)
        {
            Lusid.Sdk.Client.ApiResponse<Dictionary<string, CalendarDate>> localVarResponse = DeleteDatesFromCalendarWithHttpInfo(scope, code, requestBody);
            return localVarResponse.Data;
        }
        ...
        /// <param name="requestBody">Identifiers of the dates to be removed</param>
        /// <returns>ApiResponse of Dictionary&lt;string, CalendarDate&gt;</returns>
        public Lusid.Sdk.Client.ApiResponse<Dictionary<string, CalendarDate>> DeleteDatesFromCalendarWithHttpInfo(string scope, string code, List<string> requestBody)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Dictionary&lt;string, CalendarDate&gt;</returns>
        public async System.Threading.Tasks.Task<Dictionary<string, CalendarDate>> DeleteDatesFromCalendarAsync(string scope, string code, List<string> requestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<Dictionary<string, CalendarDate>> localVarResponse = await DeleteDatesFromCalendarWithHttpInfoAsync(scope, code, requestBody, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, CalendarDate&gt;)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<Dictionary<string, CalendarDate>>> DeleteDatesFromCalendarWithHttpInfoAsync(string scope, string code, List<string> requestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling CalendarsApi->DeleteDatesFromCalendar");
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>PagedResourceListOfCalendar</returns>
        public PagedResourceListOfCalendar ListCalendarsInScope(string scope, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), List<string> propertyKeys = default(List<string>), string filter = default(string))
        {
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>ApiResponse of PagedResourceListOfCalendar</returns>
        public Lusid.Sdk.Client.ApiResponse<PagedResourceListOfCalendar> ListCalendarsInScopeWithHttpInfo(string scope, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), List<string> propertyKeys = default(List<string>), string filter = default(string))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        public async System.Threading.Tasks.Task<PagedResourceListOfCalendar> ListCalendarsInScopeAsync(string scope, DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), int? limit = default(int?), List<string> propertyKeys = default(List<string>), string filter = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfCalendar> localVarResponse = await ListCalendarsInScopeWithHttpInfoAsync(scope, asAt, page, limit, propertyKeys, filter, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
