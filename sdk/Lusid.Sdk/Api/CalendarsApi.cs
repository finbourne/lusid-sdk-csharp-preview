...
namespace Lusid.Sdk.Api
{
    ...
    public interface ICalendarsApi : IApiAccessor
    {
        ...
        ApiResponse<PagedResourceListOfCalendar> ListCalendarsWithHttpInfo (string scope, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<PagedResourceListOfCalendar> ListCalendarsAsync (string scope, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PagedResourceListOfCalendar>> ListCalendarsAsyncWithHttpInfo (string scope, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null);
        /// <summary>
        /// [EXPERIMENTAL] Update a calendar
        /// </summary>
        /// <remarks>
    ...
    public partial class CalendarsApi : ICalendarsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] List all calenders in a specified scope List calendars within a specific scope and a specific window of effective time, at a point in AsAt time.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">Scope of the calendars</param>
        /// <param name="asAt">The AsAt datetime at which to retrieve the calendars (optional)</param>
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>PagedResourceListOfCalendar</returns>
        public PagedResourceListOfCalendar ListCalendars (string scope, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null)
        {
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>ApiResponse of PagedResourceListOfCalendar</returns>
        public ApiResponse< PagedResourceListOfCalendar > ListCalendarsWithHttpInfo (string scope, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CalendarsApi->ListCalendars");
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>Task of PagedResourceListOfCalendar</returns>
        public async System.Threading.Tasks.Task<PagedResourceListOfCalendar> ListCalendarsAsync (string scope, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null)
        {
        ...
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        /// <returns>Task of ApiResponse (PagedResourceListOfCalendar)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PagedResourceListOfCalendar>> ListCalendarsAsyncWithHttpInfo (string scope, DateTimeOffset? asAt = null, string page = null, int? start = null, int? limit = null, string filter = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CalendarsApi->ListCalendars");
