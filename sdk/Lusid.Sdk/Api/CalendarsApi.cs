...
namespace Lusid.Sdk.Api
{
    ...
    public interface ICalendarsApi : IApiAccessor
    {
        ...
        /// <param name="code">Code of the calendar</param>
        /// <param name="createDateRequest">Add date to calendar request</param>
        /// <returns>ApiResponse of Date</returns>
        ApiResponse<Date> AddDateToCalendarWithHttpInfo (string scope, string code, CreateDateRequest createDateRequest);
        /// <summary>
        ...
        /// <param name="dateId">Identifier of the date to be removed</param>
        /// <returns>ApiResponse of Date</returns>
        ApiResponse<Date> DeleteDateFromCalendarWithHttpInfo (string scope, string code, string dateId);
        /// <summary>
        ...
        /// <returns>ResourceListOfDate</returns>
        ...
        /// <param name="asAt">AsAt the dates should be retrieved at (optional)</param>
        /// <param name="idFilter">An additional filter that will filter dates based on their identifer (optional)</param>
        /// <returns>ApiResponse of ResourceListOfDate</returns>
        ApiResponse<ResourceListOfDate> GetDatesWithHttpInfo (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null, List<string> idFilter = null);
        /// <summary>
        ...
        /// <param name="code">Code of the calendar</param>
        /// <param name="createDateRequest">Add date to calendar request</param>
        /// <returns>Task of Date</returns>
        System.Threading.Tasks.Task<Date> AddDateToCalendarAsync (string scope, string code, CreateDateRequest createDateRequest);
        ...
        /// <param name="code">Code of the calendar</param>
        /// <param name="createDateRequest">Add date to calendar request</param>
        /// <returns>Task of ApiResponse (Date)</returns>
        System.Threading.Tasks.Task<ApiResponse<Date>> AddDateToCalendarAsyncWithHttpInfo (string scope, string code, CreateDateRequest createDateRequest);
        /// <summary>
        /// [EXPERIMENTAL] Create a calendar in its generic form
        /// </summary>
        /// <remarks>
        ...
        /// <param name="dateId">Identifier of the date to be removed</param>
        /// <returns>Task of Date</returns>
        System.Threading.Tasks.Task<Date> DeleteDateFromCalendarAsync (string scope, string code, string dateId);
        ...
        /// <param name="dateId">Identifier of the date to be removed</param>
        /// <returns>Task of ApiResponse (Date)</returns>
        System.Threading.Tasks.Task<ApiResponse<Date>> DeleteDateFromCalendarAsyncWithHttpInfo (string scope, string code, string dateId);
        /// <summary>
        /// [EXPERIMENTAL] Get a calendar in its generic form
        /// </summary>
        /// <remarks>
        ...
        /// <param name="asAt">AsAt the dates should be retrieved at (optional)</param>
        /// <param name="idFilter">An additional filter that will filter dates based on their identifer (optional)</param>
        /// <returns>Task of ResourceListOfDate</returns>
        System.Threading.Tasks.Task<ResourceListOfDate> GetDatesAsync (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null, List<string> idFilter = null);
        ...
        /// <param name="asAt">AsAt the dates should be retrieved at (optional)</param>
        /// <param name="idFilter">An additional filter that will filter dates based on their identifer (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfDate)</returns>
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfDate>> GetDatesAsyncWithHttpInfo (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null, List<string> idFilter = null);
        /// <summary>
        /// [EXPERIMENTAL] Update a calendar
        /// </summary>
        /// <remarks>
    ...
    public partial class CalendarsApi : ICalendarsApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] Add a date to a calendar Add an event to the calendar. These Events can be a maximum of 24 hours and must be specified in UTC.  A local date will be calculated by the system and applied to the calendar before processing.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">Scope of the calendar</param>
        /// <param name="code">Code of the calendar</param>
        /// <param name="createDateRequest">Add date to calendar request</param>
        /// <returns>Date</returns>
        public Date AddDateToCalendar (string scope, string code, CreateDateRequest createDateRequest)
        {
             ApiResponse<Date> localVarResponse = AddDateToCalendarWithHttpInfo(scope, code, createDateRequest);
        ...
        /// <param name="createDateRequest">Add date to calendar request</param>
        /// <returns>ApiResponse of Date</returns>
        public ApiResponse< Date > AddDateToCalendarWithHttpInfo (string scope, string code, CreateDateRequest createDateRequest)
        {
            ...
            var localVarPath = "./api/calendar/generic/{scope}/{code}/dates";
            ...
            return new ApiResponse<Date>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (Date) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(Date)));
        }
        ...
        /// <param name="createDateRequest">Add date to calendar request</param>
        /// <returns>Task of Date</returns>
        public async System.Threading.Tasks.Task<Date> AddDateToCalendarAsync (string scope, string code, CreateDateRequest createDateRequest)
        {
             ApiResponse<Date> localVarResponse = await AddDateToCalendarAsyncWithHttpInfo(scope, code, createDateRequest);
             return localVarResponse.Data;
        ...
        /// <param name="createDateRequest">Add date to calendar request</param>
        /// <returns>Task of ApiResponse (Date)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Date>> AddDateToCalendarAsyncWithHttpInfo (string scope, string code, CreateDateRequest createDateRequest)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CalendarsApi->AddDateToCalendar");
        ...
        /// <summary>
        /// [EXPERIMENTAL] Create a calendar in its generic form Create a calendar in a generic form which can be used to store date events.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="createCalendarRequest">A request to create the calendar</param>
        /// <returns>Calendar</returns>
        ...
        public ApiResponse< Calendar > CreateCalendarWithHttpInfo (CreateCalendarRequest createCalendarRequest)
        {
            ...
            var localVarPath = "./api/calendar/generic";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <summary>
        /// [EXPERIMENTAL] Delete a calendar Delete a calendar and all of its respective dates
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">Scope of the calendar</param>
        /// <param name="code">Code of the calendar</param>
        ...
        public ApiResponse< Calendar > DeleteCalendarWithHttpInfo (string scope, string code)
        {
            ...
            var localVarPath = "./api/calendar/generic/{scope}/{code}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <summary>
        /// [EXPERIMENTAL] Remove a date from a calendar Remove a date from a calendar.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">Scope of the calendar</param>
        /// <param name="code">Code of the calendar</param>
        /// <param name="dateId">Identifier of the date to be removed</param>
        /// <returns>Date</returns>
        public Date DeleteDateFromCalendar (string scope, string code, string dateId)
        {
             ApiResponse<Date> localVarResponse = DeleteDateFromCalendarWithHttpInfo(scope, code, dateId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="dateId">Identifier of the date to be removed</param>
        /// <returns>ApiResponse of Date</returns>
        public ApiResponse< Date > DeleteDateFromCalendarWithHttpInfo (string scope, string code, string dateId)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            var localVarPath = "./api/calendar/generic/{scope}/{code}/dates/{dateId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="dateId">Identifier of the date to be removed</param>
        /// <returns>Task of Date</returns>
        public async System.Threading.Tasks.Task<Date> DeleteDateFromCalendarAsync (string scope, string code, string dateId)
        {
             ApiResponse<Date> localVarResponse = await DeleteDateFromCalendarAsyncWithHttpInfo(scope, code, dateId);
             return localVarResponse.Data;
        ...
        /// <param name="dateId">Identifier of the date to be removed</param>
        /// <returns>Task of ApiResponse (Date)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Date>> DeleteDateFromCalendarAsyncWithHttpInfo (string scope, string code, string dateId)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CalendarsApi->DeleteDateFromCalendar");
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get a calendar in its generic form Retrieve a generic calendar by a specific ID at a point in AsAt time
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">Scope of the calendar identifier</param>
        /// <param name="code">Code of the calendar identifier</param>
        ...
        /// <summary>
        /// [EXPERIMENTAL] Get dates for a specific calendar Get dates from a specific calendar within a specific window of effective time, at a point in AsAt time.  Providing an id filter can further refine the results.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">Scope of the calendar</param>
        /// <param name="code">Code of the calendar</param>
        ...
        /// <param name="idFilter">An additional filter that will filter dates based on their identifer (optional)</param>
        /// <returns>ResourceListOfDate</returns>
        public ResourceListOfDate GetDates (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null, List<string> idFilter = null)
        {
             ApiResponse<ResourceListOfDate> localVarResponse = GetDatesWithHttpInfo(scope, code, fromEffectiveAt, toEffectiveAt, asAt, idFilter);
             return localVarResponse.Data;
        }
        ...
        /// <param name="idFilter">An additional filter that will filter dates based on their identifer (optional)</param>
        /// <returns>ApiResponse of ResourceListOfDate</returns>
        public ApiResponse< ResourceListOfDate > GetDatesWithHttpInfo (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null, List<string> idFilter = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            return new ApiResponse<ResourceListOfDate>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (ResourceListOfDate) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ResourceListOfDate)));
        }
        ...
        /// <param name="idFilter">An additional filter that will filter dates based on their identifer (optional)</param>
        /// <returns>Task of ResourceListOfDate</returns>
        public async System.Threading.Tasks.Task<ResourceListOfDate> GetDatesAsync (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null, List<string> idFilter = null)
        {
             ApiResponse<ResourceListOfDate> localVarResponse = await GetDatesAsyncWithHttpInfo(scope, code, fromEffectiveAt, toEffectiveAt, asAt, idFilter);
             return localVarResponse.Data;
        ...
        /// <param name="idFilter">An additional filter that will filter dates based on their identifer (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfDate)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfDate>> GetDatesAsyncWithHttpInfo (string scope, string code, DateTimeOrCutLabel fromEffectiveAt = null, DateTimeOrCutLabel toEffectiveAt = null, DateTimeOffset? asAt = null, List<string> idFilter = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CalendarsApi->GetDates");
        ...
        /// <summary>
        /// [EXPERIMENTAL] Update a calendar Update the calendars WeekendMask, SourceProvider or Properties
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">Scope of the request</param>
        /// <param name="code">Code of the request</param>
        ...
        public ApiResponse< Calendar > UpdateCalendarWithHttpInfo (string scope, string code, UpdateCalendarRequest updateCalendarRequest)
        {
            ...
            var localVarPath = "./api/calendar/generic/{scope}/{code}/mask";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
