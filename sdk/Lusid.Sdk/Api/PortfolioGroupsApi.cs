...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPortfolioGroupsApiSync : IApiAccessor
    {
        ...
        /// <returns>Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        Dictionary<string, List<AccessMetadataValue>> PatchPortfolioGroupAccessMetadata(string scope, string code, List<Operation> operation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        ...
        /// <param name="effectiveAt">The date this rule will be effective from (optional)</param>
        /// <returns>ApiResponse of Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        ApiResponse<Dictionary<string, List<AccessMetadataValue>>> PatchPortfolioGroupAccessMetadataWithHttpInfo(string scope, string code, List<Operation> operation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel));
        /// <summary>
    ...
    public partial class PortfolioGroupsApi : IPortfolioGroupsApi
    {
        ...
        /// <param name="effectiveAt">The date this rule will be effective from (optional)</param>
        /// <returns>Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        public Dictionary<string, List<AccessMetadataValue>> PatchPortfolioGroupAccessMetadata(string scope, string code, List<Operation> operation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            Lusid.Sdk.Client.ApiResponse<Dictionary<string, List<AccessMetadataValue>>> localVarResponse = PatchPortfolioGroupAccessMetadataWithHttpInfo(scope, code, operation, effectiveAt);
            return localVarResponse.Data;
        }
        ...
        /// <param name="effectiveAt">The date this rule will be effective from (optional)</param>
        /// <returns>ApiResponse of Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        public Lusid.Sdk.Client.ApiResponse<Dictionary<string, List<AccessMetadataValue>>> PatchPortfolioGroupAccessMetadataWithHttpInfo(string scope, string code, List<Operation> operation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        {
            Lusid.Sdk.Client.ApiResponse<Dictionary<string, List<AccessMetadataValue>>> localVarResponse = await PatchPortfolioGroupAccessMetadataWithHttpInfoAsync(scope, code, operation, effectiveAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
