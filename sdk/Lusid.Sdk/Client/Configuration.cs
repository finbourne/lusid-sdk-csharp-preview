...
namespace Lusid.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.11.3028-MARK";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.11.3028-MARK/csharp";
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.11.3028-MARK\n";
            report += "    SDK Package Version: 0.11.3028-MARK\n";
