...
namespace Lusid.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.11.3377-mark";
        ...
        {
            UserAgent = "OpenAPI-Generator/0.11.3377-mark/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "OpenAPI-Generator/0.11.3377-mark/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.11.3377-mark\n";
            report += "    SDK Package Version: 0.11.3377-mark\n";
