...
namespace Lusid.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.11.3833";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.11.3833/csharp";
            BasePath = "http://local-unit-test-server.lusid.com:40691";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "http://local-unit-test-server.lusid.com:40691"},
        ...
        public Configuration(
            ...
            string basePath = "http://local-unit-test-server.lusid.com:40691") : this()
        {
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.11.3833\n";
            report += "    SDK Package Version: 0.11.3833\n";
