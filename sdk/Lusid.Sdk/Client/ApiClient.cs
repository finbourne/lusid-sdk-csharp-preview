...
namespace Lusid.Sdk.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("http://localhost.lusid.com:8282");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://localhost.lusid.com:8282).
        /// </summary>
        ...
        public ApiClient(String basePath = "http://localhost.lusid.com:8282")
        {
