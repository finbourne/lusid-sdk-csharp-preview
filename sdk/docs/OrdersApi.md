...
namespace Example
{
    public class ListOrdersExample
    {
        public static void Main()
        {
            ...
            var filter = filter_example;  // string | Expression to filter the result set.  Currently Orders can be filtered by Code (e.g.              \"Code eq 'ORD001'), Quantity (e.g. \"Quantity lt 100\"), Portfolio (e.g. \"Portfolio eq 'TestScope/UKEquities'\"),              LUSID Instrument Id (e.g. \"LusidInstrumentId eq 'LUID_12345678'\") or by Property (Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid). (optional)  (default to "Quantity gt 0")
