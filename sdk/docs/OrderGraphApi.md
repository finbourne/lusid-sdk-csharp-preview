...
All URIs are relative to *http://local-unit-test-server.lusid.com:60190*
...
namespace Example
{
    public class ListOrderGraphBlocksExample
    {
        public static void Main()
        {
            ...
            config.BasePath = "http://local-unit-test-server.lusid.com:60190";
            ...
            var propertyKeys = new List<string>(); // List<string> | See https://support.lusid.com/knowledgebase/article/KA-01855/ (optional) 
