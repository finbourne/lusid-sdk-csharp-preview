...
<a name="listpropertydefinitions"></a>
...
namespace Example
{
    public class ListPropertyDefinitionsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var asAt = 2013-10-20T19:20:30+01:00;  // DateTimeOffset? | The asAt datetime at which to list the property definitions. Defaults to returning the latest version              of each property definition if not specified. (optional) 
            ...
            {
                Debug.Print("Exception when calling PropertyDefinitionsApi.ListPropertyDefinitions: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
