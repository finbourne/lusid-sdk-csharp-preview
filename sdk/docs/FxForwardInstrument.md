...
**IsNdf** | **bool?** | Is the contract an Fx-Forward of \&quot;Non-Deliverable\&quot; type, meaning a single payment in the domestic currency based on  the change in fx-rate vs  a reference rate is used. | 
**FixingDate** | **DateTimeOffset?** | The fixing date. Its presence determines the NDF status of the instrument. | 
