...
namespace Example
{
    public class GetQuotesExample
    {
        public static void Main()
        {
            ...
            var effectiveAt = effectiveAt_example;  // DateTimeOrCutLabel | The effective datetime at which to retrieve the quotes. Defaults to the current LUSID system datetime if not specified. (optional) 
 ...
 **effectiveAt** | **DateTimeOrCutLabel**| The effective datetime at which to retrieve the quotes. Defaults to the current LUSID system datetime if not specified. | [optional] 
