...
<a name="getstagedmodification"></a>
...
namespace Example
{
    public class GetStagedModificationExample
    {
        public static void Main()
        {
            ...
            var asAt = 2013-10-20T19:20:30+01:00;  // DateTimeOffset? | The asAt datetime at which to retrieve the staged modification. Defaults to latest if not specified. (optional) 
...
namespace Example
{
    public class ListRequestedChangesExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new StagedModificationsApi(config);
            var id = id_example;  // string | Unique Id for a staged modification..
            var asAt = 2013-10-20T19:20:30+01:00;  // DateTimeOffset? | The asAt datetime at which to list changes. Defaults to return the latest version              of each staged change if not specified. (optional) 
...
<a name="liststagedmodifications"></a>
...
namespace Example
{
    public class ListStagedModificationsExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new StagedModificationsApi(config);
            var asAt = 2013-10-20T19:20:30+01:00;  // DateTimeOffset? | The asAt datetime at which to list staged modifications. Defaults to return the latest version              of each staged modification if not specified. (optional) 
