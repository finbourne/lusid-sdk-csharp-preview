...
<a name="getcustomentitybyentityuniqueid"></a>
...
namespace Example
{
    public class GetCustomEntityByEntityUniqueIdExample
    {
        public static void Main()
        {
            ...
            var asAt = 2013-10-20T19:20:30+01:00;  // DateTimeOffset? | The asAt datetime at which to retrieve the Custom Entity. Defaults to returning the latest version of the Custom Entity if not specified. (optional) 
            ...
            {
                Debug.Print("Exception when calling EntitiesApi.GetCustomEntityByEntityUniqueId: " + e.Message );
...
namespace Example
{
    public class GetEntityHistoryExample
    {
        public static void Main()
        {
            ...
            var asAt = 2013-10-20T19:20:30+01:00;  // DateTimeOffset? | The asAt datetime at which to list change history information. Defaults to return the change history at the latest datetime if not specified. (optional) 
            ...
            {
                Debug.Print("Exception when calling EntitiesApi.GetEntityHistory: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetInstrumentByEntityUniqueIdExample
    {
        public static void Main()
        {
            ...
            var asAt = 2013-10-20T19:20:30+01:00;  // DateTimeOffset? | The asAt datetime at which to retrieve the instrument definition. Defaults to returning the latest version of the instrument definition if not specified. (optional) 
            var previews = new List<string>(); // List<string> | The ids of the staged modifications to be previewed in the response. (optional) 
...
<a name="getportfoliobyentityuniqueid"></a>
...
<a name="getpropertydefinitionbyentityuniqueid"></a>
...
namespace Example
{
    public class GetPropertyDefinitionByEntityUniqueIdExample
    {
        public static void Main()
        {
            ...
            var asAt = 2013-10-20T19:20:30+01:00;  // DateTimeOffset? | The asAt datetime at which to retrieve the property definition. Defaults to returning the latest version of the property definition if not specified. (optional) 
            var previews = new List<string>(); // List<string> | The ids of the staged modifications to be previewed in the response. (optional) 
