...
namespace Example
{
    public class DeletePortfolioPropertiesExample
    {
        public static void Main()
        {
            ...
            var effectiveAt = effectiveAt_example;  // DateTimeOrCutLabel | The effective datetime at which to delete the properties. Defaults to the current LUSID system datetime if not specified. (optional) 
 ...
 **effectiveAt** | **DateTimeOrCutLabel**| The effective datetime at which to delete the properties. Defaults to the current LUSID system datetime if not specified. | [optional] 
...
namespace Example
{
    public class GetPortfolioExample
    {
        public static void Main()
        {
            ...
            var effectiveAt = effectiveAt_example;  // DateTimeOrCutLabel | The effective datetime at which to retrieve the portfolio definition. Defaults to the current LUSID system datetime if not specified. (optional) 
 ...
 **effectiveAt** | **DateTimeOrCutLabel**| The effective datetime at which to retrieve the portfolio definition. Defaults to the current LUSID system datetime if not specified. | [optional] 
...
namespace Example
{
    public class GetPortfolioPropertiesExample
    {
        public static void Main()
        {
            ...
            var effectiveAt = effectiveAt_example;  // DateTimeOrCutLabel | The effective datetime at which to list the portfolio's properties. Defaults to the current LUSID system datetime if not specified. (optional) 
 ...
 **effectiveAt** | **DateTimeOrCutLabel**| The effective datetime at which to list the portfolio&#39;s properties. Defaults to the current LUSID system datetime if not specified. | [optional] 
...
namespace Example
{
    public class ListPortfoliosExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new PortfoliosApi(Configuration.Default);
            var effectiveAt = effectiveAt_example;  // DateTimeOrCutLabel | The effective datetime at which to list the portfolios. Defaults to the current LUSID              system datetime if not specified. (optional) 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **effectiveAt** | **DateTimeOrCutLabel**| The effective datetime at which to list the portfolios. Defaults to the current LUSID              system datetime if not specified. | [optional] 
...
namespace Example
{
    public class UpdatePortfolioExample
    {
        public static void Main()
        {
            ...
            var effectiveAt = effectiveAt_example;  // DateTimeOrCutLabel | The effective datetime at which to update the definition. Defaults to the current              LUSID system datetime if not specified. (optional) 
 ...
 **effectiveAt** | **DateTimeOrCutLabel**| The effective datetime at which to update the definition. Defaults to the current              LUSID system datetime if not specified. | [optional] 
