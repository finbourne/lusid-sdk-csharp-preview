...
<a name="deletetransactiontemplate"></a>
...
<a name="listtransactiontemplatespecifications"></a>
...
namespace Example
{
    public class ListTransactionTemplateSpecificationsExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new InstrumentEventTypesApi(config);
            var asAt = 2013-10-20T19:20:30+01:00;  // DateTimeOffset? | AsAt of the request (optional) 
...
<a name="listtransactiontemplates"></a>
...
namespace Example
{
    public class ListTransactionTemplatesExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new InstrumentEventTypesApi(config);
            var asAt = 2013-10-20T19:20:30+01:00;  // DateTimeOffset? | The AsAt time at which to retrieve the Transaction Templates (optional) 
...
<a name="updatetransactiontemplate"></a>
