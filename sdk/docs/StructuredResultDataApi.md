...
<a name="getvirtualdocumentrows"></a>
...
namespace Example
{
    public class GetVirtualDocumentRowsExample
    {
        public static void Main()
        {
            ...
            var asAt = 2013-10-20T19:20:30+01:00;  // DateTimeOffset? | The asAt datetime at which to retrieve the virtual document. Defaults to returning the latest version if not specified. (optional) 
