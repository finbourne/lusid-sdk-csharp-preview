...
All URIs are relative to *http://local-unit-test-server.lusid.com:50800*
...
namespace Example
{
    public class DeleteExecutionExample
    {
        ...
        {
            Configuration.Default.BasePath = "http://local-unit-test-server.lusid.com:50800";
            // Configure OAuth2 access token for authorization: oauth2
            Configuration.Default.AccessToken = "YOUR_ACCESS_TOKEN";

            var apiInstance = new ExecutionsApi(Configuration.Default);
