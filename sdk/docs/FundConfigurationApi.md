...
namespace Example
{
    public class CreateFundConfigurationExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new FundConfigurationApi(config);
            ...
            {
                Debug.Print("Exception when calling FundConfigurationApi.CreateFundConfiguration: " + e.Message );
...
namespace Example
{
    public class DeleteFundConfigurationExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FundConfigurationApi.DeleteFundConfiguration: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetFundConfigurationExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FundConfigurationApi.GetFundConfiguration: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class ListFundConfigurationsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FundConfigurationApi.ListFundConfigurations: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
<a name="patchfundconfiguration"></a>
...
namespace Example
{
    public class PatchFundConfigurationExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling FundConfigurationApi.PatchFundConfiguration: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UpsertFundConfigurationPropertiesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FundConfigurationApi.UpsertFundConfigurationProperties: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
